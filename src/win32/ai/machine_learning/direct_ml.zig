...
pub const IDMLObject = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getPrivateData(self: *const T, guid_: ?*const Guid, data_size_: ?*u32, data_: ?*anyopaque) HRESULT {
                return @as(*const IDMLObject.VTable, @ptrCast(self.vtable)).GetPrivateData(@as(*const IDMLObject, @ptrCast(self)), guid_, data_size_, data_);
            }
            pub inline fn setPrivateData(self: *const T, guid_: ?*const Guid, data_size_: u32, data_: ?*const anyopaque) HRESULT {
                return @as(*const IDMLObject.VTable, @ptrCast(self.vtable)).SetPrivateData(@as(*const IDMLObject, @ptrCast(self)), guid_, data_size_, data_);
            }
            pub inline fn setPrivateDataInterface(self: *const T, guid_: ?*const Guid, data_: ?*IUnknown) HRESULT {
                return @as(*const IDMLObject.VTable, @ptrCast(self.vtable)).SetPrivateDataInterface(@as(*const IDMLObject, @ptrCast(self)), guid_, data_);
            }
            pub inline fn setName(self: *const T, name_: ?[*:0]const u16) HRESULT {
                return @as(*const IDMLObject.VTable, @ptrCast(self.vtable)).SetName(@as(*const IDMLObject, @ptrCast(self)), name_);
            }
        };
    }
...
pub const IDMLDevice = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn checkFeatureSupport(self: *const T, feature_: DML_FEATURE, feature_query_data_size_: u32, feature_query_data_: ?*const anyopaque, feature_support_data_size_: u32, feature_support_data_: ?*anyopaque) HRESULT {
                return @as(*const IDMLDevice.VTable, @ptrCast(self.vtable)).CheckFeatureSupport(@as(*const IDMLDevice, @ptrCast(self)), feature_, feature_query_data_size_, feature_query_data_, feature_support_data_size_, feature_support_data_);
            }
            pub inline fn createOperator(self: *const T, desc_: ?*const DML_OPERATOR_DESC, riid_: ?*const Guid, ppv_: ?*?*anyopaque) HRESULT {
                return @as(*const IDMLDevice.VTable, @ptrCast(self.vtable)).CreateOperator(@as(*const IDMLDevice, @ptrCast(self)), desc_, riid_, ppv_);
            }
            pub inline fn compileOperator(self: *const T, op_: ?*IDMLOperator, flags_: DML_EXECUTION_FLAGS, riid_: ?*const Guid, ppv_: ?*?*anyopaque) HRESULT {
                return @as(*const IDMLDevice.VTable, @ptrCast(self.vtable)).CompileOperator(@as(*const IDMLDevice, @ptrCast(self)), op_, flags_, riid_, ppv_);
            }
            pub inline fn createOperatorInitializer(self: *const T, operator_count_: u32, operators_: ?[*]?*IDMLCompiledOperator, riid_: ?*const Guid, ppv_: ?*?*anyopaque) HRESULT {
                return @as(*const IDMLDevice.VTable, @ptrCast(self.vtable)).CreateOperatorInitializer(@as(*const IDMLDevice, @ptrCast(self)), operator_count_, operators_, riid_, ppv_);
            }
            pub inline fn createCommandRecorder(self: *const T, riid_: ?*const Guid, ppv_: ?*?*anyopaque) HRESULT {
                return @as(*const IDMLDevice.VTable, @ptrCast(self.vtable)).CreateCommandRecorder(@as(*const IDMLDevice, @ptrCast(self)), riid_, ppv_);
            }
            pub inline fn createBindingTable(self: *const T, desc_: ?*const DML_BINDING_TABLE_DESC, riid_: ?*const Guid, ppv_: ?*?*anyopaque) HRESULT {
                return @as(*const IDMLDevice.VTable, @ptrCast(self.vtable)).CreateBindingTable(@as(*const IDMLDevice, @ptrCast(self)), desc_, riid_, ppv_);
            }
            pub inline fn evict(self: *const T, count_: u32, pp_objects_: [*]?*IDMLPageable) HRESULT {
                return @as(*const IDMLDevice.VTable, @ptrCast(self.vtable)).Evict(@as(*const IDMLDevice, @ptrCast(self)), count_, pp_objects_);
            }
            pub inline fn makeResident(self: *const T, count_: u32, pp_objects_: [*]?*IDMLPageable) HRESULT {
                return @as(*const IDMLDevice.VTable, @ptrCast(self.vtable)).MakeResident(@as(*const IDMLDevice, @ptrCast(self)), count_, pp_objects_);
            }
            ...
            pub inline fn getParentDevice(self: *const T, riid_: ?*const Guid, ppv_: ?*?*anyopaque) HRESULT {
                return @as(*const IDMLDevice.VTable, @ptrCast(self.vtable)).GetParentDevice(@as(*const IDMLDevice, @ptrCast(self)), riid_, ppv_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getDevice(self: *const T, riid_: ?*const Guid, ppv_: ?*?*anyopaque) HRESULT {
                return @as(*const IDMLDeviceChild.VTable, @ptrCast(self.vtable)).GetDevice(@as(*const IDMLDeviceChild, @ptrCast(self)), riid_, ppv_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDMLDispatchable = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getBindingProperties(self: *const T) DML_BINDING_PROPERTIES {
                var retval: DML_BINDING_PROPERTIES = undefined;
                @as(*const IDMLDispatchable.VTable, @ptrCast(self.vtable)).GetBindingProperties(@as(*const IDMLDispatchable, @ptrCast(self)), &retval);
                return retval;
            }
        };
    }
...
pub const IDMLOperatorInitializer = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDMLDispatchable.MethodMixin(T);
            pub inline fn reset(self: *const T, operator_count_: u32, operators_: ?[*]?*IDMLCompiledOperator) HRESULT {
                return @as(*const IDMLOperatorInitializer.VTable, @ptrCast(self.vtable)).Reset(@as(*const IDMLOperatorInitializer, @ptrCast(self)), operator_count_, operators_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDMLBindingTable = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDMLDeviceChild.MethodMixin(T);
            pub inline fn bindInputs(self: *const T, binding_count_: u32, bindings_: ?[*]const DML_BINDING_DESC) void {
                return @as(*const IDMLBindingTable.VTable, @ptrCast(self.vtable)).BindInputs(@as(*const IDMLBindingTable, @ptrCast(self)), binding_count_, bindings_);
            }
            pub inline fn bindOutputs(self: *const T, binding_count_: u32, bindings_: ?[*]const DML_BINDING_DESC) void {
                return @as(*const IDMLBindingTable.VTable, @ptrCast(self.vtable)).BindOutputs(@as(*const IDMLBindingTable, @ptrCast(self)), binding_count_, bindings_);
            }
            pub inline fn bindTemporaryResource(self: *const T, binding_: ?*const DML_BINDING_DESC) void {
                return @as(*const IDMLBindingTable.VTable, @ptrCast(self.vtable)).BindTemporaryResource(@as(*const IDMLBindingTable, @ptrCast(self)), binding_);
            }
            pub inline fn bindPersistentResource(self: *const T, binding_: ?*const DML_BINDING_DESC) void {
                return @as(*const IDMLBindingTable.VTable, @ptrCast(self.vtable)).BindPersistentResource(@as(*const IDMLBindingTable, @ptrCast(self)), binding_);
            }
            pub inline fn reset(self: *const T, desc_: ?*const DML_BINDING_TABLE_DESC) HRESULT {
                return @as(*const IDMLBindingTable.VTable, @ptrCast(self.vtable)).Reset(@as(*const IDMLBindingTable, @ptrCast(self)), desc_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDMLCommandRecorder = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDMLDeviceChild.MethodMixin(T);
            pub inline fn recordDispatch(self: *const T, command_list_: ?*ID3D12CommandList, dispatchable_: ?*IDMLDispatchable, bindings_: ?*IDMLBindingTable) void {
                return @as(*const IDMLCommandRecorder.VTable, @ptrCast(self.vtable)).RecordDispatch(@as(*const IDMLCommandRecorder, @ptrCast(self)), command_list_, dispatchable_, bindings_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDMLDebugDevice = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn setMuteDebugOutput(self: *const T, mute_: BOOL) void {
                return @as(*const IDMLDebugDevice.VTable, @ptrCast(self.vtable)).SetMuteDebugOutput(@as(*const IDMLDebugDevice, @ptrCast(self)), mute_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDMLDevice1 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn compileGraph(self: *const T, desc_: ?*const DML_GRAPH_DESC, flags_: DML_EXECUTION_FLAGS, riid_: ?*const Guid, ppv_: ?*?*anyopaque) HRESULT {
                return @as(*const IDMLDevice1.VTable, @ptrCast(self.vtable)).CompileGraph(@as(*const IDMLDevice1, @ptrCast(self)), desc_, flags_, riid_, ppv_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub extern "directml" fn DMLCreateDevice1(
    d3d12_device: ?*ID3D12Device,
    flags: DML_CREATE_DEVICE_FLAGS,
    minimum_feature_level: DML_FEATURE_LEVEL,
    riid: ?*const Guid,
    ppv: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
