...
pub const SAFER_COMPUTE_TOKEN_FROM_LEVEL_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(SAFER_COMPUTE_TOKEN_FROM_LEVEL_FLAGS, @enumFromInt((if (o.NULL_IF_EQUAL == 1) @intFromEnum(SAFER_COMPUTE_TOKEN_FROM_LEVEL_FLAGS.NULL_IF_EQUAL) else 0) | (if (o.COMPARE_ONLY == 1) @intFromEnum(SAFER_COMPUTE_TOKEN_FROM_LEVEL_FLAGS.COMPARE_ONLY) else 0) | (if (o.MAKE_INERT == 1) @intFromEnum(SAFER_COMPUTE_TOKEN_FROM_LEVEL_FLAGS.MAKE_INERT) else 0) | (if (o.WANT_FLAGS == 1) @intFromEnum(SAFER_COMPUTE_TOKEN_FROM_LEVEL_FLAGS.WANT_FLAGS) else 0)));
    }
};
...
pub extern "advapi32" fn SaferCreateLevel(
    ...
    dw_level_id: u32,
    open_flags: u32,
    p_level_handle: ?*SAFER_LEVEL_HANDLE,
    lp_reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "advapi32" fn SaferCloseLevel(
    h_level_handle: SAFER_LEVEL_HANDLE,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "advapi32" fn SaferIdentifyLevel(
    dw_num_properties: u32,
    p_code_properties: ?[*]SAFER_CODE_PROPERTIES_V2,
    p_level_handle: ?*SAFER_LEVEL_HANDLE,
    lp_reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "advapi32" fn SaferComputeTokenFromLevel(
    level_handle: SAFER_LEVEL_HANDLE,
    in_access_token: ?HANDLE,
    out_access_token: ?*?HANDLE,
    dw_flags: SAFER_COMPUTE_TOKEN_FROM_LEVEL_FLAGS,
    lp_reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "advapi32" fn SaferGetLevelInformation(
    level_handle: SAFER_LEVEL_HANDLE,
    dw_info_type: SAFER_OBJECT_INFO_CLASS,
    // TODO: what to do with BytesParamIndex 3?
    lp_query_buffer: ?*anyopaque,
    dw_in_buffer_size: u32,
    lpdw_out_buffer_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "advapi32" fn SaferRecordEventLogEntry(
    ...
    sz_target_path: ?[*:0]const u16,
    lp_reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "advapi32" fn SaferiIsExecutableFileType(
    sz_full_pathname: ?[*:0]const u16,
    b_from_shell_execute: BOOLEAN,
) callconv(@import("std").os.windows.WINAPI) BOOL;
