...
pub const pCryptSIPGetSignedDataMsg = *const fn (
    p_subject_info: ?*SIP_SUBJECTINFO,
    pdw_encoding_type: ?*u32,
    dw_index: u32,
    pcb_signed_data_msg: ?*u32,
    pb_signed_data_msg: ?*u8,
...
pub const pCryptSIPGetCaps = *const fn (
    p_subj_info: ?*SIP_SUBJECTINFO,
    p_caps: ?*SIP_CAP_SET_V3,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wintrust" fn CryptSIPGetSignedDataMsg(
    p_subject_info: ?*SIP_SUBJECTINFO,
    pdw_encoding_type: ?*CERT_QUERY_ENCODING_TYPE,
    dw_index: u32,
    pcb_signed_data_msg: ?*u32,
    pb_signed_data_msg: ?*u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "crypt32" fn CryptSIPLoad(
    pg_subject: ?*const Guid,
    dw_flags: u32,
    p_sip_dispatch: ?*SIP_DISPATCH_INFO,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "crypt32" fn CryptSIPAddProvider(
    ps_new_prov: ?*SIP_ADD_NEWPROVIDER,
) callconv(@import("std").os.windows.WINAPI) BOOL;
