...
pub extern "keycredmgr" fn KeyCredentialManagerGetOperationErrorStates(
    key_credential_manager_operation_type: KeyCredentialManagerOperationType,
    is_ready: ?*BOOL,
    key_credential_manager_operation_error_states: ?*KeyCredentialManagerOperationErrorStates,
...
pub extern "keycredmgr" fn KeyCredentialManagerGetInformation(
    key_credential_manager_info: ?*?*KeyCredentialManagerInfo,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "advapi32" fn CredWriteDomainCredentialsA(
    target_info: ?*CREDENTIAL_TARGET_INFORMATIONA,
    credential: ?*CREDENTIALA,
    flags: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "advapi32" fn CredRenameW(
    old_target_name: ?[*:0]const u16,
    new_target_name: ?[*:0]const u16,
    type: u32,
    flags: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "advapi32" fn CredRenameA(
    old_target_name: ?[*:0]const u8,
    new_target_name: ?[*:0]const u8,
    type: u32,
    flags: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "advapi32" fn CredMarshalCredentialW(
    cred_type: CRED_MARSHAL_TYPE,
    credential: ?*anyopaque,
    marshaled_credential: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "advapi32" fn CredMarshalCredentialA(
    cred_type: CRED_MARSHAL_TYPE,
    credential: ?*anyopaque,
    marshaled_credential: ?*?PSTR,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "advapi32" fn CredUnmarshalCredentialW(
    marshaled_credential: ?[*:0]const u16,
    cred_type: ?*CRED_MARSHAL_TYPE,
    credential: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "advapi32" fn CredUnmarshalCredentialA(
    marshaled_credential: ?[*:0]const u8,
    cred_type: ?*CRED_MARSHAL_TYPE,
    credential: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "credui" fn CredUnPackAuthenticationBufferW(
    dw_flags: CRED_PACK_FLAGS,
    // TODO: what to do with BytesParamIndex 2?
    p_auth_buffer: ?*anyopaque,
    cb_auth_buffer: u32,
    psz_user_name: ?[*:0]u16,
    pcch_max_user_name: ?*u32,
    psz_domain_name: ?[*:0]u16,
    pcch_max_domain_name: ?*u32,
    psz_password: ?[*:0]u16,
    pcch_max_password: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "credui" fn CredUnPackAuthenticationBufferA(
    ...
    cb_auth_buffer: u32,
    psz_user_name: ?[*:0]u8,
    pcchl_max_user_name: ?*u32,
    psz_domain_name: ?[*:0]u8,
    pcch_max_domain_name: ?*u32,
    psz_password: ?[*:0]u8,
    pcch_max_password: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "credui" fn CredPackAuthenticationBufferW(
    ...
    p_packed_credentials: ?*u8,
    pcb_packed_credentials: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "advapi32" fn CredProtectW(
    f_as_self: BOOL,
    psz_credentials: [*:0]u16,
    cch_credentials: u32,
    psz_protected_credentials: [*:0]u16,
    pcch_max_chars: ?*u32,
    protection_type: ?*CRED_PROTECTION_TYPE,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "advapi32" fn CredProtectA(
    f_as_self: BOOL,
    psz_credentials: [*:0]u8,
    cch_credentials: u32,
    psz_protected_credentials: [*:0]u8,
    pcch_max_chars: ?*u32,
    protection_type: ?*CRED_PROTECTION_TYPE,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "advapi32" fn CredIsProtectedW(
    psz_protected_credentials: ?PWSTR,
    p_protection_type: ?*CRED_PROTECTION_TYPE,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "advapi32" fn CredIsProtectedA(
    psz_protected_credentials: ?PSTR,
    p_protection_type: ?*CRED_PROTECTION_TYPE,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "credui" fn CredUIPromptForCredentialsW(
    p_ui_info: ?*CREDUI_INFOW,
    psz_target_name: ?[*:0]const u16,
    p_context: ?*SecHandle,
    dw_auth_error: u32,
    psz_user_name: [*:0]u16,
    ul_user_name_buffer_size: u32,
    psz_password: [*:0]u16,
    ul_password_buffer_size: u32,
    save: ?*BOOL,
    dw_flags: CREDUI_FLAGS,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "credui" fn CredUIPromptForCredentialsA(
    p_ui_info: ?*CREDUI_INFOA,
...
pub extern "credui" fn CredUIPromptForWindowsCredentialsW(
    p_ui_info: ?*CREDUI_INFOW,
    dw_auth_error: u32,
    pul_auth_package: ?*u32,
    // TODO: what to do with BytesParamIndex 4?
    pv_in_auth_buffer: ?*const anyopaque,
    ul_in_auth_buffer_size: u32,
    // TODO: what to do with BytesParamIndex 6?
    ppv_out_auth_buffer: ?*?*anyopaque,
    pul_out_auth_buffer_size: ?*u32,
    pf_save: ?*BOOL,
    dw_flags: CREDUIWIN_FLAGS,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "credui" fn CredUIParseUserNameW(
    ...
    user: [*:0]u16,
    user_buffer_size: u32,
    domain: [*:0]u16,
    domain_buffer_size: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "winscard" fn SCardEstablishContext(
    dw_scope: SCARD_SCOPE,
    pv_reserved1: ?*const anyopaque,
    pv_reserved2: ?*const anyopaque,
    ph_context: ?*usize,
...
pub extern "winscard" fn SCardListInterfacesA(
    h_context: usize,
    sz_card: ?[*:0]const u8,
    pguid_interfaces: ?*Guid,
    pcguid_interfaces: ?*u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "winscard" fn SCardIntroduceReaderGroupA(
    h_context: usize,
    sz_group_name: ?[*:0]const u8,
) callconv(@import("std").os.windows.WINAPI) i32;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "winscard" fn SCardIntroduceReaderGroupW(
    h_context: usize,
    sz_group_name: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "winscard" fn SCardIntroduceReaderA(
    h_context: usize,
    sz_reader_name: ?[*:0]const u8,
    sz_device_name: ?[*:0]const u8,
) callconv(@import("std").os.windows.WINAPI) i32;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "winscard" fn SCardIntroduceReaderW(
    h_context: usize,
    sz_reader_name: ?[*:0]const u16,
    sz_device_name: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "winscard" fn SCardIntroduceCardTypeA(
    h_context: usize,
    sz_card_name: ?[*:0]const u8,
    pguid_primary_provider: ?*const Guid,
    rgguid_interfaces: ?*const Guid,
    dw_interface_count: u32,
    pb_atr: ?*u8,
    pb_atr_mask: ?*u8,
    cb_atr_len: u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "winscard" fn SCardLocateCardsA(
    h_context: usize,
    msz_cards: ?[*:0]const u8,
    rg_reader_states: ?*SCARD_READERSTATEA,
    c_readers: u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "winscard" fn SCardLocateCardsW(
    h_context: usize,
    msz_cards: ?[*:0]const u16,
    rg_reader_states: ?*SCARD_READERSTATEW,
    c_readers: u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "winscard" fn SCardConnectA(
    h_context: usize,
    sz_reader: ?[*:0]const u8,
    dw_share_mode: u32,
    dw_preferred_protocols: u32,
    ph_card: ?*usize,
    pdw_active_protocol: ?*u32,
) callconv(@import("std").os.windows.WINAPI) i32;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "winscard" fn SCardConnectW(
    h_context: usize,
    sz_reader: ?[*:0]const u16,
    dw_share_mode: u32,
    dw_preferred_protocols: u32,
    ph_card: ?*usize,
    pdw_active_protocol: ?*u32,
...
pub extern "winscard" fn SCardTransmit(
    h_card: usize,
    pio_send_pci: ?*SCARD_IO_REQUEST,
    // TODO: what to do with BytesParamIndex 3?
    pb_send_buffer: ?*u8,
    cb_send_length: u32,
    pio_recv_pci: ?*SCARD_IO_REQUEST,
    // TODO: what to do with BytesParamIndex 6?
    pb_recv_buffer: ?*u8,
    pcb_recv_length: ?*u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "winscard" fn SCardGetReaderDeviceInstanceIdA(
    h_context: usize,
    sz_reader_name: ?[*:0]const u8,
    sz_device_instance_id: ?PSTR,
    pcch_device_instance_id: ?*u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "winscard" fn SCardListReadersWithDeviceInstanceIdA(
    h_context: usize,
    sz_device_instance_id: ?[*:0]const u8,
    msz_readers: ?PSTR,
    pcch_readers: ?*u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "winscard" fn SCardListReadersWithDeviceInstanceIdW(
    h_context: usize,
    sz_device_instance_id: ?[*:0]const u16,
    msz_readers: ?PWSTR,
    pcch_readers: ?*u32,
) callconv(@import("std").os.windows.WINAPI) i32;
