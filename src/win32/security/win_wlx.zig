...
pub const PWLX_QUERY_CLIENT_CREDENTIALS = *const fn (
    p_cred: ?*WLX_CLIENT_CREDENTIALS_INFO_V1_0,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub const PWLX_QUERY_TS_LOGON_CREDENTIALS = *const fn (
    p_cred: ?*WLX_CLIENT_CREDENTIALS_INFO_V2_0,
) callconv(@import("std").os.windows.WINAPI) BOOL;

pub const PWLX_DISCONNECT = *const fn () callconv(@import("std").os.windows.WINAPI) BOOL;

pub const PWLX_QUERY_TERMINAL_SERVICES_DATA = *const fn (
    h_wlx: ?HANDLE,
    p_t_s_data: ?*WLX_TERMINAL_SERVICES_DATA,
    user_name: ?PWSTR,
    domain: ?PWSTR,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const PWLX_QUERY_CONSOLESWITCH_CREDENTIALS = *const fn (
    p_cred: ?*WLX_CONSOLESWITCH_CREDENTIALS_INFO_V1_0,
) callconv(@import("std").os.windows.WINAPI) u32;
