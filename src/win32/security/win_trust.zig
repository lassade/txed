...
pub const WINTRUST_DATA_PROVIDER_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(WINTRUST_DATA_PROVIDER_FLAGS, @enumFromInt((if (o.USE_IE4_TRUST_FLAG == 1) @intFromEnum(WINTRUST_DATA_PROVIDER_FLAGS.USE_IE4_TRUST_FLAG) else 0) | (if (o.NO_IE4_CHAIN_FLAG == 1) @intFromEnum(WINTRUST_DATA_PROVIDER_FLAGS.NO_IE4_CHAIN_FLAG) else 0) | (if (o.NO_POLICY_USAGE_FLAG == 1) @intFromEnum(WINTRUST_DATA_PROVIDER_FLAGS.NO_POLICY_USAGE_FLAG) else 0) | (if (o.REVOCATION_CHECK_NONE == 1) @intFromEnum(WINTRUST_DATA_PROVIDER_FLAGS.REVOCATION_CHECK_NONE) else 0) | (if (o.REVOCATION_CHECK_END_CERT == 1) @intFromEnum(WINTRUST_DATA_PROVIDER_FLAGS.REVOCATION_CHECK_END_CERT) else 0) | (if (o.REVOCATION_CHECK_CHAIN == 1) @intFromEnum(WINTRUST_DATA_PROVIDER_FLAGS.REVOCATION_CHECK_CHAIN) else 0) | (if (o.REVOCATION_CHECK_CHAIN_EXCLUDE_ROOT == 1) @intFromEnum(WINTRUST_DATA_PROVIDER_FLAGS.REVOCATION_CHECK_CHAIN_EXCLUDE_ROOT) else 0) | (if (o.SAFER_FLAG == 1) @intFromEnum(WINTRUST_DATA_PROVIDER_FLAGS.SAFER_FLAG) else 0) | (if (o.HASH_ONLY_FLAG == 1) @intFromEnum(WINTRUST_DATA_PROVIDER_FLAGS.HASH_ONLY_FLAG) else 0) | (if (o.USE_DEFAULT_OSVER_CHECK == 1) @intFromEnum(WINTRUST_DATA_PROVIDER_FLAGS.USE_DEFAULT_OSVER_CHECK) else 0) | (if (o.LIFETIME_SIGNING_FLAG == 1) @intFromEnum(WINTRUST_DATA_PROVIDER_FLAGS.LIFETIME_SIGNING_FLAG) else 0) | (if (o.CACHE_ONLY_URL_RETRIEVAL == 1) @intFromEnum(WINTRUST_DATA_PROVIDER_FLAGS.CACHE_ONLY_URL_RETRIEVAL) else 0) | (if (o.DISABLE_MD2_MD4 == 1) @intFromEnum(WINTRUST_DATA_PROVIDER_FLAGS.DISABLE_MD2_MD4) else 0) | (if (o.MOTW == 1) @intFromEnum(WINTRUST_DATA_PROVIDER_FLAGS.MOTW) else 0)));
    }
};
...
pub const PFN_ALLOCANDFILLDEFUSAGE = *const fn (
    psz_usage_o_i_d: ?[*:0]const u8,
    ps_def_usage: ?*CRYPT_PROVIDER_DEFUSAGE,
...
pub const PFN_WTD_GENERIC_CHAIN_POLICY_CALLBACK = *const fn (
    p_prov_data: ?*CRYPT_PROVIDER_DATA,
    dw_step_error: u32,
    dw_reg_policy_settings: u32,
    c_signer: u32,
    rgp_signer: ?*?*WTD_GENERIC_CHAIN_POLICY_SIGNER_INFO,
    pv_policy_arg: ?*anyopaque,
...
pub extern "wintrust" fn WinVerifyTrustEx(
    hwnd: ?HWND,
    pg_action_i_d: ?*Guid,
    p_win_trust_data: ?*WINTRUST_DATA,
) callconv(@import("std").os.windows.WINAPI) i32;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "wintrust" fn WintrustGetRegPolicyFlags(
    pdw_policy_flags: ?*WINTRUST_POLICY_FLAGS,
) callconv(@import("std").os.windows.WINAPI) void;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "wintrust" fn WintrustSetRegPolicyFlags(
    dw_policy_flags: WINTRUST_POLICY_FLAGS,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wintrust" fn WintrustAddActionID(
    pg_action_i_d: ?*Guid,
    fdw_flags: u32,
    ps_prov_info: ?*CRYPT_REGISTER_ACTIONID,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wintrust" fn WintrustLoadFunctionPointers(
    pg_action_i_d: ?*Guid,
    p_pfns: ?*CRYPT_PROVIDER_FUNCTIONS,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "wintrust" fn WintrustAddDefaultForUsage(
    psz_usage_o_i_d: ?[*:0]const u8,
    ps_def_usage: ?*CRYPT_PROVIDER_REGDEFUSAGE,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "wintrust" fn WintrustGetDefaultForUsage(
    dw_action: WINTRUST_GET_DEFAULT_FOR_USAGE_ACTION,
    psz_usage_o_i_d: ?[*:0]const u8,
    ps_usage: ?*CRYPT_PROVIDER_DEFUSAGE,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wintrust" fn WintrustSetDefaultIncludePEPageHashes(
    f_include_p_e_page_hashes: BOOL,
) callconv(@import("std").os.windows.WINAPI) void;
