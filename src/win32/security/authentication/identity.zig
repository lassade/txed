...
pub const PSAM_INIT_NOTIFICATION_ROUTINE = *const fn () callconv(@import("std").os.windows.WINAPI) BOOLEAN;
...
pub const INIT_SECURITY_INTERFACE_A = *const fn () callconv(@import("std").os.windows.WINAPI) ?*SecurityFunctionTableA;

pub const INIT_SECURITY_INTERFACE_W = *const fn () callconv(@import("std").os.windows.WINAPI) ?*SecurityFunctionTableW;
...
pub const PLSA_GET_CREDENTIALS = *const fn (
    ...
    authentication_package: u32,
    query_context: ?*u32,
    retrieve_all_credentials: BOOLEAN,
    primary_key_value: ?*STRING,
    primary_key_length: ?*u32,
    credentials: ?*STRING,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const PLSA_AP_INITIALIZE_PACKAGE = *const fn (
    ...
    lsa_dispatch_table: ?*LSA_DISPATCH_TABLE,
    database: ?*STRING,
...
pub const PLSA_AP_LOGON_USER = *const fn (
    ...
    authentication_information: ?*anyopaque,
    client_authentication_base: ?*anyopaque,
    authentication_information_length: u32,
    profile_buffer: ?*?*anyopaque,
    profile_buffer_length: ?*u32,
    logon_id: ?*LUID,
    sub_status: ?*i32,
    token_information_type: ?*LSA_TOKEN_INFORMATION_TYPE,
    token_information: ?*?*anyopaque,
    account_name: ?*?*UNICODE_STRING,
    authenticating_authority: ?*?*UNICODE_STRING,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const PSAM_CREDENTIAL_UPDATE_NOTIFY_ROUTINE = *const fn (
    clear_password: ?*UNICODE_STRING,
    // TODO: what to do with BytesParamIndex 2?
    old_credentials: ?*anyopaque,
    old_credential_size: u32,
    user_account_control: u32,
    u_p_n: ?*UNICODE_STRING,
    user_name: ?*UNICODE_STRING,
    netbios_domain_name: ?*UNICODE_STRING,
    dns_domain_name: ?*UNICODE_STRING,
    new_credentials: ?*?*anyopaque,
    new_credential_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

pub const PSAM_CREDENTIAL_UPDATE_REGISTER_ROUTINE = *const fn (
    credential_name: ?*UNICODE_STRING,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;
...
pub const PLSA_REDIRECTED_LOGON_INIT = *const fn (
    redirected_logon_handle: ?HANDLE,
    package_name: ?*const UNICODE_STRING,
    session_id: u32,
    logon_id: ?*const LUID,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const PLSA_REDIRECTED_LOGON_GET_LOGON_CREDS = *const fn (
    redirected_logon_handle: ?HANDLE,
    logon_buffer: ?*?*u8,
    logon_buffer_length: ?*u32,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

pub const PLSA_REDIRECTED_LOGON_GET_SUPP_CREDS = *const fn (
    redirected_logon_handle: ?HANDLE,
    supplemental_credentials: ?*?*SECPKG_SUPPLEMENTAL_CRED_ARRAY,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const PLSA_IMPERSONATE_CLIENT = *const fn () callconv(@import("std").os.windows.WINAPI) NTSTATUS;

pub const PLSA_UNLOAD_PACKAGE = *const fn () callconv(@import("std").os.windows.WINAPI) NTSTATUS;

pub const PLSA_DUPLICATE_HANDLE = *const fn (
    source_handle: ?HANDLE,
    destionation_handle: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

pub const PLSA_SAVE_SUPPLEMENTAL_CREDENTIALS = *const fn (
    logon_id: ?*LUID,
    supplemental_cred_size: u32,
    // TODO: what to do with BytesParamIndex 1?
    supplemental_creds: ?*anyopaque,
    synchronous: BOOLEAN,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const PLSA_CREATE_THREAD = *const fn (
    ...
    stack_size: u32,
    start_function: ?LPTHREAD_START_ROUTINE,
    thread_parameter: ?*anyopaque,
    creation_flags: u32,
    thread_id: ?*u32,
) callconv(@import("std").os.windows.WINAPI) ?HANDLE;

pub const PLSA_GET_CLIENT_INFO = *const fn (
    client_info: ?*SECPKG_CLIENT_INFO,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const PLSA_CREATE_TOKEN_EX = *const fn (
    ...
    workstation: ?*UNICODE_STRING,
    profile_path: ?*UNICODE_STRING,
    session_information: ?*anyopaque,
    session_information_type: SECPKG_SESSIONINFO_TYPE,
    token: ?*?HANDLE,
    sub_status: ?*i32,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const PLSA_AUDIT_LOGON = *const fn (
    ...
    account_name: ?*UNICODE_STRING,
    authenticating_authority: ?*UNICODE_STRING,
    workstation_name: ?*UNICODE_STRING,
    user_sid: ?PSID,
    logon_type: SECURITY_LOGON_TYPE,
    token_source: ?*TOKEN_SOURCE,
    logon_id: ?*LUID,
...
pub const PLSA_OPEN_SAM_USER = *const fn (
    name: ?*UNICODE_STRING,
    name_type: SECPKG_NAME_TYPE,
    prefix: ?*UNICODE_STRING,
    allow_guest: BOOLEAN,
    reserved: u32,
    user_handle: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

pub const PLSA_GET_USER_CREDENTIALS = *const fn (
    user_handle: ?*anyopaque,
    primary_creds: ?*?*anyopaque,
    primary_creds_size: ?*u32,
    supplemental_creds: ?*?*anyopaque,
    supplemental_creds_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

pub const PLSA_GET_USER_AUTH_DATA = *const fn (
    user_handle: ?*anyopaque,
    user_auth_data: ?*?*u8,
    user_auth_data_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const PLSA_GET_AUTH_DATA_FOR_USER = *const fn (
    ...
    user_auth_data: ?*?*u8,
    user_auth_data_size: ?*u32,
    user_flat_name: ?*UNICODE_STRING,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

pub const PLSA_CONVERT_AUTH_DATA_TO_TOKEN = *const fn (
    user_auth_data: ?*anyopaque,
    user_auth_data_size: u32,
    impersonation_level: SECURITY_IMPERSONATION_LEVEL,
    token_source: ?*TOKEN_SOURCE,
    logon_type: SECURITY_LOGON_TYPE,
...
pub const PLSA_CRACK_SINGLE_NAME = *const fn (
    format_offered: u32,
    perform_at_g_c: BOOLEAN,
    name_input: ?*UNICODE_STRING,
    prefix: ?*UNICODE_STRING,
    requested_format: u32,
    cracked_name: ?*UNICODE_STRING,
    dns_domain_name: ?*UNICODE_STRING,
    sub_status: ?*u32,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const PLSA_UPDATE_PRIMARY_CREDENTIALS = *const fn (
    primary_credentials: ?*SECPKG_PRIMARY_CRED,
...
pub const PLSA_EXPAND_AUTH_DATA_FOR_DOMAIN = *const fn (
    ...
    user_auth_data_size: u32,
    reserved: ?*anyopaque,
    expanded_auth_data: ?*?*u8,
    expanded_auth_data_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const PLSA_GET_SERVICE_ACCOUNT_PASSWORD = *const fn (
    ...
    file_time_expiry: ?*FILETIME,
    current_password: ?*UNICODE_STRING,
    previous_password: ?*UNICODE_STRING,
    file_time_curr_pwd_valid_for_outbound: ?*FILETIME,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const CredReadDomainCredentialsFn = *const fn (
    logon_id: ?*LUID,
    cred_flags: u32,
    target_info: ?*CREDENTIAL_TARGET_INFORMATIONW,
    flags: u32,
    count: ?*u32,
    credential: ?*?*?*ENCRYPTED_CREDENTIALW,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const SpInitializeFn = *const fn (
    ...
    function_table: ?*LSA_SECPKG_FUNCTION_TABLE,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

pub const SpShutdownFn = *const fn () callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const SpGetExtendedInformationFn = *const fn (
    class: SECPKG_EXTENDED_INFORMATION_CLASS,
    pp_information: ?*?*SECPKG_EXTENDED_INFORMATION,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const PLSA_AP_LOGON_USER_EX3 = *const fn (
    ...
    client_buffer_base: ?*anyopaque,
    submit_buffer_size: u32,
    surrogate_logon: ?*SECPKG_SURROGATE_LOGON,
    profile_buffer: ?*?*anyopaque,
    profile_buffer_size: ?*u32,
    logon_id: ?*LUID,
    sub_status: ?*i32,
...
pub const SpAcceptCredentialsFn = *const fn (
    ...
    account_name: ?*UNICODE_STRING,
    primary_credentials: ?*SECPKG_PRIMARY_CRED,
    supplemental_credentials: ?*SECPKG_SUPPLEMENTAL_CRED,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

pub const SpAcquireCredentialsHandleFn = *const fn (
    principal_name: ?*UNICODE_STRING,
    credential_use_flags: u32,
    logon_id: ?*LUID,
    authorization_data: ?*anyopaque,
    get_key_funciton: ?*anyopaque,
    get_key_argument: ?*anyopaque,
    credential_handle: ?*usize,
...
pub const SpInitLsaModeContextFn = *const fn (
    ...
    target_data_rep: u32,
    input_buffers: ?*SecBufferDesc,
    new_context_handle: ?*usize,
    output_buffers: ?*SecBufferDesc,
    context_attributes: ?*u32,
    expiration_time: ?*LARGE_INTEGER,
    mapped_context: ?*BOOLEAN,
    context_data: ?*SecBuffer,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const SpApplyControlTokenFn = *const fn (
    context_handle: usize,
    control_token: ?*SecBufferDesc,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

pub const SpAcceptLsaModeContextFn = *const fn (
    credential_handle: usize,
    context_handle: usize,
    input_buffer: ?*SecBufferDesc,
    context_requirements: u32,
    target_data_rep: u32,
    new_context_handle: ?*usize,
    output_buffer: ?*SecBufferDesc,
    context_attributes: ?*u32,
    expiration_time: ?*LARGE_INTEGER,
    mapped_context: ?*BOOLEAN,
    context_data: ?*SecBuffer,
...
pub const SpGetUserInfoFn = *const fn (
    logon_id: ?*LUID,
    flags: u32,
    user_data: ?*?*SECURITY_USER_DATA,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

pub const SpQueryContextAttributesFn = *const fn (
    context_handle: usize,
    context_attribute: u32,
    buffer: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const SpChangeAccountPasswordFn = *const fn (
    p_domain_name: ?*UNICODE_STRING,
    p_account_name: ?*UNICODE_STRING,
    p_old_password: ?*UNICODE_STRING,
    p_new_password: ?*UNICODE_STRING,
    impersonating: BOOLEAN,
    p_output: ?*SecBufferDesc,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const SpGetCredUIContextFn = *const fn (
    context_handle: usize,
    cred_type: ?*Guid,
    flat_cred_u_i_context_length: ?*u32,
    flat_cred_u_i_context: ?*?*u8,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const SpValidateTargetInfoFn = *const fn (
    ...
    client_buffer_base: ?*anyopaque,
    submit_buffer_length: u32,
    target_info: ?*SECPKG_TARGETINFO,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

pub const LSA_AP_POST_LOGON_USER = *const fn (
    post_logon_user_info: ?*SECPKG_POST_LOGON_USER_INFO,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const SpGetRemoteCredGuardLogonBufferFn = *const fn (
    ...
    logon_buffer_size: ?*u32,
    logon_buffer: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const SpInstanceInitFn = *const fn (
    version: u32,
    function_table: ?*SECPKG_DLL_FUNCTIONS,
    user_functions: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

pub const SpInitUserModeContextFn = *const fn (
    context_handle: usize,
    packed_context: ?*SecBuffer,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

pub const SpMakeSignatureFn = *const fn (
    context_handle: usize,
    quality_of_protection: u32,
    message_buffers: ?*SecBufferDesc,
    message_sequence_number: u32,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const SpFormatCredentialsFn = *const fn (
    credentials: ?*SecBuffer,
    formatted_credentials: ?*SecBuffer,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const SpMarshallSupplementalCredsFn = *const fn (
    ...
    credentials: ?*u8,
    marshalled_cred_size: ?*u32,
    marshalled_creds: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

pub const SpMarshalAttributeDataFn = *const fn (
    attribute_info: u32,
    attribute: u32,
    attribute_data_size: u32,
    // TODO: what to do with BytesParamIndex 2?
    attribute_data: ?*u8,
    marshaled_attribute_data_size: ?*u32,
    marshaled_attribute_data: ?*?*u8,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const SpLsaModeInitializeFn = *const fn (
    lsa_version: u32,
    package_version: ?*u32,
    pp_tables: ?*?*SECPKG_FUNCTION_TABLE,
    pc_tables: ?*u32,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const SpUserModeInitializeFn = *const fn (
    lsa_version: u32,
    package_version: ?*u32,
    pp_tables: ?*?*SECPKG_USER_FUNCTION_TABLE,
    pc_tables: ?*u32,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const PKSEC_SERIALIZE_WINNT_AUTH_DATA = *const fn (
    pv_auth_data: ?*anyopaque,
    size: ?*u32,
    serialized_data: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const KspInitPackageFn = *const fn (
    function_table: ?*SECPKG_KERNEL_FUNCTIONS,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

pub const KspDeleteContextFn = *const fn (
    context_id: usize,
    lsa_context_id: ?*usize,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

pub const KspInitContextFn = *const fn (
    context_id: usize,
    context_data: ?*SecBuffer,
    new_context_id: ?*usize,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub const SSL_CRACK_CERTIFICATE_FN = *const fn (
    ...
    pp_certificate: ?*?*X509Certificate,
) callconv(@import("std").os.windows.WINAPI) BOOL;

pub const SSL_FREE_CERTIFICATE_FN = *const fn (
    p_certificate: ?*X509Certificate,
) callconv(@import("std").os.windows.WINAPI) void;
...
pub const SslGetExtensionsFn = *const fn (
    client_hello: [*:0]const u8,
    client_hello_byte_size: u32,
    generic_extensions: [*]SCH_EXTENSION_DATA,
    generic_extensions_count: u8,
    bytes_to_read: ?*u32,
...
pub const ICcgDomainAuthCredentials = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getPasswordCredentials(self: *const T, plugin_input_: ?[*:0]const u16, domain_name_: ?*?PWSTR, username_: ?*?PWSTR, password_: ?*?PWSTR) HRESULT {
                return @as(*const ICcgDomainAuthCredentials.VTable, @ptrCast(self.vtable)).GetPasswordCredentials(@as(*const ICcgDomainAuthCredentials, @ptrCast(self)), plugin_input_, domain_name_, username_, password_);
            }
        };
    }
...
pub extern "secur32" fn LsaLogonUser(
    ...
    authentication_information: ?*anyopaque,
    authentication_information_length: u32,
    local_groups: ?*TOKEN_GROUPS,
    source_context: ?*TOKEN_SOURCE,
    profile_buffer: ?*?*anyopaque,
    profile_buffer_length: ?*u32,
    logon_id: ?*LUID,
    token: ?*?HANDLE,
...
pub extern "advapi32" fn LsaClose(
    object_handle: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "secur32" fn LsaEnumerateLogonSessions(
    logon_session_count: ?*u32,
    logon_session_list: ?*?*LUID,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "secur32" fn LsaGetLogonSessionData(
    logon_id: ?*LUID,
    pp_logon_session_data: ?*?*SECURITY_LOGON_SESSION_DATA,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "advapi32" fn LsaOpenPolicy(
    system_name: ?*UNICODE_STRING,
    object_attributes: ?*OBJECT_ATTRIBUTES,
    desired_access: u32,
    policy_handle: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

pub extern "advapi32" fn LsaSetCAPs(
    c_a_p_d_ns: ?[*]UNICODE_STRING,
    c_a_p_d_n_count: u32,
    flags: u32,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub extern "advapi32" fn LsaQueryInformationPolicy(
    policy_handle: ?*anyopaque,
    information_class: POLICY_INFORMATION_CLASS,
    buffer: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub extern "advapi32" fn LsaQueryDomainInformationPolicy(
    policy_handle: ?*anyopaque,
    information_class: POLICY_DOMAIN_INFORMATION_CLASS,
    buffer: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub extern "secur32" fn LsaRegisterPolicyChangeNotification(
    information_class: POLICY_NOTIFICATION_INFORMATION_CLASS,
    notification_event_handle: ?HANDLE,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub extern "advapi32" fn LsaLookupNames(
    ...
    count: u32,
    names: ?*UNICODE_STRING,
    referenced_domains: ?*?*LSA_REFERENCED_DOMAIN_LIST,
...
pub extern "advapi32" fn LsaOpenTrustedDomainByName(
    policy_handle: ?*anyopaque,
    trusted_domain_name: ?*UNICODE_STRING,
    desired_access: u32,
    trusted_domain_handle: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "advapi32" fn LsaQueryTrustedDomainInfo(
    policy_handle: ?*anyopaque,
    trusted_domain_sid: ?PSID,
    information_class: TRUSTED_INFORMATION_CLASS,
    buffer: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub extern "advapi32" fn LsaCreateTrustedDomainEx(
    policy_handle: ?*anyopaque,
    trusted_domain_information: ?*TRUSTED_DOMAIN_INFORMATION_EX,
    authentication_information: ?*TRUSTED_DOMAIN_AUTH_INFORMATION,
    desired_access: u32,
    trusted_domain_handle: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub extern "advapi32" fn LsaSetForestTrustInformation(
    ...
    forest_trust_info: ?*LSA_FOREST_TRUST_INFORMATION,
    check_only: BOOLEAN,
    collision_info: ?*?*LSA_FOREST_TRUST_COLLISION_INFORMATION,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "advapi32" fn LsaStorePrivateData(
    policy_handle: ?*anyopaque,
    key_name: ?*UNICODE_STRING,
...
pub extern "advapi32" fn AuditSetSystemPolicy(
    p_audit_policy: [*]AUDIT_POLICY_INFORMATION,
    dw_policy_count: u32,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;
...
pub extern "advapi32" fn AuditQuerySystemPolicy(
    p_sub_category_guids: [*]const Guid,
    dw_policy_count: u32,
    pp_audit_policy: ?*?*AUDIT_POLICY_INFORMATION,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;
...
pub extern "advapi32" fn AuditEnumeratePerUserPolicy(
    pp_audit_sid_array: ?*?*POLICY_AUDIT_SID_ARRAY,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;
...
pub extern "advapi32" fn AuditEnumerateCategories(
    pp_audit_categories_array: ?*?*Guid,
    pdw_count_returned: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "advapi32" fn AuditEnumerateSubCategories(
    p_audit_category_guid: ?*const Guid,
    b_retrieve_all_sub_categories: BOOLEAN,
    pp_audit_sub_categories_array: ?*?*Guid,
    pdw_count_returned: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;
...
pub extern "secur32" fn AcquireCredentialsHandleW(
    psz_principal: ?PWSTR,
    psz_package: ?PWSTR,
    f_credential_use: SECPKG_CRED,
    pv_logon_id: ?*anyopaque,
    p_auth_data: ?*anyopaque,
    p_get_key_fn: ?SEC_GET_KEY_FN,
    pv_get_key_argument: ?*anyopaque,
    ph_credential: ?*SecHandle,
    pts_expiry: ?*LARGE_INTEGER,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "secur32" fn ChangeAccountPasswordW(
    psz_package_name: ?*u16,
    psz_domain_name: ?*u16,
    psz_account_name: ?*u16,
    psz_old_password: ?*u16,
    psz_new_password: ?*u16,
    b_impersonating: BOOLEAN,
    dw_reserved: u32,
    p_output: ?*SecBufferDesc,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "secur32" fn InitializeSecurityContextW(
    ph_credential: ?*SecHandle,
    ph_context: ?*SecHandle,
    psz_target_name: ?*u16,
    f_context_req: u32,
    reserved1: u32,
    target_data_rep: u32,
    p_input: ?*SecBufferDesc,
    reserved2: u32,
    ph_new_context: ?*SecHandle,
    p_output: ?*SecBufferDesc,
    pf_context_attr: ?*u32,
    pts_expiry: ?*LARGE_INTEGER,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "secur32" fn AcceptSecurityContext(
    ...
    ph_context: ?*SecHandle,
    p_input: ?*SecBufferDesc,
    f_context_req: ACCEPT_SECURITY_CONTEXT_CONTEXT_REQ,
    target_data_rep: u32,
    ph_new_context: ?*SecHandle,
    p_output: ?*SecBufferDesc,
    pf_context_attr: ?*u32,
...
pub extern "secur32" fn ExportSecurityContext(
    ph_context: ?*SecHandle,
    f_flags: EXPORT_SECURITY_CONTEXT_FLAGS,
    p_packed_context: ?*SecBuffer,
    p_token: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "credui" fn SspiPromptForCredentialsW(
    psz_target_name: ?[*:0]const u16,
    p_ui_info: ?*anyopaque,
    dw_auth_error: u32,
    psz_package: ?[*:0]const u16,
    p_input_auth_identity: ?*anyopaque,
    pp_auth_identity: ?*?*anyopaque,
    pf_save: ?*i32,
    dw_flags: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "credui" fn SspiPromptForCredentialsA(
    psz_target_name: ?[*:0]const u8,
    p_ui_info: ?*anyopaque,
    dw_auth_error: u32,
    psz_package: ?[*:0]const u8,
    p_input_auth_identity: ?*anyopaque,
    pp_auth_identity: ?*?*anyopaque,
    pf_save: ?*i32,
    dw_flags: u32,
...
pub extern "secur32" fn SspiPrepareForCredRead(
    ...
    psz_target_name: ?[*:0]const u16,
    p_credman_credential_type: ?*u32,
    ppsz_credman_target_name: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "secur32" fn SspiPrepareForCredWrite(
    ...
    p_credman_credential_type: ?*u32,
    ppsz_credman_target_name: ?*?PWSTR,
    ppsz_credman_user_name: ?*?PWSTR,
    pp_credential_blob: ?*?*u8,
    p_credential_blob_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "secur32" fn SspiEncodeAuthIdentityAsStrings(
    ...
    ppsz_user_name: ?*?PWSTR,
    ppsz_domain_name: ?*?PWSTR,
    ppsz_packed_credentials_string: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "secur32" fn SspiLocalFree(
    data_buffer: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) void;

// TODO: this type is limited to platform 'windows6.1'
pub extern "secur32" fn SspiEncodeStringsAsAuthIdentity(
    psz_user_name: ?[*:0]const u16,
    psz_domain_name: ?[*:0]const u16,
    psz_packed_credentials_string: ?[*:0]const u16,
    pp_auth_identity: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows6.1'
pub extern "secur32" fn SspiCompareAuthIdentities(
    auth_identity1: ?*anyopaque,
    auth_identity2: ?*anyopaque,
    same_supplied_user: ?*BOOLEAN,
    same_supplied_identity: ?*BOOLEAN,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows6.1'
pub extern "secur32" fn SspiMarshalAuthIdentity(
    auth_identity: ?*anyopaque,
    auth_identity_length: ?*u32,
    auth_identity_byte_array: ?*?*i8,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "secur32" fn SspiUnmarshalAuthIdentity(
    auth_identity_length: u32,
    // TODO: what to do with BytesParamIndex 0?
    auth_identity_byte_array: ?PSTR,
    pp_auth_identity: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows6.1'
pub extern "credui" fn SspiIsPromptingNeeded(
    error_or_nt_status: u32,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;
...
pub extern "secur32" fn SspiExcludePackage(
    auth_identity: ?*anyopaque,
    psz_package_name: ?[*:0]const u16,
    pp_new_auth_identity: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows6.1'
pub extern "secur32" fn AddSecurityPackageA(
    psz_package_name: ?PSTR,
    p_options: ?*SECURITY_PACKAGE_OPTIONS,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "secur32" fn CredMarshalTargetInfo(
    in_target_info: ?*CREDENTIAL_TARGET_INFORMATIONW,
    buffer: ?*?*u16,
    buffer_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub extern "secur32" fn CredUnmarshalTargetInfo(
    ...
    buffer: ?*u16,
    buffer_size: u32,
    ret_target_info: ?*?*CREDENTIAL_TARGET_INFORMATIONW,
    ret_actual_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub extern "tokenbinding" fn TokenBindingGenerateBinding(
    ...
    target_u_r_l: ?[*:0]const u16,
    binding_type: TOKENBINDING_TYPE,
    // TODO: what to do with BytesParamIndex 4?
    tls_e_k_m: ?*const anyopaque,
    tls_e_k_m_size: u32,
    extension_format: TOKENBINDING_EXTENSION_FORMAT,
    extension_data: ?*const anyopaque,
    token_binding: ?*?*anyopaque,
    token_binding_size: ?*u32,
    result_data: ?*?*TOKENBINDING_RESULT_DATA,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows10.0.10240'
pub extern "tokenbinding" fn TokenBindingGenerateMessage(
    token_bindings: [*]const ?*const anyopaque,
    token_bindings_size: [*]const u32,
    token_bindings_count: u32,
    token_binding_message: ?*?*anyopaque,
    token_binding_message_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows10.0.10240'
pub extern "tokenbinding" fn TokenBindingVerifyMessage(
    // TODO: what to do with BytesParamIndex 1?
    token_binding_message: ?*const anyopaque,
    token_binding_message_size: u32,
    key_type: TOKENBINDING_KEY_PARAMETERS_TYPE,
    // TODO: what to do with BytesParamIndex 4?
    tls_e_k_m: ?*const anyopaque,
    tls_e_k_m_size: u32,
    result_list: ?*?*TOKENBINDING_RESULT_LIST,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows10.0.10240'
pub extern "tokenbinding" fn TokenBindingGetKeyTypesClient(
    key_types: ?*?*TOKENBINDING_KEY_TYPES,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
// TODO: this type is limited to platform 'windows10.0.10240'
pub extern "tokenbinding" fn TokenBindingDeleteAllBindings() callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows10.0.10240'
pub extern "tokenbinding" fn TokenBindingGenerateID(
    key_type: TOKENBINDING_KEY_PARAMETERS_TYPE,
    // TODO: what to do with BytesParamIndex 2?
    public_key: ?*const anyopaque,
    public_key_size: u32,
    result_data: ?*?*TOKENBINDING_RESULT_DATA,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "secur32" fn GetUserNameExA(
    name_format: EXTENDED_NAME_FORMAT,
    lp_name_buffer: ?[*:0]u8,
    n_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;
...
pub extern "secur32" fn TranslateNameA(
    ...
    account_name_format: EXTENDED_NAME_FORMAT,
    desired_name_format: EXTENDED_NAME_FORMAT,
    lp_translated_name: ?[*:0]u8,
    n_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;
...
pub extern "slc" fn SLInstallProofOfPurchase(
    h_s_l_c: ?*anyopaque,
    pwsz_p_key_algorithm: ?[*:0]const u16,
    pwsz_p_key_string: ?[*:0]const u16,
    cb_p_key_specific_data: u32,
    // TODO: what to do with BytesParamIndex 3?
    pb_p_key_specific_data: ?*u8,
    p_pkey_id: ?*Guid,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "slc" fn SLInstallLicense(
    ...
    cb_license_blob: u32,
    // TODO: what to do with BytesParamIndex 1?
    pb_license_blob: ?*const u8,
    p_license_file_id: ?*Guid,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.0'
pub extern "slc" fn SLUninstallLicense(
    h_s_l_c: ?*anyopaque,
    p_license_file_id: ?*const Guid,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "slc" fn SLConsumeRight(
    h_s_l_c: ?*anyopaque,
    p_app_id: ?*const Guid,
    p_product_sku_id: ?*const Guid,
    pwsz_right_name: ?[*:0]const u16,
...
pub extern "slc" fn SLGetLicensingStatusInformation(
    h_s_l_c: ?*anyopaque,
    p_app_i_d: ?*const Guid,
    p_product_sku_id: ?*const Guid,
    pwsz_right_name: ?[*:0]const u16,
    pn_status_count: ?*u32,
    pp_licensing_status: ?*?*SL_LICENSING_STATUS,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "slcext" fn SLActivateProduct(
    h_s_l_c: ?*anyopaque,
    p_product_sku_id: ?*const Guid,
    cb_app_specific_data: u32,
    pv_app_specific_data: ?*const anyopaque,
    p_activation_info: ?*const SL_ACTIVATION_INFO_HEADER,
    pwsz_proxy_server: ?[*:0]const u16,
    w_proxy_port: u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.0'
pub extern "slcext" fn SLGetServerStatus(
    pwsz_server_u_r_l: ?[*:0]const u16,
    pwsz_acquisition_type: ?[*:0]const u16,
    pwsz_proxy_server: ?[*:0]const u16,
    w_proxy_port: u16,
    phr_status: ?*HRESULT,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "slc" fn SLDepositOfflineConfirmationId(
    h_s_l_c: ?*anyopaque,
    p_product_sku_id: ?*const Guid,
    pwsz_installation_id: ?[*:0]const u16,
    pwsz_confirmation_id: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "slc" fn SLGetPKeyId(
    ...
    cb_p_key_specific_data: u32,
    // TODO: what to do with BytesParamIndex 3?
    pb_p_key_specific_data: ?*const u8,
    p_p_key_id: ?*Guid,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "slc" fn SLGetInstalledProductKeyIds(
    h_s_l_c: ?*anyopaque,
    p_product_sku_id: ?*const Guid,
    pn_product_key_ids: ?*u32,
    pp_product_key_ids: ?*?*Guid,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "slc" fn SLSetCurrentProductKey(
    h_s_l_c: ?*anyopaque,
    p_product_sku_id: ?*const Guid,
    p_product_key_id: ?*const Guid,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows8.0'
pub extern "slc" fn SLGetSLIDList(
    h_s_l_c: ?*anyopaque,
    e_query_id_type: SLIDTYPE,
    p_query_id: ?*const Guid,
    e_return_id_type: SLIDTYPE,
    pn_return_ids: ?*u32,
    pp_return_ids: ?*?*Guid,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "slwga" fn SLIsGenuineLocal(
    p_app_id: ?*const Guid,
    p_genuine_state: ?*SL_GENUINE_STATE,
    p_u_i_options: ?*SL_NONGENUINE_UI_OPTIONS,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "slcext" fn SLAcquireGenuineTicket(
    pp_ticket_blob: ?*?*anyopaque,
    pcb_ticket_blob: ?*u32,
    pwsz_template_id: ?[*:0]const u16,
    pwsz_server_url: ?[*:0]const u16,
    pwsz_client_token: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "slcext" fn SLGetReferralInformation(
    h_s_l_c: ?*anyopaque,
    e_referral_type: SLREFERRALTYPE,
    p_sku_or_app_id: ?*const Guid,
    pwsz_value_name: ?[*:0]const u16,
    ppwsz_value: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
