...
pub const PFNDPAMERGECONST = *const fn (
    u_msg: DPAMM_MESSAGE,
    pv_dest: ?*const anyopaque,
    pv_src: ?*const anyopaque,
    l_param: LPARAM,
) callconv(@import("std").os.windows.WINAPI) ?*anyopaque;
...
pub const IImageList = extern struct {
    pub const VTable = extern struct {
        ...
        GetItemFlags: *const fn (
            self: *const IImageList,
            i: i32,
            dw_flags: ?*IMAGE_LIST_ITEM_FLAGS,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn add(self: *const T, hbm_image_: ?HBITMAP, hbm_mask_: ?HBITMAP, pi_: ?*i32) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).Add(@as(*const IImageList, @ptrCast(self)), hbm_image_, hbm_mask_, pi_);
            }
            pub inline fn replaceIcon(self: *const T, i_: i32, hicon_: ?HICON, pi_: ?*i32) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).ReplaceIcon(@as(*const IImageList, @ptrCast(self)), i_, hicon_, pi_);
            }
            pub inline fn setOverlayImage(self: *const T, i_image_: i32, i_overlay_: i32) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).SetOverlayImage(@as(*const IImageList, @ptrCast(self)), i_image_, i_overlay_);
            }
            pub inline fn replace(self: *const T, i_: i32, hbm_image_: ?HBITMAP, hbm_mask_: ?HBITMAP) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).Replace(@as(*const IImageList, @ptrCast(self)), i_, hbm_image_, hbm_mask_);
            }
            pub inline fn addMasked(self: *const T, hbm_image_: ?HBITMAP, cr_mask_: u32, pi_: ?*i32) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).AddMasked(@as(*const IImageList, @ptrCast(self)), hbm_image_, cr_mask_, pi_);
            }
            pub inline fn draw(self: *const T, pimldp_: ?*IMAGELISTDRAWPARAMS) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).Draw(@as(*const IImageList, @ptrCast(self)), pimldp_);
            }
            pub inline fn remove(self: *const T, i_: i32) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).Remove(@as(*const IImageList, @ptrCast(self)), i_);
            }
            pub inline fn getIcon(self: *const T, i_: i32, flags_: u32, picon_: ?*?HICON) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).GetIcon(@as(*const IImageList, @ptrCast(self)), i_, flags_, picon_);
            }
            pub inline fn getImageInfo(self: *const T, i_: i32, p_image_info_: ?*IMAGEINFO) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).GetImageInfo(@as(*const IImageList, @ptrCast(self)), i_, p_image_info_);
            }
            pub inline fn copy(self: *const T, i_dst_: i32, punk_src_: ?*IUnknown, i_src_: i32, u_flags_: u32) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).Copy(@as(*const IImageList, @ptrCast(self)), i_dst_, punk_src_, i_src_, u_flags_);
            }
            pub inline fn merge(self: *const T, i1_: i32, punk2_: ?*IUnknown, i2_: i32, dx_: i32, dy_: i32, riid_: ?*const Guid, ppv_: ?*?*anyopaque) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).Merge(@as(*const IImageList, @ptrCast(self)), i1_, punk2_, i2_, dx_, dy_, riid_, ppv_);
            }
            pub inline fn clone(self: *const T, riid_: ?*const Guid, ppv_: ?*?*anyopaque) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).Clone(@as(*const IImageList, @ptrCast(self)), riid_, ppv_);
            }
            pub inline fn getImageRect(self: *const T, i_: i32, prc_: ?*RECT) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).GetImageRect(@as(*const IImageList, @ptrCast(self)), i_, prc_);
            }
            pub inline fn getIconSize(self: *const T, cx_: ?*i32, cy_: ?*i32) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).GetIconSize(@as(*const IImageList, @ptrCast(self)), cx_, cy_);
            }
            pub inline fn setIconSize(self: *const T, cx_: i32, cy_: i32) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).SetIconSize(@as(*const IImageList, @ptrCast(self)), cx_, cy_);
            }
            pub inline fn getImageCount(self: *const T, pi_: ?*i32) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).GetImageCount(@as(*const IImageList, @ptrCast(self)), pi_);
            }
            pub inline fn setImageCount(self: *const T, u_new_count_: u32) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).SetImageCount(@as(*const IImageList, @ptrCast(self)), u_new_count_);
            }
            pub inline fn setBkColor(self: *const T, clr_bk_: u32, pclr_: ?*u32) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).SetBkColor(@as(*const IImageList, @ptrCast(self)), clr_bk_, pclr_);
            }
            pub inline fn getBkColor(self: *const T, pclr_: ?*u32) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).GetBkColor(@as(*const IImageList, @ptrCast(self)), pclr_);
            }
            pub inline fn beginDrag(self: *const T, i_track_: i32, dx_hotspot_: i32, dy_hotspot_: i32) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).BeginDrag(@as(*const IImageList, @ptrCast(self)), i_track_, dx_hotspot_, dy_hotspot_);
            }
            pub inline fn endDrag(self: *const T) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).EndDrag(@as(*const IImageList, @ptrCast(self)));
            }
            pub inline fn dragEnter(self: *const T, hwnd_lock_: ?HWND, x_: i32, y_: i32) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).DragEnter(@as(*const IImageList, @ptrCast(self)), hwnd_lock_, x_, y_);
            }
            pub inline fn dragLeave(self: *const T, hwnd_lock_: ?HWND) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).DragLeave(@as(*const IImageList, @ptrCast(self)), hwnd_lock_);
            }
            pub inline fn dragMove(self: *const T, x_: i32, y_: i32) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).DragMove(@as(*const IImageList, @ptrCast(self)), x_, y_);
            }
            pub inline fn setDragCursorImage(self: *const T, punk_: ?*IUnknown, i_drag_: i32, dx_hotspot_: i32, dy_hotspot_: i32) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).SetDragCursorImage(@as(*const IImageList, @ptrCast(self)), punk_, i_drag_, dx_hotspot_, dy_hotspot_);
            }
            pub inline fn dragShowNolock(self: *const T, f_show_: BOOL) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).DragShowNolock(@as(*const IImageList, @ptrCast(self)), f_show_);
            }
            pub inline fn getDragImage(self: *const T, ppt_: ?*POINT, ppt_hotspot_: ?*POINT, riid_: ?*const Guid, ppv_: ?*?*anyopaque) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).GetDragImage(@as(*const IImageList, @ptrCast(self)), ppt_, ppt_hotspot_, riid_, ppv_);
            }
            pub inline fn getItemFlags(self: *const T, i_: i32, dw_flags_: ?*IMAGE_LIST_ITEM_FLAGS) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).GetItemFlags(@as(*const IImageList, @ptrCast(self)), i_, dw_flags_);
            }
            pub inline fn getOverlayImage(self: *const T, i_overlay_: i32, pi_index_: ?*i32) HRESULT {
                return @as(*const IImageList.VTable, @ptrCast(self.vtable)).GetOverlayImage(@as(*const IImageList, @ptrCast(self)), i_overlay_, pi_index_);
            }
        };
    }
...
pub const IImageList2 = extern struct {
    pub const VTable = extern struct {
        ...
        Resize: *const fn (
            ...
            cx_new_icon_size: i32,
            cy_new_icon_size: i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn resize(self: *const T, cx_new_icon_size_: i32, cy_new_icon_size_: i32) HRESULT {
                return @as(*const IImageList2.VTable, @ptrCast(self.vtable)).Resize(@as(*const IImageList2, @ptrCast(self)), cx_new_icon_size_, cy_new_icon_size_);
            }
            pub inline fn getOriginalSize(self: *const T, i_image_: i32, dw_flags_: u32, pcx_: ?*i32, pcy_: ?*i32) HRESULT {
                return @as(*const IImageList2.VTable, @ptrCast(self.vtable)).GetOriginalSize(@as(*const IImageList2, @ptrCast(self)), i_image_, dw_flags_, pcx_, pcy_);
            }
            pub inline fn setOriginalSize(self: *const T, i_image_: i32, cx_: i32, cy_: i32) HRESULT {
                return @as(*const IImageList2.VTable, @ptrCast(self.vtable)).SetOriginalSize(@as(*const IImageList2, @ptrCast(self)), i_image_, cx_, cy_);
            }
            pub inline fn setCallback(self: *const T, punk_: ?*IUnknown) HRESULT {
                return @as(*const IImageList2.VTable, @ptrCast(self.vtable)).SetCallback(@as(*const IImageList2, @ptrCast(self)), punk_);
            }
            pub inline fn getCallback(self: *const T, riid_: ?*const Guid, ppv_: ?*?*anyopaque) HRESULT {
                return @as(*const IImageList2.VTable, @ptrCast(self.vtable)).GetCallback(@as(*const IImageList2, @ptrCast(self)), riid_, ppv_);
            }
            pub inline fn forceImagePresent(self: *const T, i_image_: i32, dw_flags_: u32) HRESULT {
                return @as(*const IImageList2.VTable, @ptrCast(self.vtable)).ForceImagePresent(@as(*const IImageList2, @ptrCast(self)), i_image_, dw_flags_);
            }
            pub inline fn discardImages(self: *const T, i_first_image_: i32, i_last_image_: i32, dw_flags_: u32) HRESULT {
                return @as(*const IImageList2.VTable, @ptrCast(self.vtable)).DiscardImages(@as(*const IImageList2, @ptrCast(self)), i_first_image_, i_last_image_, dw_flags_);
            }
            pub inline fn preloadImages(self: *const T, pimldp_: ?*IMAGELISTDRAWPARAMS) HRESULT {
                return @as(*const IImageList2.VTable, @ptrCast(self.vtable)).PreloadImages(@as(*const IImageList2, @ptrCast(self)), pimldp_);
            }
            pub inline fn getStatistics(self: *const T, pils_: ?*IMAGELISTSTATS) HRESULT {
                return @as(*const IImageList2.VTable, @ptrCast(self.vtable)).GetStatistics(@as(*const IImageList2, @ptrCast(self)), pils_);
            }
            pub inline fn initialize(self: *const T, cx_: i32, cy_: i32, flags_: IMAGELIST_CREATION_FLAGS, c_initial_: i32, c_grow_: i32) HRESULT {
                return @as(*const IImageList2.VTable, @ptrCast(self.vtable)).Initialize(@as(*const IImageList2, @ptrCast(self)), cx_, cy_, flags_, c_initial_, c_grow_);
            }
            pub inline fn replace2(self: *const T, i_: i32, hbm_image_: ?HBITMAP, hbm_mask_: ?HBITMAP, punk_: ?*IUnknown, dw_flags_: u32) HRESULT {
                return @as(*const IImageList2.VTable, @ptrCast(self.vtable)).Replace2(@as(*const IImageList2, @ptrCast(self)), i_, hbm_image_, hbm_mask_, punk_, dw_flags_);
            }
            pub inline fn replaceFromImageList(self: *const T, i_: i32, pil_: ?*IImageList, i_src_: i32, punk_: ?*IUnknown, dw_flags_: u32) HRESULT {
                return @as(*const IImageList2.VTable, @ptrCast(self.vtable)).ReplaceFromImageList(@as(*const IImageList2, @ptrCast(self)), i_, pil_, i_src_, punk_, dw_flags_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub extern "comctl32" fn ImageList_Copy(
    ...
    himl_src: ?HIMAGELIST,
    i_src: i32,
    u_flags: IMAGE_LIST_COPY_FLAGS,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "comctl32" fn ImageList_BeginDrag(
    himl_track: ?HIMAGELIST,
    i_track: i32,
    dx_hotspot: i32,
    dy_hotspot: i32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "comctl32" fn TaskDialogIndirect(
    ...
    pn_button: ?*i32,
    pn_radio_button: ?*i32,
    pf_verification_flag_checked: ?*BOOL,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "comctl32" fn TaskDialog(
    hwnd_owner: ?HWND,
    h_instance: ?HINSTANCE,
    psz_window_title: ?[*:0]const u16,
    psz_main_instruction: ?[*:0]const u16,
    psz_content: ?[*:0]const u16,
...
pub extern "uxtheme" fn UpdatePanningFeedback(
    hwnd: ?HWND,
    l_total_overpan_offset_x: i32,
    l_total_overpan_offset_y: i32,
    f_in_inertia: BOOL,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "uxtheme" fn GetThemeTimingFunction(
    h_theme: isize,
    i_timing_function_id: i32,
    // TODO: what to do with BytesParamIndex 3?
    p_timing_function: ?*TA_TIMINGFUNCTION,
    cb_size: u32,
    pcb_size_out: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "uxtheme" fn OpenThemeDataEx(
    hwnd: ?HWND,
    psz_class_list: ?[*:0]const u16,
    dw_flags: OPEN_THEME_DATA_FLAGS,
) callconv(@import("std").os.windows.WINAPI) isize;
...
pub extern "uxtheme" fn GetThemeMetric(
    ...
    i_part_id: i32,
    i_state_id: i32,
    i_prop_id: THEME_PROPERTY_SYMBOL_ID,
    pi_val: ?*i32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "uxtheme" fn GetThemeSysColorBrush(
    h_theme: isize,
    i_color_id: THEME_PROPERTY_SYMBOL_ID,
...
pub extern "uxtheme" fn GetThemeSysFont(
    h_theme: isize,
    i_font_id: THEME_PROPERTY_SYMBOL_ID,
    plf: ?*LOGFONTW,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "uxtheme" fn GetThemeSysString(
    h_theme: isize,
    i_string_id: THEME_PROPERTY_SYMBOL_ID,
    psz_string_buff: [*:0]u16,
    cch_max_string_chars: i32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "uxtheme" fn GetCurrentThemeName(
    psz_theme_file_name: [*:0]u16,
    cch_max_name_chars: i32,
    psz_color_buff: ?[*:0]u16,
    cch_max_color_chars: i32,
    psz_size_buff: ?[*:0]u16,
    cch_max_size_chars: i32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "uxtheme" fn GetThemeDocumentationProperty(
    psz_theme_name: ?[*:0]const u16,
    psz_property_name: ?[*:0]const u16,
    psz_value_buff: [*:0]u16,
    cch_max_val_chars: i32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "uxtheme" fn DrawThemeParentBackgroundEx(
    hwnd: ?HWND,
    hdc: ?HDC,
    dw_flags: DRAW_THEME_PARENT_BACKGROUND_FLAGS,
    prc: ?*const RECT,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "uxtheme" fn SetWindowThemeAttribute(
    hwnd: ?HWND,
    e_attribute: WINDOWTHEMEATTRIBUTETYPE,
    // TODO: what to do with BytesParamIndex 3?
    pv_attribute: ?*anyopaque,
    cb_attribute: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "uxtheme" fn GetThemeBitmap(
    ...
    i_state_id: i32,
    i_prop_id: THEME_PROPERTY_SYMBOL_ID,
    dw_flags: GET_THEME_BITMAP_FLAGS,
    ph_bitmap: ?*?HBITMAP,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "uxtheme" fn BeginBufferedPaint(
    ...
    dw_format: BP_BUFFERFORMAT,
    p_paint_params: ?*BP_PAINTPARAMS,
    phdc: ?*?HDC,
) callconv(@import("std").os.windows.WINAPI) isize;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "uxtheme" fn EndBufferedPaint(
    h_buffered_paint: isize,
    f_update_target: BOOL,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "uxtheme" fn BeginBufferedAnimation(
    ...
    dw_format: BP_BUFFERFORMAT,
    p_paint_params: ?*BP_PAINTPARAMS,
    p_animation_params: ?*BP_ANIMATIONPARAMS,
    phdc_from: ?*?HDC,
    phdc_to: ?*?HDC,
) callconv(@import("std").os.windows.WINAPI) isize;
...
pub extern "user32" fn CheckDlgButton(
    h_dlg: ?HWND,
    n_i_d_button: i32,
    u_check: DLG_BUTTON_CHECK_STATE,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "user32" fn CheckRadioButton(
    h_dlg: ?HWND,
    n_i_d_first_button: i32,
    n_i_d_last_button: i32,
    n_i_d_check_button: i32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "user32" fn EvaluateProximityToRect(
    control_bounding_box: ?*const RECT,
    p_hit_testing_input: ?*const TOUCH_HIT_TESTING_INPUT,
    p_proximity_eval: ?*TOUCH_HIT_TESTING_PROXIMITY_EVALUATION,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows8.0'
pub extern "user32" fn EvaluateProximityToPolygon(
    num_vertices: u32,
    control_polygon: [*]const POINT,
    p_hit_testing_input: ?*const TOUCH_HIT_TESTING_INPUT,
    p_proximity_eval: ?*TOUCH_HIT_TESTING_PROXIMITY_EVALUATION,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "user32" fn PackTouchHitTestingProximityEvaluation(
    p_hit_testing_input: ?*const TOUCH_HIT_TESTING_INPUT,
    p_proximity_eval: ?*const TOUCH_HIT_TESTING_PROXIMITY_EVALUATION,
...
pub extern "user32" fn EnableScrollBar(
    h_wnd: ?HWND,
    w_s_bflags: SCROLLBAR_CONSTANTS,
    w_arrows: ENABLE_SCROLL_BAR_ARROWS,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "user32" fn DlgDirListA(
    ...
    lp_path_spec: ?PSTR,
    n_i_d_list_box: i32,
    n_i_d_static_path: i32,
    u_file_type: DLG_DIR_LIST_FILE_TYPE,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "user32" fn DlgDirListComboBoxA(
    ...
    n_i_d_combo_box: i32,
    n_i_d_static_path: i32,
    u_filetype: DLG_DIR_LIST_FILE_TYPE,
) callconv(@import("std").os.windows.WINAPI) i32;
