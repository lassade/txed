...
pub extern "user32" fn RegisterClassA(
    lp_wnd_class: ?*const WNDCLASSA,
) callconv(@import("std").os.windows.WINAPI) u16;

// TODO: this type is limited to platform 'windows5.0'
pub extern "user32" fn RegisterClassW(
    lp_wnd_class: ?*const WNDCLASSW,
) callconv(@import("std").os.windows.WINAPI) u16;

// TODO: this type is limited to platform 'windows5.0'
pub extern "user32" fn UnregisterClassA(
    lp_class_name: ?[*:0]const u8,
    h_instance: ?HINSTANCE,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "user32" fn UpdateLayeredWindowIndirect(
    h_wnd: ?HWND,
    p_u_l_w_info: ?*const UPDATELAYEREDWINDOWINFO,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "user32" fn GetLayeredWindowAttributes(
    ...
    pcr_key: ?*u32,
    pb_alpha: ?*u8,
    pdw_flags: ?*LAYERED_WINDOW_ATTRIBUTES_FLAGS,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "user32" fn CreateDialogParamA(
    h_instance: ?HINSTANCE,
    lp_template_name: ?[*:0]const u8,
    h_wnd_parent: ?HWND,
    lp_dialog_func: ?DLGPROC,
    dw_init_param: LPARAM,
) callconv(@import("std").os.windows.WINAPI) ?HWND;

// TODO: this type is limited to platform 'windows5.0'
pub extern "user32" fn CreateDialogParamW(
    h_instance: ?HINSTANCE,
    lp_template_name: ?[*:0]const u16,
    h_wnd_parent: ?HWND,
    lp_dialog_func: ?DLGPROC,
    dw_init_param: LPARAM,
) callconv(@import("std").os.windows.WINAPI) ?HWND;
...
pub extern "user32" fn CharPrevA(
    lpsz_start: ?[*:0]const u8,
    lpsz_current: ?[*:0]const u8,
) callconv(@import("std").os.windows.WINAPI) ?PSTR;

// TODO: this type is limited to platform 'windows5.0'
pub extern "user32" fn CharPrevW(
    lpsz_start: ?[*:0]const u16,
    lpsz_current: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) ?PWSTR;

// TODO: this type is limited to platform 'windows5.0'
pub extern "user32" fn CharNextExA(
    code_page: u16,
    lp_current_char: ?[*:0]const u8,
    dw_flags: u32,
) callconv(@import("std").os.windows.WINAPI) ?PSTR;
...
pub extern "user32" fn InsertMenuA(
    ...
    u_position: u32,
    u_flags: MENU_ITEM_FLAGS,
    u_i_d_new_item: usize,
    lp_new_item: ?[*:0]const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "user32" fn SetMenuItemBitmaps(
    ...
    u_position: u32,
    u_flags: MENU_ITEM_FLAGS,
    h_bitmap_unchecked: ?HBITMAP,
    h_bitmap_checked: ?HBITMAP,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "user32" fn CalculatePopupWindowPosition(
    anchor_point: ?*const POINT,
    window_size: ?*const SIZE,
    flags: u32,
    exclude_rect: ?*RECT,
    popup_window_position: ?*RECT,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "user32" fn GetSysColor(
    n_index: SYS_COLOR_INDEX,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows5.0'
pub extern "user32" fn SetSysColors(
    c_elements: i32,
    lpa_elements: [*]const i32,
    lpa_rgb_values: [*]const u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "user32" fn LoadCursorA(
    h_instance: ?HINSTANCE,
    lp_cursor_name: ?[*:0]const u8,
) callconv(@import("std").os.windows.WINAPI) ?HCURSOR;

// TODO: this type is limited to platform 'windows5.0'
pub extern "user32" fn LoadCursorW(
    h_instance: ?HINSTANCE,
    lp_cursor_name: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) ?HCURSOR;
...
pub extern "user32" fn CreateCursor(
    ...
    n_width: i32,
    n_height: i32,
    pv_a_n_d_plane: ?*const anyopaque,
    pv_x_o_r_plane: ?*const anyopaque,
) callconv(@import("std").os.windows.WINAPI) ?HCURSOR;
...
pub extern "user32" fn CreateIcon(
    ...
    c_planes: u8,
    c_bits_pixel: u8,
    lpb_a_n_dbits: [*:0]const u8,
    lpb_x_o_rbits: [*:0]const u8,
) callconv(@import("std").os.windows.WINAPI) ?HICON;
...
pub extern "user32" fn ChangeWindowMessageFilterEx(
    ...
    p_change_filter_struct: ?*CHANGEFILTERSTRUCT,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows10.0.10240'
pub extern "mrmsupport" fn CreateResourceIndexer(
    project_root: ?[*:0]const u16,
    extension_dll_path: ?[*:0]const u16,
    pp_resource_indexer: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows10.0.10240'
pub extern "mrmsupport" fn DestroyResourceIndexer(
    resource_indexer: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) void;
...
pub extern "mrmsupport" fn IndexFilePath(
    ...
    pp_resource_uri: ?*?PWSTR,
    p_qualifier_count: ?*u32,
    pp_qualifiers: [*]?*IndexedResourceQualifier,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "mrmsupport" fn MrmCreateResourceIndexer(
    ...
    project_root: ?[*:0]const u16,
    platform_version: MrmPlatformVersion,
    default_qualifiers: ?[*:0]const u16,
...
pub extern "mrmsupport" fn MrmIndexResourceContainerAutoQualifiers(
    indexer: MrmResourceIndexerHandle,
    container_path: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "mrmsupport" fn MrmCreateResourceFile(
    indexer: MrmResourceIndexerHandle,
    packaging_mode: MrmPackagingMode,
    packaging_options: MrmPackagingOptions,
    output_directory: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "mrmsupport" fn MrmDumpPriFile(
    index_file_name: ?[*:0]const u16,
    schema_pri_file: ?[*:0]const u16,
    dump_type: MrmDumpType,
    output_xml_file: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
