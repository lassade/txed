...
pub const INotificationActivationCallback = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn activate(self: *const T, app_user_model_id_: ?[*:0]const u16, invoked_args_: ?[*:0]const u16, data_: [*]const NOTIFICATION_USER_INPUT_DATA, count_: u32) HRESULT {
                return @as(*const INotificationActivationCallback.VTable, @ptrCast(self.vtable)).Activate(@as(*const INotificationActivationCallback, @ptrCast(self)), app_user_model_id_, invoked_args_, data_, count_);
            }
        };
    }
