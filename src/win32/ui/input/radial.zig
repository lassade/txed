...
pub const IRadialControllerInterop = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn createForWindow(self: *const T, hwnd_: ?HWND, riid_: ?*const Guid, ppv_: ?*?*anyopaque) HRESULT {
                return @as(*const IRadialControllerInterop.VTable, @ptrCast(self.vtable)).CreateForWindow(@as(*const IRadialControllerInterop, @ptrCast(self)), hwnd_, riid_, ppv_);
            }
        };
    }
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getForWindow(self: *const T, hwnd_: ?HWND, riid_: ?*const Guid, ppv_: ?*?*anyopaque) HRESULT {
                return @as(*const IRadialControllerConfigurationInterop.VTable, @ptrCast(self.vtable)).GetForWindow(@as(*const IRadialControllerConfigurationInterop, @ptrCast(self)), hwnd_, riid_, ppv_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IRadialControllerIndependentInputSourceInterop = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IInspectable.MethodMixin(T);
            pub inline fn createForWindow(self: *const T, hwnd_: ?HWND, riid_: ?*const Guid, ppv_: ?*?*anyopaque) HRESULT {
                return @as(*const IRadialControllerIndependentInputSourceInterop.VTable, @ptrCast(self.vtable)).CreateForWindow(@as(*const IRadialControllerIndependentInputSourceInterop, @ptrCast(self)), hwnd_, riid_, ppv_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
