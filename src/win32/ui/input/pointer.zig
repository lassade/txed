...
pub extern "user32" fn GetPointerDevices(
    device_count: ?*u32,
    pointer_devices: ?[*]POINTER_DEVICE_INFO,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows8.0'
pub extern "user32" fn GetPointerDevice(
    device: ?HANDLE,
    pointer_device: ?*POINTER_DEVICE_INFO,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "user32" fn GetPointerDeviceProperties(
    device: ?HANDLE,
    property_count: ?*u32,
    pointer_properties: ?[*]POINTER_DEVICE_PROPERTY,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "user32" fn GetPointerDeviceCursors(
    device: ?HANDLE,
    cursor_count: ?*u32,
    device_cursors: ?[*]POINTER_DEVICE_CURSOR_INFO,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "user32" fn GetRawPointerDeviceData(
    ...
    p_properties: [*]POINTER_DEVICE_PROPERTY,
    p_values: ?*i32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
