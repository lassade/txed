...
pub extern "xinputuap" fn XInputGetAudioDeviceIds(
    dw_user_index: u32,
    p_render_device_id: ?[*:0]u16,
    p_render_count: ?*u32,
    p_capture_device_id: ?[*:0]u16,
    p_capture_count: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "xinputuap" fn XInputGetBatteryInformation(
    dw_user_index: u32,
    dev_type: u8,
    p_battery_information: ?*XINPUT_BATTERY_INFORMATION,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "xinputuap" fn XInputGetKeystroke(
    dw_user_index: u32,
    dw_reserved: u32,
    p_keystroke: ?*XINPUT_KEYSTROKE,
) callconv(@import("std").os.windows.WINAPI) u32;
