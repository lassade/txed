...
pub const IObjectArray = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getCount(self: *const T, pc_objects_: ?*u32) HRESULT {
                return @as(*const IObjectArray.VTable, @ptrCast(self.vtable)).GetCount(@as(*const IObjectArray, @ptrCast(self)), pc_objects_);
            }
            pub inline fn getAt(self: *const T, ui_index_: u32, riid_: ?*const Guid, ppv_: ?*?*anyopaque) HRESULT {
                return @as(*const IObjectArray.VTable, @ptrCast(self.vtable)).GetAt(@as(*const IObjectArray, @ptrCast(self)), ui_index_, riid_, ppv_);
            }
        };
    }
...
pub const IObjectCollection = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn addObject(self: *const T, punk_: ?*IUnknown) HRESULT {
                return @as(*const IObjectCollection.VTable, @ptrCast(self.vtable)).AddObject(@as(*const IObjectCollection, @ptrCast(self)), punk_);
            }
            pub inline fn addFromArray(self: *const T, poa_source_: ?*IObjectArray) HRESULT {
                return @as(*const IObjectCollection.VTable, @ptrCast(self.vtable)).AddFromArray(@as(*const IObjectCollection, @ptrCast(self)), poa_source_);
            }
            pub inline fn removeObjectAt(self: *const T, ui_index_: u32) HRESULT {
                return @as(*const IObjectCollection.VTable, @ptrCast(self.vtable)).RemoveObjectAt(@as(*const IObjectCollection, @ptrCast(self)), ui_index_);
            }
