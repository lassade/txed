...
pub const VDMKILLWOWPROC = *const fn () callconv(@import("std").os.windows.WINAPI) BOOL;

pub const VDMDETECTWOWPROC = *const fn () callconv(@import("std").os.windows.WINAPI) BOOL;
