...
pub extern "powrprof" fn CallNtPowerInformation(
    information_level: POWER_INFORMATION_LEVEL,
...
pub extern "powrprof" fn ReadGlobalPwrPolicy(
    p_global_power_policy: ?*GLOBAL_POWER_POLICY,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "powrprof" fn ReadPwrScheme(
    ui_i_d: u32,
    p_power_policy: ?*POWER_POLICY,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "powrprof" fn WritePwrScheme(
    pui_i_d: ?*u32,
    lpsz_scheme_name: ?[*:0]const u16,
    lpsz_description: ?[*:0]const u16,
    lp_scheme: ?*POWER_POLICY,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;
...
pub extern "powrprof" fn SetSuspendState(
    b_hibernate: BOOLEAN,
    b_force: BOOLEAN,
    b_wakeup_events_disabled: BOOLEAN,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;
...
pub extern "powrprof" fn ReadProcessorPwrScheme(
    ui_i_d: u32,
    p_machine_processor_power_policy: ?*MACHINE_PROCESSOR_POWER_POLICY,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;
...
pub extern "powrprof" fn PowerSettingAccessCheckEx(
    ...
    power_guid: ?*const Guid,
    access_type: REG_SAM_FLAGS,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "powrprof" fn PowerReadACDefaultIndex(
    root_power_key: ?HKEY,
    scheme_personality_guid: ?*const Guid,
    sub_group_of_power_settings_guid: ?*const Guid,
    power_setting_guid: ?*const Guid,
    ac_default_index: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "powrprof" fn PowerWriteACDefaultIndex(
    root_system_power_key: ?HKEY,
    scheme_personality_guid: ?*const Guid,
    sub_group_of_power_settings_guid: ?*const Guid,
    power_setting_guid: ?*const Guid,
    default_ac_index: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "powrprof" fn PowerDuplicateScheme(
    root_power_key: ?HKEY,
    source_scheme_guid: ?*const Guid,
    destination_scheme_guid: ?*?*Guid,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "powrprof" fn PowerImportPowerScheme(
    root_power_key: ?HKEY,
    import_file_name_path: ?[*:0]const u16,
    destination_scheme_guid: ?*?*Guid,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "powrprof" fn PowerRemovePowerSetting(
    power_setting_sub_key_guid: ?*const Guid,
    power_setting_guid: ?*const Guid,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "powrprof" fn PowerOpenUserPowerKey(
    ph_user_power_key: ?*?HKEY,
    access: u32,
    open_existing: BOOL,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "powrprof" fn PowerOpenSystemPowerKey(
    ph_system_power_key: ?*?HKEY,
    access: u32,
    open_existing: BOOL,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "kernel32" fn GetSystemPowerStatus(
    lp_system_power_status: ?*SYSTEM_POWER_STATUS,
) callconv(@import("std").os.windows.WINAPI) BOOL;
