...
pub const ITraceEvent = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn clone(self: *const T, new_event_: ?*?*ITraceEvent) HRESULT {
                return @as(*const ITraceEvent.VTable, @ptrCast(self.vtable)).Clone(@as(*const ITraceEvent, @ptrCast(self)), new_event_);
            }
            pub inline fn getUserContext(self: *const T, user_context_: ?*?*anyopaque) HRESULT {
                return @as(*const ITraceEvent.VTable, @ptrCast(self.vtable)).GetUserContext(@as(*const ITraceEvent, @ptrCast(self)), user_context_);
            }
            pub inline fn getEventRecord(self: *const T, event_record_: ?*?*EVENT_RECORD) HRESULT {
                return @as(*const ITraceEvent.VTable, @ptrCast(self.vtable)).GetEventRecord(@as(*const ITraceEvent, @ptrCast(self)), event_record_);
            }
            pub inline fn setPayload(self: *const T, payload_: [*:0]u8, payload_size_: u32) HRESULT {
                return @as(*const ITraceEvent.VTable, @ptrCast(self.vtable)).SetPayload(@as(*const ITraceEvent, @ptrCast(self)), payload_, payload_size_);
            }
            pub inline fn setEventDescriptor(self: *const T, event_descriptor_: ?*const EVENT_DESCRIPTOR) HRESULT {
                return @as(*const ITraceEvent.VTable, @ptrCast(self.vtable)).SetEventDescriptor(@as(*const ITraceEvent, @ptrCast(self)), event_descriptor_);
            }
            pub inline fn setProcessId(self: *const T, process_id_: u32) HRESULT {
                return @as(*const ITraceEvent.VTable, @ptrCast(self.vtable)).SetProcessId(@as(*const ITraceEvent, @ptrCast(self)), process_id_);
            }
            pub inline fn setProcessorIndex(self: *const T, processor_index_: u32) HRESULT {
                return @as(*const ITraceEvent.VTable, @ptrCast(self.vtable)).SetProcessorIndex(@as(*const ITraceEvent, @ptrCast(self)), processor_index_);
            }
            pub inline fn setThreadId(self: *const T, thread_id_: u32) HRESULT {
                return @as(*const ITraceEvent.VTable, @ptrCast(self.vtable)).SetThreadId(@as(*const ITraceEvent, @ptrCast(self)), thread_id_);
            }
            pub inline fn setThreadTimes(self: *const T, kernel_time_: u32, user_time_: u32) HRESULT {
                return @as(*const ITraceEvent.VTable, @ptrCast(self.vtable)).SetThreadTimes(@as(*const ITraceEvent, @ptrCast(self)), kernel_time_, user_time_);
            }
            pub inline fn setActivityId(self: *const T, activity_id_: ?*const Guid) HRESULT {
                return @as(*const ITraceEvent.VTable, @ptrCast(self.vtable)).SetActivityId(@as(*const ITraceEvent, @ptrCast(self)), activity_id_);
            }
            pub inline fn setTimeStamp(self: *const T, time_stamp_: ?*LARGE_INTEGER) HRESULT {
                return @as(*const ITraceEvent.VTable, @ptrCast(self.vtable)).SetTimeStamp(@as(*const ITraceEvent, @ptrCast(self)), time_stamp_);
            }
            pub inline fn setProviderId(self: *const T, provider_id_: ?*const Guid) HRESULT {
                return @as(*const ITraceEvent.VTable, @ptrCast(self.vtable)).SetProviderId(@as(*const ITraceEvent, @ptrCast(self)), provider_id_);
            }
        };
    }
...
pub const ITraceEventCallback = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn onBeginProcessTrace(self: *const T, header_event_: ?*ITraceEvent, relogger_: ?*ITraceRelogger) HRESULT {
                return @as(*const ITraceEventCallback.VTable, @ptrCast(self.vtable)).OnBeginProcessTrace(@as(*const ITraceEventCallback, @ptrCast(self)), header_event_, relogger_);
            }
            pub inline fn onFinalizeProcessTrace(self: *const T, relogger_: ?*ITraceRelogger) HRESULT {
                return @as(*const ITraceEventCallback.VTable, @ptrCast(self.vtable)).OnFinalizeProcessTrace(@as(*const ITraceEventCallback, @ptrCast(self)), relogger_);
            }
            pub inline fn onEvent(self: *const T, event_: ?*ITraceEvent, relogger_: ?*ITraceRelogger) HRESULT {
                return @as(*const ITraceEventCallback.VTable, @ptrCast(self.vtable)).OnEvent(@as(*const ITraceEventCallback, @ptrCast(self)), event_, relogger_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ITraceRelogger = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn addLogfileTraceStream(self: *const T, logfile_name_: ?BSTR, user_context_: ?*anyopaque, trace_handle_: ?*u64) HRESULT {
                return @as(*const ITraceRelogger.VTable, @ptrCast(self.vtable)).AddLogfileTraceStream(@as(*const ITraceRelogger, @ptrCast(self)), logfile_name_, user_context_, trace_handle_);
            }
            pub inline fn addRealtimeTraceStream(self: *const T, logger_name_: ?BSTR, user_context_: ?*anyopaque, trace_handle_: ?*u64) HRESULT {
                return @as(*const ITraceRelogger.VTable, @ptrCast(self.vtable)).AddRealtimeTraceStream(@as(*const ITraceRelogger, @ptrCast(self)), logger_name_, user_context_, trace_handle_);
            }
            pub inline fn registerCallback(self: *const T, callback_: ?*ITraceEventCallback) HRESULT {
                return @as(*const ITraceRelogger.VTable, @ptrCast(self.vtable)).RegisterCallback(@as(*const ITraceRelogger, @ptrCast(self)), callback_);
            }
            pub inline fn inject(self: *const T, event_: ?*ITraceEvent) HRESULT {
                return @as(*const ITraceRelogger.VTable, @ptrCast(self.vtable)).Inject(@as(*const ITraceRelogger, @ptrCast(self)), event_);
            }
            pub inline fn createEventInstance(self: *const T, trace_handle_: u64, flags_: u32, event_: ?*?*ITraceEvent) HRESULT {
                return @as(*const ITraceRelogger.VTable, @ptrCast(self.vtable)).CreateEventInstance(@as(*const ITraceRelogger, @ptrCast(self)), trace_handle_, flags_, event_);
            }
            pub inline fn processTrace(self: *const T) HRESULT {
                return @as(*const ITraceRelogger.VTable, @ptrCast(self.vtable)).ProcessTrace(@as(*const ITraceRelogger, @ptrCast(self)));
            }
            pub inline fn setOutputFilename(self: *const T, logfile_name_: ?BSTR) HRESULT {
                return @as(*const ITraceRelogger.VTable, @ptrCast(self.vtable)).SetOutputFilename(@as(*const ITraceRelogger, @ptrCast(self)), logfile_name_);
            }
            pub inline fn setCompressionMode(self: *const T, compression_mode_: BOOLEAN) HRESULT {
                return @as(*const ITraceRelogger.VTable, @ptrCast(self.vtable)).SetCompressionMode(@as(*const ITraceRelogger, @ptrCast(self)), compression_mode_);
            }
...
pub extern "advapi32" fn QueryAllTracesW(
    property_array: [*]?*EVENT_TRACE_PROPERTIES,
    property_array_count: u32,
    logger_count: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "advapi32" fn EnableTraceEx2(
    ...
    match_all_keyword: u64,
    timeout: u32,
    enable_parameters: ?*ENABLE_TRACE_PARAMETERS,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "advapi32" fn TraceSetInformation(
    session_handle: u64,
    information_class: TRACE_QUERY_INFO_CLASS,
    // TODO: what to do with BytesParamIndex 3?
    trace_information: ?*anyopaque,
...
pub extern "advapi32" fn CreateTraceInstanceId(
    reg_handle: ?HANDLE,
    inst_info: ?*EVENT_INSTANCE_INFO,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows5.0'
pub extern "advapi32" fn TraceEvent(
    trace_handle: u64,
    event_trace: ?*EVENT_TRACE_HEADER,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows5.0'
pub extern "advapi32" fn TraceEventInstance(
    trace_handle: u64,
    event_trace: ?*EVENT_INSTANCE_HEADER,
    inst_info: ?*EVENT_INSTANCE_INFO,
    parent_inst_info: ?*EVENT_INSTANCE_INFO,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "advapi32" fn RegisterTraceGuidsW(
    ...
    control_guid: ?*const Guid,
    guid_count: u32,
    trace_guid_reg: ?[*]TRACE_GUID_REGISTRATION,
    mof_image_path: ?[*:0]const u16,
    mof_resource_name: ?[*:0]const u16,
...
pub extern "advapi32" fn RegisterTraceGuidsA(
    ...
    guid_count: u32,
    trace_guid_reg: ?[*]TRACE_GUID_REGISTRATION,
    mof_image_path: ?[*:0]const u8,
    mof_resource_name: ?[*:0]const u8,
    registration_handle: ?*u64,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "advapi32" fn EnumerateTraceGuids(
    guid_properties_array: [*]?*TRACE_GUID_PROPERTIES,
    property_array_count: u32,
    guid_count: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "advapi32" fn QueryTraceProcessingHandle(
    processing_handle: u64,
    information_class: ETW_PROCESS_HANDLE_INFO_TYPE,
    in_buffer: ?*anyopaque,
    in_buffer_size: u32,
    out_buffer: ?*anyopaque,
    out_buffer_size: u32,
...
pub extern "advapi32" fn TraceMessage(
    logger_handle: u64,
    message_flags: TRACE_MESSAGE_FLAGS,
    message_guid: ?*const Guid,
    message_number: u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "advapi32" fn EventRegister(
    provider_id: ?*const Guid,
    enable_callback: ?PENABLECALLBACK,
    callback_context: ?*anyopaque,
    reg_handle: ?*u64,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "advapi32" fn EventSetInformation(
    reg_handle: u64,
    information_class: EVENT_INFO_CLASS,
    // TODO: what to do with BytesParamIndex 3?
    event_information: ?*anyopaque,
    information_length: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "advapi32" fn EventWrite(
    ...
    event_descriptor: ?*const EVENT_DESCRIPTOR,
    user_data_count: u32,
    user_data: ?[*]EVENT_DATA_DESCRIPTOR,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "advapi32" fn EventWriteTransfer(
    ...
    event_descriptor: ?*const EVENT_DESCRIPTOR,
    activity_id: ?*const Guid,
    related_activity_id: ?*const Guid,
    user_data_count: u32,
    user_data: ?[*]EVENT_DATA_DESCRIPTOR,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "tdh" fn TdhCreatePayloadFilter(
    ...
    event_descriptor: ?*const EVENT_DESCRIPTOR,
    event_match_a_n_y: BOOLEAN,
    payload_predicate_count: u32,
    payload_predicates: [*]PAYLOAD_FILTER_PREDICATE,
    payload_filter: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "tdh" fn TdhAggregatePayloadFilters(
    payload_filter_count: u32,
    payload_filter_ptrs: [*]?*anyopaque,
    event_match_a_l_l_flags: ?[*]BOOLEAN,
...
pub extern "tdh" fn TdhGetEventMapInformation(
    p_event: ?*EVENT_RECORD,
    p_map_name: ?PWSTR,
    // TODO: what to do with BytesParamIndex 3?
    p_buffer: ?*EVENT_MAP_INFO,
    p_buffer_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "tdh" fn TdhGetPropertySize(
    p_event: ?*EVENT_RECORD,
    tdh_context_count: u32,
    p_tdh_context: ?[*]TDH_CONTEXT,
    property_data_count: u32,
    p_property_data: [*]PROPERTY_DATA_DESCRIPTOR,
    p_property_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "tdh" fn TdhEnumerateProviders(
    ...
    p_buffer: ?*PROVIDER_ENUMERATION_INFO,
    p_buffer_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "tdh" fn TdhQueryProviderFieldInformation(
    p_guid: ?*Guid,
    event_field_value: u64,
    event_field_type: EVENT_FIELD_TYPE,
    // TODO: what to do with BytesParamIndex 4?
    p_buffer: ?*PROVIDER_FIELD_INFOARRAY,
    p_buffer_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "tdh" fn TdhFormatProperty(
    ...
    map_info: ?*EVENT_MAP_INFO,
    pointer_size: u32,
    property_in_type: u16,
    property_out_type: u16,
    property_length: u16,
...
pub extern "advapi32" fn CveEventWrite(
    cve_id: ?[*:0]const u16,
    additional_details: ?[*:0]const u16,
