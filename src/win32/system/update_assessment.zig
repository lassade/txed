...
pub const IWaaSAssessor = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getOSUpdateAssessment(self: *const T, result_: ?*OSUpdateAssessment) HRESULT {
                return @as(*const IWaaSAssessor.VTable, @ptrCast(self.vtable)).GetOSUpdateAssessment(@as(*const IWaaSAssessor, @ptrCast(self)), result_);
            }
        };
    }
