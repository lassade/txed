...
pub const LPMAPISENDDOCUMENTS = *const fn (
    ul_u_i_param: usize,
    lpsz_delim_char: ?PSTR,
    lpsz_file_paths: ?PSTR,
    lpsz_file_names: ?PSTR,
    ul_reserved: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const LPMAPIFINDNEXT = *const fn (
    ...
    lpsz_seed_message_i_d: ?PSTR,
    fl_flags: u32,
    ul_reserved: u32,
    lpsz_message_i_d: ?PSTR,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const LPMAPIADDRESS = *const fn (
    ...
    ul_reserved: u32,
    lpn_new_recips: ?*u32,
    lpp_new_recips: ?*?*MapiRecipDesc,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const LPMAPIDETAILS = *const fn (
    lh_session: usize,
    ul_u_i_param: usize,
    lp_recip: ?*MapiRecipDesc,
    fl_flags: u32,
    ul_reserved: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
