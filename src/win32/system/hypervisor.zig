...
pub const WHV_EMULATOR_IO_PORT_CALLBACK = *const fn (
    context: ?*anyopaque,
    io_access: ?*WHV_EMULATOR_IO_ACCESS_INFO,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub const WHV_EMULATOR_MEMORY_CALLBACK = *const fn (
    context: ?*anyopaque,
    memory_access: ?*WHV_EMULATOR_MEMORY_ACCESS_INFO,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub const HDV_PCI_DEVICE_SET_CONFIGURATION = *const fn (
    ...
    configuration_values: [*]const ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub const HDV_PCI_DEVICE_GET_DETAILS = *const fn (
    device_context: ?*anyopaque,
    pnp_id: ?*HDV_PCI_PNP_ID,
...
pub const GUEST_SYMBOLS_PROVIDER_DEBUG_INFO_CALLBACK = *const fn (
    info_message: ?[*:0]const u8,
) callconv(@import("std").os.windows.WINAPI) void;

pub const FOUND_IMAGE_CALLBACK = *const fn (
    context: ?*anyopaque,
    image_info: ?*DOS_IMAGE_INFO,
...
pub extern "winhvplatform" fn WHvGetCapability(
    capability_code: WHV_CAPABILITY_CODE,
    // TODO: what to do with BytesParamIndex 2?
    capability_buffer: ?*anyopaque,
    capability_buffer_size_in_bytes: u32,
    written_size_in_bytes: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "winhvplatform" fn WHvGetPartitionProperty(
    ...
    property_buffer: ?*anyopaque,
    property_buffer_size_in_bytes: u32,
    written_size_in_bytes: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "winhvplatform" fn WHvSetPartitionProperty(
    ...
    property_code: WHV_PARTITION_PROPERTY_CODE,
    // TODO: what to do with BytesParamIndex 3?
    property_buffer: ?*const anyopaque,
    property_buffer_size_in_bytes: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "winhvplatform" fn WHvTranslateGva(
    ...
    gva: u64,
    translate_flags: WHV_TRANSLATE_GVA_FLAGS,
    translation_result: ?*WHV_TRANSLATE_GVA_RESULT,
    gpa: ?*u64,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "winhvplatform" fn WHvRunVirtualProcessor(
    ...
    exit_context_size_in_bytes: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "winhvplatform" fn WHvQueryGpaRangeDirtyBitmap(
    partition: WHV_PARTITION_HANDLE,
    guest_address: u64,
    range_size_in_bytes: u64,
    // TODO: what to do with BytesParamIndex 4?
    bitmap: ?*u64,
    bitmap_size_in_bytes: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "winhvplatform" fn WHvGetVirtualProcessorCounters(
    partition: WHV_PARTITION_HANDLE,
    vp_index: u32,
    counter_set: WHV_PROCESSOR_COUNTER_SET,
    // TODO: what to do with BytesParamIndex 4?
    buffer: ?*anyopaque,
    buffer_size_in_bytes: u32,
    bytes_written: ?*u32,
...
pub extern "winhvplatform" fn WHvRegisterPartitionDoorbellEvent(
    partition: WHV_PARTITION_HANDLE,
    match_data: ?*const WHV_DOORBELL_MATCH_DATA,
    event_handle: ?HANDLE,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "winhvplatform" fn WHvAdviseGpaRange(
    partition: WHV_PARTITION_HANDLE,
    gpa_ranges: [*]const WHV_MEMORY_RANGE_ENTRY,
    gpa_ranges_count: u32,
    advice: WHV_ADVISE_GPA_RANGE_CODE,
    // TODO: what to do with BytesParamIndex 5?
    advice_buffer: ?*const anyopaque,
    advice_buffer_size_in_bytes: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "winhvplatform" fn WHvAllocateVpciResource(
    ...
    resource_descriptor: ?[*]const u8,
    resource_descriptor_size_in_bytes: u32,
...
pub extern "winhvplatform" fn WHvGetVpciDeviceNotification(
    ...
    notification_size_in_bytes: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "winhvplatform" fn WHvSetVpciDevicePowerState(
    partition: WHV_PARTITION_HANDLE,
    logical_device_id: u64,
    power_state: DEVICE_POWER_STATE,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "winhvplatform" fn WHvGetVpciDeviceInterruptTarget(
    ...
    logical_device_id: u64,
    index: u32,
    multi_message_number: u32,
    // TODO: what to do with BytesParamIndex 5?
    target: ?*WHV_VPCI_INTERRUPT_TARGET,
    target_size_in_bytes: u32,
    bytes_written: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "winhvemulation" fn WHvEmulatorTryIoEmulation(
    ...
    io_instruction_context: ?*const WHV_X64_IO_PORT_ACCESS_CONTEXT,
    emulator_return_status: ?*WHV_EMULATOR_STATUS,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "winhvemulation" fn WHvEmulatorTryMmioEmulation(
    ...
    context: ?*anyopaque,
    vp_context: ?*const WHV_VP_EXIT_CONTEXT,
    mmio_instruction_context: ?*const WHV_MEMORY_ACCESS_CONTEXT,
    emulator_return_status: ?*WHV_EMULATOR_STATUS,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "vmdevicehost" fn HdvInitializeDeviceHost(
    compute_system: HCS_SYSTEM,
    device_host_handle: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "vmdevicehost" fn HdvCreateDeviceInstance(
    device_host_handle: ?*anyopaque,
    device_type: HDV_DEVICE_TYPE,
    device_class_id: ?*const Guid,
    device_instance_id: ?*const Guid,
    device_interface: ?*const anyopaque,
    device_context: ?*anyopaque,
...
pub extern "vmdevicehost" fn HdvCreateSectionBackedMmioRange(
    ...
    offset_in_pages: u64,
    length_in_pages: u64,
    mapping_flags: HDV_MMIO_MAPPING_FLAGS,
...
pub extern "vmsavedstatedumpprovider" fn LoadSavedStateFile(
    vmrs_file: ?[*:0]const u16,
    vm_saved_state_dump_handle: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "vmsavedstatedumpprovider" fn LoadSavedStateFiles(
    bin_file: ?[*:0]const u16,
    vsv_file: ?[*:0]const u16,
    vm_saved_state_dump_handle: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "vmsavedstatedumpprovider" fn GetGuestEnabledVirtualTrustLevels(
    vm_saved_state_dump_handle: ?*anyopaque,
    virtual_trust_levels: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "vmsavedstatedumpprovider" fn GetGuestOsInfo(
    vm_saved_state_dump_handle: ?*anyopaque,
    virtual_trust_level: u8,
    guest_os_info: ?*GUEST_OS_INFO,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "vmsavedstatedumpprovider" fn IsActiveVirtualTrustLevelEnabled(
    vm_saved_state_dump_handle: ?*anyopaque,
    vp_id: u32,
    active_virtual_trust_level_enabled: ?*BOOL,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "vmsavedstatedumpprovider" fn GetRegisterValue(
    ...
    vp_id: u32,
    register_id: u32,
    register_value: ?*VIRTUAL_PROCESSOR_REGISTER,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "vmsavedstatedumpprovider" fn GetGuestRawSavedMemorySize(
    vm_saved_state_dump_handle: ?*anyopaque,
    guest_raw_saved_memory_size: ?*u64,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "vmsavedstatedumpprovider" fn ScanMemoryForDosImages(
    ...
    found_image_callback: ?FOUND_IMAGE_CALLBACK,
    standalone_address: ?*u64,
    standalone_address_count: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "vmsavedstatedumpprovider" fn CallStackUnwind(
    vm_saved_state_dump_handle: ?*anyopaque,
    vp_id: u32,
    image_info: ?*MODULE_INFO,
