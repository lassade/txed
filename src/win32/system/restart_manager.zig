...
pub extern "rstrtmgr" fn RmStartSession(
    p_session_handle: ?*u32,
    dw_session_flags: u32,
    str_session_key: ?PWSTR,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "rstrtmgr" fn RmJoinSession(
    p_session_handle: ?*u32,
    str_session_key: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "rstrtmgr" fn RmRegisterResources(
    dw_session_handle: u32,
    n_files: u32,
    rgs_file_names: ?[*]?PWSTR,
    n_applications: u32,
    rg_applications: ?[*]RM_UNIQUE_PROCESS,
    n_services: u32,
    rgs_service_names: ?[*]?PWSTR,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "rstrtmgr" fn RmGetList(
    dw_session_handle: u32,
    pn_proc_info_needed: ?*u32,
    pn_proc_info: ?*u32,
    rg_affected_apps: ?[*]RM_PROCESS_INFO,
    lpdw_reboot_reasons: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "rstrtmgr" fn RmShutdown(
    dw_session_handle: u32,
    l_action_flags: u32,
    fn_status: ?RM_WRITE_STATUS_CALLBACK,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "rstrtmgr" fn RmRestart(
    dw_session_handle: u32,
    dw_restart_flags: u32,
    fn_status: ?RM_WRITE_STATUS_CALLBACK,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "rstrtmgr" fn RmAddFilter(
    dw_session_handle: u32,
    str_module_name: ?[*:0]const u16,
    p_process: ?*RM_UNIQUE_PROCESS,
    str_service_short_name: ?[*:0]const u16,
