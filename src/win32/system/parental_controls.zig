...
pub const IWPCProviderConfig = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getUserSummary(self: *const T, bstr_s_i_d_: ?BSTR, pbstr_user_summary_: ?*?BSTR) HRESULT {
                return @as(*const IWPCProviderConfig.VTable, @ptrCast(self.vtable)).GetUserSummary(@as(*const IWPCProviderConfig, @ptrCast(self)), bstr_s_i_d_, pbstr_user_summary_);
            }
            pub inline fn configure(self: *const T, h_wnd_: ?HWND, bstr_s_i_d_: ?BSTR) HRESULT {
                return @as(*const IWPCProviderConfig.VTable, @ptrCast(self.vtable)).Configure(@as(*const IWPCProviderConfig, @ptrCast(self)), h_wnd_, bstr_s_i_d_);
            }
            pub inline fn requestOverride(self: *const T, h_wnd_: ?HWND, bstr_path_: ?BSTR, dw_flags_: WPCFLAG_RESTRICTION) HRESULT {
                return @as(*const IWPCProviderConfig.VTable, @ptrCast(self.vtable)).RequestOverride(@as(*const IWPCProviderConfig, @ptrCast(self)), h_wnd_, bstr_path_, dw_flags_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWPCSettings = extern struct {
    pub const VTable = extern struct {
        ...
        GetRestrictions: *const fn (
            self: *const IWPCSettings,
            pdw_restrictions: ?*WPCFLAG_RESTRICTION,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn isLoggingRequired(self: *const T, pf_required_: ?*BOOL) HRESULT {
                return @as(*const IWPCSettings.VTable, @ptrCast(self.vtable)).IsLoggingRequired(@as(*const IWPCSettings, @ptrCast(self)), pf_required_);
            }
            pub inline fn getLastSettingsChangeTime(self: *const T, p_time_: ?*SYSTEMTIME) HRESULT {
                return @as(*const IWPCSettings.VTable, @ptrCast(self.vtable)).GetLastSettingsChangeTime(@as(*const IWPCSettings, @ptrCast(self)), p_time_);
            }
            pub inline fn getRestrictions(self: *const T, pdw_restrictions_: ?*WPCFLAG_RESTRICTION) HRESULT {
                return @as(*const IWPCSettings.VTable, @ptrCast(self.vtable)).GetRestrictions(@as(*const IWPCSettings, @ptrCast(self)), pdw_restrictions_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWPCGamesSettings = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn isBlocked(self: *const T, guid_app_i_d_: Guid, pdw_reasons_: ?*u32) HRESULT {
                return @as(*const IWPCGamesSettings.VTable, @ptrCast(self.vtable)).IsBlocked(@as(*const IWPCGamesSettings, @ptrCast(self)), guid_app_i_d_, pdw_reasons_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWPCWebSettings = extern struct {
    pub const VTable = extern struct {
        ...
        GetSettings: *const fn (
            ...
            pdw_settings: ?*WPCFLAG_WEB_SETTING,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IWPCSettings.MethodMixin(T);
            pub inline fn getSettings(self: *const T, pdw_settings_: ?*WPCFLAG_WEB_SETTING) HRESULT {
                return @as(*const IWPCWebSettings.VTable, @ptrCast(self.vtable)).GetSettings(@as(*const IWPCWebSettings, @ptrCast(self)), pdw_settings_);
            }
            pub inline fn requestURLOverride(self: *const T, h_wnd_: ?HWND, pcsz_u_r_l_: ?[*:0]const u16, c_u_r_ls_: u32, ppcsz_sub_u_r_ls_: ?[*]?PWSTR, pf_changed_: ?*BOOL) HRESULT {
                return @as(*const IWPCWebSettings.VTable, @ptrCast(self.vtable)).RequestURLOverride(@as(*const IWPCWebSettings, @ptrCast(self)), h_wnd_, pcsz_u_r_l_, c_u_r_ls_, ppcsz_sub_u_r_ls_, pf_changed_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWindowsParentalControlsCore = extern struct {
    pub const VTable = extern struct {
        ...
        GetVisibility: *const fn (
            ...
            pe_visibility: ?*WPCFLAG_VISIBILITY,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetUserSettings: *const fn (
            self: *const IWindowsParentalControlsCore,
            pcsz_s_i_d: ?[*:0]const u16,
            pp_settings: ?*?*IWPCSettings,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetWebSettings: *const fn (
            self: *const IWindowsParentalControlsCore,
            pcsz_s_i_d: ?[*:0]const u16,
            pp_settings: ?*?*IWPCWebSettings,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getVisibility(self: *const T, pe_visibility_: ?*WPCFLAG_VISIBILITY) HRESULT {
                return @as(*const IWindowsParentalControlsCore.VTable, @ptrCast(self.vtable)).GetVisibility(@as(*const IWindowsParentalControlsCore, @ptrCast(self)), pe_visibility_);
            }
            pub inline fn getUserSettings(self: *const T, pcsz_s_i_d_: ?[*:0]const u16, pp_settings_: ?*?*IWPCSettings) HRESULT {
                return @as(*const IWindowsParentalControlsCore.VTable, @ptrCast(self.vtable)).GetUserSettings(@as(*const IWindowsParentalControlsCore, @ptrCast(self)), pcsz_s_i_d_, pp_settings_);
            }
            pub inline fn getWebSettings(self: *const T, pcsz_s_i_d_: ?[*:0]const u16, pp_settings_: ?*?*IWPCWebSettings) HRESULT {
                return @as(*const IWindowsParentalControlsCore.VTable, @ptrCast(self.vtable)).GetWebSettings(@as(*const IWindowsParentalControlsCore, @ptrCast(self)), pcsz_s_i_d_, pp_settings_);
            }
            pub inline fn getWebFilterInfo(self: *const T, pguid_i_d_: ?*Guid, ppsz_name_: ?*?PWSTR) HRESULT {
                return @as(*const IWindowsParentalControlsCore.VTable, @ptrCast(self.vtable)).GetWebFilterInfo(@as(*const IWindowsParentalControlsCore, @ptrCast(self)), pguid_i_d_, ppsz_name_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWindowsParentalControls = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getGamesSettings(self: *const T, pcsz_s_i_d_: ?[*:0]const u16, pp_settings_: ?*?*IWPCGamesSettings) HRESULT {
                return @as(*const IWindowsParentalControls.VTable, @ptrCast(self.vtable)).GetGamesSettings(@as(*const IWindowsParentalControls, @ptrCast(self)), pcsz_s_i_d_, pp_settings_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWPCProviderSupport = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getCurrent(self: *const T, pguid_provider_: ?*Guid) HRESULT {
                return @as(*const IWPCProviderSupport.VTable, @ptrCast(self.vtable)).GetCurrent(@as(*const IWPCProviderSupport, @ptrCast(self)), pguid_provider_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
