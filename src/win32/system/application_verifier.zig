...
pub const AVRF_RESOURCE_ENUMERATE_CALLBACK = *const fn (
    resource_description: ?*anyopaque,
    enumeration_context: ?*anyopaque,
    enumeration_level: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const AVRF_HEAPALLOCATION_ENUMERATE_CALLBACK = *const fn (
    heap_allocation: ?*AVRF_HEAP_ALLOCATION,
    enumeration_context: ?*anyopaque,
    enumeration_level: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const AVRF_HANDLEOPERATION_ENUMERATE_CALLBACK = *const fn (
    handle_operation: ?*AVRF_HANDLE_OPERATION,
    enumeration_context: ?*anyopaque,
    enumeration_level: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "verifier" fn VerifierEnumerateResource(
    ...
    resource_type: eAvrfResourceTypes,
    resource_callback: ?AVRF_RESOURCE_ENUMERATE_CALLBACK,
    enumeration_context: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
