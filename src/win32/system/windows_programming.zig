...
pub const ICameraUIControlEventCallback = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn onStartupComplete(self: *const T) void {
            ...
            pub inline fn onSuspendComplete(self: *const T) void {
            ...
            pub inline fn onItemCaptured(self: *const T, psz_path_: ?[*:0]const u16) void {
                return @as(*const ICameraUIControlEventCallback.VTable, @ptrCast(self.vtable)).OnItemCaptured(@as(*const ICameraUIControlEventCallback, @ptrCast(self)), psz_path_);
            }
            pub inline fn onItemDeleted(self: *const T, psz_path_: ?[*:0]const u16) void {
                return @as(*const ICameraUIControlEventCallback.VTable, @ptrCast(self.vtable)).OnItemDeleted(@as(*const ICameraUIControlEventCallback, @ptrCast(self)), psz_path_);
            }
            pub inline fn onClosed(self: *const T) void {
...
pub const ICameraUIControl = extern struct {
    pub const VTable = extern struct {
        ...
        GetCurrentViewType: *const fn (
            self: *const ICameraUIControl,
            p_view_type: ?*CameraUIControlViewType,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetActiveItem: *const fn (
            self: *const ICameraUIControl,
            pbstr_active_item_path: ?*?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetSelectedItems: *const fn (
            self: *const ICameraUIControl,
            pp_selected_item_paths: ?*?*SAFEARRAY,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn show(self: *const T, p_window_: ?*IUnknown, mode_: CameraUIControlMode, selection_mode_: CameraUIControlLinearSelectionMode, capture_mode_: CameraUIControlCaptureMode, photo_format_: CameraUIControlPhotoFormat, video_format_: CameraUIControlVideoFormat, b_has_close_button_: BOOL, p_event_callback_: ?*ICameraUIControlEventCallback) HRESULT {
                return @as(*const ICameraUIControl.VTable, @ptrCast(self.vtable)).Show(@as(*const ICameraUIControl, @ptrCast(self)), p_window_, mode_, selection_mode_, capture_mode_, photo_format_, video_format_, b_has_close_button_, p_event_callback_);
            }
            ...
            pub inline fn @"suspend"(self: *const T, pb_deferral_required_: ?*BOOL) HRESULT {
                return @as(*const ICameraUIControl.VTable, @ptrCast(self.vtable)).Suspend(@as(*const ICameraUIControl, @ptrCast(self)), pb_deferral_required_);
            }
            ...
            pub inline fn getCurrentViewType(self: *const T, p_view_type_: ?*CameraUIControlViewType) HRESULT {
                return @as(*const ICameraUIControl.VTable, @ptrCast(self.vtable)).GetCurrentViewType(@as(*const ICameraUIControl, @ptrCast(self)), p_view_type_);
            }
            pub inline fn getActiveItem(self: *const T, pbstr_active_item_path_: ?*?BSTR) HRESULT {
                return @as(*const ICameraUIControl.VTable, @ptrCast(self.vtable)).GetActiveItem(@as(*const ICameraUIControl, @ptrCast(self)), pbstr_active_item_path_);
            }
            pub inline fn getSelectedItems(self: *const T, pp_selected_item_paths_: ?*?*SAFEARRAY) HRESULT {
                return @as(*const ICameraUIControl.VTable, @ptrCast(self.vtable)).GetSelectedItems(@as(*const ICameraUIControl, @ptrCast(self)), pp_selected_item_paths_);
            }
            pub inline fn removeCapturedItem(self: *const T, psz_path_: ?[*:0]const u16) HRESULT {
                return @as(*const ICameraUIControl.VTable, @ptrCast(self.vtable)).RemoveCapturedItem(@as(*const ICameraUIControl, @ptrCast(self)), psz_path_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IEditionUpgradeHelper = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn canUpgrade(self: *const T, is_allowed_: ?*BOOL) HRESULT {
                return @as(*const IEditionUpgradeHelper.VTable, @ptrCast(self.vtable)).CanUpgrade(@as(*const IEditionUpgradeHelper, @ptrCast(self)), is_allowed_);
            }
            pub inline fn updateOperatingSystem(self: *const T, content_id_: ?[*:0]const u16) HRESULT {
                return @as(*const IEditionUpgradeHelper.VTable, @ptrCast(self.vtable)).UpdateOperatingSystem(@as(*const IEditionUpgradeHelper, @ptrCast(self)), content_id_);
            }
            pub inline fn showProductKeyUI(self: *const T) HRESULT {
            ...
            pub inline fn getOsProductContentId(self: *const T, content_id_: ?*?PWSTR) HRESULT {
                return @as(*const IEditionUpgradeHelper.VTable, @ptrCast(self.vtable)).GetOsProductContentId(@as(*const IEditionUpgradeHelper, @ptrCast(self)), content_id_);
            }
            pub inline fn getGenuineLocalStatus(self: *const T, is_genuine_: ?*BOOL) HRESULT {
                return @as(*const IEditionUpgradeHelper.VTable, @ptrCast(self.vtable)).GetGenuineLocalStatus(@as(*const IEditionUpgradeHelper, @ptrCast(self)), is_genuine_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWindowsLockModeHelper = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getSMode(self: *const T, is_smode_: ?*BOOL) HRESULT {
                return @as(*const IWindowsLockModeHelper.VTable, @ptrCast(self.vtable)).GetSMode(@as(*const IWindowsLockModeHelper, @ptrCast(self)), is_smode_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IEditionUpgradeBroker = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn initializeParentWindow(self: *const T, parent_handle_: u32) HRESULT {
                return @as(*const IEditionUpgradeBroker.VTable, @ptrCast(self.vtable)).InitializeParentWindow(@as(*const IEditionUpgradeBroker, @ptrCast(self)), parent_handle_);
            }
            pub inline fn updateOperatingSystem(self: *const T, parameter_: ?BSTR) HRESULT {
                return @as(*const IEditionUpgradeBroker.VTable, @ptrCast(self.vtable)).UpdateOperatingSystem(@as(*const IEditionUpgradeBroker, @ptrCast(self)), parameter_);
            }
            pub inline fn showProductKeyUI(self: *const T) HRESULT {
            ...
            pub inline fn canUpgrade(self: *const T) HRESULT {
...
pub const IContainerActivationHelper = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn canActivateClientVM(self: *const T, is_allowed_: ?*i16) HRESULT {
                return @as(*const IContainerActivationHelper.VTable, @ptrCast(self.vtable)).CanActivateClientVM(@as(*const IContainerActivationHelper, @ptrCast(self)), is_allowed_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IClipServiceNotificationHelper = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn showToast(self: *const T, title_text_: ?BSTR, body_text_: ?BSTR, package_name_: ?BSTR, app_id_: ?BSTR, launch_command_: ?BSTR) HRESULT {
                return @as(*const IClipServiceNotificationHelper.VTable, @ptrCast(self.vtable)).ShowToast(@as(*const IClipServiceNotificationHelper, @ptrCast(self)), title_text_, body_text_, package_name_, app_id_, launch_command_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ENUM_CALLBACK = *const fn (
    lp_surface_info: ?*DCISURFACEINFO,
...
pub const PWLDP_QUERYDYNAMICODETRUST_API = *const fn (
    ...
    base_image: ?*anyopaque,
    image_size: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub const PWLDP_QUERYWINDOWSLOCKDOWNMODE_API = *const fn (
    lockdown_mode: ?*WLDP_WINDOWS_LOCKDOWN_MODE,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub const PWLDP_ISWCOSPRODUCTIONCONFIGURATION_API = *const fn (
    is_production_configuration: ?*BOOL,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub const PWLDP_RESETWCOSPRODUCTIONCONFIGURATION_API = *const fn () callconv(@import("std").os.windows.WINAPI) HRESULT;

pub const PWLDP_ISPRODUCTIONCONFIGURATION_API = *const fn (
    is_production_configuration: ?*BOOL,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub const PWLDP_RESETPRODUCTIONCONFIGURATION_API = *const fn () callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub const IDeleteBrowsingHistory = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn deleteBrowsingHistory(self: *const T, dw_flags_: u32) HRESULT {
                return @as(*const IDeleteBrowsingHistory.VTable, @ptrCast(self.vtable)).DeleteBrowsingHistory(@as(*const IDeleteBrowsingHistory, @ptrCast(self)), dw_flags_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub extern "ntdll" fn RtlRaiseCustomSystemEventTrigger(
    trigger_config: ?*CUSTOM_SYSTEM_EVENT_TRIGGER_CONFIG,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "api-ms-win-core-realtime-l1-1-2" fn ConvertPerformanceCounterToAuxiliaryCounter(
    ...
    lp_auxiliary_counter_value: ?*u64,
    lp_conversion_error: ?*u64,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "kernel32" fn SignalObjectAndWait(
    h_object_to_signal: ?HANDLE,
    h_object_to_wait_on: ?HANDLE,
    dw_milliseconds: u32,
    b_alertable: BOOL,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "kernel32" fn IsNativeVhdBoot(
    native_vhd_boot: ?*BOOL,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.0'
pub extern "kernel32" fn GetProfileIntA(
    lp_app_name: ?[*:0]const u8,
    lp_key_name: ?[*:0]const u8,
    n_default: i32,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows5.0'
pub extern "kernel32" fn GetProfileIntW(
    lp_app_name: ?[*:0]const u16,
    lp_key_name: ?[*:0]const u16,
    n_default: i32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "kernel32" fn GetProfileStringA(
    lp_app_name: ?[*:0]const u8,
    lp_key_name: ?[*:0]const u8,
    lp_default: ?[*:0]const u8,
    lp_returned_string: ?[*:0]u8,
    n_size: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "kernel32" fn GetProfileStringW(
    lp_app_name: ?[*:0]const u16,
    lp_key_name: ?[*:0]const u16,
    lp_default: ?[*:0]const u16,
    lp_returned_string: ?[*:0]u16,
    n_size: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "kernel32" fn GetPrivateProfileStructW(
    lpsz_section: ?[*:0]const u16,
    lpsz_key: ?[*:0]const u16,
    // TODO: what to do with BytesParamIndex 3?
    lp_struct: ?*anyopaque,
    u_size_struct: u32,
    sz_file: ?[*:0]const u16,
...
pub extern "advapi32" fn GetCurrentHwProfileA(
    lp_hw_profile_info: ?*HW_PROFILE_INFOA,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.0'
pub extern "advapi32" fn GetCurrentHwProfileW(
    lp_hw_profile_info: ?*HW_PROFILE_INFOW,
) callconv(@import("std").os.windows.WINAPI) BOOL;

pub extern "kernel32" fn ReplacePartitionUnit(
    target_partition: ?PWSTR,
    spare_partition: ?PWSTR,
    flags: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "api-ms-win-core-backgroundtask-l1-1-0" fn RaiseCustomSystemEventTrigger(
    custom_system_event_trigger_config: ?*CUSTOM_SYSTEM_EVENT_TRIGGER_CONFIG,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "ntdll" fn NtRenameKey(
    key_handle: ?HANDLE,
    new_name: ?*UNICODE_STRING,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

pub extern "ntdll" fn NtNotifyChangeMultipleKeys(
    master_key_handle: ?HANDLE,
    count: u32,
    subordinate_objects: ?[*]OBJECT_ATTRIBUTES,
    event: ?HANDLE,
...
pub extern "ntdll" fn RtlInitUnicodeString(
    destination_string: ?*UNICODE_STRING,
...
pub extern "ntdll" fn RtlUnicodeToMultiByteSize(
    bytes_in_multi_byte_string: ?*u32,
    // TODO: what to do with BytesParamIndex 2?
    unicode_string: ?[*]u16,
...
pub extern "dciman32" fn DCICreateOffscreen(
    ...
    dw_d_c_i_caps: u32,
    dw_bit_count: u32,
    lplp_surface: ?*?*DCIOFFSCREEN,
) callconv(@import("std").os.windows.WINAPI) i32;

pub extern "dciman32" fn DCICreateOverlay(
    hdc: ?HDC,
    lp_offscreen_surf: ?*anyopaque,
    lplp_surface: ?*?*DCIOVERLAY,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "dciman32" fn WinWatchNotify(
    h_w_w: ?HWINWATCH,
    notify_callback: ?WINWATCHNOTIFYPROC,
    notify_param: LPARAM,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "advpack" fn RunSetupCommandA(
    h_wnd: ?HWND,
    sz_cmd_name: ?[*:0]const u8,
    sz_inf_section: ?[*:0]const u8,
    sz_dir: ?[*:0]const u8,
    lpsz_title: ?[*:0]const u8,
    ph_e_x_e: ?*?HANDLE,
    dw_flags: u32,
...
pub extern "advpack" fn RunSetupCommandW(
    h_wnd: ?HWND,
    sz_cmd_name: ?[*:0]const u16,
    sz_inf_section: ?[*:0]const u16,
    sz_dir: ?[*:0]const u16,
...
pub extern "advpack" fn RebootCheckOnInstallW(
    hwnd: ?HWND,
    psz_i_n_f: ?[*:0]const u16,
    psz_sec: ?[*:0]const u16,
    dw_reserved: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "advpack" fn TranslateInfStringA(
    psz_inf_filename: ?[*:0]const u8,
    psz_install_section: ?[*:0]const u8,
    psz_translate_section: ?[*:0]const u8,
    psz_translate_key: ?[*:0]const u8,
    psz_buffer: ?[*:0]u8,
    cch_buffer: u32,
    pdw_required_size: ?*u32,
    pv_reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "advpack" fn TranslateInfStringW(
    psz_inf_filename: ?[*:0]const u16,
    psz_install_section: ?[*:0]const u16,
    psz_translate_section: ?[*:0]const u16,
    psz_translate_key: ?[*:0]const u16,
    psz_buffer: ?[*:0]u16,
    cch_buffer: u32,
    pdw_required_size: ?*u32,
    pv_reserved: ?*anyopaque,
...
pub extern "advpack" fn RegInstallA(
    hmod: ?HINSTANCE,
    psz_section: ?[*:0]const u8,
    pst_table: ?*const STRTABLEA,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows10.0.10240'
pub extern "advpack" fn RegInstallW(
    hmod: ?HINSTANCE,
    psz_section: ?[*:0]const u16,
    pst_table: ?*const STRTABLEW,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "advpack" fn AdvInstallFileA(
    hwnd: ?HWND,
    lpsz_source_dir: ?[*:0]const u8,
    lpsz_source_file: ?[*:0]const u8,
    lpsz_dest_dir: ?[*:0]const u8,
    lpsz_dest_file: ?[*:0]const u8,
    dw_flags: u32,
    dw_reserved: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "advpack" fn AdvInstallFileW(
    hwnd: ?HWND,
    lpsz_source_dir: ?[*:0]const u16,
    lpsz_source_file: ?[*:0]const u16,
    lpsz_dest_dir: ?[*:0]const u16,
    lpsz_dest_file: ?[*:0]const u16,
    dw_flags: u32,
    dw_reserved: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "advpack" fn RegSaveRestoreA(
    h_wnd: ?HWND,
    psz_title_string: ?[*:0]const u8,
    hk_bckup_key: ?HKEY,
    pcsz_root_key: ?[*:0]const u8,
    pcsz_sub_key: ?[*:0]const u8,
    pcsz_value_name: ?[*:0]const u8,
    dw_flags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "advpack" fn RegSaveRestoreW(
    h_wnd: ?HWND,
    psz_title_string: ?[*:0]const u16,
    hk_bckup_key: ?HKEY,
    pcsz_root_key: ?[*:0]const u16,
    pcsz_sub_key: ?[*:0]const u16,
    pcsz_value_name: ?[*:0]const u16,
    dw_flags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "advpack" fn RegSaveRestoreOnINFA(
    h_wnd: ?HWND,
    psz_title: ?[*:0]const u8,
    psz_i_n_f: ?[*:0]const u8,
    psz_section: ?[*:0]const u8,
    h_h_k_l_m_back_key: ?HKEY,
    h_h_k_c_u_back_key: ?HKEY,
    dw_flags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "advpack" fn FileSaveRestoreOnINFA(
    ...
    psz_i_n_f: ?[*:0]const u8,
    psz_section: ?[*:0]const u8,
    psz_backup_dir: ?[*:0]const u8,
    psz_base_backup_file: ?[*:0]const u8,
    dw_flags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "advpack" fn FileSaveRestoreOnINFW(
    ...
    psz_i_n_f: ?[*:0]const u16,
    psz_section: ?[*:0]const u16,
    psz_backup_dir: ?[*:0]const u16,
    psz_base_backup_file: ?[*:0]const u16,
    dw_flags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "advpack" fn AddDelBackupEntryA(
    lpcsz_file_list: ?[*:0]const u8,
    lpcsz_backup_dir: ?[*:0]const u8,
    lpcsz_base_name: ?[*:0]const u8,
    dw_flags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "advpack" fn AddDelBackupEntryW(
    lpcsz_file_list: ?[*:0]const u16,
    lpcsz_backup_dir: ?[*:0]const u16,
    lpcsz_base_name: ?[*:0]const u16,
    dw_flags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "advpack" fn FileSaveMarkNotExistA(
    lp_file_list: ?[*:0]const u8,
    lp_dir: ?[*:0]const u8,
    lp_base_name: ?[*:0]const u8,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "advpack" fn FileSaveMarkNotExistW(
    lp_file_list: ?[*:0]const u16,
    lp_dir: ?[*:0]const u16,
    lp_base_name: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "advpack" fn GetVersionFromFileA(
    lpsz_filename: ?[*:0]const u8,
    pdw_m_s_ver: ?*u32,
    pdw_l_s_ver: ?*u32,
    b_version: BOOL,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "advpack" fn DelNodeA(
    psz_file_or_dir_name: ?[*:0]const u8,
    dw_flags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "advpack" fn DelNodeW(
    psz_file_or_dir_name: ?[*:0]const u16,
    dw_flags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "advpack" fn ExtractFilesA(
    psz_cab_name: ?[*:0]const u8,
    psz_expand_dir: ?[*:0]const u8,
    dw_flags: u32,
    psz_file_list: ?[*:0]const u8,
    lp_reserved: ?*anyopaque,
    dw_reserved: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "advpack" fn ExtractFilesW(
    psz_cab_name: ?[*:0]const u16,
    psz_expand_dir: ?[*:0]const u16,
    dw_flags: u32,
    psz_file_list: ?[*:0]const u16,
    lp_reserved: ?*anyopaque,
    dw_reserved: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "advpack" fn SetPerUserSecValuesA(
    p_per_user: ?*PERUSERSECTIONA,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "advpack" fn SetPerUserSecValuesW(
    p_per_user: ?*PERUSERSECTIONW,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
