...
pub const PENUM_PAGE_FILE_CALLBACKW = *const fn (
    p_context: ?*anyopaque,
    p_page_file_info: ?*ENUM_PAGE_FILE_INFORMATION,
...
pub extern "kernel32" fn K32EnumProcessModulesEx(
    ...
    cb: u32,
    lpcb_needed: ?*u32,
    dw_filter_flag: ENUM_PROCESS_MODULES_EX_FLAGS,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "kernel32" fn K32GetWsChanges(
    h_process: ?HANDLE,
    // TODO: what to do with BytesParamIndex 2?
    lp_watch_info: ?*PSAPI_WS_WATCH_INFORMATION,
    cb: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "kernel32" fn K32GetWsChangesEx(
    h_process: ?HANDLE,
    // TODO: what to do with BytesParamIndex 2?
    lp_watch_info_ex: ?*PSAPI_WS_WATCH_INFORMATION_EX,
    cb: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "kernel32" fn K32GetProcessMemoryInfo(
    process: ?HANDLE,
    ppsmem_counters: ?*PROCESS_MEMORY_COUNTERS,
    cb: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;

pub extern "kernel32" fn K32GetPerformanceInfo(
    p_performance_information: ?*PERFORMANCE_INFORMATION,
    cb: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;

pub extern "kernel32" fn K32EnumPageFilesW(
    p_call_back_routine: ?PENUM_PAGE_FILE_CALLBACKW,
    p_context: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;

pub extern "kernel32" fn K32EnumPageFilesA(
    p_call_back_routine: ?PENUM_PAGE_FILE_CALLBACKA,
    p_context: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;

pub extern "kernel32" fn K32GetProcessImageFileNameA(
    h_process: ?HANDLE,
    lp_image_file_name: [*:0]u8,
    n_size: u32,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "kernel32" fn K32GetProcessImageFileNameW(
    h_process: ?HANDLE,
    lp_image_file_name: [*:0]u16,
    n_size: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
