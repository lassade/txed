...
pub extern "wevtapi" fn EvtGetLogInfo(
    log: isize,
    property_id: EVT_LOG_PROPERTY_ID,
    property_value_buffer_size: u32,
    // TODO: what to do with BytesParamIndex 2?
    property_value_buffer: ?*EVT_VARIANT,
...
pub extern "wevtapi" fn EvtNextChannelPath(
    channel_enum: isize,
    channel_path_buffer_size: u32,
    channel_path_buffer: ?[*:0]u16,
    channel_path_buffer_used: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wevtapi" fn EvtNextPublisherId(
    publisher_enum: isize,
    publisher_id_buffer_size: u32,
    publisher_id_buffer: ?[*:0]u16,
    publisher_id_buffer_used: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "wevtapi" fn EvtOpenPublisherMetadata(
    session: isize,
    publisher_id: ?[*:0]const u16,
    log_file_path: ?[*:0]const u16,
    locale: u32,
    flags: u32,
) callconv(@import("std").os.windows.WINAPI) isize;
...
pub extern "wevtapi" fn EvtGetPublisherMetadataProperty(
    ...
    flags: u32,
    publisher_metadata_property_buffer_size: u32,
    // TODO: what to do with BytesParamIndex 3?
    publisher_metadata_property_buffer: ?*EVT_VARIANT,
    publisher_metadata_property_buffer_used: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wevtapi" fn EvtNextEventMetadata(
    event_metadata_enum: isize,
    flags: u32,
) callconv(@import("std").os.windows.WINAPI) isize;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "wevtapi" fn EvtGetEventMetadataProperty(
    event_metadata: isize,
    property_id: EVT_EVENT_METADATA_PROPERTY_ID,
    flags: u32,
    event_metadata_property_buffer_size: u32,
    // TODO: what to do with BytesParamIndex 3?
    event_metadata_property_buffer: ?*EVT_VARIANT,
    event_metadata_property_buffer_used: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "wevtapi" fn EvtGetQueryInfo(
    query_or_subscription: isize,
    property_id: EVT_QUERY_PROPERTY_ID,
    property_value_buffer_size: u32,
    // TODO: what to do with BytesParamIndex 2?
    property_value_buffer: ?*EVT_VARIANT,
    property_value_buffer_used: ?*u32,
...
pub extern "wevtapi" fn EvtGetEventInfo(
    event: isize,
    property_id: EVT_EVENT_PROPERTY_ID,
    property_value_buffer_size: u32,
    // TODO: what to do with BytesParamIndex 2?
    property_value_buffer: ?*EVT_VARIANT,
    property_value_buffer_used: ?*u32,
...
pub extern "advapi32" fn ReadEventLogA(
    h_event_log: EventLogHandle,
    dw_read_flags: READ_EVENT_LOG_READ_FLAGS,
    dw_record_offset: u32,
    // TODO: what to do with BytesParamIndex 4?
    lp_buffer: ?*anyopaque,
    n_number_of_bytes_to_read: u32,
    pn_bytes_read: ?*u32,
    pn_min_number_of_bytes_needed: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
