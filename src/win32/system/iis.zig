...
pub const IFtpProviderConstruct = extern struct {
    pub const VTable = extern struct {
        ...
        Construct: *const fn (
            ...
            configuration_entries: ?*SAFEARRAY,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn construct(self: *const T, configuration_entries_: ?*SAFEARRAY) HRESULT {
                return @as(*const IFtpProviderConstruct.VTable, @ptrCast(self.vtable)).Construct(@as(*const IFtpProviderConstruct, @ptrCast(self)), configuration_entries_);
            }
        };
    }
...
pub const IFtpAuthenticationProvider = extern struct {
    pub const VTable = extern struct {
        ...
        AuthenticateUser: *const fn (
            ...
            psz_site_name: ?[*:0]const u16,
            psz_user_name: ?[*:0]const u16,
            psz_password: ?[*:0]const u16,
            ppsz_canonical_user_name: ?*?PWSTR,
            pf_authenticated: ?*BOOL,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn authenticateUser(self: *const T, psz_session_id_: ?[*:0]const u16, psz_site_name_: ?[*:0]const u16, psz_user_name_: ?[*:0]const u16, psz_password_: ?[*:0]const u16, ppsz_canonical_user_name_: ?*?PWSTR, pf_authenticated_: ?*BOOL) HRESULT {
                return @as(*const IFtpAuthenticationProvider.VTable, @ptrCast(self.vtable)).AuthenticateUser(@as(*const IFtpAuthenticationProvider, @ptrCast(self)), psz_session_id_, psz_site_name_, psz_user_name_, psz_password_, ppsz_canonical_user_name_, pf_authenticated_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const AsyncIFtpAuthenticationProvider = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn beginAuthenticateUser(self: *const T, psz_session_id_: ?[*:0]const u16, psz_site_name_: ?[*:0]const u16, psz_user_name_: ?[*:0]const u16, psz_password_: ?[*:0]const u16) HRESULT {
                return @as(*const AsyncIFtpAuthenticationProvider.VTable, @ptrCast(self.vtable)).Begin_AuthenticateUser(@as(*const AsyncIFtpAuthenticationProvider, @ptrCast(self)), psz_session_id_, psz_site_name_, psz_user_name_, psz_password_);
            }
            pub inline fn finishAuthenticateUser(self: *const T, ppsz_canonical_user_name_: ?*?PWSTR, pf_authenticated_: ?*BOOL) HRESULT {
                return @as(*const AsyncIFtpAuthenticationProvider.VTable, @ptrCast(self.vtable)).Finish_AuthenticateUser(@as(*const AsyncIFtpAuthenticationProvider, @ptrCast(self)), ppsz_canonical_user_name_, pf_authenticated_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IFtpRoleProvider = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn isUserInRole(self: *const T, psz_session_id_: ?[*:0]const u16, psz_site_name_: ?[*:0]const u16, psz_user_name_: ?[*:0]const u16, psz_role_: ?[*:0]const u16, pf_is_in_role_: ?*BOOL) HRESULT {
                return @as(*const IFtpRoleProvider.VTable, @ptrCast(self.vtable)).IsUserInRole(@as(*const IFtpRoleProvider, @ptrCast(self)), psz_session_id_, psz_site_name_, psz_user_name_, psz_role_, pf_is_in_role_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const AsyncIFtpRoleProvider = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn beginIsUserInRole(self: *const T, psz_session_id_: ?[*:0]const u16, psz_site_name_: ?[*:0]const u16, psz_user_name_: ?[*:0]const u16, psz_role_: ?[*:0]const u16) HRESULT {
                return @as(*const AsyncIFtpRoleProvider.VTable, @ptrCast(self.vtable)).Begin_IsUserInRole(@as(*const AsyncIFtpRoleProvider, @ptrCast(self)), psz_session_id_, psz_site_name_, psz_user_name_, psz_role_);
            }
            pub inline fn finishIsUserInRole(self: *const T, pf_is_in_role_: ?*BOOL) HRESULT {
                return @as(*const AsyncIFtpRoleProvider.VTable, @ptrCast(self.vtable)).Finish_IsUserInRole(@as(*const AsyncIFtpRoleProvider, @ptrCast(self)), pf_is_in_role_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IFtpHomeDirectoryProvider = extern struct {
    pub const VTable = extern struct {
        ...
        GetUserHomeDirectoryData: *const fn (
            ...
            psz_site_name: ?[*:0]const u16,
            psz_user_name: ?[*:0]const u16,
            ppsz_home_directory_data: ?*?PWSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getUserHomeDirectoryData(self: *const T, psz_session_id_: ?[*:0]const u16, psz_site_name_: ?[*:0]const u16, psz_user_name_: ?[*:0]const u16, ppsz_home_directory_data_: ?*?PWSTR) HRESULT {
                return @as(*const IFtpHomeDirectoryProvider.VTable, @ptrCast(self.vtable)).GetUserHomeDirectoryData(@as(*const IFtpHomeDirectoryProvider, @ptrCast(self)), psz_session_id_, psz_site_name_, psz_user_name_, ppsz_home_directory_data_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const AsyncIFtpHomeDirectoryProvider = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn beginGetUserHomeDirectoryData(self: *const T, psz_session_id_: ?[*:0]const u16, psz_site_name_: ?[*:0]const u16, psz_user_name_: ?[*:0]const u16) HRESULT {
                return @as(*const AsyncIFtpHomeDirectoryProvider.VTable, @ptrCast(self.vtable)).Begin_GetUserHomeDirectoryData(@as(*const AsyncIFtpHomeDirectoryProvider, @ptrCast(self)), psz_session_id_, psz_site_name_, psz_user_name_);
            }
            pub inline fn finishGetUserHomeDirectoryData(self: *const T, ppsz_home_directory_data_: ?*?PWSTR) HRESULT {
                return @as(*const AsyncIFtpHomeDirectoryProvider.VTable, @ptrCast(self.vtable)).Finish_GetUserHomeDirectoryData(@as(*const AsyncIFtpHomeDirectoryProvider, @ptrCast(self)), ppsz_home_directory_data_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IFtpLogProvider = extern struct {
    pub const VTable = extern struct {
        ...
        Log: *const fn (
            ...
            p_logging_parameters: ?*const LOGGING_PARAMETERS,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn log(self: *const T, p_logging_parameters_: ?*const LOGGING_PARAMETERS) HRESULT {
                return @as(*const IFtpLogProvider.VTable, @ptrCast(self.vtable)).Log(@as(*const IFtpLogProvider, @ptrCast(self)), p_logging_parameters_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const AsyncIFtpLogProvider = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn beginLog(self: *const T, p_logging_parameters_: ?*const LOGGING_PARAMETERS) HRESULT {
                return @as(*const AsyncIFtpLogProvider.VTable, @ptrCast(self.vtable)).Begin_Log(@as(*const AsyncIFtpLogProvider, @ptrCast(self)), p_logging_parameters_);
            }
            pub inline fn finishLog(self: *const T) HRESULT {
...
pub const IFtpAuthorizationProvider = extern struct {
    pub const VTable = extern struct {
        ...
        GetUserAccessPermission: *const fn (
            ...
            psz_session_id: ?[*:0]const u16,
            psz_site_name: ?[*:0]const u16,
            psz_virtual_path: ?[*:0]const u16,
            psz_user_name: ?[*:0]const u16,
            p_ftp_access: ?*FTP_ACCESS,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getUserAccessPermission(self: *const T, psz_session_id_: ?[*:0]const u16, psz_site_name_: ?[*:0]const u16, psz_virtual_path_: ?[*:0]const u16, psz_user_name_: ?[*:0]const u16, p_ftp_access_: ?*FTP_ACCESS) HRESULT {
                return @as(*const IFtpAuthorizationProvider.VTable, @ptrCast(self.vtable)).GetUserAccessPermission(@as(*const IFtpAuthorizationProvider, @ptrCast(self)), psz_session_id_, psz_site_name_, psz_virtual_path_, psz_user_name_, p_ftp_access_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const AsyncIFtpAuthorizationProvider = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn beginGetUserAccessPermission(self: *const T, psz_session_id_: ?[*:0]const u16, psz_site_name_: ?[*:0]const u16, psz_virtual_path_: ?[*:0]const u16, psz_user_name_: ?[*:0]const u16) HRESULT {
                return @as(*const AsyncIFtpAuthorizationProvider.VTable, @ptrCast(self.vtable)).Begin_GetUserAccessPermission(@as(*const AsyncIFtpAuthorizationProvider, @ptrCast(self)), psz_session_id_, psz_site_name_, psz_virtual_path_, psz_user_name_);
            }
            pub inline fn finishGetUserAccessPermission(self: *const T, p_ftp_access_: ?*FTP_ACCESS) HRESULT {
                return @as(*const AsyncIFtpAuthorizationProvider.VTable, @ptrCast(self.vtable)).Finish_GetUserAccessPermission(@as(*const AsyncIFtpAuthorizationProvider, @ptrCast(self)), p_ftp_access_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IFtpPreprocessProvider = extern struct {
    pub const VTable = extern struct {
        ...
        HandlePreprocess: *const fn (
            ...
            p_pre_process_parameters: ?*const PRE_PROCESS_PARAMETERS,
            p_ftp_process_status: ?*FTP_PROCESS_STATUS,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn handlePreprocess(self: *const T, p_pre_process_parameters_: ?*const PRE_PROCESS_PARAMETERS, p_ftp_process_status_: ?*FTP_PROCESS_STATUS) HRESULT {
                return @as(*const IFtpPreprocessProvider.VTable, @ptrCast(self.vtable)).HandlePreprocess(@as(*const IFtpPreprocessProvider, @ptrCast(self)), p_pre_process_parameters_, p_ftp_process_status_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const AsyncIFtpPreprocessProvider = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn beginHandlePreprocess(self: *const T, p_pre_process_parameters_: ?*const PRE_PROCESS_PARAMETERS) HRESULT {
                return @as(*const AsyncIFtpPreprocessProvider.VTable, @ptrCast(self.vtable)).Begin_HandlePreprocess(@as(*const AsyncIFtpPreprocessProvider, @ptrCast(self)), p_pre_process_parameters_);
            }
            pub inline fn finishHandlePreprocess(self: *const T, p_ftp_process_status_: ?*FTP_PROCESS_STATUS) HRESULT {
                return @as(*const AsyncIFtpPreprocessProvider.VTable, @ptrCast(self.vtable)).Finish_HandlePreprocess(@as(*const AsyncIFtpPreprocessProvider, @ptrCast(self)), p_ftp_process_status_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IFtpPostprocessProvider = extern struct {
    pub const VTable = extern struct {
        ...
        HandlePostprocess: *const fn (
            ...
            p_post_process_parameters: ?*const POST_PROCESS_PARAMETERS,
            p_ftp_process_status: ?*FTP_PROCESS_STATUS,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn handlePostprocess(self: *const T, p_post_process_parameters_: ?*const POST_PROCESS_PARAMETERS, p_ftp_process_status_: ?*FTP_PROCESS_STATUS) HRESULT {
                return @as(*const IFtpPostprocessProvider.VTable, @ptrCast(self.vtable)).HandlePostprocess(@as(*const IFtpPostprocessProvider, @ptrCast(self)), p_post_process_parameters_, p_ftp_process_status_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const AsyncIFtpPostprocessProvider = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn beginHandlePostprocess(self: *const T, p_post_process_parameters_: ?*const POST_PROCESS_PARAMETERS) HRESULT {
                return @as(*const AsyncIFtpPostprocessProvider.VTable, @ptrCast(self.vtable)).Begin_HandlePostprocess(@as(*const AsyncIFtpPostprocessProvider, @ptrCast(self)), p_post_process_parameters_);
            }
            pub inline fn finishHandlePostprocess(self: *const T, p_ftp_process_status_: ?*FTP_PROCESS_STATUS) HRESULT {
                return @as(*const AsyncIFtpPostprocessProvider.VTable, @ptrCast(self.vtable)).Finish_HandlePostprocess(@as(*const AsyncIFtpPostprocessProvider, @ptrCast(self)), p_ftp_process_status_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IADMEXT = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn enumDcomCLSIDs(self: *const T, pclsid_dcom_: ?*Guid, dw_enum_index_: u32) HRESULT {
                return @as(*const IADMEXT.VTable, @ptrCast(self.vtable)).EnumDcomCLSIDs(@as(*const IADMEXT, @ptrCast(self)), pclsid_dcom_, dw_enum_index_);
            }
...
pub const IMSAdminBaseW = extern struct {
    pub const VTable = extern struct {
        ...
        EnumKeys: *const fn (
            ...
            h_m_d_handle: u32,
            psz_m_d_path: ?[*:0]const u16,
            psz_m_d_name: *[256]u16,
            dw_m_d_enum_object_index: u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        CopyKey: *const fn (
            self: *const IMSAdminBaseW,
            h_m_d_source_handle: u32,
            psz_m_d_source_path: ?[*:0]const u16,
            h_m_d_dest_handle: u32,
            psz_m_d_dest_path: ?[*:0]const u16,
            b_m_d_overwrite_flag: BOOL,
            b_m_d_copy_flag: BOOL,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        RenameKey: *const fn (
            self: *const IMSAdminBaseW,
            h_m_d_handle: u32,
            psz_m_d_path: ?[*:0]const u16,
            psz_m_d_new_name: ?[*:0]const u16,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        SetData: *const fn (
            self: *const IMSAdminBaseW,
            h_m_d_handle: u32,
            psz_m_d_path: ?[*:0]const u16,
            pmdr_m_d_data: ?*METADATA_RECORD,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetData: *const fn (
            self: *const IMSAdminBaseW,
            h_m_d_handle: u32,
            psz_m_d_path: ?[*:0]const u16,
            pmdr_m_d_data: ?*METADATA_RECORD,
            pdw_m_d_required_data_len: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        DeleteData: *const fn (
            self: *const IMSAdminBaseW,
            h_m_d_handle: u32,
            psz_m_d_path: ?[*:0]const u16,
            dw_m_d_identifier: u32,
            dw_m_d_data_type: u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        EnumData: *const fn (
            self: *const IMSAdminBaseW,
            h_m_d_handle: u32,
        ...
        GetAllData: *const fn (
            ...
            h_m_d_handle: u32,
            psz_m_d_path: ?[*:0]const u16,
            dw_m_d_attributes: u32,
            dw_m_d_user_type: u32,
            dw_m_d_data_type: u32,
            pdw_m_d_num_data_entries: ?*u32,
            pdw_m_d_data_set_number: ?*u32,
            dw_m_d_buffer_size: u32,
            pb_m_d_buffer: ?*u8,
            pdw_m_d_required_buffer_size: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        OpenKey: *const fn (
            ...
            h_m_d_handle: u32,
            psz_m_d_path: ?[*:0]const u16,
            dw_m_d_access_requested: u32,
            dw_m_d_time_out: u32,
            ph_m_d_new_handle: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        CloseKey: *const fn (
            self: *const IMSAdminBaseW,
            h_m_d_handle: u32,
        ...
        GetHandleInfo: *const fn (
            self: *const IMSAdminBaseW,
            h_m_d_handle: u32,
            pmdhi_info: ?*METADATA_HANDLE_INFO,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetSystemChangeNumber: *const fn (
            self: *const IMSAdminBaseW,
            pdw_system_change_number: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        SetLastChangeTime: *const fn (
            ...
            h_m_d_handle: u32,
            psz_m_d_path: ?[*:0]const u16,
            pft_m_d_last_change_time: ?*FILETIME,
            b_local_time: BOOL,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        Backup: *const fn (
            self: *const IMSAdminBaseW,
            psz_m_d_backup_location: ?[*:0]const u16,
            dw_m_d_version: u32,
            dw_m_d_flags: u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Restore: *const fn (
        ...
        EnumBackups: *const fn (
            self: *const IMSAdminBaseW,
            psz_m_d_backup_location: *[256]u16,
            pdw_m_d_version: ?*u32,
            pft_m_d_backup_time: ?*FILETIME,
            dw_m_d_enum_index: u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        UnmarshalInterface: *const fn (
            self: *const IMSAdminBaseW,
            piadmbw_interface: ?*?*IMSAdminBaseW,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn addKey(self: *const T, h_m_d_handle_: u32, psz_m_d_path_: ?[*:0]const u16) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).AddKey(@as(*const IMSAdminBaseW, @ptrCast(self)), h_m_d_handle_, psz_m_d_path_);
            }
            pub inline fn deleteKey(self: *const T, h_m_d_handle_: u32, psz_m_d_path_: ?[*:0]const u16) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).DeleteKey(@as(*const IMSAdminBaseW, @ptrCast(self)), h_m_d_handle_, psz_m_d_path_);
            }
            pub inline fn deleteChildKeys(self: *const T, h_m_d_handle_: u32, psz_m_d_path_: ?[*:0]const u16) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).DeleteChildKeys(@as(*const IMSAdminBaseW, @ptrCast(self)), h_m_d_handle_, psz_m_d_path_);
            }
            pub inline fn enumKeys(self: *const T, h_m_d_handle_: u32, psz_m_d_path_: ?[*:0]const u16, psz_m_d_name_: *[256]u16, dw_m_d_enum_object_index_: u32) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).EnumKeys(@as(*const IMSAdminBaseW, @ptrCast(self)), h_m_d_handle_, psz_m_d_path_, psz_m_d_name_, dw_m_d_enum_object_index_);
            }
            pub inline fn copyKey(self: *const T, h_m_d_source_handle_: u32, psz_m_d_source_path_: ?[*:0]const u16, h_m_d_dest_handle_: u32, psz_m_d_dest_path_: ?[*:0]const u16, b_m_d_overwrite_flag_: BOOL, b_m_d_copy_flag_: BOOL) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).CopyKey(@as(*const IMSAdminBaseW, @ptrCast(self)), h_m_d_source_handle_, psz_m_d_source_path_, h_m_d_dest_handle_, psz_m_d_dest_path_, b_m_d_overwrite_flag_, b_m_d_copy_flag_);
            }
            pub inline fn renameKey(self: *const T, h_m_d_handle_: u32, psz_m_d_path_: ?[*:0]const u16, psz_m_d_new_name_: ?[*:0]const u16) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).RenameKey(@as(*const IMSAdminBaseW, @ptrCast(self)), h_m_d_handle_, psz_m_d_path_, psz_m_d_new_name_);
            }
            pub inline fn setData(self: *const T, h_m_d_handle_: u32, psz_m_d_path_: ?[*:0]const u16, pmdr_m_d_data_: ?*METADATA_RECORD) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).SetData(@as(*const IMSAdminBaseW, @ptrCast(self)), h_m_d_handle_, psz_m_d_path_, pmdr_m_d_data_);
            }
            pub inline fn getData(self: *const T, h_m_d_handle_: u32, psz_m_d_path_: ?[*:0]const u16, pmdr_m_d_data_: ?*METADATA_RECORD, pdw_m_d_required_data_len_: ?*u32) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).GetData(@as(*const IMSAdminBaseW, @ptrCast(self)), h_m_d_handle_, psz_m_d_path_, pmdr_m_d_data_, pdw_m_d_required_data_len_);
            }
            pub inline fn deleteData(self: *const T, h_m_d_handle_: u32, psz_m_d_path_: ?[*:0]const u16, dw_m_d_identifier_: u32, dw_m_d_data_type_: u32) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).DeleteData(@as(*const IMSAdminBaseW, @ptrCast(self)), h_m_d_handle_, psz_m_d_path_, dw_m_d_identifier_, dw_m_d_data_type_);
            }
            pub inline fn enumData(self: *const T, h_m_d_handle_: u32, psz_m_d_path_: ?[*:0]const u16, pmdr_m_d_data_: ?*METADATA_RECORD, dw_m_d_enum_data_index_: u32, pdw_m_d_required_data_len_: ?*u32) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).EnumData(@as(*const IMSAdminBaseW, @ptrCast(self)), h_m_d_handle_, psz_m_d_path_, pmdr_m_d_data_, dw_m_d_enum_data_index_, pdw_m_d_required_data_len_);
            }
            pub inline fn getAllData(self: *const T, h_m_d_handle_: u32, psz_m_d_path_: ?[*:0]const u16, dw_m_d_attributes_: u32, dw_m_d_user_type_: u32, dw_m_d_data_type_: u32, pdw_m_d_num_data_entries_: ?*u32, pdw_m_d_data_set_number_: ?*u32, dw_m_d_buffer_size_: u32, pb_m_d_buffer_: ?*u8, pdw_m_d_required_buffer_size_: ?*u32) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).GetAllData(@as(*const IMSAdminBaseW, @ptrCast(self)), h_m_d_handle_, psz_m_d_path_, dw_m_d_attributes_, dw_m_d_user_type_, dw_m_d_data_type_, pdw_m_d_num_data_entries_, pdw_m_d_data_set_number_, dw_m_d_buffer_size_, pb_m_d_buffer_, pdw_m_d_required_buffer_size_);
            }
            pub inline fn deleteAllData(self: *const T, h_m_d_handle_: u32, psz_m_d_path_: ?[*:0]const u16, dw_m_d_user_type_: u32, dw_m_d_data_type_: u32) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).DeleteAllData(@as(*const IMSAdminBaseW, @ptrCast(self)), h_m_d_handle_, psz_m_d_path_, dw_m_d_user_type_, dw_m_d_data_type_);
            }
            pub inline fn copyData(self: *const T, h_m_d_source_handle_: u32, psz_m_d_source_path_: ?[*:0]const u16, h_m_d_dest_handle_: u32, psz_m_d_dest_path_: ?[*:0]const u16, dw_m_d_attributes_: u32, dw_m_d_user_type_: u32, dw_m_d_data_type_: u32, b_m_d_copy_flag_: BOOL) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).CopyData(@as(*const IMSAdminBaseW, @ptrCast(self)), h_m_d_source_handle_, psz_m_d_source_path_, h_m_d_dest_handle_, psz_m_d_dest_path_, dw_m_d_attributes_, dw_m_d_user_type_, dw_m_d_data_type_, b_m_d_copy_flag_);
            }
            pub inline fn getDataPaths(self: *const T, h_m_d_handle_: u32, psz_m_d_path_: ?[*:0]const u16, dw_m_d_identifier_: u32, dw_m_d_data_type_: u32, dw_m_d_buffer_size_: u32, psz_buffer_: [*:0]u16, pdw_m_d_required_buffer_size_: ?*u32) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).GetDataPaths(@as(*const IMSAdminBaseW, @ptrCast(self)), h_m_d_handle_, psz_m_d_path_, dw_m_d_identifier_, dw_m_d_data_type_, dw_m_d_buffer_size_, psz_buffer_, pdw_m_d_required_buffer_size_);
            }
            pub inline fn openKey(self: *const T, h_m_d_handle_: u32, psz_m_d_path_: ?[*:0]const u16, dw_m_d_access_requested_: u32, dw_m_d_time_out_: u32, ph_m_d_new_handle_: ?*u32) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).OpenKey(@as(*const IMSAdminBaseW, @ptrCast(self)), h_m_d_handle_, psz_m_d_path_, dw_m_d_access_requested_, dw_m_d_time_out_, ph_m_d_new_handle_);
            }
            pub inline fn closeKey(self: *const T, h_m_d_handle_: u32) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).CloseKey(@as(*const IMSAdminBaseW, @ptrCast(self)), h_m_d_handle_);
            }
            pub inline fn changePermissions(self: *const T, h_m_d_handle_: u32, dw_m_d_time_out_: u32, dw_m_d_access_requested_: u32) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).ChangePermissions(@as(*const IMSAdminBaseW, @ptrCast(self)), h_m_d_handle_, dw_m_d_time_out_, dw_m_d_access_requested_);
            }
            ...
            pub inline fn getHandleInfo(self: *const T, h_m_d_handle_: u32, pmdhi_info_: ?*METADATA_HANDLE_INFO) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).GetHandleInfo(@as(*const IMSAdminBaseW, @ptrCast(self)), h_m_d_handle_, pmdhi_info_);
            }
            pub inline fn getSystemChangeNumber(self: *const T, pdw_system_change_number_: ?*u32) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).GetSystemChangeNumber(@as(*const IMSAdminBaseW, @ptrCast(self)), pdw_system_change_number_);
            }
            pub inline fn getDataSetNumber(self: *const T, h_m_d_handle_: u32, psz_m_d_path_: ?[*:0]const u16, pdw_m_d_data_set_number_: ?*u32) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).GetDataSetNumber(@as(*const IMSAdminBaseW, @ptrCast(self)), h_m_d_handle_, psz_m_d_path_, pdw_m_d_data_set_number_);
            }
            pub inline fn setLastChangeTime(self: *const T, h_m_d_handle_: u32, psz_m_d_path_: ?[*:0]const u16, pft_m_d_last_change_time_: ?*FILETIME, b_local_time_: BOOL) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).SetLastChangeTime(@as(*const IMSAdminBaseW, @ptrCast(self)), h_m_d_handle_, psz_m_d_path_, pft_m_d_last_change_time_, b_local_time_);
            }
            pub inline fn getLastChangeTime(self: *const T, h_m_d_handle_: u32, psz_m_d_path_: ?[*:0]const u16, pft_m_d_last_change_time_: ?*FILETIME, b_local_time_: BOOL) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).GetLastChangeTime(@as(*const IMSAdminBaseW, @ptrCast(self)), h_m_d_handle_, psz_m_d_path_, pft_m_d_last_change_time_, b_local_time_);
            }
            pub inline fn keyExchangePhase1(self: *const T) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).KeyExchangePhase1(@as(*const IMSAdminBaseW, @ptrCast(self)));
            }
            pub inline fn keyExchangePhase2(self: *const T) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).KeyExchangePhase2(@as(*const IMSAdminBaseW, @ptrCast(self)));
            }
            pub inline fn backup(self: *const T, psz_m_d_backup_location_: ?[*:0]const u16, dw_m_d_version_: u32, dw_m_d_flags_: u32) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).Backup(@as(*const IMSAdminBaseW, @ptrCast(self)), psz_m_d_backup_location_, dw_m_d_version_, dw_m_d_flags_);
            }
            pub inline fn restore(self: *const T, psz_m_d_backup_location_: ?[*:0]const u16, dw_m_d_version_: u32, dw_m_d_flags_: u32) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).Restore(@as(*const IMSAdminBaseW, @ptrCast(self)), psz_m_d_backup_location_, dw_m_d_version_, dw_m_d_flags_);
            }
            pub inline fn enumBackups(self: *const T, psz_m_d_backup_location_: *[256]u16, pdw_m_d_version_: ?*u32, pft_m_d_backup_time_: ?*FILETIME, dw_m_d_enum_index_: u32) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).EnumBackups(@as(*const IMSAdminBaseW, @ptrCast(self)), psz_m_d_backup_location_, pdw_m_d_version_, pft_m_d_backup_time_, dw_m_d_enum_index_);
            }
            pub inline fn deleteBackup(self: *const T, psz_m_d_backup_location_: ?[*:0]const u16, dw_m_d_version_: u32) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).DeleteBackup(@as(*const IMSAdminBaseW, @ptrCast(self)), psz_m_d_backup_location_, dw_m_d_version_);
            }
            pub inline fn unmarshalInterface(self: *const T, piadmbw_interface_: ?*?*IMSAdminBaseW) HRESULT {
                return @as(*const IMSAdminBaseW.VTable, @ptrCast(self.vtable)).UnmarshalInterface(@as(*const IMSAdminBaseW, @ptrCast(self)), piadmbw_interface_);
            }
            pub inline fn getServerGuid(self: *const T) HRESULT {
...
pub const IMSAdminBase2W = extern struct {
    pub const VTable = extern struct {
        ...
        Import: *const fn (
            ...
            psz_file_name: ?[*:0]const u16,
            psz_source_path: ?[*:0]const u16,
            psz_dest_path: ?[*:0]const u16,
            dw_m_d_flags: u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        RestoreHistory: *const fn (
            self: *const IMSAdminBase2W,
            psz_m_d_history_location: ?[*:0]const u16,
            dw_m_d_major_version: u32,
            dw_m_d_minor_version: u32,
            dw_m_d_flags: u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        EnumHistory: *const fn (
            self: *const IMSAdminBase2W,
            psz_m_d_history_location: *[256]u16,
            pdw_m_d_major_version: ?*u32,
            pdw_m_d_minor_version: ?*u32,
            pft_m_d_history_time: ?*FILETIME,
            dw_m_d_enum_index: u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn backupWithPasswd(self: *const T, psz_m_d_backup_location_: ?[*:0]const u16, dw_m_d_version_: u32, dw_m_d_flags_: u32, psz_passwd_: ?[*:0]const u16) HRESULT {
                return @as(*const IMSAdminBase2W.VTable, @ptrCast(self.vtable)).BackupWithPasswd(@as(*const IMSAdminBase2W, @ptrCast(self)), psz_m_d_backup_location_, dw_m_d_version_, dw_m_d_flags_, psz_passwd_);
            }
            pub inline fn restoreWithPasswd(self: *const T, psz_m_d_backup_location_: ?[*:0]const u16, dw_m_d_version_: u32, dw_m_d_flags_: u32, psz_passwd_: ?[*:0]const u16) HRESULT {
                return @as(*const IMSAdminBase2W.VTable, @ptrCast(self.vtable)).RestoreWithPasswd(@as(*const IMSAdminBase2W, @ptrCast(self)), psz_m_d_backup_location_, dw_m_d_version_, dw_m_d_flags_, psz_passwd_);
            }
            pub inline fn @"export"(self: *const T, psz_passwd_: ?[*:0]const u16, psz_file_name_: ?[*:0]const u16, psz_source_path_: ?[*:0]const u16, dw_m_d_flags_: u32) HRESULT {
                return @as(*const IMSAdminBase2W.VTable, @ptrCast(self.vtable)).Export(@as(*const IMSAdminBase2W, @ptrCast(self)), psz_passwd_, psz_file_name_, psz_source_path_, dw_m_d_flags_);
            }
            pub inline fn import(self: *const T, psz_passwd_: ?[*:0]const u16, psz_file_name_: ?[*:0]const u16, psz_source_path_: ?[*:0]const u16, psz_dest_path_: ?[*:0]const u16, dw_m_d_flags_: u32) HRESULT {
                return @as(*const IMSAdminBase2W.VTable, @ptrCast(self.vtable)).Import(@as(*const IMSAdminBase2W, @ptrCast(self)), psz_passwd_, psz_file_name_, psz_source_path_, psz_dest_path_, dw_m_d_flags_);
            }
            pub inline fn restoreHistory(self: *const T, psz_m_d_history_location_: ?[*:0]const u16, dw_m_d_major_version_: u32, dw_m_d_minor_version_: u32, dw_m_d_flags_: u32) HRESULT {
                return @as(*const IMSAdminBase2W.VTable, @ptrCast(self.vtable)).RestoreHistory(@as(*const IMSAdminBase2W, @ptrCast(self)), psz_m_d_history_location_, dw_m_d_major_version_, dw_m_d_minor_version_, dw_m_d_flags_);
            }
            pub inline fn enumHistory(self: *const T, psz_m_d_history_location_: *[256]u16, pdw_m_d_major_version_: ?*u32, pdw_m_d_minor_version_: ?*u32, pft_m_d_history_time_: ?*FILETIME, dw_m_d_enum_index_: u32) HRESULT {
                return @as(*const IMSAdminBase2W.VTable, @ptrCast(self.vtable)).EnumHistory(@as(*const IMSAdminBase2W, @ptrCast(self)), psz_m_d_history_location_, pdw_m_d_major_version_, pdw_m_d_minor_version_, pft_m_d_history_time_, dw_m_d_enum_index_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IMSAdminBase3W = extern struct {
    pub const VTable = extern struct {
        ...
        GetChildPaths: *const fn (
            ...
            h_m_d_handle: u32,
            psz_m_d_path: ?[*:0]const u16,
            cch_m_d_buffer_size: u32,
            psz_buffer: ?[*:0]u16,
            pcch_m_d_required_buffer_size: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getChildPaths(self: *const T, h_m_d_handle_: u32, psz_m_d_path_: ?[*:0]const u16, cch_m_d_buffer_size_: u32, psz_buffer_: ?[*:0]u16, pcch_m_d_required_buffer_size_: ?*u32) HRESULT {
                return @as(*const IMSAdminBase3W.VTable, @ptrCast(self.vtable)).GetChildPaths(@as(*const IMSAdminBase3W, @ptrCast(self)), h_m_d_handle_, psz_m_d_path_, cch_m_d_buffer_size_, psz_buffer_, pcch_m_d_required_buffer_size_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IMSImpExpHelpW = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn enumeratePathsInFile(self: *const T, psz_file_name_: ?[*:0]const u16, psz_key_type_: ?[*:0]const u16, dw_m_d_buffer_size_: u32, psz_buffer_: ?[*:0]u16, pdw_m_d_required_buffer_size_: ?*u32) HRESULT {
                return @as(*const IMSImpExpHelpW.VTable, @ptrCast(self.vtable)).EnumeratePathsInFile(@as(*const IMSImpExpHelpW, @ptrCast(self)), psz_file_name_, psz_key_type_, dw_m_d_buffer_size_, psz_buffer_, pdw_m_d_required_buffer_size_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IMSAdminBaseSinkW = extern struct {
    pub const VTable = extern struct {
        ...
        SinkNotify: *const fn (
            ...
            dw_m_d_num_elements: u32,
            pco_change_list: [*]MD_CHANGE_OBJECT_W,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn sinkNotify(self: *const T, dw_m_d_num_elements_: u32, pco_change_list_: [*]MD_CHANGE_OBJECT_W) HRESULT {
                return @as(*const IMSAdminBaseSinkW.VTable, @ptrCast(self.vtable)).SinkNotify(@as(*const IMSAdminBaseSinkW, @ptrCast(self)), dw_m_d_num_elements_, pco_change_list_);
            }
            pub inline fn shutdownNotify(self: *const T) HRESULT {
...
pub const AsyncIMSAdminBaseSinkW = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn beginSinkNotify(self: *const T, dw_m_d_num_elements_: u32, pco_change_list_: [*]MD_CHANGE_OBJECT_W) HRESULT {
                return @as(*const AsyncIMSAdminBaseSinkW.VTable, @ptrCast(self.vtable)).Begin_SinkNotify(@as(*const AsyncIMSAdminBaseSinkW, @ptrCast(self)), dw_m_d_num_elements_, pco_change_list_);
            }
            pub inline fn finishSinkNotify(self: *const T) HRESULT {
            ...
            pub inline fn beginShutdownNotify(self: *const T) HRESULT {
            ...
            pub inline fn finishShutdownNotify(self: *const T) HRESULT {
...
pub const PFN_HSE_IO_COMPLETION = *const fn (
    p_e_c_b: ?*EXTENSION_CONTROL_BLOCK,
    p_context: ?*anyopaque,
    cb_i_o: u32,
    dw_error: u32,
...
pub const PFN_HSE_GET_PROTOCOL_MANAGER_CUSTOM_INTERFACE_CALLBACK = *const fn (
    psz_protocol_manager_dll: ?[*:0]const u16,
    psz_protocol_manager_dll_init_function: ?[*:0]const u16,
    dw_custom_interface_id: u32,
    pp_custom_interface: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub const PFN_GETEXTENSIONVERSION = *const fn (
    p_ver: ?*HSE_VERSION_INFO,
...
pub const PFN_WEB_CORE_SET_METADATA_DLL_ENTRY = *const fn (
    psz_metadata_type: ?[*:0]const u16,
    psz_value: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub const PFN_WEB_CORE_ACTIVATE = *const fn (
    psz_app_host_config_file: ?[*:0]const u16,
    psz_root_web_config_file: ?[*:0]const u16,
    psz_instance_name: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "rpcproxy" fn HttpFilterProc(
    ...
    pv_notification: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "rpcproxy" fn GetFilterVersion(
    p_ver: ?*HTTP_FILTER_VERSION,
) callconv(@import("std").os.windows.WINAPI) BOOL;
