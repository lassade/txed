...
pub extern "advapi32" fn InitiateSystemShutdownA(
    ...
    lp_message: ?PSTR,
    dw_timeout: u32,
    b_force_apps_closed: BOOL,
    b_reboot_after_shutdown: BOOL,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "advapi32" fn InitiateSystemShutdownW(
    lp_machine_name: ?PWSTR,
    lp_message: ?PWSTR,
    dw_timeout: u32,
    b_force_apps_closed: BOOL,
    b_reboot_after_shutdown: BOOL,
...
pub extern "advapi32" fn InitiateShutdownA(
    ...
    lp_message: ?PSTR,
    dw_grace_period: u32,
    dw_shutdown_flags: SHUTDOWN_FLAGS,
    dw_reason: SHUTDOWN_REASON,
...
pub extern "advapi32" fn CheckForHiberboot(
    p_hiberboot: ?*BOOLEAN,
    b_clear_flag: BOOLEAN,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "user32" fn ExitWindowsEx(
    u_flags: EXIT_WINDOWS_FLAGS,
    dw_reason: SHUTDOWN_REASON,
) callconv(@import("std").os.windows.WINAPI) BOOL;
