...
// TODO: this type is limited to platform 'windows5.0'
pub extern "advapi32" fn RegDisablePredefinedCache() callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "advapi32" fn RegDisablePredefinedCacheEx() callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;
...
pub extern "advapi32" fn RegCreateKeyExA(
    ...
    phk_result: ?*?HKEY,
    lpdw_disposition: ?*REG_CREATE_KEY_DISPOSITION,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;
...
pub extern "advapi32" fn RegCreateKeyTransactedA(
    ...
    p_extended_paremeter: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;
...
pub extern "advapi32" fn RegDeleteKeyTransactedA(
    ...
    reserved: u32,
    h_transaction: ?HANDLE,
    p_extended_parameter: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;
...
pub extern "advapi32" fn RegQueryReflectionKey(
    h_base: ?HKEY,
    b_is_reflection_disabled: ?*BOOL,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;

// TODO: this type is limited to platform 'windows5.0'
pub extern "advapi32" fn RegDeleteValueA(
    h_key: ?HKEY,
    lp_value_name: ?[*:0]const u8,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;
...
pub extern "advapi32" fn RegReplaceKeyA(
    h_key: ?HKEY,
    lp_sub_key: ?[*:0]const u8,
    lp_new_file: ?[*:0]const u8,
    lp_old_file: ?[*:0]const u8,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;
...
pub extern "advapi32" fn RegReplaceKeyW(
    h_key: ?HKEY,
    lp_sub_key: ?[*:0]const u16,
    lp_new_file: ?[*:0]const u16,
    lp_old_file: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;
...
pub extern "advapi32" fn RegRenameKey(
    h_key: ?HKEY,
    lp_sub_key_name: ?[*:0]const u16,
    lp_new_key_name: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;
...
pub extern "api-ms-win-core-state-helpers-l1-1-0" fn GetRegistryValueWithFallbackW(
    hkey_primary: ?HKEY,
    pwsz_primary_sub_key: ?[*:0]const u16,
    hkey_fallback: ?HKEY,
    pwsz_fallback_sub_key: ?[*:0]const u16,
