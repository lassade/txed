...
pub extern "kernel32" fn IsUserCetAvailableInEnvironment(
    user_cet_environment: USER_CET_ENVIRONMENT,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "kernel32" fn GetSystemTimeAdjustment(
    lp_time_adjustment: ?*u32,
    lp_time_increment: ?*u32,
    lp_time_adjustment_disabled: ?*BOOL,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows10.0.10240'
pub extern "api-ms-win-core-sysinfo-l1-2-4" fn GetSystemTimeAdjustmentPrecise(
    lp_time_adjustment: ?*u64,
    lp_time_increment: ?*u64,
    lp_time_adjustment_disabled: ?*BOOL,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "kernel32" fn GetVersionExA(
    lp_version_information: ?*OSVERSIONINFOA,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.0'
pub extern "kernel32" fn GetVersionExW(
    lp_version_information: ?*OSVERSIONINFOW,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "kernel32" fn GetProductInfo(
    dw_o_s_major_version: u32,
    dw_o_s_minor_version: u32,
    dw_sp_major_version: u32,
    dw_sp_minor_version: u32,
    pdw_returned_product_type: ?*OS_PRODUCT_TYPE,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "kernel32" fn EnumSystemFirmwareTables(
    ...
    // TODO: what to do with BytesParamIndex 2?
    p_firmware_table_enum_buffer: ?*FIRMWARE_TABLE_ID,
    buffer_size: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "kernel32" fn GetSystemFirmwareTable(
    firmware_table_provider_signature: FIRMWARE_TABLE_PROVIDER,
    firmware_table_i_d: FIRMWARE_TABLE_ID,
    // TODO: what to do with BytesParamIndex 3?
    p_firmware_table_buffer: ?*anyopaque,
    buffer_size: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "kernel32" fn SetSystemTimeAdjustment(
    ...
    b_time_adjustment_disabled: BOOL,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "kernel32" fn IsWow64GuestMachineSupported(
    wow_guest_machine: u16,
    machine_is_supported: ?*BOOL,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "ntdll" fn RtlGetProductInfo(
    o_s_major_version: u32,
    o_s_minor_version: u32,
    sp_major_version: u32,
    sp_minor_version: u32,
    returned_product_type: ?*u32,
...
pub extern "ntdll" fn RtlGetDeviceFamilyInfoEnum(
    pull_u_a_p_info: ?*u64,
    pul_device_family: ?*DEVICEFAMILYINFOENUM,
    pul_device_form: ?*DEVICEFAMILYDEVICEFORM,
) callconv(@import("std").os.windows.WINAPI) void;

pub extern "ntdll" fn RtlConvertDeviceFamilyInfoToString(
    pul_device_family_buffer_size: ?*u32,
    pul_device_form_buffer_size: ?*u32,
...
pub extern "kernel32" fn VerifyVersionInfoA(
    lp_version_information: ?*OSVERSIONINFOEXA,
...
pub extern "kernel32" fn VerifyVersionInfoW(
    lp_version_information: ?*OSVERSIONINFOEXW,
    dw_type_mask: VER_FLAGS,
    dwl_condition_mask: u64,
) callconv(@import("std").os.windows.WINAPI) BOOL;
