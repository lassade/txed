...
pub const PBAD_MEMORY_CALLBACK_ROUTINE = *const fn () callconv(@import("std").os.windows.WINAPI) void;
...
pub extern "kernel32" fn HeapSummary(
    h_heap: ?HANDLE,
    dw_flags: u32,
    lp_summary: ?*HEAP_SUMMARY,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "kernel32" fn GetProcessHeaps(
    number_of_heaps: u32,
    process_heaps: [*]?HeapHandle,
...
pub extern "kernel32" fn VirtualProtect(
    ...
    lpfl_old_protect: ?*PAGE_PROTECTION_FLAGS,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "kernel32" fn VirtualQuery(
    ...
    lp_buffer: ?*MEMORY_BASIC_INFORMATION,
    dw_length: usize,
) callconv(@import("std").os.windows.WINAPI) usize;
...
pub extern "kernel32" fn CreateFileMappingW(
    h_file: ?HANDLE,
    lp_file_mapping_attributes: ?*SECURITY_ATTRIBUTES,
    fl_protect: PAGE_PROTECTION_FLAGS,
...
pub extern "kernel32" fn GetWriteWatch(
    dw_flags: u32,
    lp_base_address: ?*anyopaque,
    dw_region_size: usize,
    lp_addresses: ?[*]?*anyopaque,
    lpdw_count: ?*usize,
    lpdw_granularity: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "kernel32" fn QueryMemoryResourceNotification(
    resource_notification_handle: ?HANDLE,
    resource_state: ?*BOOL,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "kernel32" fn GetSystemFileCacheSize(
    lp_minimum_file_cache_size: ?*usize,
    lp_maximum_file_cache_size: ?*usize,
    lp_flags: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "kernel32" fn PrefetchVirtualMemory(
    ...
    virtual_addresses: [*]WIN32_MEMORY_RANGE_ENTRY,
    flags: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "api-ms-win-core-memory-l1-1-3" fn SetProcessValidCallTargets(
    ...
    offset_information: [*]CFG_CALL_TARGET_INFO,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "api-ms-win-core-memory-l1-1-8" fn QueryPartitionInformation(
    ...
    // TODO: what to do with BytesParamIndex 3?
    partition_information: ?*anyopaque,
