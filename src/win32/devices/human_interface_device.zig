...
pub const IDirectInputEffect = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn initialize(self: *const T, param0_: ?HINSTANCE, param1_: u32, param2_: ?*const Guid) HRESULT {
                return @as(*const IDirectInputEffect.VTable, @ptrCast(self.vtable)).Initialize(@as(*const IDirectInputEffect, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn getEffectGuid(self: *const T, param0_: ?*Guid) HRESULT {
                return @as(*const IDirectInputEffect.VTable, @ptrCast(self.vtable)).GetEffectGuid(@as(*const IDirectInputEffect, @ptrCast(self)), param0_);
            }
            pub inline fn getParameters(self: *const T, param0_: ?*DIEFFECT, param1_: u32) HRESULT {
                return @as(*const IDirectInputEffect.VTable, @ptrCast(self.vtable)).GetParameters(@as(*const IDirectInputEffect, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn setParameters(self: *const T, param0_: ?*DIEFFECT, param1_: u32) HRESULT {
                return @as(*const IDirectInputEffect.VTable, @ptrCast(self.vtable)).SetParameters(@as(*const IDirectInputEffect, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn start(self: *const T, param0_: u32, param1_: u32) HRESULT {
                return @as(*const IDirectInputEffect.VTable, @ptrCast(self.vtable)).Start(@as(*const IDirectInputEffect, @ptrCast(self)), param0_, param1_);
            }
            ...
            pub inline fn getEffectStatus(self: *const T, param0_: ?*u32) HRESULT {
                return @as(*const IDirectInputEffect.VTable, @ptrCast(self.vtable)).GetEffectStatus(@as(*const IDirectInputEffect, @ptrCast(self)), param0_);
            }
            ...
            pub inline fn escape(self: *const T, param0_: ?*DIEFFESCAPE) HRESULT {
                return @as(*const IDirectInputEffect.VTable, @ptrCast(self.vtable)).Escape(@as(*const IDirectInputEffect, @ptrCast(self)), param0_);
            }
        };
    }
...
pub const IDirectInputDeviceW = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getCapabilities(self: *const T, param0_: ?*DIDEVCAPS) HRESULT {
                return @as(*const IDirectInputDeviceW.VTable, @ptrCast(self.vtable)).GetCapabilities(@as(*const IDirectInputDeviceW, @ptrCast(self)), param0_);
            }
            pub inline fn enumObjects(self: *const T, param0_: ?LPDIENUMDEVICEOBJECTSCALLBACKW, param1_: ?*anyopaque, param2_: u32) HRESULT {
                return @as(*const IDirectInputDeviceW.VTable, @ptrCast(self.vtable)).EnumObjects(@as(*const IDirectInputDeviceW, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn getProperty(self: *const T, param0_: ?*const Guid, param1_: ?*DIPROPHEADER) HRESULT {
                return @as(*const IDirectInputDeviceW.VTable, @ptrCast(self.vtable)).GetProperty(@as(*const IDirectInputDeviceW, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn setProperty(self: *const T, param0_: ?*const Guid, param1_: ?*DIPROPHEADER) HRESULT {
                return @as(*const IDirectInputDeviceW.VTable, @ptrCast(self.vtable)).SetProperty(@as(*const IDirectInputDeviceW, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn acquire(self: *const T) HRESULT {
                return @as(*const IDirectInputDeviceW.VTable, @ptrCast(self.vtable)).Acquire(@as(*const IDirectInputDeviceW, @ptrCast(self)));
            }
            pub inline fn unacquire(self: *const T) HRESULT {
                return @as(*const IDirectInputDeviceW.VTable, @ptrCast(self.vtable)).Unacquire(@as(*const IDirectInputDeviceW, @ptrCast(self)));
            }
            pub inline fn getDeviceState(self: *const T, param0_: u32, param1_: ?*anyopaque) HRESULT {
                return @as(*const IDirectInputDeviceW.VTable, @ptrCast(self.vtable)).GetDeviceState(@as(*const IDirectInputDeviceW, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getDeviceData(self: *const T, param0_: u32, param1_: ?*DIDEVICEOBJECTDATA, param2_: ?*u32, param3_: u32) HRESULT {
                return @as(*const IDirectInputDeviceW.VTable, @ptrCast(self.vtable)).GetDeviceData(@as(*const IDirectInputDeviceW, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn setDataFormat(self: *const T, param0_: ?*DIDATAFORMAT) HRESULT {
                return @as(*const IDirectInputDeviceW.VTable, @ptrCast(self.vtable)).SetDataFormat(@as(*const IDirectInputDeviceW, @ptrCast(self)), param0_);
            }
            pub inline fn setEventNotification(self: *const T, param0_: ?HANDLE) HRESULT {
                return @as(*const IDirectInputDeviceW.VTable, @ptrCast(self.vtable)).SetEventNotification(@as(*const IDirectInputDeviceW, @ptrCast(self)), param0_);
            }
            pub inline fn setCooperativeLevel(self: *const T, param0_: ?HWND, param1_: u32) HRESULT {
                return @as(*const IDirectInputDeviceW.VTable, @ptrCast(self.vtable)).SetCooperativeLevel(@as(*const IDirectInputDeviceW, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getObjectInfo(self: *const T, param0_: ?*DIDEVICEOBJECTINSTANCEW, param1_: u32, param2_: u32) HRESULT {
                return @as(*const IDirectInputDeviceW.VTable, @ptrCast(self.vtable)).GetObjectInfo(@as(*const IDirectInputDeviceW, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn getDeviceInfo(self: *const T, param0_: ?*DIDEVICEINSTANCEW) HRESULT {
                return @as(*const IDirectInputDeviceW.VTable, @ptrCast(self.vtable)).GetDeviceInfo(@as(*const IDirectInputDeviceW, @ptrCast(self)), param0_);
            }
            pub inline fn runControlPanel(self: *const T, param0_: ?HWND, param1_: u32) HRESULT {
                return @as(*const IDirectInputDeviceW.VTable, @ptrCast(self.vtable)).RunControlPanel(@as(*const IDirectInputDeviceW, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn initialize(self: *const T, param0_: ?HINSTANCE, param1_: u32, param2_: ?*const Guid) HRESULT {
                return @as(*const IDirectInputDeviceW.VTable, @ptrCast(self.vtable)).Initialize(@as(*const IDirectInputDeviceW, @ptrCast(self)), param0_, param1_, param2_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectInputDeviceA = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getCapabilities(self: *const T, param0_: ?*DIDEVCAPS) HRESULT {
                return @as(*const IDirectInputDeviceA.VTable, @ptrCast(self.vtable)).GetCapabilities(@as(*const IDirectInputDeviceA, @ptrCast(self)), param0_);
            }
            pub inline fn enumObjects(self: *const T, param0_: ?LPDIENUMDEVICEOBJECTSCALLBACKA, param1_: ?*anyopaque, param2_: u32) HRESULT {
                return @as(*const IDirectInputDeviceA.VTable, @ptrCast(self.vtable)).EnumObjects(@as(*const IDirectInputDeviceA, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn getProperty(self: *const T, param0_: ?*const Guid, param1_: ?*DIPROPHEADER) HRESULT {
                return @as(*const IDirectInputDeviceA.VTable, @ptrCast(self.vtable)).GetProperty(@as(*const IDirectInputDeviceA, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn setProperty(self: *const T, param0_: ?*const Guid, param1_: ?*DIPROPHEADER) HRESULT {
                return @as(*const IDirectInputDeviceA.VTable, @ptrCast(self.vtable)).SetProperty(@as(*const IDirectInputDeviceA, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn acquire(self: *const T) HRESULT {
            ...
            pub inline fn getDeviceState(self: *const T, param0_: u32, param1_: ?*anyopaque) HRESULT {
                return @as(*const IDirectInputDeviceA.VTable, @ptrCast(self.vtable)).GetDeviceState(@as(*const IDirectInputDeviceA, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getDeviceData(self: *const T, param0_: u32, param1_: ?*DIDEVICEOBJECTDATA, param2_: ?*u32, param3_: u32) HRESULT {
                return @as(*const IDirectInputDeviceA.VTable, @ptrCast(self.vtable)).GetDeviceData(@as(*const IDirectInputDeviceA, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn setDataFormat(self: *const T, param0_: ?*DIDATAFORMAT) HRESULT {
                return @as(*const IDirectInputDeviceA.VTable, @ptrCast(self.vtable)).SetDataFormat(@as(*const IDirectInputDeviceA, @ptrCast(self)), param0_);
            }
            pub inline fn setEventNotification(self: *const T, param0_: ?HANDLE) HRESULT {
                return @as(*const IDirectInputDeviceA.VTable, @ptrCast(self.vtable)).SetEventNotification(@as(*const IDirectInputDeviceA, @ptrCast(self)), param0_);
            }
            pub inline fn setCooperativeLevel(self: *const T, param0_: ?HWND, param1_: u32) HRESULT {
                return @as(*const IDirectInputDeviceA.VTable, @ptrCast(self.vtable)).SetCooperativeLevel(@as(*const IDirectInputDeviceA, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getObjectInfo(self: *const T, param0_: ?*DIDEVICEOBJECTINSTANCEA, param1_: u32, param2_: u32) HRESULT {
                return @as(*const IDirectInputDeviceA.VTable, @ptrCast(self.vtable)).GetObjectInfo(@as(*const IDirectInputDeviceA, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn getDeviceInfo(self: *const T, param0_: ?*DIDEVICEINSTANCEA) HRESULT {
                return @as(*const IDirectInputDeviceA.VTable, @ptrCast(self.vtable)).GetDeviceInfo(@as(*const IDirectInputDeviceA, @ptrCast(self)), param0_);
            }
            pub inline fn runControlPanel(self: *const T, param0_: ?HWND, param1_: u32) HRESULT {
                return @as(*const IDirectInputDeviceA.VTable, @ptrCast(self.vtable)).RunControlPanel(@as(*const IDirectInputDeviceA, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn initialize(self: *const T, param0_: ?HINSTANCE, param1_: u32, param2_: ?*const Guid) HRESULT {
                return @as(*const IDirectInputDeviceA.VTable, @ptrCast(self.vtable)).Initialize(@as(*const IDirectInputDeviceA, @ptrCast(self)), param0_, param1_, param2_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectInputDevice2W = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn createEffect(self: *const T, param0_: ?*const Guid, param1_: ?*DIEFFECT, param2_: ?*?*IDirectInputEffect, param3_: ?*IUnknown) HRESULT {
                return @as(*const IDirectInputDevice2W.VTable, @ptrCast(self.vtable)).CreateEffect(@as(*const IDirectInputDevice2W, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn enumEffects(self: *const T, param0_: ?LPDIENUMEFFECTSCALLBACKW, param1_: ?*anyopaque, param2_: u32) HRESULT {
                return @as(*const IDirectInputDevice2W.VTable, @ptrCast(self.vtable)).EnumEffects(@as(*const IDirectInputDevice2W, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn getEffectInfo(self: *const T, param0_: ?*DIEFFECTINFOW, param1_: ?*const Guid) HRESULT {
                return @as(*const IDirectInputDevice2W.VTable, @ptrCast(self.vtable)).GetEffectInfo(@as(*const IDirectInputDevice2W, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getForceFeedbackState(self: *const T, param0_: ?*u32) HRESULT {
                return @as(*const IDirectInputDevice2W.VTable, @ptrCast(self.vtable)).GetForceFeedbackState(@as(*const IDirectInputDevice2W, @ptrCast(self)), param0_);
            }
            pub inline fn sendForceFeedbackCommand(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectInputDevice2W.VTable, @ptrCast(self.vtable)).SendForceFeedbackCommand(@as(*const IDirectInputDevice2W, @ptrCast(self)), param0_);
            }
            pub inline fn enumCreatedEffectObjects(self: *const T, param0_: ?LPDIENUMCREATEDEFFECTOBJECTSCALLBACK, param1_: ?*anyopaque, param2_: u32) HRESULT {
                return @as(*const IDirectInputDevice2W.VTable, @ptrCast(self.vtable)).EnumCreatedEffectObjects(@as(*const IDirectInputDevice2W, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn escape(self: *const T, param0_: ?*DIEFFESCAPE) HRESULT {
                return @as(*const IDirectInputDevice2W.VTable, @ptrCast(self.vtable)).Escape(@as(*const IDirectInputDevice2W, @ptrCast(self)), param0_);
            }
            pub inline fn poll(self: *const T) HRESULT {
                return @as(*const IDirectInputDevice2W.VTable, @ptrCast(self.vtable)).Poll(@as(*const IDirectInputDevice2W, @ptrCast(self)));
            }
            pub inline fn sendDeviceData(self: *const T, param0_: u32, param1_: ?*DIDEVICEOBJECTDATA, param2_: ?*u32, param3_: u32) HRESULT {
                return @as(*const IDirectInputDevice2W.VTable, @ptrCast(self.vtable)).SendDeviceData(@as(*const IDirectInputDevice2W, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectInputDevice2A = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn createEffect(self: *const T, param0_: ?*const Guid, param1_: ?*DIEFFECT, param2_: ?*?*IDirectInputEffect, param3_: ?*IUnknown) HRESULT {
                return @as(*const IDirectInputDevice2A.VTable, @ptrCast(self.vtable)).CreateEffect(@as(*const IDirectInputDevice2A, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn enumEffects(self: *const T, param0_: ?LPDIENUMEFFECTSCALLBACKA, param1_: ?*anyopaque, param2_: u32) HRESULT {
                return @as(*const IDirectInputDevice2A.VTable, @ptrCast(self.vtable)).EnumEffects(@as(*const IDirectInputDevice2A, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn getEffectInfo(self: *const T, param0_: ?*DIEFFECTINFOA, param1_: ?*const Guid) HRESULT {
                return @as(*const IDirectInputDevice2A.VTable, @ptrCast(self.vtable)).GetEffectInfo(@as(*const IDirectInputDevice2A, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getForceFeedbackState(self: *const T, param0_: ?*u32) HRESULT {
                return @as(*const IDirectInputDevice2A.VTable, @ptrCast(self.vtable)).GetForceFeedbackState(@as(*const IDirectInputDevice2A, @ptrCast(self)), param0_);
            }
            pub inline fn sendForceFeedbackCommand(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectInputDevice2A.VTable, @ptrCast(self.vtable)).SendForceFeedbackCommand(@as(*const IDirectInputDevice2A, @ptrCast(self)), param0_);
            }
            pub inline fn enumCreatedEffectObjects(self: *const T, param0_: ?LPDIENUMCREATEDEFFECTOBJECTSCALLBACK, param1_: ?*anyopaque, param2_: u32) HRESULT {
                return @as(*const IDirectInputDevice2A.VTable, @ptrCast(self.vtable)).EnumCreatedEffectObjects(@as(*const IDirectInputDevice2A, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn escape(self: *const T, param0_: ?*DIEFFESCAPE) HRESULT {
                return @as(*const IDirectInputDevice2A.VTable, @ptrCast(self.vtable)).Escape(@as(*const IDirectInputDevice2A, @ptrCast(self)), param0_);
            }
            pub inline fn poll(self: *const T) HRESULT {
                return @as(*const IDirectInputDevice2A.VTable, @ptrCast(self.vtable)).Poll(@as(*const IDirectInputDevice2A, @ptrCast(self)));
            }
            pub inline fn sendDeviceData(self: *const T, param0_: u32, param1_: ?*DIDEVICEOBJECTDATA, param2_: ?*u32, param3_: u32) HRESULT {
                return @as(*const IDirectInputDevice2A.VTable, @ptrCast(self.vtable)).SendDeviceData(@as(*const IDirectInputDevice2A, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectInputDevice7W = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn enumEffectsInFile(self: *const T, param0_: ?[*:0]const u16, param1_: ?LPDIENUMEFFECTSINFILECALLBACK, param2_: ?*anyopaque, param3_: u32) HRESULT {
                return @as(*const IDirectInputDevice7W.VTable, @ptrCast(self.vtable)).EnumEffectsInFile(@as(*const IDirectInputDevice7W, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn writeEffectToFile(self: *const T, param0_: ?[*:0]const u16, param1_: u32, param2_: ?*DIFILEEFFECT, param3_: u32) HRESULT {
                return @as(*const IDirectInputDevice7W.VTable, @ptrCast(self.vtable)).WriteEffectToFile(@as(*const IDirectInputDevice7W, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectInputDevice7A = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn enumEffectsInFile(self: *const T, param0_: ?[*:0]const u8, param1_: ?LPDIENUMEFFECTSINFILECALLBACK, param2_: ?*anyopaque, param3_: u32) HRESULT {
                return @as(*const IDirectInputDevice7A.VTable, @ptrCast(self.vtable)).EnumEffectsInFile(@as(*const IDirectInputDevice7A, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn writeEffectToFile(self: *const T, param0_: ?[*:0]const u8, param1_: u32, param2_: ?*DIFILEEFFECT, param3_: u32) HRESULT {
                return @as(*const IDirectInputDevice7A.VTable, @ptrCast(self.vtable)).WriteEffectToFile(@as(*const IDirectInputDevice7A, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectInputDevice8W = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getCapabilities(self: *const T, param0_: ?*DIDEVCAPS) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).GetCapabilities(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_);
            }
            pub inline fn enumObjects(self: *const T, param0_: ?LPDIENUMDEVICEOBJECTSCALLBACKW, param1_: ?*anyopaque, param2_: u32) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).EnumObjects(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn getProperty(self: *const T, param0_: ?*const Guid, param1_: ?*DIPROPHEADER) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).GetProperty(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn setProperty(self: *const T, param0_: ?*const Guid, param1_: ?*DIPROPHEADER) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).SetProperty(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn acquire(self: *const T) HRESULT {
            ...
            pub inline fn getDeviceState(self: *const T, param0_: u32, param1_: ?*anyopaque) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).GetDeviceState(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getDeviceData(self: *const T, param0_: u32, param1_: ?*DIDEVICEOBJECTDATA, param2_: ?*u32, param3_: u32) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).GetDeviceData(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn setDataFormat(self: *const T, param0_: ?*DIDATAFORMAT) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).SetDataFormat(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_);
            }
            pub inline fn setEventNotification(self: *const T, param0_: ?HANDLE) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).SetEventNotification(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_);
            }
            pub inline fn setCooperativeLevel(self: *const T, param0_: ?HWND, param1_: u32) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).SetCooperativeLevel(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getObjectInfo(self: *const T, param0_: ?*DIDEVICEOBJECTINSTANCEW, param1_: u32, param2_: u32) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).GetObjectInfo(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn getDeviceInfo(self: *const T, param0_: ?*DIDEVICEINSTANCEW) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).GetDeviceInfo(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_);
            }
            pub inline fn runControlPanel(self: *const T, param0_: ?HWND, param1_: u32) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).RunControlPanel(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn initialize(self: *const T, param0_: ?HINSTANCE, param1_: u32, param2_: ?*const Guid) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).Initialize(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn createEffect(self: *const T, param0_: ?*const Guid, param1_: ?*DIEFFECT, param2_: ?*?*IDirectInputEffect, param3_: ?*IUnknown) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).CreateEffect(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn enumEffects(self: *const T, param0_: ?LPDIENUMEFFECTSCALLBACKW, param1_: ?*anyopaque, param2_: u32) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).EnumEffects(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn getEffectInfo(self: *const T, param0_: ?*DIEFFECTINFOW, param1_: ?*const Guid) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).GetEffectInfo(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getForceFeedbackState(self: *const T, param0_: ?*u32) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).GetForceFeedbackState(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_);
            }
            pub inline fn sendForceFeedbackCommand(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).SendForceFeedbackCommand(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_);
            }
            pub inline fn enumCreatedEffectObjects(self: *const T, param0_: ?LPDIENUMCREATEDEFFECTOBJECTSCALLBACK, param1_: ?*anyopaque, param2_: u32) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).EnumCreatedEffectObjects(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn escape(self: *const T, param0_: ?*DIEFFESCAPE) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).Escape(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_);
            }
            pub inline fn poll(self: *const T) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).Poll(@as(*const IDirectInputDevice8W, @ptrCast(self)));
            }
            pub inline fn sendDeviceData(self: *const T, param0_: u32, param1_: ?*DIDEVICEOBJECTDATA, param2_: ?*u32, param3_: u32) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).SendDeviceData(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn enumEffectsInFile(self: *const T, param0_: ?[*:0]const u16, param1_: ?LPDIENUMEFFECTSINFILECALLBACK, param2_: ?*anyopaque, param3_: u32) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).EnumEffectsInFile(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn writeEffectToFile(self: *const T, param0_: ?[*:0]const u16, param1_: u32, param2_: ?*DIFILEEFFECT, param3_: u32) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).WriteEffectToFile(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn buildActionMap(self: *const T, param0_: ?*DIACTIONFORMATW, param1_: ?[*:0]const u16, param2_: u32) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).BuildActionMap(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn setActionMap(self: *const T, param0_: ?*DIACTIONFORMATW, param1_: ?[*:0]const u16, param2_: u32) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).SetActionMap(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn getImageInfo(self: *const T, param0_: ?*DIDEVICEIMAGEINFOHEADERW) HRESULT {
                return @as(*const IDirectInputDevice8W.VTable, @ptrCast(self.vtable)).GetImageInfo(@as(*const IDirectInputDevice8W, @ptrCast(self)), param0_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectInputDevice8A = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getCapabilities(self: *const T, param0_: ?*DIDEVCAPS) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).GetCapabilities(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_);
            }
            pub inline fn enumObjects(self: *const T, param0_: ?LPDIENUMDEVICEOBJECTSCALLBACKA, param1_: ?*anyopaque, param2_: u32) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).EnumObjects(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn getProperty(self: *const T, param0_: ?*const Guid, param1_: ?*DIPROPHEADER) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).GetProperty(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn setProperty(self: *const T, param0_: ?*const Guid, param1_: ?*DIPROPHEADER) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).SetProperty(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn acquire(self: *const T) HRESULT {
            ...
            pub inline fn getDeviceState(self: *const T, param0_: u32, param1_: ?*anyopaque) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).GetDeviceState(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getDeviceData(self: *const T, param0_: u32, param1_: ?*DIDEVICEOBJECTDATA, param2_: ?*u32, param3_: u32) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).GetDeviceData(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn setDataFormat(self: *const T, param0_: ?*DIDATAFORMAT) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).SetDataFormat(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_);
            }
            pub inline fn setEventNotification(self: *const T, param0_: ?HANDLE) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).SetEventNotification(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_);
            }
            pub inline fn setCooperativeLevel(self: *const T, param0_: ?HWND, param1_: u32) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).SetCooperativeLevel(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getObjectInfo(self: *const T, param0_: ?*DIDEVICEOBJECTINSTANCEA, param1_: u32, param2_: u32) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).GetObjectInfo(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn getDeviceInfo(self: *const T, param0_: ?*DIDEVICEINSTANCEA) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).GetDeviceInfo(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_);
            }
            pub inline fn runControlPanel(self: *const T, param0_: ?HWND, param1_: u32) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).RunControlPanel(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn initialize(self: *const T, param0_: ?HINSTANCE, param1_: u32, param2_: ?*const Guid) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).Initialize(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn createEffect(self: *const T, param0_: ?*const Guid, param1_: ?*DIEFFECT, param2_: ?*?*IDirectInputEffect, param3_: ?*IUnknown) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).CreateEffect(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn enumEffects(self: *const T, param0_: ?LPDIENUMEFFECTSCALLBACKA, param1_: ?*anyopaque, param2_: u32) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).EnumEffects(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn getEffectInfo(self: *const T, param0_: ?*DIEFFECTINFOA, param1_: ?*const Guid) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).GetEffectInfo(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getForceFeedbackState(self: *const T, param0_: ?*u32) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).GetForceFeedbackState(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_);
            }
            pub inline fn sendForceFeedbackCommand(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).SendForceFeedbackCommand(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_);
            }
            pub inline fn enumCreatedEffectObjects(self: *const T, param0_: ?LPDIENUMCREATEDEFFECTOBJECTSCALLBACK, param1_: ?*anyopaque, param2_: u32) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).EnumCreatedEffectObjects(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn escape(self: *const T, param0_: ?*DIEFFESCAPE) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).Escape(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_);
            }
            pub inline fn poll(self: *const T) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).Poll(@as(*const IDirectInputDevice8A, @ptrCast(self)));
            }
            pub inline fn sendDeviceData(self: *const T, param0_: u32, param1_: ?*DIDEVICEOBJECTDATA, param2_: ?*u32, param3_: u32) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).SendDeviceData(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn enumEffectsInFile(self: *const T, param0_: ?[*:0]const u8, param1_: ?LPDIENUMEFFECTSINFILECALLBACK, param2_: ?*anyopaque, param3_: u32) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).EnumEffectsInFile(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn writeEffectToFile(self: *const T, param0_: ?[*:0]const u8, param1_: u32, param2_: ?*DIFILEEFFECT, param3_: u32) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).WriteEffectToFile(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn buildActionMap(self: *const T, param0_: ?*DIACTIONFORMATA, param1_: ?[*:0]const u8, param2_: u32) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).BuildActionMap(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn setActionMap(self: *const T, param0_: ?*DIACTIONFORMATA, param1_: ?[*:0]const u8, param2_: u32) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).SetActionMap(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn getImageInfo(self: *const T, param0_: ?*DIDEVICEIMAGEINFOHEADERA) HRESULT {
                return @as(*const IDirectInputDevice8A.VTable, @ptrCast(self.vtable)).GetImageInfo(@as(*const IDirectInputDevice8A, @ptrCast(self)), param0_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectInputW = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn createDevice(self: *const T, param0_: ?*const Guid, param1_: ?*?*IDirectInputDeviceW, param2_: ?*IUnknown) HRESULT {
                return @as(*const IDirectInputW.VTable, @ptrCast(self.vtable)).CreateDevice(@as(*const IDirectInputW, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn enumDevices(self: *const T, param0_: u32, param1_: ?LPDIENUMDEVICESCALLBACKW, param2_: ?*anyopaque, param3_: u32) HRESULT {
                return @as(*const IDirectInputW.VTable, @ptrCast(self.vtable)).EnumDevices(@as(*const IDirectInputW, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn getDeviceStatus(self: *const T, param0_: ?*const Guid) HRESULT {
                return @as(*const IDirectInputW.VTable, @ptrCast(self.vtable)).GetDeviceStatus(@as(*const IDirectInputW, @ptrCast(self)), param0_);
            }
            pub inline fn runControlPanel(self: *const T, param0_: ?HWND, param1_: u32) HRESULT {
                return @as(*const IDirectInputW.VTable, @ptrCast(self.vtable)).RunControlPanel(@as(*const IDirectInputW, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn initialize(self: *const T, param0_: ?HINSTANCE, param1_: u32) HRESULT {
                return @as(*const IDirectInputW.VTable, @ptrCast(self.vtable)).Initialize(@as(*const IDirectInputW, @ptrCast(self)), param0_, param1_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectInputA = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn createDevice(self: *const T, param0_: ?*const Guid, param1_: ?*?*IDirectInputDeviceA, param2_: ?*IUnknown) HRESULT {
                return @as(*const IDirectInputA.VTable, @ptrCast(self.vtable)).CreateDevice(@as(*const IDirectInputA, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn enumDevices(self: *const T, param0_: u32, param1_: ?LPDIENUMDEVICESCALLBACKA, param2_: ?*anyopaque, param3_: u32) HRESULT {
                return @as(*const IDirectInputA.VTable, @ptrCast(self.vtable)).EnumDevices(@as(*const IDirectInputA, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn getDeviceStatus(self: *const T, param0_: ?*const Guid) HRESULT {
                return @as(*const IDirectInputA.VTable, @ptrCast(self.vtable)).GetDeviceStatus(@as(*const IDirectInputA, @ptrCast(self)), param0_);
            }
            pub inline fn runControlPanel(self: *const T, param0_: ?HWND, param1_: u32) HRESULT {
                return @as(*const IDirectInputA.VTable, @ptrCast(self.vtable)).RunControlPanel(@as(*const IDirectInputA, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn initialize(self: *const T, param0_: ?HINSTANCE, param1_: u32) HRESULT {
                return @as(*const IDirectInputA.VTable, @ptrCast(self.vtable)).Initialize(@as(*const IDirectInputA, @ptrCast(self)), param0_, param1_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectInput2W = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn findDevice(self: *const T, param0_: ?*const Guid, param1_: ?[*:0]const u16, param2_: ?*Guid) HRESULT {
                return @as(*const IDirectInput2W.VTable, @ptrCast(self.vtable)).FindDevice(@as(*const IDirectInput2W, @ptrCast(self)), param0_, param1_, param2_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectInput2A = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn findDevice(self: *const T, param0_: ?*const Guid, param1_: ?[*:0]const u8, param2_: ?*Guid) HRESULT {
                return @as(*const IDirectInput2A.VTable, @ptrCast(self.vtable)).FindDevice(@as(*const IDirectInput2A, @ptrCast(self)), param0_, param1_, param2_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectInput7W = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn createDeviceEx(self: *const T, param0_: ?*const Guid, param1_: ?*const Guid, param2_: ?*?*anyopaque, param3_: ?*IUnknown) HRESULT {
                return @as(*const IDirectInput7W.VTable, @ptrCast(self.vtable)).CreateDeviceEx(@as(*const IDirectInput7W, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectInput7A = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn createDeviceEx(self: *const T, param0_: ?*const Guid, param1_: ?*const Guid, param2_: ?*?*anyopaque, param3_: ?*IUnknown) HRESULT {
                return @as(*const IDirectInput7A.VTable, @ptrCast(self.vtable)).CreateDeviceEx(@as(*const IDirectInput7A, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectInput8W = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn createDevice(self: *const T, param0_: ?*const Guid, param1_: ?*?*IDirectInputDevice8W, param2_: ?*IUnknown) HRESULT {
                return @as(*const IDirectInput8W.VTable, @ptrCast(self.vtable)).CreateDevice(@as(*const IDirectInput8W, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn enumDevices(self: *const T, param0_: u32, param1_: ?LPDIENUMDEVICESCALLBACKW, param2_: ?*anyopaque, param3_: u32) HRESULT {
                return @as(*const IDirectInput8W.VTable, @ptrCast(self.vtable)).EnumDevices(@as(*const IDirectInput8W, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn getDeviceStatus(self: *const T, param0_: ?*const Guid) HRESULT {
                return @as(*const IDirectInput8W.VTable, @ptrCast(self.vtable)).GetDeviceStatus(@as(*const IDirectInput8W, @ptrCast(self)), param0_);
            }
            pub inline fn runControlPanel(self: *const T, param0_: ?HWND, param1_: u32) HRESULT {
                return @as(*const IDirectInput8W.VTable, @ptrCast(self.vtable)).RunControlPanel(@as(*const IDirectInput8W, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn initialize(self: *const T, param0_: ?HINSTANCE, param1_: u32) HRESULT {
                return @as(*const IDirectInput8W.VTable, @ptrCast(self.vtable)).Initialize(@as(*const IDirectInput8W, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn findDevice(self: *const T, param0_: ?*const Guid, param1_: ?[*:0]const u16, param2_: ?*Guid) HRESULT {
                return @as(*const IDirectInput8W.VTable, @ptrCast(self.vtable)).FindDevice(@as(*const IDirectInput8W, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn enumDevicesBySemantics(self: *const T, param0_: ?[*:0]const u16, param1_: ?*DIACTIONFORMATW, param2_: ?LPDIENUMDEVICESBYSEMANTICSCBW, param3_: ?*anyopaque, param4_: u32) HRESULT {
                return @as(*const IDirectInput8W.VTable, @ptrCast(self.vtable)).EnumDevicesBySemantics(@as(*const IDirectInput8W, @ptrCast(self)), param0_, param1_, param2_, param3_, param4_);
            }
            pub inline fn configureDevices(self: *const T, param0_: ?LPDICONFIGUREDEVICESCALLBACK, param1_: ?*DICONFIGUREDEVICESPARAMSW, param2_: u32, param3_: ?*anyopaque) HRESULT {
                return @as(*const IDirectInput8W.VTable, @ptrCast(self.vtable)).ConfigureDevices(@as(*const IDirectInput8W, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectInput8A = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn createDevice(self: *const T, param0_: ?*const Guid, param1_: ?*?*IDirectInputDevice8A, param2_: ?*IUnknown) HRESULT {
                return @as(*const IDirectInput8A.VTable, @ptrCast(self.vtable)).CreateDevice(@as(*const IDirectInput8A, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn enumDevices(self: *const T, param0_: u32, param1_: ?LPDIENUMDEVICESCALLBACKA, param2_: ?*anyopaque, param3_: u32) HRESULT {
                return @as(*const IDirectInput8A.VTable, @ptrCast(self.vtable)).EnumDevices(@as(*const IDirectInput8A, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn getDeviceStatus(self: *const T, param0_: ?*const Guid) HRESULT {
                return @as(*const IDirectInput8A.VTable, @ptrCast(self.vtable)).GetDeviceStatus(@as(*const IDirectInput8A, @ptrCast(self)), param0_);
            }
            pub inline fn runControlPanel(self: *const T, param0_: ?HWND, param1_: u32) HRESULT {
                return @as(*const IDirectInput8A.VTable, @ptrCast(self.vtable)).RunControlPanel(@as(*const IDirectInput8A, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn initialize(self: *const T, param0_: ?HINSTANCE, param1_: u32) HRESULT {
                return @as(*const IDirectInput8A.VTable, @ptrCast(self.vtable)).Initialize(@as(*const IDirectInput8A, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn findDevice(self: *const T, param0_: ?*const Guid, param1_: ?[*:0]const u8, param2_: ?*Guid) HRESULT {
                return @as(*const IDirectInput8A.VTable, @ptrCast(self.vtable)).FindDevice(@as(*const IDirectInput8A, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn enumDevicesBySemantics(self: *const T, param0_: ?[*:0]const u8, param1_: ?*DIACTIONFORMATA, param2_: ?LPDIENUMDEVICESBYSEMANTICSCBA, param3_: ?*anyopaque, param4_: u32) HRESULT {
                return @as(*const IDirectInput8A.VTable, @ptrCast(self.vtable)).EnumDevicesBySemantics(@as(*const IDirectInput8A, @ptrCast(self)), param0_, param1_, param2_, param3_, param4_);
            }
            pub inline fn configureDevices(self: *const T, param0_: ?LPDICONFIGUREDEVICESCALLBACK, param1_: ?*DICONFIGUREDEVICESPARAMSA, param2_: u32, param3_: ?*anyopaque) HRESULT {
                return @as(*const IDirectInput8A.VTable, @ptrCast(self.vtable)).ConfigureDevices(@as(*const IDirectInput8A, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectInputEffectDriver = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn deviceID(self: *const T, param0_: u32, param1_: u32, param2_: u32, param3_: u32, param4_: ?*anyopaque) HRESULT {
                return @as(*const IDirectInputEffectDriver.VTable, @ptrCast(self.vtable)).DeviceID(@as(*const IDirectInputEffectDriver, @ptrCast(self)), param0_, param1_, param2_, param3_, param4_);
            }
            pub inline fn getVersions(self: *const T, param0_: ?*DIDRIVERVERSIONS) HRESULT {
                return @as(*const IDirectInputEffectDriver.VTable, @ptrCast(self.vtable)).GetVersions(@as(*const IDirectInputEffectDriver, @ptrCast(self)), param0_);
            }
            pub inline fn escape(self: *const T, param0_: u32, param1_: u32, param2_: ?*DIEFFESCAPE) HRESULT {
                return @as(*const IDirectInputEffectDriver.VTable, @ptrCast(self.vtable)).Escape(@as(*const IDirectInputEffectDriver, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn setGain(self: *const T, param0_: u32, param1_: u32) HRESULT {
                return @as(*const IDirectInputEffectDriver.VTable, @ptrCast(self.vtable)).SetGain(@as(*const IDirectInputEffectDriver, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn sendForceFeedbackCommand(self: *const T, param0_: u32, param1_: u32) HRESULT {
                return @as(*const IDirectInputEffectDriver.VTable, @ptrCast(self.vtable)).SendForceFeedbackCommand(@as(*const IDirectInputEffectDriver, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getForceFeedbackState(self: *const T, param0_: u32, param1_: ?*DIDEVICESTATE) HRESULT {
                return @as(*const IDirectInputEffectDriver.VTable, @ptrCast(self.vtable)).GetForceFeedbackState(@as(*const IDirectInputEffectDriver, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn downloadEffect(self: *const T, param0_: u32, param1_: u32, param2_: ?*u32, param3_: ?*DIEFFECT, param4_: u32) HRESULT {
                return @as(*const IDirectInputEffectDriver.VTable, @ptrCast(self.vtable)).DownloadEffect(@as(*const IDirectInputEffectDriver, @ptrCast(self)), param0_, param1_, param2_, param3_, param4_);
            }
            pub inline fn destroyEffect(self: *const T, param0_: u32, param1_: u32) HRESULT {
                return @as(*const IDirectInputEffectDriver.VTable, @ptrCast(self.vtable)).DestroyEffect(@as(*const IDirectInputEffectDriver, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn startEffect(self: *const T, param0_: u32, param1_: u32, param2_: u32, param3_: u32) HRESULT {
                return @as(*const IDirectInputEffectDriver.VTable, @ptrCast(self.vtable)).StartEffect(@as(*const IDirectInputEffectDriver, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn stopEffect(self: *const T, param0_: u32, param1_: u32) HRESULT {
                return @as(*const IDirectInputEffectDriver.VTable, @ptrCast(self.vtable)).StopEffect(@as(*const IDirectInputEffectDriver, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getEffectStatus(self: *const T, param0_: u32, param1_: u32, param2_: ?*u32) HRESULT {
                return @as(*const IDirectInputEffectDriver.VTable, @ptrCast(self.vtable)).GetEffectStatus(@as(*const IDirectInputEffectDriver, @ptrCast(self)), param0_, param1_, param2_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectInputJoyConfig = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn setCooperativeLevel(self: *const T, param0_: ?HWND, param1_: u32) HRESULT {
                return @as(*const IDirectInputJoyConfig.VTable, @ptrCast(self.vtable)).SetCooperativeLevel(@as(*const IDirectInputJoyConfig, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn sendNotify(self: *const T) HRESULT {
                return @as(*const IDirectInputJoyConfig.VTable, @ptrCast(self.vtable)).SendNotify(@as(*const IDirectInputJoyConfig, @ptrCast(self)));
            }
            pub inline fn enumTypes(self: *const T, param0_: ?LPDIJOYTYPECALLBACK, param1_: ?*anyopaque) HRESULT {
                return @as(*const IDirectInputJoyConfig.VTable, @ptrCast(self.vtable)).EnumTypes(@as(*const IDirectInputJoyConfig, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getTypeInfo(self: *const T, param0_: ?[*:0]const u16, param1_: ?*DIJOYTYPEINFO, param2_: u32) HRESULT {
                return @as(*const IDirectInputJoyConfig.VTable, @ptrCast(self.vtable)).GetTypeInfo(@as(*const IDirectInputJoyConfig, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn setTypeInfo(self: *const T, param0_: ?[*:0]const u16, param1_: ?*DIJOYTYPEINFO, param2_: u32) HRESULT {
                return @as(*const IDirectInputJoyConfig.VTable, @ptrCast(self.vtable)).SetTypeInfo(@as(*const IDirectInputJoyConfig, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn deleteType(self: *const T, param0_: ?[*:0]const u16) HRESULT {
                return @as(*const IDirectInputJoyConfig.VTable, @ptrCast(self.vtable)).DeleteType(@as(*const IDirectInputJoyConfig, @ptrCast(self)), param0_);
            }
            pub inline fn getConfig(self: *const T, param0_: u32, param1_: ?*DIJOYCONFIG, param2_: u32) HRESULT {
                return @as(*const IDirectInputJoyConfig.VTable, @ptrCast(self.vtable)).GetConfig(@as(*const IDirectInputJoyConfig, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn setConfig(self: *const T, param0_: u32, param1_: ?*DIJOYCONFIG, param2_: u32) HRESULT {
                return @as(*const IDirectInputJoyConfig.VTable, @ptrCast(self.vtable)).SetConfig(@as(*const IDirectInputJoyConfig, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn deleteConfig(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectInputJoyConfig.VTable, @ptrCast(self.vtable)).DeleteConfig(@as(*const IDirectInputJoyConfig, @ptrCast(self)), param0_);
            }
            pub inline fn getUserValues(self: *const T, param0_: ?*DIJOYUSERVALUES, param1_: u32) HRESULT {
                return @as(*const IDirectInputJoyConfig.VTable, @ptrCast(self.vtable)).GetUserValues(@as(*const IDirectInputJoyConfig, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn setUserValues(self: *const T, param0_: ?*DIJOYUSERVALUES, param1_: u32) HRESULT {
                return @as(*const IDirectInputJoyConfig.VTable, @ptrCast(self.vtable)).SetUserValues(@as(*const IDirectInputJoyConfig, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn addNewHardware(self: *const T, param0_: ?HWND, param1_: ?*const Guid) HRESULT {
                return @as(*const IDirectInputJoyConfig.VTable, @ptrCast(self.vtable)).AddNewHardware(@as(*const IDirectInputJoyConfig, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn openTypeKey(self: *const T, param0_: ?[*:0]const u16, param1_: u32, param2_: ?*?HKEY) HRESULT {
                return @as(*const IDirectInputJoyConfig.VTable, @ptrCast(self.vtable)).OpenTypeKey(@as(*const IDirectInputJoyConfig, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn openConfigKey(self: *const T, param0_: u32, param1_: u32, param2_: ?*?HKEY) HRESULT {
                return @as(*const IDirectInputJoyConfig.VTable, @ptrCast(self.vtable)).OpenConfigKey(@as(*const IDirectInputJoyConfig, @ptrCast(self)), param0_, param1_, param2_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectInputJoyConfig8 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn setCooperativeLevel(self: *const T, param0_: ?HWND, param1_: u32) HRESULT {
                return @as(*const IDirectInputJoyConfig8.VTable, @ptrCast(self.vtable)).SetCooperativeLevel(@as(*const IDirectInputJoyConfig8, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn sendNotify(self: *const T) HRESULT {
            ...
            pub inline fn enumTypes(self: *const T, param0_: ?LPDIJOYTYPECALLBACK, param1_: ?*anyopaque) HRESULT {
                return @as(*const IDirectInputJoyConfig8.VTable, @ptrCast(self.vtable)).EnumTypes(@as(*const IDirectInputJoyConfig8, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getTypeInfo(self: *const T, param0_: ?[*:0]const u16, param1_: ?*DIJOYTYPEINFO, param2_: u32) HRESULT {
                return @as(*const IDirectInputJoyConfig8.VTable, @ptrCast(self.vtable)).GetTypeInfo(@as(*const IDirectInputJoyConfig8, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn setTypeInfo(self: *const T, param0_: ?[*:0]const u16, param1_: ?*DIJOYTYPEINFO, param2_: u32, param3_: ?PWSTR) HRESULT {
                return @as(*const IDirectInputJoyConfig8.VTable, @ptrCast(self.vtable)).SetTypeInfo(@as(*const IDirectInputJoyConfig8, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn deleteType(self: *const T, param0_: ?[*:0]const u16) HRESULT {
                return @as(*const IDirectInputJoyConfig8.VTable, @ptrCast(self.vtable)).DeleteType(@as(*const IDirectInputJoyConfig8, @ptrCast(self)), param0_);
            }
            pub inline fn getConfig(self: *const T, param0_: u32, param1_: ?*DIJOYCONFIG, param2_: u32) HRESULT {
                return @as(*const IDirectInputJoyConfig8.VTable, @ptrCast(self.vtable)).GetConfig(@as(*const IDirectInputJoyConfig8, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn setConfig(self: *const T, param0_: u32, param1_: ?*DIJOYCONFIG, param2_: u32) HRESULT {
                return @as(*const IDirectInputJoyConfig8.VTable, @ptrCast(self.vtable)).SetConfig(@as(*const IDirectInputJoyConfig8, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn deleteConfig(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectInputJoyConfig8.VTable, @ptrCast(self.vtable)).DeleteConfig(@as(*const IDirectInputJoyConfig8, @ptrCast(self)), param0_);
            }
            pub inline fn getUserValues(self: *const T, param0_: ?*DIJOYUSERVALUES, param1_: u32) HRESULT {
                return @as(*const IDirectInputJoyConfig8.VTable, @ptrCast(self.vtable)).GetUserValues(@as(*const IDirectInputJoyConfig8, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn setUserValues(self: *const T, param0_: ?*DIJOYUSERVALUES, param1_: u32) HRESULT {
                return @as(*const IDirectInputJoyConfig8.VTable, @ptrCast(self.vtable)).SetUserValues(@as(*const IDirectInputJoyConfig8, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn addNewHardware(self: *const T, param0_: ?HWND, param1_: ?*const Guid) HRESULT {
                return @as(*const IDirectInputJoyConfig8.VTable, @ptrCast(self.vtable)).AddNewHardware(@as(*const IDirectInputJoyConfig8, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn openTypeKey(self: *const T, param0_: ?[*:0]const u16, param1_: u32, param2_: ?*?HKEY) HRESULT {
                return @as(*const IDirectInputJoyConfig8.VTable, @ptrCast(self.vtable)).OpenTypeKey(@as(*const IDirectInputJoyConfig8, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn openAppStatusKey(self: *const T, param0_: ?*?HKEY) HRESULT {
                return @as(*const IDirectInputJoyConfig8.VTable, @ptrCast(self.vtable)).OpenAppStatusKey(@as(*const IDirectInputJoyConfig8, @ptrCast(self)), param0_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub extern "hid" fn HidP_GetCaps(
    preparsed_data: isize,
    capabilities: ?*HIDP_CAPS,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

pub extern "hid" fn HidP_GetLinkCollectionNodes(
    link_collection_nodes: [*]HIDP_LINK_COLLECTION_NODE,
    link_collection_nodes_length: ?*u32,
    preparsed_data: isize,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub extern "hid" fn HidP_UsageListDifference(
    previous_usage_list: [*:0]u16,
    current_usage_list: [*:0]u16,
    break_usage_list: [*:0]u16,
    make_usage_list: [*:0]u16,
...
pub extern "hid" fn HidP_GetButtonArray(
    ...
    link_collection: u16,
    usage: u16,
    button_data: [*]HIDP_BUTTON_ARRAY_DATA,
    button_data_length: ?*u16,
    preparsed_data: isize,
    // TODO: what to do with BytesParamIndex 8?
    report: ?[*]u8,
    report_length: u32,
...
pub extern "hid" fn HidP_TranslateUsagesToI8042ScanCodes(
    changed_usage_list: [*:0]u16,
    usage_list_length: u32,
    key_action: HIDP_KEYBOARD_DIRECTION,
    modifier_state: ?*HIDP_KEYBOARD_MODIFIER_STATE,
    insert_codes_procedure: ?PHIDP_INSERT_SCANCODES,
    insert_codes_context: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

pub extern "hid" fn HidD_GetAttributes(
    hid_device_object: ?HANDLE,
