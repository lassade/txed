...
pub const ISensorManager = extern struct {
    pub const VTable = extern struct {
        ...
        GetSensorsByCategory: *const fn (
            ...
            sensor_category: ?*Guid,
            pp_sensors_found: ?*?*ISensorCollection,
        ...
        SetEventSink: *const fn (
            self: *const ISensorManager,
            p_events: ?*ISensorManagerEvents,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        RequestPermissions: *const fn (
            self: *const ISensorManager,
            h_parent: ?HWND,
            p_sensors: ?*ISensorCollection,
            f_modal: BOOL,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getSensorsByCategory(self: *const T, sensor_category_: ?*Guid, pp_sensors_found_: ?*?*ISensorCollection) HRESULT {
                return @as(*const ISensorManager.VTable, @ptrCast(self.vtable)).GetSensorsByCategory(@as(*const ISensorManager, @ptrCast(self)), sensor_category_, pp_sensors_found_);
            }
            pub inline fn getSensorsByType(self: *const T, sensor_type_: ?*Guid, pp_sensors_found_: ?*?*ISensorCollection) HRESULT {
                return @as(*const ISensorManager.VTable, @ptrCast(self.vtable)).GetSensorsByType(@as(*const ISensorManager, @ptrCast(self)), sensor_type_, pp_sensors_found_);
            }
            pub inline fn getSensorByID(self: *const T, sensor_i_d_: ?*Guid, pp_sensor_: ?*?*ISensor) HRESULT {
                return @as(*const ISensorManager.VTable, @ptrCast(self.vtable)).GetSensorByID(@as(*const ISensorManager, @ptrCast(self)), sensor_i_d_, pp_sensor_);
            }
            pub inline fn setEventSink(self: *const T, p_events_: ?*ISensorManagerEvents) HRESULT {
                return @as(*const ISensorManager.VTable, @ptrCast(self.vtable)).SetEventSink(@as(*const ISensorManager, @ptrCast(self)), p_events_);
            }
            pub inline fn requestPermissions(self: *const T, h_parent_: ?HWND, p_sensors_: ?*ISensorCollection, f_modal_: BOOL) HRESULT {
                return @as(*const ISensorManager.VTable, @ptrCast(self.vtable)).RequestPermissions(@as(*const ISensorManager, @ptrCast(self)), h_parent_, p_sensors_, f_modal_);
            }
        };
    }
...
pub const ILocationPermissions = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getGlobalLocationPermission(self: *const T, pf_enabled_: ?*BOOL) HRESULT {
                return @as(*const ILocationPermissions.VTable, @ptrCast(self.vtable)).GetGlobalLocationPermission(@as(*const ILocationPermissions, @ptrCast(self)), pf_enabled_);
            }
            pub inline fn checkLocationCapability(self: *const T, dw_client_thread_id_: u32) HRESULT {
                return @as(*const ILocationPermissions.VTable, @ptrCast(self.vtable)).CheckLocationCapability(@as(*const ILocationPermissions, @ptrCast(self)), dw_client_thread_id_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISensorCollection = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getAt(self: *const T, ul_index_: u32, pp_sensor_: ?*?*ISensor) HRESULT {
                return @as(*const ISensorCollection.VTable, @ptrCast(self.vtable)).GetAt(@as(*const ISensorCollection, @ptrCast(self)), ul_index_, pp_sensor_);
            }
            pub inline fn getCount(self: *const T, p_count_: ?*u32) HRESULT {
                return @as(*const ISensorCollection.VTable, @ptrCast(self.vtable)).GetCount(@as(*const ISensorCollection, @ptrCast(self)), p_count_);
            }
            pub inline fn add(self: *const T, p_sensor_: ?*ISensor) HRESULT {
                return @as(*const ISensorCollection.VTable, @ptrCast(self.vtable)).Add(@as(*const ISensorCollection, @ptrCast(self)), p_sensor_);
            }
            pub inline fn remove(self: *const T, p_sensor_: ?*ISensor) HRESULT {
                return @as(*const ISensorCollection.VTable, @ptrCast(self.vtable)).Remove(@as(*const ISensorCollection, @ptrCast(self)), p_sensor_);
            }
            pub inline fn removeByID(self: *const T, sensor_i_d_: ?*Guid) HRESULT {
                return @as(*const ISensorCollection.VTable, @ptrCast(self.vtable)).RemoveByID(@as(*const ISensorCollection, @ptrCast(self)), sensor_i_d_);
            }
...
pub const ISensor = extern struct {
    pub const VTable = extern struct {
        ...
        GetFriendlyName: *const fn (
            self: *const ISensor,
            p_friendly_name: ?*?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetProperty: *const fn (
            self: *const ISensor,
            key: ?*const PROPERTYKEY,
            p_property: ?*PROPVARIANT,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetProperties: *const fn (
            self: *const ISensor,
            p_keys: ?*IPortableDeviceKeyCollection,
            pp_properties: ?*?*IPortableDeviceValues,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetSupportedDataFields: *const fn (
            self: *const ISensor,
            pp_data_fields: ?*?*IPortableDeviceKeyCollection,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        GetData: *const fn (
            self: *const ISensor,
            pp_data_report: ?*?*ISensorDataReport,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        SupportsEvent: *const fn (
            self: *const ISensor,
            event_guid: ?*const Guid,
            p_is_supported: ?*i16,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getID(self: *const T, p_i_d_: ?*Guid) HRESULT {
                return @as(*const ISensor.VTable, @ptrCast(self.vtable)).GetID(@as(*const ISensor, @ptrCast(self)), p_i_d_);
            }
            pub inline fn getCategory(self: *const T, p_sensor_category_: ?*Guid) HRESULT {
                return @as(*const ISensor.VTable, @ptrCast(self.vtable)).GetCategory(@as(*const ISensor, @ptrCast(self)), p_sensor_category_);
            }
            pub inline fn getType(self: *const T, p_sensor_type_: ?*Guid) HRESULT {
                return @as(*const ISensor.VTable, @ptrCast(self.vtable)).GetType(@as(*const ISensor, @ptrCast(self)), p_sensor_type_);
            }
            pub inline fn getFriendlyName(self: *const T, p_friendly_name_: ?*?BSTR) HRESULT {
                return @as(*const ISensor.VTable, @ptrCast(self.vtable)).GetFriendlyName(@as(*const ISensor, @ptrCast(self)), p_friendly_name_);
            }
            pub inline fn getProperty(self: *const T, key_: ?*const PROPERTYKEY, p_property_: ?*PROPVARIANT) HRESULT {
                return @as(*const ISensor.VTable, @ptrCast(self.vtable)).GetProperty(@as(*const ISensor, @ptrCast(self)), key_, p_property_);
            }
            pub inline fn getProperties(self: *const T, p_keys_: ?*IPortableDeviceKeyCollection, pp_properties_: ?*?*IPortableDeviceValues) HRESULT {
                return @as(*const ISensor.VTable, @ptrCast(self.vtable)).GetProperties(@as(*const ISensor, @ptrCast(self)), p_keys_, pp_properties_);
            }
            pub inline fn getSupportedDataFields(self: *const T, pp_data_fields_: ?*?*IPortableDeviceKeyCollection) HRESULT {
                return @as(*const ISensor.VTable, @ptrCast(self.vtable)).GetSupportedDataFields(@as(*const ISensor, @ptrCast(self)), pp_data_fields_);
            }
            pub inline fn setProperties(self: *const T, p_properties_: ?*IPortableDeviceValues, pp_results_: ?*?*IPortableDeviceValues) HRESULT {
                return @as(*const ISensor.VTable, @ptrCast(self.vtable)).SetProperties(@as(*const ISensor, @ptrCast(self)), p_properties_, pp_results_);
            }
            pub inline fn supportsDataField(self: *const T, key_: ?*const PROPERTYKEY, p_is_supported_: ?*i16) HRESULT {
                return @as(*const ISensor.VTable, @ptrCast(self.vtable)).SupportsDataField(@as(*const ISensor, @ptrCast(self)), key_, p_is_supported_);
            }
            pub inline fn getState(self: *const T, p_state_: ?*SensorState) HRESULT {
                return @as(*const ISensor.VTable, @ptrCast(self.vtable)).GetState(@as(*const ISensor, @ptrCast(self)), p_state_);
            }
            pub inline fn getData(self: *const T, pp_data_report_: ?*?*ISensorDataReport) HRESULT {
                return @as(*const ISensor.VTable, @ptrCast(self.vtable)).GetData(@as(*const ISensor, @ptrCast(self)), pp_data_report_);
            }
            pub inline fn supportsEvent(self: *const T, event_guid_: ?*const Guid, p_is_supported_: ?*i16) HRESULT {
                return @as(*const ISensor.VTable, @ptrCast(self.vtable)).SupportsEvent(@as(*const ISensor, @ptrCast(self)), event_guid_, p_is_supported_);
            }
            pub inline fn getEventInterest(self: *const T, pp_values_: [*]?*Guid, p_count_: ?*u32) HRESULT {
                return @as(*const ISensor.VTable, @ptrCast(self.vtable)).GetEventInterest(@as(*const ISensor, @ptrCast(self)), pp_values_, p_count_);
            }
            pub inline fn setEventInterest(self: *const T, p_values_: ?[*]Guid, count_: u32) HRESULT {
                return @as(*const ISensor.VTable, @ptrCast(self.vtable)).SetEventInterest(@as(*const ISensor, @ptrCast(self)), p_values_, count_);
            }
            pub inline fn setEventSink(self: *const T, p_events_: ?*ISensorEvents) HRESULT {
                return @as(*const ISensor.VTable, @ptrCast(self.vtable)).SetEventSink(@as(*const ISensor, @ptrCast(self)), p_events_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISensorDataReport = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getTimestamp(self: *const T, p_time_stamp_: ?*SYSTEMTIME) HRESULT {
                return @as(*const ISensorDataReport.VTable, @ptrCast(self.vtable)).GetTimestamp(@as(*const ISensorDataReport, @ptrCast(self)), p_time_stamp_);
            }
            pub inline fn getSensorValue(self: *const T, p_key_: ?*const PROPERTYKEY, p_value_: ?*PROPVARIANT) HRESULT {
                return @as(*const ISensorDataReport.VTable, @ptrCast(self.vtable)).GetSensorValue(@as(*const ISensorDataReport, @ptrCast(self)), p_key_, p_value_);
            }
            pub inline fn getSensorValues(self: *const T, p_keys_: ?*IPortableDeviceKeyCollection, pp_values_: ?*?*IPortableDeviceValues) HRESULT {
                return @as(*const ISensorDataReport.VTable, @ptrCast(self.vtable)).GetSensorValues(@as(*const ISensorDataReport, @ptrCast(self)), p_keys_, pp_values_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISensorManagerEvents = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn onSensorEnter(self: *const T, p_sensor_: ?*ISensor, state_: SensorState) HRESULT {
                return @as(*const ISensorManagerEvents.VTable, @ptrCast(self.vtable)).OnSensorEnter(@as(*const ISensorManagerEvents, @ptrCast(self)), p_sensor_, state_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISensorEvents = extern struct {
    pub const VTable = extern struct {
        ...
        OnDataUpdated: *const fn (
            self: *const ISensorEvents,
            p_sensor: ?*ISensor,
            p_new_data: ?*ISensorDataReport,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnEvent: *const fn (
            self: *const ISensorEvents,
            p_sensor: ?*ISensor,
            event_i_d: ?*const Guid,
            p_event_data: ?*IPortableDeviceValues,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnLeave: *const fn (
            self: *const ISensorEvents,
            i_d: ?*Guid,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn onStateChanged(self: *const T, p_sensor_: ?*ISensor, state_: SensorState) HRESULT {
                return @as(*const ISensorEvents.VTable, @ptrCast(self.vtable)).OnStateChanged(@as(*const ISensorEvents, @ptrCast(self)), p_sensor_, state_);
            }
            pub inline fn onDataUpdated(self: *const T, p_sensor_: ?*ISensor, p_new_data_: ?*ISensorDataReport) HRESULT {
                return @as(*const ISensorEvents.VTable, @ptrCast(self.vtable)).OnDataUpdated(@as(*const ISensorEvents, @ptrCast(self)), p_sensor_, p_new_data_);
            }
            pub inline fn onEvent(self: *const T, p_sensor_: ?*ISensor, event_i_d_: ?*const Guid, p_event_data_: ?*IPortableDeviceValues) HRESULT {
                return @as(*const ISensorEvents.VTable, @ptrCast(self.vtable)).OnEvent(@as(*const ISensorEvents, @ptrCast(self)), p_sensor_, event_i_d_, p_event_data_);
            }
            pub inline fn onLeave(self: *const T, i_d_: ?*Guid) HRESULT {
                return @as(*const ISensorEvents.VTable, @ptrCast(self.vtable)).OnLeave(@as(*const ISensorEvents, @ptrCast(self)), i_d_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub extern "sensorsutilsv2" fn PropKeyFindKeyGetPropVariant(
    p_list: ?*const SENSOR_COLLECTION_LIST,
    p_key: ?*const PROPERTYKEY,
    type_check: BOOLEAN,
    p_value: ?*PROPVARIANT,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub extern "sensorsutilsv2" fn IsCollectionListSame(
    list_a: ?*const SENSOR_COLLECTION_LIST,
    list_b: ?*const SENSOR_COLLECTION_LIST,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;

pub extern "sensorsutilsv2" fn PropVariantGetInformation(
    prop_variant_value: ?*const PROPVARIANT,
    prop_variant_offset: ?*u32,
    prop_variant_size: ?*u32,
    prop_variant_pointer: ?*?*anyopaque,
    remapped_type: ?*u32,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub extern "sensorsutilsv2" fn CollectionsListSerializeToBuffer(
    source_collection: ?*const SENSOR_COLLECTION_LIST,
    target_buffer_size_in_bytes: u32,
...
pub extern "sensorsutilsv2" fn CollectionsListAllocateBufferAndSerialize(
    source_collection: ?*const SENSOR_COLLECTION_LIST,
    p_target_buffer_size_in_bytes: ?*u32,
    p_target_buffer: ?*?*u8,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

pub extern "sensorsutilsv2" fn CollectionsListDeserializeFromBuffer(
    source_buffer_size_in_bytes: u32,
    // TODO: what to do with BytesParamIndex 0?
    source_buffer: ?*const u8,
    target_collection: ?*SENSOR_COLLECTION_LIST,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;

pub extern "sensorsutilsv2" fn SensorCollectionGetAt(
    index: u32,
    p_sensors_list: ?*SENSOR_COLLECTION_LIST,
    p_key: ?*PROPERTYKEY,
    p_value: ?*PROPVARIANT,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub extern "sensorsutilsv2" fn IsSensorSubscribed(
    subscription_list: ?*SENSOR_COLLECTION_LIST,
    current_type: Guid,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;

pub extern "sensorsutilsv2" fn IsGUIDPresentInList(
    guid_array: [*]const Guid,
    array_length: u32,
    guid_elem: ?*const Guid,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;
