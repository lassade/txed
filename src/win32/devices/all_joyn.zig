...
pub const alljoyn_applicationstatelistener_state_ptr = *const fn (
    bus_name: ?*i8,
    public_key: ?*i8,
    application_state: alljoyn_applicationstate,
    context: ?*anyopaque,
...
pub const alljoyn_buslistener_name_owner_changed_ptr = *const fn (
    context: ?*const anyopaque,
    bus_name: ?[*:0]const u8,
    previous_owner: ?[*:0]const u8,
    new_owner: ?[*:0]const u8,
) callconv(@import("std").os.windows.WINAPI) void;
...
pub const alljoyn_interfacedescription_translation_callback_ptr = *const fn (
    source_language: ?[*:0]const u8,
    target_language: ?[*:0]const u8,
...
pub const alljoyn_about_announced_ptr = *const fn (
    ...
    version: u16,
    port: u16,
    object_description_arg: alljoyn_msgarg,
    about_data_arg: alljoyn_msgarg,
) callconv(@import("std").os.windows.WINAPI) void;
...
pub extern "msajapi" fn alljoyn_permissionconfigurator_getidentitycertificateid(
    configurator: alljoyn_permissionconfigurator,
    certificate_id: ?*alljoyn_certificateid,
) callconv(@import("std").os.windows.WINAPI) QStatus;
...
pub extern "msajapi" fn alljoyn_permissionconfigurator_removemembership(
    ...
    serial: ?*const u8,
    serial_len: usize,
    issuer_public_key: ?*i8,
    issuer_aki: ?*const u8,
    issuer_aki_len: usize,
) callconv(@import("std").os.windows.WINAPI) QStatus;
...
pub extern "msajapi" fn alljoyn_interfacedescription_addmember(
    ...
    name: ?[*:0]const u8,
    input_sig: ?[*:0]const u8,
    out_sig: ?[*:0]const u8,
    arg_names: ?[*:0]const u8,
    annotation: u8,
) callconv(@import("std").os.windows.WINAPI) QStatus;
...
pub extern "msajapi" fn alljoyn_interfacedescription_setdescriptiontranslationcallback(
    iface: alljoyn_interfacedescription,
    translation_callback: ?alljoyn_interfacedescription_translation_callback_ptr,
) callconv(@import("std").os.windows.WINAPI) void;

pub extern "msajapi" fn alljoyn_interfacedescription_getdescriptiontranslationcallback(
    iface: alljoyn_interfacedescription,
    retval: *?alljoyn_interfacedescription_translation_callback_ptr,
) callconv(@import("std").os.windows.WINAPI) void;
...
pub extern "msajapi" fn alljoyn_busobject_setannounceflag(
    bus: alljoyn_busobject,
    iface: alljoyn_interfacedescription,
    is_announced: alljoyn_about_announceflag,
) callconv(@import("std").os.windows.WINAPI) QStatus;
...
pub extern "msajapi" fn alljoyn_proxybusobject_destroy(
    proxy_obj: alljoyn_proxybusobject,
) callconv(@import("std").os.windows.WINAPI) void;
...
pub extern "msajapi" fn alljoyn_proxybusobject_methodcallasync(
    ...
    iface_name: ?[*:0]const u8,
    method_name: ?[*:0]const u8,
    reply_func: ?alljoyn_messagereceiver_replyhandler_ptr,
    args: alljoyn_msgarg,
    num_args: usize,
    context: ?*anyopaque,
    timeout: u32,
...
pub extern "msajapi" fn alljoyn_busattachment_createinterface_secure(
    ...
    name: ?[*:0]const u8,
    iface: ?*alljoyn_interfacedescription,
    sec_policy: alljoyn_interfacedescription_securitypolicy,
) callconv(@import("std").os.windows.WINAPI) QStatus;

pub extern "msajapi" fn alljoyn_busattachment_connect(
    bus: alljoyn_busattachment,
    connect_spec: ?[*:0]const u8,
) callconv(@import("std").os.windows.WINAPI) QStatus;
...
pub extern "msajapi" fn alljoyn_busattachment_enablepeersecurity(
    bus: alljoyn_busattachment,
    auth_mechanisms: ?[*:0]const u8,
    listener: alljoyn_authlistener,
    key_store_file_name: ?[*:0]const u8,
    is_shared: i32,
) callconv(@import("std").os.windows.WINAPI) QStatus;
...
pub extern "msajapi" fn alljoyn_busattachment_enablepeersecuritywithpermissionconfigurationlistener(
    bus: alljoyn_busattachment,
    auth_mechanisms: ?[*:0]const u8,
    auth_listener: alljoyn_authlistener,
    key_store_file_name: ?[*:0]const u8,
    is_shared: i32,
    permission_configuration_listener: alljoyn_permissionconfigurationlistener,
) callconv(@import("std").os.windows.WINAPI) QStatus;
...
pub extern "msajapi" fn alljoyn_busattachment_registeraboutlistener(
    bus: alljoyn_busattachment,
    about_listener: alljoyn_aboutlistener,
) callconv(@import("std").os.windows.WINAPI) void;
...
pub extern "msajapi" fn alljoyn_busattachment_whoimplements_interfaces(
    bus: alljoyn_busattachment,
    implements_interfaces: ?*const ?*i8,
    number_interfaces: usize,
) callconv(@import("std").os.windows.WINAPI) QStatus;

pub extern "msajapi" fn alljoyn_busattachment_whoimplements_interface(
    bus: alljoyn_busattachment,
    implements_interface: ?[*:0]const u8,
) callconv(@import("std").os.windows.WINAPI) QStatus;
...
pub extern "msajapi" fn alljoyn_aboutobj_announce(
    obj: alljoyn_aboutobj,
    session_port: u16,
    about_data: alljoyn_aboutdata,
) callconv(@import("std").os.windows.WINAPI) QStatus;

pub extern "msajapi" fn alljoyn_aboutobj_announce_using_datalistener(
    obj: alljoyn_aboutobj,
    session_port: u16,
    about_listener: alljoyn_aboutdatalistener,
) callconv(@import("std").os.windows.WINAPI) QStatus;
...
pub extern "msajapi" fn alljoyn_observer_create(
    bus: alljoyn_busattachment,
    mandatory_interfaces: ?*const ?*i8,
    num_mandatory_interfaces: usize,
...
pub extern "msajapi" fn alljoyn_securityapplicationproxy_signmanifest(
    unsigned_manifest_xml: ?*i8,
    identity_certificate_pem: ?*i8,
    signing_private_key_pem: ?*i8,
    signed_manifest_xml: ?*?*i8,
) callconv(@import("std").os.windows.WINAPI) QStatus;
