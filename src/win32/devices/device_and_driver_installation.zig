...
pub const PDETECT_PROGRESS_NOTIFY = *const fn (
    progress_notify_param: ?*anyopaque,
    detect_complete: u32,
...
pub const PSP_DETSIG_CMPPROC = *const fn (
    device_info_set: ?*anyopaque,
    new_device_data: ?*SP_DEVINFO_DATA,
    existing_device_data: ?*SP_DEVINFO_DATA,
    compare_context: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PCM_NOTIFY_CALLBACK = *const fn (
    h_notify: ?HCMNOTIFICATION,
    context: ?*anyopaque,
    action: CM_NOTIFY_ACTION,
    // TODO: what to do with BytesParamIndex 4?
    event_data: ?*CM_NOTIFY_EVENT_DATA,
    event_data_size: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "setupapi" fn SetupGetInfInformationA(
    inf_spec: ?*const anyopaque,
    search_control: u32,
    // TODO: what to do with BytesParamIndex 3?
    return_buffer: ?*SP_INF_INFORMATION,
...
pub extern "setupapi" fn SetupQueryInfFileInformationA(
    inf_information: ?*SP_INF_INFORMATION,
    inf_index: u32,
    return_buffer: ?[*:0]u8,
    return_buffer_size: u32,
    required_size: ?*u32,
...
pub extern "setupapi" fn SetupQueryInfOriginalFileInformationA(
    inf_information: ?*SP_INF_INFORMATION,
    inf_index: u32,
    alternate_platform_info: ?*SP_ALTPLATFORM_INFO_V2,
    original_file_info: ?*SP_ORIGINAL_FILE_INFO_A,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupQueryInfOriginalFileInformationW(
    ...
    inf_index: u32,
    alternate_platform_info: ?*SP_ALTPLATFORM_INFO_V2,
    original_file_info: ?*SP_ORIGINAL_FILE_INFO_W,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupGetInfPublishedNameA(
    driver_store_location: ?[*:0]const u8,
    return_buffer: [*:0]u8,
    return_buffer_size: u32,
    required_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupGetInfPublishedNameW(
    driver_store_location: ?[*:0]const u16,
    return_buffer: [*:0]u16,
    return_buffer_size: u32,
    required_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupFindNextLine(
    context_in: ?*INFCONTEXT,
    context_out: ?*INFCONTEXT,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupGetFileCompressionInfoA(
    source_file_name: ?[*:0]const u8,
    actual_source_file_name: ?*?PSTR,
    source_file_size: ?*u32,
    target_file_size: ?*u32,
    compression_type: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "setupapi" fn SetupGetFileCompressionInfoW(
    source_file_name: ?[*:0]const u16,
    actual_source_file_name: ?*?PWSTR,
    source_file_size: ?*u32,
    target_file_size: ?*u32,
    compression_type: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "setupapi" fn SetupGetFileCompressionInfoExA(
    source_file_name: ?[*:0]const u8,
    actual_source_file_name_buffer: ?[*:0]u8,
    actual_source_file_name_buffer_len: u32,
    required_buffer_len: ?*u32,
    source_file_size: ?*u32,
    target_file_size: ?*u32,
    compression_type: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupGetFileCompressionInfoExW(
    source_file_name: ?[*:0]const u16,
    actual_source_file_name_buffer: ?[*:0]u16,
    actual_source_file_name_buffer_len: u32,
    required_buffer_len: ?*u32,
    source_file_size: ?*u32,
    target_file_size: ?*u32,
...
pub extern "setupapi" fn SetupPromptForDiskA(
    hwnd_parent: ?HWND,
    dialog_title: ?[*:0]const u8,
    disk_name: ?[*:0]const u8,
    path_to_source: ?[*:0]const u8,
    file_sought: ?[*:0]const u8,
    tag_file: ?[*:0]const u8,
    disk_prompt_style: u32,
    path_buffer: ?[*:0]u8,
    path_buffer_size: u32,
    path_required_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "setupapi" fn SetupPromptForDiskW(
    hwnd_parent: ?HWND,
    dialog_title: ?[*:0]const u16,
    disk_name: ?[*:0]const u16,
    path_to_source: ?[*:0]const u16,
    file_sought: ?[*:0]const u16,
    tag_file: ?[*:0]const u16,
    disk_prompt_style: u32,
    path_buffer: ?[*:0]u16,
    path_buffer_size: u32,
    path_required_size: ?*u32,
...
pub extern "setupapi" fn SetupCopyErrorW(
    ...
    disk_name: ?[*:0]const u16,
    path_to_source: ?[*:0]const u16,
    source_file: ?[*:0]const u16,
    target_path_file: ?[*:0]const u16,
    win32_error_code: u32,
    style: u32,
    path_buffer: ?[*:0]u16,
    path_buffer_size: u32,
...
pub extern "setupapi" fn SetupInstallFileA(
    ...
    inf_context: ?*INFCONTEXT,
    source_file: ?[*:0]const u8,
    source_path_root: ?[*:0]const u8,
    destination_name: ?[*:0]const u8,
    copy_style: SP_COPY_STYLE,
    copy_msg_handler: ?PSP_FILE_CALLBACK_A,
    context: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupInstallFileW(
    ...
    inf_context: ?*INFCONTEXT,
    source_file: ?[*:0]const u16,
    source_path_root: ?[*:0]const u16,
    destination_name: ?[*:0]const u16,
    copy_style: SP_COPY_STYLE,
    copy_msg_handler: ?PSP_FILE_CALLBACK_W,
    context: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupSetFileQueueAlternatePlatformA(
    queue_handle: ?*anyopaque,
    alternate_platform_info: ?*SP_ALTPLATFORM_INFO_V2,
    alternate_default_catalog_file: ?[*:0]const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupSetFileQueueAlternatePlatformW(
    queue_handle: ?*anyopaque,
    alternate_platform_info: ?*SP_ALTPLATFORM_INFO_V2,
    alternate_default_catalog_file: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupQueueCopyA(
    queue_handle: ?*anyopaque,
    source_root_path: ?[*:0]const u8,
    source_path: ?[*:0]const u8,
    source_filename: ?[*:0]const u8,
    source_description: ?[*:0]const u8,
    source_tagfile: ?[*:0]const u8,
    target_directory: ?[*:0]const u8,
    target_filename: ?[*:0]const u8,
    copy_style: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupQueueCopyW(
    queue_handle: ?*anyopaque,
    source_root_path: ?[*:0]const u16,
    source_path: ?[*:0]const u16,
    source_filename: ?[*:0]const u16,
    source_description: ?[*:0]const u16,
    source_tagfile: ?[*:0]const u16,
    target_directory: ?[*:0]const u16,
    target_filename: ?[*:0]const u16,
    copy_style: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "setupapi" fn SetupQueueCopyIndirectA(
    copy_params: ?*SP_FILE_COPY_PARAMS_A,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "setupapi" fn SetupQueueCopyIndirectW(
    copy_params: ?*SP_FILE_COPY_PARAMS_W,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupQueueDeleteA(
    queue_handle: ?*anyopaque,
    path_part1: ?[*:0]const u8,
    path_part2: ?[*:0]const u8,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "setupapi" fn SetupQueueDeleteW(
    queue_handle: ?*anyopaque,
    path_part1: ?[*:0]const u16,
    path_part2: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupCommitFileQueueA(
    owner: ?HWND,
    queue_handle: ?*anyopaque,
    msg_handler: ?PSP_FILE_CALLBACK_A,
    context: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupCommitFileQueueW(
    owner: ?HWND,
    queue_handle: ?*anyopaque,
    msg_handler: ?PSP_FILE_CALLBACK_W,
    context: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "setupapi" fn SetupScanFileQueueA(
    file_queue: ?*anyopaque,
    flags: u32,
    window: ?HWND,
    callback_routine: ?PSP_FILE_CALLBACK_A,
...
pub extern "setupapi" fn SetupScanFileQueueW(
    ...
    flags: u32,
    window: ?HWND,
    callback_routine: ?PSP_FILE_CALLBACK_W,
    callback_context: ?*anyopaque,
    result: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupCopyOEMInfA(
    source_inf_file_name: ?[*:0]const u8,
    o_e_m_source_media_location: ?[*:0]const u8,
    o_e_m_source_media_type: OEM_SOURCE_MEDIA_TYPE,
    copy_style: u32,
    destination_inf_file_name: ?[*:0]u8,
    destination_inf_file_name_size: u32,
    required_size: ?*u32,
    destination_inf_file_name_component: ?*?PSTR,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "setupapi" fn SetupCopyOEMInfW(
    source_inf_file_name: ?[*:0]const u16,
    o_e_m_source_media_location: ?[*:0]const u16,
    o_e_m_source_media_type: OEM_SOURCE_MEDIA_TYPE,
    copy_style: u32,
    destination_inf_file_name: ?[*:0]u16,
    destination_inf_file_name_size: u32,
    required_size: ?*u32,
    destination_inf_file_name_component: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "setupapi" fn SetupUninstallOEMInfA(
    inf_file_name: ?[*:0]const u8,
    flags: u32,
    reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupInitDefaultQueueCallbackEx(
    owner_window: ?HWND,
    alternate_progress_window: ?HWND,
...
pub extern "setupapi" fn SetupInitializeFileLogA(
    log_file_name: ?[*:0]const u8,
    flags: u32,
) callconv(@import("std").os.windows.WINAPI) ?*anyopaque;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "setupapi" fn SetupInitializeFileLogW(
    log_file_name: ?[*:0]const u16,
    flags: u32,
) callconv(@import("std").os.windows.WINAPI) ?*anyopaque;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "setupapi" fn SetupTerminateFileLog(
    file_log_handle: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "setupapi" fn SetupLogFileA(
    file_log_handle: ?*anyopaque,
    log_section_name: ?[*:0]const u8,
    source_filename: ?[*:0]const u8,
    target_filename: ?[*:0]const u8,
    checksum: u32,
    disk_tagfile: ?[*:0]const u8,
    disk_description: ?[*:0]const u8,
    other_info: ?[*:0]const u8,
    flags: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupLogFileW(
    file_log_handle: ?*anyopaque,
    log_section_name: ?[*:0]const u16,
    source_filename: ?[*:0]const u16,
    target_filename: ?[*:0]const u16,
    checksum: u32,
    disk_tagfile: ?[*:0]const u16,
    disk_description: ?[*:0]const u16,
    other_info: ?[*:0]const u16,
    flags: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupLogErrorA(
    message_string: ?[*:0]const u8,
    severity: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "setupapi" fn SetupLogErrorW(
    message_string: ?[*:0]const u16,
    severity: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupGetBackupInformationA(
    queue_handle: ?*anyopaque,
    backup_params: ?*SP_BACKUP_QUEUE_PARAMS_V2_A,
) callconv(@import("std").os.windows.WINAPI) BOOL;

pub extern "setupapi" fn SetupGetBackupInformationW(
    queue_handle: ?*anyopaque,
    backup_params: ?*SP_BACKUP_QUEUE_PARAMS_V2_W,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiGetDeviceInfoListDetailA(
    device_info_set: ?*anyopaque,
    device_info_set_detail_data: ?*SP_DEVINFO_LIST_DETAIL_DATA_A,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.0'
pub extern "setupapi" fn SetupDiGetDeviceInfoListDetailW(
    device_info_set: ?*anyopaque,
    device_info_set_detail_data: ?*SP_DEVINFO_LIST_DETAIL_DATA_W,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiCreateDeviceInfoW(
    device_info_set: ?*anyopaque,
    device_name: ?[*:0]const u16,
    class_guid: ?*const Guid,
    device_description: ?[*:0]const u16,
    hwnd_parent: ?HWND,
    creation_flags: u32,
    device_info_data: ?*SP_DEVINFO_DATA,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiGetDeviceInterfaceAlias(
    device_info_set: ?*anyopaque,
    device_interface_data: ?*SP_DEVICE_INTERFACE_DATA,
    alias_interface_class_guid: ?*const Guid,
    alias_device_interface_data: ?*SP_DEVICE_INTERFACE_DATA,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiRegisterDeviceInfo(
    ...
    device_info_data: ?*SP_DEVINFO_DATA,
    flags: u32,
    compare_proc: ?PSP_DETSIG_CMPPROC,
    compare_context: ?*anyopaque,
    dup_device_info_data: ?*SP_DEVINFO_DATA,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiBuildDriverInfoList(
    device_info_set: ?*anyopaque,
    device_info_data: ?*SP_DEVINFO_DATA,
    driver_type: SETUP_DI_BUILD_DRIVER_DRIVER_TYPE,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiEnumDriverInfoA(
    ...
    driver_type: u32,
    member_index: u32,
    driver_info_data: ?*SP_DRVINFO_DATA_V2_A,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiEnumDriverInfoW(
    ...
    driver_type: u32,
    member_index: u32,
    driver_info_data: ?*SP_DRVINFO_DATA_V2_W,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiGetDriverInfoDetailA(
    ...
    driver_info_data: ?*SP_DRVINFO_DATA_V2_A,
    // TODO: what to do with BytesParamIndex 4?
    driver_info_detail_data: ?*SP_DRVINFO_DETAIL_DATA_A,
...
pub extern "setupapi" fn SetupDiGetDriverInfoDetailW(
    ...
    driver_info_data: ?*SP_DRVINFO_DATA_V2_W,
    // TODO: what to do with BytesParamIndex 4?
    driver_info_detail_data: ?*SP_DRVINFO_DETAIL_DATA_W,
    driver_info_detail_data_size: u32,
    required_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiBuildClassInfoList(
    flags: u32,
    class_guid_list: ?[*]Guid,
    class_guid_list_size: u32,
    required_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiGetClassDescriptionA(
    class_guid: ?*const Guid,
    class_description: [*:0]u8,
    class_description_size: u32,
    required_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiGetHwProfileList(
    hw_profile_list: [*]u32,
    hw_profile_list_size: u32,
    required_size: ?*u32,
    currently_active_index: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiGetDevicePropertyKeys(
    device_info_set: ?*anyopaque,
    device_info_data: ?*SP_DEVINFO_DATA,
    property_key_array: ?[*]DEVPROPKEY,
    property_key_count: u32,
    required_property_key_count: ?*u32,
    flags: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiGetDeviceInstallParamsA(
    device_info_set: ?*anyopaque,
    device_info_data: ?*SP_DEVINFO_DATA,
    device_install_params: ?*SP_DEVINSTALL_PARAMS_A,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiGetDeviceInstallParamsW(
    device_info_set: ?*anyopaque,
    device_info_data: ?*SP_DEVINFO_DATA,
    device_install_params: ?*SP_DEVINSTALL_PARAMS_W,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiGetClassInstallParamsA(
    ...
    device_info_data: ?*SP_DEVINFO_DATA,
    // TODO: what to do with BytesParamIndex 3?
    class_install_params: ?*SP_CLASSINSTALL_HEADER,
...
pub extern "setupapi" fn SetupDiGetDriverInstallParamsA(
    ...
    device_info_data: ?*SP_DEVINFO_DATA,
    driver_info_data: ?*SP_DRVINFO_DATA_V2_A,
    driver_install_params: ?*SP_DRVINSTALL_PARAMS,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiGetClassImageList(
    class_image_list_data: ?*SP_CLASSIMAGELIST_DATA,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiGetClassDevPropertySheetsA(
    device_info_set: ?*anyopaque,
    device_info_data: ?*SP_DEVINFO_DATA,
    property_sheet_header: ?*PROPSHEETHEADERA_V2,
    property_sheet_header_page_list_size: u32,
    required_size: ?*u32,
    property_sheet_type: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiGetClassDevPropertySheetsW(
    device_info_set: ?*anyopaque,
    device_info_data: ?*SP_DEVINFO_DATA,
    property_sheet_header: ?*PROPSHEETHEADERW_V2,
    property_sheet_header_page_list_size: u32,
    required_size: ?*u32,
    property_sheet_type: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiGetWizardPage(
    device_info_set: ?*anyopaque,
    device_info_data: ?*SP_DEVINFO_DATA,
    install_wizard_data: ?*SP_INSTALLWIZARD_DATA,
    page_type: u32,
    flags: u32,
...
pub extern "setupapi" fn SetupDiGetActualModelsSectionA(
    context: ?*INFCONTEXT,
    alternate_platform_info: ?*SP_ALTPLATFORM_INFO_V2,
    inf_section_with_ext: ?[*:0]u8,
    inf_section_with_ext_size: u32,
    required_size: ?*u32,
    reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupVerifyInfFileA(
    inf_name: ?[*:0]const u8,
    alt_platform_info: ?*SP_ALTPLATFORM_INFO_V2,
    inf_signer_info: ?*SP_INF_SIGNER_INFO_V2_A,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupVerifyInfFileW(
    inf_name: ?[*:0]const u16,
    alt_platform_info: ?*SP_ALTPLATFORM_INFO_V2,
    inf_signer_info: ?*SP_INF_SIGNER_INFO_V2_W,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "setupapi" fn SetupDiGetCustomDevicePropertyA(
    device_info_set: ?*anyopaque,
    device_info_data: ?*SP_DEVINFO_DATA,
    custom_property_name: ?[*:0]const u8,
    flags: u32,
    property_reg_data_type: ?*u32,
...
pub extern "setupapi" fn SetupDiGetCustomDevicePropertyW(
    device_info_set: ?*anyopaque,
    device_info_data: ?*SP_DEVINFO_DATA,
    custom_property_name: ?[*:0]const u16,
    flags: u32,
    property_reg_data_type: ?*u32,
    // TODO: what to do with BytesParamIndex 6?
    property_buffer: ?*u8,
...
pub extern "cfgmgr32" fn CM_Connect_MachineA(
    u_n_c_server_name: ?[*:0]const u8,
    ph_machine: ?*isize,
) callconv(@import("std").os.windows.WINAPI) CONFIGRET;

// TODO: this type is limited to platform 'windows5.0'
pub extern "cfgmgr32" fn CM_Connect_MachineW(
    u_n_c_server_name: ?[*:0]const u16,
    ph_machine: ?*isize,
) callconv(@import("std").os.windows.WINAPI) CONFIGRET;
...
pub extern "cfgmgr32" fn CM_Get_DevNode_Custom_PropertyA(
    dn_dev_inst: u32,
    psz_custom_property_name: ?[*:0]const u8,
    pul_reg_data_type: ?*u32,
    // TODO: what to do with BytesParamIndex 4?
    buffer: ?*anyopaque,
    pul_length: ?*u32,
...
pub extern "cfgmgr32" fn CM_Get_DevNode_Custom_PropertyW(
    dn_dev_inst: u32,
    psz_custom_property_name: ?[*:0]const u16,
    pul_reg_data_type: ?*u32,
    // TODO: what to do with BytesParamIndex 4?
    buffer: ?*anyopaque,
    pul_length: ?*u32,
...
pub extern "cfgmgr32" fn CM_Get_Hardware_Profile_InfoA(
    ul_index: u32,
    p_h_w_profile_info: ?*HWProfileInfo_sA,
    ul_flags: u32,
) callconv(@import("std").os.windows.WINAPI) CONFIGRET;
...
pub extern "cfgmgr32" fn CM_Get_Hardware_Profile_InfoW(
    ul_index: u32,
    p_h_w_profile_info: ?*HWProfileInfo_sW,
    ul_flags: u32,
) callconv(@import("std").os.windows.WINAPI) CONFIGRET;
...
pub extern "cfgmgr32" fn CM_Get_Device_Interface_AliasA(
    psz_device_interface: ?[*:0]const u8,
    alias_interface_guid: ?*Guid,
    psz_alias_device_interface: [*:0]u8,
    pul_length: ?*u32,
    ul_flags: u32,
) callconv(@import("std").os.windows.WINAPI) CONFIGRET;
...
pub extern "cfgmgr32" fn CM_Get_Device_Interface_AliasW(
    psz_device_interface: ?[*:0]const u16,
    alias_interface_guid: ?*Guid,
    psz_alias_device_interface: [*:0]u16,
    pul_length: ?*u32,
    ul_flags: u32,
) callconv(@import("std").os.windows.WINAPI) CONFIGRET;
...
pub extern "cfgmgr32" fn CM_Register_Device_InterfaceA(
    dn_dev_inst: u32,
    interface_class_guid: ?*Guid,
    psz_reference: ?[*:0]const u8,
    psz_device_interface: [*:0]u8,
    pul_length: ?*u32,
    ul_flags: u32,
) callconv(@import("std").os.windows.WINAPI) CONFIGRET;
...
pub extern "cfgmgr32" fn CM_Register_Device_InterfaceW(
    dn_dev_inst: u32,
    interface_class_guid: ?*Guid,
    psz_reference: ?[*:0]const u16,
    psz_device_interface: [*:0]u16,
    pul_length: ?*u32,
    ul_flags: u32,
) callconv(@import("std").os.windows.WINAPI) CONFIGRET;
...
pub extern "cfgmgr32" fn CM_Get_Resource_Conflict_DetailsA(
    cl_conflict_list: usize,
    ul_index: u32,
    p_conflict_details: ?*CONFLICT_DETAILS_A,
) callconv(@import("std").os.windows.WINAPI) CONFIGRET;
...
pub extern "cfgmgr32" fn CM_Get_Resource_Conflict_DetailsW(
    cl_conflict_list: usize,
    ul_index: u32,
    p_conflict_details: ?*CONFLICT_DETAILS_W,
) callconv(@import("std").os.windows.WINAPI) CONFIGRET;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "cfgmgr32" fn CM_Get_Class_PropertyW(
    class_g_u_i_d: ?*const Guid,
    property_key: ?*const DEVPROPKEY,
    property_type: ?*u32,
    // TODO: what to do with BytesParamIndex 4?
    property_buffer: ?*u8,
...
pub extern "cfgmgr32" fn CM_Register_Notification(
    p_filter: ?*CM_NOTIFY_FILTER,
    p_context: ?*anyopaque,
    p_callback: ?PCM_NOTIFY_CALLBACK,
    p_notify_context: ?*isize,
) callconv(@import("std").os.windows.WINAPI) CONFIGRET;

// TODO: this type is limited to platform 'windows8.0'
pub extern "cfgmgr32" fn CM_Unregister_Notification(
    notify_context: ?HCMNOTIFICATION,
) callconv(@import("std").os.windows.WINAPI) CONFIGRET;

// TODO: this type is limited to platform 'windows6.1'
pub extern "cfgmgr32" fn CM_MapCrToWin32Err(
    cm_return_code: CONFIGRET,
    default_err: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "newdev" fn UpdateDriverForPlugAndPlayDevicesA(
    hwnd_parent: ?HWND,
    hardware_id: ?[*:0]const u8,
    full_inf_path: ?[*:0]const u8,
    install_flags: u32,
    b_reboot_required: ?*BOOL,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.0'
pub extern "newdev" fn UpdateDriverForPlugAndPlayDevicesW(
    hwnd_parent: ?HWND,
    hardware_id: ?[*:0]const u16,
    full_inf_path: ?[*:0]const u16,
    install_flags: u32,
    b_reboot_required: ?*BOOL,
) callconv(@import("std").os.windows.WINAPI) BOOL;
