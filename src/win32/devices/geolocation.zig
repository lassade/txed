...
pub const ILocationReport = extern struct {
    pub const VTable = extern struct {
        ...
        GetTimestamp: *const fn (
            self: *const ILocationReport,
            p_creation_time: ?*SYSTEMTIME,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetValue: *const fn (
            self: *const ILocationReport,
            p_key: ?*const PROPERTYKEY,
            p_value: ?*PROPVARIANT,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getSensorID(self: *const T, p_sensor_i_d_: ?*Guid) HRESULT {
                return @as(*const ILocationReport.VTable, @ptrCast(self.vtable)).GetSensorID(@as(*const ILocationReport, @ptrCast(self)), p_sensor_i_d_);
            }
            pub inline fn getTimestamp(self: *const T, p_creation_time_: ?*SYSTEMTIME) HRESULT {
                return @as(*const ILocationReport.VTable, @ptrCast(self.vtable)).GetTimestamp(@as(*const ILocationReport, @ptrCast(self)), p_creation_time_);
            }
            pub inline fn getValue(self: *const T, p_key_: ?*const PROPERTYKEY, p_value_: ?*PROPVARIANT) HRESULT {
                return @as(*const ILocationReport.VTable, @ptrCast(self.vtable)).GetValue(@as(*const ILocationReport, @ptrCast(self)), p_key_, p_value_);
            }
        };
    }
...
pub const ILatLongReport = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getLatitude(self: *const T, p_latitude_: ?*f64) HRESULT {
                return @as(*const ILatLongReport.VTable, @ptrCast(self.vtable)).GetLatitude(@as(*const ILatLongReport, @ptrCast(self)), p_latitude_);
            }
            pub inline fn getLongitude(self: *const T, p_longitude_: ?*f64) HRESULT {
                return @as(*const ILatLongReport.VTable, @ptrCast(self.vtable)).GetLongitude(@as(*const ILatLongReport, @ptrCast(self)), p_longitude_);
            }
            pub inline fn getErrorRadius(self: *const T, p_error_radius_: ?*f64) HRESULT {
                return @as(*const ILatLongReport.VTable, @ptrCast(self.vtable)).GetErrorRadius(@as(*const ILatLongReport, @ptrCast(self)), p_error_radius_);
            }
            pub inline fn getAltitude(self: *const T, p_altitude_: ?*f64) HRESULT {
                return @as(*const ILatLongReport.VTable, @ptrCast(self.vtable)).GetAltitude(@as(*const ILatLongReport, @ptrCast(self)), p_altitude_);
            }
            pub inline fn getAltitudeError(self: *const T, p_altitude_error_: ?*f64) HRESULT {
                return @as(*const ILatLongReport.VTable, @ptrCast(self.vtable)).GetAltitudeError(@as(*const ILatLongReport, @ptrCast(self)), p_altitude_error_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ICivicAddressReport = extern struct {
    pub const VTable = extern struct {
        ...
        GetStateProvince: *const fn (
            self: *const ICivicAddressReport,
            pbstr_state_province: ?*?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetPostalCode: *const fn (
            self: *const ICivicAddressReport,
            pbstr_postal_code: ?*?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetCountryRegion: *const fn (
            self: *const ICivicAddressReport,
            pbstr_country_region: ?*?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace ILocationReport.MethodMixin(T);
            pub inline fn getAddressLine1(self: *const T, pbstr_address1_: ?*?BSTR) HRESULT {
                return @as(*const ICivicAddressReport.VTable, @ptrCast(self.vtable)).GetAddressLine1(@as(*const ICivicAddressReport, @ptrCast(self)), pbstr_address1_);
            }
            pub inline fn getAddressLine2(self: *const T, pbstr_address2_: ?*?BSTR) HRESULT {
                return @as(*const ICivicAddressReport.VTable, @ptrCast(self.vtable)).GetAddressLine2(@as(*const ICivicAddressReport, @ptrCast(self)), pbstr_address2_);
            }
            pub inline fn getCity(self: *const T, pbstr_city_: ?*?BSTR) HRESULT {
                return @as(*const ICivicAddressReport.VTable, @ptrCast(self.vtable)).GetCity(@as(*const ICivicAddressReport, @ptrCast(self)), pbstr_city_);
            }
            pub inline fn getStateProvince(self: *const T, pbstr_state_province_: ?*?BSTR) HRESULT {
                return @as(*const ICivicAddressReport.VTable, @ptrCast(self.vtable)).GetStateProvince(@as(*const ICivicAddressReport, @ptrCast(self)), pbstr_state_province_);
            }
            pub inline fn getPostalCode(self: *const T, pbstr_postal_code_: ?*?BSTR) HRESULT {
                return @as(*const ICivicAddressReport.VTable, @ptrCast(self.vtable)).GetPostalCode(@as(*const ICivicAddressReport, @ptrCast(self)), pbstr_postal_code_);
            }
            pub inline fn getCountryRegion(self: *const T, pbstr_country_region_: ?*?BSTR) HRESULT {
                return @as(*const ICivicAddressReport.VTable, @ptrCast(self.vtable)).GetCountryRegion(@as(*const ICivicAddressReport, @ptrCast(self)), pbstr_country_region_);
            }
            pub inline fn getDetailLevel(self: *const T, p_detail_level_: ?*u32) HRESULT {
                return @as(*const ICivicAddressReport.VTable, @ptrCast(self.vtable)).GetDetailLevel(@as(*const ICivicAddressReport, @ptrCast(self)), p_detail_level_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ILocation = extern struct {
    pub const VTable = extern struct {
        ...
        RegisterForReport: *const fn (
            ...
            p_events: ?*ILocationEvents,
            report_type: ?*const Guid,
            dw_requested_report_interval: u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        GetReport: *const fn (
            self: *const ILocation,
            report_type: ?*const Guid,
            pp_location_report: ?*?*ILocationReport,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetReportStatus: *const fn (
            self: *const ILocation,
            report_type: ?*const Guid,
            p_status: ?*LOCATION_REPORT_STATUS,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        SetReportInterval: *const fn (
            self: *const ILocation,
            report_type: ?*const Guid,
            milliseconds_requested: u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetDesiredAccuracy: *const fn (
            self: *const ILocation,
            report_type: ?*const Guid,
            p_desired_accuracy: ?*LOCATION_DESIRED_ACCURACY,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        SetDesiredAccuracy: *const fn (
            self: *const ILocation,
            report_type: ?*const Guid,
            desired_accuracy: LOCATION_DESIRED_ACCURACY,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn registerForReport(self: *const T, p_events_: ?*ILocationEvents, report_type_: ?*const Guid, dw_requested_report_interval_: u32) HRESULT {
                return @as(*const ILocation.VTable, @ptrCast(self.vtable)).RegisterForReport(@as(*const ILocation, @ptrCast(self)), p_events_, report_type_, dw_requested_report_interval_);
            }
            pub inline fn unregisterForReport(self: *const T, report_type_: ?*const Guid) HRESULT {
                return @as(*const ILocation.VTable, @ptrCast(self.vtable)).UnregisterForReport(@as(*const ILocation, @ptrCast(self)), report_type_);
            }
            pub inline fn getReport(self: *const T, report_type_: ?*const Guid, pp_location_report_: ?*?*ILocationReport) HRESULT {
                return @as(*const ILocation.VTable, @ptrCast(self.vtable)).GetReport(@as(*const ILocation, @ptrCast(self)), report_type_, pp_location_report_);
            }
            pub inline fn getReportStatus(self: *const T, report_type_: ?*const Guid, p_status_: ?*LOCATION_REPORT_STATUS) HRESULT {
                return @as(*const ILocation.VTable, @ptrCast(self.vtable)).GetReportStatus(@as(*const ILocation, @ptrCast(self)), report_type_, p_status_);
            }
            pub inline fn getReportInterval(self: *const T, report_type_: ?*const Guid, p_milliseconds_: ?*u32) HRESULT {
                return @as(*const ILocation.VTable, @ptrCast(self.vtable)).GetReportInterval(@as(*const ILocation, @ptrCast(self)), report_type_, p_milliseconds_);
            }
            pub inline fn setReportInterval(self: *const T, report_type_: ?*const Guid, milliseconds_requested_: u32) HRESULT {
                return @as(*const ILocation.VTable, @ptrCast(self.vtable)).SetReportInterval(@as(*const ILocation, @ptrCast(self)), report_type_, milliseconds_requested_);
            }
            pub inline fn getDesiredAccuracy(self: *const T, report_type_: ?*const Guid, p_desired_accuracy_: ?*LOCATION_DESIRED_ACCURACY) HRESULT {
                return @as(*const ILocation.VTable, @ptrCast(self.vtable)).GetDesiredAccuracy(@as(*const ILocation, @ptrCast(self)), report_type_, p_desired_accuracy_);
            }
            pub inline fn setDesiredAccuracy(self: *const T, report_type_: ?*const Guid, desired_accuracy_: LOCATION_DESIRED_ACCURACY) HRESULT {
                return @as(*const ILocation.VTable, @ptrCast(self.vtable)).SetDesiredAccuracy(@as(*const ILocation, @ptrCast(self)), report_type_, desired_accuracy_);
            }
            pub inline fn requestPermissions(self: *const T, h_parent_: ?HWND, p_report_types_: [*]Guid, count_: u32, f_modal_: BOOL) HRESULT {
                return @as(*const ILocation.VTable, @ptrCast(self.vtable)).RequestPermissions(@as(*const ILocation, @ptrCast(self)), h_parent_, p_report_types_, count_, f_modal_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDefaultLocation = extern struct {
    pub const VTable = extern struct {
        ...
        SetReport: *const fn (
            ...
            report_type: ?*const Guid,
            p_location_report: ?*ILocationReport,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetReport: *const fn (
            self: *const IDefaultLocation,
            report_type: ?*const Guid,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn setReport(self: *const T, report_type_: ?*const Guid, p_location_report_: ?*ILocationReport) HRESULT {
                return @as(*const IDefaultLocation.VTable, @ptrCast(self.vtable)).SetReport(@as(*const IDefaultLocation, @ptrCast(self)), report_type_, p_location_report_);
            }
            pub inline fn getReport(self: *const T, report_type_: ?*const Guid, pp_location_report_: ?*?*ILocationReport) HRESULT {
                return @as(*const IDefaultLocation.VTable, @ptrCast(self.vtable)).GetReport(@as(*const IDefaultLocation, @ptrCast(self)), report_type_, pp_location_report_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ILocationEvents = extern struct {
    pub const VTable = extern struct {
        ...
        OnStatusChanged: *const fn (
            self: *const ILocationEvents,
            report_type: ?*const Guid,
            new_status: LOCATION_REPORT_STATUS,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn onLocationChanged(self: *const T, report_type_: ?*const Guid, p_location_report_: ?*ILocationReport) HRESULT {
                return @as(*const ILocationEvents.VTable, @ptrCast(self.vtable)).OnLocationChanged(@as(*const ILocationEvents, @ptrCast(self)), report_type_, p_location_report_);
            }
            pub inline fn onStatusChanged(self: *const T, report_type_: ?*const Guid, new_status_: LOCATION_REPORT_STATUS) HRESULT {
                return @as(*const ILocationEvents.VTable, @ptrCast(self.vtable)).OnStatusChanged(@as(*const ILocationEvents, @ptrCast(self)), report_type_, new_status_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDispLatLongReport = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getLatitude(self: *const T, p_val_: ?*f64) HRESULT {
                return @as(*const IDispLatLongReport.VTable, @ptrCast(self.vtable)).get_Latitude(@as(*const IDispLatLongReport, @ptrCast(self)), p_val_);
            }
            pub inline fn getLongitude(self: *const T, p_val_: ?*f64) HRESULT {
                return @as(*const IDispLatLongReport.VTable, @ptrCast(self.vtable)).get_Longitude(@as(*const IDispLatLongReport, @ptrCast(self)), p_val_);
            }
            pub inline fn getErrorRadius(self: *const T, p_val_: ?*f64) HRESULT {
                return @as(*const IDispLatLongReport.VTable, @ptrCast(self.vtable)).get_ErrorRadius(@as(*const IDispLatLongReport, @ptrCast(self)), p_val_);
            }
            pub inline fn getAltitude(self: *const T, p_val_: ?*f64) HRESULT {
                return @as(*const IDispLatLongReport.VTable, @ptrCast(self.vtable)).get_Altitude(@as(*const IDispLatLongReport, @ptrCast(self)), p_val_);
            }
            pub inline fn getAltitudeError(self: *const T, p_val_: ?*f64) HRESULT {
                return @as(*const IDispLatLongReport.VTable, @ptrCast(self.vtable)).get_AltitudeError(@as(*const IDispLatLongReport, @ptrCast(self)), p_val_);
            }
            pub inline fn getTimestamp(self: *const T, p_val_: ?*f64) HRESULT {
                return @as(*const IDispLatLongReport.VTable, @ptrCast(self.vtable)).get_Timestamp(@as(*const IDispLatLongReport, @ptrCast(self)), p_val_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDispCivicAddressReport = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getAddressLine1(self: *const T, p_address1_: ?*?BSTR) HRESULT {
                return @as(*const IDispCivicAddressReport.VTable, @ptrCast(self.vtable)).get_AddressLine1(@as(*const IDispCivicAddressReport, @ptrCast(self)), p_address1_);
            }
            pub inline fn getAddressLine2(self: *const T, p_address2_: ?*?BSTR) HRESULT {
                return @as(*const IDispCivicAddressReport.VTable, @ptrCast(self.vtable)).get_AddressLine2(@as(*const IDispCivicAddressReport, @ptrCast(self)), p_address2_);
            }
            pub inline fn getCity(self: *const T, p_city_: ?*?BSTR) HRESULT {
                return @as(*const IDispCivicAddressReport.VTable, @ptrCast(self.vtable)).get_City(@as(*const IDispCivicAddressReport, @ptrCast(self)), p_city_);
            }
            pub inline fn getStateProvince(self: *const T, p_state_province_: ?*?BSTR) HRESULT {
                return @as(*const IDispCivicAddressReport.VTable, @ptrCast(self.vtable)).get_StateProvince(@as(*const IDispCivicAddressReport, @ptrCast(self)), p_state_province_);
            }
            pub inline fn getPostalCode(self: *const T, p_postal_code_: ?*?BSTR) HRESULT {
                return @as(*const IDispCivicAddressReport.VTable, @ptrCast(self.vtable)).get_PostalCode(@as(*const IDispCivicAddressReport, @ptrCast(self)), p_postal_code_);
            }
            pub inline fn getCountryRegion(self: *const T, p_country_region_: ?*?BSTR) HRESULT {
                return @as(*const IDispCivicAddressReport.VTable, @ptrCast(self.vtable)).get_CountryRegion(@as(*const IDispCivicAddressReport, @ptrCast(self)), p_country_region_);
            }
            pub inline fn getDetailLevel(self: *const T, p_detail_level_: ?*u32) HRESULT {
                return @as(*const IDispCivicAddressReport.VTable, @ptrCast(self.vtable)).get_DetailLevel(@as(*const IDispCivicAddressReport, @ptrCast(self)), p_detail_level_);
            }
            pub inline fn getTimestamp(self: *const T, p_val_: ?*f64) HRESULT {
                return @as(*const IDispCivicAddressReport.VTable, @ptrCast(self.vtable)).get_Timestamp(@as(*const IDispCivicAddressReport, @ptrCast(self)), p_val_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ILocationReportFactory = extern struct {
    pub const VTable = extern struct {
        ...
        get_DesiredAccuracy: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ILocationReportFactory,
            p_desired_accuracy: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        put_DesiredAccuracy: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ILocationReportFactory,
            desired_accuracy: u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        RequestPermissions: *const fn (
            self: *const ILocationReportFactory,
            h_wnd: ?*u32,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn listenForReports(self: *const T, requested_report_interval_: u32) HRESULT {
                return @as(*const ILocationReportFactory.VTable, @ptrCast(self.vtable)).ListenForReports(@as(*const ILocationReportFactory, @ptrCast(self)), requested_report_interval_);
            }
            pub inline fn stopListeningForReports(self: *const T) HRESULT {
            ...
            pub inline fn getStatus(self: *const T, p_val_: ?*u32) HRESULT {
                return @as(*const ILocationReportFactory.VTable, @ptrCast(self.vtable)).get_Status(@as(*const ILocationReportFactory, @ptrCast(self)), p_val_);
            }
            pub inline fn getReportInterval(self: *const T, p_milliseconds_: ?*u32) HRESULT {
                return @as(*const ILocationReportFactory.VTable, @ptrCast(self.vtable)).get_ReportInterval(@as(*const ILocationReportFactory, @ptrCast(self)), p_milliseconds_);
            }
            pub inline fn putReportInterval(self: *const T, milliseconds_requested_: u32) HRESULT {
                return @as(*const ILocationReportFactory.VTable, @ptrCast(self.vtable)).put_ReportInterval(@as(*const ILocationReportFactory, @ptrCast(self)), milliseconds_requested_);
            }
            pub inline fn getDesiredAccuracy(self: *const T, p_desired_accuracy_: ?*u32) HRESULT {
                return @as(*const ILocationReportFactory.VTable, @ptrCast(self.vtable)).get_DesiredAccuracy(@as(*const ILocationReportFactory, @ptrCast(self)), p_desired_accuracy_);
            }
            pub inline fn putDesiredAccuracy(self: *const T, desired_accuracy_: u32) HRESULT {
                return @as(*const ILocationReportFactory.VTable, @ptrCast(self.vtable)).put_DesiredAccuracy(@as(*const ILocationReportFactory, @ptrCast(self)), desired_accuracy_);
            }
            pub inline fn requestPermissions(self: *const T, h_wnd_: ?*u32) HRESULT {
                return @as(*const ILocationReportFactory.VTable, @ptrCast(self.vtable)).RequestPermissions(@as(*const ILocationReportFactory, @ptrCast(self)), h_wnd_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ILatLongReportFactory = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getLatLongReport(self: *const T, p_val_: ?*?*IDispLatLongReport) HRESULT {
                return @as(*const ILatLongReportFactory.VTable, @ptrCast(self.vtable)).get_LatLongReport(@as(*const ILatLongReportFactory, @ptrCast(self)), p_val_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ICivicAddressReportFactory = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace ILocationReportFactory.MethodMixin(T);
            pub inline fn getCivicAddressReport(self: *const T, p_val_: ?*?*IDispCivicAddressReport) HRESULT {
                return @as(*const ICivicAddressReportFactory.VTable, @ptrCast(self.vtable)).get_CivicAddressReport(@as(*const ICivicAddressReportFactory, @ptrCast(self)), p_val_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
