...
pub extern "kernel32" fn ClearCommError(
    h_file: ?HANDLE,
    lp_errors: ?*CLEAR_COMM_ERROR_FLAGS,
    lp_stat: ?*COMSTAT,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "kernel32" fn GetCommTimeouts(
    h_file: ?HANDLE,
    lp_comm_timeouts: ?*COMMTIMEOUTS,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "kernel32" fn PurgeComm(
    h_file: ?HANDLE,
    dw_flags: PURGE_COMM_FLAGS,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "api-ms-win-core-comm-l1-1-2" fn GetCommPorts(
    lp_port_numbers: [*]u32,
    u_port_numbers_count: u32,
    pu_port_numbers_found: ?*u32,
