...
pub extern "winusb" fn WinUsb_GetAssociatedInterface(
    ...
    associated_interface_handle: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "winusb" fn WinUsb_QueryPipe(
    ...
    alternate_interface_number: u8,
    pipe_index: u8,
    pipe_information: ?*WINUSB_PIPE_INFORMATION,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "winusb" fn WinUsb_QueryPipeEx(
    ...
    pipe_index: u8,
    pipe_information_ex: ?*WINUSB_PIPE_INFORMATION_EX,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "winusb" fn WinUsb_ControlTransfer(
    interface_handle: ?*anyopaque,
    setup_packet: WINUSB_SETUP_PACKET,
    // TODO: what to do with BytesParamIndex 3?
    buffer: ?*u8,
    buffer_length: u32,
    length_transferred: ?*u32,
...
pub extern "winusb" fn WinUsb_ParseConfigurationDescriptor(
    ...
    start_position: ?*anyopaque,
    interface_number: i32,
    alternate_setting: i32,
    interface_class: i32,
    interface_sub_class: i32,
...
pub extern "winusb" fn WinUsb_ReadIsochPipe(
    ...
    iso_packet_descriptors: [*]USBD_ISO_PACKET_DESCRIPTOR,
    overlapped: ?*OVERLAPPED,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "winusb" fn WinUsb_StartTrackingForTimeSync(
    interface_handle: ?*anyopaque,
    start_tracking_info: ?*USB_START_TRACKING_FOR_TIME_SYNC_INFORMATION,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows10.0.10240'
pub extern "winusb" fn WinUsb_GetCurrentFrameNumberAndQpc(
    interface_handle: ?*anyopaque,
    frame_qpc_info: ?*USB_FRAME_NUMBER_AND_QPC_FOR_TIME_SYNC_INFORMATION,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows10.0.10240'
pub extern "winusb" fn WinUsb_StopTrackingForTimeSync(
    interface_handle: ?*anyopaque,
    stop_tracking_info: ?*USB_STOP_TRACKING_FOR_TIME_SYNC_INFORMATION,
) callconv(@import("std").os.windows.WINAPI) BOOL;
