...
pub const ICloneViewHelper = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getConnectedIDs(self: *const T, wsz_adaptor_name_: ?[*:0]const u16, pul_count_: ?*u32, pul_i_d_: ?*u32, ul_flags_: u32) HRESULT {
                return @as(*const ICloneViewHelper.VTable, @ptrCast(self.vtable)).GetConnectedIDs(@as(*const ICloneViewHelper, @ptrCast(self)), wsz_adaptor_name_, pul_count_, pul_i_d_, ul_flags_);
            }
            pub inline fn getActiveTopology(self: *const T, wsz_adaptor_name_: ?[*:0]const u16, ul_source_i_d_: u32, pul_count_: ?*u32, pul_target_i_d_: ?*u32) HRESULT {
                return @as(*const ICloneViewHelper.VTable, @ptrCast(self.vtable)).GetActiveTopology(@as(*const ICloneViewHelper, @ptrCast(self)), wsz_adaptor_name_, ul_source_i_d_, pul_count_, pul_target_i_d_);
            }
            pub inline fn setActiveTopology(self: *const T, wsz_adaptor_name_: ?[*:0]const u16, ul_source_i_d_: u32, ul_count_: u32, pul_target_i_d_: ?*u32) HRESULT {
                return @as(*const ICloneViewHelper.VTable, @ptrCast(self.vtable)).SetActiveTopology(@as(*const ICloneViewHelper, @ptrCast(self)), wsz_adaptor_name_, ul_source_i_d_, ul_count_, pul_target_i_d_);
            }
            pub inline fn commit(self: *const T, f_final_call_: BOOL) HRESULT {
                return @as(*const ICloneViewHelper.VTable, @ptrCast(self.vtable)).Commit(@as(*const ICloneViewHelper, @ptrCast(self)), f_final_call_);
            }
        };
    }
...
pub const IViewHelper = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getConnectedIDs(self: *const T, wsz_adaptor_name_: ?[*:0]const u16, pul_count_: ?*u32, pul_i_d_: ?*u32, ul_flags_: u32) HRESULT {
                return @as(*const IViewHelper.VTable, @ptrCast(self.vtable)).GetConnectedIDs(@as(*const IViewHelper, @ptrCast(self)), wsz_adaptor_name_, pul_count_, pul_i_d_, ul_flags_);
            }
            pub inline fn getActiveTopology(self: *const T, wsz_adaptor_name_: ?[*:0]const u16, ul_source_i_d_: u32, pul_count_: ?*u32, pul_target_i_d_: ?*u32) HRESULT {
                return @as(*const IViewHelper.VTable, @ptrCast(self.vtable)).GetActiveTopology(@as(*const IViewHelper, @ptrCast(self)), wsz_adaptor_name_, ul_source_i_d_, pul_count_, pul_target_i_d_);
            }
            pub inline fn setActiveTopology(self: *const T, wsz_adaptor_name_: ?[*:0]const u16, ul_source_i_d_: u32, ul_count_: u32, pul_target_i_d_: ?*u32) HRESULT {
                return @as(*const IViewHelper.VTable, @ptrCast(self.vtable)).SetActiveTopology(@as(*const IViewHelper, @ptrCast(self)), wsz_adaptor_name_, ul_source_i_d_, ul_count_, pul_target_i_d_);
            }
            ...
            pub inline fn setConfiguration(self: *const T, p_i_stream_: ?*IStream, pul_status_: ?*u32) HRESULT {
                return @as(*const IViewHelper.VTable, @ptrCast(self.vtable)).SetConfiguration(@as(*const IViewHelper, @ptrCast(self)), p_i_stream_, pul_status_);
            }
            pub inline fn getProceedOnNewConfiguration(self: *const T) HRESULT {
...
pub const PFN = *const fn () callconv(@import("std").os.windows.WINAPI) isize;
...
pub const PFN_DrvDisableDriver = *const fn () callconv(@import("std").os.windows.WINAPI) void;
...
pub const PFN_DrvStartDxInterop = *const fn (
    param0: ?*SURFOBJ,
    param1: BOOL,
    kernel_mode_device_handle: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "dxva2" fn GetNumberOfPhysicalMonitorsFromHMONITOR(
    h_monitor: ?HMONITOR,
    pdw_number_of_physical_monitors: ?*u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "dxva2" fn GetPhysicalMonitorsFromHMONITOR(
    h_monitor: ?HMONITOR,
    dw_physical_monitor_array_size: u32,
    p_physical_monitor_array: [*]PHYSICAL_MONITOR,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "dxva2" fn GetVCPFeatureAndVCPFeatureReply(
    ...
    pdw_current_value: ?*u32,
    pdw_maximum_value: ?*u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "dxva2" fn GetCapabilitiesStringLength(
    h_monitor: ?HANDLE,
    pdw_capabilities_string_length_in_characters: ?*u32,
) callconv(@import("std").os.windows.WINAPI) i32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "dxva2" fn CapabilitiesRequestAndCapabilitiesReply(
    h_monitor: ?HANDLE,
    psz_a_s_c_i_i_capabilities_string: [*:0]u8,
    dw_capabilities_string_length_in_characters: u32,
) callconv(@import("std").os.windows.WINAPI) i32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "dxva2" fn GetTimingReport(
    h_monitor: ?HANDLE,
    pmtr_monitor_timing_report: ?*MC_TIMING_REPORT,
) callconv(@import("std").os.windows.WINAPI) i32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "dxva2" fn GetMonitorCapabilities(
    h_monitor: ?HANDLE,
    pdw_monitor_capabilities: ?*u32,
    pdw_supported_color_temperatures: ?*u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "dxva2" fn GetMonitorTechnologyType(
    h_monitor: ?HANDLE,
    pdty_display_technology_type: ?*MC_DISPLAY_TECHNOLOGY_TYPE,
) callconv(@import("std").os.windows.WINAPI) i32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "dxva2" fn GetMonitorBrightness(
    h_monitor: ?HANDLE,
    pdw_minimum_brightness: ?*u32,
    pdw_current_brightness: ?*u32,
    pdw_maximum_brightness: ?*u32,
) callconv(@import("std").os.windows.WINAPI) i32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "dxva2" fn GetMonitorContrast(
    h_monitor: ?HANDLE,
    pdw_minimum_contrast: ?*u32,
    pdw_current_contrast: ?*u32,
    pdw_maximum_contrast: ?*u32,
) callconv(@import("std").os.windows.WINAPI) i32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "dxva2" fn GetMonitorColorTemperature(
    h_monitor: ?HANDLE,
    pct_current_color_temperature: ?*MC_COLOR_TEMPERATURE,
) callconv(@import("std").os.windows.WINAPI) i32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "dxva2" fn GetMonitorRedGreenOrBlueDrive(
    h_monitor: ?HANDLE,
    dt_drive_type: MC_DRIVE_TYPE,
    pdw_minimum_drive: ?*u32,
    pdw_current_drive: ?*u32,
    pdw_maximum_drive: ?*u32,
) callconv(@import("std").os.windows.WINAPI) i32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "dxva2" fn GetMonitorRedGreenOrBlueGain(
    h_monitor: ?HANDLE,
    gt_gain_type: MC_GAIN_TYPE,
    pdw_minimum_gain: ?*u32,
    pdw_current_gain: ?*u32,
    pdw_maximum_gain: ?*u32,
) callconv(@import("std").os.windows.WINAPI) i32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "dxva2" fn SetMonitorBrightness(
    h_monitor: ?HANDLE,
    dw_new_brightness: u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "dxva2" fn SetMonitorColorTemperature(
    h_monitor: ?HANDLE,
    ct_current_color_temperature: MC_COLOR_TEMPERATURE,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "dxva2" fn GetMonitorDisplayAreaSize(
    h_monitor: ?HANDLE,
    st_size_type: MC_SIZE_TYPE,
    pdw_minimum_width_or_height: ?*u32,
    pdw_current_width_or_height: ?*u32,
    pdw_maximum_width_or_height: ?*u32,
) callconv(@import("std").os.windows.WINAPI) i32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "dxva2" fn GetMonitorDisplayAreaPosition(
    h_monitor: ?HANDLE,
    pt_position_type: MC_POSITION_TYPE,
    pdw_minimum_position: ?*u32,
    pdw_current_position: ?*u32,
    pdw_maximum_position: ?*u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "dxva2" fn SetMonitorDisplayAreaSize(
    h_monitor: ?HANDLE,
    st_size_type: MC_SIZE_TYPE,
    dw_new_display_area_width_or_height: u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "gdi32" fn EngMultiByteToUnicodeN(
    ...
    max_bytes_in_unicode_string: u32,
...
pub extern "gdi32" fn EngUnicodeToMultiByteN(
    // TODO: what to do with BytesParamIndex 1?
    multi_byte_string: ?[*]u8,
    max_bytes_in_multi_byte_string: u32,
    bytes_in_multi_byte_string: ?*u32,
    // TODO: what to do with BytesParamIndex 4?
    unicode_string: ?PWSTR,
    bytes_in_unicode_string: u32,
...
pub extern "gdi32" fn EngMultiByteToWideChar(
    code_page: u32,
    // TODO: what to do with BytesParamIndex 2?
    wide_char_string: ?PWSTR,
    bytes_in_wide_char_string: i32,
    // TODO: what to do with BytesParamIndex 4?
    multi_byte_string: ?PSTR,
    bytes_in_multi_byte_string: i32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "user32" fn SetDisplayConfig(
    num_path_array_elements: u32,
    path_array: ?[*]DISPLAYCONFIG_PATH_INFO,
    num_mode_info_array_elements: u32,
    mode_info_array: ?[*]DISPLAYCONFIG_MODE_INFO,
    flags: u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "user32" fn QueryDisplayConfig(
    ...
    num_mode_info_array_elements: ?*u32,
    mode_info_array: [*]DISPLAYCONFIG_MODE_INFO,
    current_topology_id: ?*DISPLAYCONFIG_TOPOLOGY_ID,
) callconv(@import("std").os.windows.WINAPI) i32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "user32" fn DisplayConfigGetDeviceInfo(
    request_packet: ?*DISPLAYCONFIG_DEVICE_INFO_HEADER,
) callconv(@import("std").os.windows.WINAPI) i32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "user32" fn DisplayConfigSetDeviceInfo(
    set_packet: ?*DISPLAYCONFIG_DEVICE_INFO_HEADER,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "user32" fn GetDisplayAutoRotationPreferences(
    p_orientation: ?*ORIENTATION_PREFERENCE,
) callconv(@import("std").os.windows.WINAPI) BOOL;
