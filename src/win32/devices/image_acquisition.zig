...
pub const IWiaDevMgr = extern struct {
    pub const VTable = extern struct {
        ...
        EnumDeviceInfo: *const fn (
            ...
            l_flag: i32,
            pp_i_enum: ?*?*IEnumWIA_DEV_INFO,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        CreateDevice: *const fn (
            self: *const IWiaDevMgr,
            bstr_device_i_d: ?BSTR,
            pp_wia_item_root: ?*?*IWiaItem,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        SelectDeviceDlg: *const fn (
            ...
            l_device_type: i32,
            l_flags: i32,
            pbstr_device_i_d: ?*?BSTR,
            pp_item_root: ?*?*IWiaItem,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        RegisterEventCallbackProgram: *const fn (
            ...
            l_flags: i32,
            bstr_device_i_d: ?BSTR,
            p_event_g_u_i_d: ?*const Guid,
            bstr_commandline: ?BSTR,
            bstr_name: ?BSTR,
        ...
        RegisterEventCallbackInterface: *const fn (
            ...
            bstr_device_i_d: ?BSTR,
            p_event_g_u_i_d: ?*const Guid,
            p_i_wia_event_callback: ?*IWiaEventCallback,
            p_event_object: ?*?*IUnknown,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn enumDeviceInfo(self: *const T, l_flag_: i32, pp_i_enum_: ?*?*IEnumWIA_DEV_INFO) HRESULT {
                return @as(*const IWiaDevMgr.VTable, @ptrCast(self.vtable)).EnumDeviceInfo(@as(*const IWiaDevMgr, @ptrCast(self)), l_flag_, pp_i_enum_);
            }
            pub inline fn createDevice(self: *const T, bstr_device_i_d_: ?BSTR, pp_wia_item_root_: ?*?*IWiaItem) HRESULT {
                return @as(*const IWiaDevMgr.VTable, @ptrCast(self.vtable)).CreateDevice(@as(*const IWiaDevMgr, @ptrCast(self)), bstr_device_i_d_, pp_wia_item_root_);
            }
            pub inline fn selectDeviceDlg(self: *const T, hwnd_parent_: ?HWND, l_device_type_: i32, l_flags_: i32, pbstr_device_i_d_: ?*?BSTR, pp_item_root_: ?*?*IWiaItem) HRESULT {
                return @as(*const IWiaDevMgr.VTable, @ptrCast(self.vtable)).SelectDeviceDlg(@as(*const IWiaDevMgr, @ptrCast(self)), hwnd_parent_, l_device_type_, l_flags_, pbstr_device_i_d_, pp_item_root_);
            }
            pub inline fn selectDeviceDlgID(self: *const T, hwnd_parent_: ?HWND, l_device_type_: i32, l_flags_: i32, pbstr_device_i_d_: ?*?BSTR) HRESULT {
                return @as(*const IWiaDevMgr.VTable, @ptrCast(self.vtable)).SelectDeviceDlgID(@as(*const IWiaDevMgr, @ptrCast(self)), hwnd_parent_, l_device_type_, l_flags_, pbstr_device_i_d_);
            }
            pub inline fn getImageDlg(self: *const T, hwnd_parent_: ?HWND, l_device_type_: i32, l_flags_: i32, l_intent_: i32, p_item_root_: ?*IWiaItem, bstr_filename_: ?BSTR, pguid_format_: ?*Guid) HRESULT {
                return @as(*const IWiaDevMgr.VTable, @ptrCast(self.vtable)).GetImageDlg(@as(*const IWiaDevMgr, @ptrCast(self)), hwnd_parent_, l_device_type_, l_flags_, l_intent_, p_item_root_, bstr_filename_, pguid_format_);
            }
            pub inline fn registerEventCallbackProgram(self: *const T, l_flags_: i32, bstr_device_i_d_: ?BSTR, p_event_g_u_i_d_: ?*const Guid, bstr_commandline_: ?BSTR, bstr_name_: ?BSTR, bstr_description_: ?BSTR, bstr_icon_: ?BSTR) HRESULT {
                return @as(*const IWiaDevMgr.VTable, @ptrCast(self.vtable)).RegisterEventCallbackProgram(@as(*const IWiaDevMgr, @ptrCast(self)), l_flags_, bstr_device_i_d_, p_event_g_u_i_d_, bstr_commandline_, bstr_name_, bstr_description_, bstr_icon_);
            }
            pub inline fn registerEventCallbackInterface(self: *const T, l_flags_: i32, bstr_device_i_d_: ?BSTR, p_event_g_u_i_d_: ?*const Guid, p_i_wia_event_callback_: ?*IWiaEventCallback, p_event_object_: ?*?*IUnknown) HRESULT {
                return @as(*const IWiaDevMgr.VTable, @ptrCast(self.vtable)).RegisterEventCallbackInterface(@as(*const IWiaDevMgr, @ptrCast(self)), l_flags_, bstr_device_i_d_, p_event_g_u_i_d_, p_i_wia_event_callback_, p_event_object_);
            }
            pub inline fn registerEventCallbackCLSID(self: *const T, l_flags_: i32, bstr_device_i_d_: ?BSTR, p_event_g_u_i_d_: ?*const Guid, p_cls_i_d_: ?*const Guid, bstr_name_: ?BSTR, bstr_description_: ?BSTR, bstr_icon_: ?BSTR) HRESULT {
                return @as(*const IWiaDevMgr.VTable, @ptrCast(self.vtable)).RegisterEventCallbackCLSID(@as(*const IWiaDevMgr, @ptrCast(self)), l_flags_, bstr_device_i_d_, p_event_g_u_i_d_, p_cls_i_d_, bstr_name_, bstr_description_, bstr_icon_);
            }
            pub inline fn addDeviceDlg(self: *const T, hwnd_parent_: ?HWND, l_flags_: i32) HRESULT {
                return @as(*const IWiaDevMgr.VTable, @ptrCast(self.vtable)).AddDeviceDlg(@as(*const IWiaDevMgr, @ptrCast(self)), hwnd_parent_, l_flags_);
            }
        };
    }
...
pub const IEnumWIA_DEV_INFO = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn next(self: *const T, celt_: u32, rgelt_: ?*?*IWiaPropertyStorage, pcelt_fetched_: ?*u32) HRESULT {
                return @as(*const IEnumWIA_DEV_INFO.VTable, @ptrCast(self.vtable)).Next(@as(*const IEnumWIA_DEV_INFO, @ptrCast(self)), celt_, rgelt_, pcelt_fetched_);
            }
            pub inline fn skip(self: *const T, celt_: u32) HRESULT {
                return @as(*const IEnumWIA_DEV_INFO.VTable, @ptrCast(self.vtable)).Skip(@as(*const IEnumWIA_DEV_INFO, @ptrCast(self)), celt_);
            }
            pub inline fn reset(self: *const T) HRESULT {
                return @as(*const IEnumWIA_DEV_INFO.VTable, @ptrCast(self.vtable)).Reset(@as(*const IEnumWIA_DEV_INFO, @ptrCast(self)));
            }
            pub inline fn clone(self: *const T, pp_i_enum_: ?*?*IEnumWIA_DEV_INFO) HRESULT {
                return @as(*const IEnumWIA_DEV_INFO.VTable, @ptrCast(self.vtable)).Clone(@as(*const IEnumWIA_DEV_INFO, @ptrCast(self)), pp_i_enum_);
            }
            pub inline fn getCount(self: *const T, celt_: ?*u32) HRESULT {
                return @as(*const IEnumWIA_DEV_INFO.VTable, @ptrCast(self.vtable)).GetCount(@as(*const IEnumWIA_DEV_INFO, @ptrCast(self)), celt_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWiaEventCallback = extern struct {
    pub const VTable = extern struct {
        ...
        ImageEventCallback: *const fn (
            ...
            p_event_g_u_i_d: ?*const Guid,
            bstr_event_description: ?BSTR,
            bstr_device_i_d: ?BSTR,
            bstr_device_description: ?BSTR,
            dw_device_type: u32,
            bstr_full_item_name: ?BSTR,
            pul_event_type: ?*u32,
            ul_reserved: u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn imageEventCallback(self: *const T, p_event_g_u_i_d_: ?*const Guid, bstr_event_description_: ?BSTR, bstr_device_i_d_: ?BSTR, bstr_device_description_: ?BSTR, dw_device_type_: u32, bstr_full_item_name_: ?BSTR, pul_event_type_: ?*u32, ul_reserved_: u32) HRESULT {
                return @as(*const IWiaEventCallback.VTable, @ptrCast(self.vtable)).ImageEventCallback(@as(*const IWiaEventCallback, @ptrCast(self)), p_event_g_u_i_d_, bstr_event_description_, bstr_device_i_d_, bstr_device_description_, dw_device_type_, bstr_full_item_name_, pul_event_type_, ul_reserved_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWiaDataCallback = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn bandedDataCallback(self: *const T, l_message_: i32, l_status_: i32, l_percent_complete_: i32, l_offset_: i32, l_length_: i32, l_reserved_: i32, l_res_length_: i32, pb_buffer_: ?*u8) HRESULT {
                return @as(*const IWiaDataCallback.VTable, @ptrCast(self.vtable)).BandedDataCallback(@as(*const IWiaDataCallback, @ptrCast(self)), l_message_, l_status_, l_percent_complete_, l_offset_, l_length_, l_reserved_, l_res_length_, pb_buffer_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWiaDataTransfer = extern struct {
    pub const VTable = extern struct {
        ...
        idtGetData: *const fn (
            ...
            p_medium: ?*STGMEDIUM,
            p_i_wia_data_callback: ?*IWiaDataCallback,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        idtGetBandedData: *const fn (
            self: *const IWiaDataTransfer,
            p_wia_data_trans_info: ?*WIA_DATA_TRANSFER_INFO,
            p_i_wia_data_callback: ?*IWiaDataCallback,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        idtEnumWIA_FORMAT_INFO: *const fn (
            self: *const IWiaDataTransfer,
            pp_enum: ?*?*IEnumWIA_FORMAT_INFO,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        idtGetExtendedTransferInfo: *const fn (
            self: *const IWiaDataTransfer,
            p_extended_transfer_info: ?*WIA_EXTENDED_TRANSFER_INFO,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn idtGetData(self: *const T, p_medium_: ?*STGMEDIUM, p_i_wia_data_callback_: ?*IWiaDataCallback) HRESULT {
                return @as(*const IWiaDataTransfer.VTable, @ptrCast(self.vtable)).idtGetData(@as(*const IWiaDataTransfer, @ptrCast(self)), p_medium_, p_i_wia_data_callback_);
            }
            pub inline fn idtGetBandedData(self: *const T, p_wia_data_trans_info_: ?*WIA_DATA_TRANSFER_INFO, p_i_wia_data_callback_: ?*IWiaDataCallback) HRESULT {
                return @as(*const IWiaDataTransfer.VTable, @ptrCast(self.vtable)).idtGetBandedData(@as(*const IWiaDataTransfer, @ptrCast(self)), p_wia_data_trans_info_, p_i_wia_data_callback_);
            }
            pub inline fn idtQueryGetData(self: *const T, pfe_: ?*WIA_FORMAT_INFO) HRESULT {
                return @as(*const IWiaDataTransfer.VTable, @ptrCast(self.vtable)).idtQueryGetData(@as(*const IWiaDataTransfer, @ptrCast(self)), pfe_);
            }
            pub inline fn idtEnumWIAFORMATINFO(self: *const T, pp_enum_: ?*?*IEnumWIA_FORMAT_INFO) HRESULT {
                return @as(*const IWiaDataTransfer.VTable, @ptrCast(self.vtable)).idtEnumWIA_FORMAT_INFO(@as(*const IWiaDataTransfer, @ptrCast(self)), pp_enum_);
            }
            pub inline fn idtGetExtendedTransferInfo(self: *const T, p_extended_transfer_info_: ?*WIA_EXTENDED_TRANSFER_INFO) HRESULT {
                return @as(*const IWiaDataTransfer.VTable, @ptrCast(self.vtable)).idtGetExtendedTransferInfo(@as(*const IWiaDataTransfer, @ptrCast(self)), p_extended_transfer_info_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWiaItem = extern struct {
    pub const VTable = extern struct {
        ...
        EnumChildItems: *const fn (
            self: *const IWiaItem,
            pp_i_enum_wia_item: ?*?*IEnumWiaItem,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        DeleteItem: *const fn (
            self: *const IWiaItem,
            l_flags: i32,
        ...
        CreateChildItem: *const fn (
            ...
            bstr_item_name: ?BSTR,
            bstr_full_item_name: ?BSTR,
            pp_i_wia_item: ?*?*IWiaItem,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        EnumRegisterEventInfo: *const fn (
            self: *const IWiaItem,
            l_flags: i32,
            p_event_g_u_i_d: ?*const Guid,
            pp_i_enum: ?*?*IEnumWIA_DEV_CAPS,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        DeviceCommand: *const fn (
            self: *const IWiaItem,
            l_flags: i32,
            p_cmd_g_u_i_d: ?*const Guid,
            p_i_wia_item: ?*?*IWiaItem,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        EnumDeviceCapabilities: *const fn (
            self: *const IWiaItem,
            l_flags: i32,
            pp_i_enum_w_i_a__d_e_v__c_a_p_s: ?*?*IEnumWIA_DEV_CAPS,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getItemType(self: *const T, p_item_type_: ?*i32) HRESULT {
                return @as(*const IWiaItem.VTable, @ptrCast(self.vtable)).GetItemType(@as(*const IWiaItem, @ptrCast(self)), p_item_type_);
            }
            pub inline fn analyzeItem(self: *const T, l_flags_: i32) HRESULT {
                return @as(*const IWiaItem.VTable, @ptrCast(self.vtable)).AnalyzeItem(@as(*const IWiaItem, @ptrCast(self)), l_flags_);
            }
            pub inline fn enumChildItems(self: *const T, pp_i_enum_wia_item_: ?*?*IEnumWiaItem) HRESULT {
                return @as(*const IWiaItem.VTable, @ptrCast(self.vtable)).EnumChildItems(@as(*const IWiaItem, @ptrCast(self)), pp_i_enum_wia_item_);
            }
            pub inline fn deleteItem(self: *const T, l_flags_: i32) HRESULT {
                return @as(*const IWiaItem.VTable, @ptrCast(self.vtable)).DeleteItem(@as(*const IWiaItem, @ptrCast(self)), l_flags_);
            }
            pub inline fn createChildItem(self: *const T, l_flags_: i32, bstr_item_name_: ?BSTR, bstr_full_item_name_: ?BSTR, pp_i_wia_item_: ?*?*IWiaItem) HRESULT {
                return @as(*const IWiaItem.VTable, @ptrCast(self.vtable)).CreateChildItem(@as(*const IWiaItem, @ptrCast(self)), l_flags_, bstr_item_name_, bstr_full_item_name_, pp_i_wia_item_);
            }
            pub inline fn enumRegisterEventInfo(self: *const T, l_flags_: i32, p_event_g_u_i_d_: ?*const Guid, pp_i_enum_: ?*?*IEnumWIA_DEV_CAPS) HRESULT {
                return @as(*const IWiaItem.VTable, @ptrCast(self.vtable)).EnumRegisterEventInfo(@as(*const IWiaItem, @ptrCast(self)), l_flags_, p_event_g_u_i_d_, pp_i_enum_);
            }
            pub inline fn findItemByName(self: *const T, l_flags_: i32, bstr_full_item_name_: ?BSTR, pp_i_wia_item_: ?*?*IWiaItem) HRESULT {
                return @as(*const IWiaItem.VTable, @ptrCast(self.vtable)).FindItemByName(@as(*const IWiaItem, @ptrCast(self)), l_flags_, bstr_full_item_name_, pp_i_wia_item_);
            }
            pub inline fn deviceDlg(self: *const T, hwnd_parent_: ?HWND, l_flags_: i32, l_intent_: i32, pl_item_count_: ?*i32, pp_i_wia_item_: ?*?*?*IWiaItem) HRESULT {
                return @as(*const IWiaItem.VTable, @ptrCast(self.vtable)).DeviceDlg(@as(*const IWiaItem, @ptrCast(self)), hwnd_parent_, l_flags_, l_intent_, pl_item_count_, pp_i_wia_item_);
            }
            pub inline fn deviceCommand(self: *const T, l_flags_: i32, p_cmd_g_u_i_d_: ?*const Guid, p_i_wia_item_: ?*?*IWiaItem) HRESULT {
                return @as(*const IWiaItem.VTable, @ptrCast(self.vtable)).DeviceCommand(@as(*const IWiaItem, @ptrCast(self)), l_flags_, p_cmd_g_u_i_d_, p_i_wia_item_);
            }
            pub inline fn getRootItem(self: *const T, pp_i_wia_item_: ?*?*IWiaItem) HRESULT {
                return @as(*const IWiaItem.VTable, @ptrCast(self.vtable)).GetRootItem(@as(*const IWiaItem, @ptrCast(self)), pp_i_wia_item_);
            }
            pub inline fn enumDeviceCapabilities(self: *const T, l_flags_: i32, pp_i_enum_w_i_a__d_e_v__c_a_p_s_: ?*?*IEnumWIA_DEV_CAPS) HRESULT {
                return @as(*const IWiaItem.VTable, @ptrCast(self.vtable)).EnumDeviceCapabilities(@as(*const IWiaItem, @ptrCast(self)), l_flags_, pp_i_enum_w_i_a__d_e_v__c_a_p_s_);
            }
            pub inline fn dumpItemData(self: *const T, bstr_data_: ?*?BSTR) HRESULT {
                return @as(*const IWiaItem.VTable, @ptrCast(self.vtable)).DumpItemData(@as(*const IWiaItem, @ptrCast(self)), bstr_data_);
            }
            pub inline fn dumpDrvItemData(self: *const T, bstr_data_: ?*?BSTR) HRESULT {
                return @as(*const IWiaItem.VTable, @ptrCast(self.vtable)).DumpDrvItemData(@as(*const IWiaItem, @ptrCast(self)), bstr_data_);
            }
            pub inline fn dumpTreeItemData(self: *const T, bstr_data_: ?*?BSTR) HRESULT {
                return @as(*const IWiaItem.VTable, @ptrCast(self.vtable)).DumpTreeItemData(@as(*const IWiaItem, @ptrCast(self)), bstr_data_);
            }
            pub inline fn diagnostic(self: *const T, ul_size_: u32, p_buffer_: [*:0]u8) HRESULT {
                return @as(*const IWiaItem.VTable, @ptrCast(self.vtable)).Diagnostic(@as(*const IWiaItem, @ptrCast(self)), ul_size_, p_buffer_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn readMultiple(self: *const T, cpspec_: u32, rgpspec_: [*]const PROPSPEC, rgpropvar_: [*]PROPVARIANT) HRESULT {
                return @as(*const IWiaPropertyStorage.VTable, @ptrCast(self.vtable)).ReadMultiple(@as(*const IWiaPropertyStorage, @ptrCast(self)), cpspec_, rgpspec_, rgpropvar_);
            }
            pub inline fn writeMultiple(self: *const T, cpspec_: u32, rgpspec_: ?*const PROPSPEC, rgpropvar_: ?*const PROPVARIANT, propid_name_first_: u32) HRESULT {
                return @as(*const IWiaPropertyStorage.VTable, @ptrCast(self.vtable)).WriteMultiple(@as(*const IWiaPropertyStorage, @ptrCast(self)), cpspec_, rgpspec_, rgpropvar_, propid_name_first_);
            }
            pub inline fn deleteMultiple(self: *const T, cpspec_: u32, rgpspec_: [*]const PROPSPEC) HRESULT {
                return @as(*const IWiaPropertyStorage.VTable, @ptrCast(self.vtable)).DeleteMultiple(@as(*const IWiaPropertyStorage, @ptrCast(self)), cpspec_, rgpspec_);
            }
            pub inline fn readPropertyNames(self: *const T, cpropid_: u32, rgpropid_: [*]const u32, rglpwstr_name_: [*]?PWSTR) HRESULT {
                return @as(*const IWiaPropertyStorage.VTable, @ptrCast(self.vtable)).ReadPropertyNames(@as(*const IWiaPropertyStorage, @ptrCast(self)), cpropid_, rgpropid_, rglpwstr_name_);
            }
            pub inline fn writePropertyNames(self: *const T, cpropid_: u32, rgpropid_: [*]const u32, rglpwstr_name_: [*]const ?[*:0]const u16) HRESULT {
                return @as(*const IWiaPropertyStorage.VTable, @ptrCast(self.vtable)).WritePropertyNames(@as(*const IWiaPropertyStorage, @ptrCast(self)), cpropid_, rgpropid_, rglpwstr_name_);
            }
            pub inline fn deletePropertyNames(self: *const T, cpropid_: u32, rgpropid_: [*]const u32) HRESULT {
                return @as(*const IWiaPropertyStorage.VTable, @ptrCast(self.vtable)).DeletePropertyNames(@as(*const IWiaPropertyStorage, @ptrCast(self)), cpropid_, rgpropid_);
            }
            pub inline fn commit(self: *const T, grf_commit_flags_: u32) HRESULT {
                return @as(*const IWiaPropertyStorage.VTable, @ptrCast(self.vtable)).Commit(@as(*const IWiaPropertyStorage, @ptrCast(self)), grf_commit_flags_);
            }
            ...
            pub inline fn @"enum"(self: *const T, ppenum_: ?*?*IEnumSTATPROPSTG) HRESULT {
                return @as(*const IWiaPropertyStorage.VTable, @ptrCast(self.vtable)).Enum(@as(*const IWiaPropertyStorage, @ptrCast(self)), ppenum_);
            }
            pub inline fn setTimes(self: *const T, pctime_: ?*const FILETIME, patime_: ?*const FILETIME, pmtime_: ?*const FILETIME) HRESULT {
                return @as(*const IWiaPropertyStorage.VTable, @ptrCast(self.vtable)).SetTimes(@as(*const IWiaPropertyStorage, @ptrCast(self)), pctime_, patime_, pmtime_);
            }
            pub inline fn setClass(self: *const T, clsid_: ?*const Guid) HRESULT {
                return @as(*const IWiaPropertyStorage.VTable, @ptrCast(self.vtable)).SetClass(@as(*const IWiaPropertyStorage, @ptrCast(self)), clsid_);
            }
            pub inline fn stat(self: *const T, pstatpsstg_: ?*STATPROPSETSTG) HRESULT {
                return @as(*const IWiaPropertyStorage.VTable, @ptrCast(self.vtable)).Stat(@as(*const IWiaPropertyStorage, @ptrCast(self)), pstatpsstg_);
            }
            pub inline fn getPropertyAttributes(self: *const T, cpspec_: u32, rgpspec_: [*]PROPSPEC, rgflags_: [*]u32, rgpropvar_: [*]PROPVARIANT) HRESULT {
                return @as(*const IWiaPropertyStorage.VTable, @ptrCast(self.vtable)).GetPropertyAttributes(@as(*const IWiaPropertyStorage, @ptrCast(self)), cpspec_, rgpspec_, rgflags_, rgpropvar_);
            }
            pub inline fn getCount(self: *const T, pul_num_props_: ?*u32) HRESULT {
                return @as(*const IWiaPropertyStorage.VTable, @ptrCast(self.vtable)).GetCount(@as(*const IWiaPropertyStorage, @ptrCast(self)), pul_num_props_);
            }
            pub inline fn getPropertyStream(self: *const T, p_compatibility_id_: ?*Guid, pp_i_stream_: ?*?*IStream) HRESULT {
                return @as(*const IWiaPropertyStorage.VTable, @ptrCast(self.vtable)).GetPropertyStream(@as(*const IWiaPropertyStorage, @ptrCast(self)), p_compatibility_id_, pp_i_stream_);
            }
            pub inline fn setPropertyStream(self: *const T, p_compatibility_id_: ?*Guid, p_i_stream_: ?*IStream) HRESULT {
                return @as(*const IWiaPropertyStorage.VTable, @ptrCast(self.vtable)).SetPropertyStream(@as(*const IWiaPropertyStorage, @ptrCast(self)), p_compatibility_id_, p_i_stream_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IEnumWiaItem = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn next(self: *const T, celt_: u32, pp_i_wia_item_: ?*?*IWiaItem, pcelt_fetched_: ?*u32) HRESULT {
                return @as(*const IEnumWiaItem.VTable, @ptrCast(self.vtable)).Next(@as(*const IEnumWiaItem, @ptrCast(self)), celt_, pp_i_wia_item_, pcelt_fetched_);
            }
            pub inline fn skip(self: *const T, celt_: u32) HRESULT {
                return @as(*const IEnumWiaItem.VTable, @ptrCast(self.vtable)).Skip(@as(*const IEnumWiaItem, @ptrCast(self)), celt_);
            }
            pub inline fn reset(self: *const T) HRESULT {
                return @as(*const IEnumWiaItem.VTable, @ptrCast(self.vtable)).Reset(@as(*const IEnumWiaItem, @ptrCast(self)));
            }
            pub inline fn clone(self: *const T, pp_i_enum_: ?*?*IEnumWiaItem) HRESULT {
                return @as(*const IEnumWiaItem.VTable, @ptrCast(self.vtable)).Clone(@as(*const IEnumWiaItem, @ptrCast(self)), pp_i_enum_);
            }
            pub inline fn getCount(self: *const T, celt_: ?*u32) HRESULT {
                return @as(*const IEnumWiaItem.VTable, @ptrCast(self.vtable)).GetCount(@as(*const IEnumWiaItem, @ptrCast(self)), celt_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IEnumWIA_DEV_CAPS = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn next(self: *const T, celt_: u32, rgelt_: ?*WIA_DEV_CAP, pcelt_fetched_: ?*u32) HRESULT {
                return @as(*const IEnumWIA_DEV_CAPS.VTable, @ptrCast(self.vtable)).Next(@as(*const IEnumWIA_DEV_CAPS, @ptrCast(self)), celt_, rgelt_, pcelt_fetched_);
            }
            pub inline fn skip(self: *const T, celt_: u32) HRESULT {
                return @as(*const IEnumWIA_DEV_CAPS.VTable, @ptrCast(self.vtable)).Skip(@as(*const IEnumWIA_DEV_CAPS, @ptrCast(self)), celt_);
            }
            pub inline fn reset(self: *const T) HRESULT {
                return @as(*const IEnumWIA_DEV_CAPS.VTable, @ptrCast(self.vtable)).Reset(@as(*const IEnumWIA_DEV_CAPS, @ptrCast(self)));
            }
            pub inline fn clone(self: *const T, pp_i_enum_: ?*?*IEnumWIA_DEV_CAPS) HRESULT {
                return @as(*const IEnumWIA_DEV_CAPS.VTable, @ptrCast(self.vtable)).Clone(@as(*const IEnumWIA_DEV_CAPS, @ptrCast(self)), pp_i_enum_);
            }
            pub inline fn getCount(self: *const T, pcelt_: ?*u32) HRESULT {
                return @as(*const IEnumWIA_DEV_CAPS.VTable, @ptrCast(self.vtable)).GetCount(@as(*const IEnumWIA_DEV_CAPS, @ptrCast(self)), pcelt_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IEnumWIA_FORMAT_INFO = extern struct {
    pub const VTable = extern struct {
        ...
        Clone: *const fn (
            self: *const IEnumWIA_FORMAT_INFO,
            pp_i_enum: ?*?*IEnumWIA_FORMAT_INFO,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetCount: *const fn (
            self: *const IEnumWIA_FORMAT_INFO,
            pcelt: ?*u32,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn next(self: *const T, celt_: u32, rgelt_: ?*WIA_FORMAT_INFO, pcelt_fetched_: ?*u32) HRESULT {
                return @as(*const IEnumWIA_FORMAT_INFO.VTable, @ptrCast(self.vtable)).Next(@as(*const IEnumWIA_FORMAT_INFO, @ptrCast(self)), celt_, rgelt_, pcelt_fetched_);
            }
            pub inline fn skip(self: *const T, celt_: u32) HRESULT {
                return @as(*const IEnumWIA_FORMAT_INFO.VTable, @ptrCast(self.vtable)).Skip(@as(*const IEnumWIA_FORMAT_INFO, @ptrCast(self)), celt_);
            }
            pub inline fn reset(self: *const T) HRESULT {
                return @as(*const IEnumWIA_FORMAT_INFO.VTable, @ptrCast(self.vtable)).Reset(@as(*const IEnumWIA_FORMAT_INFO, @ptrCast(self)));
            }
            pub inline fn clone(self: *const T, pp_i_enum_: ?*?*IEnumWIA_FORMAT_INFO) HRESULT {
                return @as(*const IEnumWIA_FORMAT_INFO.VTable, @ptrCast(self.vtable)).Clone(@as(*const IEnumWIA_FORMAT_INFO, @ptrCast(self)), pp_i_enum_);
            }
            pub inline fn getCount(self: *const T, pcelt_: ?*u32) HRESULT {
                return @as(*const IEnumWIA_FORMAT_INFO.VTable, @ptrCast(self.vtable)).GetCount(@as(*const IEnumWIA_FORMAT_INFO, @ptrCast(self)), pcelt_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWiaLog = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn initializeLog(self: *const T, h_instance_: i32) HRESULT {
                return @as(*const IWiaLog.VTable, @ptrCast(self.vtable)).InitializeLog(@as(*const IWiaLog, @ptrCast(self)), h_instance_);
            }
            pub inline fn hResult(self: *const T, h_result_: HRESULT) HRESULT {
                return @as(*const IWiaLog.VTable, @ptrCast(self.vtable)).hResult(@as(*const IWiaLog, @ptrCast(self)), h_result_);
            }
            pub inline fn log(self: *const T, l_flags_: i32, l_res_i_d_: i32, l_detail_: i32, bstr_text_: ?BSTR) HRESULT {
                return @as(*const IWiaLog.VTable, @ptrCast(self.vtable)).Log(@as(*const IWiaLog, @ptrCast(self)), l_flags_, l_res_i_d_, l_detail_, bstr_text_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWiaLogEx = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn initializeLogEx(self: *const T, h_instance_: ?*u8) HRESULT {
                return @as(*const IWiaLogEx.VTable, @ptrCast(self.vtable)).InitializeLogEx(@as(*const IWiaLogEx, @ptrCast(self)), h_instance_);
            }
            pub inline fn hResult(self: *const T, h_result_: HRESULT) HRESULT {
                return @as(*const IWiaLogEx.VTable, @ptrCast(self.vtable)).hResult(@as(*const IWiaLogEx, @ptrCast(self)), h_result_);
            }
            pub inline fn log(self: *const T, l_flags_: i32, l_res_i_d_: i32, l_detail_: i32, bstr_text_: ?BSTR) HRESULT {
                return @as(*const IWiaLogEx.VTable, @ptrCast(self.vtable)).Log(@as(*const IWiaLogEx, @ptrCast(self)), l_flags_, l_res_i_d_, l_detail_, bstr_text_);
            }
            pub inline fn hResultEx(self: *const T, l_method_id_: i32, h_result_: HRESULT) HRESULT {
                return @as(*const IWiaLogEx.VTable, @ptrCast(self.vtable)).hResultEx(@as(*const IWiaLogEx, @ptrCast(self)), l_method_id_, h_result_);
            }
            pub inline fn logEx(self: *const T, l_method_id_: i32, l_flags_: i32, l_res_i_d_: i32, l_detail_: i32, bstr_text_: ?BSTR) HRESULT {
                return @as(*const IWiaLogEx.VTable, @ptrCast(self.vtable)).LogEx(@as(*const IWiaLogEx, @ptrCast(self)), l_method_id_, l_flags_, l_res_i_d_, l_detail_, bstr_text_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWiaNotifyDevMgr = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn newDeviceArrival(self: *const T) HRESULT {
...
pub const IWiaItemExtras = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getExtendedErrorInfo(self: *const T, bstr_error_text_: ?*?BSTR) HRESULT {
                return @as(*const IWiaItemExtras.VTable, @ptrCast(self.vtable)).GetExtendedErrorInfo(@as(*const IWiaItemExtras, @ptrCast(self)), bstr_error_text_);
            }
            pub inline fn escape(self: *const T, dw_escape_code_: u32, lp_in_data_: [*:0]u8, cb_in_data_size_: u32, p_out_data_: ?*u8, dw_out_data_size_: u32, pdw_actual_data_size_: ?*u32) HRESULT {
                return @as(*const IWiaItemExtras.VTable, @ptrCast(self.vtable)).Escape(@as(*const IWiaItemExtras, @ptrCast(self)), dw_escape_code_, lp_in_data_, cb_in_data_size_, p_out_data_, dw_out_data_size_, pdw_actual_data_size_);
            }
            pub inline fn cancelPendingIO(self: *const T) HRESULT {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getWindow(self: *const T, phwnd_: ?*?HWND) HRESULT {
                return @as(*const IWiaAppErrorHandler.VTable, @ptrCast(self.vtable)).GetWindow(@as(*const IWiaAppErrorHandler, @ptrCast(self)), phwnd_);
            }
            pub inline fn reportStatus(self: *const T, l_flags_: i32, p_wia_item2_: ?*IWiaItem2, hr_status_: HRESULT, l_percent_complete_: i32) HRESULT {
                return @as(*const IWiaAppErrorHandler.VTable, @ptrCast(self.vtable)).ReportStatus(@as(*const IWiaAppErrorHandler, @ptrCast(self)), l_flags_, p_wia_item2_, hr_status_, l_percent_complete_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWiaErrorHandler = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn reportStatus(self: *const T, l_flags_: i32, hwnd_parent_: ?HWND, p_wia_item2_: ?*IWiaItem2, hr_status_: HRESULT, l_percent_complete_: i32) HRESULT {
                return @as(*const IWiaErrorHandler.VTable, @ptrCast(self.vtable)).ReportStatus(@as(*const IWiaErrorHandler, @ptrCast(self)), l_flags_, hwnd_parent_, p_wia_item2_, hr_status_, l_percent_complete_);
            }
            pub inline fn getStatusDescription(self: *const T, l_flags_: i32, p_wia_item2_: ?*IWiaItem2, hr_status_: HRESULT, pbstr_description_: ?*?BSTR) HRESULT {
                return @as(*const IWiaErrorHandler.VTable, @ptrCast(self.vtable)).GetStatusDescription(@as(*const IWiaErrorHandler, @ptrCast(self)), l_flags_, p_wia_item2_, hr_status_, pbstr_description_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWiaTransfer = extern struct {
    pub const VTable = extern struct {
        ...
        Download: *const fn (
            ...
            l_flags: i32,
            p_i_wia_transfer_callback: ?*IWiaTransferCallback,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Upload: *const fn (
            self: *const IWiaTransfer,
            l_flags: i32,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn download(self: *const T, l_flags_: i32, p_i_wia_transfer_callback_: ?*IWiaTransferCallback) HRESULT {
                return @as(*const IWiaTransfer.VTable, @ptrCast(self.vtable)).Download(@as(*const IWiaTransfer, @ptrCast(self)), l_flags_, p_i_wia_transfer_callback_);
            }
            pub inline fn upload(self: *const T, l_flags_: i32, p_source_: ?*IStream, p_i_wia_transfer_callback_: ?*IWiaTransferCallback) HRESULT {
                return @as(*const IWiaTransfer.VTable, @ptrCast(self.vtable)).Upload(@as(*const IWiaTransfer, @ptrCast(self)), l_flags_, p_source_, p_i_wia_transfer_callback_);
            }
            ...
            pub inline fn enumWIAFORMATINFO(self: *const T, pp_enum_: ?*?*IEnumWIA_FORMAT_INFO) HRESULT {
                return @as(*const IWiaTransfer.VTable, @ptrCast(self.vtable)).EnumWIA_FORMAT_INFO(@as(*const IWiaTransfer, @ptrCast(self)), pp_enum_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWiaTransferCallback = extern struct {
    pub const VTable = extern struct {
        ...
        TransferCallback: *const fn (
            ...
            l_flags: i32,
            p_wia_transfer_params: ?*WiaTransferParams,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn transferCallback(self: *const T, l_flags_: i32, p_wia_transfer_params_: ?*WiaTransferParams) HRESULT {
                return @as(*const IWiaTransferCallback.VTable, @ptrCast(self.vtable)).TransferCallback(@as(*const IWiaTransferCallback, @ptrCast(self)), l_flags_, p_wia_transfer_params_);
            }
            pub inline fn getNextStream(self: *const T, l_flags_: i32, bstr_item_name_: ?BSTR, bstr_full_item_name_: ?BSTR, pp_destination_: ?*?*IStream) HRESULT {
                return @as(*const IWiaTransferCallback.VTable, @ptrCast(self.vtable)).GetNextStream(@as(*const IWiaTransferCallback, @ptrCast(self)), l_flags_, bstr_item_name_, bstr_full_item_name_, pp_destination_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWiaSegmentationFilter = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn detectRegions(self: *const T, l_flags_: i32, p_input_stream_: ?*IStream, p_wia_item2_: ?*IWiaItem2) HRESULT {
                return @as(*const IWiaSegmentationFilter.VTable, @ptrCast(self.vtable)).DetectRegions(@as(*const IWiaSegmentationFilter, @ptrCast(self)), l_flags_, p_input_stream_, p_wia_item2_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWiaImageFilter = extern struct {
    pub const VTable = extern struct {
        ...
        InitializeFilter: *const fn (
            ...
            p_wia_item2: ?*IWiaItem2,
            p_wia_transfer_callback: ?*IWiaTransferCallback,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        FilterPreviewImage: *const fn (
            self: *const IWiaImageFilter,
            l_flags: i32,
            p_wia_child_item2: ?*IWiaItem2,
            input_image_extents: RECT,
            p_input_stream: ?*IStream,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ApplyProperties: *const fn (
            self: *const IWiaImageFilter,
            p_wia_property_storage: ?*IWiaPropertyStorage,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn initializeFilter(self: *const T, p_wia_item2_: ?*IWiaItem2, p_wia_transfer_callback_: ?*IWiaTransferCallback) HRESULT {
                return @as(*const IWiaImageFilter.VTable, @ptrCast(self.vtable)).InitializeFilter(@as(*const IWiaImageFilter, @ptrCast(self)), p_wia_item2_, p_wia_transfer_callback_);
            }
            pub inline fn setNewCallback(self: *const T, p_wia_transfer_callback_: ?*IWiaTransferCallback) HRESULT {
                return @as(*const IWiaImageFilter.VTable, @ptrCast(self.vtable)).SetNewCallback(@as(*const IWiaImageFilter, @ptrCast(self)), p_wia_transfer_callback_);
            }
            pub inline fn filterPreviewImage(self: *const T, l_flags_: i32, p_wia_child_item2_: ?*IWiaItem2, input_image_extents_: RECT, p_input_stream_: ?*IStream) HRESULT {
                return @as(*const IWiaImageFilter.VTable, @ptrCast(self.vtable)).FilterPreviewImage(@as(*const IWiaImageFilter, @ptrCast(self)), l_flags_, p_wia_child_item2_, input_image_extents_, p_input_stream_);
            }
            pub inline fn applyProperties(self: *const T, p_wia_property_storage_: ?*IWiaPropertyStorage) HRESULT {
                return @as(*const IWiaImageFilter.VTable, @ptrCast(self.vtable)).ApplyProperties(@as(*const IWiaImageFilter, @ptrCast(self)), p_wia_property_storage_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWiaPreview = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getNewPreview(self: *const T, l_flags_: i32, p_wia_item2_: ?*IWiaItem2, p_wia_transfer_callback_: ?*IWiaTransferCallback) HRESULT {
                return @as(*const IWiaPreview.VTable, @ptrCast(self.vtable)).GetNewPreview(@as(*const IWiaPreview, @ptrCast(self)), l_flags_, p_wia_item2_, p_wia_transfer_callback_);
            }
            pub inline fn updatePreview(self: *const T, l_flags_: i32, p_child_wia_item2_: ?*IWiaItem2, p_wia_transfer_callback_: ?*IWiaTransferCallback) HRESULT {
                return @as(*const IWiaPreview.VTable, @ptrCast(self.vtable)).UpdatePreview(@as(*const IWiaPreview, @ptrCast(self)), l_flags_, p_child_wia_item2_, p_wia_transfer_callback_);
            }
            pub inline fn detectRegions(self: *const T, l_flags_: i32) HRESULT {
                return @as(*const IWiaPreview.VTable, @ptrCast(self.vtable)).DetectRegions(@as(*const IWiaPreview, @ptrCast(self)), l_flags_);
            }
...
pub const IEnumWiaItem2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn next(self: *const T, c_elt_: u32, pp_i_wia_item2_: ?*?*IWiaItem2, pc_elt_fetched_: ?*u32) HRESULT {
                return @as(*const IEnumWiaItem2.VTable, @ptrCast(self.vtable)).Next(@as(*const IEnumWiaItem2, @ptrCast(self)), c_elt_, pp_i_wia_item2_, pc_elt_fetched_);
            }
            pub inline fn skip(self: *const T, c_elt_: u32) HRESULT {
                return @as(*const IEnumWiaItem2.VTable, @ptrCast(self.vtable)).Skip(@as(*const IEnumWiaItem2, @ptrCast(self)), c_elt_);
            }
            pub inline fn reset(self: *const T) HRESULT {
                return @as(*const IEnumWiaItem2.VTable, @ptrCast(self.vtable)).Reset(@as(*const IEnumWiaItem2, @ptrCast(self)));
            }
            pub inline fn clone(self: *const T, pp_i_enum_: ?*?*IEnumWiaItem2) HRESULT {
                return @as(*const IEnumWiaItem2.VTable, @ptrCast(self.vtable)).Clone(@as(*const IEnumWiaItem2, @ptrCast(self)), pp_i_enum_);
            }
            pub inline fn getCount(self: *const T, c_elt_: ?*u32) HRESULT {
                return @as(*const IEnumWiaItem2.VTable, @ptrCast(self.vtable)).GetCount(@as(*const IEnumWiaItem2, @ptrCast(self)), c_elt_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWiaItem2 = extern struct {
    pub const VTable = extern struct {
        ...
        EnumChildItems: *const fn (
            self: *const IWiaItem2,
            p_category_g_u_i_d: ?*const Guid,
            pp_i_enum_wia_item2: ?*?*IEnumWiaItem2,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        FindItemByName: *const fn (
            self: *const IWiaItem2,
            l_flags: i32,
        ...
        DeviceDlg: *const fn (
            ...
            l_flags: i32,
            hwnd_parent: ?HWND,
            bstr_folder_name: ?BSTR,
            bstr_filename: ?BSTR,
            pl_num_files: ?*i32,
            ppbstr_file_paths: ?*?*?BSTR,
            pp_item: ?*?*IWiaItem2,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        DeviceCommand: *const fn (
            self: *const IWiaItem2,
        ...
        CheckExtension: *const fn (
            ...
            l_flags: i32,
            bstr_name: ?BSTR,
            riid_extension_interface: ?*const Guid,
            pb_extension_exists: ?*BOOL,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn createChildItem(self: *const T, l_item_flags_: i32, l_creation_flags_: i32, bstr_item_name_: ?BSTR, pp_i_wia_item2_: ?*?*IWiaItem2) HRESULT {
                return @as(*const IWiaItem2.VTable, @ptrCast(self.vtable)).CreateChildItem(@as(*const IWiaItem2, @ptrCast(self)), l_item_flags_, l_creation_flags_, bstr_item_name_, pp_i_wia_item2_);
            }
            pub inline fn deleteItem(self: *const T, l_flags_: i32) HRESULT {
                return @as(*const IWiaItem2.VTable, @ptrCast(self.vtable)).DeleteItem(@as(*const IWiaItem2, @ptrCast(self)), l_flags_);
            }
            pub inline fn enumChildItems(self: *const T, p_category_g_u_i_d_: ?*const Guid, pp_i_enum_wia_item2_: ?*?*IEnumWiaItem2) HRESULT {
                return @as(*const IWiaItem2.VTable, @ptrCast(self.vtable)).EnumChildItems(@as(*const IWiaItem2, @ptrCast(self)), p_category_g_u_i_d_, pp_i_enum_wia_item2_);
            }
            pub inline fn findItemByName(self: *const T, l_flags_: i32, bstr_full_item_name_: ?BSTR, pp_i_wia_item2_: ?*?*IWiaItem2) HRESULT {
                return @as(*const IWiaItem2.VTable, @ptrCast(self.vtable)).FindItemByName(@as(*const IWiaItem2, @ptrCast(self)), l_flags_, bstr_full_item_name_, pp_i_wia_item2_);
            }
            pub inline fn getItemCategory(self: *const T, p_item_category_g_u_i_d_: ?*Guid) HRESULT {
                return @as(*const IWiaItem2.VTable, @ptrCast(self.vtable)).GetItemCategory(@as(*const IWiaItem2, @ptrCast(self)), p_item_category_g_u_i_d_);
            }
            pub inline fn getItemType(self: *const T, p_item_type_: ?*i32) HRESULT {
                return @as(*const IWiaItem2.VTable, @ptrCast(self.vtable)).GetItemType(@as(*const IWiaItem2, @ptrCast(self)), p_item_type_);
            }
            pub inline fn deviceDlg(self: *const T, l_flags_: i32, hwnd_parent_: ?HWND, bstr_folder_name_: ?BSTR, bstr_filename_: ?BSTR, pl_num_files_: ?*i32, ppbstr_file_paths_: ?*?*?BSTR, pp_item_: ?*?*IWiaItem2) HRESULT {
                return @as(*const IWiaItem2.VTable, @ptrCast(self.vtable)).DeviceDlg(@as(*const IWiaItem2, @ptrCast(self)), l_flags_, hwnd_parent_, bstr_folder_name_, bstr_filename_, pl_num_files_, ppbstr_file_paths_, pp_item_);
            }
            pub inline fn deviceCommand(self: *const T, l_flags_: i32, p_cmd_g_u_i_d_: ?*const Guid, pp_i_wia_item2_: ?*?*IWiaItem2) HRESULT {
                return @as(*const IWiaItem2.VTable, @ptrCast(self.vtable)).DeviceCommand(@as(*const IWiaItem2, @ptrCast(self)), l_flags_, p_cmd_g_u_i_d_, pp_i_wia_item2_);
            }
            pub inline fn enumDeviceCapabilities(self: *const T, l_flags_: i32, pp_i_enum_w_i_a__d_e_v__c_a_p_s_: ?*?*IEnumWIA_DEV_CAPS) HRESULT {
                return @as(*const IWiaItem2.VTable, @ptrCast(self.vtable)).EnumDeviceCapabilities(@as(*const IWiaItem2, @ptrCast(self)), l_flags_, pp_i_enum_w_i_a__d_e_v__c_a_p_s_);
            }
            pub inline fn checkExtension(self: *const T, l_flags_: i32, bstr_name_: ?BSTR, riid_extension_interface_: ?*const Guid, pb_extension_exists_: ?*BOOL) HRESULT {
                return @as(*const IWiaItem2.VTable, @ptrCast(self.vtable)).CheckExtension(@as(*const IWiaItem2, @ptrCast(self)), l_flags_, bstr_name_, riid_extension_interface_, pb_extension_exists_);
            }
            pub inline fn getExtension(self: *const T, l_flags_: i32, bstr_name_: ?BSTR, riid_extension_interface_: ?*const Guid, pp_out_: ?*?*anyopaque) HRESULT {
                return @as(*const IWiaItem2.VTable, @ptrCast(self.vtable)).GetExtension(@as(*const IWiaItem2, @ptrCast(self)), l_flags_, bstr_name_, riid_extension_interface_, pp_out_);
            }
            pub inline fn getParentItem(self: *const T, pp_i_wia_item2_: ?*?*IWiaItem2) HRESULT {
                return @as(*const IWiaItem2.VTable, @ptrCast(self.vtable)).GetParentItem(@as(*const IWiaItem2, @ptrCast(self)), pp_i_wia_item2_);
            }
            pub inline fn getRootItem(self: *const T, pp_i_wia_item2_: ?*?*IWiaItem2) HRESULT {
                return @as(*const IWiaItem2.VTable, @ptrCast(self.vtable)).GetRootItem(@as(*const IWiaItem2, @ptrCast(self)), pp_i_wia_item2_);
            }
            pub inline fn getPreviewComponent(self: *const T, l_flags_: i32, pp_wia_preview_: ?*?*IWiaPreview) HRESULT {
                return @as(*const IWiaItem2.VTable, @ptrCast(self.vtable)).GetPreviewComponent(@as(*const IWiaItem2, @ptrCast(self)), l_flags_, pp_wia_preview_);
            }
            pub inline fn enumRegisterEventInfo(self: *const T, l_flags_: i32, p_event_g_u_i_d_: ?*const Guid, pp_i_enum_: ?*?*IEnumWIA_DEV_CAPS) HRESULT {
                return @as(*const IWiaItem2.VTable, @ptrCast(self.vtable)).EnumRegisterEventInfo(@as(*const IWiaItem2, @ptrCast(self)), l_flags_, p_event_g_u_i_d_, pp_i_enum_);
            }
            pub inline fn diagnostic(self: *const T, ul_size_: u32, p_buffer_: [*:0]u8) HRESULT {
                return @as(*const IWiaItem2.VTable, @ptrCast(self.vtable)).Diagnostic(@as(*const IWiaItem2, @ptrCast(self)), ul_size_, p_buffer_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWiaDevMgr2 = extern struct {
    pub const VTable = extern struct {
        ...
        RegisterEventCallbackProgram: *const fn (
            ...
            bstr_device_i_d: ?BSTR,
            p_event_g_u_i_d: ?*const Guid,
            bstr_full_app_name: ?BSTR,
            bstr_command_line_arg: ?BSTR,
            bstr_name: ?BSTR,
            bstr_description: ?BSTR,
            bstr_icon: ?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn enumDeviceInfo(self: *const T, l_flags_: i32, pp_i_enum_: ?*?*IEnumWIA_DEV_INFO) HRESULT {
                return @as(*const IWiaDevMgr2.VTable, @ptrCast(self.vtable)).EnumDeviceInfo(@as(*const IWiaDevMgr2, @ptrCast(self)), l_flags_, pp_i_enum_);
            }
            pub inline fn createDevice(self: *const T, l_flags_: i32, bstr_device_i_d_: ?BSTR, pp_wia_item2_root_: ?*?*IWiaItem2) HRESULT {
                return @as(*const IWiaDevMgr2.VTable, @ptrCast(self.vtable)).CreateDevice(@as(*const IWiaDevMgr2, @ptrCast(self)), l_flags_, bstr_device_i_d_, pp_wia_item2_root_);
            }
            pub inline fn selectDeviceDlg(self: *const T, hwnd_parent_: ?HWND, l_device_type_: i32, l_flags_: i32, pbstr_device_i_d_: ?*?BSTR, pp_item_root_: ?*?*IWiaItem2) HRESULT {
                return @as(*const IWiaDevMgr2.VTable, @ptrCast(self.vtable)).SelectDeviceDlg(@as(*const IWiaDevMgr2, @ptrCast(self)), hwnd_parent_, l_device_type_, l_flags_, pbstr_device_i_d_, pp_item_root_);
            }
            pub inline fn selectDeviceDlgID(self: *const T, hwnd_parent_: ?HWND, l_device_type_: i32, l_flags_: i32, pbstr_device_i_d_: ?*?BSTR) HRESULT {
                return @as(*const IWiaDevMgr2.VTable, @ptrCast(self.vtable)).SelectDeviceDlgID(@as(*const IWiaDevMgr2, @ptrCast(self)), hwnd_parent_, l_device_type_, l_flags_, pbstr_device_i_d_);
            }
            pub inline fn registerEventCallbackInterface(self: *const T, l_flags_: i32, bstr_device_i_d_: ?BSTR, p_event_g_u_i_d_: ?*const Guid, p_i_wia_event_callback_: ?*IWiaEventCallback, p_event_object_: ?*?*IUnknown) HRESULT {
                return @as(*const IWiaDevMgr2.VTable, @ptrCast(self.vtable)).RegisterEventCallbackInterface(@as(*const IWiaDevMgr2, @ptrCast(self)), l_flags_, bstr_device_i_d_, p_event_g_u_i_d_, p_i_wia_event_callback_, p_event_object_);
            }
            pub inline fn registerEventCallbackProgram(self: *const T, l_flags_: i32, bstr_device_i_d_: ?BSTR, p_event_g_u_i_d_: ?*const Guid, bstr_full_app_name_: ?BSTR, bstr_command_line_arg_: ?BSTR, bstr_name_: ?BSTR, bstr_description_: ?BSTR, bstr_icon_: ?BSTR) HRESULT {
                return @as(*const IWiaDevMgr2.VTable, @ptrCast(self.vtable)).RegisterEventCallbackProgram(@as(*const IWiaDevMgr2, @ptrCast(self)), l_flags_, bstr_device_i_d_, p_event_g_u_i_d_, bstr_full_app_name_, bstr_command_line_arg_, bstr_name_, bstr_description_, bstr_icon_);
            }
            pub inline fn registerEventCallbackCLSID(self: *const T, l_flags_: i32, bstr_device_i_d_: ?BSTR, p_event_g_u_i_d_: ?*const Guid, p_cls_i_d_: ?*const Guid, bstr_name_: ?BSTR, bstr_description_: ?BSTR, bstr_icon_: ?BSTR) HRESULT {
                return @as(*const IWiaDevMgr2.VTable, @ptrCast(self.vtable)).RegisterEventCallbackCLSID(@as(*const IWiaDevMgr2, @ptrCast(self)), l_flags_, bstr_device_i_d_, p_event_g_u_i_d_, p_cls_i_d_, bstr_name_, bstr_description_, bstr_icon_);
            }
            pub inline fn getImageDlg(self: *const T, l_flags_: i32, bstr_device_i_d_: ?BSTR, hwnd_parent_: ?HWND, bstr_folder_name_: ?BSTR, bstr_filename_: ?BSTR, pl_num_files_: ?*i32, ppbstr_file_paths_: ?*?*?BSTR, pp_item_: ?*?*IWiaItem2) HRESULT {
                return @as(*const IWiaDevMgr2.VTable, @ptrCast(self.vtable)).GetImageDlg(@as(*const IWiaDevMgr2, @ptrCast(self)), l_flags_, bstr_device_i_d_, hwnd_parent_, bstr_folder_name_, bstr_filename_, pl_num_files_, ppbstr_file_paths_, pp_item_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWiaMiniDrv = extern struct {
    pub const VTable = extern struct {
        ...
        drvInitializeWia: *const fn (
            ...
            ___m_i_d_l___i_wia_mini_drv0000: ?*u8,
            ___m_i_d_l___i_wia_mini_drv0001: i32,
            ___m_i_d_l___i_wia_mini_drv0002: ?BSTR,
            ___m_i_d_l___i_wia_mini_drv0003: ?BSTR,
            ___m_i_d_l___i_wia_mini_drv0004: ?*IUnknown,
            ___m_i_d_l___i_wia_mini_drv0005: ?*IUnknown,
            ___m_i_d_l___i_wia_mini_drv0006: ?*?*IWiaDrvItem,
            ___m_i_d_l___i_wia_mini_drv0007: ?*?*IUnknown,
            ___m_i_d_l___i_wia_mini_drv0008: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        drvAcquireItemData: *const fn (
            self: *const IWiaMiniDrv,
            ___m_i_d_l___i_wia_mini_drv0009: ?*u8,
            ___m_i_d_l___i_wia_mini_drv0010: i32,
            ___m_i_d_l___i_wia_mini_drv0011: ?*MINIDRV_TRANSFER_CONTEXT,
            ___m_i_d_l___i_wia_mini_drv0012: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        drvInitItemProperties: *const fn (
            self: *const IWiaMiniDrv,
            ___m_i_d_l___i_wia_mini_drv0013: ?*u8,
            ___m_i_d_l___i_wia_mini_drv0014: i32,
            ___m_i_d_l___i_wia_mini_drv0015: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        drvValidateItemProperties: *const fn (
            self: *const IWiaMiniDrv,
            ___m_i_d_l___i_wia_mini_drv0016: ?*u8,
            ___m_i_d_l___i_wia_mini_drv0017: i32,
            ___m_i_d_l___i_wia_mini_drv0018: u32,
            ___m_i_d_l___i_wia_mini_drv0019: ?*const PROPSPEC,
            ___m_i_d_l___i_wia_mini_drv0020: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        drvWriteItemProperties: *const fn (
            self: *const IWiaMiniDrv,
            ___m_i_d_l___i_wia_mini_drv0021: ?*u8,
            ___m_i_d_l___i_wia_mini_drv0022: i32,
            ___m_i_d_l___i_wia_mini_drv0023: ?*MINIDRV_TRANSFER_CONTEXT,
            ___m_i_d_l___i_wia_mini_drv0024: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        drvReadItemProperties: *const fn (
            self: *const IWiaMiniDrv,
            ___m_i_d_l___i_wia_mini_drv0025: ?*u8,
            ___m_i_d_l___i_wia_mini_drv0026: i32,
            ___m_i_d_l___i_wia_mini_drv0027: u32,
            ___m_i_d_l___i_wia_mini_drv0028: ?*const PROPSPEC,
            ___m_i_d_l___i_wia_mini_drv0029: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        drvLockWiaDevice: *const fn (
            self: *const IWiaMiniDrv,
            ___m_i_d_l___i_wia_mini_drv0030: ?*u8,
            ___m_i_d_l___i_wia_mini_drv0031: i32,
            ___m_i_d_l___i_wia_mini_drv0032: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        drvUnLockWiaDevice: *const fn (
            self: *const IWiaMiniDrv,
            ___m_i_d_l___i_wia_mini_drv0033: ?*u8,
            ___m_i_d_l___i_wia_mini_drv0034: i32,
            ___m_i_d_l___i_wia_mini_drv0035: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        drvAnalyzeItem: *const fn (
            self: *const IWiaMiniDrv,
            ___m_i_d_l___i_wia_mini_drv0036: ?*u8,
            ___m_i_d_l___i_wia_mini_drv0037: i32,
            ___m_i_d_l___i_wia_mini_drv0038: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        drvGetDeviceErrorStr: *const fn (
            self: *const IWiaMiniDrv,
            ___m_i_d_l___i_wia_mini_drv0039: i32,
            ___m_i_d_l___i_wia_mini_drv0040: i32,
            ___m_i_d_l___i_wia_mini_drv0041: ?*?PWSTR,
            ___m_i_d_l___i_wia_mini_drv0042: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        drvDeviceCommand: *const fn (
            self: *const IWiaMiniDrv,
            ___m_i_d_l___i_wia_mini_drv0043: ?*u8,
            ___m_i_d_l___i_wia_mini_drv0044: i32,
            ___m_i_d_l___i_wia_mini_drv0045: ?*const Guid,
            ___m_i_d_l___i_wia_mini_drv0046: ?*?*IWiaDrvItem,
            ___m_i_d_l___i_wia_mini_drv0047: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        drvGetCapabilities: *const fn (
            self: *const IWiaMiniDrv,
            ___m_i_d_l___i_wia_mini_drv0048: ?*u8,
            ___m_i_d_l___i_wia_mini_drv0049: i32,
            ___m_i_d_l___i_wia_mini_drv0050: ?*i32,
            ___m_i_d_l___i_wia_mini_drv0051: ?*?*WIA_DEV_CAP_DRV,
            ___m_i_d_l___i_wia_mini_drv0052: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        drvDeleteItem: *const fn (
            self: *const IWiaMiniDrv,
            ___m_i_d_l___i_wia_mini_drv0053: ?*u8,
            ___m_i_d_l___i_wia_mini_drv0054: i32,
            ___m_i_d_l___i_wia_mini_drv0055: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        drvFreeDrvItemContext: *const fn (
            self: *const IWiaMiniDrv,
            ___m_i_d_l___i_wia_mini_drv0056: i32,
            ___m_i_d_l___i_wia_mini_drv0057: ?*u8,
            ___m_i_d_l___i_wia_mini_drv0058: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        drvGetWiaFormatInfo: *const fn (
            self: *const IWiaMiniDrv,
            ___m_i_d_l___i_wia_mini_drv0059: ?*u8,
            ___m_i_d_l___i_wia_mini_drv0060: i32,
            ___m_i_d_l___i_wia_mini_drv0061: ?*i32,
            ___m_i_d_l___i_wia_mini_drv0062: ?*?*WIA_FORMAT_INFO,
            ___m_i_d_l___i_wia_mini_drv0063: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        drvUnInitializeWia: *const fn (
            self: *const IWiaMiniDrv,
            ___m_i_d_l___i_wia_mini_drv0064: ?*u8,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn drvInitializeWia(self: *const T, ___m_i_d_l___i_wia_mini_drv0000_: ?*u8, ___m_i_d_l___i_wia_mini_drv0001_: i32, ___m_i_d_l___i_wia_mini_drv0002_: ?BSTR, ___m_i_d_l___i_wia_mini_drv0003_: ?BSTR, ___m_i_d_l___i_wia_mini_drv0004_: ?*IUnknown, ___m_i_d_l___i_wia_mini_drv0005_: ?*IUnknown, ___m_i_d_l___i_wia_mini_drv0006_: ?*?*IWiaDrvItem, ___m_i_d_l___i_wia_mini_drv0007_: ?*?*IUnknown, ___m_i_d_l___i_wia_mini_drv0008_: ?*i32) HRESULT {
                return @as(*const IWiaMiniDrv.VTable, @ptrCast(self.vtable)).drvInitializeWia(@as(*const IWiaMiniDrv, @ptrCast(self)), ___m_i_d_l___i_wia_mini_drv0000_, ___m_i_d_l___i_wia_mini_drv0001_, ___m_i_d_l___i_wia_mini_drv0002_, ___m_i_d_l___i_wia_mini_drv0003_, ___m_i_d_l___i_wia_mini_drv0004_, ___m_i_d_l___i_wia_mini_drv0005_, ___m_i_d_l___i_wia_mini_drv0006_, ___m_i_d_l___i_wia_mini_drv0007_, ___m_i_d_l___i_wia_mini_drv0008_);
            }
            pub inline fn drvAcquireItemData(self: *const T, ___m_i_d_l___i_wia_mini_drv0009_: ?*u8, ___m_i_d_l___i_wia_mini_drv0010_: i32, ___m_i_d_l___i_wia_mini_drv0011_: ?*MINIDRV_TRANSFER_CONTEXT, ___m_i_d_l___i_wia_mini_drv0012_: ?*i32) HRESULT {
                return @as(*const IWiaMiniDrv.VTable, @ptrCast(self.vtable)).drvAcquireItemData(@as(*const IWiaMiniDrv, @ptrCast(self)), ___m_i_d_l___i_wia_mini_drv0009_, ___m_i_d_l___i_wia_mini_drv0010_, ___m_i_d_l___i_wia_mini_drv0011_, ___m_i_d_l___i_wia_mini_drv0012_);
            }
            pub inline fn drvInitItemProperties(self: *const T, ___m_i_d_l___i_wia_mini_drv0013_: ?*u8, ___m_i_d_l___i_wia_mini_drv0014_: i32, ___m_i_d_l___i_wia_mini_drv0015_: ?*i32) HRESULT {
                return @as(*const IWiaMiniDrv.VTable, @ptrCast(self.vtable)).drvInitItemProperties(@as(*const IWiaMiniDrv, @ptrCast(self)), ___m_i_d_l___i_wia_mini_drv0013_, ___m_i_d_l___i_wia_mini_drv0014_, ___m_i_d_l___i_wia_mini_drv0015_);
            }
            pub inline fn drvValidateItemProperties(self: *const T, ___m_i_d_l___i_wia_mini_drv0016_: ?*u8, ___m_i_d_l___i_wia_mini_drv0017_: i32, ___m_i_d_l___i_wia_mini_drv0018_: u32, ___m_i_d_l___i_wia_mini_drv0019_: ?*const PROPSPEC, ___m_i_d_l___i_wia_mini_drv0020_: ?*i32) HRESULT {
                return @as(*const IWiaMiniDrv.VTable, @ptrCast(self.vtable)).drvValidateItemProperties(@as(*const IWiaMiniDrv, @ptrCast(self)), ___m_i_d_l___i_wia_mini_drv0016_, ___m_i_d_l___i_wia_mini_drv0017_, ___m_i_d_l___i_wia_mini_drv0018_, ___m_i_d_l___i_wia_mini_drv0019_, ___m_i_d_l___i_wia_mini_drv0020_);
            }
            pub inline fn drvWriteItemProperties(self: *const T, ___m_i_d_l___i_wia_mini_drv0021_: ?*u8, ___m_i_d_l___i_wia_mini_drv0022_: i32, ___m_i_d_l___i_wia_mini_drv0023_: ?*MINIDRV_TRANSFER_CONTEXT, ___m_i_d_l___i_wia_mini_drv0024_: ?*i32) HRESULT {
                return @as(*const IWiaMiniDrv.VTable, @ptrCast(self.vtable)).drvWriteItemProperties(@as(*const IWiaMiniDrv, @ptrCast(self)), ___m_i_d_l___i_wia_mini_drv0021_, ___m_i_d_l___i_wia_mini_drv0022_, ___m_i_d_l___i_wia_mini_drv0023_, ___m_i_d_l___i_wia_mini_drv0024_);
            }
            pub inline fn drvReadItemProperties(self: *const T, ___m_i_d_l___i_wia_mini_drv0025_: ?*u8, ___m_i_d_l___i_wia_mini_drv0026_: i32, ___m_i_d_l___i_wia_mini_drv0027_: u32, ___m_i_d_l___i_wia_mini_drv0028_: ?*const PROPSPEC, ___m_i_d_l___i_wia_mini_drv0029_: ?*i32) HRESULT {
                return @as(*const IWiaMiniDrv.VTable, @ptrCast(self.vtable)).drvReadItemProperties(@as(*const IWiaMiniDrv, @ptrCast(self)), ___m_i_d_l___i_wia_mini_drv0025_, ___m_i_d_l___i_wia_mini_drv0026_, ___m_i_d_l___i_wia_mini_drv0027_, ___m_i_d_l___i_wia_mini_drv0028_, ___m_i_d_l___i_wia_mini_drv0029_);
            }
            pub inline fn drvLockWiaDevice(self: *const T, ___m_i_d_l___i_wia_mini_drv0030_: ?*u8, ___m_i_d_l___i_wia_mini_drv0031_: i32, ___m_i_d_l___i_wia_mini_drv0032_: ?*i32) HRESULT {
                return @as(*const IWiaMiniDrv.VTable, @ptrCast(self.vtable)).drvLockWiaDevice(@as(*const IWiaMiniDrv, @ptrCast(self)), ___m_i_d_l___i_wia_mini_drv0030_, ___m_i_d_l___i_wia_mini_drv0031_, ___m_i_d_l___i_wia_mini_drv0032_);
            }
            pub inline fn drvUnLockWiaDevice(self: *const T, ___m_i_d_l___i_wia_mini_drv0033_: ?*u8, ___m_i_d_l___i_wia_mini_drv0034_: i32, ___m_i_d_l___i_wia_mini_drv0035_: ?*i32) HRESULT {
                return @as(*const IWiaMiniDrv.VTable, @ptrCast(self.vtable)).drvUnLockWiaDevice(@as(*const IWiaMiniDrv, @ptrCast(self)), ___m_i_d_l___i_wia_mini_drv0033_, ___m_i_d_l___i_wia_mini_drv0034_, ___m_i_d_l___i_wia_mini_drv0035_);
            }
            pub inline fn drvAnalyzeItem(self: *const T, ___m_i_d_l___i_wia_mini_drv0036_: ?*u8, ___m_i_d_l___i_wia_mini_drv0037_: i32, ___m_i_d_l___i_wia_mini_drv0038_: ?*i32) HRESULT {
                return @as(*const IWiaMiniDrv.VTable, @ptrCast(self.vtable)).drvAnalyzeItem(@as(*const IWiaMiniDrv, @ptrCast(self)), ___m_i_d_l___i_wia_mini_drv0036_, ___m_i_d_l___i_wia_mini_drv0037_, ___m_i_d_l___i_wia_mini_drv0038_);
            }
            pub inline fn drvGetDeviceErrorStr(self: *const T, ___m_i_d_l___i_wia_mini_drv0039_: i32, ___m_i_d_l___i_wia_mini_drv0040_: i32, ___m_i_d_l___i_wia_mini_drv0041_: ?*?PWSTR, ___m_i_d_l___i_wia_mini_drv0042_: ?*i32) HRESULT {
                return @as(*const IWiaMiniDrv.VTable, @ptrCast(self.vtable)).drvGetDeviceErrorStr(@as(*const IWiaMiniDrv, @ptrCast(self)), ___m_i_d_l___i_wia_mini_drv0039_, ___m_i_d_l___i_wia_mini_drv0040_, ___m_i_d_l___i_wia_mini_drv0041_, ___m_i_d_l___i_wia_mini_drv0042_);
            }
            pub inline fn drvDeviceCommand(self: *const T, ___m_i_d_l___i_wia_mini_drv0043_: ?*u8, ___m_i_d_l___i_wia_mini_drv0044_: i32, ___m_i_d_l___i_wia_mini_drv0045_: ?*const Guid, ___m_i_d_l___i_wia_mini_drv0046_: ?*?*IWiaDrvItem, ___m_i_d_l___i_wia_mini_drv0047_: ?*i32) HRESULT {
                return @as(*const IWiaMiniDrv.VTable, @ptrCast(self.vtable)).drvDeviceCommand(@as(*const IWiaMiniDrv, @ptrCast(self)), ___m_i_d_l___i_wia_mini_drv0043_, ___m_i_d_l___i_wia_mini_drv0044_, ___m_i_d_l___i_wia_mini_drv0045_, ___m_i_d_l___i_wia_mini_drv0046_, ___m_i_d_l___i_wia_mini_drv0047_);
            }
            pub inline fn drvGetCapabilities(self: *const T, ___m_i_d_l___i_wia_mini_drv0048_: ?*u8, ___m_i_d_l___i_wia_mini_drv0049_: i32, ___m_i_d_l___i_wia_mini_drv0050_: ?*i32, ___m_i_d_l___i_wia_mini_drv0051_: ?*?*WIA_DEV_CAP_DRV, ___m_i_d_l___i_wia_mini_drv0052_: ?*i32) HRESULT {
                return @as(*const IWiaMiniDrv.VTable, @ptrCast(self.vtable)).drvGetCapabilities(@as(*const IWiaMiniDrv, @ptrCast(self)), ___m_i_d_l___i_wia_mini_drv0048_, ___m_i_d_l___i_wia_mini_drv0049_, ___m_i_d_l___i_wia_mini_drv0050_, ___m_i_d_l___i_wia_mini_drv0051_, ___m_i_d_l___i_wia_mini_drv0052_);
            }
            pub inline fn drvDeleteItem(self: *const T, ___m_i_d_l___i_wia_mini_drv0053_: ?*u8, ___m_i_d_l___i_wia_mini_drv0054_: i32, ___m_i_d_l___i_wia_mini_drv0055_: ?*i32) HRESULT {
                return @as(*const IWiaMiniDrv.VTable, @ptrCast(self.vtable)).drvDeleteItem(@as(*const IWiaMiniDrv, @ptrCast(self)), ___m_i_d_l___i_wia_mini_drv0053_, ___m_i_d_l___i_wia_mini_drv0054_, ___m_i_d_l___i_wia_mini_drv0055_);
            }
            pub inline fn drvFreeDrvItemContext(self: *const T, ___m_i_d_l___i_wia_mini_drv0056_: i32, ___m_i_d_l___i_wia_mini_drv0057_: ?*u8, ___m_i_d_l___i_wia_mini_drv0058_: ?*i32) HRESULT {
                return @as(*const IWiaMiniDrv.VTable, @ptrCast(self.vtable)).drvFreeDrvItemContext(@as(*const IWiaMiniDrv, @ptrCast(self)), ___m_i_d_l___i_wia_mini_drv0056_, ___m_i_d_l___i_wia_mini_drv0057_, ___m_i_d_l___i_wia_mini_drv0058_);
            }
            pub inline fn drvGetWiaFormatInfo(self: *const T, ___m_i_d_l___i_wia_mini_drv0059_: ?*u8, ___m_i_d_l___i_wia_mini_drv0060_: i32, ___m_i_d_l___i_wia_mini_drv0061_: ?*i32, ___m_i_d_l___i_wia_mini_drv0062_: ?*?*WIA_FORMAT_INFO, ___m_i_d_l___i_wia_mini_drv0063_: ?*i32) HRESULT {
                return @as(*const IWiaMiniDrv.VTable, @ptrCast(self.vtable)).drvGetWiaFormatInfo(@as(*const IWiaMiniDrv, @ptrCast(self)), ___m_i_d_l___i_wia_mini_drv0059_, ___m_i_d_l___i_wia_mini_drv0060_, ___m_i_d_l___i_wia_mini_drv0061_, ___m_i_d_l___i_wia_mini_drv0062_, ___m_i_d_l___i_wia_mini_drv0063_);
            }
            pub inline fn drvNotifyPnpEvent(self: *const T, p_event_g_u_i_d_: ?*const Guid, bstr_device_i_d_: ?BSTR, ul_reserved_: u32) HRESULT {
                return @as(*const IWiaMiniDrv.VTable, @ptrCast(self.vtable)).drvNotifyPnpEvent(@as(*const IWiaMiniDrv, @ptrCast(self)), p_event_g_u_i_d_, bstr_device_i_d_, ul_reserved_);
            }
            pub inline fn drvUnInitializeWia(self: *const T, ___m_i_d_l___i_wia_mini_drv0064_: ?*u8) HRESULT {
                return @as(*const IWiaMiniDrv.VTable, @ptrCast(self.vtable)).drvUnInitializeWia(@as(*const IWiaMiniDrv, @ptrCast(self)), ___m_i_d_l___i_wia_mini_drv0064_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWiaMiniDrvCallBack = extern struct {
    pub const VTable = extern struct {
        ...
        MiniDrvCallback: *const fn (
            ...
            l_offset: i32,
            l_length: i32,
            p_tran_ctx: ?*MINIDRV_TRANSFER_CONTEXT,
            l_reserved: i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn miniDrvCallback(self: *const T, l_reason_: i32, l_status_: i32, l_percent_complete_: i32, l_offset_: i32, l_length_: i32, p_tran_ctx_: ?*MINIDRV_TRANSFER_CONTEXT, l_reserved_: i32) HRESULT {
                return @as(*const IWiaMiniDrvCallBack.VTable, @ptrCast(self.vtable)).MiniDrvCallback(@as(*const IWiaMiniDrvCallBack, @ptrCast(self)), l_reason_, l_status_, l_percent_complete_, l_offset_, l_length_, p_tran_ctx_, l_reserved_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWiaMiniDrvTransferCallback = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getNextStream(self: *const T, l_flags_: i32, bstr_item_name_: ?BSTR, bstr_full_item_name_: ?BSTR, pp_i_stream_: ?*?*IStream) HRESULT {
                return @as(*const IWiaMiniDrvTransferCallback.VTable, @ptrCast(self.vtable)).GetNextStream(@as(*const IWiaMiniDrvTransferCallback, @ptrCast(self)), l_flags_, bstr_item_name_, bstr_full_item_name_, pp_i_stream_);
            }
            pub inline fn sendMessage(self: *const T, l_flags_: i32, p_wia_transfer_params_: ?*WiaTransferParams) HRESULT {
                return @as(*const IWiaMiniDrvTransferCallback.VTable, @ptrCast(self.vtable)).SendMessage(@as(*const IWiaMiniDrvTransferCallback, @ptrCast(self)), l_flags_, p_wia_transfer_params_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWiaDrvItem = extern struct {
    pub const VTable = extern struct {
        ...
        GetItemFlags: *const fn (
            ...
            ___m_i_d_l___i_wia_drv_item0000: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetDeviceSpecContext: *const fn (
            self: *const IWiaDrvItem,
            ___m_i_d_l___i_wia_drv_item0001: ?*?*u8,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetFullItemName: *const fn (
            self: *const IWiaDrvItem,
            ___m_i_d_l___i_wia_drv_item0002: ?*?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetItemName: *const fn (
            self: *const IWiaDrvItem,
            ___m_i_d_l___i_wia_drv_item0003: ?*?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        AddItemToFolder: *const fn (
            self: *const IWiaDrvItem,
            ___m_i_d_l___i_wia_drv_item0004: ?*IWiaDrvItem,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        UnlinkItemTree: *const fn (
            self: *const IWiaDrvItem,
            ___m_i_d_l___i_wia_drv_item0005: i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        RemoveItemFromFolder: *const fn (
            self: *const IWiaDrvItem,
            ___m_i_d_l___i_wia_drv_item0006: i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        FindItemByName: *const fn (
            self: *const IWiaDrvItem,
            ___m_i_d_l___i_wia_drv_item0007: i32,
            ___m_i_d_l___i_wia_drv_item0008: ?BSTR,
            ___m_i_d_l___i_wia_drv_item0009: ?*?*IWiaDrvItem,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        FindChildItemByName: *const fn (
            self: *const IWiaDrvItem,
            ___m_i_d_l___i_wia_drv_item0010: ?BSTR,
            ___m_i_d_l___i_wia_drv_item0011: ?*?*IWiaDrvItem,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetParentItem: *const fn (
            self: *const IWiaDrvItem,
            ___m_i_d_l___i_wia_drv_item0012: ?*?*IWiaDrvItem,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetFirstChildItem: *const fn (
            self: *const IWiaDrvItem,
            ___m_i_d_l___i_wia_drv_item0013: ?*?*IWiaDrvItem,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetNextSiblingItem: *const fn (
            self: *const IWiaDrvItem,
            ___m_i_d_l___i_wia_drv_item0014: ?*?*IWiaDrvItem,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        DumpItemData: *const fn (
            self: *const IWiaDrvItem,
            ___m_i_d_l___i_wia_drv_item0015: ?*?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getItemFlags(self: *const T, ___m_i_d_l___i_wia_drv_item0000_: ?*i32) HRESULT {
                return @as(*const IWiaDrvItem.VTable, @ptrCast(self.vtable)).GetItemFlags(@as(*const IWiaDrvItem, @ptrCast(self)), ___m_i_d_l___i_wia_drv_item0000_);
            }
            pub inline fn getDeviceSpecContext(self: *const T, ___m_i_d_l___i_wia_drv_item0001_: ?*?*u8) HRESULT {
                return @as(*const IWiaDrvItem.VTable, @ptrCast(self.vtable)).GetDeviceSpecContext(@as(*const IWiaDrvItem, @ptrCast(self)), ___m_i_d_l___i_wia_drv_item0001_);
            }
            pub inline fn getFullItemName(self: *const T, ___m_i_d_l___i_wia_drv_item0002_: ?*?BSTR) HRESULT {
                return @as(*const IWiaDrvItem.VTable, @ptrCast(self.vtable)).GetFullItemName(@as(*const IWiaDrvItem, @ptrCast(self)), ___m_i_d_l___i_wia_drv_item0002_);
            }
            pub inline fn getItemName(self: *const T, ___m_i_d_l___i_wia_drv_item0003_: ?*?BSTR) HRESULT {
                return @as(*const IWiaDrvItem.VTable, @ptrCast(self.vtable)).GetItemName(@as(*const IWiaDrvItem, @ptrCast(self)), ___m_i_d_l___i_wia_drv_item0003_);
            }
            pub inline fn addItemToFolder(self: *const T, ___m_i_d_l___i_wia_drv_item0004_: ?*IWiaDrvItem) HRESULT {
                return @as(*const IWiaDrvItem.VTable, @ptrCast(self.vtable)).AddItemToFolder(@as(*const IWiaDrvItem, @ptrCast(self)), ___m_i_d_l___i_wia_drv_item0004_);
            }
            pub inline fn unlinkItemTree(self: *const T, ___m_i_d_l___i_wia_drv_item0005_: i32) HRESULT {
                return @as(*const IWiaDrvItem.VTable, @ptrCast(self.vtable)).UnlinkItemTree(@as(*const IWiaDrvItem, @ptrCast(self)), ___m_i_d_l___i_wia_drv_item0005_);
            }
            pub inline fn removeItemFromFolder(self: *const T, ___m_i_d_l___i_wia_drv_item0006_: i32) HRESULT {
                return @as(*const IWiaDrvItem.VTable, @ptrCast(self.vtable)).RemoveItemFromFolder(@as(*const IWiaDrvItem, @ptrCast(self)), ___m_i_d_l___i_wia_drv_item0006_);
            }
            pub inline fn findItemByName(self: *const T, ___m_i_d_l___i_wia_drv_item0007_: i32, ___m_i_d_l___i_wia_drv_item0008_: ?BSTR, ___m_i_d_l___i_wia_drv_item0009_: ?*?*IWiaDrvItem) HRESULT {
                return @as(*const IWiaDrvItem.VTable, @ptrCast(self.vtable)).FindItemByName(@as(*const IWiaDrvItem, @ptrCast(self)), ___m_i_d_l___i_wia_drv_item0007_, ___m_i_d_l___i_wia_drv_item0008_, ___m_i_d_l___i_wia_drv_item0009_);
            }
            pub inline fn findChildItemByName(self: *const T, ___m_i_d_l___i_wia_drv_item0010_: ?BSTR, ___m_i_d_l___i_wia_drv_item0011_: ?*?*IWiaDrvItem) HRESULT {
                return @as(*const IWiaDrvItem.VTable, @ptrCast(self.vtable)).FindChildItemByName(@as(*const IWiaDrvItem, @ptrCast(self)), ___m_i_d_l___i_wia_drv_item0010_, ___m_i_d_l___i_wia_drv_item0011_);
            }
            pub inline fn getParentItem(self: *const T, ___m_i_d_l___i_wia_drv_item0012_: ?*?*IWiaDrvItem) HRESULT {
                return @as(*const IWiaDrvItem.VTable, @ptrCast(self.vtable)).GetParentItem(@as(*const IWiaDrvItem, @ptrCast(self)), ___m_i_d_l___i_wia_drv_item0012_);
            }
            pub inline fn getFirstChildItem(self: *const T, ___m_i_d_l___i_wia_drv_item0013_: ?*?*IWiaDrvItem) HRESULT {
                return @as(*const IWiaDrvItem.VTable, @ptrCast(self.vtable)).GetFirstChildItem(@as(*const IWiaDrvItem, @ptrCast(self)), ___m_i_d_l___i_wia_drv_item0013_);
            }
            pub inline fn getNextSiblingItem(self: *const T, ___m_i_d_l___i_wia_drv_item0014_: ?*?*IWiaDrvItem) HRESULT {
                return @as(*const IWiaDrvItem.VTable, @ptrCast(self.vtable)).GetNextSiblingItem(@as(*const IWiaDrvItem, @ptrCast(self)), ___m_i_d_l___i_wia_drv_item0014_);
            }
            pub inline fn dumpItemData(self: *const T, ___m_i_d_l___i_wia_drv_item0015_: ?*?BSTR) HRESULT {
                return @as(*const IWiaDrvItem.VTable, @ptrCast(self.vtable)).DumpItemData(@as(*const IWiaDrvItem, @ptrCast(self)), ___m_i_d_l___i_wia_drv_item0015_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWiaVideo = extern struct {
    pub const VTable = extern struct {
        ...
        get_PreviewVisible: *const fn (
            ...
            pb_preview_visible: ?*BOOL,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        put_PreviewVisible: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const IWiaVideo,
            b_preview_visible: BOOL,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_ImagesDirectory: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const IWiaVideo,
            pbstr_image_directory: ?*?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        put_ImagesDirectory: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const IWiaVideo,
            bstr_image_directory: ?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        CreateVideoByWiaDevID: *const fn (
            self: *const IWiaVideo,
            bstr_wia_device_i_d: ?BSTR,
            hwnd_parent: ?HWND,
            b_stretch_to_fit_parent: BOOL,
            b_auto_begin_playback: BOOL,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        CreateVideoByDevNum: *const fn (
            self: *const IWiaVideo,
            ui_device_number: u32,
            hwnd_parent: ?HWND,
            b_stretch_to_fit_parent: BOOL,
            b_auto_begin_playback: BOOL,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getPreviewVisible(self: *const T, pb_preview_visible_: ?*BOOL) HRESULT {
                return @as(*const IWiaVideo.VTable, @ptrCast(self.vtable)).get_PreviewVisible(@as(*const IWiaVideo, @ptrCast(self)), pb_preview_visible_);
            }
            pub inline fn putPreviewVisible(self: *const T, b_preview_visible_: BOOL) HRESULT {
                return @as(*const IWiaVideo.VTable, @ptrCast(self.vtable)).put_PreviewVisible(@as(*const IWiaVideo, @ptrCast(self)), b_preview_visible_);
            }
            pub inline fn getImagesDirectory(self: *const T, pbstr_image_directory_: ?*?BSTR) HRESULT {
                return @as(*const IWiaVideo.VTable, @ptrCast(self.vtable)).get_ImagesDirectory(@as(*const IWiaVideo, @ptrCast(self)), pbstr_image_directory_);
            }
            pub inline fn putImagesDirectory(self: *const T, bstr_image_directory_: ?BSTR) HRESULT {
                return @as(*const IWiaVideo.VTable, @ptrCast(self.vtable)).put_ImagesDirectory(@as(*const IWiaVideo, @ptrCast(self)), bstr_image_directory_);
            }
            pub inline fn createVideoByWiaDevID(self: *const T, bstr_wia_device_i_d_: ?BSTR, hwnd_parent_: ?HWND, b_stretch_to_fit_parent_: BOOL, b_auto_begin_playback_: BOOL) HRESULT {
                return @as(*const IWiaVideo.VTable, @ptrCast(self.vtable)).CreateVideoByWiaDevID(@as(*const IWiaVideo, @ptrCast(self)), bstr_wia_device_i_d_, hwnd_parent_, b_stretch_to_fit_parent_, b_auto_begin_playback_);
            }
            pub inline fn createVideoByDevNum(self: *const T, ui_device_number_: u32, hwnd_parent_: ?HWND, b_stretch_to_fit_parent_: BOOL, b_auto_begin_playback_: BOOL) HRESULT {
                return @as(*const IWiaVideo.VTable, @ptrCast(self.vtable)).CreateVideoByDevNum(@as(*const IWiaVideo, @ptrCast(self)), ui_device_number_, hwnd_parent_, b_stretch_to_fit_parent_, b_auto_begin_playback_);
            }
            pub inline fn createVideoByName(self: *const T, bstr_friendly_name_: ?BSTR, hwnd_parent_: ?HWND, b_stretch_to_fit_parent_: BOOL, b_auto_begin_playback_: BOOL) HRESULT {
                return @as(*const IWiaVideo.VTable, @ptrCast(self.vtable)).CreateVideoByName(@as(*const IWiaVideo, @ptrCast(self)), bstr_friendly_name_, hwnd_parent_, b_stretch_to_fit_parent_, b_auto_begin_playback_);
            }
            pub inline fn destroyVideo(self: *const T) HRESULT {
            ...
            pub inline fn takePicture(self: *const T, pbstr_new_image_filename_: ?*?BSTR) HRESULT {
                return @as(*const IWiaVideo.VTable, @ptrCast(self.vtable)).TakePicture(@as(*const IWiaVideo, @ptrCast(self)), pbstr_new_image_filename_);
            }
            pub inline fn resizeVideo(self: *const T, b_stretch_to_fit_parent_: BOOL) HRESULT {
                return @as(*const IWiaVideo.VTable, @ptrCast(self.vtable)).ResizeVideo(@as(*const IWiaVideo, @ptrCast(self)), b_stretch_to_fit_parent_);
            }
            pub inline fn getCurrentState(self: *const T, p_state_: ?*WIAVIDEO_STATE) HRESULT {
                return @as(*const IWiaVideo.VTable, @ptrCast(self.vtable)).GetCurrentState(@as(*const IWiaVideo, @ptrCast(self)), p_state_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWiaUIExtension2 = extern struct {
    pub const VTable = extern struct {
        ...
        DeviceDialog: *const fn (
            ...
            p_device_dialog_data: ?*DEVICEDIALOGDATA2,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn deviceDialog(self: *const T, p_device_dialog_data_: ?*DEVICEDIALOGDATA2) HRESULT {
                return @as(*const IWiaUIExtension2.VTable, @ptrCast(self.vtable)).DeviceDialog(@as(*const IWiaUIExtension2, @ptrCast(self)), p_device_dialog_data_);
            }
            pub inline fn getDeviceIcon(self: *const T, bstr_device_id_: ?BSTR, ph_icon_: ?*?HICON, n_size_: u32) HRESULT {
                return @as(*const IWiaUIExtension2.VTable, @ptrCast(self.vtable)).GetDeviceIcon(@as(*const IWiaUIExtension2, @ptrCast(self)), bstr_device_id_, ph_icon_, n_size_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWiaUIExtension = extern struct {
    pub const VTable = extern struct {
        ...
        DeviceDialog: *const fn (
            ...
            p_device_dialog_data: ?*DEVICEDIALOGDATA,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetDeviceIcon: *const fn (
            self: *const IWiaUIExtension,
            bstr_device_id: ?BSTR,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn deviceDialog(self: *const T, p_device_dialog_data_: ?*DEVICEDIALOGDATA) HRESULT {
                return @as(*const IWiaUIExtension.VTable, @ptrCast(self.vtable)).DeviceDialog(@as(*const IWiaUIExtension, @ptrCast(self)), p_device_dialog_data_);
            }
            pub inline fn getDeviceIcon(self: *const T, bstr_device_id_: ?BSTR, ph_icon_: ?*?HICON, n_size_: u32) HRESULT {
                return @as(*const IWiaUIExtension.VTable, @ptrCast(self.vtable)).GetDeviceIcon(@as(*const IWiaUIExtension, @ptrCast(self)), bstr_device_id_, ph_icon_, n_size_);
            }
            pub inline fn getDeviceBitmapLogo(self: *const T, bstr_device_id_: ?BSTR, ph_bitmap_: ?*?HBITMAP, n_max_width_: u32, n_max_height_: u32) HRESULT {
                return @as(*const IWiaUIExtension.VTable, @ptrCast(self.vtable)).GetDeviceBitmapLogo(@as(*const IWiaUIExtension, @ptrCast(self)), bstr_device_id_, ph_bitmap_, n_max_width_, n_max_height_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
