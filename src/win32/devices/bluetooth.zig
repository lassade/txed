...
pub const PFN_DEVICE_CALLBACK = *const fn (
    pv_param: ?*anyopaque,
    p_device: ?*const BLUETOOTH_DEVICE_INFO,
...
pub const PFN_AUTHENTICATION_CALLBACK = *const fn (
    pv_param: ?*anyopaque,
    p_device: ?*BLUETOOTH_DEVICE_INFO,
) callconv(@import("std").os.windows.WINAPI) BOOL;

pub const PFN_AUTHENTICATION_CALLBACK_EX = *const fn (
    pv_param: ?*anyopaque,
    p_auth_callback_params: ?*BLUETOOTH_AUTHENTICATION_CALLBACK_PARAMS,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "bluetoothapis" fn BluetoothGetRadioInfo(
    h_radio: ?HANDLE,
    p_radio_info: ?*BLUETOOTH_RADIO_INFO,
...
pub extern "bluetoothapis" fn BluetoothRemoveDevice(
    p_address: ?*const BLUETOOTH_ADDRESS,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "bthprops.cpl" fn BluetoothAuthenticateDeviceEx(
    hwnd_parent_in: ?HWND,
    h_radio_in: ?HANDLE,
    pbtdi_inout: ?*BLUETOOTH_DEVICE_INFO,
    pbt_oob_data: ?*BLUETOOTH_OOB_DATA_INFO,
    authentication_requirement: AUTHENTICATION_REQUIREMENTS,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "bluetoothapis" fn BluetoothEnumerateInstalledServices(
    h_radio: ?HANDLE,
    pbtdi: ?*const BLUETOOTH_DEVICE_INFO,
    pc_service_inout: ?*u32,
    p_guid_services: ?[*]Guid,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "bluetoothapis" fn BluetoothRegisterForAuthentication(
    pbtdi: ?*const BLUETOOTH_DEVICE_INFO,
    ph_reg_handle: ?*isize,
    pfn_callback: ?PFN_AUTHENTICATION_CALLBACK,
    pv_param: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "bluetoothapis" fn BluetoothRegisterForAuthenticationEx(
    pbtdi_in: ?*const BLUETOOTH_DEVICE_INFO,
    ph_reg_handle_out: ?*isize,
    pfn_callback_in: ?PFN_AUTHENTICATION_CALLBACK_EX,
    pv_param: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "bluetoothapis" fn BluetoothSendAuthenticationResponse(
    h_radio: ?HANDLE,
    pbtdi: ?*const BLUETOOTH_DEVICE_INFO,
    psz_passkey: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "bluetoothapis" fn BluetoothSendAuthenticationResponseEx(
    h_radio_in: ?HANDLE,
    pauth_response: ?*BLUETOOTH_AUTHENTICATE_RESPONSE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "bluetoothapis" fn BluetoothSdpGetElementData(
    ...
    p_sdp_stream: ?*u8,
    cb_sdp_stream_length: u32,
    p_data: ?*SDP_ELEMENT_DATA,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "bluetoothapis" fn BluetoothSdpGetContainerElementData(
    // TODO: what to do with BytesParamIndex 1?
    p_container_stream: ?*u8,
    cb_container_length: u32,
    p_element: ?*isize,
    p_data: ?*SDP_ELEMENT_DATA,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "bluetoothapis" fn BluetoothSdpGetAttributeValue(
    // TODO: what to do with BytesParamIndex 1?
    p_record_stream: ?*u8,
    cb_record_length: u32,
    us_attribute_id: u16,
    p_attribute_data: ?*SDP_ELEMENT_DATA,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "bluetoothapis" fn BluetoothSdpGetString(
    ...
    p_record_stream: ?*u8,
    cb_record_length: u32,
    p_string_data: ?*const SDP_STRING_TYPE_DATA,
    us_string_offset: u16,
    psz_string: [*:0]u16,
    pcch_string_length: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "bluetoothapis" fn BluetoothSdpEnumAttributes(
    ...
    p_s_d_p_stream: ?*u8,
    cb_stream_size: u32,
    pfn_callback: ?PFN_BLUETOOTH_ENUM_ATTRIBUTES_CALLBACK,
    pv_param: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "bluetoothapis" fn BluetoothSetLocalServiceInfo(
    h_radio_in: ?HANDLE,
    p_class_guid: ?*const Guid,
    ul_instance: u32,
    p_service_info_in: ?*const BLUETOOTH_LOCAL_SERVICE_INFO,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "bluetoothapis" fn BluetoothGATTGetServices(
    h_device: ?HANDLE,
    services_buffer_count: u16,
    services_buffer: ?[*]BTH_LE_GATT_SERVICE,
    services_buffer_actual: ?*u16,
    flags: u32,
...
pub extern "bluetoothapis" fn BluetoothGATTGetIncludedServices(
    h_device: ?HANDLE,
    parent_service: ?*BTH_LE_GATT_SERVICE,
    included_services_buffer_count: u16,
    included_services_buffer: ?[*]BTH_LE_GATT_SERVICE,
    included_services_buffer_actual: ?*u16,
    flags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "bluetoothapis" fn BluetoothGATTGetCharacteristics(
    ...
    characteristics_buffer_count: u16,
    characteristics_buffer: ?[*]BTH_LE_GATT_CHARACTERISTIC,
    characteristics_buffer_actual: ?*u16,
    flags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "bluetoothapis" fn BluetoothGATTGetDescriptors(
    ...
    descriptors_buffer_count: u16,
    descriptors_buffer: ?[*]BTH_LE_GATT_DESCRIPTOR,
    descriptors_buffer_actual: ?*u16,
    flags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "bluetoothapis" fn BluetoothGATTGetCharacteristicValue(
    h_device: ?HANDLE,
    characteristic: ?*BTH_LE_GATT_CHARACTERISTIC,
    characteristic_value_data_size: u32,
    characteristic_value: ?*BTH_LE_GATT_CHARACTERISTIC_VALUE,
    characteristic_value_size_required: ?*u16,
    flags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "bluetoothapis" fn BluetoothGATTGetDescriptorValue(
    ...
    descriptor_value_data_size: u32,
    descriptor_value: ?*BTH_LE_GATT_DESCRIPTOR_VALUE,
    descriptor_value_size_required: ?*u16,
    flags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "bluetoothapis" fn BluetoothGATTRegisterEvent(
    h_service: ?HANDLE,
    event_type: BTH_LE_GATT_EVENT_TYPE,
    event_parameter_in: ?*anyopaque,
    callback: ?PFNBLUETOOTH_GATT_EVENT_CALLBACK,
    callback_context: ?*anyopaque,
    p_event_handle: ?*isize,
    flags: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
