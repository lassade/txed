...
pub const IWpdSerializer = extern struct {
    pub const VTable = extern struct {
        ...
        GetIPortableDeviceValuesFromBuffer: *const fn (
            ...
            p_buffer: [*:0]u8,
            dw_input_buffer_length: u32,
            pp_params: ?*?*IPortableDeviceValues,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        WriteIPortableDeviceValuesToBuffer: *const fn (
            self: *const IWpdSerializer,
            dw_output_buffer_length: u32,
            p_results: ?*IPortableDeviceValues,
            p_buffer: [*:0]u8,
            pdw_bytes_written: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetBufferFromIPortableDeviceValues: *const fn (
            self: *const IWpdSerializer,
            p_source: ?*IPortableDeviceValues,
            pp_buffer: [*]?*u8,
            pdw_buffer_size: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getIPortableDeviceValuesFromBuffer(self: *const T, p_buffer_: [*:0]u8, dw_input_buffer_length_: u32, pp_params_: ?*?*IPortableDeviceValues) HRESULT {
                return @as(*const IWpdSerializer.VTable, @ptrCast(self.vtable)).GetIPortableDeviceValuesFromBuffer(@as(*const IWpdSerializer, @ptrCast(self)), p_buffer_, dw_input_buffer_length_, pp_params_);
            }
            pub inline fn writeIPortableDeviceValuesToBuffer(self: *const T, dw_output_buffer_length_: u32, p_results_: ?*IPortableDeviceValues, p_buffer_: [*:0]u8, pdw_bytes_written_: ?*u32) HRESULT {
                return @as(*const IWpdSerializer.VTable, @ptrCast(self.vtable)).WriteIPortableDeviceValuesToBuffer(@as(*const IWpdSerializer, @ptrCast(self)), dw_output_buffer_length_, p_results_, p_buffer_, pdw_bytes_written_);
            }
            pub inline fn getBufferFromIPortableDeviceValues(self: *const T, p_source_: ?*IPortableDeviceValues, pp_buffer_: [*]?*u8, pdw_buffer_size_: ?*u32) HRESULT {
                return @as(*const IWpdSerializer.VTable, @ptrCast(self.vtable)).GetBufferFromIPortableDeviceValues(@as(*const IWpdSerializer, @ptrCast(self)), p_source_, pp_buffer_, pdw_buffer_size_);
            }
            pub inline fn getSerializedSize(self: *const T, p_source_: ?*IPortableDeviceValues, pdw_size_: ?*u32) HRESULT {
                return @as(*const IWpdSerializer.VTable, @ptrCast(self.vtable)).GetSerializedSize(@as(*const IWpdSerializer, @ptrCast(self)), p_source_, pdw_size_);
            }
        };
    }
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getCount(self: *const T, pcelt_: ?*u32) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).GetCount(@as(*const IPortableDeviceValues, @ptrCast(self)), pcelt_);
            }
            pub inline fn getAt(self: *const T, index_: u32, p_key_: ?*PROPERTYKEY, p_value_: ?*PROPVARIANT) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).GetAt(@as(*const IPortableDeviceValues, @ptrCast(self)), index_, p_key_, p_value_);
            }
            pub inline fn setValue(self: *const T, key_: ?*const PROPERTYKEY, p_value_: ?*const PROPVARIANT) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).SetValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, p_value_);
            }
            pub inline fn getValue(self: *const T, key_: ?*const PROPERTYKEY, p_value_: ?*PROPVARIANT) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).GetValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, p_value_);
            }
            pub inline fn setStringValue(self: *const T, key_: ?*const PROPERTYKEY, value_: ?[*:0]const u16) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).SetStringValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, value_);
            }
            pub inline fn getStringValue(self: *const T, key_: ?*const PROPERTYKEY, p_value_: ?*?PWSTR) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).GetStringValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, p_value_);
            }
            pub inline fn setUnsignedIntegerValue(self: *const T, key_: ?*const PROPERTYKEY, value_: u32) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).SetUnsignedIntegerValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, value_);
            }
            pub inline fn getUnsignedIntegerValue(self: *const T, key_: ?*const PROPERTYKEY, p_value_: ?*u32) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).GetUnsignedIntegerValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, p_value_);
            }
            pub inline fn setSignedIntegerValue(self: *const T, key_: ?*const PROPERTYKEY, value_: i32) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).SetSignedIntegerValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, value_);
            }
            pub inline fn getSignedIntegerValue(self: *const T, key_: ?*const PROPERTYKEY, p_value_: ?*i32) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).GetSignedIntegerValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, p_value_);
            }
            pub inline fn setUnsignedLargeIntegerValue(self: *const T, key_: ?*const PROPERTYKEY, value_: u64) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).SetUnsignedLargeIntegerValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, value_);
            }
            pub inline fn getUnsignedLargeIntegerValue(self: *const T, key_: ?*const PROPERTYKEY, p_value_: ?*u64) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).GetUnsignedLargeIntegerValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, p_value_);
            }
            pub inline fn setSignedLargeIntegerValue(self: *const T, key_: ?*const PROPERTYKEY, value_: i64) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).SetSignedLargeIntegerValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, value_);
            }
            pub inline fn getSignedLargeIntegerValue(self: *const T, key_: ?*const PROPERTYKEY, p_value_: ?*i64) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).GetSignedLargeIntegerValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, p_value_);
            }
            pub inline fn setFloatValue(self: *const T, key_: ?*const PROPERTYKEY, value_: f32) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).SetFloatValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, value_);
            }
            pub inline fn getFloatValue(self: *const T, key_: ?*const PROPERTYKEY, p_value_: ?*f32) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).GetFloatValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, p_value_);
            }
            pub inline fn setErrorValue(self: *const T, key_: ?*const PROPERTYKEY, value_: HRESULT) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).SetErrorValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, value_);
            }
            pub inline fn getErrorValue(self: *const T, key_: ?*const PROPERTYKEY, p_value_: ?*HRESULT) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).GetErrorValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, p_value_);
            }
            pub inline fn setKeyValue(self: *const T, key_: ?*const PROPERTYKEY, value_: ?*const PROPERTYKEY) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).SetKeyValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, value_);
            }
            pub inline fn getKeyValue(self: *const T, key_: ?*const PROPERTYKEY, p_value_: ?*PROPERTYKEY) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).GetKeyValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, p_value_);
            }
            pub inline fn setBoolValue(self: *const T, key_: ?*const PROPERTYKEY, value_: BOOL) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).SetBoolValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, value_);
            }
            pub inline fn getBoolValue(self: *const T, key_: ?*const PROPERTYKEY, p_value_: ?*BOOL) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).GetBoolValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, p_value_);
            }
            pub inline fn setIUnknownValue(self: *const T, key_: ?*const PROPERTYKEY, p_value_: ?*IUnknown) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).SetIUnknownValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, p_value_);
            }
            pub inline fn getIUnknownValue(self: *const T, key_: ?*const PROPERTYKEY, pp_value_: ?*?*IUnknown) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).GetIUnknownValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, pp_value_);
            }
            pub inline fn setGuidValue(self: *const T, key_: ?*const PROPERTYKEY, value_: ?*const Guid) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).SetGuidValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, value_);
            }
            pub inline fn getGuidValue(self: *const T, key_: ?*const PROPERTYKEY, p_value_: ?*Guid) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).GetGuidValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, p_value_);
            }
            pub inline fn setBufferValue(self: *const T, key_: ?*const PROPERTYKEY, p_value_: [*:0]u8, cb_value_: u32) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).SetBufferValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, p_value_, cb_value_);
            }
            pub inline fn getBufferValue(self: *const T, key_: ?*const PROPERTYKEY, pp_value_: [*]?*u8, pcb_value_: ?*u32) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).GetBufferValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, pp_value_, pcb_value_);
            }
            pub inline fn setIPortableDeviceValuesValue(self: *const T, key_: ?*const PROPERTYKEY, p_value_: ?*IPortableDeviceValues) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).SetIPortableDeviceValuesValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, p_value_);
            }
            pub inline fn getIPortableDeviceValuesValue(self: *const T, key_: ?*const PROPERTYKEY, pp_value_: ?*?*IPortableDeviceValues) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).GetIPortableDeviceValuesValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, pp_value_);
            }
            pub inline fn setIPortableDevicePropVariantCollectionValue(self: *const T, key_: ?*const PROPERTYKEY, p_value_: ?*IPortableDevicePropVariantCollection) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).SetIPortableDevicePropVariantCollectionValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, p_value_);
            }
            pub inline fn getIPortableDevicePropVariantCollectionValue(self: *const T, key_: ?*const PROPERTYKEY, pp_value_: ?*?*IPortableDevicePropVariantCollection) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).GetIPortableDevicePropVariantCollectionValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, pp_value_);
            }
            pub inline fn setIPortableDeviceKeyCollectionValue(self: *const T, key_: ?*const PROPERTYKEY, p_value_: ?*IPortableDeviceKeyCollection) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).SetIPortableDeviceKeyCollectionValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, p_value_);
            }
            pub inline fn getIPortableDeviceKeyCollectionValue(self: *const T, key_: ?*const PROPERTYKEY, pp_value_: ?*?*IPortableDeviceKeyCollection) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).GetIPortableDeviceKeyCollectionValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, pp_value_);
            }
            pub inline fn setIPortableDeviceValuesCollectionValue(self: *const T, key_: ?*const PROPERTYKEY, p_value_: ?*IPortableDeviceValuesCollection) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).SetIPortableDeviceValuesCollectionValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, p_value_);
            }
            pub inline fn getIPortableDeviceValuesCollectionValue(self: *const T, key_: ?*const PROPERTYKEY, pp_value_: ?*?*IPortableDeviceValuesCollection) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).GetIPortableDeviceValuesCollectionValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_, pp_value_);
            }
            pub inline fn removeValue(self: *const T, key_: ?*const PROPERTYKEY) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).RemoveValue(@as(*const IPortableDeviceValues, @ptrCast(self)), key_);
            }
            pub inline fn copyValuesFromPropertyStore(self: *const T, p_store_: ?*IPropertyStore) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).CopyValuesFromPropertyStore(@as(*const IPortableDeviceValues, @ptrCast(self)), p_store_);
            }
            pub inline fn copyValuesToPropertyStore(self: *const T, p_store_: ?*IPropertyStore) HRESULT {
                return @as(*const IPortableDeviceValues.VTable, @ptrCast(self.vtable)).CopyValuesToPropertyStore(@as(*const IPortableDeviceValues, @ptrCast(self)), p_store_);
            }
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getCount(self: *const T, pc_elems_: ?*u32) HRESULT {
                return @as(*const IPortableDeviceKeyCollection.VTable, @ptrCast(self.vtable)).GetCount(@as(*const IPortableDeviceKeyCollection, @ptrCast(self)), pc_elems_);
            }
            pub inline fn getAt(self: *const T, dw_index_: u32, p_key_: ?*PROPERTYKEY) HRESULT {
                return @as(*const IPortableDeviceKeyCollection.VTable, @ptrCast(self.vtable)).GetAt(@as(*const IPortableDeviceKeyCollection, @ptrCast(self)), dw_index_, p_key_);
            }
            pub inline fn add(self: *const T, key_: ?*const PROPERTYKEY) HRESULT {
                return @as(*const IPortableDeviceKeyCollection.VTable, @ptrCast(self.vtable)).Add(@as(*const IPortableDeviceKeyCollection, @ptrCast(self)), key_);
            }
            pub inline fn clear(self: *const T) HRESULT {
            ...
            pub inline fn removeAt(self: *const T, dw_index_: u32) HRESULT {
                return @as(*const IPortableDeviceKeyCollection.VTable, @ptrCast(self.vtable)).RemoveAt(@as(*const IPortableDeviceKeyCollection, @ptrCast(self)), dw_index_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IPortableDevicePropVariantCollection = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getCount(self: *const T, pc_elems_: ?*u32) HRESULT {
                return @as(*const IPortableDevicePropVariantCollection.VTable, @ptrCast(self.vtable)).GetCount(@as(*const IPortableDevicePropVariantCollection, @ptrCast(self)), pc_elems_);
            }
            pub inline fn getAt(self: *const T, dw_index_: u32, p_value_: ?*PROPVARIANT) HRESULT {
                return @as(*const IPortableDevicePropVariantCollection.VTable, @ptrCast(self.vtable)).GetAt(@as(*const IPortableDevicePropVariantCollection, @ptrCast(self)), dw_index_, p_value_);
            }
            pub inline fn add(self: *const T, p_value_: ?*const PROPVARIANT) HRESULT {
                return @as(*const IPortableDevicePropVariantCollection.VTable, @ptrCast(self.vtable)).Add(@as(*const IPortableDevicePropVariantCollection, @ptrCast(self)), p_value_);
            }
            pub inline fn getType(self: *const T, pvt_: ?*u16) HRESULT {
                return @as(*const IPortableDevicePropVariantCollection.VTable, @ptrCast(self.vtable)).GetType(@as(*const IPortableDevicePropVariantCollection, @ptrCast(self)), pvt_);
            }
            pub inline fn changeType(self: *const T, vt_: u16) HRESULT {
                return @as(*const IPortableDevicePropVariantCollection.VTable, @ptrCast(self.vtable)).ChangeType(@as(*const IPortableDevicePropVariantCollection, @ptrCast(self)), vt_);
            }
            pub inline fn clear(self: *const T) HRESULT {
            ...
            pub inline fn removeAt(self: *const T, dw_index_: u32) HRESULT {
                return @as(*const IPortableDevicePropVariantCollection.VTable, @ptrCast(self.vtable)).RemoveAt(@as(*const IPortableDevicePropVariantCollection, @ptrCast(self)), dw_index_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IPortableDeviceValuesCollection = extern struct {
    pub const VTable = extern struct {
        ...
        GetAt: *const fn (
            self: *const IPortableDeviceValuesCollection,
            dw_index: u32,
            pp_values: ?*?*IPortableDeviceValues,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Add: *const fn (
            self: *const IPortableDeviceValuesCollection,
            p_values: ?*IPortableDeviceValues,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Clear: *const fn (
            self: *const IPortableDeviceValuesCollection,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getCount(self: *const T, pc_elems_: ?*u32) HRESULT {
                return @as(*const IPortableDeviceValuesCollection.VTable, @ptrCast(self.vtable)).GetCount(@as(*const IPortableDeviceValuesCollection, @ptrCast(self)), pc_elems_);
            }
            pub inline fn getAt(self: *const T, dw_index_: u32, pp_values_: ?*?*IPortableDeviceValues) HRESULT {
                return @as(*const IPortableDeviceValuesCollection.VTable, @ptrCast(self.vtable)).GetAt(@as(*const IPortableDeviceValuesCollection, @ptrCast(self)), dw_index_, pp_values_);
            }
            pub inline fn add(self: *const T, p_values_: ?*IPortableDeviceValues) HRESULT {
                return @as(*const IPortableDeviceValuesCollection.VTable, @ptrCast(self.vtable)).Add(@as(*const IPortableDeviceValuesCollection, @ptrCast(self)), p_values_);
            }
            pub inline fn clear(self: *const T) HRESULT {
            ...
            pub inline fn removeAt(self: *const T, dw_index_: u32) HRESULT {
                return @as(*const IPortableDeviceValuesCollection.VTable, @ptrCast(self.vtable)).RemoveAt(@as(*const IPortableDeviceValuesCollection, @ptrCast(self)), dw_index_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IPortableDeviceManager = extern struct {
    pub const VTable = extern struct {
        ...
        GetDevices: *const fn (
            ...
            p_pn_p_device_i_ds: ?*?PWSTR,
            pc_pn_p_device_i_ds: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        GetDeviceFriendlyName: *const fn (
            self: *const IPortableDeviceManager,
            psz_pn_p_device_i_d: ?[*:0]const u16,
            p_device_friendly_name: ?PWSTR,
            pcch_device_friendly_name: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetDeviceDescription: *const fn (
            self: *const IPortableDeviceManager,
            psz_pn_p_device_i_d: ?[*:0]const u16,
            p_device_description: ?PWSTR,
            pcch_device_description: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetDeviceManufacturer: *const fn (
            self: *const IPortableDeviceManager,
            psz_pn_p_device_i_d: ?[*:0]const u16,
            p_device_manufacturer: ?PWSTR,
            pcch_device_manufacturer: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetDeviceProperty: *const fn (
            self: *const IPortableDeviceManager,
            psz_pn_p_device_i_d: ?[*:0]const u16,
            psz_device_property_name: ?[*:0]const u16,
            p_data: ?*u8,
            pcb_data: ?*u32,
            pdw_type: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getDevices(self: *const T, p_pn_p_device_i_ds_: ?*?PWSTR, pc_pn_p_device_i_ds_: ?*u32) HRESULT {
                return @as(*const IPortableDeviceManager.VTable, @ptrCast(self.vtable)).GetDevices(@as(*const IPortableDeviceManager, @ptrCast(self)), p_pn_p_device_i_ds_, pc_pn_p_device_i_ds_);
            }
            pub inline fn refreshDeviceList(self: *const T) HRESULT {
            ...
            pub inline fn getDeviceFriendlyName(self: *const T, psz_pn_p_device_i_d_: ?[*:0]const u16, p_device_friendly_name_: ?PWSTR, pcch_device_friendly_name_: ?*u32) HRESULT {
                return @as(*const IPortableDeviceManager.VTable, @ptrCast(self.vtable)).GetDeviceFriendlyName(@as(*const IPortableDeviceManager, @ptrCast(self)), psz_pn_p_device_i_d_, p_device_friendly_name_, pcch_device_friendly_name_);
            }
            pub inline fn getDeviceDescription(self: *const T, psz_pn_p_device_i_d_: ?[*:0]const u16, p_device_description_: ?PWSTR, pcch_device_description_: ?*u32) HRESULT {
                return @as(*const IPortableDeviceManager.VTable, @ptrCast(self.vtable)).GetDeviceDescription(@as(*const IPortableDeviceManager, @ptrCast(self)), psz_pn_p_device_i_d_, p_device_description_, pcch_device_description_);
            }
            pub inline fn getDeviceManufacturer(self: *const T, psz_pn_p_device_i_d_: ?[*:0]const u16, p_device_manufacturer_: ?PWSTR, pcch_device_manufacturer_: ?*u32) HRESULT {
                return @as(*const IPortableDeviceManager.VTable, @ptrCast(self.vtable)).GetDeviceManufacturer(@as(*const IPortableDeviceManager, @ptrCast(self)), psz_pn_p_device_i_d_, p_device_manufacturer_, pcch_device_manufacturer_);
            }
            pub inline fn getDeviceProperty(self: *const T, psz_pn_p_device_i_d_: ?[*:0]const u16, psz_device_property_name_: ?[*:0]const u16, p_data_: ?*u8, pcb_data_: ?*u32, pdw_type_: ?*u32) HRESULT {
                return @as(*const IPortableDeviceManager.VTable, @ptrCast(self.vtable)).GetDeviceProperty(@as(*const IPortableDeviceManager, @ptrCast(self)), psz_pn_p_device_i_d_, psz_device_property_name_, p_data_, pcb_data_, pdw_type_);
            }
            pub inline fn getPrivateDevices(self: *const T, p_pn_p_device_i_ds_: ?*?PWSTR, pc_pn_p_device_i_ds_: ?*u32) HRESULT {
                return @as(*const IPortableDeviceManager.VTable, @ptrCast(self.vtable)).GetPrivateDevices(@as(*const IPortableDeviceManager, @ptrCast(self)), p_pn_p_device_i_ds_, pc_pn_p_device_i_ds_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IPortableDevice = extern struct {
    pub const VTable = extern struct {
        ...
        Open: *const fn (
            ...
            psz_pn_p_device_i_d: ?[*:0]const u16,
            p_client_info: ?*IPortableDeviceValues,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        SendCommand: *const fn (
            self: *const IPortableDevice,
            dw_flags: u32,
            p_parameters: ?*IPortableDeviceValues,
            pp_results: ?*?*IPortableDeviceValues,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Content: *const fn (
            self: *const IPortableDevice,
            pp_content: ?*?*IPortableDeviceContent,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Capabilities: *const fn (
            self: *const IPortableDevice,
            pp_capabilities: ?*?*IPortableDeviceCapabilities,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Cancel: *const fn (
            self: *const IPortableDevice,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        Advise: *const fn (
            self: *const IPortableDevice,
            dw_flags: u32,
            p_callback: ?*IPortableDeviceEventCallback,
            p_parameters: ?*IPortableDeviceValues,
            ppsz_cookie: ?*?PWSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Unadvise: *const fn (
            self: *const IPortableDevice,
            psz_cookie: ?[*:0]const u16,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetPnPDeviceID: *const fn (
            self: *const IPortableDevice,
            ppsz_pn_p_device_i_d: ?*?PWSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn open(self: *const T, psz_pn_p_device_i_d_: ?[*:0]const u16, p_client_info_: ?*IPortableDeviceValues) HRESULT {
                return @as(*const IPortableDevice.VTable, @ptrCast(self.vtable)).Open(@as(*const IPortableDevice, @ptrCast(self)), psz_pn_p_device_i_d_, p_client_info_);
            }
            pub inline fn sendCommand(self: *const T, dw_flags_: u32, p_parameters_: ?*IPortableDeviceValues, pp_results_: ?*?*IPortableDeviceValues) HRESULT {
                return @as(*const IPortableDevice.VTable, @ptrCast(self.vtable)).SendCommand(@as(*const IPortableDevice, @ptrCast(self)), dw_flags_, p_parameters_, pp_results_);
            }
            pub inline fn content(self: *const T, pp_content_: ?*?*IPortableDeviceContent) HRESULT {
                return @as(*const IPortableDevice.VTable, @ptrCast(self.vtable)).Content(@as(*const IPortableDevice, @ptrCast(self)), pp_content_);
            }
            pub inline fn capabilities(self: *const T, pp_capabilities_: ?*?*IPortableDeviceCapabilities) HRESULT {
                return @as(*const IPortableDevice.VTable, @ptrCast(self.vtable)).Capabilities(@as(*const IPortableDevice, @ptrCast(self)), pp_capabilities_);
            }
            ...
            pub inline fn advise(self: *const T, dw_flags_: u32, p_callback_: ?*IPortableDeviceEventCallback, p_parameters_: ?*IPortableDeviceValues, ppsz_cookie_: ?*?PWSTR) HRESULT {
                return @as(*const IPortableDevice.VTable, @ptrCast(self.vtable)).Advise(@as(*const IPortableDevice, @ptrCast(self)), dw_flags_, p_callback_, p_parameters_, ppsz_cookie_);
            }
            pub inline fn unadvise(self: *const T, psz_cookie_: ?[*:0]const u16) HRESULT {
                return @as(*const IPortableDevice.VTable, @ptrCast(self.vtable)).Unadvise(@as(*const IPortableDevice, @ptrCast(self)), psz_cookie_);
            }
            pub inline fn getPnPDeviceID(self: *const T, ppsz_pn_p_device_i_d_: ?*?PWSTR) HRESULT {
                return @as(*const IPortableDevice.VTable, @ptrCast(self.vtable)).GetPnPDeviceID(@as(*const IPortableDevice, @ptrCast(self)), ppsz_pn_p_device_i_d_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IPortableDeviceContent = extern struct {
    pub const VTable = extern struct {
        ...
        EnumObjects: *const fn (
            ...
            dw_flags: u32,
            psz_parent_object_i_d: ?[*:0]const u16,
            p_filter: ?*IPortableDeviceValues,
            pp_enum: ?*?*IEnumPortableDeviceObjectIDs,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Properties: *const fn (
            self: *const IPortableDeviceContent,
            pp_properties: ?*?*IPortableDeviceProperties,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Transfer: *const fn (
            self: *const IPortableDeviceContent,
            pp_resources: ?*?*IPortableDeviceResources,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        CreateObjectWithPropertiesOnly: *const fn (
            self: *const IPortableDeviceContent,
            p_values: ?*IPortableDeviceValues,
            ppsz_object_i_d: ?*?PWSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        CreateObjectWithPropertiesAndData: *const fn (
            self: *const IPortableDeviceContent,
            p_values: ?*IPortableDeviceValues,
            pp_data: ?*?*IStream,
            pdw_optimal_write_buffer_size: ?*u32,
            ppsz_cookie: ?*?PWSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Delete: *const fn (
            self: *const IPortableDeviceContent,
            dw_options: u32,
            p_object_i_ds: ?*IPortableDevicePropVariantCollection,
            pp_results: ?*?*IPortableDevicePropVariantCollection,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetObjectIDsFromPersistentUniqueIDs: *const fn (
            self: *const IPortableDeviceContent,
            p_persistent_unique_i_ds: ?*IPortableDevicePropVariantCollection,
            pp_object_i_ds: ?*?*IPortableDevicePropVariantCollection,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Cancel: *const fn (
            self: *const IPortableDeviceContent,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Move: *const fn (
            self: *const IPortableDeviceContent,
            p_object_i_ds: ?*IPortableDevicePropVariantCollection,
            psz_destination_folder_object_i_d: ?[*:0]const u16,
            pp_results: ?*?*IPortableDevicePropVariantCollection,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Copy: *const fn (
            self: *const IPortableDeviceContent,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn enumObjects(self: *const T, dw_flags_: u32, psz_parent_object_i_d_: ?[*:0]const u16, p_filter_: ?*IPortableDeviceValues, pp_enum_: ?*?*IEnumPortableDeviceObjectIDs) HRESULT {
                return @as(*const IPortableDeviceContent.VTable, @ptrCast(self.vtable)).EnumObjects(@as(*const IPortableDeviceContent, @ptrCast(self)), dw_flags_, psz_parent_object_i_d_, p_filter_, pp_enum_);
            }
            pub inline fn properties(self: *const T, pp_properties_: ?*?*IPortableDeviceProperties) HRESULT {
                return @as(*const IPortableDeviceContent.VTable, @ptrCast(self.vtable)).Properties(@as(*const IPortableDeviceContent, @ptrCast(self)), pp_properties_);
            }
            pub inline fn transfer(self: *const T, pp_resources_: ?*?*IPortableDeviceResources) HRESULT {
                return @as(*const IPortableDeviceContent.VTable, @ptrCast(self.vtable)).Transfer(@as(*const IPortableDeviceContent, @ptrCast(self)), pp_resources_);
            }
            pub inline fn createObjectWithPropertiesOnly(self: *const T, p_values_: ?*IPortableDeviceValues, ppsz_object_i_d_: ?*?PWSTR) HRESULT {
                return @as(*const IPortableDeviceContent.VTable, @ptrCast(self.vtable)).CreateObjectWithPropertiesOnly(@as(*const IPortableDeviceContent, @ptrCast(self)), p_values_, ppsz_object_i_d_);
            }
            pub inline fn createObjectWithPropertiesAndData(self: *const T, p_values_: ?*IPortableDeviceValues, pp_data_: ?*?*IStream, pdw_optimal_write_buffer_size_: ?*u32, ppsz_cookie_: ?*?PWSTR) HRESULT {
                return @as(*const IPortableDeviceContent.VTable, @ptrCast(self.vtable)).CreateObjectWithPropertiesAndData(@as(*const IPortableDeviceContent, @ptrCast(self)), p_values_, pp_data_, pdw_optimal_write_buffer_size_, ppsz_cookie_);
            }
            pub inline fn delete(self: *const T, dw_options_: u32, p_object_i_ds_: ?*IPortableDevicePropVariantCollection, pp_results_: ?*?*IPortableDevicePropVariantCollection) HRESULT {
                return @as(*const IPortableDeviceContent.VTable, @ptrCast(self.vtable)).Delete(@as(*const IPortableDeviceContent, @ptrCast(self)), dw_options_, p_object_i_ds_, pp_results_);
            }
            pub inline fn getObjectIDsFromPersistentUniqueIDs(self: *const T, p_persistent_unique_i_ds_: ?*IPortableDevicePropVariantCollection, pp_object_i_ds_: ?*?*IPortableDevicePropVariantCollection) HRESULT {
                return @as(*const IPortableDeviceContent.VTable, @ptrCast(self.vtable)).GetObjectIDsFromPersistentUniqueIDs(@as(*const IPortableDeviceContent, @ptrCast(self)), p_persistent_unique_i_ds_, pp_object_i_ds_);
            }
            pub inline fn cancel(self: *const T) HRESULT {
                return @as(*const IPortableDeviceContent.VTable, @ptrCast(self.vtable)).Cancel(@as(*const IPortableDeviceContent, @ptrCast(self)));
            }
            pub inline fn move(self: *const T, p_object_i_ds_: ?*IPortableDevicePropVariantCollection, psz_destination_folder_object_i_d_: ?[*:0]const u16, pp_results_: ?*?*IPortableDevicePropVariantCollection) HRESULT {
                return @as(*const IPortableDeviceContent.VTable, @ptrCast(self.vtable)).Move(@as(*const IPortableDeviceContent, @ptrCast(self)), p_object_i_ds_, psz_destination_folder_object_i_d_, pp_results_);
            }
            pub inline fn copy(self: *const T, p_object_i_ds_: ?*IPortableDevicePropVariantCollection, psz_destination_folder_object_i_d_: ?[*:0]const u16, pp_results_: ?*?*IPortableDevicePropVariantCollection) HRESULT {
                return @as(*const IPortableDeviceContent.VTable, @ptrCast(self.vtable)).Copy(@as(*const IPortableDeviceContent, @ptrCast(self)), p_object_i_ds_, psz_destination_folder_object_i_d_, pp_results_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IPortableDeviceContent2 = extern struct {
    pub const VTable = extern struct {
        ...
        UpdateObjectWithPropertiesAndData: *const fn (
            ...
            psz_object_i_d: ?[*:0]const u16,
            p_properties: ?*IPortableDeviceValues,
            pp_data: ?*?*IStream,
            pdw_optimal_write_buffer_size: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn updateObjectWithPropertiesAndData(self: *const T, psz_object_i_d_: ?[*:0]const u16, p_properties_: ?*IPortableDeviceValues, pp_data_: ?*?*IStream, pdw_optimal_write_buffer_size_: ?*u32) HRESULT {
                return @as(*const IPortableDeviceContent2.VTable, @ptrCast(self.vtable)).UpdateObjectWithPropertiesAndData(@as(*const IPortableDeviceContent2, @ptrCast(self)), psz_object_i_d_, p_properties_, pp_data_, pdw_optimal_write_buffer_size_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IEnumPortableDeviceObjectIDs = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn next(self: *const T, c_objects_: u32, p_obj_i_ds_: [*]?PWSTR, pc_fetched_: ?*u32) HRESULT {
                return @as(*const IEnumPortableDeviceObjectIDs.VTable, @ptrCast(self.vtable)).Next(@as(*const IEnumPortableDeviceObjectIDs, @ptrCast(self)), c_objects_, p_obj_i_ds_, pc_fetched_);
            }
            pub inline fn skip(self: *const T, c_objects_: u32) HRESULT {
                return @as(*const IEnumPortableDeviceObjectIDs.VTable, @ptrCast(self.vtable)).Skip(@as(*const IEnumPortableDeviceObjectIDs, @ptrCast(self)), c_objects_);
            }
            ...
            pub inline fn clone(self: *const T, pp_enum_: ?*?*IEnumPortableDeviceObjectIDs) HRESULT {
                return @as(*const IEnumPortableDeviceObjectIDs.VTable, @ptrCast(self.vtable)).Clone(@as(*const IEnumPortableDeviceObjectIDs, @ptrCast(self)), pp_enum_);
            }
            pub inline fn cancel(self: *const T) HRESULT {
...
pub const IPortableDeviceProperties = extern struct {
    pub const VTable = extern struct {
        ...
        GetSupportedProperties: *const fn (
            ...
            psz_object_i_d: ?[*:0]const u16,
            pp_keys: ?*?*IPortableDeviceKeyCollection,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetPropertyAttributes: *const fn (
            self: *const IPortableDeviceProperties,
            psz_object_i_d: ?[*:0]const u16,
            key: ?*const PROPERTYKEY,
            pp_attributes: ?*?*IPortableDeviceValues,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetValues: *const fn (
            self: *const IPortableDeviceProperties,
            psz_object_i_d: ?[*:0]const u16,
            p_keys: ?*IPortableDeviceKeyCollection,
            pp_values: ?*?*IPortableDeviceValues,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        SetValues: *const fn (
            self: *const IPortableDeviceProperties,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getSupportedProperties(self: *const T, psz_object_i_d_: ?[*:0]const u16, pp_keys_: ?*?*IPortableDeviceKeyCollection) HRESULT {
                return @as(*const IPortableDeviceProperties.VTable, @ptrCast(self.vtable)).GetSupportedProperties(@as(*const IPortableDeviceProperties, @ptrCast(self)), psz_object_i_d_, pp_keys_);
            }
            pub inline fn getPropertyAttributes(self: *const T, psz_object_i_d_: ?[*:0]const u16, key_: ?*const PROPERTYKEY, pp_attributes_: ?*?*IPortableDeviceValues) HRESULT {
                return @as(*const IPortableDeviceProperties.VTable, @ptrCast(self.vtable)).GetPropertyAttributes(@as(*const IPortableDeviceProperties, @ptrCast(self)), psz_object_i_d_, key_, pp_attributes_);
            }
            pub inline fn getValues(self: *const T, psz_object_i_d_: ?[*:0]const u16, p_keys_: ?*IPortableDeviceKeyCollection, pp_values_: ?*?*IPortableDeviceValues) HRESULT {
                return @as(*const IPortableDeviceProperties.VTable, @ptrCast(self.vtable)).GetValues(@as(*const IPortableDeviceProperties, @ptrCast(self)), psz_object_i_d_, p_keys_, pp_values_);
            }
            pub inline fn setValues(self: *const T, psz_object_i_d_: ?[*:0]const u16, p_values_: ?*IPortableDeviceValues, pp_results_: ?*?*IPortableDeviceValues) HRESULT {
                return @as(*const IPortableDeviceProperties.VTable, @ptrCast(self.vtable)).SetValues(@as(*const IPortableDeviceProperties, @ptrCast(self)), psz_object_i_d_, p_values_, pp_results_);
            }
            pub inline fn delete(self: *const T, psz_object_i_d_: ?[*:0]const u16, p_keys_: ?*IPortableDeviceKeyCollection) HRESULT {
                return @as(*const IPortableDeviceProperties.VTable, @ptrCast(self.vtable)).Delete(@as(*const IPortableDeviceProperties, @ptrCast(self)), psz_object_i_d_, p_keys_);
            }
            pub inline fn cancel(self: *const T) HRESULT {
...
pub const IPortableDeviceResources = extern struct {
    pub const VTable = extern struct {
        ...
        GetResourceAttributes: *const fn (
            ...
            psz_object_i_d: ?[*:0]const u16,
            key: ?*const PROPERTYKEY,
            pp_resource_attributes: ?*?*IPortableDeviceValues,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetStream: *const fn (
            self: *const IPortableDeviceResources,
            psz_object_i_d: ?[*:0]const u16,
        ...
        CreateResource: *const fn (
            self: *const IPortableDeviceResources,
            p_resource_attributes: ?*IPortableDeviceValues,
            pp_data: ?*?*IStream,
            pdw_optimal_write_buffer_size: ?*u32,
            ppsz_cookie: ?*?PWSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getSupportedResources(self: *const T, psz_object_i_d_: ?[*:0]const u16, pp_keys_: ?*?*IPortableDeviceKeyCollection) HRESULT {
                return @as(*const IPortableDeviceResources.VTable, @ptrCast(self.vtable)).GetSupportedResources(@as(*const IPortableDeviceResources, @ptrCast(self)), psz_object_i_d_, pp_keys_);
            }
            pub inline fn getResourceAttributes(self: *const T, psz_object_i_d_: ?[*:0]const u16, key_: ?*const PROPERTYKEY, pp_resource_attributes_: ?*?*IPortableDeviceValues) HRESULT {
                return @as(*const IPortableDeviceResources.VTable, @ptrCast(self.vtable)).GetResourceAttributes(@as(*const IPortableDeviceResources, @ptrCast(self)), psz_object_i_d_, key_, pp_resource_attributes_);
            }
            pub inline fn getStream(self: *const T, psz_object_i_d_: ?[*:0]const u16, key_: ?*const PROPERTYKEY, dw_mode_: u32, pdw_optimal_buffer_size_: ?*u32, pp_stream_: ?*?*IStream) HRESULT {
                return @as(*const IPortableDeviceResources.VTable, @ptrCast(self.vtable)).GetStream(@as(*const IPortableDeviceResources, @ptrCast(self)), psz_object_i_d_, key_, dw_mode_, pdw_optimal_buffer_size_, pp_stream_);
            }
            pub inline fn delete(self: *const T, psz_object_i_d_: ?[*:0]const u16, p_keys_: ?*IPortableDeviceKeyCollection) HRESULT {
                return @as(*const IPortableDeviceResources.VTable, @ptrCast(self.vtable)).Delete(@as(*const IPortableDeviceResources, @ptrCast(self)), psz_object_i_d_, p_keys_);
            }
            pub inline fn cancel(self: *const T) HRESULT {
            ...
            pub inline fn createResource(self: *const T, p_resource_attributes_: ?*IPortableDeviceValues, pp_data_: ?*?*IStream, pdw_optimal_write_buffer_size_: ?*u32, ppsz_cookie_: ?*?PWSTR) HRESULT {
                return @as(*const IPortableDeviceResources.VTable, @ptrCast(self.vtable)).CreateResource(@as(*const IPortableDeviceResources, @ptrCast(self)), p_resource_attributes_, pp_data_, pdw_optimal_write_buffer_size_, ppsz_cookie_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IPortableDeviceCapabilities = extern struct {
    pub const VTable = extern struct {
        ...
        GetSupportedCommands: *const fn (
            ...
            pp_commands: ?*?*IPortableDeviceKeyCollection,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetCommandOptions: *const fn (
            self: *const IPortableDeviceCapabilities,
            command: ?*const PROPERTYKEY,
            pp_options: ?*?*IPortableDeviceValues,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetFunctionalCategories: *const fn (
            self: *const IPortableDeviceCapabilities,
            pp_categories: ?*?*IPortableDevicePropVariantCollection,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        GetSupportedContentTypes: *const fn (
            self: *const IPortableDeviceCapabilities,
            category: ?*const Guid,
            pp_content_types: ?*?*IPortableDevicePropVariantCollection,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetSupportedFormats: *const fn (
            self: *const IPortableDeviceCapabilities,
            content_type: ?*const Guid,
            pp_formats: ?*?*IPortableDevicePropVariantCollection,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        GetSupportedEvents: *const fn (
            self: *const IPortableDeviceCapabilities,
            pp_events: ?*?*IPortableDevicePropVariantCollection,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getSupportedCommands(self: *const T, pp_commands_: ?*?*IPortableDeviceKeyCollection) HRESULT {
                return @as(*const IPortableDeviceCapabilities.VTable, @ptrCast(self.vtable)).GetSupportedCommands(@as(*const IPortableDeviceCapabilities, @ptrCast(self)), pp_commands_);
            }
            pub inline fn getCommandOptions(self: *const T, command_: ?*const PROPERTYKEY, pp_options_: ?*?*IPortableDeviceValues) HRESULT {
                return @as(*const IPortableDeviceCapabilities.VTable, @ptrCast(self.vtable)).GetCommandOptions(@as(*const IPortableDeviceCapabilities, @ptrCast(self)), command_, pp_options_);
            }
            pub inline fn getFunctionalCategories(self: *const T, pp_categories_: ?*?*IPortableDevicePropVariantCollection) HRESULT {
                return @as(*const IPortableDeviceCapabilities.VTable, @ptrCast(self.vtable)).GetFunctionalCategories(@as(*const IPortableDeviceCapabilities, @ptrCast(self)), pp_categories_);
            }
            pub inline fn getFunctionalObjects(self: *const T, category_: ?*const Guid, pp_object_i_ds_: ?*?*IPortableDevicePropVariantCollection) HRESULT {
                return @as(*const IPortableDeviceCapabilities.VTable, @ptrCast(self.vtable)).GetFunctionalObjects(@as(*const IPortableDeviceCapabilities, @ptrCast(self)), category_, pp_object_i_ds_);
            }
            pub inline fn getSupportedContentTypes(self: *const T, category_: ?*const Guid, pp_content_types_: ?*?*IPortableDevicePropVariantCollection) HRESULT {
                return @as(*const IPortableDeviceCapabilities.VTable, @ptrCast(self.vtable)).GetSupportedContentTypes(@as(*const IPortableDeviceCapabilities, @ptrCast(self)), category_, pp_content_types_);
            }
            pub inline fn getSupportedFormats(self: *const T, content_type_: ?*const Guid, pp_formats_: ?*?*IPortableDevicePropVariantCollection) HRESULT {
                return @as(*const IPortableDeviceCapabilities.VTable, @ptrCast(self.vtable)).GetSupportedFormats(@as(*const IPortableDeviceCapabilities, @ptrCast(self)), content_type_, pp_formats_);
            }
            pub inline fn getSupportedFormatProperties(self: *const T, format_: ?*const Guid, pp_keys_: ?*?*IPortableDeviceKeyCollection) HRESULT {
                return @as(*const IPortableDeviceCapabilities.VTable, @ptrCast(self.vtable)).GetSupportedFormatProperties(@as(*const IPortableDeviceCapabilities, @ptrCast(self)), format_, pp_keys_);
            }
            pub inline fn getFixedPropertyAttributes(self: *const T, format_: ?*const Guid, key_: ?*const PROPERTYKEY, pp_attributes_: ?*?*IPortableDeviceValues) HRESULT {
                return @as(*const IPortableDeviceCapabilities.VTable, @ptrCast(self.vtable)).GetFixedPropertyAttributes(@as(*const IPortableDeviceCapabilities, @ptrCast(self)), format_, key_, pp_attributes_);
            }
            pub inline fn cancel(self: *const T) HRESULT {
            ...
            pub inline fn getSupportedEvents(self: *const T, pp_events_: ?*?*IPortableDevicePropVariantCollection) HRESULT {
                return @as(*const IPortableDeviceCapabilities.VTable, @ptrCast(self.vtable)).GetSupportedEvents(@as(*const IPortableDeviceCapabilities, @ptrCast(self)), pp_events_);
            }
            pub inline fn getEventOptions(self: *const T, event_: ?*const Guid, pp_options_: ?*?*IPortableDeviceValues) HRESULT {
                return @as(*const IPortableDeviceCapabilities.VTable, @ptrCast(self.vtable)).GetEventOptions(@as(*const IPortableDeviceCapabilities, @ptrCast(self)), event_, pp_options_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IPortableDeviceEventCallback = extern struct {
    pub const VTable = extern struct {
        ...
        OnEvent: *const fn (
            ...
            p_event_parameters: ?*IPortableDeviceValues,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn onEvent(self: *const T, p_event_parameters_: ?*IPortableDeviceValues) HRESULT {
                return @as(*const IPortableDeviceEventCallback.VTable, @ptrCast(self.vtable)).OnEvent(@as(*const IPortableDeviceEventCallback, @ptrCast(self)), p_event_parameters_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IPortableDeviceDataStream = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getObjectID(self: *const T, ppsz_object_i_d_: ?*?PWSTR) HRESULT {
                return @as(*const IPortableDeviceDataStream.VTable, @ptrCast(self.vtable)).GetObjectID(@as(*const IPortableDeviceDataStream, @ptrCast(self)), ppsz_object_i_d_);
            }
            pub inline fn cancel(self: *const T) HRESULT {
...
pub const IPortableDeviceUnitsStream = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn seekInUnits(self: *const T, dlib_move_: LARGE_INTEGER, units_: WPD_STREAM_UNITS, dw_origin_: u32, plib_new_position_: ?*ULARGE_INTEGER) HRESULT {
                return @as(*const IPortableDeviceUnitsStream.VTable, @ptrCast(self.vtable)).SeekInUnits(@as(*const IPortableDeviceUnitsStream, @ptrCast(self)), dlib_move_, units_, dw_origin_, plib_new_position_);
            }
            pub inline fn cancel(self: *const T) HRESULT {
...
pub const IPortableDevicePropertiesBulk = extern struct {
    pub const VTable = extern struct {
        ...
        QueueGetValuesByObjectList: *const fn (
            ...
            p_object_i_ds: ?*IPortableDevicePropVariantCollection,
            p_keys: ?*IPortableDeviceKeyCollection,
            p_callback: ?*IPortableDevicePropertiesBulkCallback,
            p_context: ?*Guid,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        QueueGetValuesByObjectFormat: *const fn (
            self: *const IPortableDevicePropertiesBulk,
            pguid_object_format: ?*const Guid,
            psz_parent_object_i_d: ?[*:0]const u16,
            dw_depth: u32,
            p_keys: ?*IPortableDeviceKeyCollection,
            p_callback: ?*IPortableDevicePropertiesBulkCallback,
        ...
        QueueSetValuesByObjectList: *const fn (
            self: *const IPortableDevicePropertiesBulk,
            p_object_values: ?*IPortableDeviceValuesCollection,
            p_callback: ?*IPortableDevicePropertiesBulkCallback,
            p_context: ?*Guid,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Start: *const fn (
            self: *const IPortableDevicePropertiesBulk,
            p_context: ?*const Guid,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Cancel: *const fn (
            self: *const IPortableDevicePropertiesBulk,
            p_context: ?*const Guid,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn queueGetValuesByObjectList(self: *const T, p_object_i_ds_: ?*IPortableDevicePropVariantCollection, p_keys_: ?*IPortableDeviceKeyCollection, p_callback_: ?*IPortableDevicePropertiesBulkCallback, p_context_: ?*Guid) HRESULT {
                return @as(*const IPortableDevicePropertiesBulk.VTable, @ptrCast(self.vtable)).QueueGetValuesByObjectList(@as(*const IPortableDevicePropertiesBulk, @ptrCast(self)), p_object_i_ds_, p_keys_, p_callback_, p_context_);
            }
            pub inline fn queueGetValuesByObjectFormat(self: *const T, pguid_object_format_: ?*const Guid, psz_parent_object_i_d_: ?[*:0]const u16, dw_depth_: u32, p_keys_: ?*IPortableDeviceKeyCollection, p_callback_: ?*IPortableDevicePropertiesBulkCallback, p_context_: ?*Guid) HRESULT {
                return @as(*const IPortableDevicePropertiesBulk.VTable, @ptrCast(self.vtable)).QueueGetValuesByObjectFormat(@as(*const IPortableDevicePropertiesBulk, @ptrCast(self)), pguid_object_format_, psz_parent_object_i_d_, dw_depth_, p_keys_, p_callback_, p_context_);
            }
            pub inline fn queueSetValuesByObjectList(self: *const T, p_object_values_: ?*IPortableDeviceValuesCollection, p_callback_: ?*IPortableDevicePropertiesBulkCallback, p_context_: ?*Guid) HRESULT {
                return @as(*const IPortableDevicePropertiesBulk.VTable, @ptrCast(self.vtable)).QueueSetValuesByObjectList(@as(*const IPortableDevicePropertiesBulk, @ptrCast(self)), p_object_values_, p_callback_, p_context_);
            }
            pub inline fn start(self: *const T, p_context_: ?*const Guid) HRESULT {
                return @as(*const IPortableDevicePropertiesBulk.VTable, @ptrCast(self.vtable)).Start(@as(*const IPortableDevicePropertiesBulk, @ptrCast(self)), p_context_);
            }
            pub inline fn cancel(self: *const T, p_context_: ?*const Guid) HRESULT {
                return @as(*const IPortableDevicePropertiesBulk.VTable, @ptrCast(self.vtable)).Cancel(@as(*const IPortableDevicePropertiesBulk, @ptrCast(self)), p_context_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IPortableDevicePropertiesBulkCallback = extern struct {
    pub const VTable = extern struct {
        ...
        OnProgress: *const fn (
            self: *const IPortableDevicePropertiesBulkCallback,
            p_context: ?*const Guid,
            p_results: ?*IPortableDeviceValuesCollection,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnEnd: *const fn (
            self: *const IPortableDevicePropertiesBulkCallback,
            p_context: ?*const Guid,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn onStart(self: *const T, p_context_: ?*const Guid) HRESULT {
                return @as(*const IPortableDevicePropertiesBulkCallback.VTable, @ptrCast(self.vtable)).OnStart(@as(*const IPortableDevicePropertiesBulkCallback, @ptrCast(self)), p_context_);
            }
            pub inline fn onProgress(self: *const T, p_context_: ?*const Guid, p_results_: ?*IPortableDeviceValuesCollection) HRESULT {
                return @as(*const IPortableDevicePropertiesBulkCallback.VTable, @ptrCast(self.vtable)).OnProgress(@as(*const IPortableDevicePropertiesBulkCallback, @ptrCast(self)), p_context_, p_results_);
            }
            pub inline fn onEnd(self: *const T, p_context_: ?*const Guid, hr_status_: HRESULT) HRESULT {
                return @as(*const IPortableDevicePropertiesBulkCallback.VTable, @ptrCast(self.vtable)).OnEnd(@as(*const IPortableDevicePropertiesBulkCallback, @ptrCast(self)), p_context_, hr_status_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IPortableDeviceServiceManager = extern struct {
    pub const VTable = extern struct {
        ...
        GetDeviceServices: *const fn (
            ...
            psz_pn_p_device_i_d: ?[*:0]const u16,
            guid_service_category: ?*const Guid,
            p_services: ?*?PWSTR,
            pc_services: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetDeviceForService: *const fn (
            self: *const IPortableDeviceServiceManager,
            psz_pn_p_service_i_d: ?[*:0]const u16,
            ppsz_pn_p_device_i_d: ?*?PWSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getDeviceServices(self: *const T, psz_pn_p_device_i_d_: ?[*:0]const u16, guid_service_category_: ?*const Guid, p_services_: ?*?PWSTR, pc_services_: ?*u32) HRESULT {
                return @as(*const IPortableDeviceServiceManager.VTable, @ptrCast(self.vtable)).GetDeviceServices(@as(*const IPortableDeviceServiceManager, @ptrCast(self)), psz_pn_p_device_i_d_, guid_service_category_, p_services_, pc_services_);
            }
            pub inline fn getDeviceForService(self: *const T, psz_pn_p_service_i_d_: ?[*:0]const u16, ppsz_pn_p_device_i_d_: ?*?PWSTR) HRESULT {
                return @as(*const IPortableDeviceServiceManager.VTable, @ptrCast(self.vtable)).GetDeviceForService(@as(*const IPortableDeviceServiceManager, @ptrCast(self)), psz_pn_p_service_i_d_, ppsz_pn_p_device_i_d_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IPortableDeviceService = extern struct {
    pub const VTable = extern struct {
        ...
        Capabilities: *const fn (
            self: *const IPortableDeviceService,
            pp_capabilities: ?*?*IPortableDeviceServiceCapabilities,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Content: *const fn (
            self: *const IPortableDeviceService,
            pp_content: ?*?*IPortableDeviceContent2,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Methods: *const fn (
            self: *const IPortableDeviceService,
            pp_methods: ?*?*IPortableDeviceServiceMethods,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Cancel: *const fn (
            self: *const IPortableDeviceService,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        GetServiceObjectID: *const fn (
            self: *const IPortableDeviceService,
            ppsz_service_object_i_d: ?*?PWSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetPnPServiceID: *const fn (
            self: *const IPortableDeviceService,
            ppsz_pn_p_service_i_d: ?*?PWSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Advise: *const fn (
            self: *const IPortableDeviceService,
            dw_flags: u32,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn open(self: *const T, psz_pn_p_service_i_d_: ?[*:0]const u16, p_client_info_: ?*IPortableDeviceValues) HRESULT {
                return @as(*const IPortableDeviceService.VTable, @ptrCast(self.vtable)).Open(@as(*const IPortableDeviceService, @ptrCast(self)), psz_pn_p_service_i_d_, p_client_info_);
            }
            pub inline fn capabilities(self: *const T, pp_capabilities_: ?*?*IPortableDeviceServiceCapabilities) HRESULT {
                return @as(*const IPortableDeviceService.VTable, @ptrCast(self.vtable)).Capabilities(@as(*const IPortableDeviceService, @ptrCast(self)), pp_capabilities_);
            }
            pub inline fn content(self: *const T, pp_content_: ?*?*IPortableDeviceContent2) HRESULT {
                return @as(*const IPortableDeviceService.VTable, @ptrCast(self.vtable)).Content(@as(*const IPortableDeviceService, @ptrCast(self)), pp_content_);
            }
            pub inline fn methods(self: *const T, pp_methods_: ?*?*IPortableDeviceServiceMethods) HRESULT {
                return @as(*const IPortableDeviceService.VTable, @ptrCast(self.vtable)).Methods(@as(*const IPortableDeviceService, @ptrCast(self)), pp_methods_);
            }
            pub inline fn cancel(self: *const T) HRESULT {
            ...
            pub inline fn getServiceObjectID(self: *const T, ppsz_service_object_i_d_: ?*?PWSTR) HRESULT {
                return @as(*const IPortableDeviceService.VTable, @ptrCast(self.vtable)).GetServiceObjectID(@as(*const IPortableDeviceService, @ptrCast(self)), ppsz_service_object_i_d_);
            }
            pub inline fn getPnPServiceID(self: *const T, ppsz_pn_p_service_i_d_: ?*?PWSTR) HRESULT {
                return @as(*const IPortableDeviceService.VTable, @ptrCast(self.vtable)).GetPnPServiceID(@as(*const IPortableDeviceService, @ptrCast(self)), ppsz_pn_p_service_i_d_);
            }
            pub inline fn advise(self: *const T, dw_flags_: u32, p_callback_: ?*IPortableDeviceEventCallback, p_parameters_: ?*IPortableDeviceValues, ppsz_cookie_: ?*?PWSTR) HRESULT {
                return @as(*const IPortableDeviceService.VTable, @ptrCast(self.vtable)).Advise(@as(*const IPortableDeviceService, @ptrCast(self)), dw_flags_, p_callback_, p_parameters_, ppsz_cookie_);
            }
            pub inline fn unadvise(self: *const T, psz_cookie_: ?[*:0]const u16) HRESULT {
                return @as(*const IPortableDeviceService.VTable, @ptrCast(self.vtable)).Unadvise(@as(*const IPortableDeviceService, @ptrCast(self)), psz_cookie_);
            }
            pub inline fn sendCommand(self: *const T, dw_flags_: u32, p_parameters_: ?*IPortableDeviceValues, pp_results_: ?*?*IPortableDeviceValues) HRESULT {
                return @as(*const IPortableDeviceService.VTable, @ptrCast(self.vtable)).SendCommand(@as(*const IPortableDeviceService, @ptrCast(self)), dw_flags_, p_parameters_, pp_results_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IPortableDeviceServiceCapabilities = extern struct {
    pub const VTable = extern struct {
        ...
        GetSupportedMethods: *const fn (
            ...
            pp_methods: ?*?*IPortableDevicePropVariantCollection,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        GetInheritedServices: *const fn (
            self: *const IPortableDeviceServiceCapabilities,
            dw_inheritance_type: u32,
            pp_services: ?*?*IPortableDevicePropVariantCollection,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetFormatRenderingProfiles: *const fn (
            self: *const IPortableDeviceServiceCapabilities,
            format: ?*const Guid,
            pp_rendering_profiles: ?*?*IPortableDeviceValuesCollection,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetSupportedCommands: *const fn (
            self: *const IPortableDeviceServiceCapabilities,
            pp_commands: ?*?*IPortableDeviceKeyCollection,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getSupportedMethods(self: *const T, pp_methods_: ?*?*IPortableDevicePropVariantCollection) HRESULT {
                return @as(*const IPortableDeviceServiceCapabilities.VTable, @ptrCast(self.vtable)).GetSupportedMethods(@as(*const IPortableDeviceServiceCapabilities, @ptrCast(self)), pp_methods_);
            }
            pub inline fn getSupportedMethodsByFormat(self: *const T, format_: ?*const Guid, pp_methods_: ?*?*IPortableDevicePropVariantCollection) HRESULT {
                return @as(*const IPortableDeviceServiceCapabilities.VTable, @ptrCast(self.vtable)).GetSupportedMethodsByFormat(@as(*const IPortableDeviceServiceCapabilities, @ptrCast(self)), format_, pp_methods_);
            }
            pub inline fn getMethodAttributes(self: *const T, method_: ?*const Guid, pp_attributes_: ?*?*IPortableDeviceValues) HRESULT {
                return @as(*const IPortableDeviceServiceCapabilities.VTable, @ptrCast(self.vtable)).GetMethodAttributes(@as(*const IPortableDeviceServiceCapabilities, @ptrCast(self)), method_, pp_attributes_);
            }
            pub inline fn getMethodParameterAttributes(self: *const T, method_: ?*const Guid, parameter_: ?*const PROPERTYKEY, pp_attributes_: ?*?*IPortableDeviceValues) HRESULT {
                return @as(*const IPortableDeviceServiceCapabilities.VTable, @ptrCast(self.vtable)).GetMethodParameterAttributes(@as(*const IPortableDeviceServiceCapabilities, @ptrCast(self)), method_, parameter_, pp_attributes_);
            }
            pub inline fn getSupportedFormats(self: *const T, pp_formats_: ?*?*IPortableDevicePropVariantCollection) HRESULT {
                return @as(*const IPortableDeviceServiceCapabilities.VTable, @ptrCast(self.vtable)).GetSupportedFormats(@as(*const IPortableDeviceServiceCapabilities, @ptrCast(self)), pp_formats_);
            }
            pub inline fn getFormatAttributes(self: *const T, format_: ?*const Guid, pp_attributes_: ?*?*IPortableDeviceValues) HRESULT {
                return @as(*const IPortableDeviceServiceCapabilities.VTable, @ptrCast(self.vtable)).GetFormatAttributes(@as(*const IPortableDeviceServiceCapabilities, @ptrCast(self)), format_, pp_attributes_);
            }
            pub inline fn getSupportedFormatProperties(self: *const T, format_: ?*const Guid, pp_keys_: ?*?*IPortableDeviceKeyCollection) HRESULT {
                return @as(*const IPortableDeviceServiceCapabilities.VTable, @ptrCast(self.vtable)).GetSupportedFormatProperties(@as(*const IPortableDeviceServiceCapabilities, @ptrCast(self)), format_, pp_keys_);
            }
            pub inline fn getFormatPropertyAttributes(self: *const T, format_: ?*const Guid, property_: ?*const PROPERTYKEY, pp_attributes_: ?*?*IPortableDeviceValues) HRESULT {
                return @as(*const IPortableDeviceServiceCapabilities.VTable, @ptrCast(self.vtable)).GetFormatPropertyAttributes(@as(*const IPortableDeviceServiceCapabilities, @ptrCast(self)), format_, property_, pp_attributes_);
            }
            pub inline fn getSupportedEvents(self: *const T, pp_events_: ?*?*IPortableDevicePropVariantCollection) HRESULT {
                return @as(*const IPortableDeviceServiceCapabilities.VTable, @ptrCast(self.vtable)).GetSupportedEvents(@as(*const IPortableDeviceServiceCapabilities, @ptrCast(self)), pp_events_);
            }
            pub inline fn getEventAttributes(self: *const T, event_: ?*const Guid, pp_attributes_: ?*?*IPortableDeviceValues) HRESULT {
                return @as(*const IPortableDeviceServiceCapabilities.VTable, @ptrCast(self.vtable)).GetEventAttributes(@as(*const IPortableDeviceServiceCapabilities, @ptrCast(self)), event_, pp_attributes_);
            }
            pub inline fn getEventParameterAttributes(self: *const T, event_: ?*const Guid, parameter_: ?*const PROPERTYKEY, pp_attributes_: ?*?*IPortableDeviceValues) HRESULT {
                return @as(*const IPortableDeviceServiceCapabilities.VTable, @ptrCast(self.vtable)).GetEventParameterAttributes(@as(*const IPortableDeviceServiceCapabilities, @ptrCast(self)), event_, parameter_, pp_attributes_);
            }
            pub inline fn getInheritedServices(self: *const T, dw_inheritance_type_: u32, pp_services_: ?*?*IPortableDevicePropVariantCollection) HRESULT {
                return @as(*const IPortableDeviceServiceCapabilities.VTable, @ptrCast(self.vtable)).GetInheritedServices(@as(*const IPortableDeviceServiceCapabilities, @ptrCast(self)), dw_inheritance_type_, pp_services_);
            }
            pub inline fn getFormatRenderingProfiles(self: *const T, format_: ?*const Guid, pp_rendering_profiles_: ?*?*IPortableDeviceValuesCollection) HRESULT {
                return @as(*const IPortableDeviceServiceCapabilities.VTable, @ptrCast(self.vtable)).GetFormatRenderingProfiles(@as(*const IPortableDeviceServiceCapabilities, @ptrCast(self)), format_, pp_rendering_profiles_);
            }
            pub inline fn getSupportedCommands(self: *const T, pp_commands_: ?*?*IPortableDeviceKeyCollection) HRESULT {
                return @as(*const IPortableDeviceServiceCapabilities.VTable, @ptrCast(self.vtable)).GetSupportedCommands(@as(*const IPortableDeviceServiceCapabilities, @ptrCast(self)), pp_commands_);
            }
            pub inline fn getCommandOptions(self: *const T, command_: ?*const PROPERTYKEY, pp_options_: ?*?*IPortableDeviceValues) HRESULT {
                return @as(*const IPortableDeviceServiceCapabilities.VTable, @ptrCast(self.vtable)).GetCommandOptions(@as(*const IPortableDeviceServiceCapabilities, @ptrCast(self)), command_, pp_options_);
            }
            pub inline fn cancel(self: *const T) HRESULT {
...
pub const IPortableDeviceServiceMethods = extern struct {
    pub const VTable = extern struct {
        ...
        InvokeAsync: *const fn (
            ...
            method: ?*const Guid,
            p_parameters: ?*IPortableDeviceValues,
            p_callback: ?*IPortableDeviceServiceMethodCallback,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Cancel: *const fn (
            self: *const IPortableDeviceServiceMethods,
            p_callback: ?*IPortableDeviceServiceMethodCallback,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn invoke(self: *const T, method_: ?*const Guid, p_parameters_: ?*IPortableDeviceValues, pp_results_: ?*?*IPortableDeviceValues) HRESULT {
                return @as(*const IPortableDeviceServiceMethods.VTable, @ptrCast(self.vtable)).Invoke(@as(*const IPortableDeviceServiceMethods, @ptrCast(self)), method_, p_parameters_, pp_results_);
            }
            pub inline fn invokeAsync(self: *const T, method_: ?*const Guid, p_parameters_: ?*IPortableDeviceValues, p_callback_: ?*IPortableDeviceServiceMethodCallback) HRESULT {
                return @as(*const IPortableDeviceServiceMethods.VTable, @ptrCast(self.vtable)).InvokeAsync(@as(*const IPortableDeviceServiceMethods, @ptrCast(self)), method_, p_parameters_, p_callback_);
            }
            pub inline fn cancel(self: *const T, p_callback_: ?*IPortableDeviceServiceMethodCallback) HRESULT {
                return @as(*const IPortableDeviceServiceMethods.VTable, @ptrCast(self.vtable)).Cancel(@as(*const IPortableDeviceServiceMethods, @ptrCast(self)), p_callback_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IPortableDeviceServiceMethodCallback = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn onComplete(self: *const T, hr_status_: HRESULT, p_results_: ?*IPortableDeviceValues) HRESULT {
                return @as(*const IPortableDeviceServiceMethodCallback.VTable, @ptrCast(self.vtable)).OnComplete(@as(*const IPortableDeviceServiceMethodCallback, @ptrCast(self)), hr_status_, p_results_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IPortableDeviceServiceActivation = extern struct {
    pub const VTable = extern struct {
        ...
        OpenAsync: *const fn (
            ...
            psz_pn_p_service_i_d: ?[*:0]const u16,
            p_client_info: ?*IPortableDeviceValues,
            p_callback: ?*IPortableDeviceServiceOpenCallback,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn openAsync(self: *const T, psz_pn_p_service_i_d_: ?[*:0]const u16, p_client_info_: ?*IPortableDeviceValues, p_callback_: ?*IPortableDeviceServiceOpenCallback) HRESULT {
                return @as(*const IPortableDeviceServiceActivation.VTable, @ptrCast(self.vtable)).OpenAsync(@as(*const IPortableDeviceServiceActivation, @ptrCast(self)), psz_pn_p_service_i_d_, p_client_info_, p_callback_);
            }
            pub inline fn cancelOpenAsync(self: *const T) HRESULT {
...
pub const IPortableDeviceServiceOpenCallback = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn onComplete(self: *const T, hr_status_: HRESULT) HRESULT {
                return @as(*const IPortableDeviceServiceOpenCallback.VTable, @ptrCast(self.vtable)).OnComplete(@as(*const IPortableDeviceServiceOpenCallback, @ptrCast(self)), hr_status_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IPortableDeviceDispatchFactory = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getDeviceDispatch(self: *const T, psz_pn_p_device_i_d_: ?[*:0]const u16, pp_device_dispatch_: ?*?*IDispatch) HRESULT {
                return @as(*const IPortableDeviceDispatchFactory.VTable, @ptrCast(self.vtable)).GetDeviceDispatch(@as(*const IPortableDeviceDispatchFactory, @ptrCast(self)), psz_pn_p_device_i_d_, pp_device_dispatch_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IPortableDeviceWebControl = extern struct {
    pub const VTable = extern struct {
        ...
        GetDeviceFromIdAsync: *const fn (
            self: *const IPortableDeviceWebControl,
            device_id: ?BSTR,
            p_completion_handler: ?*IDispatch,
            p_error_handler: ?*IDispatch,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getDeviceFromId(self: *const T, device_id_: ?BSTR, pp_device_: ?*?*IDispatch) HRESULT {
                return @as(*const IPortableDeviceWebControl.VTable, @ptrCast(self.vtable)).GetDeviceFromId(@as(*const IPortableDeviceWebControl, @ptrCast(self)), device_id_, pp_device_);
            }
            pub inline fn getDeviceFromIdAsync(self: *const T, device_id_: ?BSTR, p_completion_handler_: ?*IDispatch, p_error_handler_: ?*IDispatch) HRESULT {
                return @as(*const IPortableDeviceWebControl.VTable, @ptrCast(self.vtable)).GetDeviceFromIdAsync(@as(*const IPortableDeviceWebControl, @ptrCast(self)), device_id_, p_completion_handler_, p_error_handler_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IEnumPortableDeviceConnectors = extern struct {
    pub const VTable = extern struct {
        ...
        Next: *const fn (
            ...
            c_requested: u32,
            p_connectors: [*]?*IPortableDeviceConnector,
            pc_fetched: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Skip: *const fn (
            self: *const IEnumPortableDeviceConnectors,
        ...
        Clone: *const fn (
            self: *const IEnumPortableDeviceConnectors,
            pp_enum: ?*?*IEnumPortableDeviceConnectors,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn next(self: *const T, c_requested_: u32, p_connectors_: [*]?*IPortableDeviceConnector, pc_fetched_: ?*u32) HRESULT {
                return @as(*const IEnumPortableDeviceConnectors.VTable, @ptrCast(self.vtable)).Next(@as(*const IEnumPortableDeviceConnectors, @ptrCast(self)), c_requested_, p_connectors_, pc_fetched_);
            }
            pub inline fn skip(self: *const T, c_connectors_: u32) HRESULT {
                return @as(*const IEnumPortableDeviceConnectors.VTable, @ptrCast(self.vtable)).Skip(@as(*const IEnumPortableDeviceConnectors, @ptrCast(self)), c_connectors_);
            }
            pub inline fn reset(self: *const T) HRESULT {
            ...
            pub inline fn clone(self: *const T, pp_enum_: ?*?*IEnumPortableDeviceConnectors) HRESULT {
                return @as(*const IEnumPortableDeviceConnectors.VTable, @ptrCast(self.vtable)).Clone(@as(*const IEnumPortableDeviceConnectors, @ptrCast(self)), pp_enum_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IPortableDeviceConnector = extern struct {
    pub const VTable = extern struct {
        ...
        Connect: *const fn (
            ...
            p_callback: ?*IConnectionRequestCallback,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Disconnect: *const fn (
            self: *const IPortableDeviceConnector,
            p_callback: ?*IConnectionRequestCallback,
        ...
        GetProperty: *const fn (
            self: *const IPortableDeviceConnector,
            p_property_key: ?*const DEVPROPKEY,
            p_property_type: ?*u32,
            pp_data: [*]?*u8,
            pcb_data: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn connect(self: *const T, p_callback_: ?*IConnectionRequestCallback) HRESULT {
                return @as(*const IPortableDeviceConnector.VTable, @ptrCast(self.vtable)).Connect(@as(*const IPortableDeviceConnector, @ptrCast(self)), p_callback_);
            }
            pub inline fn disconnect(self: *const T, p_callback_: ?*IConnectionRequestCallback) HRESULT {
                return @as(*const IPortableDeviceConnector.VTable, @ptrCast(self.vtable)).Disconnect(@as(*const IPortableDeviceConnector, @ptrCast(self)), p_callback_);
            }
            pub inline fn cancel(self: *const T, p_callback_: ?*IConnectionRequestCallback) HRESULT {
                return @as(*const IPortableDeviceConnector.VTable, @ptrCast(self.vtable)).Cancel(@as(*const IPortableDeviceConnector, @ptrCast(self)), p_callback_);
            }
            pub inline fn getProperty(self: *const T, p_property_key_: ?*const DEVPROPKEY, p_property_type_: ?*u32, pp_data_: [*]?*u8, pcb_data_: ?*u32) HRESULT {
                return @as(*const IPortableDeviceConnector.VTable, @ptrCast(self.vtable)).GetProperty(@as(*const IPortableDeviceConnector, @ptrCast(self)), p_property_key_, p_property_type_, pp_data_, pcb_data_);
            }
            pub inline fn setProperty(self: *const T, p_property_key_: ?*const DEVPROPKEY, property_type_: u32, p_data_: [*:0]const u8, cb_data_: u32) HRESULT {
                return @as(*const IPortableDeviceConnector.VTable, @ptrCast(self.vtable)).SetProperty(@as(*const IPortableDeviceConnector, @ptrCast(self)), p_property_key_, property_type_, p_data_, cb_data_);
            }
            pub inline fn getPnPID(self: *const T, ppwsz_pn_p_i_d_: ?*?PWSTR) HRESULT {
                return @as(*const IPortableDeviceConnector.VTable, @ptrCast(self.vtable)).GetPnPID(@as(*const IPortableDeviceConnector, @ptrCast(self)), ppwsz_pn_p_i_d_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IConnectionRequestCallback = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn onComplete(self: *const T, hr_status_: HRESULT) HRESULT {
                return @as(*const IConnectionRequestCallback.VTable, @ptrCast(self.vtable)).OnComplete(@as(*const IConnectionRequestCallback, @ptrCast(self)), hr_status_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IMediaRadioManager = extern struct {
    pub const VTable = extern struct {
        ...
        GetRadioInstances: *const fn (
            ...
            pp_collection: ?*?*IRadioInstanceCollection,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnSystemRadioStateChange: *const fn (
            self: *const IMediaRadioManager,
            sys_radio_state: SYSTEM_RADIO_STATE,
            u_timeout_sec: u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getRadioInstances(self: *const T, pp_collection_: ?*?*IRadioInstanceCollection) HRESULT {
                return @as(*const IMediaRadioManager.VTable, @ptrCast(self.vtable)).GetRadioInstances(@as(*const IMediaRadioManager, @ptrCast(self)), pp_collection_);
            }
            pub inline fn onSystemRadioStateChange(self: *const T, sys_radio_state_: SYSTEM_RADIO_STATE, u_timeout_sec_: u32) HRESULT {
                return @as(*const IMediaRadioManager.VTable, @ptrCast(self.vtable)).OnSystemRadioStateChange(@as(*const IMediaRadioManager, @ptrCast(self)), sys_radio_state_, u_timeout_sec_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IRadioInstanceCollection = extern struct {
    pub const VTable = extern struct {
        ...
        GetAt: *const fn (
            self: *const IRadioInstanceCollection,
            u_index: u32,
            pp_radio_instance: ?*?*IRadioInstance,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getCount(self: *const T, pc_instance_: ?*u32) HRESULT {
                return @as(*const IRadioInstanceCollection.VTable, @ptrCast(self.vtable)).GetCount(@as(*const IRadioInstanceCollection, @ptrCast(self)), pc_instance_);
            }
            pub inline fn getAt(self: *const T, u_index_: u32, pp_radio_instance_: ?*?*IRadioInstance) HRESULT {
                return @as(*const IRadioInstanceCollection.VTable, @ptrCast(self.vtable)).GetAt(@as(*const IRadioInstanceCollection, @ptrCast(self)), u_index_, pp_radio_instance_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IRadioInstance = extern struct {
    pub const VTable = extern struct {
        ...
        GetRadioState: *const fn (
            self: *const IRadioInstance,
            p_radio_state: ?*DEVICE_RADIO_STATE,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        SetRadioState: *const fn (
            self: *const IRadioInstance,
            radio_state: DEVICE_RADIO_STATE,
            u_timeout_sec: u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getRadioManagerSignature(self: *const T, pguid_signature_: ?*Guid) HRESULT {
                return @as(*const IRadioInstance.VTable, @ptrCast(self.vtable)).GetRadioManagerSignature(@as(*const IRadioInstance, @ptrCast(self)), pguid_signature_);
            }
            pub inline fn getInstanceSignature(self: *const T, pbstr_id_: ?*?BSTR) HRESULT {
                return @as(*const IRadioInstance.VTable, @ptrCast(self.vtable)).GetInstanceSignature(@as(*const IRadioInstance, @ptrCast(self)), pbstr_id_);
            }
            pub inline fn getFriendlyName(self: *const T, lcid_: u32, pbstr_name_: ?*?BSTR) HRESULT {
                return @as(*const IRadioInstance.VTable, @ptrCast(self.vtable)).GetFriendlyName(@as(*const IRadioInstance, @ptrCast(self)), lcid_, pbstr_name_);
            }
            pub inline fn getRadioState(self: *const T, p_radio_state_: ?*DEVICE_RADIO_STATE) HRESULT {
                return @as(*const IRadioInstance.VTable, @ptrCast(self.vtable)).GetRadioState(@as(*const IRadioInstance, @ptrCast(self)), p_radio_state_);
            }
            pub inline fn setRadioState(self: *const T, radio_state_: DEVICE_RADIO_STATE, u_timeout_sec_: u32) HRESULT {
                return @as(*const IRadioInstance.VTable, @ptrCast(self.vtable)).SetRadioState(@as(*const IRadioInstance, @ptrCast(self)), radio_state_, u_timeout_sec_);
            }
            pub inline fn isMultiComm(self: *const T) BOOL {
                return @as(*const IRadioInstance.VTable, @ptrCast(self.vtable)).IsMultiComm(@as(*const IRadioInstance, @ptrCast(self)));
            }
            pub inline fn isAssociatingDevice(self: *const T) BOOL {
...
pub const IMediaRadioManagerNotifySink = extern struct {
    pub const VTable = extern struct {
        ...
        OnInstanceAdd: *const fn (
            ...
            p_radio_instance: ?*IRadioInstance,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnInstanceRemove: *const fn (
            self: *const IMediaRadioManagerNotifySink,
            bstr_radio_instance_id: ?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn onInstanceAdd(self: *const T, p_radio_instance_: ?*IRadioInstance) HRESULT {
                return @as(*const IMediaRadioManagerNotifySink.VTable, @ptrCast(self.vtable)).OnInstanceAdd(@as(*const IMediaRadioManagerNotifySink, @ptrCast(self)), p_radio_instance_);
            }
            pub inline fn onInstanceRemove(self: *const T, bstr_radio_instance_id_: ?BSTR) HRESULT {
                return @as(*const IMediaRadioManagerNotifySink.VTable, @ptrCast(self.vtable)).OnInstanceRemove(@as(*const IMediaRadioManagerNotifySink, @ptrCast(self)), bstr_radio_instance_id_);
            }
            pub inline fn onInstanceRadioChange(self: *const T, bstr_radio_instance_id_: ?BSTR, radio_state_: DEVICE_RADIO_STATE) HRESULT {
                return @as(*const IMediaRadioManagerNotifySink.VTable, @ptrCast(self.vtable)).OnInstanceRadioChange(@as(*const IMediaRadioManagerNotifySink, @ptrCast(self)), bstr_radio_instance_id_, radio_state_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub extern "dmprocessxmlfiltered" fn DMProcessConfigXMLFiltered(
    psz_xml_in: ?[*:0]const u16,
    rgsz_allowed_csp_nodes: [*]?PWSTR,
    dw_num_allowed_csp_nodes: u32,
    pbstr_xml_out: ?*?BSTR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
