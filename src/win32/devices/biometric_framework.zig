...
pub const PWINBIO_ASYNC_COMPLETION_CALLBACK = *const fn (
    async_result: ?*WINBIO_ASYNC_RESULT,
) callconv(@import("std").os.windows.WINAPI) void;

pub const PWINBIO_VERIFY_CALLBACK = *const fn (
    verify_callback_context: ?*anyopaque,
    operation_status: HRESULT,
    unit_id: u32,
    match: BOOLEAN,
    reject_detail: u32,
) callconv(@import("std").os.windows.WINAPI) void;
...
pub const PWINBIO_IDENTIFY_CALLBACK = *const fn (
    identify_callback_context: ?*anyopaque,
    operation_status: HRESULT,
    unit_id: u32,
    identity: ?*WINBIO_IDENTITY,
    sub_factor: u8,
...
pub extern "winbio" fn WinBioAsyncOpenFramework(
    notification_method: WINBIO_ASYNC_NOTIFICATION_METHOD,
    target_window: ?HWND,
    message_code: u32,
    callback_routine: ?PWINBIO_ASYNC_COMPLETION_CALLBACK,
    user_data: ?*anyopaque,
    asynchronous_open: BOOL,
    framework_handle: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "winbio" fn WinBioVerifyWithCallback(
    ...
    identity: ?*WINBIO_IDENTITY,
    sub_factor: u8,
    verify_callback: ?PWINBIO_VERIFY_CALLBACK,
    verify_callback_context: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "winbio" fn WinBioIdentifyWithCallback(
    session_handle: u32,
    identify_callback: ?PWINBIO_IDENTIFY_CALLBACK,
    identify_callback_context: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "winbio" fn WinBioLocateSensorWithCallback(
    session_handle: u32,
    locate_callback: ?PWINBIO_LOCATE_SENSOR_CALLBACK,
    locate_callback_context: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "winbio" fn WinBioEnrollCaptureWithCallback(
    session_handle: u32,
    enroll_callback: ?PWINBIO_ENROLL_CAPTURE_CALLBACK,
    enroll_callback_context: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "winbio" fn WinBioRegisterEventMonitor(
    session_handle: u32,
    event_mask: u32,
    event_callback: ?PWINBIO_EVENT_CALLBACK,
    event_callback_context: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "winbio" fn WinBioCaptureSampleWithCallback(
    ...
    purpose: u8,
    flags: u8,
    capture_callback: ?PWINBIO_CAPTURE_CALLBACK,
    capture_callback_context: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "winbio" fn WinBioGetCredentialState(
    identity: WINBIO_IDENTITY,
    type: WINBIO_CREDENTIAL_TYPE,
    credential_state: ?*WINBIO_CREDENTIAL_STATE,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "winbio" fn WinBioGetEnrolledFactors(
    account_owner: ?*WINBIO_IDENTITY,
    enrolled_factors: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
