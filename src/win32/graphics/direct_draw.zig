...
pub const LPCLIPPERCALLBACK = *const fn (
    lp_d_d_clipper: ?*IDirectDrawClipper,
    h_wnd: ?HWND,
    code: u32,
    lp_context: ?*anyopaque,
...
pub const IDirectDraw = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn createClipper(self: *const T, param0_: u32, param1_: ?*?*IDirectDrawClipper, param2_: ?*IUnknown) HRESULT {
                return @as(*const IDirectDraw.VTable, @ptrCast(self.vtable)).CreateClipper(@as(*const IDirectDraw, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn createPalette(self: *const T, param0_: u32, param1_: ?*PALETTEENTRY, param2_: ?*?*IDirectDrawPalette, param3_: ?*IUnknown) HRESULT {
                return @as(*const IDirectDraw.VTable, @ptrCast(self.vtable)).CreatePalette(@as(*const IDirectDraw, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn createSurface(self: *const T, param0_: ?*DDSURFACEDESC, param1_: ?*?*IDirectDrawSurface, param2_: ?*IUnknown) HRESULT {
                return @as(*const IDirectDraw.VTable, @ptrCast(self.vtable)).CreateSurface(@as(*const IDirectDraw, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn duplicateSurface(self: *const T, param0_: ?*IDirectDrawSurface, param1_: ?*?*IDirectDrawSurface) HRESULT {
                return @as(*const IDirectDraw.VTable, @ptrCast(self.vtable)).DuplicateSurface(@as(*const IDirectDraw, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn enumDisplayModes(self: *const T, param0_: u32, param1_: ?*DDSURFACEDESC, param2_: ?*anyopaque, param3_: ?LPDDENUMMODESCALLBACK) HRESULT {
                return @as(*const IDirectDraw.VTable, @ptrCast(self.vtable)).EnumDisplayModes(@as(*const IDirectDraw, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn enumSurfaces(self: *const T, param0_: u32, param1_: ?*DDSURFACEDESC, param2_: ?*anyopaque, param3_: ?LPDDENUMSURFACESCALLBACK) HRESULT {
                return @as(*const IDirectDraw.VTable, @ptrCast(self.vtable)).EnumSurfaces(@as(*const IDirectDraw, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn flipToGDISurface(self: *const T) HRESULT {
                return @as(*const IDirectDraw.VTable, @ptrCast(self.vtable)).FlipToGDISurface(@as(*const IDirectDraw, @ptrCast(self)));
            }
            pub inline fn getCaps(self: *const T, param0_: ?*DDCAPS_DX7, param1_: ?*DDCAPS_DX7) HRESULT {
                return @as(*const IDirectDraw.VTable, @ptrCast(self.vtable)).GetCaps(@as(*const IDirectDraw, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getDisplayMode(self: *const T, param0_: ?*DDSURFACEDESC) HRESULT {
                return @as(*const IDirectDraw.VTable, @ptrCast(self.vtable)).GetDisplayMode(@as(*const IDirectDraw, @ptrCast(self)), param0_);
            }
            pub inline fn getFourCCCodes(self: *const T, param0_: ?*u32, param1_: ?*u32) HRESULT {
                return @as(*const IDirectDraw.VTable, @ptrCast(self.vtable)).GetFourCCCodes(@as(*const IDirectDraw, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getGDISurface(self: *const T, param0_: ?*?*IDirectDrawSurface) HRESULT {
                return @as(*const IDirectDraw.VTable, @ptrCast(self.vtable)).GetGDISurface(@as(*const IDirectDraw, @ptrCast(self)), param0_);
            }
            pub inline fn getMonitorFrequency(self: *const T, param0_: ?*u32) HRESULT {
                return @as(*const IDirectDraw.VTable, @ptrCast(self.vtable)).GetMonitorFrequency(@as(*const IDirectDraw, @ptrCast(self)), param0_);
            }
            pub inline fn getScanLine(self: *const T, param0_: ?*u32) HRESULT {
                return @as(*const IDirectDraw.VTable, @ptrCast(self.vtable)).GetScanLine(@as(*const IDirectDraw, @ptrCast(self)), param0_);
            }
            pub inline fn getVerticalBlankStatus(self: *const T, param0_: ?*i32) HRESULT {
                return @as(*const IDirectDraw.VTable, @ptrCast(self.vtable)).GetVerticalBlankStatus(@as(*const IDirectDraw, @ptrCast(self)), param0_);
            }
            pub inline fn initialize(self: *const T, param0_: ?*Guid) HRESULT {
                return @as(*const IDirectDraw.VTable, @ptrCast(self.vtable)).Initialize(@as(*const IDirectDraw, @ptrCast(self)), param0_);
            }
            pub inline fn restoreDisplayMode(self: *const T) HRESULT {
                return @as(*const IDirectDraw.VTable, @ptrCast(self.vtable)).RestoreDisplayMode(@as(*const IDirectDraw, @ptrCast(self)));
            }
            pub inline fn setCooperativeLevel(self: *const T, param0_: ?HWND, param1_: u32) HRESULT {
                return @as(*const IDirectDraw.VTable, @ptrCast(self.vtable)).SetCooperativeLevel(@as(*const IDirectDraw, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn setDisplayMode(self: *const T, param0_: u32, param1_: u32, param2_: u32) HRESULT {
                return @as(*const IDirectDraw.VTable, @ptrCast(self.vtable)).SetDisplayMode(@as(*const IDirectDraw, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn waitForVerticalBlank(self: *const T, param0_: u32, param1_: ?HANDLE) HRESULT {
                return @as(*const IDirectDraw.VTable, @ptrCast(self.vtable)).WaitForVerticalBlank(@as(*const IDirectDraw, @ptrCast(self)), param0_, param1_);
            }
        };
    }
...
pub const IDirectDraw2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn createClipper(self: *const T, param0_: u32, param1_: ?*?*IDirectDrawClipper, param2_: ?*IUnknown) HRESULT {
                return @as(*const IDirectDraw2.VTable, @ptrCast(self.vtable)).CreateClipper(@as(*const IDirectDraw2, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn createPalette(self: *const T, param0_: u32, param1_: ?*PALETTEENTRY, param2_: ?*?*IDirectDrawPalette, param3_: ?*IUnknown) HRESULT {
                return @as(*const IDirectDraw2.VTable, @ptrCast(self.vtable)).CreatePalette(@as(*const IDirectDraw2, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn createSurface(self: *const T, param0_: ?*DDSURFACEDESC, param1_: ?*?*IDirectDrawSurface, param2_: ?*IUnknown) HRESULT {
                return @as(*const IDirectDraw2.VTable, @ptrCast(self.vtable)).CreateSurface(@as(*const IDirectDraw2, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn duplicateSurface(self: *const T, param0_: ?*IDirectDrawSurface, param1_: ?*?*IDirectDrawSurface) HRESULT {
                return @as(*const IDirectDraw2.VTable, @ptrCast(self.vtable)).DuplicateSurface(@as(*const IDirectDraw2, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn enumDisplayModes(self: *const T, param0_: u32, param1_: ?*DDSURFACEDESC, param2_: ?*anyopaque, param3_: ?LPDDENUMMODESCALLBACK) HRESULT {
                return @as(*const IDirectDraw2.VTable, @ptrCast(self.vtable)).EnumDisplayModes(@as(*const IDirectDraw2, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn enumSurfaces(self: *const T, param0_: u32, param1_: ?*DDSURFACEDESC, param2_: ?*anyopaque, param3_: ?LPDDENUMSURFACESCALLBACK) HRESULT {
                return @as(*const IDirectDraw2.VTable, @ptrCast(self.vtable)).EnumSurfaces(@as(*const IDirectDraw2, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn flipToGDISurface(self: *const T) HRESULT {
                return @as(*const IDirectDraw2.VTable, @ptrCast(self.vtable)).FlipToGDISurface(@as(*const IDirectDraw2, @ptrCast(self)));
            }
            pub inline fn getCaps(self: *const T, param0_: ?*DDCAPS_DX7, param1_: ?*DDCAPS_DX7) HRESULT {
                return @as(*const IDirectDraw2.VTable, @ptrCast(self.vtable)).GetCaps(@as(*const IDirectDraw2, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getDisplayMode(self: *const T, param0_: ?*DDSURFACEDESC) HRESULT {
                return @as(*const IDirectDraw2.VTable, @ptrCast(self.vtable)).GetDisplayMode(@as(*const IDirectDraw2, @ptrCast(self)), param0_);
            }
            pub inline fn getFourCCCodes(self: *const T, param0_: ?*u32, param1_: ?*u32) HRESULT {
                return @as(*const IDirectDraw2.VTable, @ptrCast(self.vtable)).GetFourCCCodes(@as(*const IDirectDraw2, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getGDISurface(self: *const T, param0_: ?*?*IDirectDrawSurface) HRESULT {
                return @as(*const IDirectDraw2.VTable, @ptrCast(self.vtable)).GetGDISurface(@as(*const IDirectDraw2, @ptrCast(self)), param0_);
            }
            pub inline fn getMonitorFrequency(self: *const T, param0_: ?*u32) HRESULT {
                return @as(*const IDirectDraw2.VTable, @ptrCast(self.vtable)).GetMonitorFrequency(@as(*const IDirectDraw2, @ptrCast(self)), param0_);
            }
            pub inline fn getScanLine(self: *const T, param0_: ?*u32) HRESULT {
                return @as(*const IDirectDraw2.VTable, @ptrCast(self.vtable)).GetScanLine(@as(*const IDirectDraw2, @ptrCast(self)), param0_);
            }
            pub inline fn getVerticalBlankStatus(self: *const T, param0_: ?*i32) HRESULT {
                return @as(*const IDirectDraw2.VTable, @ptrCast(self.vtable)).GetVerticalBlankStatus(@as(*const IDirectDraw2, @ptrCast(self)), param0_);
            }
            pub inline fn initialize(self: *const T, param0_: ?*Guid) HRESULT {
                return @as(*const IDirectDraw2.VTable, @ptrCast(self.vtable)).Initialize(@as(*const IDirectDraw2, @ptrCast(self)), param0_);
            }
            pub inline fn restoreDisplayMode(self: *const T) HRESULT {
                return @as(*const IDirectDraw2.VTable, @ptrCast(self.vtable)).RestoreDisplayMode(@as(*const IDirectDraw2, @ptrCast(self)));
            }
            pub inline fn setCooperativeLevel(self: *const T, param0_: ?HWND, param1_: u32) HRESULT {
                return @as(*const IDirectDraw2.VTable, @ptrCast(self.vtable)).SetCooperativeLevel(@as(*const IDirectDraw2, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn setDisplayMode(self: *const T, param0_: u32, param1_: u32, param2_: u32, param3_: u32, param4_: u32) HRESULT {
                return @as(*const IDirectDraw2.VTable, @ptrCast(self.vtable)).SetDisplayMode(@as(*const IDirectDraw2, @ptrCast(self)), param0_, param1_, param2_, param3_, param4_);
            }
            pub inline fn waitForVerticalBlank(self: *const T, param0_: u32, param1_: ?HANDLE) HRESULT {
                return @as(*const IDirectDraw2.VTable, @ptrCast(self.vtable)).WaitForVerticalBlank(@as(*const IDirectDraw2, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getAvailableVidMem(self: *const T, param0_: ?*DDSCAPS, param1_: ?*u32, param2_: ?*u32) HRESULT {
                return @as(*const IDirectDraw2.VTable, @ptrCast(self.vtable)).GetAvailableVidMem(@as(*const IDirectDraw2, @ptrCast(self)), param0_, param1_, param2_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectDraw4 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn createClipper(self: *const T, param0_: u32, param1_: ?*?*IDirectDrawClipper, param2_: ?*IUnknown) HRESULT {
                return @as(*const IDirectDraw4.VTable, @ptrCast(self.vtable)).CreateClipper(@as(*const IDirectDraw4, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn createPalette(self: *const T, param0_: u32, param1_: ?*PALETTEENTRY, param2_: ?*?*IDirectDrawPalette, param3_: ?*IUnknown) HRESULT {
                return @as(*const IDirectDraw4.VTable, @ptrCast(self.vtable)).CreatePalette(@as(*const IDirectDraw4, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn createSurface(self: *const T, param0_: ?*DDSURFACEDESC2, param1_: ?*?*IDirectDrawSurface4, param2_: ?*IUnknown) HRESULT {
                return @as(*const IDirectDraw4.VTable, @ptrCast(self.vtable)).CreateSurface(@as(*const IDirectDraw4, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn duplicateSurface(self: *const T, param0_: ?*IDirectDrawSurface4, param1_: ?*?*IDirectDrawSurface4) HRESULT {
                return @as(*const IDirectDraw4.VTable, @ptrCast(self.vtable)).DuplicateSurface(@as(*const IDirectDraw4, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn enumDisplayModes(self: *const T, param0_: u32, param1_: ?*DDSURFACEDESC2, param2_: ?*anyopaque, param3_: ?LPDDENUMMODESCALLBACK2) HRESULT {
                return @as(*const IDirectDraw4.VTable, @ptrCast(self.vtable)).EnumDisplayModes(@as(*const IDirectDraw4, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn enumSurfaces(self: *const T, param0_: u32, param1_: ?*DDSURFACEDESC2, param2_: ?*anyopaque, param3_: ?LPDDENUMSURFACESCALLBACK2) HRESULT {
                return @as(*const IDirectDraw4.VTable, @ptrCast(self.vtable)).EnumSurfaces(@as(*const IDirectDraw4, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn flipToGDISurface(self: *const T) HRESULT {
                return @as(*const IDirectDraw4.VTable, @ptrCast(self.vtable)).FlipToGDISurface(@as(*const IDirectDraw4, @ptrCast(self)));
            }
            pub inline fn getCaps(self: *const T, param0_: ?*DDCAPS_DX7, param1_: ?*DDCAPS_DX7) HRESULT {
                return @as(*const IDirectDraw4.VTable, @ptrCast(self.vtable)).GetCaps(@as(*const IDirectDraw4, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getDisplayMode(self: *const T, param0_: ?*DDSURFACEDESC2) HRESULT {
                return @as(*const IDirectDraw4.VTable, @ptrCast(self.vtable)).GetDisplayMode(@as(*const IDirectDraw4, @ptrCast(self)), param0_);
            }
            pub inline fn getFourCCCodes(self: *const T, param0_: ?*u32, param1_: ?*u32) HRESULT {
                return @as(*const IDirectDraw4.VTable, @ptrCast(self.vtable)).GetFourCCCodes(@as(*const IDirectDraw4, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getGDISurface(self: *const T, param0_: ?*?*IDirectDrawSurface4) HRESULT {
                return @as(*const IDirectDraw4.VTable, @ptrCast(self.vtable)).GetGDISurface(@as(*const IDirectDraw4, @ptrCast(self)), param0_);
            }
            pub inline fn getMonitorFrequency(self: *const T, param0_: ?*u32) HRESULT {
                return @as(*const IDirectDraw4.VTable, @ptrCast(self.vtable)).GetMonitorFrequency(@as(*const IDirectDraw4, @ptrCast(self)), param0_);
            }
            pub inline fn getScanLine(self: *const T, param0_: ?*u32) HRESULT {
                return @as(*const IDirectDraw4.VTable, @ptrCast(self.vtable)).GetScanLine(@as(*const IDirectDraw4, @ptrCast(self)), param0_);
            }
            pub inline fn getVerticalBlankStatus(self: *const T, param0_: ?*i32) HRESULT {
                return @as(*const IDirectDraw4.VTable, @ptrCast(self.vtable)).GetVerticalBlankStatus(@as(*const IDirectDraw4, @ptrCast(self)), param0_);
            }
            pub inline fn initialize(self: *const T, param0_: ?*Guid) HRESULT {
                return @as(*const IDirectDraw4.VTable, @ptrCast(self.vtable)).Initialize(@as(*const IDirectDraw4, @ptrCast(self)), param0_);
            }
            pub inline fn restoreDisplayMode(self: *const T) HRESULT {
                return @as(*const IDirectDraw4.VTable, @ptrCast(self.vtable)).RestoreDisplayMode(@as(*const IDirectDraw4, @ptrCast(self)));
            }
            pub inline fn setCooperativeLevel(self: *const T, param0_: ?HWND, param1_: u32) HRESULT {
                return @as(*const IDirectDraw4.VTable, @ptrCast(self.vtable)).SetCooperativeLevel(@as(*const IDirectDraw4, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn setDisplayMode(self: *const T, param0_: u32, param1_: u32, param2_: u32, param3_: u32, param4_: u32) HRESULT {
                return @as(*const IDirectDraw4.VTable, @ptrCast(self.vtable)).SetDisplayMode(@as(*const IDirectDraw4, @ptrCast(self)), param0_, param1_, param2_, param3_, param4_);
            }
            pub inline fn waitForVerticalBlank(self: *const T, param0_: u32, param1_: ?HANDLE) HRESULT {
                return @as(*const IDirectDraw4.VTable, @ptrCast(self.vtable)).WaitForVerticalBlank(@as(*const IDirectDraw4, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getAvailableVidMem(self: *const T, param0_: ?*DDSCAPS2, param1_: ?*u32, param2_: ?*u32) HRESULT {
                return @as(*const IDirectDraw4.VTable, @ptrCast(self.vtable)).GetAvailableVidMem(@as(*const IDirectDraw4, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn getSurfaceFromDC(self: *const T, param0_: ?HDC, param1_: ?*?*IDirectDrawSurface4) HRESULT {
                return @as(*const IDirectDraw4.VTable, @ptrCast(self.vtable)).GetSurfaceFromDC(@as(*const IDirectDraw4, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn restoreAllSurfaces(self: *const T) HRESULT {
            ...
            pub inline fn getDeviceIdentifier(self: *const T, param0_: ?*DDDEVICEIDENTIFIER, param1_: u32) HRESULT {
                return @as(*const IDirectDraw4.VTable, @ptrCast(self.vtable)).GetDeviceIdentifier(@as(*const IDirectDraw4, @ptrCast(self)), param0_, param1_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectDraw7 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn createClipper(self: *const T, param0_: u32, param1_: ?*?*IDirectDrawClipper, param2_: ?*IUnknown) HRESULT {
                return @as(*const IDirectDraw7.VTable, @ptrCast(self.vtable)).CreateClipper(@as(*const IDirectDraw7, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn createPalette(self: *const T, param0_: u32, param1_: ?*PALETTEENTRY, param2_: ?*?*IDirectDrawPalette, param3_: ?*IUnknown) HRESULT {
                return @as(*const IDirectDraw7.VTable, @ptrCast(self.vtable)).CreatePalette(@as(*const IDirectDraw7, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn createSurface(self: *const T, param0_: ?*DDSURFACEDESC2, param1_: ?*?*IDirectDrawSurface7, param2_: ?*IUnknown) HRESULT {
                return @as(*const IDirectDraw7.VTable, @ptrCast(self.vtable)).CreateSurface(@as(*const IDirectDraw7, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn duplicateSurface(self: *const T, param0_: ?*IDirectDrawSurface7, param1_: ?*?*IDirectDrawSurface7) HRESULT {
                return @as(*const IDirectDraw7.VTable, @ptrCast(self.vtable)).DuplicateSurface(@as(*const IDirectDraw7, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn enumDisplayModes(self: *const T, param0_: u32, param1_: ?*DDSURFACEDESC2, param2_: ?*anyopaque, param3_: ?LPDDENUMMODESCALLBACK2) HRESULT {
                return @as(*const IDirectDraw7.VTable, @ptrCast(self.vtable)).EnumDisplayModes(@as(*const IDirectDraw7, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn enumSurfaces(self: *const T, param0_: u32, param1_: ?*DDSURFACEDESC2, param2_: ?*anyopaque, param3_: ?LPDDENUMSURFACESCALLBACK7) HRESULT {
                return @as(*const IDirectDraw7.VTable, @ptrCast(self.vtable)).EnumSurfaces(@as(*const IDirectDraw7, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn flipToGDISurface(self: *const T) HRESULT {
                return @as(*const IDirectDraw7.VTable, @ptrCast(self.vtable)).FlipToGDISurface(@as(*const IDirectDraw7, @ptrCast(self)));
            }
            pub inline fn getCaps(self: *const T, param0_: ?*DDCAPS_DX7, param1_: ?*DDCAPS_DX7) HRESULT {
                return @as(*const IDirectDraw7.VTable, @ptrCast(self.vtable)).GetCaps(@as(*const IDirectDraw7, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getDisplayMode(self: *const T, param0_: ?*DDSURFACEDESC2) HRESULT {
                return @as(*const IDirectDraw7.VTable, @ptrCast(self.vtable)).GetDisplayMode(@as(*const IDirectDraw7, @ptrCast(self)), param0_);
            }
            pub inline fn getFourCCCodes(self: *const T, param0_: ?*u32, param1_: ?*u32) HRESULT {
                return @as(*const IDirectDraw7.VTable, @ptrCast(self.vtable)).GetFourCCCodes(@as(*const IDirectDraw7, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getGDISurface(self: *const T, param0_: ?*?*IDirectDrawSurface7) HRESULT {
                return @as(*const IDirectDraw7.VTable, @ptrCast(self.vtable)).GetGDISurface(@as(*const IDirectDraw7, @ptrCast(self)), param0_);
            }
            pub inline fn getMonitorFrequency(self: *const T, param0_: ?*u32) HRESULT {
                return @as(*const IDirectDraw7.VTable, @ptrCast(self.vtable)).GetMonitorFrequency(@as(*const IDirectDraw7, @ptrCast(self)), param0_);
            }
            pub inline fn getScanLine(self: *const T, param0_: ?*u32) HRESULT {
                return @as(*const IDirectDraw7.VTable, @ptrCast(self.vtable)).GetScanLine(@as(*const IDirectDraw7, @ptrCast(self)), param0_);
            }
            pub inline fn getVerticalBlankStatus(self: *const T, param0_: ?*i32) HRESULT {
                return @as(*const IDirectDraw7.VTable, @ptrCast(self.vtable)).GetVerticalBlankStatus(@as(*const IDirectDraw7, @ptrCast(self)), param0_);
            }
            pub inline fn initialize(self: *const T, param0_: ?*Guid) HRESULT {
                return @as(*const IDirectDraw7.VTable, @ptrCast(self.vtable)).Initialize(@as(*const IDirectDraw7, @ptrCast(self)), param0_);
            }
            pub inline fn restoreDisplayMode(self: *const T) HRESULT {
                return @as(*const IDirectDraw7.VTable, @ptrCast(self.vtable)).RestoreDisplayMode(@as(*const IDirectDraw7, @ptrCast(self)));
            }
            pub inline fn setCooperativeLevel(self: *const T, param0_: ?HWND, param1_: u32) HRESULT {
                return @as(*const IDirectDraw7.VTable, @ptrCast(self.vtable)).SetCooperativeLevel(@as(*const IDirectDraw7, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn setDisplayMode(self: *const T, param0_: u32, param1_: u32, param2_: u32, param3_: u32, param4_: u32) HRESULT {
                return @as(*const IDirectDraw7.VTable, @ptrCast(self.vtable)).SetDisplayMode(@as(*const IDirectDraw7, @ptrCast(self)), param0_, param1_, param2_, param3_, param4_);
            }
            pub inline fn waitForVerticalBlank(self: *const T, param0_: u32, param1_: ?HANDLE) HRESULT {
                return @as(*const IDirectDraw7.VTable, @ptrCast(self.vtable)).WaitForVerticalBlank(@as(*const IDirectDraw7, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getAvailableVidMem(self: *const T, param0_: ?*DDSCAPS2, param1_: ?*u32, param2_: ?*u32) HRESULT {
                return @as(*const IDirectDraw7.VTable, @ptrCast(self.vtable)).GetAvailableVidMem(@as(*const IDirectDraw7, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn getSurfaceFromDC(self: *const T, param0_: ?HDC, param1_: ?*?*IDirectDrawSurface7) HRESULT {
                return @as(*const IDirectDraw7.VTable, @ptrCast(self.vtable)).GetSurfaceFromDC(@as(*const IDirectDraw7, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn restoreAllSurfaces(self: *const T) HRESULT {
            ...
            pub inline fn getDeviceIdentifier(self: *const T, param0_: ?*DDDEVICEIDENTIFIER2, param1_: u32) HRESULT {
                return @as(*const IDirectDraw7.VTable, @ptrCast(self.vtable)).GetDeviceIdentifier(@as(*const IDirectDraw7, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn startModeTest(self: *const T, param0_: ?*SIZE, param1_: u32, param2_: u32) HRESULT {
                return @as(*const IDirectDraw7.VTable, @ptrCast(self.vtable)).StartModeTest(@as(*const IDirectDraw7, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn evaluateMode(self: *const T, param0_: u32, param1_: ?*u32) HRESULT {
                return @as(*const IDirectDraw7.VTable, @ptrCast(self.vtable)).EvaluateMode(@as(*const IDirectDraw7, @ptrCast(self)), param0_, param1_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectDrawPalette = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getCaps(self: *const T, param0_: ?*u32) HRESULT {
                return @as(*const IDirectDrawPalette.VTable, @ptrCast(self.vtable)).GetCaps(@as(*const IDirectDrawPalette, @ptrCast(self)), param0_);
            }
            pub inline fn getEntries(self: *const T, param0_: u32, param1_: u32, param2_: u32, param3_: ?*PALETTEENTRY) HRESULT {
                return @as(*const IDirectDrawPalette.VTable, @ptrCast(self.vtable)).GetEntries(@as(*const IDirectDrawPalette, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn initialize(self: *const T, param0_: ?*IDirectDraw, param1_: u32, param2_: ?*PALETTEENTRY) HRESULT {
                return @as(*const IDirectDrawPalette.VTable, @ptrCast(self.vtable)).Initialize(@as(*const IDirectDrawPalette, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn setEntries(self: *const T, param0_: u32, param1_: u32, param2_: u32, param3_: ?*PALETTEENTRY) HRESULT {
                return @as(*const IDirectDrawPalette.VTable, @ptrCast(self.vtable)).SetEntries(@as(*const IDirectDrawPalette, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectDrawClipper = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getClipList(self: *const T, param0_: ?*RECT, param1_: ?*RGNDATA, param2_: ?*u32) HRESULT {
                return @as(*const IDirectDrawClipper.VTable, @ptrCast(self.vtable)).GetClipList(@as(*const IDirectDrawClipper, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn getHWnd(self: *const T, param0_: ?*?HWND) HRESULT {
                return @as(*const IDirectDrawClipper.VTable, @ptrCast(self.vtable)).GetHWnd(@as(*const IDirectDrawClipper, @ptrCast(self)), param0_);
            }
            pub inline fn initialize(self: *const T, param0_: ?*IDirectDraw, param1_: u32) HRESULT {
                return @as(*const IDirectDrawClipper.VTable, @ptrCast(self.vtable)).Initialize(@as(*const IDirectDrawClipper, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn isClipListChanged(self: *const T, param0_: ?*BOOL) HRESULT {
                return @as(*const IDirectDrawClipper.VTable, @ptrCast(self.vtable)).IsClipListChanged(@as(*const IDirectDrawClipper, @ptrCast(self)), param0_);
            }
            pub inline fn setClipList(self: *const T, param0_: ?*RGNDATA, param1_: u32) HRESULT {
                return @as(*const IDirectDrawClipper.VTable, @ptrCast(self.vtable)).SetClipList(@as(*const IDirectDrawClipper, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn setHWnd(self: *const T, param0_: u32, param1_: ?HWND) HRESULT {
                return @as(*const IDirectDrawClipper.VTable, @ptrCast(self.vtable)).SetHWnd(@as(*const IDirectDrawClipper, @ptrCast(self)), param0_, param1_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectDrawSurface = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn addAttachedSurface(self: *const T, param0_: ?*IDirectDrawSurface) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).AddAttachedSurface(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_);
            }
            pub inline fn addOverlayDirtyRect(self: *const T, param0_: ?*RECT) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).AddOverlayDirtyRect(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_);
            }
            pub inline fn blt(self: *const T, param0_: ?*RECT, param1_: ?*IDirectDrawSurface, param2_: ?*RECT, param3_: u32, param4_: ?*DDBLTFX) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).Blt(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_, param1_, param2_, param3_, param4_);
            }
            pub inline fn bltBatch(self: *const T, param0_: ?*DDBLTBATCH, param1_: u32, param2_: u32) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).BltBatch(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn bltFast(self: *const T, param0_: u32, param1_: u32, param2_: ?*IDirectDrawSurface, param3_: ?*RECT, param4_: u32) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).BltFast(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_, param1_, param2_, param3_, param4_);
            }
            pub inline fn deleteAttachedSurface(self: *const T, param0_: u32, param1_: ?*IDirectDrawSurface) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).DeleteAttachedSurface(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn enumAttachedSurfaces(self: *const T, param0_: ?*anyopaque, param1_: ?LPDDENUMSURFACESCALLBACK) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).EnumAttachedSurfaces(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn enumOverlayZOrders(self: *const T, param0_: u32, param1_: ?*anyopaque, param2_: ?LPDDENUMSURFACESCALLBACK) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).EnumOverlayZOrders(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn flip(self: *const T, param0_: ?*IDirectDrawSurface, param1_: u32) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).Flip(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getAttachedSurface(self: *const T, param0_: ?*DDSCAPS, param1_: ?*?*IDirectDrawSurface) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).GetAttachedSurface(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getBltStatus(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).GetBltStatus(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_);
            }
            pub inline fn getCaps(self: *const T, param0_: ?*DDSCAPS) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).GetCaps(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_);
            }
            pub inline fn getClipper(self: *const T, param0_: ?*?*IDirectDrawClipper) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).GetClipper(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_);
            }
            pub inline fn getColorKey(self: *const T, param0_: u32, param1_: ?*DDCOLORKEY) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).GetColorKey(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getDC(self: *const T, param0_: ?*?HDC) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).GetDC(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_);
            }
            pub inline fn getFlipStatus(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).GetFlipStatus(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_);
            }
            pub inline fn getOverlayPosition(self: *const T, param0_: ?*i32, param1_: ?*i32) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).GetOverlayPosition(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getPalette(self: *const T, param0_: ?*?*IDirectDrawPalette) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).GetPalette(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_);
            }
            pub inline fn getPixelFormat(self: *const T, param0_: ?*DDPIXELFORMAT) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).GetPixelFormat(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_);
            }
            pub inline fn getSurfaceDesc(self: *const T, param0_: ?*DDSURFACEDESC) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).GetSurfaceDesc(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_);
            }
            pub inline fn initialize(self: *const T, param0_: ?*IDirectDraw, param1_: ?*DDSURFACEDESC) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).Initialize(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn isLost(self: *const T) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).IsLost(@as(*const IDirectDrawSurface, @ptrCast(self)));
            }
            pub inline fn lock(self: *const T, param0_: ?*RECT, param1_: ?*DDSURFACEDESC, param2_: u32, param3_: ?HANDLE) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).Lock(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn releaseDC(self: *const T, param0_: ?HDC) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).ReleaseDC(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_);
            }
            ...
            pub inline fn setClipper(self: *const T, param0_: ?*IDirectDrawClipper) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).SetClipper(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_);
            }
            pub inline fn setColorKey(self: *const T, param0_: u32, param1_: ?*DDCOLORKEY) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).SetColorKey(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn setOverlayPosition(self: *const T, param0_: i32, param1_: i32) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).SetOverlayPosition(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn setPalette(self: *const T, param0_: ?*IDirectDrawPalette) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).SetPalette(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_);
            }
            pub inline fn unlock(self: *const T, param0_: ?*anyopaque) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).Unlock(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_);
            }
            pub inline fn updateOverlay(self: *const T, param0_: ?*RECT, param1_: ?*IDirectDrawSurface, param2_: ?*RECT, param3_: u32, param4_: ?*DDOVERLAYFX) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).UpdateOverlay(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_, param1_, param2_, param3_, param4_);
            }
            pub inline fn updateOverlayDisplay(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).UpdateOverlayDisplay(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_);
            }
            pub inline fn updateOverlayZOrder(self: *const T, param0_: u32, param1_: ?*IDirectDrawSurface) HRESULT {
                return @as(*const IDirectDrawSurface.VTable, @ptrCast(self.vtable)).UpdateOverlayZOrder(@as(*const IDirectDrawSurface, @ptrCast(self)), param0_, param1_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectDrawSurface2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn addAttachedSurface(self: *const T, param0_: ?*IDirectDrawSurface2) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).AddAttachedSurface(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_);
            }
            pub inline fn addOverlayDirtyRect(self: *const T, param0_: ?*RECT) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).AddOverlayDirtyRect(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_);
            }
            pub inline fn blt(self: *const T, param0_: ?*RECT, param1_: ?*IDirectDrawSurface2, param2_: ?*RECT, param3_: u32, param4_: ?*DDBLTFX) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).Blt(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_, param1_, param2_, param3_, param4_);
            }
            pub inline fn bltBatch(self: *const T, param0_: ?*DDBLTBATCH, param1_: u32, param2_: u32) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).BltBatch(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn bltFast(self: *const T, param0_: u32, param1_: u32, param2_: ?*IDirectDrawSurface2, param3_: ?*RECT, param4_: u32) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).BltFast(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_, param1_, param2_, param3_, param4_);
            }
            pub inline fn deleteAttachedSurface(self: *const T, param0_: u32, param1_: ?*IDirectDrawSurface2) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).DeleteAttachedSurface(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn enumAttachedSurfaces(self: *const T, param0_: ?*anyopaque, param1_: ?LPDDENUMSURFACESCALLBACK) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).EnumAttachedSurfaces(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn enumOverlayZOrders(self: *const T, param0_: u32, param1_: ?*anyopaque, param2_: ?LPDDENUMSURFACESCALLBACK) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).EnumOverlayZOrders(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn flip(self: *const T, param0_: ?*IDirectDrawSurface2, param1_: u32) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).Flip(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getAttachedSurface(self: *const T, param0_: ?*DDSCAPS, param1_: ?*?*IDirectDrawSurface2) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).GetAttachedSurface(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getBltStatus(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).GetBltStatus(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_);
            }
            pub inline fn getCaps(self: *const T, param0_: ?*DDSCAPS) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).GetCaps(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_);
            }
            pub inline fn getClipper(self: *const T, param0_: ?*?*IDirectDrawClipper) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).GetClipper(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_);
            }
            pub inline fn getColorKey(self: *const T, param0_: u32, param1_: ?*DDCOLORKEY) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).GetColorKey(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getDC(self: *const T, param0_: ?*?HDC) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).GetDC(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_);
            }
            pub inline fn getFlipStatus(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).GetFlipStatus(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_);
            }
            pub inline fn getOverlayPosition(self: *const T, param0_: ?*i32, param1_: ?*i32) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).GetOverlayPosition(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getPalette(self: *const T, param0_: ?*?*IDirectDrawPalette) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).GetPalette(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_);
            }
            pub inline fn getPixelFormat(self: *const T, param0_: ?*DDPIXELFORMAT) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).GetPixelFormat(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_);
            }
            pub inline fn getSurfaceDesc(self: *const T, param0_: ?*DDSURFACEDESC) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).GetSurfaceDesc(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_);
            }
            pub inline fn initialize(self: *const T, param0_: ?*IDirectDraw, param1_: ?*DDSURFACEDESC) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).Initialize(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn isLost(self: *const T) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).IsLost(@as(*const IDirectDrawSurface2, @ptrCast(self)));
            }
            pub inline fn lock(self: *const T, param0_: ?*RECT, param1_: ?*DDSURFACEDESC, param2_: u32, param3_: ?HANDLE) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).Lock(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn releaseDC(self: *const T, param0_: ?HDC) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).ReleaseDC(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_);
            }
            pub inline fn restore(self: *const T) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).Restore(@as(*const IDirectDrawSurface2, @ptrCast(self)));
            }
            pub inline fn setClipper(self: *const T, param0_: ?*IDirectDrawClipper) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).SetClipper(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_);
            }
            pub inline fn setColorKey(self: *const T, param0_: u32, param1_: ?*DDCOLORKEY) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).SetColorKey(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn setOverlayPosition(self: *const T, param0_: i32, param1_: i32) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).SetOverlayPosition(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn setPalette(self: *const T, param0_: ?*IDirectDrawPalette) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).SetPalette(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_);
            }
            pub inline fn unlock(self: *const T, param0_: ?*anyopaque) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).Unlock(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_);
            }
            pub inline fn updateOverlay(self: *const T, param0_: ?*RECT, param1_: ?*IDirectDrawSurface2, param2_: ?*RECT, param3_: u32, param4_: ?*DDOVERLAYFX) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).UpdateOverlay(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_, param1_, param2_, param3_, param4_);
            }
            pub inline fn updateOverlayDisplay(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).UpdateOverlayDisplay(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_);
            }
            pub inline fn updateOverlayZOrder(self: *const T, param0_: u32, param1_: ?*IDirectDrawSurface2) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).UpdateOverlayZOrder(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getDDInterface(self: *const T, param0_: ?*?*anyopaque) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).GetDDInterface(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_);
            }
            pub inline fn pageLock(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).PageLock(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_);
            }
            pub inline fn pageUnlock(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectDrawSurface2.VTable, @ptrCast(self.vtable)).PageUnlock(@as(*const IDirectDrawSurface2, @ptrCast(self)), param0_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectDrawSurface3 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn addAttachedSurface(self: *const T, param0_: ?*IDirectDrawSurface3) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).AddAttachedSurface(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_);
            }
            pub inline fn addOverlayDirtyRect(self: *const T, param0_: ?*RECT) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).AddOverlayDirtyRect(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_);
            }
            pub inline fn blt(self: *const T, param0_: ?*RECT, param1_: ?*IDirectDrawSurface3, param2_: ?*RECT, param3_: u32, param4_: ?*DDBLTFX) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).Blt(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_, param1_, param2_, param3_, param4_);
            }
            pub inline fn bltBatch(self: *const T, param0_: ?*DDBLTBATCH, param1_: u32, param2_: u32) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).BltBatch(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn bltFast(self: *const T, param0_: u32, param1_: u32, param2_: ?*IDirectDrawSurface3, param3_: ?*RECT, param4_: u32) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).BltFast(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_, param1_, param2_, param3_, param4_);
            }
            pub inline fn deleteAttachedSurface(self: *const T, param0_: u32, param1_: ?*IDirectDrawSurface3) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).DeleteAttachedSurface(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn enumAttachedSurfaces(self: *const T, param0_: ?*anyopaque, param1_: ?LPDDENUMSURFACESCALLBACK) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).EnumAttachedSurfaces(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn enumOverlayZOrders(self: *const T, param0_: u32, param1_: ?*anyopaque, param2_: ?LPDDENUMSURFACESCALLBACK) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).EnumOverlayZOrders(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn flip(self: *const T, param0_: ?*IDirectDrawSurface3, param1_: u32) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).Flip(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getAttachedSurface(self: *const T, param0_: ?*DDSCAPS, param1_: ?*?*IDirectDrawSurface3) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).GetAttachedSurface(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getBltStatus(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).GetBltStatus(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_);
            }
            pub inline fn getCaps(self: *const T, param0_: ?*DDSCAPS) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).GetCaps(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_);
            }
            pub inline fn getClipper(self: *const T, param0_: ?*?*IDirectDrawClipper) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).GetClipper(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_);
            }
            pub inline fn getColorKey(self: *const T, param0_: u32, param1_: ?*DDCOLORKEY) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).GetColorKey(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getDC(self: *const T, param0_: ?*?HDC) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).GetDC(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_);
            }
            pub inline fn getFlipStatus(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).GetFlipStatus(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_);
            }
            pub inline fn getOverlayPosition(self: *const T, param0_: ?*i32, param1_: ?*i32) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).GetOverlayPosition(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getPalette(self: *const T, param0_: ?*?*IDirectDrawPalette) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).GetPalette(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_);
            }
            pub inline fn getPixelFormat(self: *const T, param0_: ?*DDPIXELFORMAT) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).GetPixelFormat(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_);
            }
            pub inline fn getSurfaceDesc(self: *const T, param0_: ?*DDSURFACEDESC) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).GetSurfaceDesc(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_);
            }
            pub inline fn initialize(self: *const T, param0_: ?*IDirectDraw, param1_: ?*DDSURFACEDESC) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).Initialize(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn isLost(self: *const T) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).IsLost(@as(*const IDirectDrawSurface3, @ptrCast(self)));
            }
            pub inline fn lock(self: *const T, param0_: ?*RECT, param1_: ?*DDSURFACEDESC, param2_: u32, param3_: ?HANDLE) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).Lock(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn releaseDC(self: *const T, param0_: ?HDC) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).ReleaseDC(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_);
            }
            pub inline fn restore(self: *const T) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).Restore(@as(*const IDirectDrawSurface3, @ptrCast(self)));
            }
            pub inline fn setClipper(self: *const T, param0_: ?*IDirectDrawClipper) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).SetClipper(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_);
            }
            pub inline fn setColorKey(self: *const T, param0_: u32, param1_: ?*DDCOLORKEY) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).SetColorKey(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn setOverlayPosition(self: *const T, param0_: i32, param1_: i32) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).SetOverlayPosition(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn setPalette(self: *const T, param0_: ?*IDirectDrawPalette) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).SetPalette(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_);
            }
            pub inline fn unlock(self: *const T, param0_: ?*anyopaque) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).Unlock(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_);
            }
            pub inline fn updateOverlay(self: *const T, param0_: ?*RECT, param1_: ?*IDirectDrawSurface3, param2_: ?*RECT, param3_: u32, param4_: ?*DDOVERLAYFX) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).UpdateOverlay(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_, param1_, param2_, param3_, param4_);
            }
            pub inline fn updateOverlayDisplay(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).UpdateOverlayDisplay(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_);
            }
            pub inline fn updateOverlayZOrder(self: *const T, param0_: u32, param1_: ?*IDirectDrawSurface3) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).UpdateOverlayZOrder(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getDDInterface(self: *const T, param0_: ?*?*anyopaque) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).GetDDInterface(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_);
            }
            pub inline fn pageLock(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).PageLock(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_);
            }
            pub inline fn pageUnlock(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).PageUnlock(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_);
            }
            pub inline fn setSurfaceDesc(self: *const T, param0_: ?*DDSURFACEDESC, param1_: u32) HRESULT {
                return @as(*const IDirectDrawSurface3.VTable, @ptrCast(self.vtable)).SetSurfaceDesc(@as(*const IDirectDrawSurface3, @ptrCast(self)), param0_, param1_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectDrawSurface4 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn addAttachedSurface(self: *const T, param0_: ?*IDirectDrawSurface4) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).AddAttachedSurface(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_);
            }
            pub inline fn addOverlayDirtyRect(self: *const T, param0_: ?*RECT) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).AddOverlayDirtyRect(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_);
            }
            pub inline fn blt(self: *const T, param0_: ?*RECT, param1_: ?*IDirectDrawSurface4, param2_: ?*RECT, param3_: u32, param4_: ?*DDBLTFX) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).Blt(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_, param1_, param2_, param3_, param4_);
            }
            pub inline fn bltBatch(self: *const T, param0_: ?*DDBLTBATCH, param1_: u32, param2_: u32) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).BltBatch(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn bltFast(self: *const T, param0_: u32, param1_: u32, param2_: ?*IDirectDrawSurface4, param3_: ?*RECT, param4_: u32) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).BltFast(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_, param1_, param2_, param3_, param4_);
            }
            pub inline fn deleteAttachedSurface(self: *const T, param0_: u32, param1_: ?*IDirectDrawSurface4) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).DeleteAttachedSurface(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn enumAttachedSurfaces(self: *const T, param0_: ?*anyopaque, param1_: ?LPDDENUMSURFACESCALLBACK2) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).EnumAttachedSurfaces(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn enumOverlayZOrders(self: *const T, param0_: u32, param1_: ?*anyopaque, param2_: ?LPDDENUMSURFACESCALLBACK2) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).EnumOverlayZOrders(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn flip(self: *const T, param0_: ?*IDirectDrawSurface4, param1_: u32) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).Flip(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getAttachedSurface(self: *const T, param0_: ?*DDSCAPS2, param1_: ?*?*IDirectDrawSurface4) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).GetAttachedSurface(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getBltStatus(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).GetBltStatus(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_);
            }
            pub inline fn getCaps(self: *const T, param0_: ?*DDSCAPS2) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).GetCaps(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_);
            }
            pub inline fn getClipper(self: *const T, param0_: ?*?*IDirectDrawClipper) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).GetClipper(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_);
            }
            pub inline fn getColorKey(self: *const T, param0_: u32, param1_: ?*DDCOLORKEY) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).GetColorKey(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getDC(self: *const T, param0_: ?*?HDC) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).GetDC(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_);
            }
            pub inline fn getFlipStatus(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).GetFlipStatus(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_);
            }
            pub inline fn getOverlayPosition(self: *const T, param0_: ?*i32, param1_: ?*i32) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).GetOverlayPosition(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getPalette(self: *const T, param0_: ?*?*IDirectDrawPalette) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).GetPalette(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_);
            }
            pub inline fn getPixelFormat(self: *const T, param0_: ?*DDPIXELFORMAT) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).GetPixelFormat(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_);
            }
            pub inline fn getSurfaceDesc(self: *const T, param0_: ?*DDSURFACEDESC2) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).GetSurfaceDesc(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_);
            }
            pub inline fn initialize(self: *const T, param0_: ?*IDirectDraw, param1_: ?*DDSURFACEDESC2) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).Initialize(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn isLost(self: *const T) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).IsLost(@as(*const IDirectDrawSurface4, @ptrCast(self)));
            }
            pub inline fn lock(self: *const T, param0_: ?*RECT, param1_: ?*DDSURFACEDESC2, param2_: u32, param3_: ?HANDLE) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).Lock(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn releaseDC(self: *const T, param0_: ?HDC) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).ReleaseDC(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_);
            }
            pub inline fn restore(self: *const T) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).Restore(@as(*const IDirectDrawSurface4, @ptrCast(self)));
            }
            pub inline fn setClipper(self: *const T, param0_: ?*IDirectDrawClipper) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).SetClipper(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_);
            }
            pub inline fn setColorKey(self: *const T, param0_: u32, param1_: ?*DDCOLORKEY) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).SetColorKey(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn setOverlayPosition(self: *const T, param0_: i32, param1_: i32) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).SetOverlayPosition(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn setPalette(self: *const T, param0_: ?*IDirectDrawPalette) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).SetPalette(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_);
            }
            pub inline fn unlock(self: *const T, param0_: ?*RECT) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).Unlock(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_);
            }
            pub inline fn updateOverlay(self: *const T, param0_: ?*RECT, param1_: ?*IDirectDrawSurface4, param2_: ?*RECT, param3_: u32, param4_: ?*DDOVERLAYFX) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).UpdateOverlay(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_, param1_, param2_, param3_, param4_);
            }
            pub inline fn updateOverlayDisplay(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).UpdateOverlayDisplay(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_);
            }
            pub inline fn updateOverlayZOrder(self: *const T, param0_: u32, param1_: ?*IDirectDrawSurface4) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).UpdateOverlayZOrder(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getDDInterface(self: *const T, param0_: ?*?*anyopaque) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).GetDDInterface(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_);
            }
            pub inline fn pageLock(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).PageLock(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_);
            }
            pub inline fn pageUnlock(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).PageUnlock(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_);
            }
            pub inline fn setSurfaceDesc(self: *const T, param0_: ?*DDSURFACEDESC2, param1_: u32) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).SetSurfaceDesc(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn setPrivateData(self: *const T, param0_: ?*const Guid, param1_: ?*anyopaque, param2_: u32, param3_: u32) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).SetPrivateData(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn getPrivateData(self: *const T, param0_: ?*const Guid, param1_: ?*anyopaque, param2_: ?*u32) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).GetPrivateData(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn freePrivateData(self: *const T, param0_: ?*const Guid) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).FreePrivateData(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_);
            }
            pub inline fn getUniquenessValue(self: *const T, param0_: ?*u32) HRESULT {
                return @as(*const IDirectDrawSurface4.VTable, @ptrCast(self.vtable)).GetUniquenessValue(@as(*const IDirectDrawSurface4, @ptrCast(self)), param0_);
            }
            pub inline fn changeUniquenessValue(self: *const T) HRESULT {
...
pub const IDirectDrawSurface7 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn addAttachedSurface(self: *const T, param0_: ?*IDirectDrawSurface7) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).AddAttachedSurface(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_);
            }
            pub inline fn addOverlayDirtyRect(self: *const T, param0_: ?*RECT) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).AddOverlayDirtyRect(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_);
            }
            pub inline fn blt(self: *const T, param0_: ?*RECT, param1_: ?*IDirectDrawSurface7, param2_: ?*RECT, param3_: u32, param4_: ?*DDBLTFX) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).Blt(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_, param1_, param2_, param3_, param4_);
            }
            pub inline fn bltBatch(self: *const T, param0_: ?*DDBLTBATCH, param1_: u32, param2_: u32) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).BltBatch(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn bltFast(self: *const T, param0_: u32, param1_: u32, param2_: ?*IDirectDrawSurface7, param3_: ?*RECT, param4_: u32) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).BltFast(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_, param1_, param2_, param3_, param4_);
            }
            pub inline fn deleteAttachedSurface(self: *const T, param0_: u32, param1_: ?*IDirectDrawSurface7) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).DeleteAttachedSurface(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn enumAttachedSurfaces(self: *const T, param0_: ?*anyopaque, param1_: ?LPDDENUMSURFACESCALLBACK7) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).EnumAttachedSurfaces(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn enumOverlayZOrders(self: *const T, param0_: u32, param1_: ?*anyopaque, param2_: ?LPDDENUMSURFACESCALLBACK7) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).EnumOverlayZOrders(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn flip(self: *const T, param0_: ?*IDirectDrawSurface7, param1_: u32) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).Flip(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getAttachedSurface(self: *const T, param0_: ?*DDSCAPS2, param1_: ?*?*IDirectDrawSurface7) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).GetAttachedSurface(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getBltStatus(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).GetBltStatus(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_);
            }
            pub inline fn getCaps(self: *const T, param0_: ?*DDSCAPS2) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).GetCaps(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_);
            }
            pub inline fn getClipper(self: *const T, param0_: ?*?*IDirectDrawClipper) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).GetClipper(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_);
            }
            pub inline fn getColorKey(self: *const T, param0_: u32, param1_: ?*DDCOLORKEY) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).GetColorKey(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getDC(self: *const T, param0_: ?*?HDC) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).GetDC(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_);
            }
            pub inline fn getFlipStatus(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).GetFlipStatus(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_);
            }
            pub inline fn getOverlayPosition(self: *const T, param0_: ?*i32, param1_: ?*i32) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).GetOverlayPosition(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getPalette(self: *const T, param0_: ?*?*IDirectDrawPalette) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).GetPalette(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_);
            }
            pub inline fn getPixelFormat(self: *const T, param0_: ?*DDPIXELFORMAT) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).GetPixelFormat(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_);
            }
            pub inline fn getSurfaceDesc(self: *const T, param0_: ?*DDSURFACEDESC2) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).GetSurfaceDesc(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_);
            }
            pub inline fn initialize(self: *const T, param0_: ?*IDirectDraw, param1_: ?*DDSURFACEDESC2) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).Initialize(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn isLost(self: *const T) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).IsLost(@as(*const IDirectDrawSurface7, @ptrCast(self)));
            }
            pub inline fn lock(self: *const T, param0_: ?*RECT, param1_: ?*DDSURFACEDESC2, param2_: u32, param3_: ?HANDLE) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).Lock(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn releaseDC(self: *const T, param0_: ?HDC) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).ReleaseDC(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_);
            }
            pub inline fn restore(self: *const T) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).Restore(@as(*const IDirectDrawSurface7, @ptrCast(self)));
            }
            pub inline fn setClipper(self: *const T, param0_: ?*IDirectDrawClipper) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).SetClipper(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_);
            }
            pub inline fn setColorKey(self: *const T, param0_: u32, param1_: ?*DDCOLORKEY) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).SetColorKey(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn setOverlayPosition(self: *const T, param0_: i32, param1_: i32) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).SetOverlayPosition(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn setPalette(self: *const T, param0_: ?*IDirectDrawPalette) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).SetPalette(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_);
            }
            pub inline fn unlock(self: *const T, param0_: ?*RECT) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).Unlock(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_);
            }
            pub inline fn updateOverlay(self: *const T, param0_: ?*RECT, param1_: ?*IDirectDrawSurface7, param2_: ?*RECT, param3_: u32, param4_: ?*DDOVERLAYFX) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).UpdateOverlay(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_, param1_, param2_, param3_, param4_);
            }
            pub inline fn updateOverlayDisplay(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).UpdateOverlayDisplay(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_);
            }
            pub inline fn updateOverlayZOrder(self: *const T, param0_: u32, param1_: ?*IDirectDrawSurface7) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).UpdateOverlayZOrder(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getDDInterface(self: *const T, param0_: ?*?*anyopaque) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).GetDDInterface(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_);
            }
            pub inline fn pageLock(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).PageLock(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_);
            }
            pub inline fn pageUnlock(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).PageUnlock(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_);
            }
            pub inline fn setSurfaceDesc(self: *const T, param0_: ?*DDSURFACEDESC2, param1_: u32) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).SetSurfaceDesc(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn setPrivateData(self: *const T, param0_: ?*const Guid, param1_: ?*anyopaque, param2_: u32, param3_: u32) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).SetPrivateData(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn getPrivateData(self: *const T, param0_: ?*const Guid, param1_: ?*anyopaque, param2_: ?*u32) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).GetPrivateData(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_, param1_, param2_);
            }
            pub inline fn freePrivateData(self: *const T, param0_: ?*const Guid) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).FreePrivateData(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_);
            }
            pub inline fn getUniquenessValue(self: *const T, param0_: ?*u32) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).GetUniquenessValue(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_);
            }
            pub inline fn changeUniquenessValue(self: *const T) HRESULT {
            ...
            pub inline fn setPriority(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).SetPriority(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_);
            }
            pub inline fn getPriority(self: *const T, param0_: ?*u32) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).GetPriority(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_);
            }
            pub inline fn setLOD(self: *const T, param0_: u32) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).SetLOD(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_);
            }
            pub inline fn getLOD(self: *const T, param0_: ?*u32) HRESULT {
                return @as(*const IDirectDrawSurface7.VTable, @ptrCast(self.vtable)).GetLOD(@as(*const IDirectDrawSurface7, @ptrCast(self)), param0_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectDrawColorControl = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getColorControls(self: *const T, param0_: ?*DDCOLORCONTROL) HRESULT {
                return @as(*const IDirectDrawColorControl.VTable, @ptrCast(self.vtable)).GetColorControls(@as(*const IDirectDrawColorControl, @ptrCast(self)), param0_);
            }
            pub inline fn setColorControls(self: *const T, param0_: ?*DDCOLORCONTROL) HRESULT {
                return @as(*const IDirectDrawColorControl.VTable, @ptrCast(self.vtable)).SetColorControls(@as(*const IDirectDrawColorControl, @ptrCast(self)), param0_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectDrawGammaControl = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getGammaRamp(self: *const T, param0_: u32, param1_: ?*DDGAMMARAMP) HRESULT {
                return @as(*const IDirectDrawGammaControl.VTable, @ptrCast(self.vtable)).GetGammaRamp(@as(*const IDirectDrawGammaControl, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn setGammaRamp(self: *const T, param0_: u32, param1_: ?*DDGAMMARAMP) HRESULT {
                return @as(*const IDirectDrawGammaControl.VTable, @ptrCast(self.vtable)).SetGammaRamp(@as(*const IDirectDrawGammaControl, @ptrCast(self)), param0_, param1_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDDVideoPortContainer = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn createVideoPort(self: *const T, param0_: u32, param1_: ?*DDVIDEOPORTDESC, param2_: ?*?*IDirectDrawVideoPort, param3_: ?*IUnknown) HRESULT {
                return @as(*const IDDVideoPortContainer.VTable, @ptrCast(self.vtable)).CreateVideoPort(@as(*const IDDVideoPortContainer, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn enumVideoPorts(self: *const T, param0_: u32, param1_: ?*DDVIDEOPORTCAPS, param2_: ?*anyopaque, param3_: ?LPDDENUMVIDEOCALLBACK) HRESULT {
                return @as(*const IDDVideoPortContainer.VTable, @ptrCast(self.vtable)).EnumVideoPorts(@as(*const IDDVideoPortContainer, @ptrCast(self)), param0_, param1_, param2_, param3_);
            }
            pub inline fn getVideoPortConnectInfo(self: *const T, param0_: u32, pc_info_: ?*u32, param2_: ?[*]DDVIDEOPORTCONNECT) HRESULT {
                return @as(*const IDDVideoPortContainer.VTable, @ptrCast(self.vtable)).GetVideoPortConnectInfo(@as(*const IDDVideoPortContainer, @ptrCast(self)), param0_, pc_info_, param2_);
            }
            pub inline fn queryVideoPortStatus(self: *const T, param0_: u32, param1_: ?*DDVIDEOPORTSTATUS) HRESULT {
                return @as(*const IDDVideoPortContainer.VTable, @ptrCast(self.vtable)).QueryVideoPortStatus(@as(*const IDDVideoPortContainer, @ptrCast(self)), param0_, param1_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectDrawVideoPort = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn flip(self: *const T, param0_: ?*IDirectDrawSurface, param1_: u32) HRESULT {
                return @as(*const IDirectDrawVideoPort.VTable, @ptrCast(self.vtable)).Flip(@as(*const IDirectDrawVideoPort, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn getBandwidthInfo(self: *const T, param0_: ?*DDPIXELFORMAT, param1_: u32, param2_: u32, param3_: u32, param4_: ?*DDVIDEOPORTBANDWIDTH) HRESULT {
                return @as(*const IDirectDrawVideoPort.VTable, @ptrCast(self.vtable)).GetBandwidthInfo(@as(*const IDirectDrawVideoPort, @ptrCast(self)), param0_, param1_, param2_, param3_, param4_);
            }
            pub inline fn getColorControls(self: *const T, param0_: ?*DDCOLORCONTROL) HRESULT {
                return @as(*const IDirectDrawVideoPort.VTable, @ptrCast(self.vtable)).GetColorControls(@as(*const IDirectDrawVideoPort, @ptrCast(self)), param0_);
            }
            pub inline fn getInputFormats(self: *const T, lp_num_formats_: ?*u32, param1_: ?[*]DDPIXELFORMAT, param2_: u32) HRESULT {
                return @as(*const IDirectDrawVideoPort.VTable, @ptrCast(self.vtable)).GetInputFormats(@as(*const IDirectDrawVideoPort, @ptrCast(self)), lp_num_formats_, param1_, param2_);
            }
            pub inline fn getOutputFormats(self: *const T, param0_: ?*DDPIXELFORMAT, lp_num_formats_: ?*u32, param2_: ?[*]DDPIXELFORMAT, param3_: u32) HRESULT {
                return @as(*const IDirectDrawVideoPort.VTable, @ptrCast(self.vtable)).GetOutputFormats(@as(*const IDirectDrawVideoPort, @ptrCast(self)), param0_, lp_num_formats_, param2_, param3_);
            }
            pub inline fn getFieldPolarity(self: *const T, param0_: ?*i32) HRESULT {
                return @as(*const IDirectDrawVideoPort.VTable, @ptrCast(self.vtable)).GetFieldPolarity(@as(*const IDirectDrawVideoPort, @ptrCast(self)), param0_);
            }
            pub inline fn getVideoLine(self: *const T, param0_: ?*u32) HRESULT {
                return @as(*const IDirectDrawVideoPort.VTable, @ptrCast(self.vtable)).GetVideoLine(@as(*const IDirectDrawVideoPort, @ptrCast(self)), param0_);
            }
            pub inline fn getVideoSignalStatus(self: *const T, param0_: ?*u32) HRESULT {
                return @as(*const IDirectDrawVideoPort.VTable, @ptrCast(self.vtable)).GetVideoSignalStatus(@as(*const IDirectDrawVideoPort, @ptrCast(self)), param0_);
            }
            pub inline fn setColorControls(self: *const T, param0_: ?*DDCOLORCONTROL) HRESULT {
                return @as(*const IDirectDrawVideoPort.VTable, @ptrCast(self.vtable)).SetColorControls(@as(*const IDirectDrawVideoPort, @ptrCast(self)), param0_);
            }
            pub inline fn setTargetSurface(self: *const T, param0_: ?*IDirectDrawSurface, param1_: u32) HRESULT {
                return @as(*const IDirectDrawVideoPort.VTable, @ptrCast(self.vtable)).SetTargetSurface(@as(*const IDirectDrawVideoPort, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn startVideo(self: *const T, param0_: ?*DDVIDEOPORTINFO) HRESULT {
                return @as(*const IDirectDrawVideoPort.VTable, @ptrCast(self.vtable)).StartVideo(@as(*const IDirectDrawVideoPort, @ptrCast(self)), param0_);
            }
            pub inline fn stopVideo(self: *const T) HRESULT {
                return @as(*const IDirectDrawVideoPort.VTable, @ptrCast(self.vtable)).StopVideo(@as(*const IDirectDrawVideoPort, @ptrCast(self)));
            }
            pub inline fn updateVideo(self: *const T, param0_: ?*DDVIDEOPORTINFO) HRESULT {
                return @as(*const IDirectDrawVideoPort.VTable, @ptrCast(self.vtable)).UpdateVideo(@as(*const IDirectDrawVideoPort, @ptrCast(self)), param0_);
            }
            pub inline fn waitForSync(self: *const T, param0_: u32, param1_: u32, param2_: u32) HRESULT {
                return @as(*const IDirectDrawVideoPort.VTable, @ptrCast(self.vtable)).WaitForSync(@as(*const IDirectDrawVideoPort, @ptrCast(self)), param0_, param1_, param2_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectDrawVideoPortNotify = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn acquireNotification(self: *const T, param0_: ?*?HANDLE, param1_: ?*DDVIDEOPORTNOTIFY) HRESULT {
                return @as(*const IDirectDrawVideoPortNotify.VTable, @ptrCast(self.vtable)).AcquireNotification(@as(*const IDirectDrawVideoPortNotify, @ptrCast(self)), param0_, param1_);
            }
            pub inline fn releaseNotification(self: *const T, param0_: ?HANDLE) HRESULT {
                return @as(*const IDirectDrawVideoPortNotify.VTable, @ptrCast(self.vtable)).ReleaseNotification(@as(*const IDirectDrawVideoPortNotify, @ptrCast(self)), param0_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDirectDrawKernel = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getCaps(self: *const T, param0_: ?*DDKERNELCAPS) HRESULT {
                return @as(*const IDirectDrawKernel.VTable, @ptrCast(self.vtable)).GetCaps(@as(*const IDirectDrawKernel, @ptrCast(self)), param0_);
            }
            pub inline fn getKernelHandle(self: *const T, param0_: ?*usize) HRESULT {
                return @as(*const IDirectDrawKernel.VTable, @ptrCast(self.vtable)).GetKernelHandle(@as(*const IDirectDrawKernel, @ptrCast(self)), param0_);
            }
            pub inline fn releaseKernelHandle(self: *const T) HRESULT {
...
pub const IDirectDrawSurfaceKernel = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getKernelHandle(self: *const T, param0_: ?*usize) HRESULT {
                return @as(*const IDirectDrawSurfaceKernel.VTable, @ptrCast(self.vtable)).GetKernelHandle(@as(*const IDirectDrawSurfaceKernel, @ptrCast(self)), param0_);
            }
            pub inline fn releaseKernelHandle(self: *const T) HRESULT {
...
pub extern "ddraw" fn DirectDrawCreateClipper(
    dw_flags: u32,
    lplp_d_d_clipper: ?*?*IDirectDrawClipper,
    p_unk_outer: ?*IUnknown,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
