...
pub const D3D_PRIMITIVE_TOPOLOGY = enum(i32) {
    ...
    PT_1_CONTROL_POINT_PATCHLIST = 33,
    PT_2_CONTROL_POINT_PATCHLIST = 34,
    PT_3_CONTROL_POINT_PATCHLIST = 35,
    PT_4_CONTROL_POINT_PATCHLIST = 36,
    PT_5_CONTROL_POINT_PATCHLIST = 37,
    PT_6_CONTROL_POINT_PATCHLIST = 38,
    PT_7_CONTROL_POINT_PATCHLIST = 39,
    PT_8_CONTROL_POINT_PATCHLIST = 40,
    PT_9_CONTROL_POINT_PATCHLIST = 41,
    PT_10_CONTROL_POINT_PATCHLIST = 42,
    PT_11_CONTROL_POINT_PATCHLIST = 43,
    PT_12_CONTROL_POINT_PATCHLIST = 44,
    PT_13_CONTROL_POINT_PATCHLIST = 45,
    PT_14_CONTROL_POINT_PATCHLIST = 46,
    PT_15_CONTROL_POINT_PATCHLIST = 47,
    PT_16_CONTROL_POINT_PATCHLIST = 48,
    PT_17_CONTROL_POINT_PATCHLIST = 49,
    PT_18_CONTROL_POINT_PATCHLIST = 50,
    PT_19_CONTROL_POINT_PATCHLIST = 51,
    PT_20_CONTROL_POINT_PATCHLIST = 52,
    PT_21_CONTROL_POINT_PATCHLIST = 53,
    PT_22_CONTROL_POINT_PATCHLIST = 54,
    PT_23_CONTROL_POINT_PATCHLIST = 55,
    PT_24_CONTROL_POINT_PATCHLIST = 56,
    PT_25_CONTROL_POINT_PATCHLIST = 57,
    PT_26_CONTROL_POINT_PATCHLIST = 58,
    PT_27_CONTROL_POINT_PATCHLIST = 59,
    PT_28_CONTROL_POINT_PATCHLIST = 60,
    PT_29_CONTROL_POINT_PATCHLIST = 61,
    PT_30_CONTROL_POINT_PATCHLIST = 62,
    PT_31_CONTROL_POINT_PATCHLIST = 63,
    PT_32_CONTROL_POINT_PATCHLIST = 64,
...
pub const ID3DDestructionNotifier = extern struct {
    pub const VTable = extern struct {
        ...
        RegisterDestructionCallback: *const fn (
            ...
            callback_fn: ?PFN_DESTRUCTION_CALLBACK,
            p_data: ?*anyopaque,
            p_callback_i_d: ?*u32,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn registerDestructionCallback(self: *const T, callback_fn_: ?PFN_DESTRUCTION_CALLBACK, p_data_: ?*anyopaque, p_callback_i_d_: ?*u32) HRESULT {
                return @as(*const ID3DDestructionNotifier.VTable, @ptrCast(self.vtable)).RegisterDestructionCallback(@as(*const ID3DDestructionNotifier, @ptrCast(self)), callback_fn_, p_data_, p_callback_i_d_);
            }
            pub inline fn unregisterDestructionCallback(self: *const T, callback_i_d_: u32) HRESULT {
                return @as(*const ID3DDestructionNotifier.VTable, @ptrCast(self.vtable)).UnregisterDestructionCallback(@as(*const ID3DDestructionNotifier, @ptrCast(self)), callback_i_d_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ID3DInclude = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub inline fn open(self: *const T, include_type_: D3D_INCLUDE_TYPE, p_file_name_: ?[*:0]const u8, p_parent_data_: ?*const anyopaque, pp_data_: ?*?*anyopaque, p_bytes_: ?*u32) HRESULT {
                return @as(*const ID3DInclude.VTable, @ptrCast(self.vtable)).Open(@as(*const ID3DInclude, @ptrCast(self)), include_type_, p_file_name_, p_parent_data_, pp_data_, p_bytes_);
            }
            pub inline fn close(self: *const T, p_data_: ?*const anyopaque) HRESULT {
                return @as(*const ID3DInclude.VTable, @ptrCast(self.vtable)).Close(@as(*const ID3DInclude, @ptrCast(self)), p_data_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
