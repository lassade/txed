...
pub extern "gdi32" fn CreateDCA(
    pwsz_driver: ?[*:0]const u8,
    pwsz_device: ?[*:0]const u8,
    psz_port: ?[*:0]const u8,
    pdm: ?*const DEVMODEA,
) callconv(@import("std").os.windows.WINAPI) CreatedHDC;
...
pub extern "gdi32" fn CreateDCW(
    pwsz_driver: ?[*:0]const u16,
    pwsz_device: ?[*:0]const u16,
    psz_port: ?[*:0]const u16,
    pdm: ?*const DEVMODEW,
) callconv(@import("std").os.windows.WINAPI) CreatedHDC;
...
pub extern "gdi32" fn CreateDIBPatternBrushPt(
    lp_packed_d_i_b: ?*const anyopaque,
    i_usage: DIB_USAGE,
) callconv(@import("std").os.windows.WINAPI) ?HBRUSH;
...
pub extern "gdi32" fn CreateFontW(
    ...
    i_quality: FONT_QUALITY,
    i_pitch_and_family: FONT_PITCH_AND_FAMILY,
    psz_face_name: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) ?HFONT;

// TODO: this type is limited to platform 'windows5.0'
pub extern "gdi32" fn CreateHatchBrush(
    i_hatch: HATCH_BRUSH_STYLE,
    color: u32,
) callconv(@import("std").os.windows.WINAPI) ?HBRUSH;

// TODO: this type is limited to platform 'windows5.0'
pub extern "gdi32" fn CreateICA(
    psz_driver: ?[*:0]const u8,
...
pub extern "gdi32" fn AddFontMemResourceEx(
    // TODO: what to do with BytesParamIndex 1?
    p_file_view: ?*anyopaque,
    cj_size: u32,
    pv_resrved: ?*anyopaque,
    p_num_fonts: ?*u32,
...
pub extern "gdi32" fn SetPaletteEntries(
    ...
    i_start: u32,
    c_entries: u32,
    p_pal_entries: [*]const PALETTEENTRY,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "gdi32" fn GetEnhMetaFileHeader(
    ...
    n_size: u32,
    // TODO: what to do with BytesParamIndex 1?
    lp_enh_meta_header: ?*ENHMETAHEADER,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "gdi32" fn GetEnhMetaFilePaletteEntries(
    hemf: ?HENHMETAFILE,
    n_num_entries: u32,
    lp_palette_entries: ?[*]PALETTEENTRY,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fontsub" fn CreateFontPackage(
    puch_src_buffer: ?*const u8,
    ul_src_buffer_size: u32,
    ppuch_font_package_buffer: ?*?*u8,
    pul_font_package_buffer_size: ?*u32,
    pul_bytes_written: ?*u32,
    us_flag: u16,
    us_t_t_c_index: u16,
    ...
    pus_subset_keep_list: ?*const u16,
...
pub extern "fontsub" fn MergeFontPackage(
    puch_merge_font_buffer: ?*const u8,
    ul_merge_font_buffer_size: u32,
    puch_font_package_buffer: ?*const u8,
    ul_font_package_buffer_size: u32,
    ppuch_dest_buffer: ?*?*u8,
    pul_dest_buffer_size: ?*u32,
    pul_bytes_written: ?*u32,
    us_mode: u16,
    lpfn_allocate: ?CFP_ALLOCPROC,
    lpfn_re_allocate: ?CFP_REALLOCPROC,
...
pub extern "t2embed" fn TTEmbedFont(
    ...
    pul_priv_status: ?*EMBEDDED_FONT_PRIV_STATUS,
    pul_status: ?*u32,
    lpfn_write_to_stream: ?WRITEEMBEDPROC,
    lpv_write_stream: ?*anyopaque,
    pus_char_code_set: [*:0]u16,
    us_char_code_count: u16,
    us_language: u16,
    p_t_t_embed_info: ?*TTEMBEDINFO,
) callconv(@import("std").os.windows.WINAPI) i32;

// TODO: this type is limited to platform 'windows5.0'
pub extern "t2embed" fn TTEmbedFontFromFileA(
    h_d_c: ?HDC,
    sz_font_file_name: ?[*:0]const u8,
    us_t_t_c_index: u16,
    ul_flags: TTEMBED_FLAGS,
    ul_char_set: EMBED_FONT_CHARSET,
    pul_priv_status: ?*EMBEDDED_FONT_PRIV_STATUS,
...
pub extern "t2embed" fn TTLoadEmbeddedFont(
    ph_font_reference: ?*?HANDLE,
    ul_flags: u32,
    pul_priv_status: ?*EMBEDDED_FONT_PRIV_STATUS,
    ul_privs: FONT_LICENSE_PRIVS,
    pul_status: ?*TTLOAD_EMBEDDED_FONT_STATUS,
    lpfn_read_from_stream: ?READEMBEDPROC,
    lpv_read_stream: ?*anyopaque,
    sz_win_family_name: ?PWSTR,
    sz_mac_family_name: ?PSTR,
    p_t_t_load_info: ?*TTLOADINFO,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "t2embed" fn TTGetEmbeddingType(
    h_d_c: ?HDC,
    pul_embed_type: ?*EMBEDDED_FONT_PRIV_STATUS,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "t2embed" fn TTRunValidationTests(
    h_d_c: ?HDC,
    p_test_param: ?*TTVALIDATIONTESTSPARAMS,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "t2embed" fn TTRunValidationTestsEx(
    h_d_c: ?HDC,
    p_test_param: ?*TTVALIDATIONTESTSPARAMSEX,
) callconv(@import("std").os.windows.WINAPI) i32;

// TODO: this type is limited to platform 'windows5.0'
pub extern "t2embed" fn TTGetNewFontName(
    ph_font_reference: ?*?HANDLE,
    wz_win_family_name: [*:0]u16,
    cch_max_win_name: i32,
    sz_mac_family_name: [*:0]u8,
...
pub extern "user32" fn TabbedTextOutA(
    ...
    ch_count: i32,
    n_tab_positions: i32,
    lpn_tab_stop_positions: ?[*]const i32,
    n_tab_origin: i32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "user32" fn BeginPaint(
    h_wnd: ?HWND,
    lp_paint: ?*PAINTSTRUCT,
) callconv(@import("std").os.windows.WINAPI) ?HDC;

// TODO: this type is limited to platform 'windows5.0'
pub extern "user32" fn EndPaint(
    h_wnd: ?HWND,
    lp_paint: ?*const PAINTSTRUCT,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "user32" fn EnumDisplayDevicesA(
    lp_device: ?[*:0]const u8,
    i_dev_num: u32,
    lp_display_device: ?*DISPLAY_DEVICEA,
    dw_flags: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.0'
pub extern "user32" fn EnumDisplayDevicesW(
    lp_device: ?[*:0]const u16,
    i_dev_num: u32,
    lp_display_device: ?*DISPLAY_DEVICEW,
    dw_flags: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
