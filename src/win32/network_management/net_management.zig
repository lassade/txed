...
pub const IEnumNetCfgBindingInterface = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn next(self: *const T, celt_: u32, rgelt_: [*]?*INetCfgBindingInterface, pcelt_fetched_: ?*u32) HRESULT {
                return @as(*const IEnumNetCfgBindingInterface.VTable, @ptrCast(self.vtable)).Next(@as(*const IEnumNetCfgBindingInterface, @ptrCast(self)), celt_, rgelt_, pcelt_fetched_);
            }
            pub inline fn skip(self: *const T, celt_: u32) HRESULT {
                return @as(*const IEnumNetCfgBindingInterface.VTable, @ptrCast(self.vtable)).Skip(@as(*const IEnumNetCfgBindingInterface, @ptrCast(self)), celt_);
            }
            ...
            pub inline fn clone(self: *const T, ppenum_: ?*?*IEnumNetCfgBindingInterface) HRESULT {
                return @as(*const IEnumNetCfgBindingInterface.VTable, @ptrCast(self.vtable)).Clone(@as(*const IEnumNetCfgBindingInterface, @ptrCast(self)), ppenum_);
            }
        };
    }
...
pub const IEnumNetCfgBindingPath = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn next(self: *const T, celt_: u32, rgelt_: [*]?*INetCfgBindingPath, pcelt_fetched_: ?*u32) HRESULT {
                return @as(*const IEnumNetCfgBindingPath.VTable, @ptrCast(self.vtable)).Next(@as(*const IEnumNetCfgBindingPath, @ptrCast(self)), celt_, rgelt_, pcelt_fetched_);
            }
            pub inline fn skip(self: *const T, celt_: u32) HRESULT {
                return @as(*const IEnumNetCfgBindingPath.VTable, @ptrCast(self.vtable)).Skip(@as(*const IEnumNetCfgBindingPath, @ptrCast(self)), celt_);
            }
            pub inline fn reset(self: *const T) HRESULT {
                return @as(*const IEnumNetCfgBindingPath.VTable, @ptrCast(self.vtable)).Reset(@as(*const IEnumNetCfgBindingPath, @ptrCast(self)));
            }
            pub inline fn clone(self: *const T, ppenum_: ?*?*IEnumNetCfgBindingPath) HRESULT {
                return @as(*const IEnumNetCfgBindingPath.VTable, @ptrCast(self.vtable)).Clone(@as(*const IEnumNetCfgBindingPath, @ptrCast(self)), ppenum_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IEnumNetCfgComponent = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn next(self: *const T, celt_: u32, rgelt_: [*]?*INetCfgComponent, pcelt_fetched_: ?*u32) HRESULT {
                return @as(*const IEnumNetCfgComponent.VTable, @ptrCast(self.vtable)).Next(@as(*const IEnumNetCfgComponent, @ptrCast(self)), celt_, rgelt_, pcelt_fetched_);
            }
            pub inline fn skip(self: *const T, celt_: u32) HRESULT {
                return @as(*const IEnumNetCfgComponent.VTable, @ptrCast(self.vtable)).Skip(@as(*const IEnumNetCfgComponent, @ptrCast(self)), celt_);
            }
            pub inline fn reset(self: *const T) HRESULT {
                return @as(*const IEnumNetCfgComponent.VTable, @ptrCast(self.vtable)).Reset(@as(*const IEnumNetCfgComponent, @ptrCast(self)));
            }
            pub inline fn clone(self: *const T, ppenum_: ?*?*IEnumNetCfgComponent) HRESULT {
                return @as(*const IEnumNetCfgComponent.VTable, @ptrCast(self.vtable)).Clone(@as(*const IEnumNetCfgComponent, @ptrCast(self)), ppenum_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const INetCfg = extern struct {
    pub const VTable = extern struct {
        ...
        EnumComponents: *const fn (
            self: *const INetCfg,
            pguid_class: ?*const Guid,
            ppenum_component: ?*?*IEnumNetCfgComponent,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        FindComponent: *const fn (
            self: *const INetCfg,
            pszw_inf_id: ?[*:0]const u16,
            p_component: ?*?*INetCfgComponent,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn initialize(self: *const T, pv_reserved_: ?*anyopaque) HRESULT {
                return @as(*const INetCfg.VTable, @ptrCast(self.vtable)).Initialize(@as(*const INetCfg, @ptrCast(self)), pv_reserved_);
            }
            ...
            pub inline fn enumComponents(self: *const T, pguid_class_: ?*const Guid, ppenum_component_: ?*?*IEnumNetCfgComponent) HRESULT {
                return @as(*const INetCfg.VTable, @ptrCast(self.vtable)).EnumComponents(@as(*const INetCfg, @ptrCast(self)), pguid_class_, ppenum_component_);
            }
            pub inline fn findComponent(self: *const T, pszw_inf_id_: ?[*:0]const u16, p_component_: ?*?*INetCfgComponent) HRESULT {
                return @as(*const INetCfg.VTable, @ptrCast(self.vtable)).FindComponent(@as(*const INetCfg, @ptrCast(self)), pszw_inf_id_, p_component_);
            }
            pub inline fn queryNetCfgClass(self: *const T, pguid_class_: ?*const Guid, riid_: ?*const Guid, ppv_object_: ?*?*anyopaque) HRESULT {
                return @as(*const INetCfg.VTable, @ptrCast(self.vtable)).QueryNetCfgClass(@as(*const INetCfg, @ptrCast(self)), pguid_class_, riid_, ppv_object_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const INetCfgLock = extern struct {
    pub const VTable = extern struct {
        ...
        AcquireWriteLock: *const fn (
            ...
            cms_timeout: u32,
            pszw_client_description: ?[*:0]const u16,
            ppszw_client_description: ?*?PWSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn acquireWriteLock(self: *const T, cms_timeout_: u32, pszw_client_description_: ?[*:0]const u16, ppszw_client_description_: ?*?PWSTR) HRESULT {
                return @as(*const INetCfgLock.VTable, @ptrCast(self.vtable)).AcquireWriteLock(@as(*const INetCfgLock, @ptrCast(self)), cms_timeout_, pszw_client_description_, ppszw_client_description_);
            }
            pub inline fn releaseWriteLock(self: *const T) HRESULT {
                return @as(*const INetCfgLock.VTable, @ptrCast(self.vtable)).ReleaseWriteLock(@as(*const INetCfgLock, @ptrCast(self)));
            }
            pub inline fn isWriteLocked(self: *const T, ppszw_client_description_: ?*?PWSTR) HRESULT {
                return @as(*const INetCfgLock.VTable, @ptrCast(self.vtable)).IsWriteLocked(@as(*const INetCfgLock, @ptrCast(self)), ppszw_client_description_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const INetCfgBindingInterface = extern struct {
    pub const VTable = extern struct {
        ...
        GetName: *const fn (
            ...
            ppszw_interface_name: ?*?PWSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetUpperComponent: *const fn (
            self: *const INetCfgBindingInterface,
            ppncc_item: ?*?*INetCfgComponent,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getName(self: *const T, ppszw_interface_name_: ?*?PWSTR) HRESULT {
                return @as(*const INetCfgBindingInterface.VTable, @ptrCast(self.vtable)).GetName(@as(*const INetCfgBindingInterface, @ptrCast(self)), ppszw_interface_name_);
            }
            pub inline fn getUpperComponent(self: *const T, ppncc_item_: ?*?*INetCfgComponent) HRESULT {
                return @as(*const INetCfgBindingInterface.VTable, @ptrCast(self.vtable)).GetUpperComponent(@as(*const INetCfgBindingInterface, @ptrCast(self)), ppncc_item_);
            }
            pub inline fn getLowerComponent(self: *const T, ppncc_item_: ?*?*INetCfgComponent) HRESULT {
                return @as(*const INetCfgBindingInterface.VTable, @ptrCast(self.vtable)).GetLowerComponent(@as(*const INetCfgBindingInterface, @ptrCast(self)), ppncc_item_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const INetCfgBindingPath = extern struct {
    pub const VTable = extern struct {
        ...
        GetPathToken: *const fn (
            self: *const INetCfgBindingPath,
            ppszw_path_token: ?*?PWSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetOwner: *const fn (
            self: *const INetCfgBindingPath,
            pp_component: ?*?*INetCfgComponent,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetDepth: *const fn (
            self: *const INetCfgBindingPath,
            pc_interfaces: ?*u32,
        ...
        EnumBindingInterfaces: *const fn (
            self: *const INetCfgBindingPath,
            ppenum_interface: ?*?*IEnumNetCfgBindingInterface,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn isSamePathAs(self: *const T, p_path_: ?*INetCfgBindingPath) HRESULT {
                return @as(*const INetCfgBindingPath.VTable, @ptrCast(self.vtable)).IsSamePathAs(@as(*const INetCfgBindingPath, @ptrCast(self)), p_path_);
            }
            pub inline fn isSubPathOf(self: *const T, p_path_: ?*INetCfgBindingPath) HRESULT {
                return @as(*const INetCfgBindingPath.VTable, @ptrCast(self.vtable)).IsSubPathOf(@as(*const INetCfgBindingPath, @ptrCast(self)), p_path_);
            }
            ...
            pub inline fn enable(self: *const T, f_enable_: BOOL) HRESULT {
                return @as(*const INetCfgBindingPath.VTable, @ptrCast(self.vtable)).Enable(@as(*const INetCfgBindingPath, @ptrCast(self)), f_enable_);
            }
            pub inline fn getPathToken(self: *const T, ppszw_path_token_: ?*?PWSTR) HRESULT {
                return @as(*const INetCfgBindingPath.VTable, @ptrCast(self.vtable)).GetPathToken(@as(*const INetCfgBindingPath, @ptrCast(self)), ppszw_path_token_);
            }
            pub inline fn getOwner(self: *const T, pp_component_: ?*?*INetCfgComponent) HRESULT {
                return @as(*const INetCfgBindingPath.VTable, @ptrCast(self.vtable)).GetOwner(@as(*const INetCfgBindingPath, @ptrCast(self)), pp_component_);
            }
            pub inline fn getDepth(self: *const T, pc_interfaces_: ?*u32) HRESULT {
                return @as(*const INetCfgBindingPath.VTable, @ptrCast(self.vtable)).GetDepth(@as(*const INetCfgBindingPath, @ptrCast(self)), pc_interfaces_);
            }
            pub inline fn enumBindingInterfaces(self: *const T, ppenum_interface_: ?*?*IEnumNetCfgBindingInterface) HRESULT {
                return @as(*const INetCfgBindingPath.VTable, @ptrCast(self.vtable)).EnumBindingInterfaces(@as(*const INetCfgBindingPath, @ptrCast(self)), ppenum_interface_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const INetCfgClass = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn findComponent(self: *const T, pszw_inf_id_: ?[*:0]const u16, ppncc_item_: ?*?*INetCfgComponent) HRESULT {
                return @as(*const INetCfgClass.VTable, @ptrCast(self.vtable)).FindComponent(@as(*const INetCfgClass, @ptrCast(self)), pszw_inf_id_, ppncc_item_);
            }
            pub inline fn enumComponents(self: *const T, ppenum_component_: ?*?*IEnumNetCfgComponent) HRESULT {
                return @as(*const INetCfgClass.VTable, @ptrCast(self.vtable)).EnumComponents(@as(*const INetCfgClass, @ptrCast(self)), ppenum_component_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const INetCfgClassSetup = extern struct {
    pub const VTable = extern struct {
        ...
        Install: *const fn (
            ...
            p_obo_token: ?*OBO_TOKEN,
            dw_setup_flags: u32,
            dw_upgrade_from_build_no: u32,
            pszw_answer_file: ?[*:0]const u16,
            pszw_answer_sections: ?[*:0]const u16,
            ppncc_item: ?*?*INetCfgComponent,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        DeInstall: *const fn (
            self: *const INetCfgClassSetup,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn selectAndInstall(self: *const T, hwnd_parent_: ?HWND, p_obo_token_: ?*OBO_TOKEN, ppncc_item_: ?*?*INetCfgComponent) HRESULT {
                return @as(*const INetCfgClassSetup.VTable, @ptrCast(self.vtable)).SelectAndInstall(@as(*const INetCfgClassSetup, @ptrCast(self)), hwnd_parent_, p_obo_token_, ppncc_item_);
            }
            pub inline fn install(self: *const T, pszw_inf_id_: ?[*:0]const u16, p_obo_token_: ?*OBO_TOKEN, dw_setup_flags_: u32, dw_upgrade_from_build_no_: u32, pszw_answer_file_: ?[*:0]const u16, pszw_answer_sections_: ?[*:0]const u16, ppncc_item_: ?*?*INetCfgComponent) HRESULT {
                return @as(*const INetCfgClassSetup.VTable, @ptrCast(self.vtable)).Install(@as(*const INetCfgClassSetup, @ptrCast(self)), pszw_inf_id_, p_obo_token_, dw_setup_flags_, dw_upgrade_from_build_no_, pszw_answer_file_, pszw_answer_sections_, ppncc_item_);
            }
            pub inline fn deInstall(self: *const T, p_component_: ?*INetCfgComponent, p_obo_token_: ?*OBO_TOKEN, pmszw_refs_: ?*?PWSTR) HRESULT {
                return @as(*const INetCfgClassSetup.VTable, @ptrCast(self.vtable)).DeInstall(@as(*const INetCfgClassSetup, @ptrCast(self)), p_component_, p_obo_token_, pmszw_refs_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const INetCfgClassSetup2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn updateNonEnumeratedComponent(self: *const T, p_i_comp_: ?*INetCfgComponent, dw_setup_flags_: u32, dw_upgrade_from_build_no_: u32) HRESULT {
                return @as(*const INetCfgClassSetup2.VTable, @ptrCast(self.vtable)).UpdateNonEnumeratedComponent(@as(*const INetCfgClassSetup2, @ptrCast(self)), p_i_comp_, dw_setup_flags_, dw_upgrade_from_build_no_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const INetCfgComponent = extern struct {
    pub const VTable = extern struct {
        ...
        GetDisplayName: *const fn (
            ...
            ppszw_display_name: ?*?PWSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        SetDisplayName: *const fn (
            self: *const INetCfgComponent,
            pszw_display_name: ?[*:0]const u16,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetHelpText: *const fn (
            self: *const INetCfgComponent,
            pszw_help_text: ?*?PWSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetId: *const fn (
            self: *const INetCfgComponent,
            ppszw_id: ?*?PWSTR,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getDisplayName(self: *const T, ppszw_display_name_: ?*?PWSTR) HRESULT {
                return @as(*const INetCfgComponent.VTable, @ptrCast(self.vtable)).GetDisplayName(@as(*const INetCfgComponent, @ptrCast(self)), ppszw_display_name_);
            }
            pub inline fn setDisplayName(self: *const T, pszw_display_name_: ?[*:0]const u16) HRESULT {
                return @as(*const INetCfgComponent.VTable, @ptrCast(self.vtable)).SetDisplayName(@as(*const INetCfgComponent, @ptrCast(self)), pszw_display_name_);
            }
            pub inline fn getHelpText(self: *const T, pszw_help_text_: ?*?PWSTR) HRESULT {
                return @as(*const INetCfgComponent.VTable, @ptrCast(self.vtable)).GetHelpText(@as(*const INetCfgComponent, @ptrCast(self)), pszw_help_text_);
            }
            pub inline fn getId(self: *const T, ppszw_id_: ?*?PWSTR) HRESULT {
                return @as(*const INetCfgComponent.VTable, @ptrCast(self.vtable)).GetId(@as(*const INetCfgComponent, @ptrCast(self)), ppszw_id_);
            }
            pub inline fn getCharacteristics(self: *const T, pdw_characteristics_: ?*u32) HRESULT {
                return @as(*const INetCfgComponent.VTable, @ptrCast(self.vtable)).GetCharacteristics(@as(*const INetCfgComponent, @ptrCast(self)), pdw_characteristics_);
            }
            pub inline fn getInstanceGuid(self: *const T, p_guid_: ?*Guid) HRESULT {
                return @as(*const INetCfgComponent.VTable, @ptrCast(self.vtable)).GetInstanceGuid(@as(*const INetCfgComponent, @ptrCast(self)), p_guid_);
            }
            pub inline fn getPnpDevNodeId(self: *const T, ppszw_dev_node_id_: ?*?PWSTR) HRESULT {
                return @as(*const INetCfgComponent.VTable, @ptrCast(self.vtable)).GetPnpDevNodeId(@as(*const INetCfgComponent, @ptrCast(self)), ppszw_dev_node_id_);
            }
            pub inline fn getClassGuid(self: *const T, p_guid_: ?*Guid) HRESULT {
                return @as(*const INetCfgComponent.VTable, @ptrCast(self.vtable)).GetClassGuid(@as(*const INetCfgComponent, @ptrCast(self)), p_guid_);
            }
            pub inline fn getBindName(self: *const T, ppszw_bind_name_: ?*?PWSTR) HRESULT {
                return @as(*const INetCfgComponent.VTable, @ptrCast(self.vtable)).GetBindName(@as(*const INetCfgComponent, @ptrCast(self)), ppszw_bind_name_);
            }
            pub inline fn getDeviceStatus(self: *const T, pul_status_: ?*u32) HRESULT {
                return @as(*const INetCfgComponent.VTable, @ptrCast(self.vtable)).GetDeviceStatus(@as(*const INetCfgComponent, @ptrCast(self)), pul_status_);
            }
            pub inline fn openParamKey(self: *const T, phkey_: ?*?HKEY) HRESULT {
                return @as(*const INetCfgComponent.VTable, @ptrCast(self.vtable)).OpenParamKey(@as(*const INetCfgComponent, @ptrCast(self)), phkey_);
            }
            pub inline fn raisePropertyUi(self: *const T, hwnd_parent_: ?HWND, dw_flags_: u32, punk_context_: ?*IUnknown) HRESULT {
                return @as(*const INetCfgComponent.VTable, @ptrCast(self.vtable)).RaisePropertyUi(@as(*const INetCfgComponent, @ptrCast(self)), hwnd_parent_, dw_flags_, punk_context_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const INetCfgComponentBindings = extern struct {
    pub const VTable = extern struct {
        ...
        SupportsBindingInterface: *const fn (
            self: *const INetCfgComponentBindings,
            dw_flags: u32,
            pszw_interface_name: ?[*:0]const u16,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        IsBoundTo: *const fn (
            self: *const INetCfgComponentBindings,
            pncc_item: ?*INetCfgComponent,
        ...
        EnumBindingPaths: *const fn (
            self: *const INetCfgComponentBindings,
            dw_flags: u32,
            pp_i_enum: ?*?*IEnumNetCfgBindingPath,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        MoveBefore: *const fn (
            self: *const INetCfgComponentBindings,
            pncb_item_src: ?*INetCfgBindingPath,
            pncb_item_dest: ?*INetCfgBindingPath,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        MoveAfter: *const fn (
            self: *const INetCfgComponentBindings,
            pncb_item_src: ?*INetCfgBindingPath,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn bindTo(self: *const T, pncc_item_: ?*INetCfgComponent) HRESULT {
                return @as(*const INetCfgComponentBindings.VTable, @ptrCast(self.vtable)).BindTo(@as(*const INetCfgComponentBindings, @ptrCast(self)), pncc_item_);
            }
            pub inline fn unbindFrom(self: *const T, pncc_item_: ?*INetCfgComponent) HRESULT {
                return @as(*const INetCfgComponentBindings.VTable, @ptrCast(self.vtable)).UnbindFrom(@as(*const INetCfgComponentBindings, @ptrCast(self)), pncc_item_);
            }
            pub inline fn supportsBindingInterface(self: *const T, dw_flags_: u32, pszw_interface_name_: ?[*:0]const u16) HRESULT {
                return @as(*const INetCfgComponentBindings.VTable, @ptrCast(self.vtable)).SupportsBindingInterface(@as(*const INetCfgComponentBindings, @ptrCast(self)), dw_flags_, pszw_interface_name_);
            }
            pub inline fn isBoundTo(self: *const T, pncc_item_: ?*INetCfgComponent) HRESULT {
                return @as(*const INetCfgComponentBindings.VTable, @ptrCast(self.vtable)).IsBoundTo(@as(*const INetCfgComponentBindings, @ptrCast(self)), pncc_item_);
            }
            pub inline fn isBindableTo(self: *const T, pncc_item_: ?*INetCfgComponent) HRESULT {
                return @as(*const INetCfgComponentBindings.VTable, @ptrCast(self.vtable)).IsBindableTo(@as(*const INetCfgComponentBindings, @ptrCast(self)), pncc_item_);
            }
            pub inline fn enumBindingPaths(self: *const T, dw_flags_: u32, pp_i_enum_: ?*?*IEnumNetCfgBindingPath) HRESULT {
                return @as(*const INetCfgComponentBindings.VTable, @ptrCast(self.vtable)).EnumBindingPaths(@as(*const INetCfgComponentBindings, @ptrCast(self)), dw_flags_, pp_i_enum_);
            }
            pub inline fn moveBefore(self: *const T, pncb_item_src_: ?*INetCfgBindingPath, pncb_item_dest_: ?*INetCfgBindingPath) HRESULT {
                return @as(*const INetCfgComponentBindings.VTable, @ptrCast(self.vtable)).MoveBefore(@as(*const INetCfgComponentBindings, @ptrCast(self)), pncb_item_src_, pncb_item_dest_);
            }
            pub inline fn moveAfter(self: *const T, pncb_item_src_: ?*INetCfgBindingPath, pncb_item_dest_: ?*INetCfgBindingPath) HRESULT {
                return @as(*const INetCfgComponentBindings.VTable, @ptrCast(self.vtable)).MoveAfter(@as(*const INetCfgComponentBindings, @ptrCast(self)), pncb_item_src_, pncb_item_dest_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const INetCfgSysPrep = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn hrSetupSetFirstDword(self: *const T, pwsz_section_: ?[*:0]const u16, pwsz_key_: ?[*:0]const u16, dw_value_: u32) HRESULT {
                return @as(*const INetCfgSysPrep.VTable, @ptrCast(self.vtable)).HrSetupSetFirstDword(@as(*const INetCfgSysPrep, @ptrCast(self)), pwsz_section_, pwsz_key_, dw_value_);
            }
            pub inline fn hrSetupSetFirstString(self: *const T, pwsz_section_: ?[*:0]const u16, pwsz_key_: ?[*:0]const u16, pwsz_value_: ?[*:0]const u16) HRESULT {
                return @as(*const INetCfgSysPrep.VTable, @ptrCast(self.vtable)).HrSetupSetFirstString(@as(*const INetCfgSysPrep, @ptrCast(self)), pwsz_section_, pwsz_key_, pwsz_value_);
            }
            pub inline fn hrSetupSetFirstStringAsBool(self: *const T, pwsz_section_: ?[*:0]const u16, pwsz_key_: ?[*:0]const u16, f_value_: BOOL) HRESULT {
                return @as(*const INetCfgSysPrep.VTable, @ptrCast(self.vtable)).HrSetupSetFirstStringAsBool(@as(*const INetCfgSysPrep, @ptrCast(self)), pwsz_section_, pwsz_key_, f_value_);
            }
            pub inline fn hrSetupSetFirstMultiSzField(self: *const T, pwsz_section_: ?[*:0]const u16, pwsz_key_: ?[*:0]const u16, pmsz_value_: ?[*:0]const u16) HRESULT {
                return @as(*const INetCfgSysPrep.VTable, @ptrCast(self.vtable)).HrSetupSetFirstMultiSzField(@as(*const INetCfgSysPrep, @ptrCast(self)), pwsz_section_, pwsz_key_, pmsz_value_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const INetCfgPnpReconfigCallback = extern struct {
    pub const VTable = extern struct {
        ...
        SendPnpReconfig: *const fn (
            ...
            pszw_upper: ?[*:0]const u16,
            pszw_lower: ?[*:0]const u16,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn sendPnpReconfig(self: *const T, layer_: NCPNP_RECONFIG_LAYER, pszw_upper_: ?[*:0]const u16, pszw_lower_: ?[*:0]const u16, pv_data_: ?*anyopaque, dw_size_of_data_: u32) HRESULT {
                return @as(*const INetCfgPnpReconfigCallback.VTable, @ptrCast(self.vtable)).SendPnpReconfig(@as(*const INetCfgPnpReconfigCallback, @ptrCast(self)), layer_, pszw_upper_, pszw_lower_, pv_data_, dw_size_of_data_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const INetCfgComponentControl = extern struct {
    pub const VTable = extern struct {
        ...
        ApplyPnpChanges: *const fn (
            self: *const INetCfgComponentControl,
            p_i_callback: ?*INetCfgPnpReconfigCallback,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn initialize(self: *const T, p_i_comp_: ?*INetCfgComponent, p_i_net_cfg_: ?*INetCfg, f_installing_: BOOL) HRESULT {
                return @as(*const INetCfgComponentControl.VTable, @ptrCast(self.vtable)).Initialize(@as(*const INetCfgComponentControl, @ptrCast(self)), p_i_comp_, p_i_net_cfg_, f_installing_);
            }
            pub inline fn applyRegistryChanges(self: *const T) HRESULT {
            ...
            pub inline fn applyPnpChanges(self: *const T, p_i_callback_: ?*INetCfgPnpReconfigCallback) HRESULT {
                return @as(*const INetCfgComponentControl.VTable, @ptrCast(self.vtable)).ApplyPnpChanges(@as(*const INetCfgComponentControl, @ptrCast(self)), p_i_callback_);
            }
            pub inline fn cancelChanges(self: *const T) HRESULT {
...
pub const INetCfgComponentSetup = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn install(self: *const T, dw_setup_flags_: u32) HRESULT {
                return @as(*const INetCfgComponentSetup.VTable, @ptrCast(self.vtable)).Install(@as(*const INetCfgComponentSetup, @ptrCast(self)), dw_setup_flags_);
            }
            pub inline fn upgrade(self: *const T, dw_setup_flags_: u32, dw_upgrade_fom_build_no_: u32) HRESULT {
                return @as(*const INetCfgComponentSetup.VTable, @ptrCast(self.vtable)).Upgrade(@as(*const INetCfgComponentSetup, @ptrCast(self)), dw_setup_flags_, dw_upgrade_fom_build_no_);
            }
            pub inline fn readAnswerFile(self: *const T, pszw_answer_file_: ?[*:0]const u16, pszw_answer_sections_: ?[*:0]const u16) HRESULT {
                return @as(*const INetCfgComponentSetup.VTable, @ptrCast(self.vtable)).ReadAnswerFile(@as(*const INetCfgComponentSetup, @ptrCast(self)), pszw_answer_file_, pszw_answer_sections_);
            }
            pub inline fn removing(self: *const T) HRESULT {
...
pub const INetCfgComponentPropertyUi = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn queryPropertyUi(self: *const T, p_unk_reserved_: ?*IUnknown) HRESULT {
                return @as(*const INetCfgComponentPropertyUi.VTable, @ptrCast(self.vtable)).QueryPropertyUi(@as(*const INetCfgComponentPropertyUi, @ptrCast(self)), p_unk_reserved_);
            }
            pub inline fn setContext(self: *const T, p_unk_reserved_: ?*IUnknown) HRESULT {
                return @as(*const INetCfgComponentPropertyUi.VTable, @ptrCast(self.vtable)).SetContext(@as(*const INetCfgComponentPropertyUi, @ptrCast(self)), p_unk_reserved_);
            }
            pub inline fn mergePropPages(self: *const T, pdw_def_pages_: ?*u32, pahpsp_private_: ?*?*u8, pc_pages_: ?*u32, hwnd_parent_: ?HWND, psz_start_page_: ?*?PWSTR) HRESULT {
                return @as(*const INetCfgComponentPropertyUi.VTable, @ptrCast(self.vtable)).MergePropPages(@as(*const INetCfgComponentPropertyUi, @ptrCast(self)), pdw_def_pages_, pahpsp_private_, pc_pages_, hwnd_parent_, psz_start_page_);
            }
            pub inline fn validateProperties(self: *const T, hwnd_sheet_: ?HWND) HRESULT {
                return @as(*const INetCfgComponentPropertyUi.VTable, @ptrCast(self.vtable)).ValidateProperties(@as(*const INetCfgComponentPropertyUi, @ptrCast(self)), hwnd_sheet_);
            }
            pub inline fn applyProperties(self: *const T) HRESULT {
            ...
            pub inline fn cancelProperties(self: *const T) HRESULT {
...
pub const INetCfgComponentNotifyBinding = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn queryBindingPath(self: *const T, dw_change_flag_: u32, p_i_path_: ?*INetCfgBindingPath) HRESULT {
                return @as(*const INetCfgComponentNotifyBinding.VTable, @ptrCast(self.vtable)).QueryBindingPath(@as(*const INetCfgComponentNotifyBinding, @ptrCast(self)), dw_change_flag_, p_i_path_);
            }
            pub inline fn notifyBindingPath(self: *const T, dw_change_flag_: u32, p_i_path_: ?*INetCfgBindingPath) HRESULT {
                return @as(*const INetCfgComponentNotifyBinding.VTable, @ptrCast(self.vtable)).NotifyBindingPath(@as(*const INetCfgComponentNotifyBinding, @ptrCast(self)), dw_change_flag_, p_i_path_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const INetCfgComponentNotifyGlobal = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getSupportedNotifications(self: *const T, dw_notifications_: ?*u32) HRESULT {
                return @as(*const INetCfgComponentNotifyGlobal.VTable, @ptrCast(self.vtable)).GetSupportedNotifications(@as(*const INetCfgComponentNotifyGlobal, @ptrCast(self)), dw_notifications_);
            }
            pub inline fn sysQueryBindingPath(self: *const T, dw_change_flag_: u32, p_i_path_: ?*INetCfgBindingPath) HRESULT {
                return @as(*const INetCfgComponentNotifyGlobal.VTable, @ptrCast(self.vtable)).SysQueryBindingPath(@as(*const INetCfgComponentNotifyGlobal, @ptrCast(self)), dw_change_flag_, p_i_path_);
            }
            pub inline fn sysNotifyBindingPath(self: *const T, dw_change_flag_: u32, p_i_path_: ?*INetCfgBindingPath) HRESULT {
                return @as(*const INetCfgComponentNotifyGlobal.VTable, @ptrCast(self.vtable)).SysNotifyBindingPath(@as(*const INetCfgComponentNotifyGlobal, @ptrCast(self)), dw_change_flag_, p_i_path_);
            }
            pub inline fn sysNotifyComponent(self: *const T, dw_change_flag_: u32, p_i_comp_: ?*INetCfgComponent) HRESULT {
                return @as(*const INetCfgComponentNotifyGlobal.VTable, @ptrCast(self.vtable)).SysNotifyComponent(@as(*const INetCfgComponentNotifyGlobal, @ptrCast(self)), dw_change_flag_, p_i_comp_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const INetLanConnectionUiInfo = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getDeviceGuid(self: *const T, pguid_: ?*Guid) HRESULT {
                return @as(*const INetLanConnectionUiInfo.VTable, @ptrCast(self.vtable)).GetDeviceGuid(@as(*const INetLanConnectionUiInfo, @ptrCast(self)), pguid_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const INetRasConnectionIpUiInfo = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getUiInfo(self: *const T, p_info_: ?*RASCON_IPUI) HRESULT {
                return @as(*const INetRasConnectionIpUiInfo.VTable, @ptrCast(self.vtable)).GetUiInfo(@as(*const INetRasConnectionIpUiInfo, @ptrCast(self)), p_info_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const INetCfgComponentSysPrep = extern struct {
    pub const VTable = extern struct {
        ...
        SaveAdapterParameters: *const fn (
            ...
            pszw_answer_sections: ?[*:0]const u16,
            p_adapter_instance_guid: ?*Guid,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        RestoreAdapterParameters: *const fn (
            self: *const INetCfgComponentSysPrep,
            pszw_answer_file: ?[*:0]const u16,
            pszw_answer_section: ?[*:0]const u16,
            p_adapter_instance_guid: ?*Guid,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn saveAdapterParameters(self: *const T, pncsp_: ?*INetCfgSysPrep, pszw_answer_sections_: ?[*:0]const u16, p_adapter_instance_guid_: ?*Guid) HRESULT {
                return @as(*const INetCfgComponentSysPrep.VTable, @ptrCast(self.vtable)).SaveAdapterParameters(@as(*const INetCfgComponentSysPrep, @ptrCast(self)), pncsp_, pszw_answer_sections_, p_adapter_instance_guid_);
            }
            pub inline fn restoreAdapterParameters(self: *const T, pszw_answer_file_: ?[*:0]const u16, pszw_answer_section_: ?[*:0]const u16, p_adapter_instance_guid_: ?*Guid) HRESULT {
                return @as(*const INetCfgComponentSysPrep.VTable, @ptrCast(self.vtable)).RestoreAdapterParameters(@as(*const INetCfgComponentSysPrep, @ptrCast(self)), pszw_answer_file_, pszw_answer_section_, p_adapter_instance_guid_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IProvisioningDomain = extern struct {
    pub const VTable = extern struct {
        ...
        Add: *const fn (
            ...
            pszw_path_to_folder: ?[*:0]const u16,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Query: *const fn (
            self: *const IProvisioningDomain,
            pszw_domain: ?[*:0]const u16,
            pszw_language: ?[*:0]const u16,
            pszw_x_path_query: ?[*:0]const u16,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn add(self: *const T, pszw_path_to_folder_: ?[*:0]const u16) HRESULT {
                return @as(*const IProvisioningDomain.VTable, @ptrCast(self.vtable)).Add(@as(*const IProvisioningDomain, @ptrCast(self)), pszw_path_to_folder_);
            }
            pub inline fn query(self: *const T, pszw_domain_: ?[*:0]const u16, pszw_language_: ?[*:0]const u16, pszw_x_path_query_: ?[*:0]const u16, nodes_: ?*?*IXMLDOMNodeList) HRESULT {
                return @as(*const IProvisioningDomain.VTable, @ptrCast(self.vtable)).Query(@as(*const IProvisioningDomain, @ptrCast(self)), pszw_domain_, pszw_language_, pszw_x_path_query_, nodes_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IProvisioningProfileWireless = extern struct {
    pub const VTable = extern struct {
        ...
        CreateProfile: *const fn (
            ...
            bstr_x_m_l_wireless_config_profile: ?BSTR,
            bstr_x_m_l_connection_config_profile: ?BSTR,
            p_adapter_instance_guid: ?*Guid,
            pul_status: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn createProfile(self: *const T, bstr_x_m_l_wireless_config_profile_: ?BSTR, bstr_x_m_l_connection_config_profile_: ?BSTR, p_adapter_instance_guid_: ?*Guid, pul_status_: ?*u32) HRESULT {
                return @as(*const IProvisioningProfileWireless.VTable, @ptrCast(self.vtable)).CreateProfile(@as(*const IProvisioningProfileWireless, @ptrCast(self)), bstr_x_m_l_wireless_config_profile_, bstr_x_m_l_connection_config_profile_, p_adapter_instance_guid_, pul_status_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub extern "netapi32" fn NetValidatePasswordPolicy(
    server_name: ?[*:0]const u16,
    qualifier: ?*anyopaque,
    validation_type: NET_VALIDATE_PASSWORD_TYPE,
    input_arg: ?*anyopaque,
    output_arg: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "netapi32" fn NetAlertRaiseEx(
    alert_type: ?[*:0]const u16,
    variable_info: ?*anyopaque,
    variable_info_size: u32,
...
pub extern "netapi32" fn NetRemoteComputerSupports(
    unc_server_name: ?[*:0]const u16,
    options_wanted: NET_REMOTE_COMPUTER_SUPPORTS_OPTIONS,
    options_supported: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "netapi32" fn NetServerComputerNameAdd(
    server_name: ?PWSTR,
    emulated_domain_name: ?PWSTR,
    emulated_server_name: ?PWSTR,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "netapi32" fn NetUseDel(
    unc_server_name: ?PWSTR,
    use_name: ?PWSTR,
    force_level_flags: FORCE_LEVEL_FLAGS,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "netapi32" fn NetApiBufferReallocate(
    old_buffer: ?*anyopaque,
    new_byte_count: u32,
    new_buffer: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "netapi32" fn NetJoinDomain(
    ...
    lp_machine_account_o_u: ?[*:0]const u16,
    lp_account: ?[*:0]const u16,
    lp_password: ?[*:0]const u16,
    f_join_options: NET_JOIN_DOMAIN_JOIN_OPTIONS,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "netapi32" fn NetUnjoinDomain(
    ...
    lp_account: ?[*:0]const u16,
    lp_password: ?[*:0]const u16,
    f_unjoin_options: u32,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows5.0'
pub extern "netapi32" fn NetRenameMachineInDomain(
    lp_server: ?[*:0]const u16,
    lp_new_machine_name: ?[*:0]const u16,
    lp_account: ?[*:0]const u16,
    lp_password: ?[*:0]const u16,
    f_rename_options: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "netapi32" fn NetAddAlternateComputerName(
    server: ?[*:0]const u16,
    alternate_name: ?[*:0]const u16,
    domain_account: ?[*:0]const u16,
    domain_account_password: ?[*:0]const u16,
    reserved: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "netapi32" fn NetEnumerateComputerNames(
    server: ?[*:0]const u16,
    name_type: NET_COMPUTER_NAME_TYPE,
    reserved: u32,
    entry_count: ?*u32,
    computer_names: ?*?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "netapi32" fn NetProvisionComputerAccount(
    ...
    lp_machine_account_o_u: ?[*:0]const u16,
    lp_dc_name: ?[*:0]const u16,
    dw_options: NETSETUP_PROVISION,
    p_provision_bin_data: ?*?*u8,
    pdw_provision_bin_data_size: ?*u32,
    p_provision_text_data: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "netapi32" fn NetRequestOfflineDomainJoin(
    ...
    p_provision_bin_data: ?*u8,
    cb_provision_bin_data_size: u32,
    dw_options: NET_REQUEST_PROVISION_OPTIONS,
    lp_windows_path: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows8.0'
pub extern "netapi32" fn NetCreateProvisioningPackage(
    p_provisioning_params: ?*NETSETUP_PROVISIONING_PARAMS,
    pp_package_bin_data: ?*?*u8,
    pdw_package_bin_data_size: ?*u32,
    pp_package_text_data: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows8.0'
pub extern "netapi32" fn NetRequestProvisioningPackageInstall(
    // TODO: what to do with BytesParamIndex 1?
    p_package_bin_data: ?*u8,
    dw_package_bin_data_size: u32,
    dw_provision_options: NET_REQUEST_PROVISION_OPTIONS,
    lp_windows_path: ?[*:0]const u16,
    pv_reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "netapi32" fn NetGetAadJoinInformation(
    pcsz_tenant_id: ?[*:0]const u16,
    pp_join_info: ?*?*DSREG_JOIN_INFO,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows10.0.10240'
pub extern "netapi32" fn NetFreeAadJoinInformation(
    p_join_info: ?*DSREG_JOIN_INFO,
) callconv(@import("std").os.windows.WINAPI) void;

// TODO: this type is limited to platform 'windows5.0'
pub extern "netapi32" fn NetGetJoinInformation(
    lp_server: ?[*:0]const u16,
    lp_name_buffer: ?*?PWSTR,
    buffer_type: ?*NETSETUP_JOIN_STATUS,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "netapi32" fn NetScheduleJobEnum(
    servername: ?[*:0]const u16,
    pointer_to_buffer: ?*?*u8,
    preffered_maximum_length: u32,
    entries_read: ?*u32,
    total_entries: ?*u32,
    resume_handle: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "rtutils" fn TraceDumpExA(
    ...
    dw_byte_count: u32,
    dw_group_size: u32,
    b_address_prefix: BOOL,
    lpsz_prefix: ?[*:0]const u8,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "rtutils" fn TraceRegisterExW(
    lpsz_caller_name: ?[*:0]const u16,
    dw_flags: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "rtutils" fn TraceDumpExW(
    ...
    dw_group_size: u32,
    b_address_prefix: BOOL,
    lpsz_prefix: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "rtutils" fn LogErrorA(
    dw_message_id: u32,
    c_number_of_sub_strings: u32,
    plpws_sub_strings: [*]?PSTR,
    dw_error_code: u32,
) callconv(@import("std").os.windows.WINAPI) void;
...
pub extern "rtutils" fn RouterLogEventA(
    ...
    dw_event_type: u32,
    dw_message_id: u32,
    dw_sub_string_count: u32,
    plpsz_sub_string_array: ?[*]?PSTR,
    dw_error_code: u32,
) callconv(@import("std").os.windows.WINAPI) void;
...
pub extern "rtutils" fn RouterGetErrorStringA(
    dw_error_code: u32,
    lplpsz_error_string: ?*?PSTR,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "rtutils" fn RouterLogRegisterW(
    lpsz_source: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) ?HANDLE;
...
pub extern "rtutils" fn RouterGetErrorStringW(
    dw_error_code: u32,
    lplpwsz_error_string: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "rtutils" fn RouterAssert(
    psz_failed_assertion: ?PSTR,
    psz_file_name: ?PSTR,
    dw_line_number: u32,
    psz_message: ?PSTR,
) callconv(@import("std").os.windows.WINAPI) void;
