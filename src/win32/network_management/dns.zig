...
pub const PDNS_QUERY_COMPLETION_ROUTINE = *const fn (
    p_query_context: ?*anyopaque,
    p_query_results: ?*DNS_QUERY_RESULT,
) callconv(@import("std").os.windows.WINAPI) void;
...
pub const PDNS_SERVICE_RESOLVE_COMPLETE = *const fn (
    status: u32,
    p_query_context: ?*anyopaque,
    p_instance: ?*DNS_SERVICE_INSTANCE,
) callconv(@import("std").os.windows.WINAPI) void;
...
pub const PMDNS_QUERY_CALLBACK = *const fn (
    p_query_context: ?*anyopaque,
    p_query_handle: ?*MDNS_QUERY_HANDLE,
    p_query_results: ?*DNS_QUERY_RESULT,
) callconv(@import("std").os.windows.WINAPI) void;
...
pub extern "dnsapi" fn DnsRecordCopyEx(
    p_record: ?*DNS_RECORDA,
    char_set_in: DNS_CHARSET,
    char_set_out: DNS_CHARSET,
) callconv(@import("std").os.windows.WINAPI) ?*DNS_RECORDA;

// TODO: this type is limited to platform 'windows5.0'
pub extern "dnsapi" fn DnsRecordSetCopyEx(
    p_record_set: ?*DNS_RECORDA,
    char_set_in: DNS_CHARSET,
    char_set_out: DNS_CHARSET,
) callconv(@import("std").os.windows.WINAPI) ?*DNS_RECORDA;
...
pub extern "dnsapi" fn DnsRecordCompare(
    p_record1: ?*DNS_RECORDA,
    p_record2: ?*DNS_RECORDA,
...
pub extern "dnsapi" fn DnsRecordSetCompare(
    p_r_r1: ?*DNS_RECORDA,
    p_r_r2: ?*DNS_RECORDA,
    pp_diff1: ?*?*DNS_RECORDA,
    pp_diff2: ?*?*DNS_RECORDA,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.0'
pub extern "dnsapi" fn DnsRecordSetDetach(
    p_record_list: ?*DNS_RECORDA,
) callconv(@import("std").os.windows.WINAPI) ?*DNS_RECORDA;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "dnsapi" fn DnsFree(
    p_data: ?*anyopaque,
    free_type: DNS_FREE_TYPE,
) callconv(@import("std").os.windows.WINAPI) void;
...
pub extern "dnsapi" fn DnsQueryEx(
    p_query_request: ?*DNS_QUERY_REQUEST,
    p_query_results: ?*DNS_QUERY_RESULT,
    p_cancel_handle: ?*DNS_QUERY_CANCEL,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "dnsapi" fn DnsFreeCustomServers(
    pc_servers: ?*u32,
    pp_servers: ?*?*DNS_CUSTOM_SERVER,
) callconv(@import("std").os.windows.WINAPI) void;

pub extern "dnsapi" fn DnsGetApplicationSettings(
    pc_servers: ?*u32,
    pp_default_servers: ?*?*DNS_CUSTOM_SERVER,
    p_settings: ?*DNS_APPLICATION_SETTINGS,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "dnsapi" fn DnsSetApplicationSettings(
    c_servers: u32,
    p_servers: [*]const DNS_CUSTOM_SERVER,
    p_settings: ?*const DNS_APPLICATION_SETTINGS,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows5.0'
pub extern "dnsapi" fn DnsAcquireContextHandle_W(
    credential_flags: u32,
    credentials: ?*anyopaque,
    p_context: ?*DnsContextHandle,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "dnsapi" fn DnsModifyRecordsInSet_W(
    p_add_records: ?*DNS_RECORDA,
    p_delete_records: ?*DNS_RECORDA,
    options: u32,
    h_credentials: ?HANDLE,
    p_extra_list: ?*anyopaque,
    p_reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "dnsapi" fn DnsReplaceRecordSetW(
    p_replace_set: ?*DNS_RECORDA,
    options: u32,
    h_context: ?HANDLE,
    p_extra_info: ?*anyopaque,
    p_reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "dnsapi" fn DnsWriteQuestionToBuffer_W(
    p_dns_buffer: ?*DNS_MESSAGE_BUFFER,
    pdw_buffer_size: ?*u32,
    psz_name: ?[*:0]const u16,
    w_type: u16,
    xid: u16,
...
pub extern "dnsapi" fn DnsExtractRecordsFromMessage_W(
    p_dns_buffer: ?*DNS_MESSAGE_BUFFER,
    w_message_length: u16,
    pp_record: ?*?*DNS_RECORDA,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "dnsapi" fn DnsGetProxyInformation(
    host_name: ?[*:0]const u16,
    proxy_information: ?*DNS_PROXY_INFORMATION,
    default_proxy_information: ?*DNS_PROXY_INFORMATION,
    completion_routine: ?DNS_PROXY_COMPLETION_ROUTINE,
    completion_context: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "dnsapi" fn DnsConnectionGetProxyInfoForHostUrl(
    pwsz_host_url: ?[*:0]const u16,
    p_selection_context: ?[*:0]u8,
    dw_selection_context_length: u32,
    dw_explicit_interface_index: u32,
    p_proxy_info_ex: ?*DNS_CONNECTION_PROXY_INFO_EX,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "dnsapi" fn DnsConnectionGetProxyInfo(
    pwsz_connection_name: ?[*:0]const u16,
    type: DNS_CONNECTION_PROXY_TYPE,
    p_proxy_info: ?*DNS_CONNECTION_PROXY_INFO,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "dnsapi" fn DnsConnectionSetProxyInfo(
    pwsz_connection_name: ?[*:0]const u16,
    type: DNS_CONNECTION_PROXY_TYPE,
    p_proxy_info: ?*const DNS_CONNECTION_PROXY_INFO,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "dnsapi" fn DnsConnectionGetProxyList(
    pwsz_connection_name: ?[*:0]const u16,
    p_proxy_list: ?*DNS_CONNECTION_PROXY_LIST,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "dnsapi" fn DnsConnectionGetNameList(
    p_name_list: ?*DNS_CONNECTION_NAME_LIST,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "dnsapi" fn DnsConnectionUpdateIfIndexTable(
    p_connection_if_index_entries: ?*DNS_CONNECTION_IFINDEX_LIST,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "dnsapi" fn DnsConnectionSetPolicyEntries(
    policy_entry_tag: DNS_CONNECTION_POLICY_TAG,
    p_policy_entry_list: ?*DNS_CONNECTION_POLICY_ENTRY_LIST,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "dnsapi" fn DnsServiceConstructInstance(
    ...
    p_host_name: ?[*:0]const u16,
    p_ip4: ?*u32,
    p_ip6: ?*IP6_ADDRESS,
    w_port: u16,
    w_priority: u16,
    w_weight: u16,
    dw_properties_count: u32,
    keys: [*]?PWSTR,
    values: [*]?PWSTR,
...
pub extern "dnsapi" fn DnsServiceBrowse(
    p_request: ?*DNS_SERVICE_BROWSE_REQUEST,
    p_cancel: ?*DNS_SERVICE_CANCEL,
) callconv(@import("std").os.windows.WINAPI) i32;

// TODO: this type is limited to platform 'windows10.0.10240'
pub extern "dnsapi" fn DnsServiceBrowseCancel(
    p_cancel_handle: ?*DNS_SERVICE_CANCEL,
) callconv(@import("std").os.windows.WINAPI) i32;

// TODO: this type is limited to platform 'windows10.0.10240'
pub extern "dnsapi" fn DnsServiceResolve(
    p_request: ?*DNS_SERVICE_RESOLVE_REQUEST,
    p_cancel: ?*DNS_SERVICE_CANCEL,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "dnsapi" fn DnsServiceRegister(
    p_request: ?*DNS_SERVICE_REGISTER_REQUEST,
    p_cancel: ?*DNS_SERVICE_CANCEL,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "dnsapi" fn DnsStartMulticastQuery(
    p_query_request: ?*MDNS_QUERY_REQUEST,
    p_handle: ?*MDNS_QUERY_HANDLE,
) callconv(@import("std").os.windows.WINAPI) i32;
