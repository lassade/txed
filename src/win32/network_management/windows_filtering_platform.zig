...
pub const IPSEC_KEY_MANAGER_KEY_DICTATION_CHECK0 = *const fn (
    ike_traffic: ?*const IKEEXT_TRAFFIC0,
    will_dictate_key: ?*BOOL,
    weight: ?*u32,
) callconv(@import("std").os.windows.WINAPI) void;

pub const IPSEC_KEY_MANAGER_DICTATE_KEY0 = *const fn (
    inbound_sa_details: ?*IPSEC_SA_DETAILS1,
    outbound_sa_details: ?*IPSEC_SA_DETAILS1,
    keying_module_gen_key: ?*BOOL,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const IPSEC_KEY_MANAGER_NOTIFY_KEY0 = *const fn (
    inbound_sa: ?*const IPSEC_SA_DETAILS1,
    outbound_sa: ?*const IPSEC_SA_DETAILS1,
) callconv(@import("std").os.windows.WINAPI) void;
...
pub extern "fwpuclnt" fn FwpmSessionCreateEnumHandle0(
    engine_handle: ?HANDLE,
    enum_template: ?*const FWPM_SESSION_ENUM_TEMPLATE0,
    enum_handle: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn FwpmProviderCreateEnumHandle0(
    engine_handle: ?HANDLE,
    enum_template: ?*const FWPM_PROVIDER_ENUM_TEMPLATE0,
    enum_handle: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn FwpmProviderContextAdd0(
    engine_handle: ?HANDLE,
    provider_context: ?*const FWPM_PROVIDER_CONTEXT0,
    sd: ?PSECURITY_DESCRIPTOR,
    id: ?*u64,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn FwpmProviderContextAdd1(
    engine_handle: ?HANDLE,
    provider_context: ?*const FWPM_PROVIDER_CONTEXT1,
    sd: ?PSECURITY_DESCRIPTOR,
    id: ?*u64,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn FwpmProviderContextAdd2(
    engine_handle: ?HANDLE,
    provider_context: ?*const FWPM_PROVIDER_CONTEXT2,
    sd: ?PSECURITY_DESCRIPTOR,
    id: ?*u64,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn FwpmProviderContextAdd3(
    engine_handle: ?HANDLE,
    provider_context: ?*const FWPM_PROVIDER_CONTEXT3_,
    sd: ?PSECURITY_DESCRIPTOR,
    id: ?*u64,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn FwpmProviderContextGetById0(
    engine_handle: ?HANDLE,
    id: u64,
    provider_context: ?*?*FWPM_PROVIDER_CONTEXT0,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn FwpmProviderContextGetById1(
    engine_handle: ?HANDLE,
    id: u64,
    provider_context: ?*?*FWPM_PROVIDER_CONTEXT1,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn FwpmProviderContextGetById2(
    engine_handle: ?HANDLE,
    id: u64,
    provider_context: ?*?*FWPM_PROVIDER_CONTEXT2,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "fwpuclnt" fn FwpmProviderContextGetById3(
    engine_handle: ?HANDLE,
    id: u64,
    provider_context: ?*?*FWPM_PROVIDER_CONTEXT3_,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn FwpmProviderContextCreateEnumHandle0(
    engine_handle: ?HANDLE,
    enum_template: ?*const FWPM_PROVIDER_CONTEXT_ENUM_TEMPLATE0,
    enum_handle: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn FwpmSubLayerGetByKey0(
    engine_handle: ?HANDLE,
    key: ?*const Guid,
    sub_layer: ?*?*FWPM_SUBLAYER0,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "fwpuclnt" fn FwpmSubLayerCreateEnumHandle0(
    engine_handle: ?HANDLE,
    enum_template: ?*const FWPM_SUBLAYER_ENUM_TEMPLATE0,
    enum_handle: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn FwpmLayerCreateEnumHandle0(
    engine_handle: ?HANDLE,
    enum_template: ?*const FWPM_LAYER_ENUM_TEMPLATE0,
    enum_handle: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn FwpmCalloutCreateEnumHandle0(
    engine_handle: ?HANDLE,
    enum_template: ?*const FWPM_CALLOUT_ENUM_TEMPLATE0,
    enum_handle: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn FwpmFilterCreateEnumHandle0(
    engine_handle: ?HANDLE,
    enum_template: ?*const FWPM_FILTER_ENUM_TEMPLATE0,
    enum_handle: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn FwpmIPsecTunnelAdd0(
    engine_handle: ?HANDLE,
    flags: u32,
    main_mode_policy: ?*const FWPM_PROVIDER_CONTEXT0,
    tunnel_policy: ?*const FWPM_PROVIDER_CONTEXT0,
    num_filter_conditions: u32,
    filter_conditions: [*]const FWPM_FILTER_CONDITION0,
    sd: ?PSECURITY_DESCRIPTOR,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn FwpmIPsecTunnelAdd1(
    engine_handle: ?HANDLE,
    flags: u32,
    main_mode_policy: ?*const FWPM_PROVIDER_CONTEXT1,
    tunnel_policy: ?*const FWPM_PROVIDER_CONTEXT1,
    num_filter_conditions: u32,
    filter_conditions: [*]const FWPM_FILTER_CONDITION0,
    key_mod_key: ?*const Guid,
    sd: ?PSECURITY_DESCRIPTOR,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn FwpmIPsecTunnelAdd2(
    engine_handle: ?HANDLE,
    flags: u32,
    main_mode_policy: ?*const FWPM_PROVIDER_CONTEXT2,
    tunnel_policy: ?*const FWPM_PROVIDER_CONTEXT2,
    num_filter_conditions: u32,
    filter_conditions: [*]const FWPM_FILTER_CONDITION0,
    key_mod_key: ?*const Guid,
    sd: ?PSECURITY_DESCRIPTOR,
...
pub extern "fwpuclnt" fn FwpmIPsecTunnelAdd3(
    engine_handle: ?HANDLE,
    flags: u32,
    main_mode_policy: ?*const FWPM_PROVIDER_CONTEXT3_,
    tunnel_policy: ?*const FWPM_PROVIDER_CONTEXT3_,
    num_filter_conditions: u32,
    filter_conditions: [*]const FWPM_FILTER_CONDITION0,
    key_mod_key: ?*const Guid,
    sd: ?PSECURITY_DESCRIPTOR,
...
pub extern "fwpuclnt" fn IPsecGetStatistics0(
    engine_handle: ?HANDLE,
    ipsec_statistics: ?*IPSEC_STATISTICS0,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.1'
pub extern "fwpuclnt" fn IPsecGetStatistics1(
    engine_handle: ?HANDLE,
    ipsec_statistics: ?*IPSEC_STATISTICS1,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "fwpuclnt" fn IPsecSaContextCreate0(
    engine_handle: ?HANDLE,
    outbound_traffic: ?*const IPSEC_TRAFFIC0,
    inbound_filter_id: ?*u64,
    id: ?*u64,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn IPsecSaContextCreate1(
    engine_handle: ?HANDLE,
    outbound_traffic: ?*const IPSEC_TRAFFIC1,
    virtual_if_tunnel_info: ?*const IPSEC_VIRTUAL_IF_TUNNEL_INFO0,
    inbound_filter_id: ?*u64,
    id: ?*u64,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn IPsecSaContextAddInbound0(
    engine_handle: ?HANDLE,
    id: u64,
    inbound_bundle: ?*const IPSEC_SA_BUNDLE0,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn IPsecSaContextAddOutbound0(
    engine_handle: ?HANDLE,
    id: u64,
    outbound_bundle: ?*const IPSEC_SA_BUNDLE0,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn IPsecSaContextAddInbound1(
    engine_handle: ?HANDLE,
    id: u64,
    inbound_bundle: ?*const IPSEC_SA_BUNDLE1,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn IPsecSaContextAddOutbound1(
    engine_handle: ?HANDLE,
    id: u64,
    outbound_bundle: ?*const IPSEC_SA_BUNDLE1,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn IPsecSaContextUpdate0(
    engine_handle: ?HANDLE,
    flags: u64,
    new_values: ?*const IPSEC_SA_CONTEXT1,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "fwpuclnt" fn IPsecSaContextCreateEnumHandle0(
    engine_handle: ?HANDLE,
    enum_template: ?*const IPSEC_SA_CONTEXT_ENUM_TEMPLATE0,
    enum_handle: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn IPsecSaCreateEnumHandle0(
    engine_handle: ?HANDLE,
    enum_template: ?*const IPSEC_SA_ENUM_TEMPLATE0,
    enum_handle: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn IPsecDospGetStatistics0(
    engine_handle: ?HANDLE,
    idp_statistics: ?*IPSEC_DOSP_STATISTICS0,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.1'
pub extern "fwpuclnt" fn IPsecDospStateCreateEnumHandle0(
    engine_handle: ?HANDLE,
    enum_template: ?*const IPSEC_DOSP_STATE_ENUM_TEMPLATE0,
    enum_handle: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn IPsecKeyManagerAddAndRegister0(
    engine_handle: ?HANDLE,
    key_manager: ?*const IPSEC_KEY_MANAGER0,
    key_manager_callbacks: ?*const IPSEC_KEY_MANAGER_CALLBACKS0,
    key_mgmt_handle: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn IkeextGetStatistics1(
    engine_handle: ?HANDLE,
    ikeext_statistics: ?*IKEEXT_STATISTICS1,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn IkeextSaCreateEnumHandle0(
    engine_handle: ?HANDLE,
    enum_template: ?*const IKEEXT_SA_ENUM_TEMPLATE0,
    enum_handle: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn FwpmNetEventCreateEnumHandle0(
    engine_handle: ?HANDLE,
    enum_template: ?*const FWPM_NET_EVENT_ENUM_TEMPLATE0,
    enum_handle: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "fwpuclnt" fn FwpmConnectionCreateEnumHandle0(
    engine_handle: ?HANDLE,
    enum_template: ?*const FWPM_CONNECTION_ENUM_TEMPLATE0,
    enum_handle: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;
