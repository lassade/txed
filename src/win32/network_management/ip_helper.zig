...
pub const PSTABLE_UNICAST_IPADDRESS_TABLE_CALLBACK = *const fn (
    caller_context: ?*anyopaque,
    address_table: ?*MIB_UNICASTIPADDRESS_TABLE,
) callconv(@import("std").os.windows.WINAPI) void;
...
pub extern "iphlpapi" fn GetIpNetworkConnectionBandwidthEstimates(
    interface_index: u32,
    address_family: u16,
    bandwidth_estimates: ?*MIB_IP_NETWORK_CONNECTION_BANDWIDTH_ESTIMATES,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub extern "iphlpapi" fn NotifyStableUnicastIpAddressTable(
    family: u16,
    table: ?*?*MIB_UNICASTIPADDRESS_TABLE,
    caller_callback: ?PSTABLE_UNICAST_IPADDRESS_TABLE_CALLBACK,
    caller_context: ?*anyopaque,
    notification_handle: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub extern "iphlpapi" fn GetBestRoute2(
    ...
    destination_address: ?*const SOCKADDR_INET,
    address_sort_options: u32,
    best_route: ?*MIB_IPFORWARD_ROW2,
    best_source_address: ?*SOCKADDR_INET,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub extern "iphlpapi" fn CreateSortedAddressPairs(
    source_address_list: ?*const SOCKADDR_IN6,
    source_address_count: u32,
    destination_address_list: ?*const SOCKADDR_IN6,
    destination_address_count: u32,
    address_sort_options: u32,
    sorted_address_pair_list: ?*?*SOCKADDR_IN6_PAIR,
    sorted_address_pair_count: ?*u32,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub extern "iphlpapi" fn GetIpAddrTable(
    // TODO: what to do with BytesParamIndex 1?
    p_ip_addr_table: ?*MIB_IPADDRTABLE,
    pdw_size: ?*u32,
    b_order: BOOL,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "iphlpapi" fn GetIpForwardTable(
    // TODO: what to do with BytesParamIndex 1?
    p_ip_forward_table: ?*MIB_IPFORWARDTABLE,
    pdw_size: ?*u32,
    b_order: BOOL,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "iphlpapi" fn GetOwnerModuleFromTcpEntry(
    p_tcp_entry: ?*MIB_TCPROW_OWNER_MODULE,
...
pub extern "iphlpapi" fn GetExtendedUdpTable(
    // TODO: what to do with BytesParamIndex 1?
    p_udp_table: ?*anyopaque,
    pdw_size: ?*u32,
    b_order: BOOL,
    ul_af: u32,
    table_class: UDP_TABLE_CLASS,
    reserved: u32,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "iphlpapi" fn GetOwnerModuleFromUdpEntry(
    p_udp_entry: ?*MIB_UDPROW_OWNER_MODULE,
    class: TCPIP_OWNER_MODULE_INFO_CLASS,
    // TODO: what to do with BytesParamIndex 3?
    p_buffer: ?*anyopaque,
    pdw_size: ?*u32,
...
pub extern "iphlpapi" fn GetOwnerModuleFromTcp6Entry(
    p_tcp_entry: ?*MIB_TCP6ROW_OWNER_MODULE,
    class: TCPIP_OWNER_MODULE_INFO_CLASS,
    // TODO: what to do with BytesParamIndex 3?
    p_buffer: ?*anyopaque,
    pdw_size: ?*u32,
...
pub extern "iphlpapi" fn GetOwnerModuleFromUdp6Entry(
    p_udp_entry: ?*MIB_UDP6ROW_OWNER_MODULE,
    class: TCPIP_OWNER_MODULE_INFO_CLASS,
    // TODO: what to do with BytesParamIndex 3?
    p_buffer: ?*anyopaque,
    pdw_size: ?*u32,
...
pub extern "iphlpapi" fn GetBestInterface(
    dw_dest_addr: u32,
    pdw_best_if_index: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "iphlpapi" fn GetBestInterfaceEx(
    p_dest_addr: ?*SOCKADDR,
    pdw_best_if_index: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "iphlpapi" fn GetNetworkParams(
    // TODO: what to do with BytesParamIndex 1?
    p_fixed_info: ?*FIXED_INFO_W2KSP1,
    p_out_buf_len: ?*u32,
...
pub extern "iphlpapi" fn GetPerAdapterInfo(
    ...
    p_per_adapter_info: ?*IP_PER_ADAPTER_INFO_W2KSP1,
    p_out_buf_len: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "iphlpapi" fn GetInterfaceActiveTimestampCapabilities(
    interface_luid: ?*const NET_LUID_LH,
    timestamp_capabilites: ?*INTERFACE_TIMESTAMP_CAPABILITIES,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "iphlpapi" fn IpReleaseAddress(
    adapter_info: ?*IP_ADAPTER_INDEX_MAP,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "iphlpapi" fn UnenableRouter(
    p_overlapped: ?*OVERLAPPED,
    lpdw_enable_count: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "iphlpapi" fn DisableMediaSense(
    p_handle: ?*?HANDLE,
    p_over_lapped: ?*OVERLAPPED,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "iphlpapi" fn ResolveNeighbor(
    network_address: ?*SOCKADDR,
    // TODO: what to do with BytesParamIndex 2?
    physical_address: ?*anyopaque,
...
pub extern "iphlpapi" fn PfCreateInterface(
    dw_name: u32,
    in_action: PFFORWARD_ACTION,
    out_action: PFFORWARD_ACTION,
    b_use_log: BOOL,
    b_must_be_unique: BOOL,
...
pub extern "iphlpapi" fn PfAddFiltersToInterface(
    ih: ?*anyopaque,
    c_in_filters: u32,
    pfilt_in: ?*PF_FILTER_DESCRIPTOR,
    c_out_filters: u32,
    pfilt_out: ?*PF_FILTER_DESCRIPTOR,
    pf_handle: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "iphlpapi" fn PfRebindFilters(
    p_interface: ?*anyopaque,
    p_late_bind_info: ?*PF_LATEBIND_INFO,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "iphlpapi" fn PfAddGlobalFilterToInterface(
    p_interface: ?*anyopaque,
    gf_filter: GLOBAL_FILTER,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "iphlpapi" fn PfSetLogBuffer(
    ...
    dw_threshold: u32,
    dw_entries: u32,
    pdw_logged_entries: ?*u32,
    pdw_lost_entries: ?*u32,
    pdw_size_used: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "iphlpapi" fn PfGetInterfaceStatistics(
    p_interface: ?*anyopaque,
    ppf_stats: ?*PF_INTERFACE_STATS,
    pdw_buffer_size: ?*u32,
    f_reset_counters: BOOL,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "iphlpapi" fn PfTestPacket(
    p_in_interface: ?*anyopaque,
    p_out_interface: ?*anyopaque,
    c_bytes: u32,
    pb_packet: ?*u8,
    pp_action: ?*PFFORWARD_ACTION,
) callconv(@import("std").os.windows.WINAPI) u32;
