...
pub const WFD_OPEN_SESSION_COMPLETE_CALLBACK = *const fn (
    h_session_handle: ?HANDLE,
    pv_context: ?*anyopaque,
    guid_session_interface: Guid,
    dw_error: u32,
    dw_reason_code: u32,
) callconv(@import("std").os.windows.WINAPI) void;
...
pub const IDot11AdHocManager = extern struct {
    pub const VTable = extern struct {
        ...
        CreateNetwork: *const fn (
            ...
            geographical_id: i32,
            p_interface: ?*IDot11AdHocInterface,
            p_security: ?*IDot11AdHocSecuritySettings,
            p_context_guid: ?*Guid,
            p_i_ad_hoc: ?*?*IDot11AdHocNetwork,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        CommitCreatedNetwork: *const fn (
            self: *const IDot11AdHocManager,
            p_i_ad_hoc: ?*IDot11AdHocNetwork,
            f_save_profile: BOOLEAN,
            f_make_saved_profile_user_specific: BOOLEAN,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetIEnumDot11AdHocNetworks: *const fn (
            self: *const IDot11AdHocManager,
            p_context_guid: ?*Guid,
            pp_enum: ?*?*IEnumDot11AdHocNetworks,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetIEnumDot11AdHocInterfaces: *const fn (
            self: *const IDot11AdHocManager,
            pp_enum: ?*?*IEnumDot11AdHocInterfaces,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetNetwork: *const fn (
            self: *const IDot11AdHocManager,
            network_signature: ?*Guid,
            p_network: ?*?*IDot11AdHocNetwork,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn createNetwork(self: *const T, name_: ?[*:0]const u16, password_: ?[*:0]const u16, geographical_id_: i32, p_interface_: ?*IDot11AdHocInterface, p_security_: ?*IDot11AdHocSecuritySettings, p_context_guid_: ?*Guid, p_i_ad_hoc_: ?*?*IDot11AdHocNetwork) HRESULT {
                return @as(*const IDot11AdHocManager.VTable, @ptrCast(self.vtable)).CreateNetwork(@as(*const IDot11AdHocManager, @ptrCast(self)), name_, password_, geographical_id_, p_interface_, p_security_, p_context_guid_, p_i_ad_hoc_);
            }
            pub inline fn commitCreatedNetwork(self: *const T, p_i_ad_hoc_: ?*IDot11AdHocNetwork, f_save_profile_: BOOLEAN, f_make_saved_profile_user_specific_: BOOLEAN) HRESULT {
                return @as(*const IDot11AdHocManager.VTable, @ptrCast(self.vtable)).CommitCreatedNetwork(@as(*const IDot11AdHocManager, @ptrCast(self)), p_i_ad_hoc_, f_save_profile_, f_make_saved_profile_user_specific_);
            }
            pub inline fn getIEnumDot11AdHocNetworks(self: *const T, p_context_guid_: ?*Guid, pp_enum_: ?*?*IEnumDot11AdHocNetworks) HRESULT {
                return @as(*const IDot11AdHocManager.VTable, @ptrCast(self.vtable)).GetIEnumDot11AdHocNetworks(@as(*const IDot11AdHocManager, @ptrCast(self)), p_context_guid_, pp_enum_);
            }
            pub inline fn getIEnumDot11AdHocInterfaces(self: *const T, pp_enum_: ?*?*IEnumDot11AdHocInterfaces) HRESULT {
                return @as(*const IDot11AdHocManager.VTable, @ptrCast(self.vtable)).GetIEnumDot11AdHocInterfaces(@as(*const IDot11AdHocManager, @ptrCast(self)), pp_enum_);
            }
            pub inline fn getNetwork(self: *const T, network_signature_: ?*Guid, p_network_: ?*?*IDot11AdHocNetwork) HRESULT {
                return @as(*const IDot11AdHocManager.VTable, @ptrCast(self.vtable)).GetNetwork(@as(*const IDot11AdHocManager, @ptrCast(self)), network_signature_, p_network_);
            }
        };
    }
...
pub const IDot11AdHocManagerNotificationSink = extern struct {
    pub const VTable = extern struct {
        ...
        OnNetworkAdd: *const fn (
            ...
            p_i_ad_hoc_network: ?*IDot11AdHocNetwork,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        OnInterfaceAdd: *const fn (
            self: *const IDot11AdHocManagerNotificationSink,
            p_i_ad_hoc_interface: ?*IDot11AdHocInterface,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn onNetworkAdd(self: *const T, p_i_ad_hoc_network_: ?*IDot11AdHocNetwork) HRESULT {
                return @as(*const IDot11AdHocManagerNotificationSink.VTable, @ptrCast(self.vtable)).OnNetworkAdd(@as(*const IDot11AdHocManagerNotificationSink, @ptrCast(self)), p_i_ad_hoc_network_);
            }
            pub inline fn onNetworkRemove(self: *const T, signature_: ?*Guid) HRESULT {
                return @as(*const IDot11AdHocManagerNotificationSink.VTable, @ptrCast(self.vtable)).OnNetworkRemove(@as(*const IDot11AdHocManagerNotificationSink, @ptrCast(self)), signature_);
            }
            pub inline fn onInterfaceAdd(self: *const T, p_i_ad_hoc_interface_: ?*IDot11AdHocInterface) HRESULT {
                return @as(*const IDot11AdHocManagerNotificationSink.VTable, @ptrCast(self.vtable)).OnInterfaceAdd(@as(*const IDot11AdHocManagerNotificationSink, @ptrCast(self)), p_i_ad_hoc_interface_);
            }
            pub inline fn onInterfaceRemove(self: *const T, signature_: ?*Guid) HRESULT {
                return @as(*const IDot11AdHocManagerNotificationSink.VTable, @ptrCast(self.vtable)).OnInterfaceRemove(@as(*const IDot11AdHocManagerNotificationSink, @ptrCast(self)), signature_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IEnumDot11AdHocNetworks = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn next(self: *const T, c_elt_: u32, rg_elt_: [*]?*IDot11AdHocNetwork, pc_elt_fetched_: ?*u32) HRESULT {
                return @as(*const IEnumDot11AdHocNetworks.VTable, @ptrCast(self.vtable)).Next(@as(*const IEnumDot11AdHocNetworks, @ptrCast(self)), c_elt_, rg_elt_, pc_elt_fetched_);
            }
            pub inline fn skip(self: *const T, c_elt_: u32) HRESULT {
                return @as(*const IEnumDot11AdHocNetworks.VTable, @ptrCast(self.vtable)).Skip(@as(*const IEnumDot11AdHocNetworks, @ptrCast(self)), c_elt_);
            }
            ...
            pub inline fn clone(self: *const T, pp_enum_: ?*?*IEnumDot11AdHocNetworks) HRESULT {
                return @as(*const IEnumDot11AdHocNetworks.VTable, @ptrCast(self.vtable)).Clone(@as(*const IEnumDot11AdHocNetworks, @ptrCast(self)), pp_enum_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDot11AdHocNetwork = extern struct {
    pub const VTable = extern struct {
        ...
        GetStatus: *const fn (
            ...
            e_status: ?*DOT11_ADHOC_NETWORK_CONNECTION_STATUS,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetSSID: *const fn (
            self: *const IDot11AdHocNetwork,
            ppszw_s_s_i_d: ?*?PWSTR,
        ...
        GetSignalQuality: *const fn (
            self: *const IDot11AdHocNetwork,
            pu_strength_value: ?*u32,
            pu_strength_max: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetSecuritySetting: *const fn (
            self: *const IDot11AdHocNetwork,
            p_ad_hoc_security_setting: ?*?*IDot11AdHocSecuritySettings,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        GetInterface: *const fn (
            self: *const IDot11AdHocNetwork,
            p_ad_hoc_interface: ?*?*IDot11AdHocInterface,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Connect: *const fn (
            self: *const IDot11AdHocNetwork,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getStatus(self: *const T, e_status_: ?*DOT11_ADHOC_NETWORK_CONNECTION_STATUS) HRESULT {
                return @as(*const IDot11AdHocNetwork.VTable, @ptrCast(self.vtable)).GetStatus(@as(*const IDot11AdHocNetwork, @ptrCast(self)), e_status_);
            }
            pub inline fn getSSID(self: *const T, ppszw_s_s_i_d_: ?*?PWSTR) HRESULT {
                return @as(*const IDot11AdHocNetwork.VTable, @ptrCast(self.vtable)).GetSSID(@as(*const IDot11AdHocNetwork, @ptrCast(self)), ppszw_s_s_i_d_);
            }
            pub inline fn hasProfile(self: *const T, pf11d_: ?*u8) HRESULT {
                return @as(*const IDot11AdHocNetwork.VTable, @ptrCast(self.vtable)).HasProfile(@as(*const IDot11AdHocNetwork, @ptrCast(self)), pf11d_);
            }
            pub inline fn getProfileName(self: *const T, ppszw_profile_name_: ?*?PWSTR) HRESULT {
                return @as(*const IDot11AdHocNetwork.VTable, @ptrCast(self.vtable)).GetProfileName(@as(*const IDot11AdHocNetwork, @ptrCast(self)), ppszw_profile_name_);
            }
            pub inline fn deleteProfile(self: *const T) HRESULT {
                return @as(*const IDot11AdHocNetwork.VTable, @ptrCast(self.vtable)).DeleteProfile(@as(*const IDot11AdHocNetwork, @ptrCast(self)));
            }
            pub inline fn getSignalQuality(self: *const T, pu_strength_value_: ?*u32, pu_strength_max_: ?*u32) HRESULT {
                return @as(*const IDot11AdHocNetwork.VTable, @ptrCast(self.vtable)).GetSignalQuality(@as(*const IDot11AdHocNetwork, @ptrCast(self)), pu_strength_value_, pu_strength_max_);
            }
            pub inline fn getSecuritySetting(self: *const T, p_ad_hoc_security_setting_: ?*?*IDot11AdHocSecuritySettings) HRESULT {
                return @as(*const IDot11AdHocNetwork.VTable, @ptrCast(self.vtable)).GetSecuritySetting(@as(*const IDot11AdHocNetwork, @ptrCast(self)), p_ad_hoc_security_setting_);
            }
            pub inline fn getContextGuid(self: *const T, p_context_guid_: ?*Guid) HRESULT {
                return @as(*const IDot11AdHocNetwork.VTable, @ptrCast(self.vtable)).GetContextGuid(@as(*const IDot11AdHocNetwork, @ptrCast(self)), p_context_guid_);
            }
            pub inline fn getSignature(self: *const T, p_signature_: ?*Guid) HRESULT {
                return @as(*const IDot11AdHocNetwork.VTable, @ptrCast(self.vtable)).GetSignature(@as(*const IDot11AdHocNetwork, @ptrCast(self)), p_signature_);
            }
            pub inline fn getInterface(self: *const T, p_ad_hoc_interface_: ?*?*IDot11AdHocInterface) HRESULT {
                return @as(*const IDot11AdHocNetwork.VTable, @ptrCast(self.vtable)).GetInterface(@as(*const IDot11AdHocNetwork, @ptrCast(self)), p_ad_hoc_interface_);
            }
            pub inline fn connect(self: *const T, passphrase_: ?[*:0]const u16, geographical_id_: i32, f_save_profile_: BOOLEAN, f_make_saved_profile_user_specific_: BOOLEAN) HRESULT {
                return @as(*const IDot11AdHocNetwork.VTable, @ptrCast(self.vtable)).Connect(@as(*const IDot11AdHocNetwork, @ptrCast(self)), passphrase_, geographical_id_, f_save_profile_, f_make_saved_profile_user_specific_);
            }
...
pub const IDot11AdHocNetworkNotificationSink = extern struct {
    pub const VTable = extern struct {
        ...
        OnConnectFail: *const fn (
            self: *const IDot11AdHocNetworkNotificationSink,
            e_fail_reason: DOT11_ADHOC_CONNECT_FAIL_REASON,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn onStatusChange(self: *const T, e_status_: DOT11_ADHOC_NETWORK_CONNECTION_STATUS) HRESULT {
                return @as(*const IDot11AdHocNetworkNotificationSink.VTable, @ptrCast(self.vtable)).OnStatusChange(@as(*const IDot11AdHocNetworkNotificationSink, @ptrCast(self)), e_status_);
            }
            pub inline fn onConnectFail(self: *const T, e_fail_reason_: DOT11_ADHOC_CONNECT_FAIL_REASON) HRESULT {
                return @as(*const IDot11AdHocNetworkNotificationSink.VTable, @ptrCast(self.vtable)).OnConnectFail(@as(*const IDot11AdHocNetworkNotificationSink, @ptrCast(self)), e_fail_reason_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDot11AdHocInterface = extern struct {
    pub const VTable = extern struct {
        ...
        GetActiveNetwork: *const fn (
            self: *const IDot11AdHocInterface,
            pp_network: ?*?*IDot11AdHocNetwork,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetIEnumSecuritySettings: *const fn (
            self: *const IDot11AdHocInterface,
            pp_enum: ?*?*IEnumDot11AdHocSecuritySettings,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetIEnumDot11AdHocNetworks: *const fn (
            self: *const IDot11AdHocInterface,
            p_filter_guid: ?*Guid,
        ...
        GetStatus: *const fn (
            self: *const IDot11AdHocInterface,
            p_state: ?*DOT11_ADHOC_NETWORK_CONNECTION_STATUS,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getDeviceSignature(self: *const T, p_signature_: ?*Guid) HRESULT {
                return @as(*const IDot11AdHocInterface.VTable, @ptrCast(self.vtable)).GetDeviceSignature(@as(*const IDot11AdHocInterface, @ptrCast(self)), p_signature_);
            }
            pub inline fn getFriendlyName(self: *const T, ppsz_name_: ?*?PWSTR) HRESULT {
                return @as(*const IDot11AdHocInterface.VTable, @ptrCast(self.vtable)).GetFriendlyName(@as(*const IDot11AdHocInterface, @ptrCast(self)), ppsz_name_);
            }
            pub inline fn isDot11d(self: *const T, pf11d_: ?*u8) HRESULT {
                return @as(*const IDot11AdHocInterface.VTable, @ptrCast(self.vtable)).IsDot11d(@as(*const IDot11AdHocInterface, @ptrCast(self)), pf11d_);
            }
            pub inline fn isAdHocCapable(self: *const T, pf_ad_hoc_capable_: ?*u8) HRESULT {
                return @as(*const IDot11AdHocInterface.VTable, @ptrCast(self.vtable)).IsAdHocCapable(@as(*const IDot11AdHocInterface, @ptrCast(self)), pf_ad_hoc_capable_);
            }
            pub inline fn isRadioOn(self: *const T, pf_is_radio_on_: ?*u8) HRESULT {
                return @as(*const IDot11AdHocInterface.VTable, @ptrCast(self.vtable)).IsRadioOn(@as(*const IDot11AdHocInterface, @ptrCast(self)), pf_is_radio_on_);
            }
            pub inline fn getActiveNetwork(self: *const T, pp_network_: ?*?*IDot11AdHocNetwork) HRESULT {
                return @as(*const IDot11AdHocInterface.VTable, @ptrCast(self.vtable)).GetActiveNetwork(@as(*const IDot11AdHocInterface, @ptrCast(self)), pp_network_);
            }
            pub inline fn getIEnumSecuritySettings(self: *const T, pp_enum_: ?*?*IEnumDot11AdHocSecuritySettings) HRESULT {
                return @as(*const IDot11AdHocInterface.VTable, @ptrCast(self.vtable)).GetIEnumSecuritySettings(@as(*const IDot11AdHocInterface, @ptrCast(self)), pp_enum_);
            }
            pub inline fn getIEnumDot11AdHocNetworks(self: *const T, p_filter_guid_: ?*Guid, pp_enum_: ?*?*IEnumDot11AdHocNetworks) HRESULT {
                return @as(*const IDot11AdHocInterface.VTable, @ptrCast(self.vtable)).GetIEnumDot11AdHocNetworks(@as(*const IDot11AdHocInterface, @ptrCast(self)), p_filter_guid_, pp_enum_);
            }
            pub inline fn getStatus(self: *const T, p_state_: ?*DOT11_ADHOC_NETWORK_CONNECTION_STATUS) HRESULT {
                return @as(*const IDot11AdHocInterface.VTable, @ptrCast(self.vtable)).GetStatus(@as(*const IDot11AdHocInterface, @ptrCast(self)), p_state_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IEnumDot11AdHocInterfaces = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn next(self: *const T, c_elt_: u32, rg_elt_: [*]?*IDot11AdHocInterface, pc_elt_fetched_: ?*u32) HRESULT {
                return @as(*const IEnumDot11AdHocInterfaces.VTable, @ptrCast(self.vtable)).Next(@as(*const IEnumDot11AdHocInterfaces, @ptrCast(self)), c_elt_, rg_elt_, pc_elt_fetched_);
            }
            pub inline fn skip(self: *const T, c_elt_: u32) HRESULT {
                return @as(*const IEnumDot11AdHocInterfaces.VTable, @ptrCast(self.vtable)).Skip(@as(*const IEnumDot11AdHocInterfaces, @ptrCast(self)), c_elt_);
            }
            pub inline fn reset(self: *const T) HRESULT {
            ...
            pub inline fn clone(self: *const T, pp_enum_: ?*?*IEnumDot11AdHocInterfaces) HRESULT {
                return @as(*const IEnumDot11AdHocInterfaces.VTable, @ptrCast(self.vtable)).Clone(@as(*const IEnumDot11AdHocInterfaces, @ptrCast(self)), pp_enum_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IEnumDot11AdHocSecuritySettings = extern struct {
    pub const VTable = extern struct {
        ...
        Next: *const fn (
            ...
            c_elt: u32,
            rg_elt: [*]?*IDot11AdHocSecuritySettings,
            pc_elt_fetched: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Skip: *const fn (
            self: *const IEnumDot11AdHocSecuritySettings,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn next(self: *const T, c_elt_: u32, rg_elt_: [*]?*IDot11AdHocSecuritySettings, pc_elt_fetched_: ?*u32) HRESULT {
                return @as(*const IEnumDot11AdHocSecuritySettings.VTable, @ptrCast(self.vtable)).Next(@as(*const IEnumDot11AdHocSecuritySettings, @ptrCast(self)), c_elt_, rg_elt_, pc_elt_fetched_);
            }
            pub inline fn skip(self: *const T, c_elt_: u32) HRESULT {
                return @as(*const IEnumDot11AdHocSecuritySettings.VTable, @ptrCast(self.vtable)).Skip(@as(*const IEnumDot11AdHocSecuritySettings, @ptrCast(self)), c_elt_);
            }
            pub inline fn reset(self: *const T) HRESULT {
            ...
            pub inline fn clone(self: *const T, pp_enum_: ?*?*IEnumDot11AdHocSecuritySettings) HRESULT {
                return @as(*const IEnumDot11AdHocSecuritySettings.VTable, @ptrCast(self.vtable)).Clone(@as(*const IEnumDot11AdHocSecuritySettings, @ptrCast(self)), pp_enum_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDot11AdHocSecuritySettings = extern struct {
    pub const VTable = extern struct {
        ...
        GetDot11AuthAlgorithm: *const fn (
            ...
            p_auth: ?*DOT11_ADHOC_AUTH_ALGORITHM,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetDot11CipherAlgorithm: *const fn (
            self: *const IDot11AdHocSecuritySettings,
            p_cipher: ?*DOT11_ADHOC_CIPHER_ALGORITHM,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getDot11AuthAlgorithm(self: *const T, p_auth_: ?*DOT11_ADHOC_AUTH_ALGORITHM) HRESULT {
                return @as(*const IDot11AdHocSecuritySettings.VTable, @ptrCast(self.vtable)).GetDot11AuthAlgorithm(@as(*const IDot11AdHocSecuritySettings, @ptrCast(self)), p_auth_);
            }
            pub inline fn getDot11CipherAlgorithm(self: *const T, p_cipher_: ?*DOT11_ADHOC_CIPHER_ALGORITHM) HRESULT {
                return @as(*const IDot11AdHocSecuritySettings.VTable, @ptrCast(self.vtable)).GetDot11CipherAlgorithm(@as(*const IDot11AdHocSecuritySettings, @ptrCast(self)), p_cipher_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IDot11AdHocInterfaceNotificationSink = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn onConnectionStatusChange(self: *const T, e_status_: DOT11_ADHOC_NETWORK_CONNECTION_STATUS) HRESULT {
                return @as(*const IDot11AdHocInterfaceNotificationSink.VTable, @ptrCast(self.vtable)).OnConnectionStatusChange(@as(*const IDot11AdHocInterfaceNotificationSink, @ptrCast(self)), e_status_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub extern "wlanapi" fn WlanOpenHandle(
    ...
    pdw_negotiated_version: ?*u32,
    ph_client_handle: ?*?HANDLE,
...
pub extern "wlanapi" fn WlanEnumInterfaces(
    h_client_handle: ?HANDLE,
    p_reserved: ?*anyopaque,
    pp_interface_list: ?*?*WLAN_INTERFACE_INFO_LIST,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "wlanapi" fn WlanSetAutoConfigParameter(
    h_client_handle: ?HANDLE,
    op_code: WLAN_AUTOCONF_OPCODE,
    dw_data_size: u32,
...
pub extern "wlanapi" fn WlanQueryAutoConfigParameter(
    ...
    pdw_data_size: ?*u32,
    pp_data: ?*?*anyopaque,
    p_wlan_opcode_value_type: ?*WLAN_OPCODE_VALUE_TYPE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WlanGetInterfaceCapability(
    ...
    p_reserved: ?*anyopaque,
    pp_capability: ?*?*WLAN_INTERFACE_CAPABILITY,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WlanIhvControl(
    ...
    // TODO: what to do with BytesParamIndex 3?
    p_in_buffer: ?*anyopaque,
    dw_out_buffer_size: u32,
    // TODO: what to do with BytesParamIndex 5?
    p_out_buffer: ?*anyopaque,
    pdw_bytes_returned: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WlanGetAvailableNetworkList(
    ...
    dw_flags: u32,
    p_reserved: ?*anyopaque,
    pp_available_network_list: ?*?*WLAN_AVAILABLE_NETWORK_LIST,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WlanGetAvailableNetworkList2(
    ...
    dw_flags: u32,
    p_reserved: ?*anyopaque,
    pp_available_network_list: ?*?*WLAN_AVAILABLE_NETWORK_LIST_V2,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WlanGetNetworkBssList(
    ...
    b_security_enabled: BOOL,
    p_reserved: ?*anyopaque,
    pp_wlan_bss_list: ?*?*WLAN_BSS_LIST,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WlanConnect(
    h_client_handle: ?HANDLE,
    p_interface_guid: ?*const Guid,
    p_connection_parameters: ?*const WLAN_CONNECTION_PARAMETERS,
    p_reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WlanConnect2(
    h_client_handle: ?HANDLE,
    p_interface_guid: ?*const Guid,
    p_connection_parameters: ?*const WLAN_CONNECTION_PARAMETERS_V2,
    p_reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WlanRegisterNotification(
    h_client_handle: ?HANDLE,
    dw_notif_source: u32,
    b_ignore_duplicate: BOOL,
    func_callback: ?WLAN_NOTIFICATION_CALLBACK,
    p_callback_context: ?*anyopaque,
    p_reserved: ?*anyopaque,
    pdw_prev_notif_source: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WlanGetProfile(
    h_client_handle: ?HANDLE,
    p_interface_guid: ?*const Guid,
    str_profile_name: ?[*:0]const u16,
    p_reserved: ?*anyopaque,
    pstr_profile_xml: ?*?PWSTR,
    pdw_flags: ?*u32,
    pdw_granted_access: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WlanSetProfileEapUserData(
    ...
    dw_flags: WLAN_SET_EAPHOST_FLAGS,
    dw_eap_user_data_size: u32,
    // TODO: what to do with BytesParamIndex 5?
    pb_eap_user_data: ?*const u8,
    p_reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WlanSetProfileEapXmlUserData(
    ...
    str_profile_name: ?[*:0]const u16,
    dw_flags: WLAN_SET_EAPHOST_FLAGS,
    str_eap_xml_user_data: ?[*:0]const u16,
    p_reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WlanSetProfile(
    ...
    p_interface_guid: ?*const Guid,
    dw_flags: u32,
    str_profile_xml: ?[*:0]const u16,
    str_all_user_profile_security: ?[*:0]const u16,
    b_overwrite: BOOL,
    p_reserved: ?*anyopaque,
    pdw_reason_code: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WlanRenameProfile(
    h_client_handle: ?HANDLE,
    p_interface_guid: ?*const Guid,
    str_old_profile_name: ?[*:0]const u16,
    str_new_profile_name: ?[*:0]const u16,
    p_reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WlanGetProfileList(
    ...
    p_interface_guid: ?*const Guid,
    p_reserved: ?*anyopaque,
    pp_profile_list: ?*?*WLAN_PROFILE_INFO_LIST,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WlanSetFilterList(
    ...
    p_network_list: ?*const DOT11_NETWORK_LIST,
    p_reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WlanGetFilterList(
    ...
    wlan_filter_list_type: WLAN_FILTER_LIST_TYPE,
    p_reserved: ?*anyopaque,
    pp_network_list: ?*?*DOT11_NETWORK_LIST,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "wlanapi" fn WlanSetPsdIEDataList(
    h_client_handle: ?HANDLE,
    str_format: ?[*:0]const u16,
    p_psd_i_e_data_list: ?*const WLAN_RAW_DATA_LIST,
    p_reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WlanGetSupportedDeviceServices(
    h_client_handle: ?HANDLE,
    p_interface_guid: ?*const Guid,
    pp_dev_svc_guid_list: ?*?*WLAN_DEVICE_SERVICE_GUID_LIST,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "wlanapi" fn WlanRegisterDeviceServiceNotification(
    h_client_handle: ?HANDLE,
    p_dev_svc_guid_list: ?*const WLAN_DEVICE_SERVICE_GUID_LIST,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WlanExtractPsdIEDataList(
    ...
    p_raw_ie_data: ?*const u8,
    str_format: ?[*:0]const u16,
    p_reserved: ?*anyopaque,
    pp_psd_i_e_data_list: ?*?*WLAN_RAW_DATA_LIST,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WlanSetSecuritySettings(
    h_client_handle: ?HANDLE,
    securable_object: WLAN_SECURABLE_OBJECT,
    str_modified_s_d_d_l: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WlanGetSecuritySettings(
    h_client_handle: ?HANDLE,
    securable_object: WLAN_SECURABLE_OBJECT,
    p_value_type: ?*WLAN_OPCODE_VALUE_TYPE,
    pstr_current_s_d_d_l: ?*?PWSTR,
    pdw_granted_access: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanui" fn WlanUIEditProfile(
    dw_client_version: u32,
    wstr_profile_name: ?[*:0]const u16,
    p_interface_guid: ?*Guid,
    h_wnd: ?HWND,
    wl_start_page: WL_DISPLAY_PAGES,
    p_reserved: ?*anyopaque,
    p_wlan_reason_code: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.1'
pub extern "wlanapi" fn WlanHostedNetworkStartUsing(
    h_client_handle: ?HANDLE,
    p_fail_reason: ?*WLAN_HOSTED_NETWORK_REASON,
...
pub extern "wlanapi" fn WlanHostedNetworkQueryProperty(
    h_client_handle: ?HANDLE,
    op_code: WLAN_HOSTED_NETWORK_OPCODE,
    pdw_data_size: ?*u32,
    ppv_data: ?*?*anyopaque,
    p_wlan_opcode_value_type: ?*WLAN_OPCODE_VALUE_TYPE,
    pv_reserved: ?*anyopaque,
...
pub extern "wlanapi" fn WlanHostedNetworkQueryStatus(
    h_client_handle: ?HANDLE,
    pp_wlan_hosted_network_status: ?*?*WLAN_HOSTED_NETWORK_STATUS,
    pv_reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WFDStartOpenSession(
    ...
    p_device_address: ?*?*u8,
    pv_context: ?*anyopaque,
    pfn_callback: ?WFD_OPEN_SESSION_COMPLETE_CALLBACK,
    ph_session_handle: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wlanapi" fn WFDOpenLegacySession(
    h_client_handle: ?HANDLE,
    p_legacy_mac_address: ?*?*u8,
    ph_session_handle: ?*?HANDLE,
    p_guid_session_interface: ?*Guid,
) callconv(@import("std").os.windows.WINAPI) u32;
