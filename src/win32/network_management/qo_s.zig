...
pub const CBADMITRESULT = *const fn (
    lpm_handle: LPM_HANDLE,
    request_handle: RHANDLE,
    ul_pcm_action_flags: u32,
    lpm_error: i32,
    policy_decisions_count: i32,
    p_policy_decisions: ?*policy_decision,
...
pub const CBGETRSVPOBJECTS = *const fn (
    ...
    request_handle: RHANDLE,
    lpm_error: i32,
    rsvp_objects_count: i32,
    pp_rsvp_objects: ?*?*RsvpObjHdr,
) callconv(@import("std").os.windows.WINAPI) ?*u32;
...
pub extern "traffic" fn TcRegisterClient(
    tci_version: u32,
    cl_reg_ctx: ?HANDLE,
    client_handler_list: ?*TCI_CLIENT_FUNC_LIST,
    p_client_handle: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "traffic" fn TcEnumerateInterfaces(
    ...
    p_buffer_size: ?*u32,
    interface_buffer: ?*TC_IFC_DESCRIPTOR,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows5.0'
pub extern "traffic" fn TcOpenInterfaceA(
    p_interface_name: ?PSTR,
    client_handle: ?HANDLE,
    cl_ifc_ctx: ?HANDLE,
    p_ifc_handle: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "traffic" fn TcAddFlow(
    ...
    cl_flow_ctx: ?HANDLE,
    flags: u32,
    p_generic_flow: ?*TC_GEN_FLOW,
    p_flow_handle: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "traffic" fn TcAddFilter(
    flow_handle: ?HANDLE,
    p_generic_filter: ?*TC_GEN_FILTER,
