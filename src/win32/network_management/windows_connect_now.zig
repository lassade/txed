...
pub const IWCNDevice = extern struct {
    pub const VTable = extern struct {
        ...
        SetPassword: *const fn (
            ...
            dw_password_length: u32,
            pb_password: [*:0]const u8,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Connect: *const fn (
            self: *const IWCNDevice,
            p_notify: ?*IWCNConnectNotify,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetAttribute: *const fn (
            self: *const IWCNDevice,
            attribute_type: WCN_ATTRIBUTE_TYPE,
        ...
        GetNetworkProfile: *const fn (
            self: *const IWCNDevice,
            cch_max_string_length: u32,
            wsz_profile: [*:0]u16,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        SetNetworkProfile: *const fn (
            self: *const IWCNDevice,
            psz_profile_xml: ?[*:0]const u16,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetVendorExtension: *const fn (
            self: *const IWCNDevice,
            p_vendor_ext_spec: ?*const WCN_VENDOR_EXTENSION_SPEC,
            dw_max_buffer_size: u32,
            pb_buffer: [*:0]u8,
            pdw_buffer_used: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        SetNFCPasswordParams: *const fn (
            self: *const IWCNDevice,
            type: WCN_PASSWORD_TYPE,
            dw_o_o_b_password_i_d: u32,
            dw_password_length: u32,
            pb_password: ?[*:0]const u8,
            dw_remote_public_key_hash_length: u32,
            pb_remote_public_key_hash: ?[*:0]const u8,
            dw_d_h_key_blob_length: u32,
            pb_d_h_key_blob: ?[*:0]const u8,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn setPassword(self: *const T, type_: WCN_PASSWORD_TYPE, dw_password_length_: u32, pb_password_: [*:0]const u8) HRESULT {
                return @as(*const IWCNDevice.VTable, @ptrCast(self.vtable)).SetPassword(@as(*const IWCNDevice, @ptrCast(self)), type_, dw_password_length_, pb_password_);
            }
            pub inline fn connect(self: *const T, p_notify_: ?*IWCNConnectNotify) HRESULT {
                return @as(*const IWCNDevice.VTable, @ptrCast(self.vtable)).Connect(@as(*const IWCNDevice, @ptrCast(self)), p_notify_);
            }
            pub inline fn getAttribute(self: *const T, attribute_type_: WCN_ATTRIBUTE_TYPE, dw_max_buffer_size_: u32, pb_buffer_: [*:0]u8, pdw_buffer_used_: ?*u32) HRESULT {
                return @as(*const IWCNDevice.VTable, @ptrCast(self.vtable)).GetAttribute(@as(*const IWCNDevice, @ptrCast(self)), attribute_type_, dw_max_buffer_size_, pb_buffer_, pdw_buffer_used_);
            }
            pub inline fn getIntegerAttribute(self: *const T, attribute_type_: WCN_ATTRIBUTE_TYPE, pu_integer_: ?*u32) HRESULT {
                return @as(*const IWCNDevice.VTable, @ptrCast(self.vtable)).GetIntegerAttribute(@as(*const IWCNDevice, @ptrCast(self)), attribute_type_, pu_integer_);
            }
            pub inline fn getStringAttribute(self: *const T, attribute_type_: WCN_ATTRIBUTE_TYPE, cch_max_string_: u32, wsz_string_: [*:0]u16) HRESULT {
                return @as(*const IWCNDevice.VTable, @ptrCast(self.vtable)).GetStringAttribute(@as(*const IWCNDevice, @ptrCast(self)), attribute_type_, cch_max_string_, wsz_string_);
            }
            pub inline fn getNetworkProfile(self: *const T, cch_max_string_length_: u32, wsz_profile_: [*:0]u16) HRESULT {
                return @as(*const IWCNDevice.VTable, @ptrCast(self.vtable)).GetNetworkProfile(@as(*const IWCNDevice, @ptrCast(self)), cch_max_string_length_, wsz_profile_);
            }
            pub inline fn setNetworkProfile(self: *const T, psz_profile_xml_: ?[*:0]const u16) HRESULT {
                return @as(*const IWCNDevice.VTable, @ptrCast(self.vtable)).SetNetworkProfile(@as(*const IWCNDevice, @ptrCast(self)), psz_profile_xml_);
            }
            pub inline fn getVendorExtension(self: *const T, p_vendor_ext_spec_: ?*const WCN_VENDOR_EXTENSION_SPEC, dw_max_buffer_size_: u32, pb_buffer_: [*:0]u8, pdw_buffer_used_: ?*u32) HRESULT {
                return @as(*const IWCNDevice.VTable, @ptrCast(self.vtable)).GetVendorExtension(@as(*const IWCNDevice, @ptrCast(self)), p_vendor_ext_spec_, dw_max_buffer_size_, pb_buffer_, pdw_buffer_used_);
            }
            pub inline fn setVendorExtension(self: *const T, p_vendor_ext_spec_: ?*const WCN_VENDOR_EXTENSION_SPEC, cb_buffer_: u32, pb_buffer_: [*:0]const u8) HRESULT {
                return @as(*const IWCNDevice.VTable, @ptrCast(self.vtable)).SetVendorExtension(@as(*const IWCNDevice, @ptrCast(self)), p_vendor_ext_spec_, cb_buffer_, pb_buffer_);
            }
            ...
            pub inline fn setNFCPasswordParams(self: *const T, type_: WCN_PASSWORD_TYPE, dw_o_o_b_password_i_d_: u32, dw_password_length_: u32, pb_password_: ?[*:0]const u8, dw_remote_public_key_hash_length_: u32, pb_remote_public_key_hash_: ?[*:0]const u8, dw_d_h_key_blob_length_: u32, pb_d_h_key_blob_: ?[*:0]const u8) HRESULT {
                return @as(*const IWCNDevice.VTable, @ptrCast(self.vtable)).SetNFCPasswordParams(@as(*const IWCNDevice, @ptrCast(self)), type_, dw_o_o_b_password_i_d_, dw_password_length_, pb_password_, dw_remote_public_key_hash_length_, pb_remote_public_key_hash_, dw_d_h_key_blob_length_, pb_d_h_key_blob_);
            }
        };
    }
...
pub const IWCNConnectNotify = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn connectSucceeded(self: *const T) HRESULT {
                return @as(*const IWCNConnectNotify.VTable, @ptrCast(self.vtable)).ConnectSucceeded(@as(*const IWCNConnectNotify, @ptrCast(self)));
            }
            pub inline fn connectFailed(self: *const T, hr_failure_: HRESULT) HRESULT {
                return @as(*const IWCNConnectNotify.VTable, @ptrCast(self.vtable)).ConnectFailed(@as(*const IWCNConnectNotify, @ptrCast(self)), hr_failure_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
