...
pub extern "wcmapi" fn WcmGetProfileList(
    p_reserved: ?*anyopaque,
    pp_profile_list: ?*?*WCM_PROFILE_INFO_LIST,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows8.0'
pub extern "wcmapi" fn WcmSetProfileList(
    p_profile_list: ?*WCM_PROFILE_INFO_LIST,
    dw_position: u32,
    f_ignore_unknown_profiles: BOOL,
    p_reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "ondemandconnroutehelper" fn OnDemandGetRoutingHint(
    destination_host_name: ?[*:0]const u16,
    interface_index: ?*u32,
...
pub extern "ondemandconnroutehelper" fn GetInterfaceContextTableForHostName(
    ...
    proxy_name: ?[*:0]const u16,
    flags: u32,
    // TODO: what to do with BytesParamIndex 4?
    connection_profile_filter_raw_data: ?*u8,
    connection_profile_filter_raw_data_size: u32,
    interface_context_table: ?*?*NET_INTERFACE_CONTEXT_TABLE,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
