...
pub const ISdoMachine = extern struct {
    pub const VTable = extern struct {
        ...
        Attach: *const fn (
            ...
            bstr_computer_name: ?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetDictionarySDO: *const fn (
            self: *const ISdoMachine,
            pp_dictionary_s_d_o: ?*?*IUnknown,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetServiceSDO: *const fn (
            self: *const ISdoMachine,
            e_data_store: IASDATASTORE,
            bstr_service_name: ?BSTR,
            pp_service_s_d_o: ?*?*IUnknown,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetUserSDO: *const fn (
            self: *const ISdoMachine,
            e_data_store: IASDATASTORE,
            bstr_user_name: ?BSTR,
            pp_user_s_d_o: ?*?*IUnknown,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetOSType: *const fn (
            self: *const ISdoMachine,
            e_o_s_type: ?*IASOSTYPE,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetDomainType: *const fn (
            self: *const ISdoMachine,
            e_domain_type: ?*IASDOMAINTYPE,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        IsDirectoryAvailable: *const fn (
            self: *const ISdoMachine,
            bool_directory_available: ?*i16,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn attach(self: *const T, bstr_computer_name_: ?BSTR) HRESULT {
                return @as(*const ISdoMachine.VTable, @ptrCast(self.vtable)).Attach(@as(*const ISdoMachine, @ptrCast(self)), bstr_computer_name_);
            }
            pub inline fn getDictionarySDO(self: *const T, pp_dictionary_s_d_o_: ?*?*IUnknown) HRESULT {
                return @as(*const ISdoMachine.VTable, @ptrCast(self.vtable)).GetDictionarySDO(@as(*const ISdoMachine, @ptrCast(self)), pp_dictionary_s_d_o_);
            }
            pub inline fn getServiceSDO(self: *const T, e_data_store_: IASDATASTORE, bstr_service_name_: ?BSTR, pp_service_s_d_o_: ?*?*IUnknown) HRESULT {
                return @as(*const ISdoMachine.VTable, @ptrCast(self.vtable)).GetServiceSDO(@as(*const ISdoMachine, @ptrCast(self)), e_data_store_, bstr_service_name_, pp_service_s_d_o_);
            }
            pub inline fn getUserSDO(self: *const T, e_data_store_: IASDATASTORE, bstr_user_name_: ?BSTR, pp_user_s_d_o_: ?*?*IUnknown) HRESULT {
                return @as(*const ISdoMachine.VTable, @ptrCast(self.vtable)).GetUserSDO(@as(*const ISdoMachine, @ptrCast(self)), e_data_store_, bstr_user_name_, pp_user_s_d_o_);
            }
            pub inline fn getOSType(self: *const T, e_o_s_type_: ?*IASOSTYPE) HRESULT {
                return @as(*const ISdoMachine.VTable, @ptrCast(self.vtable)).GetOSType(@as(*const ISdoMachine, @ptrCast(self)), e_o_s_type_);
            }
            pub inline fn getDomainType(self: *const T, e_domain_type_: ?*IASDOMAINTYPE) HRESULT {
                return @as(*const ISdoMachine.VTable, @ptrCast(self.vtable)).GetDomainType(@as(*const ISdoMachine, @ptrCast(self)), e_domain_type_);
            }
            pub inline fn isDirectoryAvailable(self: *const T, bool_directory_available_: ?*i16) HRESULT {
                return @as(*const ISdoMachine.VTable, @ptrCast(self.vtable)).IsDirectoryAvailable(@as(*const ISdoMachine, @ptrCast(self)), bool_directory_available_);
            }
            pub inline fn getAttachedComputer(self: *const T, bstr_computer_name_: ?*?BSTR) HRESULT {
                return @as(*const ISdoMachine.VTable, @ptrCast(self.vtable)).GetAttachedComputer(@as(*const ISdoMachine, @ptrCast(self)), bstr_computer_name_);
            }
            pub inline fn getSDOSchema(self: *const T, pp_s_d_o_schema_: ?*?*IUnknown) HRESULT {
                return @as(*const ISdoMachine.VTable, @ptrCast(self.vtable)).GetSDOSchema(@as(*const ISdoMachine, @ptrCast(self)), pp_s_d_o_schema_);
            }
        };
    }
...
pub const ISdoMachine2 = extern struct {
    pub const VTable = extern struct {
        ...
        SyncConfigAgainstTemplates: *const fn (
            self: *const ISdoMachine2,
            bstr_service_name: ?BSTR,
            pp_config_root: ?*?*IUnknown,
            pp_templates_root: ?*?*IUnknown,
            b_forced_sync: i16,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ImportRemoteTemplates: *const fn (
            self: *const ISdoMachine2,
            p_local_templates_root: ?*IUnknown,
            bstr_remote_machine_name: ?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Reload: *const fn (
            self: *const ISdoMachine2,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getTemplatesSDO(self: *const T, bstr_service_name_: ?BSTR, pp_templates_s_d_o_: ?*?*IUnknown) HRESULT {
                return @as(*const ISdoMachine2.VTable, @ptrCast(self.vtable)).GetTemplatesSDO(@as(*const ISdoMachine2, @ptrCast(self)), bstr_service_name_, pp_templates_s_d_o_);
            }
            pub inline fn enableTemplates(self: *const T) HRESULT {
                return @as(*const ISdoMachine2.VTable, @ptrCast(self.vtable)).EnableTemplates(@as(*const ISdoMachine2, @ptrCast(self)));
            }
            pub inline fn syncConfigAgainstTemplates(self: *const T, bstr_service_name_: ?BSTR, pp_config_root_: ?*?*IUnknown, pp_templates_root_: ?*?*IUnknown, b_forced_sync_: i16) HRESULT {
                return @as(*const ISdoMachine2.VTable, @ptrCast(self.vtable)).SyncConfigAgainstTemplates(@as(*const ISdoMachine2, @ptrCast(self)), bstr_service_name_, pp_config_root_, pp_templates_root_, b_forced_sync_);
            }
            pub inline fn importRemoteTemplates(self: *const T, p_local_templates_root_: ?*IUnknown, bstr_remote_machine_name_: ?BSTR) HRESULT {
                return @as(*const ISdoMachine2.VTable, @ptrCast(self.vtable)).ImportRemoteTemplates(@as(*const ISdoMachine2, @ptrCast(self)), p_local_templates_root_, bstr_remote_machine_name_);
            }
            pub inline fn reload(self: *const T) HRESULT {
...
pub const ISdoServiceControl = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn startService(self: *const T) HRESULT {
                return @as(*const ISdoServiceControl.VTable, @ptrCast(self.vtable)).StartService(@as(*const ISdoServiceControl, @ptrCast(self)));
            }
            pub inline fn stopService(self: *const T) HRESULT {
                return @as(*const ISdoServiceControl.VTable, @ptrCast(self.vtable)).StopService(@as(*const ISdoServiceControl, @ptrCast(self)));
            }
            pub inline fn getServiceStatus(self: *const T, status_: ?*i32) HRESULT {
                return @as(*const ISdoServiceControl.VTable, @ptrCast(self.vtable)).GetServiceStatus(@as(*const ISdoServiceControl, @ptrCast(self)), status_);
            }
            pub inline fn resetService(self: *const T) HRESULT {
...
pub const ISdo = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getPropertyInfo(self: *const T, id_: i32, pp_property_info_: ?*?*IUnknown) HRESULT {
                return @as(*const ISdo.VTable, @ptrCast(self.vtable)).GetPropertyInfo(@as(*const ISdo, @ptrCast(self)), id_, pp_property_info_);
            }
            pub inline fn getProperty(self: *const T, id_: i32, p_value_: ?*VARIANT) HRESULT {
                return @as(*const ISdo.VTable, @ptrCast(self.vtable)).GetProperty(@as(*const ISdo, @ptrCast(self)), id_, p_value_);
            }
            pub inline fn putProperty(self: *const T, id_: i32, p_value_: ?*VARIANT) HRESULT {
                return @as(*const ISdo.VTable, @ptrCast(self.vtable)).PutProperty(@as(*const ISdo, @ptrCast(self)), id_, p_value_);
            }
            pub inline fn resetProperty(self: *const T, id_: i32) HRESULT {
                return @as(*const ISdo.VTable, @ptrCast(self.vtable)).ResetProperty(@as(*const ISdo, @ptrCast(self)), id_);
            }
            ...
            pub inline fn getNewEnum(self: *const T, pp_enum_v_a_r_i_a_n_t_: ?*?*IUnknown) HRESULT {
                return @as(*const ISdo.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISdo, @ptrCast(self)), pp_enum_v_a_r_i_a_n_t_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getCount(self: *const T, p_count_: ?*i32) HRESULT {
                return @as(*const ISdoCollection.VTable, @ptrCast(self.vtable)).get_Count(@as(*const ISdoCollection, @ptrCast(self)), p_count_);
            }
            pub inline fn add(self: *const T, bstr_name_: ?BSTR, pp_item_: ?*?*IDispatch) HRESULT {
                return @as(*const ISdoCollection.VTable, @ptrCast(self.vtable)).Add(@as(*const ISdoCollection, @ptrCast(self)), bstr_name_, pp_item_);
            }
            pub inline fn remove(self: *const T, p_item_: ?*IDispatch) HRESULT {
                return @as(*const ISdoCollection.VTable, @ptrCast(self.vtable)).Remove(@as(*const ISdoCollection, @ptrCast(self)), p_item_);
            }
            ...
            pub inline fn isNameUnique(self: *const T, bstr_name_: ?BSTR, p_bool_: ?*i16) HRESULT {
                return @as(*const ISdoCollection.VTable, @ptrCast(self.vtable)).IsNameUnique(@as(*const ISdoCollection, @ptrCast(self)), bstr_name_, p_bool_);
            }
            pub inline fn item(self: *const T, name_: ?*VARIANT, p_item_: ?*?*IDispatch) HRESULT {
                return @as(*const ISdoCollection.VTable, @ptrCast(self.vtable)).Item(@as(*const ISdoCollection, @ptrCast(self)), name_, p_item_);
            }
            pub inline fn getNewEnum(self: *const T, pp_enum_v_a_r_i_a_n_t_: ?*?*IUnknown) HRESULT {
                return @as(*const ISdoCollection.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISdoCollection, @ptrCast(self)), pp_enum_v_a_r_i_a_n_t_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ITemplateSdo = extern struct {
    pub const VTable = extern struct {
        ...
        AddToCollection: *const fn (
            ...
            bstr_name: ?BSTR,
            p_collection: ?*IDispatch,
            pp_item: ?*?*IDispatch,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        AddToSdo: *const fn (
            self: *const ITemplateSdo,
            bstr_name: ?BSTR,
            p_sdo_target: ?*IDispatch,
            pp_item: ?*?*IDispatch,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn addToCollection(self: *const T, bstr_name_: ?BSTR, p_collection_: ?*IDispatch, pp_item_: ?*?*IDispatch) HRESULT {
                return @as(*const ITemplateSdo.VTable, @ptrCast(self.vtable)).AddToCollection(@as(*const ITemplateSdo, @ptrCast(self)), bstr_name_, p_collection_, pp_item_);
            }
            pub inline fn addToSdo(self: *const T, bstr_name_: ?BSTR, p_sdo_target_: ?*IDispatch, pp_item_: ?*?*IDispatch) HRESULT {
                return @as(*const ITemplateSdo.VTable, @ptrCast(self.vtable)).AddToSdo(@as(*const ITemplateSdo, @ptrCast(self)), bstr_name_, p_sdo_target_, pp_item_);
            }
            pub inline fn addToSdoAsProperty(self: *const T, p_sdo_target_: ?*IDispatch, id_: i32) HRESULT {
                return @as(*const ITemplateSdo.VTable, @ptrCast(self.vtable)).AddToSdoAsProperty(@as(*const ITemplateSdo, @ptrCast(self)), p_sdo_target_, id_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISdoDictionaryOld = extern struct {
    pub const VTable = extern struct {
        ...
        GetAttributeInfo: *const fn (
            ...
            id: ATTRIBUTEID,
            p_info_i_ds: ?*VARIANT,
            p_info_values: ?*VARIANT,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        EnumAttributeValues: *const fn (
            self: *const ISdoDictionaryOld,
            id: ATTRIBUTEID,
            p_value_ids: ?*VARIANT,
            p_values_desc: ?*VARIANT,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        CreateAttribute: *const fn (
            self: *const ISdoDictionaryOld,
            id: ATTRIBUTEID,
            pp_attribute_object: ?*?*IDispatch,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetAttributeID: *const fn (
            self: *const ISdoDictionaryOld,
            bstr_attribute_name: ?BSTR,
            p_id: ?*ATTRIBUTEID,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn enumAttributes(self: *const T, id_: ?*VARIANT, p_values_: ?*VARIANT) HRESULT {
                return @as(*const ISdoDictionaryOld.VTable, @ptrCast(self.vtable)).EnumAttributes(@as(*const ISdoDictionaryOld, @ptrCast(self)), id_, p_values_);
            }
            pub inline fn getAttributeInfo(self: *const T, id_: ATTRIBUTEID, p_info_i_ds_: ?*VARIANT, p_info_values_: ?*VARIANT) HRESULT {
                return @as(*const ISdoDictionaryOld.VTable, @ptrCast(self.vtable)).GetAttributeInfo(@as(*const ISdoDictionaryOld, @ptrCast(self)), id_, p_info_i_ds_, p_info_values_);
            }
            pub inline fn enumAttributeValues(self: *const T, id_: ATTRIBUTEID, p_value_ids_: ?*VARIANT, p_values_desc_: ?*VARIANT) HRESULT {
                return @as(*const ISdoDictionaryOld.VTable, @ptrCast(self.vtable)).EnumAttributeValues(@as(*const ISdoDictionaryOld, @ptrCast(self)), id_, p_value_ids_, p_values_desc_);
            }
            pub inline fn createAttribute(self: *const T, id_: ATTRIBUTEID, pp_attribute_object_: ?*?*IDispatch) HRESULT {
                return @as(*const ISdoDictionaryOld.VTable, @ptrCast(self.vtable)).CreateAttribute(@as(*const ISdoDictionaryOld, @ptrCast(self)), id_, pp_attribute_object_);
            }
            pub inline fn getAttributeID(self: *const T, bstr_attribute_name_: ?BSTR, p_id_: ?*ATTRIBUTEID) HRESULT {
                return @as(*const ISdoDictionaryOld.VTable, @ptrCast(self.vtable)).GetAttributeID(@as(*const ISdoDictionaryOld, @ptrCast(self)), bstr_attribute_name_, p_id_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const PRADIUS_EXTENSION_INIT = *const fn () callconv(@import("std").os.windows.WINAPI) u32;

pub const PRADIUS_EXTENSION_TERM = *const fn () callconv(@import("std").os.windows.WINAPI) void;

pub const PRADIUS_EXTENSION_PROCESS = *const fn (
    p_attrs: ?*const RADIUS_ATTRIBUTE,
    pf_action: ?*RADIUS_ACTION,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const PRADIUS_EXTENSION_PROCESS_EX = *const fn (
    p_in_attrs: ?*const RADIUS_ATTRIBUTE,
    p_out_attrs: ?*?*RADIUS_ATTRIBUTE,
    pf_action: ?*RADIUS_ACTION,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const PRADIUS_EXTENSION_FREE_ATTRIBUTES = *const fn (
    p_attrs: ?*RADIUS_ATTRIBUTE,
...
pub const PRADIUS_EXTENSION_PROCESS_2 = *const fn (
    p_e_c_b: ?*RADIUS_EXTENSION_CONTROL_BLOCK,
) callconv(@import("std").os.windows.WINAPI) u32;
