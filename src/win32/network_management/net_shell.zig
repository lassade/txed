...
pub const PNS_CONTEXT_DUMP_FN = *const fn (
    pwsz_router: ?[*:0]const u16,
    ppwc_arguments: [*]?PWSTR,
    dw_arg_count: u32,
...
pub const PNS_OSVERSIONCHECK = *const fn (
    c_i_m_o_s_type: u32,
    c_i_m_o_s_product_suite: u32,
    c_i_m_o_s_version: ?[*:0]const u16,
    c_i_m_o_s_build_number: ?[*:0]const u16,
    c_i_m_service_pack_major_version: ?[*:0]const u16,
    c_i_m_service_pack_minor_version: ?[*:0]const u16,
    ui_reserved: u32,
    dw_reserved: u32,
...
pub extern "netsh" fn MatchEnumTag(
    ...
    pwc_arg: ?[*:0]const u16,
    dw_num_arg: u32,
    p_enum_table: ?*const TOKEN_VALUE,
    pdw_value: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "netsh" fn MatchToken(
    pwsz_user_token: ?[*:0]const u16,
    pwsz_cmd_token: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "netsh" fn RegisterContext(
    p_child_context: ?*const NS_CONTEXT_ATTRIBUTES,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "netsh" fn RegisterHelper(
    pguid_parent_context: ?*const Guid,
    pfn_register_sub_context: ?*const NS_HELPER_ATTRIBUTES,
) callconv(@import("std").os.windows.WINAPI) u32;
