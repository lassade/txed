...
pub const PFNPEER_SECURE_RECORD = *const fn (
    ...
    p_record: ?*PEER_RECORD,
    change_type: PEER_RECORD_CHANGE_TYPE,
    pp_security_data: ?*?*PEER_DATA,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub const PFNPEER_FREE_SECURITY_DATA = *const fn (
    h_graph: ?*anyopaque,
    pv_context: ?*anyopaque,
    p_security_data: ?*PEER_DATA,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub const DRT_BOOTSTRAP_RESOLVE_CALLBACK = *const fn (
    hr: HRESULT,
    pv_context: ?*anyopaque,
    p_addresses: ?*SOCKET_ADDRESS_LIST,
    f_fatal_error: BOOL,
...
pub extern "p2pgraph" fn PeerGraphStartup(
    ...
    p_version_data: ?*PEER_VERSION_DATA,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2pgraph" fn PeerGraphCreate(
    p_graph_properties: ?*PEER_GRAPH_PROPERTIES,
    pwz_database_name: ?[*:0]const u16,
    p_security_interface: ?*PEER_SECURITY_INTERFACE,
    ph_graph: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "p2pgraph" fn PeerGraphOpen(
    pwz_graph_id: ?[*:0]const u16,
    pwz_peer_id: ?[*:0]const u16,
    pwz_database_name: ?[*:0]const u16,
    p_security_interface: ?*PEER_SECURITY_INTERFACE,
    c_record_type_sync_precedence: u32,
    p_record_type_sync_precedence: ?[*]const Guid,
    ph_graph: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2pgraph" fn PeerGraphConnect(
    h_graph: ?*anyopaque,
    pwz_peer_id: ?[*:0]const u16,
    p_address: ?*PEER_ADDRESS,
    pull_connection_id: ?*u64,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2pgraph" fn PeerGraphGetProperties(
    h_graph: ?*anyopaque,
    pp_graph_properties: ?*?*PEER_GRAPH_PROPERTIES,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2pgraph" fn PeerGraphRegisterEvent(
    h_graph: ?*anyopaque,
    h_event: ?HANDLE,
    c_event_registrations: u32,
    p_event_registrations: [*]PEER_GRAPH_EVENT_REGISTRATION,
    ph_peer_event: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "p2pgraph" fn PeerGraphUnregisterEvent(
    h_peer_event: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "p2pgraph" fn PeerGraphGetEventData(
    h_peer_event: ?*anyopaque,
    pp_event_data: ?*?*PEER_GRAPH_EVENT_DATA,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "p2pgraph" fn PeerGraphGetRecord(
    h_graph: ?*anyopaque,
    p_record_id: ?*const Guid,
    pp_record: ?*?*PEER_RECORD,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2pgraph" fn PeerGraphEnumRecords(
    h_graph: ?*anyopaque,
    p_record_type: ?*const Guid,
    pwz_peer_id: ?[*:0]const u16,
    ph_peer_enum: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "p2pgraph" fn PeerGraphSearchRecords(
    h_graph: ?*anyopaque,
    pwz_criteria: ?[*:0]const u16,
    ph_peer_enum: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerGroupCreate(
    p_properties: ?*PEER_GROUP_PROPERTIES,
    ph_group: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "p2p" fn PeerGroupOpen(
    pwz_identity: ?[*:0]const u16,
    pwz_group_peer_name: ?[*:0]const u16,
    pwz_cloud: ?[*:0]const u16,
    ph_group: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerGroupCreateInvitation(
    h_group: ?*anyopaque,
    pwz_identity_info: ?[*:0]const u16,
    pft_expiration: ?*FILETIME,
    c_roles: u32,
    p_roles: ?[*]const Guid,
    ppwz_invitation: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerGroupParseInvitation(
    pwz_invitation: ?[*:0]const u16,
    pp_invitation_info: ?*?*PEER_INVITATION_INFO,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerGroupGetProperties(
    h_group: ?*anyopaque,
    pp_properties: ?*?*PEER_GROUP_PROPERTIES,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerGroupRegisterEvent(
    h_group: ?*anyopaque,
    h_event: ?HANDLE,
    c_event_registration: u32,
    p_event_registrations: [*]PEER_GROUP_EVENT_REGISTRATION,
    ph_peer_event: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerGroupGetEventData(
    h_peer_event: ?*anyopaque,
    pp_event_data: ?*?*PEER_GROUP_EVENT_DATA,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerGroupIssueCredentials(
    h_group: ?*anyopaque,
    pwz_subject_identity: ?[*:0]const u16,
...
pub extern "p2p" fn PeerGroupResumePasswordAuthentication(
    h_group: ?*anyopaque,
    h_peer_event_handle: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "p2p" fn PeerIdentityCreate(
    pwz_classifier: ?[*:0]const u16,
...
pub extern "p2p" fn PeerCreatePeerName(
    pwz_identity: ?[*:0]const u16,
    pwz_classifier: ?[*:0]const u16,
    ppwz_peer_name: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "p2p" fn PeerIdentityGetXML(
    pwz_identity: ?[*:0]const u16,
    ppwz_identity_x_m_l: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerIdentityExport(
    pwz_identity: ?[*:0]const u16,
    pwz_password: ?[*:0]const u16,
    ppwz_export_x_m_l: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "p2p" fn PeerIdentityImport(
    pwz_import_x_m_l: ?[*:0]const u16,
    pwz_password: ?[*:0]const u16,
    ppwz_identity: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerCollabGetSigninOptions(
    pdw_signin_options: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "p2p" fn PeerCollabAsyncInviteContact(
    pc_contact: ?*PEER_CONTACT,
    pc_endpoint: ?*PEER_ENDPOINT,
    pc_invitation: ?*PEER_INVITATION,
    h_event: ?HANDLE,
    ph_invitation: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "p2p" fn PeerCollabGetInvitationResponse(
    h_invitation: ?HANDLE,
    pp_invitation_response: ?*?*PEER_INVITATION_RESPONSE,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerCollabInviteContact(
    ...
    pc_endpoint: ?*PEER_ENDPOINT,
    pc_invitation: ?*PEER_INVITATION,
    pp_response: ?*?*PEER_INVITATION_RESPONSE,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerCollabGetAppLaunchInfo(
    pp_launch_info: ?*?*PEER_APP_LAUNCH_INFO,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "p2p" fn PeerCollabRegisterApplication(
    pc_application: ?*PEER_APPLICATION_REGISTRATION_INFO,
    registration_type: PEER_APPLICATION_REGISTRATION_TYPE,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerCollabGetApplicationRegistrationInfo(
    p_application_id: ?*const Guid,
    registration_type: PEER_APPLICATION_REGISTRATION_TYPE,
    pp_application: ?*?*PEER_APPLICATION_REGISTRATION_INFO,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerCollabGetPresenceInfo(
    pc_endpoint: ?*PEER_ENDPOINT,
    pp_presence_info: ?*?*PEER_PRESENCE_INFO,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerCollabQueryContactData(
    pc_endpoint: ?*PEER_ENDPOINT,
    ppwz_contact_data: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "p2p" fn PeerCollabSubscribeEndpointData(
    pc_endpoint: ?*const PEER_ENDPOINT,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerCollabRegisterEvent(
    h_event: ?HANDLE,
    c_event_registration: u32,
    p_event_registrations: [*]PEER_COLLAB_EVENT_REGISTRATION,
    ph_peer_event: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerCollabGetEventData(
    h_peer_event: ?*anyopaque,
    pp_event_data: ?*?*PEER_COLLAB_EVENT_DATA,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerCollabAddContact(
    pwz_contact_data: ?[*:0]const u16,
    pp_contact: ?*?*PEER_CONTACT,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "p2p" fn PeerCollabDeleteContact(
    pwz_peer_name: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerNameToPeerHostName(
    pwz_peer_name: ?[*:0]const u16,
    ppwz_host_name: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "p2p" fn PeerHostNameToPeerName(
    pwz_host_name: ?[*:0]const u16,
    ppwz_peer_name: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerPnrpRegister(
    pcwz_peer_name: ?[*:0]const u16,
    p_registration_info: ?*PEER_PNRP_REGISTRATION_INFO,
    ph_registration: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "p2p" fn PeerPnrpUpdateRegistration(
    h_registration: ?*anyopaque,
    p_registration_info: ?*PEER_PNRP_REGISTRATION_INFO,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerPnrpResolve(
    pcwz_peer_name: ?[*:0]const u16,
    pcwz_cloud_name: ?[*:0]const u16,
    pc_endpoints: ?*u32,
    pp_endpoints: ?*?*PEER_PNRP_ENDPOINT_INFO,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "p2p" fn PeerPnrpStartResolve(
    ...
    c_max_endpoints: u32,
    h_event: ?HANDLE,
    ph_resolve: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "p2p" fn PeerPnrpGetCloudInfo(
    pc_num_clouds: ?*u32,
    pp_cloud_info: ?*?*PEER_PNRP_CLOUD_INFO,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "p2p" fn PeerPnrpGetEndpoint(
    h_resolve: ?*anyopaque,
    pp_endpoint: ?*?*PEER_PNRP_ENDPOINT_INFO,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "drtprov" fn DrtCreatePnrpBootstrapResolver(
    f_publish: BOOL,
    pwz_peer_name: ?[*:0]const u16,
    pwz_cloud_name: ?[*:0]const u16,
    pwz_publishing_identity: ?[*:0]const u16,
    pp_resolver: ?*?*DRT_BOOTSTRAP_PROVIDER,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows6.1'
pub extern "drtprov" fn DrtDeletePnrpBootstrapResolver(
    p_resolver: ?*DRT_BOOTSTRAP_PROVIDER,
) callconv(@import("std").os.windows.WINAPI) void;

// TODO: this type is limited to platform 'windows6.1'
pub extern "drtprov" fn DrtCreateDnsBootstrapResolver(
    port: u16,
    pwsz_address: ?[*:0]const u16,
    pp_module: ?*?*DRT_BOOTSTRAP_PROVIDER,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "drttransport" fn DrtCreateIpv6UdpTransport(
    scope: DRT_SCOPE,
    dw_scope_id: u32,
    dw_locality_threshold: u32,
    pw_port: ?*u16,
    ph_transport: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows6.1'
pub extern "drttransport" fn DrtDeleteIpv6UdpTransport(
    h_transport: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows6.1'
pub extern "drtprov" fn DrtCreateDerivedKeySecurityProvider(
    p_root_cert: ?*const CERT_CONTEXT,
    p_local_cert: ?*const CERT_CONTEXT,
    pp_security_provider: ?*?*DRT_SECURITY_PROVIDER,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "drt" fn DrtOpen(
    p_settings: ?*const DRT_SETTINGS,
    h_event: ?HANDLE,
    pv_context: ?*const anyopaque,
    ph_drt: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "drt" fn DrtGetEventDataSize(
    h_drt: ?*anyopaque,
    pul_event_data_len: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows6.1'
pub extern "drt" fn DrtGetEventData(
    h_drt: ?*anyopaque,
    ul_event_data_len: u32,
    p_event_data: ?*DRT_EVENT_DATA,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows6.1'
pub extern "drt" fn DrtRegisterKey(
    h_drt: ?*anyopaque,
    p_registration: ?*DRT_REGISTRATION,
    pv_key_context: ?*anyopaque,
    ph_key_registration: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows6.1'
pub extern "drt" fn DrtUpdateKey(
    h_key_registration: ?*anyopaque,
    p_app_data: ?*DRT_DATA,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "drt" fn DrtStartSearch(
    h_drt: ?*anyopaque,
    p_key: ?*DRT_DATA,
    p_info: ?*const DRT_SEARCH_INFO,
    timeout: u32,
    h_event: ?HANDLE,
    pv_context: ?*const anyopaque,
    h_search_context: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "drt" fn DrtGetSearchResultSize(
    h_search_context: ?*anyopaque,
    pul_search_result_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows6.1'
pub extern "drt" fn DrtGetSearchResult(
    h_search_context: ?*anyopaque,
    ul_search_result_size: u32,
    p_search_result: ?*DRT_SEARCH_RESULT,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows6.1'
pub extern "drt" fn DrtGetSearchPathSize(
    h_search_context: ?*anyopaque,
    pul_search_path_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows6.1'
pub extern "drt" fn DrtGetSearchPath(
    h_search_context: ?*anyopaque,
    ul_search_path_size: u32,
    p_search_path: ?*DRT_ADDRESS_LIST,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "drt" fn DrtGetInstanceName(
    h_drt: ?*anyopaque,
    ulcb_instance_name_size: u32,
    pwz_drt_instance_name: ?PWSTR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows6.1'
pub extern "drt" fn DrtGetInstanceNameSize(
    h_drt: ?*anyopaque,
    pulcb_instance_name_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows6.1'
pub extern "peerdist" fn PeerDistStartup(
    dw_version_requested: u32,
    ph_peer_dist: ?*isize,
    pdw_supported_version: ?*u32,
...
pub extern "peerdist" fn PeerDistGetStatus(
    h_peer_dist: isize,
    p_peer_dist_status: ?*PEERDIST_STATUS,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "peerdist" fn PeerDistServerPublishStream(
    h_peer_dist: isize,
    cb_content_identifier: u32,
    // TODO: what to do with BytesParamIndex 1?
    p_content_identifier: ?*u8,
    cb_content_length: u64,
    p_publish_options: ?*PEERDIST_PUBLICATION_OPTIONS,
    h_completion_port: ?HANDLE,
    ul_completion_key: usize,
    ph_stream: ?*isize,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "peerdist" fn PeerDistServerOpenContentInformation(
    ...
    // TODO: what to do with BytesParamIndex 1?
    p_content_identifier: ?*u8,
    ull_content_offset: u64,
    cb_content_length: u64,
    h_completion_port: ?HANDLE,
    ul_completion_key: usize,
    ph_content_info: ?*isize,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.1'
pub extern "peerdist" fn PeerDistServerRetrieveContentInformation(
    h_peer_dist: isize,
    h_content_info: isize,
    cb_max_number_of_bytes: u32,
    // TODO: what to do with BytesParamIndex 2?
    p_buffer: ?*u8,
    lp_overlapped: ?*OVERLAPPED,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "peerdist" fn PeerDistClientOpenContent(
    h_peer_dist: isize,
    p_content_tag: ?*PEERDIST_CONTENT_TAG,
    h_completion_port: ?HANDLE,
    ul_completion_key: usize,
    ph_content_handle: ?*isize,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.1'
pub extern "peerdist" fn PeerDistClientCloseContent(
    h_peer_dist: isize,
    h_content_handle: isize,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "peerdist" fn PeerDistClientBlockRead(
    ...
    // TODO: what to do with BytesParamIndex 2?
    p_buffer: ?*u8,
    dw_timeout_in_milliseconds: u32,
    lp_overlapped: ?*OVERLAPPED,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "peerdist" fn PeerDistGetStatusEx(
    h_peer_dist: isize,
    p_peer_dist_status: ?*PEERDIST_STATUS_INFO,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "peerdist" fn PeerDistServerOpenContentInformationEx(
    ...
    ull_content_offset: u64,
    cb_content_length: u64,
    p_retrieval_options: ?*PEERDIST_RETRIEVAL_OPTIONS,
    h_completion_port: ?HANDLE,
    ul_completion_key: usize,
    ph_content_info: ?*isize,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "peerdist" fn PeerDistClientGetInformationByHandle(
    h_peer_dist: isize,
    h_content_handle: isize,
    peer_dist_client_info_class: PEERDIST_CLIENT_INFO_BY_HANDLE_CLASS,
    dw_buffer_size: u32,
    // TODO: what to do with BytesParamIndex 3?
    lp_information: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
