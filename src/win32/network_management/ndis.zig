...
pub const DOT11EXT_SET_PROFILE_CUSTOM_USER_DATA = *const fn (
    h_dot11_svc_handle: ?HANDLE,
    h_connect_session: ?HANDLE,
    dw_session_i_d: u32,
    dw_data_size: u32,
...
pub const DOT11EXT_SET_CURRENT_PROFILE = *const fn (
    h_dot11_svc_handle: ?HANDLE,
    h_connect_session: ?HANDLE,
    p_ihv_conn_profile: ?*DOT11EXT_IHV_CONNECTIVITY_PROFILE,
    p_ihv_sec_profile: ?*DOT11EXT_IHV_SECURITY_PROFILE,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const DOT11EXT_SEND_UI_REQUEST = *const fn (
    h_dot11_svc_handle: ?HANDLE,
    p_ihv_u_i_request: ?*DOT11EXT_IHV_UI_REQUEST,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const DOT11EXT_SEND_NOTIFICATION = *const fn (
    h_dot11_svc_handle: ?HANDLE,
    p_notification_data: ?*L2_NOTIFICATION_DATA,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const DOT11EXT_SEND_PACKET = *const fn (
    ...
    pv_packet: ?*anyopaque,
    h_send_completion: ?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const DOT11EXT_SET_ETHERTYPE_HANDLING = *const fn (
    h_dot11_svc_handle: ?HANDLE,
    u_max_back_log: u32,
    u_num_of_exemption: u32,
    p_exemption: ?[*]DOT11_PRIVACY_EXEMPTION,
    u_num_of_registration: u32,
    pus_registration: ?[*:0]u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const DOT11EXT_NIC_SPECIFIC_EXTENSION = *const fn (
    ...
    // TODO: what to do with BytesParamIndex 1?
    pv_in_buffer: ?*anyopaque,
    pdw_out_buffer_size: ?*u32,
    // TODO: what to do with BytesParamIndex 3?
    pv_out_buffer: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const DOT11EXT_ONEX_START = *const fn (
    h_dot11_svc_handle: ?HANDLE,
    p_eap_attributes: ?*EAP_ATTRIBUTES,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const DOT11EXT_PROCESS_ONEX_PACKET = *const fn (
    h_dot11_svc_handle: ?HANDLE,
    dw_in_packet_size: u32,
    // TODO: what to do with BytesParamIndex 1?
    pv_in_packet: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const DOT11EXT_REQUEST_VIRTUAL_STATION = *const fn (
    h_dot11_primary_handle: ?HANDLE,
...
pub const DOT11EXT_SET_VIRTUAL_STATION_AP_PROPERTIES = *const fn (
    h_dot11_svc_handle: ?HANDLE,
    h_connect_session: ?HANDLE,
    dw_num_properties: u32,
    p_properties: [*]DOT11EXT_VIRTUAL_STATION_AP_PROPERTY,
    pv_reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const DOT11EXTIHV_GET_VERSION_INFO = *const fn (
    p_dot11_i_h_v_version_info: ?*DOT11_IHV_VERSION_INFO,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const DOT11EXTIHV_INIT_SERVICE = *const fn (
    dw_ver_num_used: u32,
    p_dot11_ext_a_p_i: ?*DOT11EXT_APIS,
    pv_reserved: ?*anyopaque,
    p_dot11_i_h_v_handlers: ?*DOT11EXT_IHV_HANDLERS,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const DOT11EXTIHV_INIT_VIRTUAL_STATION = *const fn (
    p_dot11_ext_v_s_a_p_i: ?*DOT11EXT_VIRTUAL_STATION_APIS,
    pv_reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const DOT11EXTIHV_DEINIT_SERVICE = *const fn () callconv(@import("std").os.windows.WINAPI) void;

pub const DOT11EXTIHV_INIT_ADAPTER = *const fn (
    p_dot11_adapter: ?*DOT11_ADAPTER,
    h_dot11_svc_handle: ?HANDLE,
    ph_ihv_ext_adapter: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const DOT11EXTIHV_DEINIT_ADAPTER = *const fn (
    h_ihv_ext_adapter: ?HANDLE,
) callconv(@import("std").os.windows.WINAPI) void;

pub const DOT11EXTIHV_PERFORM_PRE_ASSOCIATE = *const fn (
    h_ihv_ext_adapter: ?HANDLE,
    h_connect_session: ?HANDLE,
    p_ihv_profile_params: ?*DOT11EXT_IHV_PROFILE_PARAMS,
    p_ihv_conn_profile: ?*DOT11EXT_IHV_CONNECTIVITY_PROFILE,
    p_ihv_sec_profile: ?*DOT11EXT_IHV_SECURITY_PROFILE,
    p_connectable_bssid: ?*DOT11_BSS_LIST,
    pdw_reason_code: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const DOT11EXTIHV_PERFORM_POST_ASSOCIATE = *const fn (
    h_ihv_ext_adapter: ?HANDLE,
    h_security_session_i_d: ?HANDLE,
    p_port_state: ?*DOT11_PORT_STATE,
    u_dot11_assoc_params_bytes: u32,
    // TODO: what to do with BytesParamIndex 3?
    p_dot11_assoc_params: ?*DOT11_ASSOCIATION_COMPLETION_PARAMETERS,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const DOT11EXTIHV_STOP_POST_ASSOCIATE = *const fn (
    h_ihv_ext_adapter: ?HANDLE,
    p_peer: ?*?*u8,
    dot11_assoc_status: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const DOT11EXTIHV_CREATE_DISCOVERY_PROFILES = *const fn (
    ...
    p_ihv_profile_params: ?*DOT11EXT_IHV_PROFILE_PARAMS,
    p_connectable_bssid: ?*DOT11_BSS_LIST,
    p_ihv_discovery_profile_list: ?*DOT11EXT_IHV_DISCOVERY_PROFILE_LIST,
    pdw_reason_code: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const DOT11EXTIHV_PROCESS_SESSION_CHANGE = *const fn (
    u_event_type: u32,
    p_session_notification: ?*WTSSESSION_NOTIFICATION,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const DOT11EXTIHV_RECEIVE_INDICATION = *const fn (
    h_ihv_ext_adapter: ?HANDLE,
    indication_type: DOT11EXT_IHV_INDICATION_TYPE,
    u_buffer_length: u32,
...
pub const DOT11EXTIHV_IS_UI_REQUEST_PENDING = *const fn (
    guid_u_i_request: Guid,
    pb_is_request_pending: ?*BOOL,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const DOT11EXTIHV_PROCESS_UI_RESPONSE = *const fn (
    ...
    dw_byte_count: u32,
    // TODO: what to do with BytesParamIndex 1?
    pv_response_buffer: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const DOT11EXTIHV_QUERY_UI_REQUEST = *const fn (
    h_ihv_ext_adapter: ?HANDLE,
    connection_phase: DOT11EXT_IHV_CONNECTION_PHASE,
    pp_ihv_u_i_request: ?*?*DOT11EXT_IHV_UI_REQUEST,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const DOT11EXTIHV_ONEX_INDICATE_RESULT = *const fn (
    h_ihv_ext_adapter: ?HANDLE,
    ms_one_x_result: DOT11_MSONEX_RESULT,
    p_dot11_ms_one_x_result_params: ?*DOT11_MSONEX_RESULT_PARAMS,
) callconv(@import("std").os.windows.WINAPI) u32;
