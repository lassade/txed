...
pub const IKsControl = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn ksProperty(self: *const T, property_: ?*KSIDENTIFIER, property_length_: u32, property_data_: ?*anyopaque, data_length_: u32, bytes_returned_: ?*u32) HRESULT {
                return @as(*const IKsControl.VTable, @ptrCast(self.vtable)).KsProperty(@as(*const IKsControl, @ptrCast(self)), property_, property_length_, property_data_, data_length_, bytes_returned_);
            }
            pub inline fn ksMethod(self: *const T, method_: ?*KSIDENTIFIER, method_length_: u32, method_data_: ?*anyopaque, data_length_: u32, bytes_returned_: ?*u32) HRESULT {
                return @as(*const IKsControl.VTable, @ptrCast(self.vtable)).KsMethod(@as(*const IKsControl, @ptrCast(self)), method_, method_length_, method_data_, data_length_, bytes_returned_);
            }
            pub inline fn ksEvent(self: *const T, event_: ?*KSIDENTIFIER, event_length_: u32, event_data_: ?*anyopaque, data_length_: u32, bytes_returned_: ?*u32) HRESULT {
                return @as(*const IKsControl.VTable, @ptrCast(self.vtable)).KsEvent(@as(*const IKsControl, @ptrCast(self)), event_, event_length_, event_data_, data_length_, bytes_returned_);
            }
        };
    }
...
pub const IKsFormatSupport = extern struct {
    pub const VTable = extern struct {
        ...
        IsFormatSupported: *const fn (
            ...
            p_ks_format: ?*KSDATAFORMAT,
            cb_format: u32,
            pb_supported: ?*BOOL,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetDevicePreferredFormat: *const fn (
            self: *const IKsFormatSupport,
            pp_ks_format: ?*?*KSDATAFORMAT,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn isFormatSupported(self: *const T, p_ks_format_: ?*KSDATAFORMAT, cb_format_: u32, pb_supported_: ?*BOOL) HRESULT {
                return @as(*const IKsFormatSupport.VTable, @ptrCast(self.vtable)).IsFormatSupported(@as(*const IKsFormatSupport, @ptrCast(self)), p_ks_format_, cb_format_, pb_supported_);
            }
            pub inline fn getDevicePreferredFormat(self: *const T, pp_ks_format_: ?*?*KSDATAFORMAT) HRESULT {
                return @as(*const IKsFormatSupport.VTable, @ptrCast(self.vtable)).GetDevicePreferredFormat(@as(*const IKsFormatSupport, @ptrCast(self)), pp_ks_format_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IKsJackDescription = extern struct {
    pub const VTable = extern struct {
        ...
        GetJackDescription: *const fn (
            self: *const IKsJackDescription,
            n_jack: u32,
            p_description: ?*KSJACK_DESCRIPTION,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getJackCount(self: *const T, pc_jacks_: ?*u32) HRESULT {
                return @as(*const IKsJackDescription.VTable, @ptrCast(self.vtable)).GetJackCount(@as(*const IKsJackDescription, @ptrCast(self)), pc_jacks_);
            }
            pub inline fn getJackDescription(self: *const T, n_jack_: u32, p_description_: ?*KSJACK_DESCRIPTION) HRESULT {
                return @as(*const IKsJackDescription.VTable, @ptrCast(self.vtable)).GetJackDescription(@as(*const IKsJackDescription, @ptrCast(self)), n_jack_, p_description_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IKsJackDescription2 = extern struct {
    pub const VTable = extern struct {
        ...
        GetJackDescription2: *const fn (
            self: *const IKsJackDescription2,
            n_jack: u32,
            p_description2: ?*KSJACK_DESCRIPTION2,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getJackCount(self: *const T, pc_jacks_: ?*u32) HRESULT {
                return @as(*const IKsJackDescription2.VTable, @ptrCast(self.vtable)).GetJackCount(@as(*const IKsJackDescription2, @ptrCast(self)), pc_jacks_);
            }
            pub inline fn getJackDescription2(self: *const T, n_jack_: u32, p_description2_: ?*KSJACK_DESCRIPTION2) HRESULT {
                return @as(*const IKsJackDescription2.VTable, @ptrCast(self.vtable)).GetJackDescription2(@as(*const IKsJackDescription2, @ptrCast(self)), n_jack_, p_description2_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IKsJackSinkInformation = extern struct {
    pub const VTable = extern struct {
        ...
        GetJackSinkInformation: *const fn (
            ...
            p_jack_sink_information: ?*KSJACK_SINK_INFORMATION,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getJackSinkInformation(self: *const T, p_jack_sink_information_: ?*KSJACK_SINK_INFORMATION) HRESULT {
                return @as(*const IKsJackSinkInformation.VTable, @ptrCast(self.vtable)).GetJackSinkInformation(@as(*const IKsJackSinkInformation, @ptrCast(self)), p_jack_sink_information_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IKsJackContainerId = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getJackContainerId(self: *const T, p_jack_container_id_: ?*Guid) HRESULT {
                return @as(*const IKsJackContainerId.VTable, @ptrCast(self.vtable)).GetJackContainerId(@as(*const IKsJackContainerId, @ptrCast(self)), p_jack_container_id_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IKsPropertySet = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn set(self: *const T, prop_set_: ?*const Guid, id_: u32, instance_data_: ?*anyopaque, instance_length_: u32, property_data_: ?*anyopaque, data_length_: u32) HRESULT {
                return @as(*const IKsPropertySet.VTable, @ptrCast(self.vtable)).Set(@as(*const IKsPropertySet, @ptrCast(self)), prop_set_, id_, instance_data_, instance_length_, property_data_, data_length_);
            }
            pub inline fn get(self: *const T, prop_set_: ?*const Guid, id_: u32, instance_data_: ?*anyopaque, instance_length_: u32, property_data_: ?*anyopaque, data_length_: u32, bytes_returned_: ?*u32) HRESULT {
                return @as(*const IKsPropertySet.VTable, @ptrCast(self.vtable)).Get(@as(*const IKsPropertySet, @ptrCast(self)), prop_set_, id_, instance_data_, instance_length_, property_data_, data_length_, bytes_returned_);
            }
            pub inline fn querySupported(self: *const T, prop_set_: ?*const Guid, id_: u32, type_support_: ?*u32) HRESULT {
                return @as(*const IKsPropertySet.VTable, @ptrCast(self.vtable)).QuerySupported(@as(*const IKsPropertySet, @ptrCast(self)), prop_set_, id_, type_support_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IKsAggregateControl = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn ksAddAggregate(self: *const T, aggregate_class_: ?*const Guid) HRESULT {
                return @as(*const IKsAggregateControl.VTable, @ptrCast(self.vtable)).KsAddAggregate(@as(*const IKsAggregateControl, @ptrCast(self)), aggregate_class_);
            }
            pub inline fn ksRemoveAggregate(self: *const T, aggregate_class_: ?*const Guid) HRESULT {
                return @as(*const IKsAggregateControl.VTable, @ptrCast(self.vtable)).KsRemoveAggregate(@as(*const IKsAggregateControl, @ptrCast(self)), aggregate_class_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IKsTopology = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn createNodeInstance(self: *const T, node_id_: u32, flags_: u32, desired_access_: u32, unk_outer_: ?*IUnknown, interface_id_: ?*const Guid, interface_: ?*?*anyopaque) HRESULT {
                return @as(*const IKsTopology.VTable, @ptrCast(self.vtable)).CreateNodeInstance(@as(*const IKsTopology, @ptrCast(self)), node_id_, flags_, desired_access_, unk_outer_, interface_id_, interface_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
