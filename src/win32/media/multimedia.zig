...
pub const IAVIStream = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn create(self: *const T, l_param1_: LPARAM, l_param2_: LPARAM) HRESULT {
                return @as(*const IAVIStream.VTable, @ptrCast(self.vtable)).Create(@as(*const IAVIStream, @ptrCast(self)), l_param1_, l_param2_);
            }
            pub inline fn info(self: *const T, psi_: ?*AVISTREAMINFOW, l_size_: i32) HRESULT {
                return @as(*const IAVIStream.VTable, @ptrCast(self.vtable)).Info(@as(*const IAVIStream, @ptrCast(self)), psi_, l_size_);
            }
            pub inline fn findSample(self: *const T, l_pos_: i32, l_flags_: i32) i32 {
                return @as(*const IAVIStream.VTable, @ptrCast(self.vtable)).FindSample(@as(*const IAVIStream, @ptrCast(self)), l_pos_, l_flags_);
            }
            pub inline fn readFormat(self: *const T, l_pos_: i32, lp_format_: ?*anyopaque, lpcb_format_: ?*i32) HRESULT {
                return @as(*const IAVIStream.VTable, @ptrCast(self.vtable)).ReadFormat(@as(*const IAVIStream, @ptrCast(self)), l_pos_, lp_format_, lpcb_format_);
            }
            pub inline fn setFormat(self: *const T, l_pos_: i32, lp_format_: ?*anyopaque, cb_format_: i32) HRESULT {
                return @as(*const IAVIStream.VTable, @ptrCast(self.vtable)).SetFormat(@as(*const IAVIStream, @ptrCast(self)), l_pos_, lp_format_, cb_format_);
            }
            pub inline fn read(self: *const T, l_start_: i32, l_samples_: i32, lp_buffer_: ?*anyopaque, cb_buffer_: i32, pl_bytes_: ?*i32, pl_samples_: ?*i32) HRESULT {
                return @as(*const IAVIStream.VTable, @ptrCast(self.vtable)).Read(@as(*const IAVIStream, @ptrCast(self)), l_start_, l_samples_, lp_buffer_, cb_buffer_, pl_bytes_, pl_samples_);
            }
            pub inline fn write(self: *const T, l_start_: i32, l_samples_: i32, lp_buffer_: ?*anyopaque, cb_buffer_: i32, dw_flags_: u32, pl_samp_written_: ?*i32, pl_bytes_written_: ?*i32) HRESULT {
                return @as(*const IAVIStream.VTable, @ptrCast(self.vtable)).Write(@as(*const IAVIStream, @ptrCast(self)), l_start_, l_samples_, lp_buffer_, cb_buffer_, dw_flags_, pl_samp_written_, pl_bytes_written_);
            }
            pub inline fn delete(self: *const T, l_start_: i32, l_samples_: i32) HRESULT {
                return @as(*const IAVIStream.VTable, @ptrCast(self.vtable)).Delete(@as(*const IAVIStream, @ptrCast(self)), l_start_, l_samples_);
            }
            pub inline fn readData(self: *const T, fcc_: u32, lp_: ?*anyopaque, lpcb_: ?*i32) HRESULT {
                return @as(*const IAVIStream.VTable, @ptrCast(self.vtable)).ReadData(@as(*const IAVIStream, @ptrCast(self)), fcc_, lp_, lpcb_);
            }
            pub inline fn writeData(self: *const T, fcc_: u32, lp_: ?*anyopaque, cb_: i32) HRESULT {
                return @as(*const IAVIStream.VTable, @ptrCast(self.vtable)).WriteData(@as(*const IAVIStream, @ptrCast(self)), fcc_, lp_, cb_);
            }
            pub inline fn setInfo(self: *const T, lp_info_: ?*AVISTREAMINFOW, cb_info_: i32) HRESULT {
                return @as(*const IAVIStream.VTable, @ptrCast(self.vtable)).SetInfo(@as(*const IAVIStream, @ptrCast(self)), lp_info_, cb_info_);
            }
        };
    }
...
pub const IAVIStreaming = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn begin(self: *const T, l_start_: i32, l_end_: i32, l_rate_: i32) HRESULT {
                return @as(*const IAVIStreaming.VTable, @ptrCast(self.vtable)).Begin(@as(*const IAVIStreaming, @ptrCast(self)), l_start_, l_end_, l_rate_);
            }
...
pub const IAVIEditStream = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn cut(self: *const T, pl_start_: ?*i32, pl_length_: ?*i32, pp_result_: ?*?*IAVIStream) HRESULT {
                return @as(*const IAVIEditStream.VTable, @ptrCast(self.vtable)).Cut(@as(*const IAVIEditStream, @ptrCast(self)), pl_start_, pl_length_, pp_result_);
            }
            pub inline fn copy(self: *const T, pl_start_: ?*i32, pl_length_: ?*i32, pp_result_: ?*?*IAVIStream) HRESULT {
                return @as(*const IAVIEditStream.VTable, @ptrCast(self.vtable)).Copy(@as(*const IAVIEditStream, @ptrCast(self)), pl_start_, pl_length_, pp_result_);
            }
            pub inline fn paste(self: *const T, pl_pos_: ?*i32, pl_length_: ?*i32, pstream_: ?*IAVIStream, l_start_: i32, l_end_: i32) HRESULT {
                return @as(*const IAVIEditStream.VTable, @ptrCast(self.vtable)).Paste(@as(*const IAVIEditStream, @ptrCast(self)), pl_pos_, pl_length_, pstream_, l_start_, l_end_);
            }
            pub inline fn clone(self: *const T, pp_result_: ?*?*IAVIStream) HRESULT {
                return @as(*const IAVIEditStream.VTable, @ptrCast(self.vtable)).Clone(@as(*const IAVIEditStream, @ptrCast(self)), pp_result_);
            }
            pub inline fn setInfo(self: *const T, lp_info_: ?*AVISTREAMINFOW, cb_info_: i32) HRESULT {
                return @as(*const IAVIEditStream.VTable, @ptrCast(self.vtable)).SetInfo(@as(*const IAVIEditStream, @ptrCast(self)), lp_info_, cb_info_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IAVIFile = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn info(self: *const T, pfi_: ?*AVIFILEINFOW, l_size_: i32) HRESULT {
                return @as(*const IAVIFile.VTable, @ptrCast(self.vtable)).Info(@as(*const IAVIFile, @ptrCast(self)), pfi_, l_size_);
            }
            pub inline fn getStream(self: *const T, pp_stream_: ?*?*IAVIStream, fcc_type_: u32, l_param_: i32) HRESULT {
                return @as(*const IAVIFile.VTable, @ptrCast(self.vtable)).GetStream(@as(*const IAVIFile, @ptrCast(self)), pp_stream_, fcc_type_, l_param_);
            }
            pub inline fn createStream(self: *const T, pp_stream_: ?*?*IAVIStream, psi_: ?*AVISTREAMINFOW) HRESULT {
                return @as(*const IAVIFile.VTable, @ptrCast(self.vtable)).CreateStream(@as(*const IAVIFile, @ptrCast(self)), pp_stream_, psi_);
            }
            pub inline fn writeData(self: *const T, ckid_: u32, lp_data_: ?*anyopaque, cb_data_: i32) HRESULT {
                return @as(*const IAVIFile.VTable, @ptrCast(self.vtable)).WriteData(@as(*const IAVIFile, @ptrCast(self)), ckid_, lp_data_, cb_data_);
            }
            pub inline fn readData(self: *const T, ckid_: u32, lp_data_: ?*anyopaque, lpcb_data_: ?*i32) HRESULT {
                return @as(*const IAVIFile.VTable, @ptrCast(self.vtable)).ReadData(@as(*const IAVIFile, @ptrCast(self)), ckid_, lp_data_, lpcb_data_);
            }
            pub inline fn endRecord(self: *const T) HRESULT {
                return @as(*const IAVIFile.VTable, @ptrCast(self.vtable)).EndRecord(@as(*const IAVIFile, @ptrCast(self)));
            }
            pub inline fn deleteStream(self: *const T, fcc_type_: u32, l_param_: i32) HRESULT {
                return @as(*const IAVIFile.VTable, @ptrCast(self.vtable)).DeleteStream(@as(*const IAVIFile, @ptrCast(self)), fcc_type_, l_param_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IGetFrame = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getFrame(self: *const T, l_pos_: i32) ?*anyopaque {
                return @as(*const IGetFrame.VTable, @ptrCast(self.vtable)).GetFrame(@as(*const IGetFrame, @ptrCast(self)), l_pos_);
            }
            pub inline fn begin(self: *const T, l_start_: i32, l_end_: i32, l_rate_: i32) HRESULT {
                return @as(*const IGetFrame.VTable, @ptrCast(self.vtable)).Begin(@as(*const IGetFrame, @ptrCast(self)), l_start_, l_end_, l_rate_);
            }
            pub inline fn end(self: *const T) HRESULT {
                return @as(*const IGetFrame.VTable, @ptrCast(self.vtable)).End(@as(*const IGetFrame, @ptrCast(self)));
            }
            pub inline fn setFormat(self: *const T, lpbi_: ?*BITMAPINFOHEADER, lp_bits_: ?*anyopaque, x_: i32, y_: i32, dx_: i32, dy_: i32) HRESULT {
                return @as(*const IGetFrame.VTable, @ptrCast(self.vtable)).SetFormat(@as(*const IGetFrame, @ptrCast(self)), lpbi_, lp_bits_, x_, y_, dx_, dy_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const VFWWDMExtensionProc = *const fn (
    pfn_device_io_control: ?*anyopaque,
    pfn_add_property_page: ?LPFNSVADDPROPSHEETPAGE,
    l_param: LPARAM,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "winmm" fn mciSendStringA(
    lpstr_command: ?[*:0]const u8,
    lpstr_return_string: ?[*:0]u8,
    u_return_length: u32,
    hwnd_callback: ?HWND,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "winmm" fn mciSendStringW(
    lpstr_command: ?[*:0]const u16,
    lpstr_return_string: ?[*:0]u16,
    u_return_length: u32,
    hwnd_callback: ?HWND,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "winmm" fn mciGetDeviceIDA(
    psz_device: ?[*:0]const u8,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "winmm" fn OpenDriver(
    sz_driver_name: ?[*:0]const u16,
    sz_section_name: ?[*:0]const u16,
    l_param2: LPARAM,
...
pub extern "avifil32" fn AVIMakeCompressedStream(
    pps_compressed: ?*?*IAVIStream,
    pps_source: ?*IAVIStream,
    lp_options: ?*AVICOMPRESSOPTIONS,
    pclsid_handler: ?*Guid,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "avifil32" fn AVISaveVA(
    ...
    n_streams: i32,
    ppavi: [*]?*IAVIStream,
    plp_options: [*]?*AVICOMPRESSOPTIONS,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
