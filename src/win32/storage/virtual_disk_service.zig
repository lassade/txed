...
pub const IEnumVdsObject = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn next(self: *const T, celt_: u32, pp_object_array_: [*]?*IUnknown, pc_fetched_: ?*u32) HRESULT {
                return @as(*const IEnumVdsObject.VTable, @ptrCast(self.vtable)).Next(@as(*const IEnumVdsObject, @ptrCast(self)), celt_, pp_object_array_, pc_fetched_);
            }
            pub inline fn skip(self: *const T, celt_: u32) HRESULT {
                return @as(*const IEnumVdsObject.VTable, @ptrCast(self.vtable)).Skip(@as(*const IEnumVdsObject, @ptrCast(self)), celt_);
            }
            pub inline fn reset(self: *const T) HRESULT {
                return @as(*const IEnumVdsObject.VTable, @ptrCast(self.vtable)).Reset(@as(*const IEnumVdsObject, @ptrCast(self)));
            }
            pub inline fn clone(self: *const T, pp_enum_: ?*?*IEnumVdsObject) HRESULT {
                return @as(*const IEnumVdsObject.VTable, @ptrCast(self.vtable)).Clone(@as(*const IEnumVdsObject, @ptrCast(self)), pp_enum_);
            }
        };
    }
...
pub const IVdsAsync = extern struct {
    pub const VTable = extern struct {
        ...
        Wait: *const fn (
            self: *const IVdsAsync,
            p_hr_result: ?*HRESULT,
            p_async_out: ?*VDS_ASYNC_OUTPUT,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        QueryStatus: *const fn (
            self: *const IVdsAsync,
            p_hr_result: ?*HRESULT,
            pul_percent_completed: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn wait(self: *const T, p_hr_result_: ?*HRESULT, p_async_out_: ?*VDS_ASYNC_OUTPUT) HRESULT {
                return @as(*const IVdsAsync.VTable, @ptrCast(self.vtable)).Wait(@as(*const IVdsAsync, @ptrCast(self)), p_hr_result_, p_async_out_);
            }
            pub inline fn queryStatus(self: *const T, p_hr_result_: ?*HRESULT, pul_percent_completed_: ?*u32) HRESULT {
                return @as(*const IVdsAsync.VTable, @ptrCast(self.vtable)).QueryStatus(@as(*const IVdsAsync, @ptrCast(self)), p_hr_result_, pul_percent_completed_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsAdviseSink = extern struct {
    pub const VTable = extern struct {
        ...
        OnNotify: *const fn (
            ...
            l_number_of_notifications: i32,
            p_notification_array: [*]VDS_NOTIFICATION,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn onNotify(self: *const T, l_number_of_notifications_: i32, p_notification_array_: [*]VDS_NOTIFICATION) HRESULT {
                return @as(*const IVdsAdviseSink.VTable, @ptrCast(self.vtable)).OnNotify(@as(*const IVdsAdviseSink, @ptrCast(self)), l_number_of_notifications_, p_notification_array_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsProvider = extern struct {
    pub const VTable = extern struct {
        ...
        GetProperties: *const fn (
            ...
            p_provider_prop: ?*VDS_PROVIDER_PROP,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getProperties(self: *const T, p_provider_prop_: ?*VDS_PROVIDER_PROP) HRESULT {
                return @as(*const IVdsProvider.VTable, @ptrCast(self.vtable)).GetProperties(@as(*const IVdsProvider, @ptrCast(self)), p_provider_prop_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsProviderSupport = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getVersionSupport(self: *const T, ul_version_support_: ?*u32) HRESULT {
                return @as(*const IVdsProviderSupport.VTable, @ptrCast(self.vtable)).GetVersionSupport(@as(*const IVdsProviderSupport, @ptrCast(self)), ul_version_support_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsProviderPrivate = extern struct {
    pub const VTable = extern struct {
        ...
        GetObject: *const fn (
            ...
            pp_object_unk: ?*?*IUnknown,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnLoad: *const fn (
            self: *const IVdsProviderPrivate,
            pwsz_machine_name: ?PWSTR,
            p_callback_object: ?*IUnknown,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnUnload: *const fn (
            self: *const IVdsProviderPrivate,
            b_force_unload: BOOL,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getObject(self: *const T, object_id_: Guid, type_: VDS_OBJECT_TYPE, pp_object_unk_: ?*?*IUnknown) HRESULT {
                return @as(*const IVdsProviderPrivate.VTable, @ptrCast(self.vtable)).GetObject(@as(*const IVdsProviderPrivate, @ptrCast(self)), object_id_, type_, pp_object_unk_);
            }
            pub inline fn onLoad(self: *const T, pwsz_machine_name_: ?PWSTR, p_callback_object_: ?*IUnknown) HRESULT {
                return @as(*const IVdsProviderPrivate.VTable, @ptrCast(self.vtable)).OnLoad(@as(*const IVdsProviderPrivate, @ptrCast(self)), pwsz_machine_name_, p_callback_object_);
            }
            pub inline fn onUnload(self: *const T, b_force_unload_: BOOL) HRESULT {
                return @as(*const IVdsProviderPrivate.VTable, @ptrCast(self.vtable)).OnUnload(@as(*const IVdsProviderPrivate, @ptrCast(self)), b_force_unload_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsHwProvider = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn querySubSystems(self: *const T, pp_enum_: ?*?*IEnumVdsObject) HRESULT {
                return @as(*const IVdsHwProvider.VTable, @ptrCast(self.vtable)).QuerySubSystems(@as(*const IVdsHwProvider, @ptrCast(self)), pp_enum_);
            }
            pub inline fn reenumerate(self: *const T) HRESULT {
...
pub const IVdsHwProviderType = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getProviderType(self: *const T, p_type_: ?*VDS_HWPROVIDER_TYPE) HRESULT {
                return @as(*const IVdsHwProviderType.VTable, @ptrCast(self.vtable)).GetProviderType(@as(*const IVdsHwProviderType, @ptrCast(self)), p_type_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsHwProviderType2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getProviderType2(self: *const T, p_type_: ?*VDS_HWPROVIDER_TYPE) HRESULT {
                return @as(*const IVdsHwProviderType2.VTable, @ptrCast(self.vtable)).GetProviderType2(@as(*const IVdsHwProviderType2, @ptrCast(self)), p_type_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsHwProviderStoragePools = extern struct {
    pub const VTable = extern struct {
        ...
        QueryStoragePools: *const fn (
            ...
            ul_flags: u32,
            ull_remaining_free_space: u64,
            p_pool_attributes: ?*VDS_POOL_ATTRIBUTES,
            pp_enum: ?*?*IEnumVdsObject,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        CreateLunInStoragePool: *const fn (
            self: *const IVdsHwProviderStoragePools,
            type: VDS_LUN_TYPE,
            ull_size_in_bytes: u64,
            storage_pool_id: Guid,
            pwsz_unmasking_list: ?PWSTR,
            p_hints2: ?*VDS_HINTS2,
            pp_async: ?*?*IVdsAsync,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn queryStoragePools(self: *const T, ul_flags_: u32, ull_remaining_free_space_: u64, p_pool_attributes_: ?*VDS_POOL_ATTRIBUTES, pp_enum_: ?*?*IEnumVdsObject) HRESULT {
                return @as(*const IVdsHwProviderStoragePools.VTable, @ptrCast(self.vtable)).QueryStoragePools(@as(*const IVdsHwProviderStoragePools, @ptrCast(self)), ul_flags_, ull_remaining_free_space_, p_pool_attributes_, pp_enum_);
            }
            pub inline fn createLunInStoragePool(self: *const T, type_: VDS_LUN_TYPE, ull_size_in_bytes_: u64, storage_pool_id_: Guid, pwsz_unmasking_list_: ?PWSTR, p_hints2_: ?*VDS_HINTS2, pp_async_: ?*?*IVdsAsync) HRESULT {
                return @as(*const IVdsHwProviderStoragePools.VTable, @ptrCast(self.vtable)).CreateLunInStoragePool(@as(*const IVdsHwProviderStoragePools, @ptrCast(self)), type_, ull_size_in_bytes_, storage_pool_id_, pwsz_unmasking_list_, p_hints2_, pp_async_);
            }
            pub inline fn queryMaxLunCreateSizeInStoragePool(self: *const T, type_: VDS_LUN_TYPE, storage_pool_id_: Guid, p_hints2_: ?*VDS_HINTS2, pull_max_lun_size_: ?*u64) HRESULT {
                return @as(*const IVdsHwProviderStoragePools.VTable, @ptrCast(self.vtable)).QueryMaxLunCreateSizeInStoragePool(@as(*const IVdsHwProviderStoragePools, @ptrCast(self)), type_, storage_pool_id_, p_hints2_, pull_max_lun_size_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsSubSystem = extern struct {
    pub const VTable = extern struct {
        ...
        GetProperties: *const fn (
            ...
            p_sub_system_prop: ?*VDS_SUB_SYSTEM_PROP,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetProvider: *const fn (
            self: *const IVdsSubSystem,
            pp_provider: ?*?*IVdsProvider,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        SetControllerStatus: *const fn (
            self: *const IVdsSubSystem,
            p_online_controller_id_array: [*]Guid,
            l_number_of_online_controllers: i32,
            p_offline_controller_id_array: [*]Guid,
            l_number_of_offline_controllers: i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        CreateLun: *const fn (
            self: *const IVdsSubSystem,
            type: VDS_LUN_TYPE,
            ull_size_in_bytes: u64,
            p_drive_id_array: ?[*]Guid,
            l_number_of_drives: i32,
            pwsz_unmasking_list: ?PWSTR,
            p_hints: ?*VDS_HINTS,
            pp_async: ?*?*IVdsAsync,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ReplaceDrive: *const fn (
            self: *const IVdsSubSystem,
            drive_to_be_replaced: Guid,
            replacement_drive: Guid,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        SetStatus: *const fn (
            self: *const IVdsSubSystem,
            status: VDS_SUB_SYSTEM_STATUS,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getProperties(self: *const T, p_sub_system_prop_: ?*VDS_SUB_SYSTEM_PROP) HRESULT {
                return @as(*const IVdsSubSystem.VTable, @ptrCast(self.vtable)).GetProperties(@as(*const IVdsSubSystem, @ptrCast(self)), p_sub_system_prop_);
            }
            pub inline fn getProvider(self: *const T, pp_provider_: ?*?*IVdsProvider) HRESULT {
                return @as(*const IVdsSubSystem.VTable, @ptrCast(self.vtable)).GetProvider(@as(*const IVdsSubSystem, @ptrCast(self)), pp_provider_);
            }
            pub inline fn queryControllers(self: *const T, pp_enum_: ?*?*IEnumVdsObject) HRESULT {
                return @as(*const IVdsSubSystem.VTable, @ptrCast(self.vtable)).QueryControllers(@as(*const IVdsSubSystem, @ptrCast(self)), pp_enum_);
            }
            pub inline fn queryLuns(self: *const T, pp_enum_: ?*?*IEnumVdsObject) HRESULT {
                return @as(*const IVdsSubSystem.VTable, @ptrCast(self.vtable)).QueryLuns(@as(*const IVdsSubSystem, @ptrCast(self)), pp_enum_);
            }
            pub inline fn queryDrives(self: *const T, pp_enum_: ?*?*IEnumVdsObject) HRESULT {
                return @as(*const IVdsSubSystem.VTable, @ptrCast(self.vtable)).QueryDrives(@as(*const IVdsSubSystem, @ptrCast(self)), pp_enum_);
            }
            pub inline fn getDrive(self: *const T, s_bus_number_: i16, s_slot_number_: i16, pp_drive_: ?*?*IVdsDrive) HRESULT {
                return @as(*const IVdsSubSystem.VTable, @ptrCast(self.vtable)).GetDrive(@as(*const IVdsSubSystem, @ptrCast(self)), s_bus_number_, s_slot_number_, pp_drive_);
            }
            pub inline fn reenumerate(self: *const T) HRESULT {
                return @as(*const IVdsSubSystem.VTable, @ptrCast(self.vtable)).Reenumerate(@as(*const IVdsSubSystem, @ptrCast(self)));
            }
            pub inline fn setControllerStatus(self: *const T, p_online_controller_id_array_: [*]Guid, l_number_of_online_controllers_: i32, p_offline_controller_id_array_: [*]Guid, l_number_of_offline_controllers_: i32) HRESULT {
                return @as(*const IVdsSubSystem.VTable, @ptrCast(self.vtable)).SetControllerStatus(@as(*const IVdsSubSystem, @ptrCast(self)), p_online_controller_id_array_, l_number_of_online_controllers_, p_offline_controller_id_array_, l_number_of_offline_controllers_);
            }
            pub inline fn createLun(self: *const T, type_: VDS_LUN_TYPE, ull_size_in_bytes_: u64, p_drive_id_array_: ?[*]Guid, l_number_of_drives_: i32, pwsz_unmasking_list_: ?PWSTR, p_hints_: ?*VDS_HINTS, pp_async_: ?*?*IVdsAsync) HRESULT {
                return @as(*const IVdsSubSystem.VTable, @ptrCast(self.vtable)).CreateLun(@as(*const IVdsSubSystem, @ptrCast(self)), type_, ull_size_in_bytes_, p_drive_id_array_, l_number_of_drives_, pwsz_unmasking_list_, p_hints_, pp_async_);
            }
            pub inline fn replaceDrive(self: *const T, drive_to_be_replaced_: Guid, replacement_drive_: Guid) HRESULT {
                return @as(*const IVdsSubSystem.VTable, @ptrCast(self.vtable)).ReplaceDrive(@as(*const IVdsSubSystem, @ptrCast(self)), drive_to_be_replaced_, replacement_drive_);
            }
            pub inline fn setStatus(self: *const T, status_: VDS_SUB_SYSTEM_STATUS) HRESULT {
                return @as(*const IVdsSubSystem.VTable, @ptrCast(self.vtable)).SetStatus(@as(*const IVdsSubSystem, @ptrCast(self)), status_);
            }
            pub inline fn queryMaxLunCreateSize(self: *const T, type_: VDS_LUN_TYPE, p_drive_id_array_: ?[*]Guid, l_number_of_drives_: i32, p_hints_: ?*VDS_HINTS, pull_max_lun_size_: ?*u64) HRESULT {
                return @as(*const IVdsSubSystem.VTable, @ptrCast(self.vtable)).QueryMaxLunCreateSize(@as(*const IVdsSubSystem, @ptrCast(self)), type_, p_drive_id_array_, l_number_of_drives_, p_hints_, pull_max_lun_size_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsSubSystem2 = extern struct {
    pub const VTable = extern struct {
        ...
        GetProperties2: *const fn (
            ...
            p_sub_system_prop2: ?*VDS_SUB_SYSTEM_PROP2,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetDrive2: *const fn (
            self: *const IVdsSubSystem2,
            s_bus_number: i16,
            s_slot_number: i16,
            ul_enclosure_number: u32,
            pp_drive: ?*?*IVdsDrive,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        CreateLun2: *const fn (
            self: *const IVdsSubSystem2,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getProperties2(self: *const T, p_sub_system_prop2_: ?*VDS_SUB_SYSTEM_PROP2) HRESULT {
                return @as(*const IVdsSubSystem2.VTable, @ptrCast(self.vtable)).GetProperties2(@as(*const IVdsSubSystem2, @ptrCast(self)), p_sub_system_prop2_);
            }
            pub inline fn getDrive2(self: *const T, s_bus_number_: i16, s_slot_number_: i16, ul_enclosure_number_: u32, pp_drive_: ?*?*IVdsDrive) HRESULT {
                return @as(*const IVdsSubSystem2.VTable, @ptrCast(self.vtable)).GetDrive2(@as(*const IVdsSubSystem2, @ptrCast(self)), s_bus_number_, s_slot_number_, ul_enclosure_number_, pp_drive_);
            }
            pub inline fn createLun2(self: *const T, type_: VDS_LUN_TYPE, ull_size_in_bytes_: u64, p_drive_id_array_: ?[*]Guid, l_number_of_drives_: i32, pwsz_unmasking_list_: ?PWSTR, p_hints2_: ?*VDS_HINTS2, pp_async_: ?*?*IVdsAsync) HRESULT {
                return @as(*const IVdsSubSystem2.VTable, @ptrCast(self.vtable)).CreateLun2(@as(*const IVdsSubSystem2, @ptrCast(self)), type_, ull_size_in_bytes_, p_drive_id_array_, l_number_of_drives_, pwsz_unmasking_list_, p_hints2_, pp_async_);
            }
            pub inline fn queryMaxLunCreateSize2(self: *const T, type_: VDS_LUN_TYPE, p_drive_id_array_: ?[*]Guid, l_number_of_drives_: i32, p_hints2_: ?*VDS_HINTS2, pull_max_lun_size_: ?*u64) HRESULT {
                return @as(*const IVdsSubSystem2.VTable, @ptrCast(self.vtable)).QueryMaxLunCreateSize2(@as(*const IVdsSubSystem2, @ptrCast(self)), type_, p_drive_id_array_, l_number_of_drives_, p_hints2_, pull_max_lun_size_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsSubSystemNaming = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn setFriendlyName(self: *const T, pwsz_friendly_name_: ?PWSTR) HRESULT {
                return @as(*const IVdsSubSystemNaming.VTable, @ptrCast(self.vtable)).SetFriendlyName(@as(*const IVdsSubSystemNaming, @ptrCast(self)), pwsz_friendly_name_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsSubSystemIscsi = extern struct {
    pub const VTable = extern struct {
        ...
        CreateTarget: *const fn (
            self: *const IVdsSubSystemIscsi,
            pwsz_iscsi_name: ?PWSTR,
            pwsz_friendly_name: ?PWSTR,
            pp_async: ?*?*IVdsAsync,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        SetIpsecGroupPresharedKey: *const fn (
            self: *const IVdsSubSystemIscsi,
            p_ipsec_key: ?*VDS_ISCSI_IPSEC_KEY,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn queryTargets(self: *const T, pp_enum_: ?*?*IEnumVdsObject) HRESULT {
                return @as(*const IVdsSubSystemIscsi.VTable, @ptrCast(self.vtable)).QueryTargets(@as(*const IVdsSubSystemIscsi, @ptrCast(self)), pp_enum_);
            }
            pub inline fn queryPortals(self: *const T, pp_enum_: ?*?*IEnumVdsObject) HRESULT {
                return @as(*const IVdsSubSystemIscsi.VTable, @ptrCast(self.vtable)).QueryPortals(@as(*const IVdsSubSystemIscsi, @ptrCast(self)), pp_enum_);
            }
            pub inline fn createTarget(self: *const T, pwsz_iscsi_name_: ?PWSTR, pwsz_friendly_name_: ?PWSTR, pp_async_: ?*?*IVdsAsync) HRESULT {
                return @as(*const IVdsSubSystemIscsi.VTable, @ptrCast(self.vtable)).CreateTarget(@as(*const IVdsSubSystemIscsi, @ptrCast(self)), pwsz_iscsi_name_, pwsz_friendly_name_, pp_async_);
            }
            pub inline fn setIpsecGroupPresharedKey(self: *const T, p_ipsec_key_: ?*VDS_ISCSI_IPSEC_KEY) HRESULT {
                return @as(*const IVdsSubSystemIscsi.VTable, @ptrCast(self.vtable)).SetIpsecGroupPresharedKey(@as(*const IVdsSubSystemIscsi, @ptrCast(self)), p_ipsec_key_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsSubSystemInterconnect = extern struct {
    pub const VTable = extern struct {
        ...
        GetSupportedInterconnects: *const fn (
            ...
            pul_supported_interconnects_flag: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getSupportedInterconnects(self: *const T, pul_supported_interconnects_flag_: ?*u32) HRESULT {
                return @as(*const IVdsSubSystemInterconnect.VTable, @ptrCast(self.vtable)).GetSupportedInterconnects(@as(*const IVdsSubSystemInterconnect, @ptrCast(self)), pul_supported_interconnects_flag_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsControllerPort = extern struct {
    pub const VTable = extern struct {
        ...
        GetProperties: *const fn (
            ...
            p_port_prop: ?*VDS_PORT_PROP,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetController: *const fn (
            self: *const IVdsControllerPort,
            pp_controller: ?*?*IVdsController,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getProperties(self: *const T, p_port_prop_: ?*VDS_PORT_PROP) HRESULT {
                return @as(*const IVdsControllerPort.VTable, @ptrCast(self.vtable)).GetProperties(@as(*const IVdsControllerPort, @ptrCast(self)), p_port_prop_);
            }
            pub inline fn getController(self: *const T, pp_controller_: ?*?*IVdsController) HRESULT {
                return @as(*const IVdsControllerPort.VTable, @ptrCast(self.vtable)).GetController(@as(*const IVdsControllerPort, @ptrCast(self)), pp_controller_);
            }
            pub inline fn queryAssociatedLuns(self: *const T, pp_enum_: ?*?*IEnumVdsObject) HRESULT {
                return @as(*const IVdsControllerPort.VTable, @ptrCast(self.vtable)).QueryAssociatedLuns(@as(*const IVdsControllerPort, @ptrCast(self)), pp_enum_);
            }
            pub inline fn reset(self: *const T) HRESULT {
                return @as(*const IVdsControllerPort.VTable, @ptrCast(self.vtable)).Reset(@as(*const IVdsControllerPort, @ptrCast(self)));
            }
            pub inline fn setStatus(self: *const T, status_: VDS_PORT_STATUS) HRESULT {
                return @as(*const IVdsControllerPort.VTable, @ptrCast(self.vtable)).SetStatus(@as(*const IVdsControllerPort, @ptrCast(self)), status_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsController = extern struct {
    pub const VTable = extern struct {
        ...
        GetProperties: *const fn (
            ...
            p_controller_prop: ?*VDS_CONTROLLER_PROP,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetSubSystem: *const fn (
            self: *const IVdsController,
            pp_sub_system: ?*?*IVdsSubSystem,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getProperties(self: *const T, p_controller_prop_: ?*VDS_CONTROLLER_PROP) HRESULT {
                return @as(*const IVdsController.VTable, @ptrCast(self.vtable)).GetProperties(@as(*const IVdsController, @ptrCast(self)), p_controller_prop_);
            }
            pub inline fn getSubSystem(self: *const T, pp_sub_system_: ?*?*IVdsSubSystem) HRESULT {
                return @as(*const IVdsController.VTable, @ptrCast(self.vtable)).GetSubSystem(@as(*const IVdsController, @ptrCast(self)), pp_sub_system_);
            }
            pub inline fn getPortProperties(self: *const T, s_port_number_: i16, p_port_prop_: ?*VDS_PORT_PROP) HRESULT {
                return @as(*const IVdsController.VTable, @ptrCast(self.vtable)).GetPortProperties(@as(*const IVdsController, @ptrCast(self)), s_port_number_, p_port_prop_);
            }
            pub inline fn flushCache(self: *const T) HRESULT {
                return @as(*const IVdsController.VTable, @ptrCast(self.vtable)).FlushCache(@as(*const IVdsController, @ptrCast(self)));
            }
            pub inline fn invalidateCache(self: *const T) HRESULT {
            ...
            pub inline fn queryAssociatedLuns(self: *const T, pp_enum_: ?*?*IEnumVdsObject) HRESULT {
                return @as(*const IVdsController.VTable, @ptrCast(self.vtable)).QueryAssociatedLuns(@as(*const IVdsController, @ptrCast(self)), pp_enum_);
            }
            pub inline fn setStatus(self: *const T, status_: VDS_CONTROLLER_STATUS) HRESULT {
                return @as(*const IVdsController.VTable, @ptrCast(self.vtable)).SetStatus(@as(*const IVdsController, @ptrCast(self)), status_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsControllerControllerPort = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn queryControllerPorts(self: *const T, pp_enum_: ?*?*IEnumVdsObject) HRESULT {
                return @as(*const IVdsControllerControllerPort.VTable, @ptrCast(self.vtable)).QueryControllerPorts(@as(*const IVdsControllerControllerPort, @ptrCast(self)), pp_enum_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsDrive = extern struct {
    pub const VTable = extern struct {
        ...
        QueryExtents: *const fn (
            self: *const IVdsDrive,
            pp_extent_array: [*]?*VDS_DRIVE_EXTENT,
            pl_number_of_extents: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        SetFlags: *const fn (
            self: *const IVdsDrive,
            ul_flags: u32,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getProperties(self: *const T, p_drive_prop_: ?*VDS_DRIVE_PROP) HRESULT {
                return @as(*const IVdsDrive.VTable, @ptrCast(self.vtable)).GetProperties(@as(*const IVdsDrive, @ptrCast(self)), p_drive_prop_);
            }
            pub inline fn getSubSystem(self: *const T, pp_sub_system_: ?*?*IVdsSubSystem) HRESULT {
                return @as(*const IVdsDrive.VTable, @ptrCast(self.vtable)).GetSubSystem(@as(*const IVdsDrive, @ptrCast(self)), pp_sub_system_);
            }
            pub inline fn queryExtents(self: *const T, pp_extent_array_: [*]?*VDS_DRIVE_EXTENT, pl_number_of_extents_: ?*i32) HRESULT {
                return @as(*const IVdsDrive.VTable, @ptrCast(self.vtable)).QueryExtents(@as(*const IVdsDrive, @ptrCast(self)), pp_extent_array_, pl_number_of_extents_);
            }
            pub inline fn setFlags(self: *const T, ul_flags_: u32) HRESULT {
                return @as(*const IVdsDrive.VTable, @ptrCast(self.vtable)).SetFlags(@as(*const IVdsDrive, @ptrCast(self)), ul_flags_);
            }
            pub inline fn clearFlags(self: *const T, ul_flags_: u32) HRESULT {
                return @as(*const IVdsDrive.VTable, @ptrCast(self.vtable)).ClearFlags(@as(*const IVdsDrive, @ptrCast(self)), ul_flags_);
            }
            pub inline fn setStatus(self: *const T, status_: VDS_DRIVE_STATUS) HRESULT {
                return @as(*const IVdsDrive.VTable, @ptrCast(self.vtable)).SetStatus(@as(*const IVdsDrive, @ptrCast(self)), status_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsDrive2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getProperties2(self: *const T, p_drive_prop2_: ?*VDS_DRIVE_PROP2) HRESULT {
                return @as(*const IVdsDrive2.VTable, @ptrCast(self.vtable)).GetProperties2(@as(*const IVdsDrive2, @ptrCast(self)), p_drive_prop2_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsLun = extern struct {
    pub const VTable = extern struct {
        ...
        Extend: *const fn (
            self: *const IVdsLun,
            ull_number_of_bytes_to_add: u64,
            p_drive_id_array: ?[*]Guid,
            l_number_of_drives: i32,
            pp_async: ?*?*IVdsAsync,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Shrink: *const fn (
            self: *const IVdsLun,
            ull_number_of_bytes_to_remove: u64,
            pp_async: ?*?*IVdsAsync,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        AssociateControllers: *const fn (
            self: *const IVdsLun,
            p_active_controller_id_array: ?[*]Guid,
            l_number_of_active_controllers: i32,
            p_inactive_controller_id_array: ?[*]Guid,
            l_number_of_inactive_controllers: i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        QueryHints: *const fn (
            self: *const IVdsLun,
            p_hints: ?*VDS_HINTS,
        ...
        QueryMaxLunExtendSize: *const fn (
            ...
            p_drive_id_array: ?[*]Guid,
            l_number_of_drives: i32,
            pull_max_bytes_to_be_added: ?*u64,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getProperties(self: *const T, p_lun_prop_: ?*VDS_LUN_PROP) HRESULT {
                return @as(*const IVdsLun.VTable, @ptrCast(self.vtable)).GetProperties(@as(*const IVdsLun, @ptrCast(self)), p_lun_prop_);
            }
            pub inline fn getSubSystem(self: *const T, pp_sub_system_: ?*?*IVdsSubSystem) HRESULT {
                return @as(*const IVdsLun.VTable, @ptrCast(self.vtable)).GetSubSystem(@as(*const IVdsLun, @ptrCast(self)), pp_sub_system_);
            }
            pub inline fn getIdentificationData(self: *const T, p_lun_info_: ?*VDS_LUN_INFORMATION) HRESULT {
                return @as(*const IVdsLun.VTable, @ptrCast(self.vtable)).GetIdentificationData(@as(*const IVdsLun, @ptrCast(self)), p_lun_info_);
            }
            pub inline fn queryActiveControllers(self: *const T, pp_enum_: ?*?*IEnumVdsObject) HRESULT {
                return @as(*const IVdsLun.VTable, @ptrCast(self.vtable)).QueryActiveControllers(@as(*const IVdsLun, @ptrCast(self)), pp_enum_);
            }
            pub inline fn extend(self: *const T, ull_number_of_bytes_to_add_: u64, p_drive_id_array_: ?[*]Guid, l_number_of_drives_: i32, pp_async_: ?*?*IVdsAsync) HRESULT {
                return @as(*const IVdsLun.VTable, @ptrCast(self.vtable)).Extend(@as(*const IVdsLun, @ptrCast(self)), ull_number_of_bytes_to_add_, p_drive_id_array_, l_number_of_drives_, pp_async_);
            }
            pub inline fn shrink(self: *const T, ull_number_of_bytes_to_remove_: u64, pp_async_: ?*?*IVdsAsync) HRESULT {
                return @as(*const IVdsLun.VTable, @ptrCast(self.vtable)).Shrink(@as(*const IVdsLun, @ptrCast(self)), ull_number_of_bytes_to_remove_, pp_async_);
            }
            pub inline fn queryPlexes(self: *const T, pp_enum_: ?*?*IEnumVdsObject) HRESULT {
                return @as(*const IVdsLun.VTable, @ptrCast(self.vtable)).QueryPlexes(@as(*const IVdsLun, @ptrCast(self)), pp_enum_);
            }
            pub inline fn addPlex(self: *const T, lun_id_: Guid, pp_async_: ?*?*IVdsAsync) HRESULT {
                return @as(*const IVdsLun.VTable, @ptrCast(self.vtable)).AddPlex(@as(*const IVdsLun, @ptrCast(self)), lun_id_, pp_async_);
            }
            pub inline fn removePlex(self: *const T, plex_id_: Guid, pp_async_: ?*?*IVdsAsync) HRESULT {
                return @as(*const IVdsLun.VTable, @ptrCast(self.vtable)).RemovePlex(@as(*const IVdsLun, @ptrCast(self)), plex_id_, pp_async_);
            }
            pub inline fn recover(self: *const T, pp_async_: ?*?*IVdsAsync) HRESULT {
                return @as(*const IVdsLun.VTable, @ptrCast(self.vtable)).Recover(@as(*const IVdsLun, @ptrCast(self)), pp_async_);
            }
            pub inline fn setMask(self: *const T, pwsz_unmasking_list_: ?PWSTR) HRESULT {
                return @as(*const IVdsLun.VTable, @ptrCast(self.vtable)).SetMask(@as(*const IVdsLun, @ptrCast(self)), pwsz_unmasking_list_);
            }
            ...
            pub inline fn associateControllers(self: *const T, p_active_controller_id_array_: ?[*]Guid, l_number_of_active_controllers_: i32, p_inactive_controller_id_array_: ?[*]Guid, l_number_of_inactive_controllers_: i32) HRESULT {
                return @as(*const IVdsLun.VTable, @ptrCast(self.vtable)).AssociateControllers(@as(*const IVdsLun, @ptrCast(self)), p_active_controller_id_array_, l_number_of_active_controllers_, p_inactive_controller_id_array_, l_number_of_inactive_controllers_);
            }
            pub inline fn queryHints(self: *const T, p_hints_: ?*VDS_HINTS) HRESULT {
                return @as(*const IVdsLun.VTable, @ptrCast(self.vtable)).QueryHints(@as(*const IVdsLun, @ptrCast(self)), p_hints_);
            }
            pub inline fn applyHints(self: *const T, p_hints_: ?*VDS_HINTS) HRESULT {
                return @as(*const IVdsLun.VTable, @ptrCast(self.vtable)).ApplyHints(@as(*const IVdsLun, @ptrCast(self)), p_hints_);
            }
            pub inline fn setStatus(self: *const T, status_: VDS_LUN_STATUS) HRESULT {
                return @as(*const IVdsLun.VTable, @ptrCast(self.vtable)).SetStatus(@as(*const IVdsLun, @ptrCast(self)), status_);
            }
            pub inline fn queryMaxLunExtendSize(self: *const T, p_drive_id_array_: ?[*]Guid, l_number_of_drives_: i32, pull_max_bytes_to_be_added_: ?*u64) HRESULT {
                return @as(*const IVdsLun.VTable, @ptrCast(self.vtable)).QueryMaxLunExtendSize(@as(*const IVdsLun, @ptrCast(self)), p_drive_id_array_, l_number_of_drives_, pull_max_bytes_to_be_added_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsLun2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn queryHints2(self: *const T, p_hints2_: ?*VDS_HINTS2) HRESULT {
                return @as(*const IVdsLun2.VTable, @ptrCast(self.vtable)).QueryHints2(@as(*const IVdsLun2, @ptrCast(self)), p_hints2_);
            }
            pub inline fn applyHints2(self: *const T, p_hints2_: ?*VDS_HINTS2) HRESULT {
                return @as(*const IVdsLun2.VTable, @ptrCast(self.vtable)).ApplyHints2(@as(*const IVdsLun2, @ptrCast(self)), p_hints2_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsLunNaming = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn setFriendlyName(self: *const T, pwsz_friendly_name_: ?PWSTR) HRESULT {
                return @as(*const IVdsLunNaming.VTable, @ptrCast(self.vtable)).SetFriendlyName(@as(*const IVdsLunNaming, @ptrCast(self)), pwsz_friendly_name_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsLunNumber = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getLunNumber(self: *const T, pul_lun_number_: ?*u32) HRESULT {
                return @as(*const IVdsLunNumber.VTable, @ptrCast(self.vtable)).GetLunNumber(@as(*const IVdsLunNumber, @ptrCast(self)), pul_lun_number_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsLunControllerPorts = extern struct {
    pub const VTable = extern struct {
        ...
        AssociateControllerPorts: *const fn (
            ...
            p_active_controller_port_id_array: ?[*]Guid,
            l_number_of_active_controller_ports: i32,
            p_inactive_controller_port_id_array: ?[*]Guid,
            l_number_of_inactive_controller_ports: i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn associateControllerPorts(self: *const T, p_active_controller_port_id_array_: ?[*]Guid, l_number_of_active_controller_ports_: i32, p_inactive_controller_port_id_array_: ?[*]Guid, l_number_of_inactive_controller_ports_: i32) HRESULT {
                return @as(*const IVdsLunControllerPorts.VTable, @ptrCast(self.vtable)).AssociateControllerPorts(@as(*const IVdsLunControllerPorts, @ptrCast(self)), p_active_controller_port_id_array_, l_number_of_active_controller_ports_, p_inactive_controller_port_id_array_, l_number_of_inactive_controller_ports_);
            }
            pub inline fn queryActiveControllerPorts(self: *const T, pp_enum_: ?*?*IEnumVdsObject) HRESULT {
                return @as(*const IVdsLunControllerPorts.VTable, @ptrCast(self.vtable)).QueryActiveControllerPorts(@as(*const IVdsLunControllerPorts, @ptrCast(self)), pp_enum_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsLunMpio = extern struct {
    pub const VTable = extern struct {
        ...
        GetPathInfo: *const fn (
            ...
            pp_paths: [*]?*VDS_PATH_INFO,
            pl_number_of_paths: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetLoadBalancePolicy: *const fn (
            self: *const IVdsLunMpio,
            p_policy: ?*VDS_LOADBALANCE_POLICY_ENUM,
            pp_paths: [*]?*VDS_PATH_POLICY,
            pl_number_of_paths: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        SetLoadBalancePolicy: *const fn (
            self: *const IVdsLunMpio,
            policy: VDS_LOADBALANCE_POLICY_ENUM,
            p_paths: ?[*]VDS_PATH_POLICY,
            l_number_of_paths: i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getPathInfo(self: *const T, pp_paths_: [*]?*VDS_PATH_INFO, pl_number_of_paths_: ?*i32) HRESULT {
                return @as(*const IVdsLunMpio.VTable, @ptrCast(self.vtable)).GetPathInfo(@as(*const IVdsLunMpio, @ptrCast(self)), pp_paths_, pl_number_of_paths_);
            }
            pub inline fn getLoadBalancePolicy(self: *const T, p_policy_: ?*VDS_LOADBALANCE_POLICY_ENUM, pp_paths_: [*]?*VDS_PATH_POLICY, pl_number_of_paths_: ?*i32) HRESULT {
                return @as(*const IVdsLunMpio.VTable, @ptrCast(self.vtable)).GetLoadBalancePolicy(@as(*const IVdsLunMpio, @ptrCast(self)), p_policy_, pp_paths_, pl_number_of_paths_);
            }
            pub inline fn setLoadBalancePolicy(self: *const T, policy_: VDS_LOADBALANCE_POLICY_ENUM, p_paths_: ?[*]VDS_PATH_POLICY, l_number_of_paths_: i32) HRESULT {
                return @as(*const IVdsLunMpio.VTable, @ptrCast(self.vtable)).SetLoadBalancePolicy(@as(*const IVdsLunMpio, @ptrCast(self)), policy_, p_paths_, l_number_of_paths_);
            }
            pub inline fn getSupportedLbPolicies(self: *const T, pul_lb_flags_: ?*u32) HRESULT {
                return @as(*const IVdsLunMpio.VTable, @ptrCast(self.vtable)).GetSupportedLbPolicies(@as(*const IVdsLunMpio, @ptrCast(self)), pul_lb_flags_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsLunIscsi = extern struct {
    pub const VTable = extern struct {
        ...
        AssociateTargets: *const fn (
            ...
            p_target_id_array: ?[*]Guid,
            l_number_of_targets: i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn associateTargets(self: *const T, p_target_id_array_: ?[*]Guid, l_number_of_targets_: i32) HRESULT {
                return @as(*const IVdsLunIscsi.VTable, @ptrCast(self.vtable)).AssociateTargets(@as(*const IVdsLunIscsi, @ptrCast(self)), p_target_id_array_, l_number_of_targets_);
            }
            pub inline fn queryAssociatedTargets(self: *const T, pp_enum_: ?*?*IEnumVdsObject) HRESULT {
                return @as(*const IVdsLunIscsi.VTable, @ptrCast(self.vtable)).QueryAssociatedTargets(@as(*const IVdsLunIscsi, @ptrCast(self)), pp_enum_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsLunPlex = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getProperties(self: *const T, p_plex_prop_: ?*VDS_LUN_PLEX_PROP) HRESULT {
                return @as(*const IVdsLunPlex.VTable, @ptrCast(self.vtable)).GetProperties(@as(*const IVdsLunPlex, @ptrCast(self)), p_plex_prop_);
            }
            pub inline fn getLun(self: *const T, pp_lun_: ?*?*IVdsLun) HRESULT {
                return @as(*const IVdsLunPlex.VTable, @ptrCast(self.vtable)).GetLun(@as(*const IVdsLunPlex, @ptrCast(self)), pp_lun_);
            }
            pub inline fn queryExtents(self: *const T, pp_extent_array_: [*]?*VDS_DRIVE_EXTENT, pl_number_of_extents_: ?*i32) HRESULT {
                return @as(*const IVdsLunPlex.VTable, @ptrCast(self.vtable)).QueryExtents(@as(*const IVdsLunPlex, @ptrCast(self)), pp_extent_array_, pl_number_of_extents_);
            }
            pub inline fn queryHints(self: *const T, p_hints_: ?*VDS_HINTS) HRESULT {
                return @as(*const IVdsLunPlex.VTable, @ptrCast(self.vtable)).QueryHints(@as(*const IVdsLunPlex, @ptrCast(self)), p_hints_);
            }
            pub inline fn applyHints(self: *const T, p_hints_: ?*VDS_HINTS) HRESULT {
                return @as(*const IVdsLunPlex.VTable, @ptrCast(self.vtable)).ApplyHints(@as(*const IVdsLunPlex, @ptrCast(self)), p_hints_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsIscsiPortal = extern struct {
    pub const VTable = extern struct {
        ...
        GetProperties: *const fn (
            ...
            p_portal_prop: ?*VDS_ISCSI_PORTAL_PROP,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetSubSystem: *const fn (
            self: *const IVdsIscsiPortal,
            pp_sub_system: ?*?*IVdsSubSystem,
        ...
        SetIpsecTunnelAddress: *const fn (
            self: *const IVdsIscsiPortal,
            p_tunnel_address: ?*VDS_IPADDRESS,
            p_destination_address: ?*VDS_IPADDRESS,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetIpsecSecurity: *const fn (
            self: *const IVdsIscsiPortal,
            p_initiator_portal_address: ?*VDS_IPADDRESS,
            pull_security_flags: ?*u64,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        SetIpsecSecurity: *const fn (
            self: *const IVdsIscsiPortal,
            p_initiator_portal_address: ?*VDS_IPADDRESS,
            ull_security_flags: u64,
            p_ipsec_key: ?*VDS_ISCSI_IPSEC_KEY,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getProperties(self: *const T, p_portal_prop_: ?*VDS_ISCSI_PORTAL_PROP) HRESULT {
                return @as(*const IVdsIscsiPortal.VTable, @ptrCast(self.vtable)).GetProperties(@as(*const IVdsIscsiPortal, @ptrCast(self)), p_portal_prop_);
            }
            pub inline fn getSubSystem(self: *const T, pp_sub_system_: ?*?*IVdsSubSystem) HRESULT {
                return @as(*const IVdsIscsiPortal.VTable, @ptrCast(self.vtable)).GetSubSystem(@as(*const IVdsIscsiPortal, @ptrCast(self)), pp_sub_system_);
            }
            pub inline fn queryAssociatedPortalGroups(self: *const T, pp_enum_: ?*?*IEnumVdsObject) HRESULT {
                return @as(*const IVdsIscsiPortal.VTable, @ptrCast(self.vtable)).QueryAssociatedPortalGroups(@as(*const IVdsIscsiPortal, @ptrCast(self)), pp_enum_);
            }
            pub inline fn setStatus(self: *const T, status_: VDS_ISCSI_PORTAL_STATUS) HRESULT {
                return @as(*const IVdsIscsiPortal.VTable, @ptrCast(self.vtable)).SetStatus(@as(*const IVdsIscsiPortal, @ptrCast(self)), status_);
            }
            pub inline fn setIpsecTunnelAddress(self: *const T, p_tunnel_address_: ?*VDS_IPADDRESS, p_destination_address_: ?*VDS_IPADDRESS) HRESULT {
                return @as(*const IVdsIscsiPortal.VTable, @ptrCast(self.vtable)).SetIpsecTunnelAddress(@as(*const IVdsIscsiPortal, @ptrCast(self)), p_tunnel_address_, p_destination_address_);
            }
            pub inline fn getIpsecSecurity(self: *const T, p_initiator_portal_address_: ?*VDS_IPADDRESS, pull_security_flags_: ?*u64) HRESULT {
                return @as(*const IVdsIscsiPortal.VTable, @ptrCast(self.vtable)).GetIpsecSecurity(@as(*const IVdsIscsiPortal, @ptrCast(self)), p_initiator_portal_address_, pull_security_flags_);
            }
            pub inline fn setIpsecSecurity(self: *const T, p_initiator_portal_address_: ?*VDS_IPADDRESS, ull_security_flags_: u64, p_ipsec_key_: ?*VDS_ISCSI_IPSEC_KEY) HRESULT {
                return @as(*const IVdsIscsiPortal.VTable, @ptrCast(self.vtable)).SetIpsecSecurity(@as(*const IVdsIscsiPortal, @ptrCast(self)), p_initiator_portal_address_, ull_security_flags_, p_ipsec_key_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsIscsiTarget = extern struct {
    pub const VTable = extern struct {
        ...
        GetProperties: *const fn (
            ...
            p_target_prop: ?*VDS_ISCSI_TARGET_PROP,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetSubSystem: *const fn (
            self: *const IVdsIscsiTarget,
            pp_sub_system: ?*?*IVdsSubSystem,
        ...
        SetSharedSecret: *const fn (
            self: *const IVdsIscsiTarget,
            p_target_shared_secret: ?*VDS_ISCSI_SHARED_SECRET,
            pwsz_initiator_name: ?PWSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        RememberInitiatorSharedSecret: *const fn (
            self: *const IVdsIscsiTarget,
            pwsz_initiator_name: ?PWSTR,
            p_initiator_shared_secret: ?*VDS_ISCSI_SHARED_SECRET,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetConnectedInitiators: *const fn (
            self: *const IVdsIscsiTarget,
            pppwsz_initiator_list: [*]?*?PWSTR,
            pl_number_of_initiators: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getProperties(self: *const T, p_target_prop_: ?*VDS_ISCSI_TARGET_PROP) HRESULT {
                return @as(*const IVdsIscsiTarget.VTable, @ptrCast(self.vtable)).GetProperties(@as(*const IVdsIscsiTarget, @ptrCast(self)), p_target_prop_);
            }
            pub inline fn getSubSystem(self: *const T, pp_sub_system_: ?*?*IVdsSubSystem) HRESULT {
                return @as(*const IVdsIscsiTarget.VTable, @ptrCast(self.vtable)).GetSubSystem(@as(*const IVdsIscsiTarget, @ptrCast(self)), pp_sub_system_);
            }
            pub inline fn queryPortalGroups(self: *const T, pp_enum_: ?*?*IEnumVdsObject) HRESULT {
                return @as(*const IVdsIscsiTarget.VTable, @ptrCast(self.vtable)).QueryPortalGroups(@as(*const IVdsIscsiTarget, @ptrCast(self)), pp_enum_);
            }
            pub inline fn queryAssociatedLuns(self: *const T, pp_enum_: ?*?*IEnumVdsObject) HRESULT {
                return @as(*const IVdsIscsiTarget.VTable, @ptrCast(self.vtable)).QueryAssociatedLuns(@as(*const IVdsIscsiTarget, @ptrCast(self)), pp_enum_);
            }
            pub inline fn createPortalGroup(self: *const T, pp_async_: ?*?*IVdsAsync) HRESULT {
                return @as(*const IVdsIscsiTarget.VTable, @ptrCast(self.vtable)).CreatePortalGroup(@as(*const IVdsIscsiTarget, @ptrCast(self)), pp_async_);
            }
            pub inline fn delete(self: *const T, pp_async_: ?*?*IVdsAsync) HRESULT {
                return @as(*const IVdsIscsiTarget.VTable, @ptrCast(self.vtable)).Delete(@as(*const IVdsIscsiTarget, @ptrCast(self)), pp_async_);
            }
            pub inline fn setFriendlyName(self: *const T, pwsz_friendly_name_: ?PWSTR) HRESULT {
                return @as(*const IVdsIscsiTarget.VTable, @ptrCast(self.vtable)).SetFriendlyName(@as(*const IVdsIscsiTarget, @ptrCast(self)), pwsz_friendly_name_);
            }
            pub inline fn setSharedSecret(self: *const T, p_target_shared_secret_: ?*VDS_ISCSI_SHARED_SECRET, pwsz_initiator_name_: ?PWSTR) HRESULT {
                return @as(*const IVdsIscsiTarget.VTable, @ptrCast(self.vtable)).SetSharedSecret(@as(*const IVdsIscsiTarget, @ptrCast(self)), p_target_shared_secret_, pwsz_initiator_name_);
            }
            pub inline fn rememberInitiatorSharedSecret(self: *const T, pwsz_initiator_name_: ?PWSTR, p_initiator_shared_secret_: ?*VDS_ISCSI_SHARED_SECRET) HRESULT {
                return @as(*const IVdsIscsiTarget.VTable, @ptrCast(self.vtable)).RememberInitiatorSharedSecret(@as(*const IVdsIscsiTarget, @ptrCast(self)), pwsz_initiator_name_, p_initiator_shared_secret_);
            }
            pub inline fn getConnectedInitiators(self: *const T, pppwsz_initiator_list_: [*]?*?PWSTR, pl_number_of_initiators_: ?*i32) HRESULT {
                return @as(*const IVdsIscsiTarget.VTable, @ptrCast(self.vtable)).GetConnectedInitiators(@as(*const IVdsIscsiTarget, @ptrCast(self)), pppwsz_initiator_list_, pl_number_of_initiators_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsIscsiPortalGroup = extern struct {
    pub const VTable = extern struct {
        ...
        GetProperties: *const fn (
            ...
            p_portal_group_prop: ?*VDS_ISCSI_PORTALGROUP_PROP,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetTarget: *const fn (
            self: *const IVdsIscsiPortalGroup,
            pp_target: ?*?*IVdsIscsiTarget,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getProperties(self: *const T, p_portal_group_prop_: ?*VDS_ISCSI_PORTALGROUP_PROP) HRESULT {
                return @as(*const IVdsIscsiPortalGroup.VTable, @ptrCast(self.vtable)).GetProperties(@as(*const IVdsIscsiPortalGroup, @ptrCast(self)), p_portal_group_prop_);
            }
            pub inline fn getTarget(self: *const T, pp_target_: ?*?*IVdsIscsiTarget) HRESULT {
                return @as(*const IVdsIscsiPortalGroup.VTable, @ptrCast(self.vtable)).GetTarget(@as(*const IVdsIscsiPortalGroup, @ptrCast(self)), pp_target_);
            }
            pub inline fn queryAssociatedPortals(self: *const T, pp_enum_: ?*?*IEnumVdsObject) HRESULT {
                return @as(*const IVdsIscsiPortalGroup.VTable, @ptrCast(self.vtable)).QueryAssociatedPortals(@as(*const IVdsIscsiPortalGroup, @ptrCast(self)), pp_enum_);
            }
            pub inline fn addPortal(self: *const T, portal_id_: Guid, pp_async_: ?*?*IVdsAsync) HRESULT {
                return @as(*const IVdsIscsiPortalGroup.VTable, @ptrCast(self.vtable)).AddPortal(@as(*const IVdsIscsiPortalGroup, @ptrCast(self)), portal_id_, pp_async_);
            }
            pub inline fn removePortal(self: *const T, portal_id_: Guid, pp_async_: ?*?*IVdsAsync) HRESULT {
                return @as(*const IVdsIscsiPortalGroup.VTable, @ptrCast(self.vtable)).RemovePortal(@as(*const IVdsIscsiPortalGroup, @ptrCast(self)), portal_id_, pp_async_);
            }
            pub inline fn delete(self: *const T, pp_async_: ?*?*IVdsAsync) HRESULT {
                return @as(*const IVdsIscsiPortalGroup.VTable, @ptrCast(self.vtable)).Delete(@as(*const IVdsIscsiPortalGroup, @ptrCast(self)), pp_async_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsStoragePool = extern struct {
    pub const VTable = extern struct {
        ...
        GetProperties: *const fn (
            self: *const IVdsStoragePool,
            p_storage_pool_prop: ?*VDS_STORAGE_POOL_PROP,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetAttributes: *const fn (
            self: *const IVdsStoragePool,
            p_storage_pool_attributes: ?*VDS_POOL_ATTRIBUTES,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        QueryDriveExtents: *const fn (
            self: *const IVdsStoragePool,
            pp_extent_array: [*]?*VDS_STORAGE_POOL_DRIVE_EXTENT,
            pl_number_of_extents: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getProvider(self: *const T, pp_provider_: ?*?*IVdsProvider) HRESULT {
                return @as(*const IVdsStoragePool.VTable, @ptrCast(self.vtable)).GetProvider(@as(*const IVdsStoragePool, @ptrCast(self)), pp_provider_);
            }
            pub inline fn getProperties(self: *const T, p_storage_pool_prop_: ?*VDS_STORAGE_POOL_PROP) HRESULT {
                return @as(*const IVdsStoragePool.VTable, @ptrCast(self.vtable)).GetProperties(@as(*const IVdsStoragePool, @ptrCast(self)), p_storage_pool_prop_);
            }
            pub inline fn getAttributes(self: *const T, p_storage_pool_attributes_: ?*VDS_POOL_ATTRIBUTES) HRESULT {
                return @as(*const IVdsStoragePool.VTable, @ptrCast(self.vtable)).GetAttributes(@as(*const IVdsStoragePool, @ptrCast(self)), p_storage_pool_attributes_);
            }
            pub inline fn queryDriveExtents(self: *const T, pp_extent_array_: [*]?*VDS_STORAGE_POOL_DRIVE_EXTENT, pl_number_of_extents_: ?*i32) HRESULT {
                return @as(*const IVdsStoragePool.VTable, @ptrCast(self.vtable)).QueryDriveExtents(@as(*const IVdsStoragePool, @ptrCast(self)), pp_extent_array_, pl_number_of_extents_);
            }
            pub inline fn queryAllocatedLuns(self: *const T, pp_enum_: ?*?*IEnumVdsObject) HRESULT {
                return @as(*const IVdsStoragePool.VTable, @ptrCast(self.vtable)).QueryAllocatedLuns(@as(*const IVdsStoragePool, @ptrCast(self)), pp_enum_);
            }
            pub inline fn queryAllocatedStoragePools(self: *const T, pp_enum_: ?*?*IEnumVdsObject) HRESULT {
                return @as(*const IVdsStoragePool.VTable, @ptrCast(self.vtable)).QueryAllocatedStoragePools(@as(*const IVdsStoragePool, @ptrCast(self)), pp_enum_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsMaintenance = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn startMaintenance(self: *const T, operation_: VDS_MAINTENANCE_OPERATION) HRESULT {
                return @as(*const IVdsMaintenance.VTable, @ptrCast(self.vtable)).StartMaintenance(@as(*const IVdsMaintenance, @ptrCast(self)), operation_);
            }
            pub inline fn stopMaintenance(self: *const T, operation_: VDS_MAINTENANCE_OPERATION) HRESULT {
                return @as(*const IVdsMaintenance.VTable, @ptrCast(self.vtable)).StopMaintenance(@as(*const IVdsMaintenance, @ptrCast(self)), operation_);
            }
            pub inline fn pulseMaintenance(self: *const T, operation_: VDS_MAINTENANCE_OPERATION, ul_count_: u32) HRESULT {
                return @as(*const IVdsMaintenance.VTable, @ptrCast(self.vtable)).PulseMaintenance(@as(*const IVdsMaintenance, @ptrCast(self)), operation_, ul_count_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsHwProviderPrivate = extern struct {
    pub const VTable = extern struct {
        ...
        QueryIfCreatedLun: *const fn (
            ...
            pwsz_device_path: ?PWSTR,
            p_vds_lun_information: ?*VDS_LUN_INFORMATION,
            p_lun_id: ?*Guid,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn queryIfCreatedLun(self: *const T, pwsz_device_path_: ?PWSTR, p_vds_lun_information_: ?*VDS_LUN_INFORMATION, p_lun_id_: ?*Guid) HRESULT {
                return @as(*const IVdsHwProviderPrivate.VTable, @ptrCast(self.vtable)).QueryIfCreatedLun(@as(*const IVdsHwProviderPrivate, @ptrCast(self)), pwsz_device_path_, p_vds_lun_information_, p_lun_id_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsHwProviderPrivateMpio = extern struct {
    pub const VTable = extern struct {
        ...
        SetAllPathStatusesFromHbaPort: *const fn (
            ...
            hba_port_prop: VDS_HBAPORT_PROP,
            status: VDS_PATH_STATUS,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn setAllPathStatusesFromHbaPort(self: *const T, hba_port_prop_: VDS_HBAPORT_PROP, status_: VDS_PATH_STATUS) HRESULT {
                return @as(*const IVdsHwProviderPrivateMpio.VTable, @ptrCast(self.vtable)).SetAllPathStatusesFromHbaPort(@as(*const IVdsHwProviderPrivateMpio, @ptrCast(self)), hba_port_prop_, status_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IVdsAdmin = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn registerProvider(self: *const T, provider_id_: Guid, provider_clsid_: Guid, pwsz_name_: ?PWSTR, type_: VDS_PROVIDER_TYPE, pwsz_machine_name_: ?PWSTR, pwsz_version_: ?PWSTR, guid_version_id_: Guid) HRESULT {
                return @as(*const IVdsAdmin.VTable, @ptrCast(self.vtable)).RegisterProvider(@as(*const IVdsAdmin, @ptrCast(self)), provider_id_, provider_clsid_, pwsz_name_, type_, pwsz_machine_name_, pwsz_version_, guid_version_id_);
            }
            pub inline fn unregisterProvider(self: *const T, provider_id_: Guid) HRESULT {
                return @as(*const IVdsAdmin.VTable, @ptrCast(self.vtable)).UnregisterProvider(@as(*const IVdsAdmin, @ptrCast(self)), provider_id_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
