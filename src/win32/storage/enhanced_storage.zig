...
pub const IEnumEnhancedStorageACT = extern struct {
    pub const VTable = extern struct {
        ...
        GetACTs: *const fn (
            ...
            ppp_i_enhanced_storage_a_c_ts: [*]?*?*IEnhancedStorageACT,
            pc_enhanced_storage_a_c_ts: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetMatchingACT: *const fn (
            self: *const IEnumEnhancedStorageACT,
            sz_volume: ?[*:0]const u16,
            pp_i_enhanced_storage_a_c_t: ?*?*IEnhancedStorageACT,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getACTs(self: *const T, ppp_i_enhanced_storage_a_c_ts_: [*]?*?*IEnhancedStorageACT, pc_enhanced_storage_a_c_ts_: ?*u32) HRESULT {
                return @as(*const IEnumEnhancedStorageACT.VTable, @ptrCast(self.vtable)).GetACTs(@as(*const IEnumEnhancedStorageACT, @ptrCast(self)), ppp_i_enhanced_storage_a_c_ts_, pc_enhanced_storage_a_c_ts_);
            }
            pub inline fn getMatchingACT(self: *const T, sz_volume_: ?[*:0]const u16, pp_i_enhanced_storage_a_c_t_: ?*?*IEnhancedStorageACT) HRESULT {
                return @as(*const IEnumEnhancedStorageACT.VTable, @ptrCast(self.vtable)).GetMatchingACT(@as(*const IEnumEnhancedStorageACT, @ptrCast(self)), sz_volume_, pp_i_enhanced_storage_a_c_t_);
            }
        };
    }
...
pub const IEnhancedStorageACT = extern struct {
    pub const VTable = extern struct {
        ...
        GetAuthorizationState: *const fn (
            self: *const IEnhancedStorageACT,
            p_state: ?*ACT_AUTHORIZATION_STATE,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        GetSilos: *const fn (
            self: *const IEnhancedStorageACT,
            ppp_i_enhanced_storage_silos: [*]?*?*IEnhancedStorageSilo,
            pc_enhanced_storage_silos: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn authorize(self: *const T, hwnd_parent_: u32, dw_flags_: u32) HRESULT {
                return @as(*const IEnhancedStorageACT.VTable, @ptrCast(self.vtable)).Authorize(@as(*const IEnhancedStorageACT, @ptrCast(self)), hwnd_parent_, dw_flags_);
            }
            pub inline fn unauthorize(self: *const T) HRESULT {
                return @as(*const IEnhancedStorageACT.VTable, @ptrCast(self.vtable)).Unauthorize(@as(*const IEnhancedStorageACT, @ptrCast(self)));
            }
            pub inline fn getAuthorizationState(self: *const T, p_state_: ?*ACT_AUTHORIZATION_STATE) HRESULT {
                return @as(*const IEnhancedStorageACT.VTable, @ptrCast(self.vtable)).GetAuthorizationState(@as(*const IEnhancedStorageACT, @ptrCast(self)), p_state_);
            }
            pub inline fn getMatchingVolume(self: *const T, ppwsz_volume_: ?*?PWSTR) HRESULT {
                return @as(*const IEnhancedStorageACT.VTable, @ptrCast(self.vtable)).GetMatchingVolume(@as(*const IEnhancedStorageACT, @ptrCast(self)), ppwsz_volume_);
            }
            pub inline fn getUniqueIdentity(self: *const T, ppwsz_identity_: ?*?PWSTR) HRESULT {
                return @as(*const IEnhancedStorageACT.VTable, @ptrCast(self.vtable)).GetUniqueIdentity(@as(*const IEnhancedStorageACT, @ptrCast(self)), ppwsz_identity_);
            }
            pub inline fn getSilos(self: *const T, ppp_i_enhanced_storage_silos_: [*]?*?*IEnhancedStorageSilo, pc_enhanced_storage_silos_: ?*u32) HRESULT {
                return @as(*const IEnhancedStorageACT.VTable, @ptrCast(self.vtable)).GetSilos(@as(*const IEnhancedStorageACT, @ptrCast(self)), ppp_i_enhanced_storage_silos_, pc_enhanced_storage_silos_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IEnhancedStorageACT2 = extern struct {
    pub const VTable = extern struct {
        ...
        GetDeviceName: *const fn (
            ...
            ppwsz_device_name: ?*?PWSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        IsDeviceRemovable: *const fn (
            self: *const IEnhancedStorageACT2,
            p_is_device_removable: ?*BOOL,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getDeviceName(self: *const T, ppwsz_device_name_: ?*?PWSTR) HRESULT {
                return @as(*const IEnhancedStorageACT2.VTable, @ptrCast(self.vtable)).GetDeviceName(@as(*const IEnhancedStorageACT2, @ptrCast(self)), ppwsz_device_name_);
            }
            pub inline fn isDeviceRemovable(self: *const T, p_is_device_removable_: ?*BOOL) HRESULT {
                return @as(*const IEnhancedStorageACT2.VTable, @ptrCast(self.vtable)).IsDeviceRemovable(@as(*const IEnhancedStorageACT2, @ptrCast(self)), p_is_device_removable_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IEnhancedStorageACT3 = extern struct {
    pub const VTable = extern struct {
        ...
        IsQueueFrozen: *const fn (
            self: *const IEnhancedStorageACT3,
            p_is_queue_frozen: ?*BOOL,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetShellExtSupport: *const fn (
            self: *const IEnhancedStorageACT3,
            p_shell_ext_support: ?*BOOL,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn unauthorizeEx(self: *const T, dw_flags_: u32) HRESULT {
                return @as(*const IEnhancedStorageACT3.VTable, @ptrCast(self.vtable)).UnauthorizeEx(@as(*const IEnhancedStorageACT3, @ptrCast(self)), dw_flags_);
            }
            pub inline fn isQueueFrozen(self: *const T, p_is_queue_frozen_: ?*BOOL) HRESULT {
                return @as(*const IEnhancedStorageACT3.VTable, @ptrCast(self.vtable)).IsQueueFrozen(@as(*const IEnhancedStorageACT3, @ptrCast(self)), p_is_queue_frozen_);
            }
            pub inline fn getShellExtSupport(self: *const T, p_shell_ext_support_: ?*BOOL) HRESULT {
                return @as(*const IEnhancedStorageACT3.VTable, @ptrCast(self.vtable)).GetShellExtSupport(@as(*const IEnhancedStorageACT3, @ptrCast(self)), p_shell_ext_support_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IEnhancedStorageSilo = extern struct {
    pub const VTable = extern struct {
        ...
        GetInfo: *const fn (
            ...
            p_silo_info: ?*SILO_INFO,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetActions: *const fn (
            self: *const IEnhancedStorageSilo,
            ppp_i_enhanced_storage_silo_actions: [*]?*?*IEnhancedStorageSiloAction,
            pc_enhanced_storage_silo_actions: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        SendCommand: *const fn (
            self: *const IEnhancedStorageSilo,
            command: u8,
            pb_command_buffer: [*:0]u8,
            cb_command_buffer: u32,
            pb_response_buffer: [*:0]u8,
            pcb_response_buffer: ?*u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetPortableDevice: *const fn (
            self: *const IEnhancedStorageSilo,
            pp_i_portable_device: ?*?*IPortableDevice,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetDevicePath: *const fn (
            self: *const IEnhancedStorageSilo,
            ppwsz_silo_device_path: ?*?PWSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getInfo(self: *const T, p_silo_info_: ?*SILO_INFO) HRESULT {
                return @as(*const IEnhancedStorageSilo.VTable, @ptrCast(self.vtable)).GetInfo(@as(*const IEnhancedStorageSilo, @ptrCast(self)), p_silo_info_);
            }
            pub inline fn getActions(self: *const T, ppp_i_enhanced_storage_silo_actions_: [*]?*?*IEnhancedStorageSiloAction, pc_enhanced_storage_silo_actions_: ?*u32) HRESULT {
                return @as(*const IEnhancedStorageSilo.VTable, @ptrCast(self.vtable)).GetActions(@as(*const IEnhancedStorageSilo, @ptrCast(self)), ppp_i_enhanced_storage_silo_actions_, pc_enhanced_storage_silo_actions_);
            }
            pub inline fn sendCommand(self: *const T, command_: u8, pb_command_buffer_: [*:0]u8, cb_command_buffer_: u32, pb_response_buffer_: [*:0]u8, pcb_response_buffer_: ?*u32) HRESULT {
                return @as(*const IEnhancedStorageSilo.VTable, @ptrCast(self.vtable)).SendCommand(@as(*const IEnhancedStorageSilo, @ptrCast(self)), command_, pb_command_buffer_, cb_command_buffer_, pb_response_buffer_, pcb_response_buffer_);
            }
            pub inline fn getPortableDevice(self: *const T, pp_i_portable_device_: ?*?*IPortableDevice) HRESULT {
                return @as(*const IEnhancedStorageSilo.VTable, @ptrCast(self.vtable)).GetPortableDevice(@as(*const IEnhancedStorageSilo, @ptrCast(self)), pp_i_portable_device_);
            }
            pub inline fn getDevicePath(self: *const T, ppwsz_silo_device_path_: ?*?PWSTR) HRESULT {
                return @as(*const IEnhancedStorageSilo.VTable, @ptrCast(self.vtable)).GetDevicePath(@as(*const IEnhancedStorageSilo, @ptrCast(self)), ppwsz_silo_device_path_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IEnhancedStorageSiloAction = extern struct {
    pub const VTable = extern struct {
        ...
        GetName: *const fn (
            ...
            ppwsz_action_name: ?*?PWSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetDescription: *const fn (
            self: *const IEnhancedStorageSiloAction,
            ppwsz_action_description: ?*?PWSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Invoke: *const fn (
            self: *const IEnhancedStorageSiloAction,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getName(self: *const T, ppwsz_action_name_: ?*?PWSTR) HRESULT {
                return @as(*const IEnhancedStorageSiloAction.VTable, @ptrCast(self.vtable)).GetName(@as(*const IEnhancedStorageSiloAction, @ptrCast(self)), ppwsz_action_name_);
            }
            pub inline fn getDescription(self: *const T, ppwsz_action_description_: ?*?PWSTR) HRESULT {
                return @as(*const IEnhancedStorageSiloAction.VTable, @ptrCast(self.vtable)).GetDescription(@as(*const IEnhancedStorageSiloAction, @ptrCast(self)), ppwsz_action_description_);
            }
