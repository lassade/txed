...
pub const DUMP_DEVICE_POWERON_ROUTINE = *const fn (
    context: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) i32;

pub const PDUMP_DEVICE_POWERON_ROUTINE = *const fn () callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "iscsidsc" fn GetIScsiVersionInformation(
    version_info: ?*ISCSI_VERSION_INFO,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "iscsidsc" fn GetIScsiTargetInformationW(
    target_name: ?PWSTR,
    discovery_mechanism: ?PWSTR,
    info_class: TARGET_INFORMATION_CLASS,
    buffer_size: ?*u32,
    buffer: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "iscsidsc" fn AddIScsiConnectionW(
    unique_session_id: ?*ISCSI_UNIQUE_SESSION_ID,
    reserved: ?*anyopaque,
...
pub extern "iscsidsc" fn AddIScsiStaticTargetW(
    ...
    mappings: ?*ISCSI_TARGET_MAPPINGW,
    login_options: ?*ISCSI_LOGIN_OPTIONS,
    portal_group: ?*ISCSI_TARGET_PORTAL_GROUPW,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "iscsidsc" fn AddIScsiStaticTargetA(
    ...
    mappings: ?*ISCSI_TARGET_MAPPINGA,
    login_options: ?*ISCSI_LOGIN_OPTIONS,
    portal_group: ?*ISCSI_TARGET_PORTAL_GROUPA,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "iscsidsc" fn ReportIScsiSendTargetPortalsW(
    portal_count: ?*u32,
    portal_info: ?*ISCSI_TARGET_PORTAL_INFOW,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "iscsidsc" fn ReportIScsiSendTargetPortalsA(
    portal_count: ?*u32,
    portal_info: ?*ISCSI_TARGET_PORTAL_INFOA,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "iscsidsc" fn ReportIScsiSendTargetPortalsExW(
    portal_count: ?*u32,
    portal_info_size: ?*u32,
    portal_info: ?*ISCSI_TARGET_PORTAL_INFO_EXW,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "iscsidsc" fn ReportIScsiSendTargetPortalsExA(
    portal_count: ?*u32,
    portal_info_size: ?*u32,
    portal_info: ?*ISCSI_TARGET_PORTAL_INFO_EXA,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "iscsidsc" fn LoginIScsiTargetW(
    ...
    unique_session_id: ?*ISCSI_UNIQUE_SESSION_ID,
    unique_connection_id: ?*ISCSI_UNIQUE_SESSION_ID,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "iscsidsc" fn ReportIScsiPersistentLoginsW(
    count: ?*u32,
    persistent_login_info: ?*PERSISTENT_ISCSI_LOGIN_INFOW,
...
pub extern "iscsidsc" fn ReportIScsiPersistentLoginsA(
    count: ?*u32,
    persistent_login_info: ?*PERSISTENT_ISCSI_LOGIN_INFOA,
    buffer_size_in_bytes: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "iscsidsc" fn SetIScsiTunnelModeOuterAddressW(
    initiator_name: ?PWSTR,
    initiator_port_number: u32,
    destination_address: ?PWSTR,
    outer_mode_address: ?PWSTR,
    persist: BOOLEAN,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "iscsidsc" fn SetIScsiTunnelModeOuterAddressA(
    initiator_name: ?PSTR,
    initiator_port_number: u32,
    destination_address: ?PSTR,
    outer_mode_address: ?PSTR,
    persist: BOOLEAN,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "iscsidsc" fn SetIScsiIKEInfoW(
    initiator_name: ?PWSTR,
    initiator_port_number: u32,
    auth_info: ?*IKE_AUTHENTICATION_INFORMATION,
    persist: BOOLEAN,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "iscsidsc" fn GetIScsiSessionListW(
    buffer_size: ?*u32,
    session_count: ?*u32,
    session_info: ?*ISCSI_SESSION_INFOW,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "iscsidsc" fn GetIScsiSessionListA(
    buffer_size: ?*u32,
    session_count: ?*u32,
    session_info: ?*ISCSI_SESSION_INFOA,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "iscsidsc" fn GetIScsiSessionListEx(
    buffer_size: ?*u32,
    session_count_ptr: ?*u32,
    session_info: ?*ISCSI_SESSION_INFO_EX,
) callconv(@import("std").os.windows.WINAPI) u32;
