...
pub const VIRTUAL_DISK_ACCESS_MASK = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(VIRTUAL_DISK_ACCESS_MASK, @enumFromInt((if (o.NONE == 1) @intFromEnum(VIRTUAL_DISK_ACCESS_MASK.NONE) else 0) | (if (o.ATTACH_RO == 1) @intFromEnum(VIRTUAL_DISK_ACCESS_MASK.ATTACH_RO) else 0) | (if (o.ATTACH_RW == 1) @intFromEnum(VIRTUAL_DISK_ACCESS_MASK.ATTACH_RW) else 0) | (if (o.DETACH == 1) @intFromEnum(VIRTUAL_DISK_ACCESS_MASK.DETACH) else 0) | (if (o.GET_INFO == 1) @intFromEnum(VIRTUAL_DISK_ACCESS_MASK.GET_INFO) else 0) | (if (o.CREATE == 1) @intFromEnum(VIRTUAL_DISK_ACCESS_MASK.CREATE) else 0) | (if (o.METAOPS == 1) @intFromEnum(VIRTUAL_DISK_ACCESS_MASK.METAOPS) else 0) | (if (o.READ == 1) @intFromEnum(VIRTUAL_DISK_ACCESS_MASK.READ) else 0) | (if (o.ALL == 1) @intFromEnum(VIRTUAL_DISK_ACCESS_MASK.ALL) else 0) | (if (o.WRITABLE == 1) @intFromEnum(VIRTUAL_DISK_ACCESS_MASK.WRITABLE) else 0)));
    }
};
...
pub const DETACH_VIRTUAL_DISK_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(DETACH_VIRTUAL_DISK_FLAG, @enumFromInt((if (o.E == 1) @intFromEnum(DETACH_VIRTUAL_DISK_FLAG.E) else 0)));
    }
};
...
pub const GET_STORAGE_DEPENDENCY_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(GET_STORAGE_DEPENDENCY_FLAG, @enumFromInt((if (o.NONE == 1) @intFromEnum(GET_STORAGE_DEPENDENCY_FLAG.NONE) else 0) | (if (o.HOST_VOLUMES == 1) @intFromEnum(GET_STORAGE_DEPENDENCY_FLAG.HOST_VOLUMES) else 0) | (if (o.DISK_HANDLE == 1) @intFromEnum(GET_STORAGE_DEPENDENCY_FLAG.DISK_HANDLE) else 0)));
    }
};
...
pub const COMPACT_VIRTUAL_DISK_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(COMPACT_VIRTUAL_DISK_FLAG, @enumFromInt((if (o.NE == 1) @intFromEnum(COMPACT_VIRTUAL_DISK_FLAG.NE) else 0) | (if (o._ZERO_SCAN == 1) @intFromEnum(COMPACT_VIRTUAL_DISK_FLAG._ZERO_SCAN) else 0) | (if (o._BLOCK_MOVES == 1) @intFromEnum(COMPACT_VIRTUAL_DISK_FLAG._BLOCK_MOVES) else 0)));
    }
};
...
pub const MERGE_VIRTUAL_DISK_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(MERGE_VIRTUAL_DISK_FLAG, @enumFromInt((if (o.E == 1) @intFromEnum(MERGE_VIRTUAL_DISK_FLAG.E) else 0)));
    }
};
...
pub const EXPAND_VIRTUAL_DISK_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(EXPAND_VIRTUAL_DISK_FLAG, @enumFromInt((if (o.NE == 1) @intFromEnum(EXPAND_VIRTUAL_DISK_FLAG.NE) else 0) | (if (o.TIFY_CHANGE == 1) @intFromEnum(EXPAND_VIRTUAL_DISK_FLAG.TIFY_CHANGE) else 0)));
    }
};
...
pub const RESIZE_VIRTUAL_DISK_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(RESIZE_VIRTUAL_DISK_FLAG, @enumFromInt((if (o.NONE == 1) @intFromEnum(RESIZE_VIRTUAL_DISK_FLAG.NONE) else 0) | (if (o.ALLOW_UNSAFE_VIRTUAL_SIZE == 1) @intFromEnum(RESIZE_VIRTUAL_DISK_FLAG.ALLOW_UNSAFE_VIRTUAL_SIZE) else 0) | (if (o.RESIZE_TO_SMALLEST_SAFE_VIRTUAL_SIZE == 1) @intFromEnum(RESIZE_VIRTUAL_DISK_FLAG.RESIZE_TO_SMALLEST_SAFE_VIRTUAL_SIZE) else 0)));
    }
};
...
pub const QUERY_CHANGES_VIRTUAL_DISK_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(QUERY_CHANGES_VIRTUAL_DISK_FLAG, @enumFromInt((if (o.E == 1) @intFromEnum(QUERY_CHANGES_VIRTUAL_DISK_FLAG.E) else 0)));
    }
};
...
pub const TAKE_SNAPSHOT_VHDSET_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(TAKE_SNAPSHOT_VHDSET_FLAG, @enumFromInt((if (o.NONE == 1) @intFromEnum(TAKE_SNAPSHOT_VHDSET_FLAG.NONE) else 0) | (if (o.WRITEABLE == 1) @intFromEnum(TAKE_SNAPSHOT_VHDSET_FLAG.WRITEABLE) else 0)));
    }
};
...
pub const DELETE_SNAPSHOT_VHDSET_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(DELETE_SNAPSHOT_VHDSET_FLAG, @enumFromInt((if (o.NONE == 1) @intFromEnum(DELETE_SNAPSHOT_VHDSET_FLAG.NONE) else 0) | (if (o.PERSIST_RCT == 1) @intFromEnum(DELETE_SNAPSHOT_VHDSET_FLAG.PERSIST_RCT) else 0)));
    }
};
...
pub const MODIFY_VHDSET_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(MODIFY_VHDSET_FLAG, @enumFromInt((if (o.NONE == 1) @intFromEnum(MODIFY_VHDSET_FLAG.NONE) else 0) | (if (o.WRITEABLE_SNAPSHOT == 1) @intFromEnum(MODIFY_VHDSET_FLAG.WRITEABLE_SNAPSHOT) else 0)));
    }
};
...
pub const APPLY_SNAPSHOT_VHDSET_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(APPLY_SNAPSHOT_VHDSET_FLAG, @enumFromInt((if (o.NONE == 1) @intFromEnum(APPLY_SNAPSHOT_VHDSET_FLAG.NONE) else 0) | (if (o.WRITEABLE == 1) @intFromEnum(APPLY_SNAPSHOT_VHDSET_FLAG.WRITEABLE) else 0)));
    }
};
...
pub const RAW_SCSI_VIRTUAL_DISK_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(RAW_SCSI_VIRTUAL_DISK_FLAG, @enumFromInt((if (o.E == 1) @intFromEnum(RAW_SCSI_VIRTUAL_DISK_FLAG.E) else 0)));
    }
};
...
pub const FORK_VIRTUAL_DISK_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(FORK_VIRTUAL_DISK_FLAG, @enumFromInt((if (o.NONE == 1) @intFromEnum(FORK_VIRTUAL_DISK_FLAG.NONE) else 0) | (if (o.EXISTING_FILE == 1) @intFromEnum(FORK_VIRTUAL_DISK_FLAG.EXISTING_FILE) else 0)));
    }
};
...
pub extern "virtdisk" fn OpenVirtualDisk(
    ...
    path: ?[*:0]const u16,
    virtual_disk_access_mask: VIRTUAL_DISK_ACCESS_MASK,
...
pub extern "virtdisk" fn GetStorageDependencyInformation(
    ...
    storage_dependency_info: ?*STORAGE_DEPENDENCY_INFO,
    size_used: ?*u32,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;
...
pub extern "virtdisk" fn GetVirtualDiskInformation(
    virtual_disk_handle: ?HANDLE,
    virtual_disk_info_size: ?*u32,
    // TODO: what to do with BytesParamIndex 1?
    virtual_disk_info: ?*GET_VIRTUAL_DISK_INFO,
    size_used: ?*u32,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;
...
pub extern "virtdisk" fn SetVirtualDiskInformation(
    virtual_disk_handle: ?HANDLE,
    virtual_disk_info: ?*SET_VIRTUAL_DISK_INFO,
) callconv(@import("std").os.windows.WINAPI) WIN32_ERROR;
...
pub extern "virtdisk" fn QueryChangesVirtualDisk(
    virtual_disk_handle: ?HANDLE,
    change_tracking_id: ?[*:0]const u16,
    byte_offset: u64,
    byte_length: u64,
