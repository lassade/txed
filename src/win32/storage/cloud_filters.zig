...
pub extern "cldapi" fn CfConnectSyncRoot(
    sync_root_path: ?[*:0]const u16,
    callback_table: ?*const CF_CALLBACK_REGISTRATION,
...
pub extern "cldapi" fn CfExecute(
    op_info: ?*const CF_OPERATION_INFO,
...
pub extern "cldapi" fn CfCreatePlaceholders(
    base_directory_path: ?[*:0]const u16,
...
pub extern "cldapi" fn CfConvertToPlaceholder(
    ...
    file_identity: ?*const anyopaque,
    file_identity_length: u32,
    convert_flags: CF_CONVERT_FLAGS,
    convert_usn: ?*i64,
...
pub extern "cldapi" fn CfUpdatePlaceholder(
    file_handle: ?HANDLE,
    fs_metadata: ?*const CF_FS_METADATA,
    // TODO: what to do with BytesParamIndex 3?
    file_identity: ?*const anyopaque,
    file_identity_length: u32,
    dehydrate_range_array: ?[*]const CF_FILE_RANGE,
    dehydrate_range_count: u32,
...
pub extern "cldapi" fn CfHydratePlaceholder(
    ...
    length: LARGE_INTEGER,
    hydrate_flags: CF_HYDRATE_FLAGS,
    overlapped: ?*OVERLAPPED,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "cldapi" fn CfDehydratePlaceholder(
    ...
    starting_offset: LARGE_INTEGER,
    length: LARGE_INTEGER,
    dehydrate_flags: CF_DEHYDRATE_FLAGS,
    overlapped: ?*OVERLAPPED,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "cldapi" fn CfSetInSyncState(
    ...
    in_sync_flags: CF_SET_IN_SYNC_FLAGS,
    in_sync_usn: ?*i64,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "cldapi" fn CfSetCorrelationVector(
    file_handle: ?HANDLE,
    correlation_vector: ?*const CORRELATION_VECTOR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "cldapi" fn CfGetSyncRootInfoByPath(
    file_path: ?[*:0]const u16,
    info_class: CF_SYNC_ROOT_INFO_CLASS,
    info_buffer: ?*anyopaque,
    info_buffer_length: u32,
    returned_length: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "cldapi" fn CfGetPlaceholderRangeInfo(
    file_handle: ?HANDLE,
    info_class: CF_PLACEHOLDER_RANGE_INFO_CLASS,
    starting_offset: LARGE_INTEGER,
    length: LARGE_INTEGER,
...
pub extern "cldapi" fn CfReportProviderProgress(
    connection_key: CF_CONNECTION_KEY,
    transfer_key: LARGE_INTEGER,
    provider_progress_total: LARGE_INTEGER,
    provider_progress_completed: LARGE_INTEGER,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
