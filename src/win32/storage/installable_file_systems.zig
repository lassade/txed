...
pub extern "fltlib" fn FilterInstanceCreate(
    ...
    lp_instance_name: ?[*:0]const u16,
    h_instance: ?*HFILTER_INSTANCE,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "fltlib" fn FilterAttach(
    ...
    lp_volume_name: ?[*:0]const u16,
    lp_instance_name: ?[*:0]const u16,
    dw_created_instance_name_length: u32,
    // TODO: what to do with BytesParamIndex 3?
    lp_created_instance_name: ?PWSTR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "fltlib" fn FilterAttachAtAltitude(
    lp_filter_name: ?[*:0]const u16,
    lp_volume_name: ?[*:0]const u16,
    lp_altitude: ?[*:0]const u16,
    lp_instance_name: ?[*:0]const u16,
    dw_created_instance_name_length: u32,
...
pub extern "fltlib" fn FilterFindFirst(
    dw_information_class: FILTER_INFORMATION_CLASS,
    // TODO: what to do with BytesParamIndex 2?
    lp_buffer: ?*anyopaque,
    dw_buffer_size: u32,
    lp_bytes_returned: ?*u32,
    lp_filter_find: ?*FilterFindHandle,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "fltlib" fn FilterFindNext(
    h_filter_find: ?HANDLE,
    dw_information_class: FILTER_INFORMATION_CLASS,
    // TODO: what to do with BytesParamIndex 3?
    lp_buffer: ?*anyopaque,
    dw_buffer_size: u32,
...
pub extern "fltlib" fn FilterVolumeFindFirst(
    dw_information_class: FILTER_VOLUME_INFORMATION_CLASS,
    // TODO: what to do with BytesParamIndex 2?
    lp_buffer: ?*anyopaque,
    dw_buffer_size: u32,
    lp_bytes_returned: ?*u32,
    lp_volume_find: ?*FilterVolumeFindHandle,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "fltlib" fn FilterVolumeFindNext(
    h_volume_find: ?HANDLE,
    dw_information_class: FILTER_VOLUME_INFORMATION_CLASS,
    // TODO: what to do with BytesParamIndex 3?
    lp_buffer: ?*anyopaque,
    dw_buffer_size: u32,
...
pub extern "fltlib" fn FilterInstanceFindFirst(
    lp_filter_name: ?[*:0]const u16,
    dw_information_class: INSTANCE_INFORMATION_CLASS,
    // TODO: what to do with BytesParamIndex 3?
    lp_buffer: ?*anyopaque,
    dw_buffer_size: u32,
    lp_bytes_returned: ?*u32,
    lp_filter_instance_find: ?*FilterInstanceFindHandle,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "fltlib" fn FilterInstanceFindNext(
    h_filter_instance_find: ?HANDLE,
    dw_information_class: INSTANCE_INFORMATION_CLASS,
    // TODO: what to do with BytesParamIndex 3?
    lp_buffer: ?*anyopaque,
    dw_buffer_size: u32,
...
pub extern "fltlib" fn FilterVolumeInstanceFindFirst(
    ...
    dw_buffer_size: u32,
    lp_bytes_returned: ?*u32,
    lp_volume_instance_find: ?*FilterVolumeInstanceFindHandle,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "fltlib" fn FilterVolumeInstanceFindNext(
    h_volume_instance_find: ?HANDLE,
    dw_information_class: INSTANCE_INFORMATION_CLASS,
    // TODO: what to do with BytesParamIndex 3?
    lp_buffer: ?*anyopaque,
    dw_buffer_size: u32,
...
pub extern "fltlib" fn FilterConnectCommunicationPort(
    lp_port_name: ?[*:0]const u16,
    dw_options: u32,
    // TODO: what to do with BytesParamIndex 3?
    lp_context: ?*const anyopaque,
    w_size_of_context: u16,
...
pub extern "fltlib" fn FilterGetMessage(
    h_port: ?HANDLE,
    // TODO: what to do with BytesParamIndex 2?
    lp_message_buffer: ?*FILTER_MESSAGE_HEADER,
    dw_message_buffer_size: u32,
...
pub extern "fltlib" fn FilterReplyMessage(
    h_port: ?HANDLE,
    // TODO: what to do with BytesParamIndex 2?
    lp_reply_buffer: ?*FILTER_REPLY_HEADER,
    dw_reply_buffer_size: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "fltlib" fn FilterGetDosName(
    lp_volume_name: ?[*:0]const u16,
    lp_dos_name: [*:0]u16,
    dw_dos_name_buffer_size: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
