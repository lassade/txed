...
pub const PRJ_NOTIFICATION_CB = *const fn (
    ...
    destination_file_name: ?[*:0]const u16,
    operation_parameters: ?*PRJ_NOTIFICATION_PARAMETERS,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "projectedfslib" fn PrjStartVirtualizing(
    virtualization_root_path: ?[*:0]const u16,
    callbacks: ?*const PRJ_CALLBACKS,
    instance_context: ?*const anyopaque,
...
pub extern "projectedfslib" fn PrjClearNegativePathCache(
    namespace_virtualization_context: PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT,
    total_entry_number: ?*u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows10.0.17763'
pub extern "projectedfslib" fn PrjGetVirtualizationInstanceInfo(
    namespace_virtualization_context: PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT,
    virtualization_instance_info: ?*PRJ_VIRTUALIZATION_INSTANCE_INFO,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows10.0.17763'
pub extern "projectedfslib" fn PrjMarkDirectoryAsPlaceholder(
    root_path_name: ?[*:0]const u16,
    target_path_name: ?[*:0]const u16,
    version_info: ?*const PRJ_PLACEHOLDER_VERSION_INFO,
    virtualization_instance_i_d: ?*const Guid,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "projectedfslib" fn PrjWritePlaceholderInfo(
    ...
    placeholder_info: ?*const PRJ_PLACEHOLDER_INFO,
    placeholder_info_size: u32,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "projectedfslib" fn PrjWritePlaceholderInfo2(
    ...
    placeholder_info: ?*const PRJ_PLACEHOLDER_INFO,
    placeholder_info_size: u32,
    extended_info: ?*const PRJ_EXTENDED_INFO,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "projectedfslib" fn PrjCompleteCommand(
    namespace_virtualization_context: PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT,
    command_id: i32,
    completion_result: HRESULT,
    extended_parameters: ?*PRJ_COMPLETE_COMMAND_EXTENDED_PARAMETERS,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "projectedfslib" fn PrjFillDirEntryBuffer2(
    ...
    file_name: ?[*:0]const u16,
    file_basic_info: ?*PRJ_FILE_BASIC_INFO,
    extended_info: ?*PRJ_EXTENDED_INFO,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows10.0.17763'
pub extern "projectedfslib" fn PrjFileNameMatch(
    file_name_to_check: ?[*:0]const u16,
    pattern: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;

// TODO: this type is limited to platform 'windows10.0.17763'
pub extern "projectedfslib" fn PrjFileNameCompare(
    file_name1: ?[*:0]const u16,
    file_name2: ?[*:0]const u16,
