...
pub const JET_PFNDURABLECOMMITCALLBACK = *const fn (
    ...
    p_commit_id_seen: ?*JET_COMMIT_ID,
    grbit: u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "esent" fn JetInit3A(
    pinstance: ?*JET_INSTANCE,
    prst_info: ?*JET_RSTINFO_A,
    grbit: u32,
) callconv(@import("std").os.windows.WINAPI) i32;

pub extern "esent" fn JetInit3W(
    pinstance: ?*JET_INSTANCE,
    prst_info: ?*JET_RSTINFO_W,
    grbit: u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "esent" fn JetCommitTransaction2(
    sesid: ?JET_SESID,
    grbit: u32,
    cmsec_durable_commit: u32,
    p_commit_id: ?*JET_COMMIT_ID,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "esent" fn JetEnumerateColumns(
    sesid: ?JET_SESID,
    tableid: JET_TABLEID,
    c_enum_column_id: u32,
    rg_enum_column_id: ?[*]JET_ENUMCOLUMNID,
    pc_enum_column: ?*u32,
    prg_enum_column: ?*?*JET_ENUMCOLUMN,
    pfn_realloc: ?JET_PFNREALLOC,
    pv_realloc_context: ?*anyopaque,
    cb_data_most: u32,
    grbit: u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "esent" fn JetSetCursorFilter(
    sesid: ?JET_SESID,
    tableid: JET_TABLEID,
    rg_column_filters: [*]JET_INDEX_COLUMN,
    c_column_filters: u32,
    grbit: u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "esent" fn JetPrereadKeys(
    sesid: ?JET_SESID,
    tableid: JET_TABLEID,
    rgpv_keys: [*]const ?*const anyopaque,
    rgcb_keys: [*]const u32,
    ckeys: i32,
    pckeys_preread: ?*i32,
    grbit: u32,
...
pub extern "esent" fn JetPrereadIndexRanges(
    sesid: ?JET_SESID,
    tableid: JET_TABLEID,
    rg_index_ranges: [*]const JET_INDEX_RANGE,
    c_index_ranges: u32,
    pc_ranges_preread: ?*u32,
    rgcolumnid_preread: [*]const u32,
    ccolumnid_preread: u32,
    grbit: u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "esent" fn JetGetSecondaryIndexBookmark(
    ...
    tableid: JET_TABLEID,
    // TODO: what to do with BytesParamIndex 3?
    pv_secondary_key: ?*anyopaque,
    cb_secondary_key_max: u32,
    pcb_secondary_key_actual: ?*u32,
    // TODO: what to do with BytesParamIndex 6?
    pv_primary_bookmark: ?*anyopaque,
    cb_primary_bookmark_max: u32,
    pcb_primary_bookmark_actual: ?*u32,
    grbit: u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "esent" fn JetGotoSecondaryIndexBookmark(
    ...
    // TODO: what to do with BytesParamIndex 3?
    pv_secondary_key: ?*anyopaque,
    cb_secondary_key: u32,
    // TODO: what to do with BytesParamIndex 5?
    pv_primary_bookmark: ?*anyopaque,
    cb_primary_bookmark: u32,
    grbit: u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "esent" fn JetOpenFileA(
    sz_file_name: ?*i8,
    phf_file: ?*JET_HANDLE,
    pul_file_size_low: ?*u32,
    pul_file_size_high: ?*u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "esent" fn JetExternalRestoreA(
    sz_checkpoint_file_path: ?*i8,
    sz_log_path: ?*i8,
    rgrstmap: ?[*]JET_RSTMAP_A,
    crstfilemap: i32,
    sz_backup_log_path: ?*i8,
    gen_low: i32,
    gen_high: i32,
    pfn: ?JET_PFNSTATUS,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "esent" fn JetExternalRestoreW(
    sz_checkpoint_file_path: ?*u16,
    sz_log_path: ?*u16,
    rgrstmap: ?[*]JET_RSTMAP_W,
    crstfilemap: i32,
    sz_backup_log_path: ?*u16,
    gen_low: i32,
    gen_high: i32,
    pfn: ?JET_PFNSTATUS,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "esent" fn JetExternalRestore2A(
    ...
    sz_backup_log_path: ?*i8,
    p_log_info: ?*JET_LOGINFO_A,
    sz_target_instance_name: ?*i8,
    sz_target_instance_log_path: ?*i8,
    sz_target_instance_checkpoint_path: ?*i8,
    pfn: ?JET_PFNSTATUS,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "esent" fn JetExternalRestore2W(
    ...
    sz_backup_log_path: ?*u16,
    p_log_info: ?*JET_LOGINFO_W,
    sz_target_instance_name: ?*u16,
    sz_target_instance_log_path: ?*u16,
    sz_target_instance_checkpoint_path: ?*u16,
    pfn: ?JET_PFNSTATUS,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "esent" fn JetRegisterCallback(
    ...
    tableid: JET_TABLEID,
    cbtyp: u32,
    p_callback: ?JET_CALLBACK,
    pv_context: ?*anyopaque,
    ph_callback_id: ?*JET_HANDLE,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "esent" fn JetUnregisterCallback(
    ...
    tableid: JET_TABLEID,
    cbtyp: u32,
    h_callback_id: JET_HANDLE,
) callconv(@import("std").os.windows.WINAPI) i32;

pub extern "esent" fn JetGetInstanceInfoA(
    pc_instance_info: ?*u32,
    pa_instance_info: ?*?*JET_INSTANCE_INFO_A,
) callconv(@import("std").os.windows.WINAPI) i32;

pub extern "esent" fn JetGetInstanceInfoW(
    pc_instance_info: ?*u32,
    pa_instance_info: ?*?*JET_INSTANCE_INFO_W,
) callconv(@import("std").os.windows.WINAPI) i32;
