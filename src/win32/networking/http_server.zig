...
pub extern "httpapi" fn HttpSetRequestQueueProperty(
    ...
    property_information: ?*anyopaque,
    property_information_length: u32,
    reserved1: u32,
    reserved2: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "httpapi" fn HttpSetRequestProperty(
    request_queue_handle: ?HANDLE,
    id: u64,
    property_id: HTTP_REQUEST_PROPERTY,
    // TODO: what to do with BytesParamIndex 4?
    input: ?*anyopaque,
    input_property_size: u32,
...
pub extern "httpapi" fn HttpReceiveClientCertificate(
    ...
    flags: u32,
    // TODO: what to do with BytesParamIndex 4?
    ssl_client_cert_info: ?*HTTP_SSL_CLIENT_CERT_INFO,
    ssl_client_cert_info_size: u32,
    bytes_received: ?*u32,
    overlapped: ?*OVERLAPPED,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "httpapi" fn HttpAddUrl(
    request_queue_handle: ?HANDLE,
    fully_qualified_url: ?[*:0]const u16,
    reserved: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "httpapi" fn HttpAddUrlToUrlGroup(
    url_group_id: u64,
    p_fully_qualified_url: ?[*:0]const u16,
    url_context: u64,
    reserved: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "httpapi" fn HttpReceiveHttpRequest(
    ...
    // TODO: what to do with BytesParamIndex 4?
    request_buffer: ?*HTTP_REQUEST_V2,
    request_buffer_length: u32,
    bytes_returned: ?*u32,
    overlapped: ?*OVERLAPPED,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "httpapi" fn HttpReceiveRequestEntityBody(
    ...
    flags: u32,
    // TODO: what to do with BytesParamIndex 4?
    entity_buffer: ?*anyopaque,
    entity_buffer_length: u32,
    bytes_returned: ?*u32,
    overlapped: ?*OVERLAPPED,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "httpapi" fn HttpSendHttpResponse(
    ...
    cache_policy: ?*HTTP_CACHE_POLICY,
    bytes_sent: ?*u32,
    reserved1: ?*anyopaque,
    reserved2: u32,
    overlapped: ?*OVERLAPPED,
    log_data: ?*HTTP_LOG_DATA,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "httpapi" fn HttpIsFeatureSupported(
    feature_id: HTTP_FEATURE_ID,
) callconv(@import("std").os.windows.WINAPI) BOOL;

pub extern "httpapi" fn HttpDelegateRequestEx(
    request_queue_handle: ?HANDLE,
    delegate_queue_handle: ?HANDLE,
    request_id: u64,
    delegate_url_group_id: u64,
    property_info_set_size: u32,
    property_info_set: ?*HTTP_DELEGATE_REQUEST_PROPERTY_INFO,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "httpapi" fn HttpSetServiceConfiguration(
    ...
    config_id: HTTP_SERVICE_CONFIG_ID,
    // TODO: what to do with BytesParamIndex 3?
    p_config_information: ?*anyopaque,
    config_information_length: u32,
...
pub extern "httpapi" fn HttpUpdateServiceConfiguration(
    ...
    config_id: HTTP_SERVICE_CONFIG_ID,
    // TODO: what to do with BytesParamIndex 3?
    config_info: ?*anyopaque,
    config_info_length: u32,
    overlapped: ?*OVERLAPPED,
) callconv(@import("std").os.windows.WINAPI) u32;
