...
pub const LPCONDITIONPROC = *const fn (
    lp_caller_id: ?*WSABUF,
    lp_caller_data: ?*WSABUF,
    lp_s_q_o_s: ?*QOS,
    lp_g_q_o_s: ?*QOS,
    lp_callee_id: ?*WSABUF,
    lp_callee_data: ?*WSABUF,
    g: ?*u32,
...
pub const LPFN_TRANSMITFILE = *const fn (
    ...
    lp_overlapped: ?*OVERLAPPED,
    lp_transmit_buffers: ?*TRANSMIT_FILE_BUFFERS,
    dw_reserved: u32,
...
pub const LPFN_GETACCEPTEXSOCKADDRS = *const fn (
    ...
    local_sockaddr_length: ?*i32,
    remote_sockaddr: ?*?*SOCKADDR,
    remote_sockaddr_length: ?*i32,
) callconv(@import("std").os.windows.WINAPI) void;
...
pub const LPFN_TRANSMITPACKETS = *const fn (
    h_socket: ?SOCKET,
    lp_packet_array: ?*TRANSMIT_PACKETS_ELEMENT,
    n_element_count: u32,
    n_send_size: u32,
    lp_overlapped: ?*OVERLAPPED,
    dw_flags: u32,
...
pub const LPFN_WSARECVMSG = *const fn (
    s: ?SOCKET,
    lp_msg: ?*WSAMSG,
    lpdw_number_of_bytes_recvd: ?*u32,
    lp_overlapped: ?*OVERLAPPED,
...
pub const LPFN_RIORECEIVEEX = *const fn (
    ...
    p_data: [*]RIO_BUF,
    data_buffer_count: u32,
    p_local_address: ?*RIO_BUF,
    p_remote_address: ?*RIO_BUF,
    p_control_context: ?*RIO_BUF,
    p_flags: ?*RIO_BUF,
    flags: u32,
    request_context: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub const LPFN_RIOCREATECOMPLETIONQUEUE = *const fn (
    queue_size: u32,
    notification_completion: ?*RIO_NOTIFICATION_COMPLETION,
...
pub const LPWSPADDRESSTOSTRING = *const fn (
    ...
    lpsa_address: ?*SOCKADDR,
    dw_address_length: u32,
    lp_protocol_info: ?*WSAPROTOCOL_INFOW,
    lpsz_address_string: [*:0]u16,
    lpdw_address_string_length: ?*u32,
    lp_errno: ?*i32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub const LPWSPENUMNETWORKEVENTS = *const fn (
    s: ?SOCKET,
    h_event_object: ?HANDLE,
    lp_network_events: ?*WSANETWORKEVENTS,
    lp_errno: ?*i32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub const LPWSPIOCTL = *const fn (
    ...
    lpv_out_buffer: ?*anyopaque,
    cb_out_buffer: u32,
    lpcb_bytes_returned: ?*u32,
    lp_overlapped: ?*OVERLAPPED,
    lp_completion_routine: ?LPWSAOVERLAPPED_COMPLETION_ROUTINE,
    lp_thread_id: ?*WSATHREADID,
    lp_errno: ?*i32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub const LPWSPRECVDISCONNECT = *const fn (
    s: ?SOCKET,
    lp_inbound_disconnect_data: ?*WSABUF,
    lp_errno: ?*i32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub const LPWSPSENDDISCONNECT = *const fn (
    s: ?SOCKET,
    lp_outbound_disconnect_data: ?*WSABUF,
    lp_errno: ?*i32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub const LPWPUGETPROVIDERPATH = *const fn (
    lp_provider_id: ?*Guid,
    lpsz_provider_dll_path: [*:0]u16,
    lp_provider_dll_path_len: ?*i32,
    lp_errno: ?*i32,
) callconv(@import("std").os.windows.WINAPI) i32;

pub const LPWPUMODIFYIFSHANDLE = *const fn (
    dw_catalog_entry_id: u32,
    proposed_handle: ?SOCKET,
    lp_errno: ?*i32,
) callconv(@import("std").os.windows.WINAPI) ?SOCKET;
...
pub const LPWPUQUERYBLOCKINGCALLBACK = *const fn (
    dw_catalog_entry_id: u32,
    lplpfn_callback: ?*?LPBLOCKINGCALLBACK,
    lpdw_context: ?*usize,
    lp_errno: ?*i32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub const LPWSPSTARTUP = *const fn (
    ...
    lp_w_s_p_data: ?*WSPData,
    lp_protocol_info: ?*WSAPROTOCOL_INFOW,
    upcall_table: WSPUPCALLTABLE,
    lp_proc_table: ?*WSPPROC_TABLE,
) callconv(@import("std").os.windows.WINAPI) i32;

pub const LPWSCENUMPROTOCOLS = *const fn (
    lpi_protocols: ?*i32,
    // TODO: what to do with BytesParamIndex 2?
    lp_protocol_buffer: ?*WSAPROTOCOL_INFOW,
...
pub const LPWSCINSTALLPROVIDER = *const fn (
    lp_provider_id: ?*Guid,
    lpsz_provider_dll_path: ?[*:0]const u16,
    lp_protocol_info_list: [*]const WSAPROTOCOL_INFOW,
...
pub const LPWSCINSTALLNAMESPACE = *const fn (
    lpsz_identifier: ?PWSTR,
    lpsz_path_name: ?PWSTR,
    dw_name_space: u32,
    dw_version: u32,
    lp_provider_id: ?*Guid,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub const LPNSPLOOKUPSERVICEBEGIN = *const fn (
    lp_provider_id: ?*Guid,
    lpqs_restrictions: ?*WSAQUERYSETW,
    lp_service_class_info: ?*WSASERVICECLASSINFOW,
...
pub const LPNSPSETSERVICE = *const fn (
    lp_provider_id: ?*Guid,
    lp_service_class_info: ?*WSASERVICECLASSINFOW,
    lpqs_reg_info: ?*WSAQUERYSETW,
    ess_operation: WSAESETSERVICEOP,
    dw_control_flags: u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub const LPNSPSTARTUP = *const fn (
    lp_provider_id: ?*Guid,
    lpnsp_routines: ?*NSP_ROUTINE,
) callconv(@import("std").os.windows.WINAPI) i32;

pub const LPNSPV2STARTUP = *const fn (
    lp_provider_id: ?*Guid,
    ppv_client_session_arg: ?*?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) i32;

pub const LPNSPV2CLEANUP = *const fn (
    lp_provider_id: ?*Guid,
    pv_client_session_arg: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) i32;

pub const LPNSPV2LOOKUPSERVICEBEGIN = *const fn (
    lp_provider_id: ?*Guid,
    lpqs_restrictions: ?*WSAQUERYSET2W,
    dw_control_flags: u32,
    lpv_client_session_arg: ?*anyopaque,
    lph_lookup: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub const LPFN_NSPAPI = *const fn () callconv(@import("std").os.windows.WINAPI) u32;

pub const LPSERVICE_CALLBACK_PROC = *const fn (
    l_param: LPARAM,
    h_async_task_handle: ?HANDLE,
) callconv(@import("std").os.windows.WINAPI) void;
...
pub extern "ws2_32" fn WSADuplicateSocketA(
    s: ?SOCKET,
    dw_process_id: u32,
    lp_protocol_info: ?*WSAPROTOCOL_INFOA,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "ws2_32" fn WSAEnumProtocolsA(
    lpi_protocols: ?*i32,
    // TODO: what to do with BytesParamIndex 2?
    lp_protocol_buffer: ?*WSAPROTOCOL_INFOA,
    lpdw_buffer_length: ?*u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "ws2_32" fn WSALookupServiceBeginA(
    lpqs_restrictions: ?*WSAQUERYSETA,
    dw_control_flags: u32,
    lph_lookup: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "ws2_32" fn WSAInstallServiceClassA(
    lp_service_class_info: ?*WSASERVICECLASSINFOA,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "ws2_32" fn WSAEnumNameSpaceProvidersA(
    ...
    lpnsp_buffer: ?*WSANAMESPACE_INFOA,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "ws2_32" fn WSAEnumNameSpaceProvidersW(
    lpdw_buffer_length: ?*u32,
    // TODO: what to do with BytesParamIndex 0?
    lpnsp_buffer: ?*WSANAMESPACE_INFOW,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "ws2_32" fn WSAEnumNameSpaceProvidersExA(
    lpdw_buffer_length: ?*u32,
    // TODO: what to do with BytesParamIndex 0?
    lpnsp_buffer: ?*WSANAMESPACE_INFOEXA,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "ws2_32" fn WSAEnumNameSpaceProvidersExW(
    lpdw_buffer_length: ?*u32,
    // TODO: what to do with BytesParamIndex 0?
    lpnsp_buffer: ?*WSANAMESPACE_INFOEXW,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "ws2_32" fn ProcessSocketNotifications(
    ...
    registration_infos: ?[*]SOCK_NOTIFY_REGISTRATION,
    timeout_ms: u32,
    completion_count: u32,
    completion_port_entries: ?[*]OVERLAPPED_ENTRY,
    received_entry_count: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "ws2_32" fn WSCGetApplicationCategory(
    ...
    extra: ?[*:0]const u16,
    extra_length: u32,
    p_permitted_lsp_categories: ?*u32,
    lp_errno: ?*i32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub usingnamespace switch (@import("../zig.zig").arch) {
    .X64, .Arm64 => struct {
        ...
        pub extern "ws2_32" fn WSCInstallProviderAndChains64_32(
            lp_provider_id: ?*Guid,
            lpsz_provider_dll_path: ?[*:0]const u16,
            lpsz_provider_dll_path32: ?[*:0]const u16,
            lpsz_lsp_name: ?[*:0]const u16,
            dw_service_flags: u32,
            lp_protocol_info_list: [*]WSAPROTOCOL_INFOW,
            dw_number_of_entries: u32,
            lpdw_catalog_entry_id: ?*u32,
            lp_errno: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) i32;
    },
    else => struct {},
...
pub extern "ws2_32" fn WSAAdvertiseProvider(
    puuid_provider_id: ?*const Guid,
    p_n_s_pv2_routine: ?*const NSPV2_ROUTINE,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "mswsock" fn GetAddressByNameA(
    ...
    lpi_protocols: ?*i32,
    dw_resolution: u32,
    lp_service_async_info: ?*SERVICE_ASYNC_INFO,
    // TODO: what to do with BytesParamIndex 7?
    lp_csaddr_buffer: ?*anyopaque,
    lpdw_buffer_length: ?*u32,
    lp_alias_buffer: ?[*:0]u8,
    lpdw_alias_buffer_length: ?*u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "mswsock" fn SetServiceA(
    ...
    dw_flags: u32,
    lp_service_info: ?*SERVICE_INFOA,
    lp_service_async_info: ?*SERVICE_ASYNC_INFO,
    lpdw_status_flags: ?*u32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "ws2_32" fn getaddrinfo(
    p_node_name: ?[*:0]const u8,
    p_service_name: ?[*:0]const u8,
    p_hints: ?*const ADDRINFOA,
    pp_result: ?*?*ADDRINFOA,
) callconv(@import("std").os.windows.WINAPI) i32;

// TODO: this type is limited to platform 'windows8.1'
pub extern "ws2_32" fn GetAddrInfoW(
    p_node_name: ?[*:0]const u16,
    p_service_name: ?[*:0]const u16,
...
pub extern "ws2_32" fn inet_pton(
    family: i32,
    psz_addr_string: ?[*:0]const u8,
    p_addr_buf: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) i32;

// TODO: this type is limited to platform 'windows8.1'
pub extern "ws2_32" fn InetPtonW(
    family: i32,
    psz_addr_string: ?[*:0]const u16,
    p_addr_buf: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "ws2_32" fn inet_ntop(
    family: i32,
    p_addr: ?*const anyopaque,
    p_string_buf: [*:0]u8,
    string_buf_size: usize,
) callconv(@import("std").os.windows.WINAPI) ?PSTR;
...
pub extern "fwpuclnt" fn WSASetSocketSecurity(
    socket: ?SOCKET,
    // TODO: what to do with BytesParamIndex 2?
    security_settings: ?*const SOCKET_SECURITY_SETTINGS,
...
pub extern "fwpuclnt" fn WSAQuerySocketSecurity(
    socket: ?SOCKET,
    // TODO: what to do with BytesParamIndex 2?
    security_query_template: ?*const SOCKET_SECURITY_QUERY_TEMPLATE,
    security_query_template_len: u32,
    // TODO: what to do with BytesParamIndex 4?
    security_query_info: ?*SOCKET_SECURITY_QUERY_INFO,
    security_query_info_len: ?*u32,
    overlapped: ?*OVERLAPPED,
    completion_routine: ?LPWSAOVERLAPPED_COMPLETION_ROUTINE,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "fwpuclnt" fn WSASetSocketPeerTargetName(
    socket: ?SOCKET,
    // TODO: what to do with BytesParamIndex 2?
    peer_target_name: ?*const SOCKET_PEER_TARGET_NAME,
