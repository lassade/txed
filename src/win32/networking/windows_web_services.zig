...
pub const WS_READ_CALLBACK = *const fn (
    ...
    max_size: u32,
    actual_size: ?*u32,
    async_context: ?*const WS_ASYNC_CONTEXT,
    @"error": ?*WS_ERROR,
...
pub const WS_PUSH_BYTES_CALLBACK = *const fn (
    ...
    write_callback_state: ?*anyopaque,
    async_context: ?*const WS_ASYNC_CONTEXT,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub const WS_ASYNC_CALLBACK = *const fn (
    error_code: HRESULT,
    callback_model: WS_CALLBACK_MODEL,
    callback_state: ?*anyopaque,
...
pub const WS_CREATE_CHANNEL_CALLBACK = *const fn (
    ...
    // TODO: what to do with BytesParamIndex 2?
    channel_parameters: ?*const anyopaque,
    channel_parameters_size: u32,
    channel_instance: ?*?*anyopaque,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub const WS_OPEN_CHANNEL_CALLBACK = *const fn (
    channel_instance: ?*anyopaque,
    endpoint_address: ?*const WS_ENDPOINT_ADDRESS,
    async_context: ?*const WS_ASYNC_CONTEXT,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub const WS_CREATE_ENCODER_CALLBACK = *const fn (
    ...
    encoder_context: ?*?*anyopaque,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub const WS_ENCODER_GET_CONTENT_TYPE_CALLBACK = *const fn (
    encoder_context: ?*anyopaque,
    content_type: ?*const WS_STRING,
    new_content_type: ?*WS_STRING,
    content_encoding: ?*WS_STRING,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub const WS_DECODER_GET_CONTENT_TYPE_CALLBACK = *const fn (
    decoder_context: ?*anyopaque,
    content_type: ?*const WS_STRING,
    content_encoding: ?*const WS_STRING,
    new_content_type: ?*WS_STRING,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub const WS_HTTP_REDIRECT_CALLBACK = *const fn (
    state: ?*anyopaque,
    original_url: ?*const WS_STRING,
    new_url: ?*const WS_STRING,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub const WS_CREATE_LISTENER_CALLBACK = *const fn (
    channel_type: WS_CHANNEL_TYPE,
    // TODO: what to do with BytesParamIndex 2?
    listener_parameters: ?*const anyopaque,
    listener_parameters_size: u32,
    listener_instance: ?*?*anyopaque,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub const WS_GET_CERT_CALLBACK = *const fn (
    get_cert_callback_state: ?*anyopaque,
    target_address: ?*const WS_ENDPOINT_ADDRESS,
    via_uri: ?*const WS_STRING,
    cert: ?*const ?*CERT_CONTEXT,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub const WS_CERT_ISSUER_LIST_NOTIFICATION_CALLBACK = *const fn (
    cert_issuer_list_notification_callback_state: ?*anyopaque,
    issuer_list: ?*const SecPkgContext_IssuerListInfoEx,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub const WS_VALIDATE_PASSWORD_CALLBACK = *const fn (
    password_validator_callback_state: ?*anyopaque,
...
pub const WS_VALIDATE_SAML_CALLBACK = *const fn (
    saml_validator_callback_state: ?*anyopaque,
    saml_assertion: ?*WS_XML_BUFFER,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub const WS_READ_TYPE_CALLBACK = *const fn (
    ...
    type_mapping: WS_TYPE_MAPPING,
    description_data: ?*const anyopaque,
    heap: ?*WS_HEAP,
...
pub const IContentPrefetcherTaskTrigger = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn triggerContentPrefetcherTask(self: *const T, package_full_name_: ?[*:0]const u16) HRESULT {
                return @as(*const IContentPrefetcherTaskTrigger.VTable, @ptrCast(self.vtable)).TriggerContentPrefetcherTask(@as(*const IContentPrefetcherTaskTrigger, @ptrCast(self)), package_full_name_);
            }
            pub inline fn isRegisteredForContentPrefetch(self: *const T, package_full_name_: ?[*:0]const u16, is_registered_: ?*u8) HRESULT {
                return @as(*const IContentPrefetcherTaskTrigger.VTable, @ptrCast(self.vtable)).IsRegisteredForContentPrefetch(@as(*const IContentPrefetcherTaskTrigger, @ptrCast(self)), package_full_name_, is_registered_);
            }
        };
    }
...
pub extern "webservices" fn WsRemoveNode(
    node_position: ?*const WS_XML_NODE_POSITION,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "webservices" fn WsReadToStartElement(
    reader: ?*WS_XML_READER,
    local_name: ?*const WS_XML_STRING,
...
pub extern "webservices" fn WsGetReaderPosition(
    reader: ?*WS_XML_READER,
    node_position: ?*WS_XML_NODE_POSITION,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "webservices" fn WsVerifyXmlNCName(
    nc_name_chars: [*:0]const u16,
    nc_name_char_count: u32,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "webservices" fn WsCreateChannel(
    ...
    property_count: u32,
    security_description: ?*const WS_SECURITY_DESCRIPTION,
    channel: ?*?*WS_CHANNEL,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "webservices" fn WsSendMessage(
    channel: ?*WS_CHANNEL,
    message: ?*WS_MESSAGE,
    message_description: ?*const WS_MESSAGE_DESCRIPTION,
    write_option: WS_WRITE_OPTION,
    // TODO: what to do with BytesParamIndex 5?
    body_value: ?*const anyopaque,
    body_value_size: u32,
    async_context: ?*const WS_ASYNC_CONTEXT,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "webservices" fn WsReceiveMessage(
    channel: ?*WS_CHANNEL,
    message: ?*WS_MESSAGE,
    message_descriptions: [*]const ?*const WS_MESSAGE_DESCRIPTION,
    message_description_count: u32,
    receive_option: WS_RECEIVE_OPTION,
    read_body_option: WS_READ_OPTION,
    heap: ?*WS_HEAP,
...
pub extern "webservices" fn WsRequestReply(
    channel: ?*WS_CHANNEL,
    request_message: ?*WS_MESSAGE,
    request_message_description: ?*const WS_MESSAGE_DESCRIPTION,
    write_option: WS_WRITE_OPTION,
    // TODO: what to do with BytesParamIndex 5?
    request_body_value: ?*const anyopaque,
    request_body_value_size: u32,
    reply_message: ?*WS_MESSAGE,
    reply_message_description: ?*const WS_MESSAGE_DESCRIPTION,
    read_option: WS_READ_OPTION,
    heap: ?*WS_HEAP,
...
pub extern "webservices" fn WsSendReplyMessage(
    ...
    write_option: WS_WRITE_OPTION,
    // TODO: what to do with BytesParamIndex 5?
    reply_body_value: ?*const anyopaque,
    reply_body_value_size: u32,
    request_message: ?*WS_MESSAGE,
    async_context: ?*const WS_ASYNC_CONTEXT,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "webservices" fn WsSendFaultMessageForError(
    channel: ?*WS_CHANNEL,
    reply_message: ?*WS_MESSAGE,
    fault_error: ?*WS_ERROR,
    fault_error_code: HRESULT,
    fault_disclosure: WS_FAULT_DISCLOSURE,
    request_message: ?*WS_MESSAGE,
    async_context: ?*const WS_ASYNC_CONTEXT,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "webservices" fn WsReadEndpointAddressExtension(
    ...
    extension_type: WS_ENDPOINT_ADDRESS_EXTENSION_TYPE,
    read_option: WS_READ_OPTION,
    heap: ?*WS_HEAP,
...
pub extern "webservices" fn WsSetFaultErrorDetail(
    @"error": ?*WS_ERROR,
    fault_detail_description: ?*const WS_FAULT_DETAIL_DESCRIPTION,
    write_option: WS_WRITE_OPTION,
    // TODO: what to do with BytesParamIndex 4?
    value: ?*const anyopaque,
    value_size: u32,
...
pub extern "webservices" fn WsGetCustomHeader(
    message: ?*WS_MESSAGE,
    custom_header_description: ?*const WS_ELEMENT_DESCRIPTION,
    repeating_option: WS_REPEATING_HEADER_OPTION,
    header_index: u32,
    read_option: WS_READ_OPTION,
    heap: ?*WS_HEAP,
...
pub extern "webservices" fn WsRemoveCustomHeader(
    message: ?*WS_MESSAGE,
    header_name: ?*const WS_XML_STRING,
    header_ns: ?*const WS_XML_STRING,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "webservices" fn WsAddCustomHeader(
    message: ?*WS_MESSAGE,
    header_description: ?*const WS_ELEMENT_DESCRIPTION,
    write_option: WS_WRITE_OPTION,
    // TODO: what to do with BytesParamIndex 4?
    value: ?*const anyopaque,
    value_size: u32,
...
pub extern "webservices" fn WsWriteBody(
    message: ?*WS_MESSAGE,
    body_description: ?*const WS_ELEMENT_DESCRIPTION,
    write_option: WS_WRITE_OPTION,
    // TODO: what to do with BytesParamIndex 4?
    value: ?*const anyopaque,
    value_size: u32,
...
pub extern "webservices" fn WsWriteEnvelopeStart(
    message: ?*WS_MESSAGE,
    writer: ?*WS_XML_WRITER,
    done_callback: ?WS_MESSAGE_DONE_CALLBACK,
    done_callback_state: ?*anyopaque,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "webservices" fn WsMarkHeaderAsUnderstood(
    message: ?*WS_MESSAGE,
    header_position: ?*const WS_XML_NODE_POSITION,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "webservices" fn WsGetSecurityTokenProperty(
    security_token: ?*WS_SECURITY_TOKEN,
...
pub extern "webservices" fn WsCreateXmlSecurityToken(
    token_xml: ?*WS_XML_BUFFER,
    token_key: ?*WS_SECURITY_KEY_HANDLE,
...
pub extern "webservices" fn WsRevokeSecurityContext(
    security_context: ?*WS_SECURITY_CONTEXT,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "webservices" fn WsReadElement(
    reader: ?*WS_XML_READER,
    element_description: ?*const WS_ELEMENT_DESCRIPTION,
    read_option: WS_READ_OPTION,
    heap: ?*WS_HEAP,
    // TODO: what to do with BytesParamIndex 5?
    value: ?*anyopaque,
...
pub extern "webservices" fn WsReadAttribute(
    reader: ?*WS_XML_READER,
    attribute_description: ?*const WS_ATTRIBUTE_DESCRIPTION,
    read_option: WS_READ_OPTION,
    heap: ?*WS_HEAP,
    // TODO: what to do with BytesParamIndex 5?
    value: ?*anyopaque,
...
pub extern "webservices" fn WsReadType(
    ...
    type_mapping: WS_TYPE_MAPPING,
    type: WS_TYPE,
    type_description: ?*const anyopaque,
    read_option: WS_READ_OPTION,
    heap: ?*WS_HEAP,
    // TODO: what to do with BytesParamIndex 7?
    value: ?*anyopaque,
...
pub extern "webservices" fn WsRegisterOperationForCancel(
    context: ?*const WS_OPERATION_CONTEXT,
    cancel_callback: ?WS_OPERATION_CANCEL_CALLBACK,
    freestate_callback: ?WS_OPERATION_FREE_STATE_CALLBACK,
...
pub extern "webservices" fn WsCreateServiceHost(
    ...
    endpoint_count: u16,
    service_properties: ?[*]const WS_SERVICE_PROPERTY,
    service_property_count: u32,
    service_host: ?*?*WS_SERVICE_HOST,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "webservices" fn WsGetServiceProxyProperty(
    service_proxy: ?*WS_SERVICE_PROXY,
    id: WS_PROXY_PROPERTY_ID,
    // TODO: what to do with BytesParamIndex 3?
    value: ?*anyopaque,
    value_size: u32,
...
pub extern "webservices" fn WsCreateServiceProxy(
    ...
    property_count: u32,
    channel_properties: ?[*]const WS_CHANNEL_PROPERTY,
    channel_property_count: u32,
    service_proxy: ?*?*WS_SERVICE_PROXY,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "webservices" fn WsCall(
    ...
    heap: ?*WS_HEAP,
    call_properties: ?[*]const WS_CALL_PROPERTY,
    call_property_count: u32,
    async_context: ?*const WS_ASYNC_CONTEXT,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "webservices" fn WsCombineUrl(
    base_url: ?*const WS_STRING,
    reference_url: ?*const WS_STRING,
    flags: u32,
    heap: ?*WS_HEAP,
    result_url: ?*WS_STRING,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

// TODO: this type is limited to platform 'windows6.1'
pub extern "webservices" fn WsDateTimeToFileTime(
    date_time: ?*const WS_DATETIME,
    file_time: ?*FILETIME,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "webservices" fn WsMatchPolicyAlternative(
    ...
    policy_constraints: ?*WS_POLICY_CONSTRAINTS,
    match_required: BOOL,
    heap: ?*WS_HEAP,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "webservices" fn WsCreateServiceProxyFromTemplate(
    ...
    properties: ?[*]const WS_PROXY_PROPERTY,
    property_count: u32,
    template_type: WS_BINDING_TEMPLATE_TYPE,
    // TODO: what to do with BytesParamIndex 5?
    template_value: ?*anyopaque,
    template_size: u32,
    template_description: ?*const anyopaque,
    template_description_size: u32,
    service_proxy: ?*?*WS_SERVICE_PROXY,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "webservices" fn WsCreateServiceEndpointFromTemplate(
    ...
    template_description: ?*const anyopaque,
    template_description_size: u32,
    service_endpoint: ?*?*WS_SERVICE_ENDPOINT,
    @"error": ?*WS_ERROR,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "webauthn" fn WebAuthNIsUserVerifyingPlatformAuthenticatorAvailable(
    pb_is_user_verifying_platform_authenticator_available: ?*BOOL,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "webauthn" fn WebAuthNAuthenticatorMakeCredential(
    h_wnd: ?HWND,
    p_rp_information: ?*WEBAUTHN_RP_ENTITY_INFORMATION,
    p_user_information: ?*WEBAUTHN_USER_ENTITY_INFORMATION,
    p_pub_key_cred_params: ?*WEBAUTHN_COSE_CREDENTIAL_PARAMETERS,
    p_web_auth_n_client_data: ?*WEBAUTHN_CLIENT_DATA,
    p_web_auth_n_make_credential_options: ?*WEBAUTHN_AUTHENTICATOR_MAKE_CREDENTIAL_OPTIONS,
    pp_web_auth_n_credential_attestation: ?*?*WEBAUTHN_CREDENTIAL_ATTESTATION,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "webauthn" fn WebAuthNAuthenticatorGetAssertion(
    h_wnd: ?HWND,
    pwsz_rp_id: ?[*:0]const u16,
    p_web_auth_n_client_data: ?*WEBAUTHN_CLIENT_DATA,
    p_web_auth_n_get_assertion_options: ?*WEBAUTHN_AUTHENTICATOR_GET_ASSERTION_OPTIONS,
    pp_web_auth_n_assertion: ?*?*WEBAUTHN_ASSERTION,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub extern "webauthn" fn WebAuthNFreeCredentialAttestation(
    p_web_auth_n_credential_attestation: ?*WEBAUTHN_CREDENTIAL_ATTESTATION,
) callconv(@import("std").os.windows.WINAPI) void;

pub extern "webauthn" fn WebAuthNFreeAssertion(
    p_web_auth_n_assertion: ?*WEBAUTHN_ASSERTION,
) callconv(@import("std").os.windows.WINAPI) void;
