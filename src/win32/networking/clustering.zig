...
pub const PCLUSAPI_SetClusterName = *const fn (
    h_cluster: ?*_HCLUSTER,
    lpsz_new_cluster_name: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const PCLUSAPI_GET_CLUSTER_INFORMATION = *const fn (
    h_cluster: ?*_HCLUSTER,
    lpsz_cluster_name: [*:0]u16,
    lpcch_cluster_name: ?*u32,
    lp_cluster_info: ?*CLUSTERVERSIONINFO,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const PCLUSAPI_GET_CLUSTER_QUORUM_RESOURCE = *const fn (
    h_cluster: ?*_HCLUSTER,
    lpsz_resource_name: [*:0]u16,
    lpcch_resource_name: ?*u32,
    lpsz_device_name: [*:0]u16,
    lpcch_device_name: ?*u32,
    lpdw_max_quorum_log_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const PCLUSAPI_SET_CLUSTER_QUORUM_RESOURCE = *const fn (
    h_resource: ?*_HRESOURCE,
    lpsz_device_name: ?[*:0]const u16,
    dw_max_quo_log_size: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PCLUSAPI_RESTORE_CLUSTER_DATABASE = *const fn (
    lpsz_path_name: ?[*:0]const u16,
    b_force: BOOL,
    lpsz_quorum_drive_letter: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const PCLUSAPI_SET_CLUSTER_NETWORK_PRIORITY_ORDER = *const fn (
    h_cluster: ?*_HCLUSTER,
    network_count: u32,
    network_list: [*]?*_HNETWORK,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const PCLUSAPI_SET_CLUSTER_SERVICE_ACCOUNT_PASSWORD = *const fn (
    lpsz_cluster_name: ?[*:0]const u16,
    lpsz_new_password: ?[*:0]const u16,
    dw_flags: u32,
    // TODO: what to do with BytesParamIndex 4?
    lp_return_status_buffer: ?*CLUSTER_SET_PASSWORD_STATUS,
    lpcb_return_status_buffer_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PCLUSTER_UPGRADE_PROGRESS_CALLBACK = *const fn (
    pv_callback_arg: ?*anyopaque,
    e_upgrade_phase: CLUSTER_UPGRADE_PHASE,
) callconv(@import("std").os.windows.WINAPI) BOOL;

pub const PCLUSAPI_CLUSTER_UPGRADE = *const fn (
    h_cluster: ?*_HCLUSTER,
    perform: BOOL,
    pfn_progress_callback: ?PCLUSTER_UPGRADE_PROGRESS_CALLBACK,
    pv_callback_arg: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PCLUSAPI_GET_NOTIFY_EVENT_HANDLE_V2 = *const fn (
    h_change: ?*_HCHANGE,
    lph_target_event: ?*?HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const PCLUSAPI_GET_CLUSTER_NOTIFY_V2 = *const fn (
    h_change: ?*_HCHANGE,
    lpdw_notify_key: ?*usize,
    p_filter_and_type: ?*NOTIFY_FILTER_AND_TYPE,
    buffer: ?*u8,
    lpcch_buffer_size: ?*u32,
    lpsz_object_id: ?PWSTR,
    lpcch_object_id: ?*u32,
    lpsz_parent_id: ?PWSTR,
    lpcch_parent_id: ?*u32,
    lpsz_name: ?PWSTR,
    lpcch_name: ?*u32,
    lpsz_type: ?PWSTR,
...
pub const PCLUSAPI_CLUSTER_GET_ENUM_COUNT_EX = *const fn (
    h_cluster_enum: ?*_HCLUSENUMEX,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const PCLUSAPI_CLUSTER_ENUM_EX = *const fn (
    h_cluster_enum: ?*_HCLUSENUMEX,
    dw_index: u32,
    p_item: ?*CLUSTER_ENUM_ITEM,
    cb_item: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PCLUSAPI_CREATE_CLUSTER_GROUP_GROUPSET = *const fn (
    h_cluster: ?*_HCLUSTER,
    lpsz_group_set_name: ?[*:0]const u16,
...
pub const PCLUSAPI_ADD_CROSS_CLUSTER_GROUPSET_DEPENDENCY = *const fn (
    h_dependent_group_set: ?*_HGROUPSET,
    lp_remote_cluster_name: ?[*:0]const u16,
    lp_remote_group_set_name: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PCLUSAPI_CREATE_CLUSTER_AVAILABILITY_SET = *const fn (
    h_cluster: ?*_HCLUSTER,
    lp_availability_set_name: ?[*:0]const u16,
    p_availability_set_config: ?*CLUSTER_AVAILABILITY_SET_CONFIG,
) callconv(@import("std").os.windows.WINAPI) ?*_HGROUPSET;

pub const PCLUSAPI_CLUSTER_CREATE_AFFINITY_RULE = *const fn (
    h_cluster: ?*_HCLUSTER,
    rule_name: ?[*:0]const u16,
...
pub const PCLUSAPI_CLUSTER_AFFINITY_RULE_CONTROL = *const fn (
    h_cluster: ?*_HCLUSTER,
    affinity_rule_name: ?[*:0]const u16,
    h_host_node: ?*_HNODE,
    dw_control_code: u32,
...
pub const PCLUSAPI_CLUSTER_RESOURCE_GET_ENUM_COUNT_EX = *const fn (
    h_resource_enum_ex: ?*_HRESENUMEX,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const PCLUSAPI_CLUSTER_RESOURCE_ENUM_EX = *const fn (
    h_resource_enum_ex: ?*_HRESENUMEX,
    dw_index: u32,
    p_item: ?*CLUSTER_RESOURCE_ENUM_ITEM,
    cb_item: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PCLUSAPI_CREATE_CLUSTER_RESOURCE = *const fn (
    h_group: ?*_HGROUP,
    lpsz_resource_name: ?[*:0]const u16,
    lpsz_resource_type: ?[*:0]const u16,
    dw_flags: u32,
...
pub const PCLUSAPI_GET_CLUSTER_RESOURCE_STATE = *const fn (
    ...
    lpsz_node_name: ?[*:0]u16,
    lpcch_node_name: ?*u32,
    lpsz_group_name: ?[*:0]u16,
    lpcch_group_name: ?*u32,
...
pub const PCLUSAPI_GET_CLUSTER_RESOURCE_DEPENDENCY_EXPRESSION = *const fn (
    h_resource: ?*_HRESOURCE,
    lpsz_dependency_expression: ?[*:0]u16,
    lpcch_dependency_expression: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PCLUSAPI_CAN_RESOURCE_BE_DEPENDENT = *const fn (
    h_resource: ?*_HRESOURCE,
    h_resource_dependent: ?*_HRESOURCE,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub const PCLUSAPI_CLUSTER_RESOURCE_TYPE_CONTROL = *const fn (
    h_cluster: ?*_HCLUSTER,
    lpsz_resource_type_name: ?[*:0]const u16,
    h_host_node: ?*_HNODE,
    dw_control_code: u32,
    // TODO: what to do with BytesParamIndex 5?
    lp_in_buffer: ?*anyopaque,
...
pub const PCLUSAPI_CREATE_CLUSTER_RESOURCE_TYPE = *const fn (
    h_cluster: ?*_HCLUSTER,
    lpsz_resource_type_name: ?[*:0]const u16,
    lpsz_display_name: ?[*:0]const u16,
    lpsz_resource_type_dll: ?[*:0]const u16,
    dw_looks_alive_poll_interval: u32,
    dw_is_alive_poll_interval: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PCLUSAPI_GET_CLUSTER_NET_INTERFACE = *const fn (
    ...
    lpsz_node_name: ?[*:0]const u16,
    lpsz_network_name: ?[*:0]const u16,
    lpsz_interface_name: ?[*:0]u16,
    lpcch_interface_name: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const PCLUSAPI_CLOSE_CLUSTER_NET_INTERFACE = *const fn (
    h_net_interface: ?*_HNETINTERFACE,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub const PCLUSAPI_CLUSTER_REG_ENUM_VALUE = *const fn (
    h_key: ?HKEY,
    dw_index: u32,
    lpsz_value_name: [*:0]u16,
    lpcch_value_name: ?*u32,
    lpdw_type: ?*u32,
    // TODO: what to do with BytesParamIndex 6?
    lp_data: ?*u8,
    lpcb_data: ?*u32,
...
pub const PCLUSAPI_CLUSTER_REG_QUERY_INFO_KEY = *const fn (
    h_key: ?HKEY,
    lpc_sub_keys: ?*u32,
    lpcb_max_sub_key_len: ?*u32,
    lpc_values: ?*u32,
    lpcb_max_value_name_len: ?*u32,
    lpcb_max_value_len: ?*u32,
...
pub const PCLUSAPI_CLUSTER_REG_CREATE_BATCH = *const fn (
    h_key: ?HKEY,
    p_h_r_e_g_b_a_t_c_h: ?*?*_HREGBATCH,
) callconv(@import("std").os.windows.WINAPI) i32;

pub const PCLUSTER_REG_BATCH_ADD_COMMAND = *const fn (
    h_reg_batch: ?*_HREGBATCH,
    dw_command: CLUSTER_REG_COMMAND,
    wz_name: ?PWSTR,
    dw_options: u32,
    // TODO: what to do with BytesParamIndex 5?
...
pub const PCLUSTER_REG_CLOSE_BATCH = *const fn (
    h_reg_batch: ?*_HREGBATCH,
    b_commit: BOOL,
    failed_command_number: ?*i32,
) callconv(@import("std").os.windows.WINAPI) i32;

pub const PCLUSTER_REG_BATCH_READ_COMMAND = *const fn (
    h_batch_notification: ?*_HREGBATCHNOTIFICATION,
    p_batch_command: ?*CLUSTER_BATCH_COMMAND,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub const PCLUSTER_REG_CREATE_BATCH_NOTIFY_PORT = *const fn (
    h_key: ?HKEY,
    ph_batch_notify_port: ?*?*_HREGBATCHPORT,
) callconv(@import("std").os.windows.WINAPI) i32;

pub const PCLUSTER_REG_CLOSE_BATCH_NOTIFY_PORT = *const fn (
    h_batch_notify_port: ?*_HREGBATCHPORT,
) callconv(@import("std").os.windows.WINAPI) i32;

pub const PCLUSTER_REG_GET_BATCH_NOTIFICATION = *const fn (
    h_batch_notify: ?*_HREGBATCHPORT,
    ph_batch_notification: ?*?*_HREGBATCHNOTIFICATION,
) callconv(@import("std").os.windows.WINAPI) i32;

pub const PCLUSTER_REG_CREATE_READ_BATCH = *const fn (
    h_key: ?HKEY,
    ph_reg_read_batch: ?*?*_HREGREADBATCH,
) callconv(@import("std").os.windows.WINAPI) i32;

pub const PCLUSTER_REG_READ_BATCH_ADD_COMMAND = *const fn (
    h_reg_read_batch: ?*_HREGREADBATCH,
    wz_subkey_name: ?[*:0]const u16,
    wz_value_name: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) i32;

pub const PCLUSTER_REG_CLOSE_READ_BATCH = *const fn (
    h_reg_read_batch: ?*_HREGREADBATCH,
    ph_reg_read_batch_reply: ?*?*_HREGREADBATCHREPLY,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub const PCLUSTER_REG_READ_BATCH_REPLY_NEXT_COMMAND = *const fn (
    h_reg_read_batch_reply: ?*_HREGREADBATCHREPLY,
    p_batch_command: ?*CLUSTER_READ_BATCH_COMMAND,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub const PCLUSTER_SETUP_PROGRESS_CALLBACK = *const fn (
    pv_callback_arg: ?*anyopaque,
    e_setup_phase: CLUSTER_SETUP_PHASE,
    e_phase_type: CLUSTER_SETUP_PHASE_TYPE,
    e_phase_severity: CLUSTER_SETUP_PHASE_SEVERITY,
    dw_percent_complete: u32,
    lpsz_object_name: ?[*:0]const u16,
    dw_status: u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;

pub const PCLUSAPI_CREATE_CLUSTER = *const fn (
    p_config: ?*CREATE_CLUSTER_CONFIG,
    pfn_progress_callback: ?PCLUSTER_SETUP_PROGRESS_CALLBACK,
    pv_callback_arg: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) ?*_HCLUSTER;
...
pub const PCLUSAPI_CREATE_CLUSTER_NAME_ACCOUNT = *const fn (
    h_cluster: ?*_HCLUSTER,
    p_config: ?*CREATE_CLUSTER_NAME_ACCOUNT,
    pfn_progress_callback: ?PCLUSTER_SETUP_PROGRESS_CALLBACK,
    pv_callback_arg: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PCLUSAPI_DESTROY_CLUSTER = *const fn (
    ...
    pfn_progress_callback: ?PCLUSTER_SETUP_PROGRESS_CALLBACK,
    pv_callback_arg: ?*anyopaque,
    fdelete_virtual_computer_objects: BOOL,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PSET_RESOURCE_STATUS_ROUTINE_EX = *const fn (
    ...
    resource_status: ?*RESOURCE_STATUS_EX,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PARBITRATE_ROUTINE = *const fn (
    resource: ?*anyopaque,
    lost_quorum_resource: ?PQUORUM_RESOURCE_LOST,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PRESOURCE_TYPE_CONTROL_ROUTINE = *const fn (
    resource_type_name: ?[*:0]const u16,
    control_code: u32,
    in_buffer: ?*anyopaque,
    in_buffer_size: u32,
    out_buffer: ?*anyopaque,
...
pub const POFFLINE_V2_ROUTINE = *const fn (
    resource: ?*anyopaque,
    destination_node_name: ?[*:0]const u16,
    offline_flags: u32,
    // TODO: what to do with BytesParamIndex 4?
    in_buffer: ?*u8,
    in_buffer_size: u32,
...
pub const PCANCEL_ROUTINE = *const fn (
    resource: ?*anyopaque,
    cancel_flags__r_e_s_e_r_v_e_d: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PSTARTUP_ROUTINE = *const fn (
    resource_type: ?[*:0]const u16,
    min_version_supported: u32,
    max_version_supported: u32,
    set_resource_status: ?PSET_RESOURCE_STATUS_ROUTINE,
    log_event: ?PLOG_EVENT_ROUTINE,
    function_table: ?*?*CLRES_FUNCTION_TABLE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PSET_RESOURCE_LOCKED_MODE_ROUTINE = *const fn (
    resource_handle: isize,
    locked_mode_enabled: BOOL,
    locked_mode_reason: u32,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const PSIGNAL_FAILURE_ROUTINE = *const fn (
    resource_handle: isize,
    failure_type: FAILURE_TYPE,
    application_specific_error_code: u32,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const PSET_RESOURCE_INMEMORY_NODELOCAL_PROPERTIES_ROUTINE = *const fn (
    resource_handle: isize,
    property_list_buffer: ?*u8,
    property_list_buffer_size: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PSET_INTERNAL_STATE = *const fn (
    param0: isize,
    state_type: CLUSTER_RESOURCE_APPLICATION_STATE,
    active: BOOL,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PSET_RESOURCE_LOCKED_MODE_EX_ROUTINE = *const fn (
    ...
    locked_mode_enabled: BOOL,
    locked_mode_reason: u32,
    locked_mode_flags: u32,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const PREQUEST_DUMP_ROUTINE = *const fn (
    resource_handle: isize,
    dump_due_to_call_in_progress: BOOL,
    dump_delay_in_ms: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PSTARTUP_EX_ROUTINE = *const fn (
    ...
    min_version_supported: u32,
    max_version_supported: u32,
    monitor_callback_functions: ?*CLRES_CALLBACK_FUNCTION_TABLE,
    resource_dll_interface_functions: ?*?*CLRES_FUNCTION_TABLE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PRESUTIL_START_RESOURCE_SERVICE = *const fn (
    psz_service_name: ?[*:0]const u16,
    ph_service_handle: ?*isize,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PRESUTIL_ENUM_PROPERTIES = *const fn (
    p_property_table: ?*const RESUTIL_PROPERTY_ITEM,
    // TODO: what to do with BytesParamIndex 2?
    psz_out_properties: ?PWSTR,
    cb_out_properties_size: u32,
    pcb_bytes_returned: ?*u32,
    pcb_required: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const PRESUTIL_ENUM_PRIVATE_PROPERTIES = *const fn (
    hkey_cluster_key: ?HKEY,
    // TODO: what to do with BytesParamIndex 2?
    psz_out_properties: ?PWSTR,
    cb_out_properties_size: u32,
    pcb_bytes_returned: ?*u32,
...
pub const PRESUTIL_GET_PROPERTIES = *const fn (
    ...
    p_property_table: ?*const RESUTIL_PROPERTY_ITEM,
    // TODO: what to do with BytesParamIndex 3?
    p_out_property_list: ?*anyopaque,
    cb_out_property_list_size: u32,
    pcb_bytes_returned: ?*u32,
    pcb_required: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PRESUTIL_GET_PROPERTY_SIZE = *const fn (
    hkey_cluster_key: ?HKEY,
    p_property_table_item: ?*const RESUTIL_PROPERTY_ITEM,
    pcb_out_property_list_size: ?*u32,
    pn_property_count: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PRESUTIL_GET_PROPERTY = *const fn (
    ...
    p_property_table_item: ?*const RESUTIL_PROPERTY_ITEM,
    // TODO: what to do with BytesParamIndex 3?
    p_out_property_item: ?*?*anyopaque,
    pcb_out_property_item_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const PRESUTIL_VERIFY_PROPERTY_TABLE = *const fn (
    p_property_table: ?*const RESUTIL_PROPERTY_ITEM,
    reserved: ?*anyopaque,
    b_allow_unknown_properties: BOOL,
    // TODO: what to do with BytesParamIndex 4?
    p_in_property_list: ?*const anyopaque,
    cb_in_property_list_size: u32,
    p_out_params: ?*u8,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PRESUTIL_GET_PROPERTIES_TO_PARAMETER_BLOCK = *const fn (
    ...
    p_property_table: ?*const RESUTIL_PROPERTY_ITEM,
    p_out_params: ?*u8,
    b_check_for_required_properties: BOOL,
    psz_name_of_prop_in_error: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PRESUTIL_SET_BINARY_VALUE = *const fn (
    ...
    psz_value_name: ?[*:0]const u16,
    // TODO: what to do with BytesParamIndex 3?
    pb_new_value: ?*const u8,
    cb_new_value_size: u32,
    // TODO: what to do with BytesParamIndex 5?
    ppb_out_value: ?*?*u8,
    pcb_out_value_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PRESUTIL_SET_SZ_VALUE = *const fn (
    hkey_cluster_key: ?HKEY,
    psz_value_name: ?[*:0]const u16,
    psz_new_value: ?[*:0]const u16,
    ppsz_out_string: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PRESUTIL_GET_BINARY_PROPERTY = *const fn (
    ppb_out_value: ?*?*u8,
    pcb_out_value_size: ?*u32,
    p_value_struct: ?*const CLUSPROP_BINARY,
    // TODO: what to do with BytesParamIndex 4?
    pb_old_value: ?*const u8,
    cb_old_value_size: u32,
    // TODO: what to do with BytesParamIndex 6?
    pp_property_list: ?*?*u8,
    pcb_property_list_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const PRESUTIL_GET_SZ_PROPERTY = *const fn (
    ppsz_out_value: ?*?PWSTR,
    p_value_struct: ?*const CLUSPROP_SZ,
    psz_old_value: ?[*:0]const u16,
    // TODO: what to do with BytesParamIndex 4?
    pp_property_list: ?*?*u8,
    pcb_property_list_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PRESUTIL_GET_DWORD_PROPERTY = *const fn (
    pdw_out_value: ?*u32,
    p_value_struct: ?*const CLUSPROP_DWORD,
    dw_old_value: u32,
    dw_minimum: u32,
    dw_maximum: u32,
    pp_property_list: ?*?*u8,
...
pub const PRESUTIL_GET_LONG_PROPERTY = *const fn (
    pl_out_value: ?*i32,
    p_value_struct: ?*const CLUSPROP_LONG,
    l_old_value: i32,
    l_minimum: i32,
    l_maximum: i32,
    pp_property_list: ?*?*u8,
...
pub const PRESUTIL_GET_FILETIME_PROPERTY = *const fn (
    pft_out_value: ?*FILETIME,
    p_value_struct: ?*const CLUSPROP_FILETIME,
    ft_old_value: FILETIME,
    ft_minimum: FILETIME,
    ft_maximum: FILETIME,
    pp_property_list: ?*?*u8,
    pcb_property_list_size: ?*u32,
...
pub const PRESUTIL_SET_RESOURCE_SERVICE_ENVIRONMENT = *const fn (
    psz_service_name: ?[*:0]const u16,
    h_resource: ?*_HRESOURCE,
    pfn_log_event: ?PLOG_EVENT_ROUTINE,
    h_resource_handle: isize,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PRESUTIL_FIND_SZ_PROPERTY = *const fn (
    // TODO: what to do with BytesParamIndex 1?
    p_property_list: ?*const anyopaque,
    cb_property_list_size: u32,
    psz_property_name: ?[*:0]const u16,
    psz_property_value: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PRESUTIL_FIND_BINARY_PROPERTY = *const fn (
    ...
    psz_property_name: ?[*:0]const u16,
    // TODO: what to do with BytesParamIndex 4?
    pb_property_value: ?*?*u8,
    pcb_property_value_size: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PWORKER_START_ROUTINE = *const fn (
    p_worker: ?*CLUS_WORKER,
    lp_thread_parameter: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const PCLUSAPI_CLUS_WORKER_CREATE = *const fn (
    lp_worker: ?*CLUS_WORKER,
    lp_start_address: ?PWORKER_START_ROUTINE,
...
pub const PRESUTIL_ENUM_RESOURCES = *const fn (
    h_self: ?*_HRESOURCE,
    lpsz_res_type_name: ?[*:0]const u16,
    p_res_call_back: ?LPRESOURCE_CALLBACK,
...
pub const PRESUTIL_ENUM_RESOURCES_EX = *const fn (
    ...
    h_self: ?*_HRESOURCE,
    lpsz_res_type_name: ?[*:0]const u16,
    p_res_call_back: ?LPRESOURCE_CALLBACK_EX,
    p_parameter: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PRESUTIL_GET_RESOURCE_DEPENDENTIP_ADDRESS_PROPS = *const fn (
    ...
    psz_address: [*:0]u16,
    pcch_address: ?*u32,
    psz_subnet_mask: [*:0]u16,
    pcch_subnet_mask: ?*u32,
    psz_network: [*:0]u16,
    pcch_network: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PRESUTIL_GET_PROPERTY_FORMATS = *const fn (
    p_property_table: ?*const RESUTIL_PROPERTY_ITEM,
    // TODO: what to do with BytesParamIndex 2?
    p_out_property_format_list: ?*anyopaque,
    cb_property_format_list_size: u32,
    pcb_bytes_returned: ?*u32,
    pcb_required: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PRESUTIL_GET_CORE_CLUSTER_RESOURCES = *const fn (
    h_cluster: ?*_HCLUSTER,
    ph_cluster_name_resource: ?*?*_HRESOURCE,
    ph_cluster_i_p_address_resource: ?*?*_HRESOURCE,
    ph_cluster_quorum_resource: ?*?*_HRESOURCE,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const PRESUTIL_GET_RESOURCE_NAME = *const fn (
    h_resource: ?*_HRESOURCE,
    psz_resource_name: [*:0]u16,
    pcch_resource_name_in_out: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PCLUSTER_PREPARE_SHARED_VOLUME_FOR_BACKUP = *const fn (
    lpsz_file_name: ?[*:0]const u16,
    lpsz_volume_path_name: ?PWSTR,
    lpcch_volume_path_name: ?*u32,
    lpsz_volume_name: ?PWSTR,
    lpcch_volume_name: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const PCLUSTER_CLEAR_BACKUP_STATE_FOR_SHARED_VOLUME = *const fn (
    lpsz_volume_path_name: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PRESUTIL_GET_CORE_CLUSTER_RESOURCES_EX = *const fn (
    h_cluster_in: ?*_HCLUSTER,
    ph_cluster_name_resource_out: ?*?*_HRESOURCE,
    ph_cluster_i_p_address_resource_out: ?*?*_HRESOURCE,
    ph_cluster_quorum_resource_out: ?*?*_HRESOURCE,
    dw_desired_access: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PCLOSE_CLUSTER_CRYPT_PROVIDER = *const fn (
    h_clus_crypt_provider: ?*_HCLUSCRYPTPROVIDER,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PCLUSTER_DECRYPT = *const fn (
    ...
    cb_crypt_input: u32,
    pp_crypt_output: ?*?*u8,
    pcb_crypt_output: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const PFREE_CLUSTER_CRYPT = *const fn (
    p_crypt_info: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PREGISTER_APPINSTANCE = *const fn (
    ...
    children_inherit_app_instance: BOOL,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const PREGISTER_APPINSTANCE_VERSION = *const fn (
    app_instance_id: ?*Guid,
    instance_version_high: u64,
    instance_version_low: u64,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const PQUERY_APPINSTANCE_VERSION = *const fn (
    ...
    instance_version_high: ?*u64,
    instance_version_low: ?*u64,
    version_status: ?*NTSTATUS,
) callconv(@import("std").os.windows.WINAPI) u32;

pub const PRESET_ALL_APPINSTANCE_VERSIONS = *const fn () callconv(@import("std").os.windows.WINAPI) u32;
...
pub const IGetClusterUIInfo = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getClusterName(self: *const T, lpsz_name_: ?BSTR, pcch_name_: ?*i32) HRESULT {
                return @as(*const IGetClusterUIInfo.VTable, @ptrCast(self.vtable)).GetClusterName(@as(*const IGetClusterUIInfo, @ptrCast(self)), lpsz_name_, pcch_name_);
            }
            pub inline fn getLocale(self: *const T) u32 {
                return @as(*const IGetClusterUIInfo.VTable, @ptrCast(self.vtable)).GetLocale(@as(*const IGetClusterUIInfo, @ptrCast(self)));
            }
            pub inline fn getFont(self: *const T) ?HFONT {
                return @as(*const IGetClusterUIInfo.VTable, @ptrCast(self.vtable)).GetFont(@as(*const IGetClusterUIInfo, @ptrCast(self)));
            }
            pub inline fn getIcon(self: *const T) ?HICON {
...
pub const IGetClusterDataInfo = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getClusterName(self: *const T, lpsz_name_: ?BSTR, pcch_name_: ?*i32) HRESULT {
                return @as(*const IGetClusterDataInfo.VTable, @ptrCast(self.vtable)).GetClusterName(@as(*const IGetClusterDataInfo, @ptrCast(self)), lpsz_name_, pcch_name_);
            }
            pub inline fn getClusterHandle(self: *const T) ?*_HCLUSTER {
...
pub const IGetClusterObjectInfo = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getObjectName(self: *const T, l_obj_index_: i32, lpsz_name_: ?BSTR, pcch_name_: ?*i32) HRESULT {
                return @as(*const IGetClusterObjectInfo.VTable, @ptrCast(self.vtable)).GetObjectName(@as(*const IGetClusterObjectInfo, @ptrCast(self)), l_obj_index_, lpsz_name_, pcch_name_);
            }
            pub inline fn getObjectType(self: *const T, l_obj_index_: i32) CLUADMEX_OBJECT_TYPE {
                return @as(*const IGetClusterObjectInfo.VTable, @ptrCast(self.vtable)).GetObjectType(@as(*const IGetClusterObjectInfo, @ptrCast(self)), l_obj_index_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IGetClusterNodeInfo = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getNodeHandle(self: *const T, l_obj_index_: i32) ?*_HNODE {
                return @as(*const IGetClusterNodeInfo.VTable, @ptrCast(self.vtable)).GetNodeHandle(@as(*const IGetClusterNodeInfo, @ptrCast(self)), l_obj_index_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IGetClusterGroupInfo = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getGroupHandle(self: *const T, l_obj_index_: i32) ?*_HGROUP {
                return @as(*const IGetClusterGroupInfo.VTable, @ptrCast(self.vtable)).GetGroupHandle(@as(*const IGetClusterGroupInfo, @ptrCast(self)), l_obj_index_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IGetClusterResourceInfo = extern struct {
    pub const VTable = extern struct {
        ...
        GetResourceTypeName: *const fn (
            self: *const IGetClusterResourceInfo,
            l_obj_index: i32,
            lpsz_res_type_name: ?BSTR,
            pcch_res_type_name: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getResourceHandle(self: *const T, l_obj_index_: i32) ?*_HRESOURCE {
                return @as(*const IGetClusterResourceInfo.VTable, @ptrCast(self.vtable)).GetResourceHandle(@as(*const IGetClusterResourceInfo, @ptrCast(self)), l_obj_index_);
            }
            pub inline fn getResourceTypeName(self: *const T, l_obj_index_: i32, lpsz_res_type_name_: ?BSTR, pcch_res_type_name_: ?*i32) HRESULT {
                return @as(*const IGetClusterResourceInfo.VTable, @ptrCast(self.vtable)).GetResourceTypeName(@as(*const IGetClusterResourceInfo, @ptrCast(self)), l_obj_index_, lpsz_res_type_name_, pcch_res_type_name_);
            }
            pub inline fn getResourceNetworkName(self: *const T, l_obj_index_: i32, lpsz_net_name_: ?BSTR, pcch_net_name_: ?*u32) BOOL {
                return @as(*const IGetClusterResourceInfo.VTable, @ptrCast(self.vtable)).GetResourceNetworkName(@as(*const IGetClusterResourceInfo, @ptrCast(self)), l_obj_index_, lpsz_net_name_, pcch_net_name_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IGetClusterNetworkInfo = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getNetworkHandle(self: *const T, l_obj_index_: i32) ?*_HNETWORK {
                return @as(*const IGetClusterNetworkInfo.VTable, @ptrCast(self.vtable)).GetNetworkHandle(@as(*const IGetClusterNetworkInfo, @ptrCast(self)), l_obj_index_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IGetClusterNetInterfaceInfo = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn getNetInterfaceHandle(self: *const T, l_obj_index_: i32) ?*_HNETINTERFACE {
                return @as(*const IGetClusterNetInterfaceInfo.VTable, @ptrCast(self.vtable)).GetNetInterfaceHandle(@as(*const IGetClusterNetInterfaceInfo, @ptrCast(self)), l_obj_index_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWCPropertySheetCallback = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn addPropertySheetPage(self: *const T, hpage_: ?*i32) HRESULT {
                return @as(*const IWCPropertySheetCallback.VTable, @ptrCast(self.vtable)).AddPropertySheetPage(@as(*const IWCPropertySheetCallback, @ptrCast(self)), hpage_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWEExtendPropertySheet = extern struct {
    pub const VTable = extern struct {
        ...
        CreatePropertySheetPages: *const fn (
            ...
            pi_data: ?*IUnknown,
            pi_callback: ?*IWCPropertySheetCallback,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn createPropertySheetPages(self: *const T, pi_data_: ?*IUnknown, pi_callback_: ?*IWCPropertySheetCallback) HRESULT {
                return @as(*const IWEExtendPropertySheet.VTable, @ptrCast(self.vtable)).CreatePropertySheetPages(@as(*const IWEExtendPropertySheet, @ptrCast(self)), pi_data_, pi_callback_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWCWizardCallback = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn addWizardPage(self: *const T, hpage_: ?*i32) HRESULT {
                return @as(*const IWCWizardCallback.VTable, @ptrCast(self.vtable)).AddWizardPage(@as(*const IWCWizardCallback, @ptrCast(self)), hpage_);
            }
            pub inline fn enableNext(self: *const T, hpage_: ?*i32, b_enable_: BOOL) HRESULT {
                return @as(*const IWCWizardCallback.VTable, @ptrCast(self.vtable)).EnableNext(@as(*const IWCWizardCallback, @ptrCast(self)), hpage_, b_enable_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWEExtendWizard = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn createWizardPages(self: *const T, pi_data_: ?*IUnknown, pi_callback_: ?*IWCWizardCallback) HRESULT {
                return @as(*const IWEExtendWizard.VTable, @ptrCast(self.vtable)).CreateWizardPages(@as(*const IWEExtendWizard, @ptrCast(self)), pi_data_, pi_callback_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWCContextMenuCallback = extern struct {
    pub const VTable = extern struct {
        ...
        AddExtensionMenuItem: *const fn (
            ...
            lpsz_name: ?BSTR,
            lpsz_status_bar_text: ?BSTR,
            n_command_i_d: u32,
            n_submenu_command_i_d: u32,
            u_flags: u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn addExtensionMenuItem(self: *const T, lpsz_name_: ?BSTR, lpsz_status_bar_text_: ?BSTR, n_command_i_d_: u32, n_submenu_command_i_d_: u32, u_flags_: u32) HRESULT {
                return @as(*const IWCContextMenuCallback.VTable, @ptrCast(self.vtable)).AddExtensionMenuItem(@as(*const IWCContextMenuCallback, @ptrCast(self)), lpsz_name_, lpsz_status_bar_text_, n_command_i_d_, n_submenu_command_i_d_, u_flags_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWEExtendContextMenu = extern struct {
    pub const VTable = extern struct {
        ...
        AddContextMenuItems: *const fn (
            ...
            pi_data: ?*IUnknown,
            pi_callback: ?*IWCContextMenuCallback,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn addContextMenuItems(self: *const T, pi_data_: ?*IUnknown, pi_callback_: ?*IWCContextMenuCallback) HRESULT {
                return @as(*const IWEExtendContextMenu.VTable, @ptrCast(self.vtable)).AddContextMenuItems(@as(*const IWEExtendContextMenu, @ptrCast(self)), pi_data_, pi_callback_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWEInvokeCommand = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn invokeCommand(self: *const T, n_command_i_d_: u32, pi_data_: ?*IUnknown) HRESULT {
                return @as(*const IWEInvokeCommand.VTable, @ptrCast(self.vtable)).InvokeCommand(@as(*const IWEInvokeCommand, @ptrCast(self)), n_command_i_d_, pi_data_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWCWizard97Callback = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn addWizard97Page(self: *const T, hpage_: ?*i32) HRESULT {
                return @as(*const IWCWizard97Callback.VTable, @ptrCast(self.vtable)).AddWizard97Page(@as(*const IWCWizard97Callback, @ptrCast(self)), hpage_);
            }
            pub inline fn enableNext(self: *const T, hpage_: ?*i32, b_enable_: BOOL) HRESULT {
                return @as(*const IWCWizard97Callback.VTable, @ptrCast(self.vtable)).EnableNext(@as(*const IWCWizard97Callback, @ptrCast(self)), hpage_, b_enable_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const IWEExtendWizard97 = extern struct {
    pub const VTable = extern struct {
        ...
        CreateWizard97Pages: *const fn (
            ...
            pi_data: ?*IUnknown,
            pi_callback: ?*IWCWizard97Callback,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn createWizard97Pages(self: *const T, pi_data_: ?*IUnknown, pi_callback_: ?*IWCWizard97Callback) HRESULT {
                return @as(*const IWEExtendWizard97.VTable, @ptrCast(self.vtable)).CreateWizard97Pages(@as(*const IWEExtendWizard97, @ptrCast(self)), pi_data_, pi_callback_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusApplication = extern struct {
    pub const VTable = extern struct {
        ...
        get_DomainNames: *const fn (
            ...
            pp_domains: ?*?*ISDomainNames,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_ClusterNames: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusApplication,
            bstr_domain_name: ?BSTR,
            pp_clusters: ?*?*ISClusterNames,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OpenCluster: *const fn (
            self: *const ISClusApplication,
            bstr_cluster_name: ?BSTR,
            p_cluster: ?*?*ISCluster,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getDomainNames(self: *const T, pp_domains_: ?*?*ISDomainNames) HRESULT {
                return @as(*const ISClusApplication.VTable, @ptrCast(self.vtable)).get_DomainNames(@as(*const ISClusApplication, @ptrCast(self)), pp_domains_);
            }
            pub inline fn getClusterNames(self: *const T, bstr_domain_name_: ?BSTR, pp_clusters_: ?*?*ISClusterNames) HRESULT {
                return @as(*const ISClusApplication.VTable, @ptrCast(self.vtable)).get_ClusterNames(@as(*const ISClusApplication, @ptrCast(self)), bstr_domain_name_, pp_clusters_);
            }
            pub inline fn openCluster(self: *const T, bstr_cluster_name_: ?BSTR, p_cluster_: ?*?*ISCluster) HRESULT {
                return @as(*const ISClusApplication.VTable, @ptrCast(self.vtable)).OpenCluster(@as(*const ISClusApplication, @ptrCast(self)), bstr_cluster_name_, p_cluster_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getCount(self: *const T, pl_count_: ?*i32) HRESULT {
                return @as(*const ISDomainNames.VTable, @ptrCast(self.vtable)).get_Count(@as(*const ISDomainNames, @ptrCast(self)), pl_count_);
            }
            pub inline fn getNewEnum(self: *const T, retval_: ?*?*IUnknown) HRESULT {
                return @as(*const ISDomainNames.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISDomainNames, @ptrCast(self)), retval_);
            }
            ...
            pub inline fn getItem(self: *const T, var_index_: VARIANT, pbstr_domain_name_: ?*?BSTR) HRESULT {
                return @as(*const ISDomainNames.VTable, @ptrCast(self.vtable)).get_Item(@as(*const ISDomainNames, @ptrCast(self)), var_index_, pbstr_domain_name_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusterNames = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCount(self: *const T, pl_count_: ?*i32) HRESULT {
                return @as(*const ISClusterNames.VTable, @ptrCast(self.vtable)).get_Count(@as(*const ISClusterNames, @ptrCast(self)), pl_count_);
            }
            pub inline fn getNewEnum(self: *const T, retval_: ?*?*IUnknown) HRESULT {
                return @as(*const ISClusterNames.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISClusterNames, @ptrCast(self)), retval_);
            }
            pub inline fn refresh(self: *const T) HRESULT {
                return @as(*const ISClusterNames.VTable, @ptrCast(self.vtable)).Refresh(@as(*const ISClusterNames, @ptrCast(self)));
            }
            pub inline fn getItem(self: *const T, var_index_: VARIANT, pbstr_cluster_name_: ?*?BSTR) HRESULT {
                return @as(*const ISClusterNames.VTable, @ptrCast(self.vtable)).get_Item(@as(*const ISClusterNames, @ptrCast(self)), var_index_, pbstr_cluster_name_);
            }
            pub inline fn getDomainName(self: *const T, pbstr_domain_name_: ?*?BSTR) HRESULT {
                return @as(*const ISClusterNames.VTable, @ptrCast(self.vtable)).get_DomainName(@as(*const ISClusterNames, @ptrCast(self)), pbstr_domain_name_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusRefObject = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getHandle(self: *const T, phandle_: ?*usize) HRESULT {
                return @as(*const ISClusRefObject.VTable, @ptrCast(self.vtable)).get_Handle(@as(*const ISClusRefObject, @ptrCast(self)), phandle_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusVersion = extern struct {
    pub const VTable = extern struct {
        ...
        get_MajorVersion: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusVersion,
            pn_major_version: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_MinorVersion: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusVersion,
            pn_minor_version: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        ...
        get_VendorId: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusVersion,
            pbstr_vendor_id: ?*?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_CSDVersion: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusVersion,
            pbstr_c_s_d_version: ?*?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_ClusterHighestVersion: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusVersion,
            pn_cluster_highest_version: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_ClusterLowestVersion: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusVersion,
            pn_cluster_lowest_version: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_Flags: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getName(self: *const T, pbstr_cluster_name_: ?*?BSTR) HRESULT {
                return @as(*const ISClusVersion.VTable, @ptrCast(self.vtable)).get_Name(@as(*const ISClusVersion, @ptrCast(self)), pbstr_cluster_name_);
            }
            pub inline fn getMajorVersion(self: *const T, pn_major_version_: ?*i32) HRESULT {
                return @as(*const ISClusVersion.VTable, @ptrCast(self.vtable)).get_MajorVersion(@as(*const ISClusVersion, @ptrCast(self)), pn_major_version_);
            }
            pub inline fn getMinorVersion(self: *const T, pn_minor_version_: ?*i32) HRESULT {
                return @as(*const ISClusVersion.VTable, @ptrCast(self.vtable)).get_MinorVersion(@as(*const ISClusVersion, @ptrCast(self)), pn_minor_version_);
            }
            pub inline fn getBuildNumber(self: *const T, pn_build_number_: ?*i16) HRESULT {
                return @as(*const ISClusVersion.VTable, @ptrCast(self.vtable)).get_BuildNumber(@as(*const ISClusVersion, @ptrCast(self)), pn_build_number_);
            }
            pub inline fn getVendorId(self: *const T, pbstr_vendor_id_: ?*?BSTR) HRESULT {
                return @as(*const ISClusVersion.VTable, @ptrCast(self.vtable)).get_VendorId(@as(*const ISClusVersion, @ptrCast(self)), pbstr_vendor_id_);
            }
            pub inline fn getCSDVersion(self: *const T, pbstr_c_s_d_version_: ?*?BSTR) HRESULT {
                return @as(*const ISClusVersion.VTable, @ptrCast(self.vtable)).get_CSDVersion(@as(*const ISClusVersion, @ptrCast(self)), pbstr_c_s_d_version_);
            }
            pub inline fn getClusterHighestVersion(self: *const T, pn_cluster_highest_version_: ?*i32) HRESULT {
                return @as(*const ISClusVersion.VTable, @ptrCast(self.vtable)).get_ClusterHighestVersion(@as(*const ISClusVersion, @ptrCast(self)), pn_cluster_highest_version_);
            }
            pub inline fn getClusterLowestVersion(self: *const T, pn_cluster_lowest_version_: ?*i32) HRESULT {
                return @as(*const ISClusVersion.VTable, @ptrCast(self.vtable)).get_ClusterLowestVersion(@as(*const ISClusVersion, @ptrCast(self)), pn_cluster_lowest_version_);
            }
            pub inline fn getFlags(self: *const T, pn_flags_: ?*i32) HRESULT {
                return @as(*const ISClusVersion.VTable, @ptrCast(self.vtable)).get_Flags(@as(*const ISClusVersion, @ptrCast(self)), pn_flags_);
            }
            pub inline fn getMixedVersion(self: *const T, pvar_mixed_version_: ?*VARIANT) HRESULT {
                return @as(*const ISClusVersion.VTable, @ptrCast(self.vtable)).get_MixedVersion(@as(*const ISClusVersion, @ptrCast(self)), pvar_mixed_version_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISCluster = extern struct {
    pub const VTable = extern struct {
        ...
        get_CommonProperties: *const fn (
            ...
            pp_properties: ?*?*ISClusProperties,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        ...
        get_Version: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISCluster,
            pp_clus_version: ?*?*ISClusVersion,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        put_QuorumResource: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISCluster,
            p_cluster_resource: ?*ISClusResource,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        ...
        get_Nodes: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISCluster,
            pp_nodes: ?*?*ISClusNodes,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_ResourceGroups: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISCluster,
            pp_cluster_resource_groups: ?*?*ISClusResGroups,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_Resources: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISCluster,
            pp_cluster_resources: ?*?*ISClusResources,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_ResourceTypes: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISCluster,
            pp_resource_types: ?*?*ISClusResTypes,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_Networks: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISCluster,
            pp_networks: ?*?*ISClusNetworks,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_NetInterfaces: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISCluster,
            pp_net_interfaces: ?*?*ISClusNetInterfaces,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCommonProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISCluster.VTable, @ptrCast(self.vtable)).get_CommonProperties(@as(*const ISCluster, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getPrivateProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISCluster.VTable, @ptrCast(self.vtable)).get_PrivateProperties(@as(*const ISCluster, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getCommonROProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISCluster.VTable, @ptrCast(self.vtable)).get_CommonROProperties(@as(*const ISCluster, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getPrivateROProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISCluster.VTable, @ptrCast(self.vtable)).get_PrivateROProperties(@as(*const ISCluster, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getHandle(self: *const T, phandle_: ?*usize) HRESULT {
                return @as(*const ISCluster.VTable, @ptrCast(self.vtable)).get_Handle(@as(*const ISCluster, @ptrCast(self)), phandle_);
            }
            pub inline fn open(self: *const T, bstr_cluster_name_: ?BSTR) HRESULT {
                return @as(*const ISCluster.VTable, @ptrCast(self.vtable)).Open(@as(*const ISCluster, @ptrCast(self)), bstr_cluster_name_);
            }
            pub inline fn getName(self: *const T, pbstr_name_: ?*?BSTR) HRESULT {
                return @as(*const ISCluster.VTable, @ptrCast(self.vtable)).get_Name(@as(*const ISCluster, @ptrCast(self)), pbstr_name_);
            }
            pub inline fn putName(self: *const T, bstr_cluster_name_: ?BSTR) HRESULT {
                return @as(*const ISCluster.VTable, @ptrCast(self.vtable)).put_Name(@as(*const ISCluster, @ptrCast(self)), bstr_cluster_name_);
            }
            pub inline fn getVersion(self: *const T, pp_clus_version_: ?*?*ISClusVersion) HRESULT {
                return @as(*const ISCluster.VTable, @ptrCast(self.vtable)).get_Version(@as(*const ISCluster, @ptrCast(self)), pp_clus_version_);
            }
            pub inline fn putQuorumResource(self: *const T, p_cluster_resource_: ?*ISClusResource) HRESULT {
                return @as(*const ISCluster.VTable, @ptrCast(self.vtable)).put_QuorumResource(@as(*const ISCluster, @ptrCast(self)), p_cluster_resource_);
            }
            pub inline fn getQuorumResource(self: *const T, p_cluster_resource_: ?*?*ISClusResource) HRESULT {
                return @as(*const ISCluster.VTable, @ptrCast(self.vtable)).get_QuorumResource(@as(*const ISCluster, @ptrCast(self)), p_cluster_resource_);
            }
            pub inline fn getQuorumLogSize(self: *const T, pn_log_size_: ?*i32) HRESULT {
                return @as(*const ISCluster.VTable, @ptrCast(self.vtable)).get_QuorumLogSize(@as(*const ISCluster, @ptrCast(self)), pn_log_size_);
            }
            pub inline fn putQuorumLogSize(self: *const T, n_log_size_: i32) HRESULT {
                return @as(*const ISCluster.VTable, @ptrCast(self.vtable)).put_QuorumLogSize(@as(*const ISCluster, @ptrCast(self)), n_log_size_);
            }
            pub inline fn getQuorumPath(self: *const T, pp_path_: ?*?BSTR) HRESULT {
                return @as(*const ISCluster.VTable, @ptrCast(self.vtable)).get_QuorumPath(@as(*const ISCluster, @ptrCast(self)), pp_path_);
            }
            pub inline fn putQuorumPath(self: *const T, p_path_: ?BSTR) HRESULT {
                return @as(*const ISCluster.VTable, @ptrCast(self.vtable)).put_QuorumPath(@as(*const ISCluster, @ptrCast(self)), p_path_);
            }
            pub inline fn getNodes(self: *const T, pp_nodes_: ?*?*ISClusNodes) HRESULT {
                return @as(*const ISCluster.VTable, @ptrCast(self.vtable)).get_Nodes(@as(*const ISCluster, @ptrCast(self)), pp_nodes_);
            }
            pub inline fn getResourceGroups(self: *const T, pp_cluster_resource_groups_: ?*?*ISClusResGroups) HRESULT {
                return @as(*const ISCluster.VTable, @ptrCast(self.vtable)).get_ResourceGroups(@as(*const ISCluster, @ptrCast(self)), pp_cluster_resource_groups_);
            }
            pub inline fn getResources(self: *const T, pp_cluster_resources_: ?*?*ISClusResources) HRESULT {
                return @as(*const ISCluster.VTable, @ptrCast(self.vtable)).get_Resources(@as(*const ISCluster, @ptrCast(self)), pp_cluster_resources_);
            }
            pub inline fn getResourceTypes(self: *const T, pp_resource_types_: ?*?*ISClusResTypes) HRESULT {
                return @as(*const ISCluster.VTable, @ptrCast(self.vtable)).get_ResourceTypes(@as(*const ISCluster, @ptrCast(self)), pp_resource_types_);
            }
            pub inline fn getNetworks(self: *const T, pp_networks_: ?*?*ISClusNetworks) HRESULT {
                return @as(*const ISCluster.VTable, @ptrCast(self.vtable)).get_Networks(@as(*const ISCluster, @ptrCast(self)), pp_networks_);
            }
            pub inline fn getNetInterfaces(self: *const T, pp_net_interfaces_: ?*?*ISClusNetInterfaces) HRESULT {
                return @as(*const ISCluster.VTable, @ptrCast(self.vtable)).get_NetInterfaces(@as(*const ISCluster, @ptrCast(self)), pp_net_interfaces_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusNode = extern struct {
    pub const VTable = extern struct {
        ...
        get_ResourceGroups: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusNode,
            pp_resource_groups: ?*?*ISClusResGroups,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_Cluster: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusNode,
            pp_cluster: ?*?*ISCluster,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_NetInterfaces: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusNode,
            pp_clus_net_interfaces: ?*?*ISClusNodeNetInterfaces,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCommonProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISClusNode.VTable, @ptrCast(self.vtable)).get_CommonProperties(@as(*const ISClusNode, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getPrivateProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISClusNode.VTable, @ptrCast(self.vtable)).get_PrivateProperties(@as(*const ISClusNode, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getCommonROProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISClusNode.VTable, @ptrCast(self.vtable)).get_CommonROProperties(@as(*const ISClusNode, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getPrivateROProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISClusNode.VTable, @ptrCast(self.vtable)).get_PrivateROProperties(@as(*const ISClusNode, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getName(self: *const T, pbstr_name_: ?*?BSTR) HRESULT {
                return @as(*const ISClusNode.VTable, @ptrCast(self.vtable)).get_Name(@as(*const ISClusNode, @ptrCast(self)), pbstr_name_);
            }
            pub inline fn getHandle(self: *const T, phandle_: ?*usize) HRESULT {
                return @as(*const ISClusNode.VTable, @ptrCast(self.vtable)).get_Handle(@as(*const ISClusNode, @ptrCast(self)), phandle_);
            }
            pub inline fn getNodeID(self: *const T, pbstr_node_i_d_: ?*?BSTR) HRESULT {
                return @as(*const ISClusNode.VTable, @ptrCast(self.vtable)).get_NodeID(@as(*const ISClusNode, @ptrCast(self)), pbstr_node_i_d_);
            }
            pub inline fn getState(self: *const T, dw_state_: ?*CLUSTER_NODE_STATE) HRESULT {
                return @as(*const ISClusNode.VTable, @ptrCast(self.vtable)).get_State(@as(*const ISClusNode, @ptrCast(self)), dw_state_);
            }
            ...
            pub inline fn evict(self: *const T) HRESULT {
                return @as(*const ISClusNode.VTable, @ptrCast(self.vtable)).Evict(@as(*const ISClusNode, @ptrCast(self)));
            }
            pub inline fn getResourceGroups(self: *const T, pp_resource_groups_: ?*?*ISClusResGroups) HRESULT {
                return @as(*const ISClusNode.VTable, @ptrCast(self.vtable)).get_ResourceGroups(@as(*const ISClusNode, @ptrCast(self)), pp_resource_groups_);
            }
            pub inline fn getCluster(self: *const T, pp_cluster_: ?*?*ISCluster) HRESULT {
                return @as(*const ISClusNode.VTable, @ptrCast(self.vtable)).get_Cluster(@as(*const ISClusNode, @ptrCast(self)), pp_cluster_);
            }
            pub inline fn getNetInterfaces(self: *const T, pp_clus_net_interfaces_: ?*?*ISClusNodeNetInterfaces) HRESULT {
                return @as(*const ISClusNode.VTable, @ptrCast(self.vtable)).get_NetInterfaces(@as(*const ISClusNode, @ptrCast(self)), pp_clus_net_interfaces_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusNodes = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCount(self: *const T, pl_count_: ?*i32) HRESULT {
                return @as(*const ISClusNodes.VTable, @ptrCast(self.vtable)).get_Count(@as(*const ISClusNodes, @ptrCast(self)), pl_count_);
            }
            pub inline fn getNewEnum(self: *const T, retval_: ?*?*IUnknown) HRESULT {
                return @as(*const ISClusNodes.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISClusNodes, @ptrCast(self)), retval_);
            }
            pub inline fn refresh(self: *const T) HRESULT {
                return @as(*const ISClusNodes.VTable, @ptrCast(self.vtable)).Refresh(@as(*const ISClusNodes, @ptrCast(self)));
            }
            pub inline fn getItem(self: *const T, var_index_: VARIANT, pp_node_: ?*?*ISClusNode) HRESULT {
                return @as(*const ISClusNodes.VTable, @ptrCast(self.vtable)).get_Item(@as(*const ISClusNodes, @ptrCast(self)), var_index_, pp_node_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusNetwork = extern struct {
    pub const VTable = extern struct {
        ...
        put_Name: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusNetwork,
            bstr_network_name: ?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_NetworkID: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusNetwork,
            pbstr_network_i_d: ?*?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_State: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusNetwork,
            dw_state: ?*CLUSTER_NETWORK_STATE,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_NetInterfaces: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusNetwork,
            pp_clus_net_interfaces: ?*?*ISClusNetworkNetInterfaces,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_Cluster: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCommonProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISClusNetwork.VTable, @ptrCast(self.vtable)).get_CommonProperties(@as(*const ISClusNetwork, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getPrivateProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISClusNetwork.VTable, @ptrCast(self.vtable)).get_PrivateProperties(@as(*const ISClusNetwork, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getCommonROProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISClusNetwork.VTable, @ptrCast(self.vtable)).get_CommonROProperties(@as(*const ISClusNetwork, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getPrivateROProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISClusNetwork.VTable, @ptrCast(self.vtable)).get_PrivateROProperties(@as(*const ISClusNetwork, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getHandle(self: *const T, phandle_: ?*usize) HRESULT {
                return @as(*const ISClusNetwork.VTable, @ptrCast(self.vtable)).get_Handle(@as(*const ISClusNetwork, @ptrCast(self)), phandle_);
            }
            pub inline fn getName(self: *const T, pbstr_name_: ?*?BSTR) HRESULT {
                return @as(*const ISClusNetwork.VTable, @ptrCast(self.vtable)).get_Name(@as(*const ISClusNetwork, @ptrCast(self)), pbstr_name_);
            }
            pub inline fn putName(self: *const T, bstr_network_name_: ?BSTR) HRESULT {
                return @as(*const ISClusNetwork.VTable, @ptrCast(self.vtable)).put_Name(@as(*const ISClusNetwork, @ptrCast(self)), bstr_network_name_);
            }
            pub inline fn getNetworkID(self: *const T, pbstr_network_i_d_: ?*?BSTR) HRESULT {
                return @as(*const ISClusNetwork.VTable, @ptrCast(self.vtable)).get_NetworkID(@as(*const ISClusNetwork, @ptrCast(self)), pbstr_network_i_d_);
            }
            pub inline fn getState(self: *const T, dw_state_: ?*CLUSTER_NETWORK_STATE) HRESULT {
                return @as(*const ISClusNetwork.VTable, @ptrCast(self.vtable)).get_State(@as(*const ISClusNetwork, @ptrCast(self)), dw_state_);
            }
            pub inline fn getNetInterfaces(self: *const T, pp_clus_net_interfaces_: ?*?*ISClusNetworkNetInterfaces) HRESULT {
                return @as(*const ISClusNetwork.VTable, @ptrCast(self.vtable)).get_NetInterfaces(@as(*const ISClusNetwork, @ptrCast(self)), pp_clus_net_interfaces_);
            }
            pub inline fn getCluster(self: *const T, pp_cluster_: ?*?*ISCluster) HRESULT {
                return @as(*const ISClusNetwork.VTable, @ptrCast(self.vtable)).get_Cluster(@as(*const ISClusNetwork, @ptrCast(self)), pp_cluster_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusNetworks = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCount(self: *const T, pl_count_: ?*i32) HRESULT {
                return @as(*const ISClusNetworks.VTable, @ptrCast(self.vtable)).get_Count(@as(*const ISClusNetworks, @ptrCast(self)), pl_count_);
            }
            pub inline fn getNewEnum(self: *const T, retval_: ?*?*IUnknown) HRESULT {
                return @as(*const ISClusNetworks.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISClusNetworks, @ptrCast(self)), retval_);
            }
            pub inline fn refresh(self: *const T) HRESULT {
                return @as(*const ISClusNetworks.VTable, @ptrCast(self.vtable)).Refresh(@as(*const ISClusNetworks, @ptrCast(self)));
            }
            pub inline fn getItem(self: *const T, var_index_: VARIANT, pp_clus_network_: ?*?*ISClusNetwork) HRESULT {
                return @as(*const ISClusNetworks.VTable, @ptrCast(self.vtable)).get_Item(@as(*const ISClusNetworks, @ptrCast(self)), var_index_, pp_clus_network_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusNetInterface = extern struct {
    pub const VTable = extern struct {
        ...
        get_State: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusNetInterface,
            dw_state: ?*CLUSTER_NETINTERFACE_STATE,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_Cluster: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCommonProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISClusNetInterface.VTable, @ptrCast(self.vtable)).get_CommonProperties(@as(*const ISClusNetInterface, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getPrivateProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISClusNetInterface.VTable, @ptrCast(self.vtable)).get_PrivateProperties(@as(*const ISClusNetInterface, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getCommonROProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISClusNetInterface.VTable, @ptrCast(self.vtable)).get_CommonROProperties(@as(*const ISClusNetInterface, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getPrivateROProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISClusNetInterface.VTable, @ptrCast(self.vtable)).get_PrivateROProperties(@as(*const ISClusNetInterface, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getName(self: *const T, pbstr_name_: ?*?BSTR) HRESULT {
                return @as(*const ISClusNetInterface.VTable, @ptrCast(self.vtable)).get_Name(@as(*const ISClusNetInterface, @ptrCast(self)), pbstr_name_);
            }
            pub inline fn getHandle(self: *const T, phandle_: ?*usize) HRESULT {
                return @as(*const ISClusNetInterface.VTable, @ptrCast(self.vtable)).get_Handle(@as(*const ISClusNetInterface, @ptrCast(self)), phandle_);
            }
            pub inline fn getState(self: *const T, dw_state_: ?*CLUSTER_NETINTERFACE_STATE) HRESULT {
                return @as(*const ISClusNetInterface.VTable, @ptrCast(self.vtable)).get_State(@as(*const ISClusNetInterface, @ptrCast(self)), dw_state_);
            }
            pub inline fn getCluster(self: *const T, pp_cluster_: ?*?*ISCluster) HRESULT {
                return @as(*const ISClusNetInterface.VTable, @ptrCast(self.vtable)).get_Cluster(@as(*const ISClusNetInterface, @ptrCast(self)), pp_cluster_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusNetInterfaces = extern struct {
    pub const VTable = extern struct {
        ...
        get_Item: *const fn (
            ...
            self: *const ISClusNetInterfaces,
            var_index: VARIANT,
            pp_clus_net_interface: ?*?*ISClusNetInterface,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCount(self: *const T, pl_count_: ?*i32) HRESULT {
                return @as(*const ISClusNetInterfaces.VTable, @ptrCast(self.vtable)).get_Count(@as(*const ISClusNetInterfaces, @ptrCast(self)), pl_count_);
            }
            pub inline fn getNewEnum(self: *const T, retval_: ?*?*IUnknown) HRESULT {
                return @as(*const ISClusNetInterfaces.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISClusNetInterfaces, @ptrCast(self)), retval_);
            }
            pub inline fn refresh(self: *const T) HRESULT {
                return @as(*const ISClusNetInterfaces.VTable, @ptrCast(self.vtable)).Refresh(@as(*const ISClusNetInterfaces, @ptrCast(self)));
            }
            pub inline fn getItem(self: *const T, var_index_: VARIANT, pp_clus_net_interface_: ?*?*ISClusNetInterface) HRESULT {
                return @as(*const ISClusNetInterfaces.VTable, @ptrCast(self.vtable)).get_Item(@as(*const ISClusNetInterfaces, @ptrCast(self)), var_index_, pp_clus_net_interface_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusNodeNetInterfaces = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCount(self: *const T, pl_count_: ?*i32) HRESULT {
                return @as(*const ISClusNodeNetInterfaces.VTable, @ptrCast(self.vtable)).get_Count(@as(*const ISClusNodeNetInterfaces, @ptrCast(self)), pl_count_);
            }
            pub inline fn getNewEnum(self: *const T, retval_: ?*?*IUnknown) HRESULT {
                return @as(*const ISClusNodeNetInterfaces.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISClusNodeNetInterfaces, @ptrCast(self)), retval_);
            }
            pub inline fn refresh(self: *const T) HRESULT {
                return @as(*const ISClusNodeNetInterfaces.VTable, @ptrCast(self.vtable)).Refresh(@as(*const ISClusNodeNetInterfaces, @ptrCast(self)));
            }
            pub inline fn getItem(self: *const T, var_index_: VARIANT, pp_clus_net_interface_: ?*?*ISClusNetInterface) HRESULT {
                return @as(*const ISClusNodeNetInterfaces.VTable, @ptrCast(self.vtable)).get_Item(@as(*const ISClusNodeNetInterfaces, @ptrCast(self)), var_index_, pp_clus_net_interface_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusNetworkNetInterfaces = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCount(self: *const T, pl_count_: ?*i32) HRESULT {
                return @as(*const ISClusNetworkNetInterfaces.VTable, @ptrCast(self.vtable)).get_Count(@as(*const ISClusNetworkNetInterfaces, @ptrCast(self)), pl_count_);
            }
            pub inline fn getNewEnum(self: *const T, retval_: ?*?*IUnknown) HRESULT {
                return @as(*const ISClusNetworkNetInterfaces.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISClusNetworkNetInterfaces, @ptrCast(self)), retval_);
            }
            pub inline fn refresh(self: *const T) HRESULT {
            ...
            pub inline fn getItem(self: *const T, var_index_: VARIANT, pp_clus_net_interface_: ?*?*ISClusNetInterface) HRESULT {
                return @as(*const ISClusNetworkNetInterfaces.VTable, @ptrCast(self.vtable)).get_Item(@as(*const ISClusNetworkNetInterfaces, @ptrCast(self)), var_index_, pp_clus_net_interface_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusResGroup = extern struct {
    pub const VTable = extern struct {
        ...
        get_State: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusResGroup,
            dw_state: ?*CLUSTER_GROUP_STATE,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_OwnerNode: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusResGroup,
            pp_owner_node: ?*?*ISClusNode,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_Resources: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusResGroup,
            pp_cluster_group_resources: ?*?*ISClusResGroupResources,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_PreferredOwnerNodes: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusResGroup,
            pp_owner_nodes: ?*?*ISClusResGroupPreferredOwnerNodes,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Delete: *const fn (
            self: *const ISClusResGroup,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCommonProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISClusResGroup.VTable, @ptrCast(self.vtable)).get_CommonProperties(@as(*const ISClusResGroup, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getPrivateProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISClusResGroup.VTable, @ptrCast(self.vtable)).get_PrivateProperties(@as(*const ISClusResGroup, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getCommonROProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISClusResGroup.VTable, @ptrCast(self.vtable)).get_CommonROProperties(@as(*const ISClusResGroup, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getPrivateROProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISClusResGroup.VTable, @ptrCast(self.vtable)).get_PrivateROProperties(@as(*const ISClusResGroup, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getHandle(self: *const T, phandle_: ?*usize) HRESULT {
                return @as(*const ISClusResGroup.VTable, @ptrCast(self.vtable)).get_Handle(@as(*const ISClusResGroup, @ptrCast(self)), phandle_);
            }
            pub inline fn getName(self: *const T, pbstr_name_: ?*?BSTR) HRESULT {
                return @as(*const ISClusResGroup.VTable, @ptrCast(self.vtable)).get_Name(@as(*const ISClusResGroup, @ptrCast(self)), pbstr_name_);
            }
            pub inline fn putName(self: *const T, bstr_group_name_: ?BSTR) HRESULT {
                return @as(*const ISClusResGroup.VTable, @ptrCast(self.vtable)).put_Name(@as(*const ISClusResGroup, @ptrCast(self)), bstr_group_name_);
            }
            pub inline fn getState(self: *const T, dw_state_: ?*CLUSTER_GROUP_STATE) HRESULT {
                return @as(*const ISClusResGroup.VTable, @ptrCast(self.vtable)).get_State(@as(*const ISClusResGroup, @ptrCast(self)), dw_state_);
            }
            pub inline fn getOwnerNode(self: *const T, pp_owner_node_: ?*?*ISClusNode) HRESULT {
                return @as(*const ISClusResGroup.VTable, @ptrCast(self.vtable)).get_OwnerNode(@as(*const ISClusResGroup, @ptrCast(self)), pp_owner_node_);
            }
            pub inline fn getResources(self: *const T, pp_cluster_group_resources_: ?*?*ISClusResGroupResources) HRESULT {
                return @as(*const ISClusResGroup.VTable, @ptrCast(self.vtable)).get_Resources(@as(*const ISClusResGroup, @ptrCast(self)), pp_cluster_group_resources_);
            }
            pub inline fn getPreferredOwnerNodes(self: *const T, pp_owner_nodes_: ?*?*ISClusResGroupPreferredOwnerNodes) HRESULT {
                return @as(*const ISClusResGroup.VTable, @ptrCast(self.vtable)).get_PreferredOwnerNodes(@as(*const ISClusResGroup, @ptrCast(self)), pp_owner_nodes_);
            }
            ...
            pub inline fn online(self: *const T, var_timeout_: VARIANT, var_node_: VARIANT, pvar_pending_: ?*VARIANT) HRESULT {
                return @as(*const ISClusResGroup.VTable, @ptrCast(self.vtable)).Online(@as(*const ISClusResGroup, @ptrCast(self)), var_timeout_, var_node_, pvar_pending_);
            }
            pub inline fn move(self: *const T, var_timeout_: VARIANT, var_node_: VARIANT, pvar_pending_: ?*VARIANT) HRESULT {
                return @as(*const ISClusResGroup.VTable, @ptrCast(self.vtable)).Move(@as(*const ISClusResGroup, @ptrCast(self)), var_timeout_, var_node_, pvar_pending_);
            }
            pub inline fn offline(self: *const T, var_timeout_: VARIANT, pvar_pending_: ?*VARIANT) HRESULT {
                return @as(*const ISClusResGroup.VTable, @ptrCast(self.vtable)).Offline(@as(*const ISClusResGroup, @ptrCast(self)), var_timeout_, pvar_pending_);
            }
            pub inline fn getCluster(self: *const T, pp_cluster_: ?*?*ISCluster) HRESULT {
                return @as(*const ISClusResGroup.VTable, @ptrCast(self.vtable)).get_Cluster(@as(*const ISClusResGroup, @ptrCast(self)), pp_cluster_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusResGroups = extern struct {
    pub const VTable = extern struct {
        ...
        get_Item: *const fn (
            ...
            self: *const ISClusResGroups,
            var_index: VARIANT,
            pp_clus_res_group: ?*?*ISClusResGroup,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        CreateItem: *const fn (
            self: *const ISClusResGroups,
            bstr_resource_group_name: ?BSTR,
            pp_resource_group: ?*?*ISClusResGroup,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        DeleteItem: *const fn (
            self: *const ISClusResGroups,
            var_index: VARIANT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCount(self: *const T, pl_count_: ?*i32) HRESULT {
                return @as(*const ISClusResGroups.VTable, @ptrCast(self.vtable)).get_Count(@as(*const ISClusResGroups, @ptrCast(self)), pl_count_);
            }
            pub inline fn getNewEnum(self: *const T, retval_: ?*?*IUnknown) HRESULT {
                return @as(*const ISClusResGroups.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISClusResGroups, @ptrCast(self)), retval_);
            }
            pub inline fn refresh(self: *const T) HRESULT {
                return @as(*const ISClusResGroups.VTable, @ptrCast(self.vtable)).Refresh(@as(*const ISClusResGroups, @ptrCast(self)));
            }
            pub inline fn getItem(self: *const T, var_index_: VARIANT, pp_clus_res_group_: ?*?*ISClusResGroup) HRESULT {
                return @as(*const ISClusResGroups.VTable, @ptrCast(self.vtable)).get_Item(@as(*const ISClusResGroups, @ptrCast(self)), var_index_, pp_clus_res_group_);
            }
            pub inline fn createItem(self: *const T, bstr_resource_group_name_: ?BSTR, pp_resource_group_: ?*?*ISClusResGroup) HRESULT {
                return @as(*const ISClusResGroups.VTable, @ptrCast(self.vtable)).CreateItem(@as(*const ISClusResGroups, @ptrCast(self)), bstr_resource_group_name_, pp_resource_group_);
            }
            pub inline fn deleteItem(self: *const T, var_index_: VARIANT) HRESULT {
                return @as(*const ISClusResGroups.VTable, @ptrCast(self.vtable)).DeleteItem(@as(*const ISClusResGroups, @ptrCast(self)), var_index_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusResource = extern struct {
    pub const VTable = extern struct {
        ...
        put_Name: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusResource,
            bstr_resource_name: ?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_State: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusResource,
            dw_state: ?*CLUSTER_RESOURCE_STATE,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_CoreFlag: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusResource,
            dw_core_flag: ?*CLUS_FLAGS,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        BecomeQuorumResource: *const fn (
            self: *const ISClusResource,
            bstr_device_path: ?BSTR,
            l_max_log_size: i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Delete: *const fn (
            self: *const ISClusResource,
        ...
        ChangeResourceGroup: *const fn (
            self: *const ISClusResource,
            p_resource_group: ?*ISClusResGroup,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        CanResourceBeDependent: *const fn (
            self: *const ISClusResource,
            p_resource: ?*ISClusResource,
            pvar_dependent: ?*VARIANT,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_PossibleOwnerNodes: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusResource,
            pp_owner_nodes: ?*?*ISClusResPossibleOwnerNodes,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_Dependencies: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusResource,
            pp_res_dependencies: ?*?*ISClusResDependencies,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_Dependents: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusResource,
            pp_res_dependents: ?*?*ISClusResDependents,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_Group: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusResource,
            pp_res_group: ?*?*ISClusResGroup,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_OwnerNode: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
        ...
        get_ClassInfo: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusResource,
            prc_class_info: ?*CLUSTER_RESOURCE_CLASS,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_Disk: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
        ...
        get_RegistryKeys: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusResource,
            pp_registry_keys: ?*?*ISClusRegistryKeys,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_CryptoKeys: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusResource,
            pp_crypto_keys: ?*?*ISClusCryptoKeys,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_TypeName: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusResource,
            pbstr_type_name: ?*?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_Type: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusResource,
            pp_resource_type: ?*?*ISClusResType,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_MaintenanceMode: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusResource,
            pb_maintenance_mode: ?*BOOL,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        put_MaintenanceMode: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusResource,
            b_maintenance_mode: BOOL,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCommonProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).get_CommonProperties(@as(*const ISClusResource, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getPrivateProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).get_PrivateProperties(@as(*const ISClusResource, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getCommonROProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).get_CommonROProperties(@as(*const ISClusResource, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getPrivateROProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).get_PrivateROProperties(@as(*const ISClusResource, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getHandle(self: *const T, phandle_: ?*usize) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).get_Handle(@as(*const ISClusResource, @ptrCast(self)), phandle_);
            }
            pub inline fn getName(self: *const T, pbstr_name_: ?*?BSTR) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).get_Name(@as(*const ISClusResource, @ptrCast(self)), pbstr_name_);
            }
            pub inline fn putName(self: *const T, bstr_resource_name_: ?BSTR) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).put_Name(@as(*const ISClusResource, @ptrCast(self)), bstr_resource_name_);
            }
            pub inline fn getState(self: *const T, dw_state_: ?*CLUSTER_RESOURCE_STATE) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).get_State(@as(*const ISClusResource, @ptrCast(self)), dw_state_);
            }
            pub inline fn getCoreFlag(self: *const T, dw_core_flag_: ?*CLUS_FLAGS) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).get_CoreFlag(@as(*const ISClusResource, @ptrCast(self)), dw_core_flag_);
            }
            pub inline fn becomeQuorumResource(self: *const T, bstr_device_path_: ?BSTR, l_max_log_size_: i32) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).BecomeQuorumResource(@as(*const ISClusResource, @ptrCast(self)), bstr_device_path_, l_max_log_size_);
            }
            pub inline fn delete(self: *const T) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).Delete(@as(*const ISClusResource, @ptrCast(self)));
            }
            pub inline fn fail(self: *const T) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).Fail(@as(*const ISClusResource, @ptrCast(self)));
            }
            pub inline fn online(self: *const T, n_timeout_: i32, pvar_pending_: ?*VARIANT) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).Online(@as(*const ISClusResource, @ptrCast(self)), n_timeout_, pvar_pending_);
            }
            pub inline fn offline(self: *const T, n_timeout_: i32, pvar_pending_: ?*VARIANT) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).Offline(@as(*const ISClusResource, @ptrCast(self)), n_timeout_, pvar_pending_);
            }
            pub inline fn changeResourceGroup(self: *const T, p_resource_group_: ?*ISClusResGroup) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).ChangeResourceGroup(@as(*const ISClusResource, @ptrCast(self)), p_resource_group_);
            }
            pub inline fn addResourceNode(self: *const T, p_node_: ?*ISClusNode) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).AddResourceNode(@as(*const ISClusResource, @ptrCast(self)), p_node_);
            }
            pub inline fn removeResourceNode(self: *const T, p_node_: ?*ISClusNode) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).RemoveResourceNode(@as(*const ISClusResource, @ptrCast(self)), p_node_);
            }
            pub inline fn canResourceBeDependent(self: *const T, p_resource_: ?*ISClusResource, pvar_dependent_: ?*VARIANT) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).CanResourceBeDependent(@as(*const ISClusResource, @ptrCast(self)), p_resource_, pvar_dependent_);
            }
            pub inline fn getPossibleOwnerNodes(self: *const T, pp_owner_nodes_: ?*?*ISClusResPossibleOwnerNodes) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).get_PossibleOwnerNodes(@as(*const ISClusResource, @ptrCast(self)), pp_owner_nodes_);
            }
            pub inline fn getDependencies(self: *const T, pp_res_dependencies_: ?*?*ISClusResDependencies) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).get_Dependencies(@as(*const ISClusResource, @ptrCast(self)), pp_res_dependencies_);
            }
            pub inline fn getDependents(self: *const T, pp_res_dependents_: ?*?*ISClusResDependents) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).get_Dependents(@as(*const ISClusResource, @ptrCast(self)), pp_res_dependents_);
            }
            pub inline fn getGroup(self: *const T, pp_res_group_: ?*?*ISClusResGroup) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).get_Group(@as(*const ISClusResource, @ptrCast(self)), pp_res_group_);
            }
            pub inline fn getOwnerNode(self: *const T, pp_owner_node_: ?*?*ISClusNode) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).get_OwnerNode(@as(*const ISClusResource, @ptrCast(self)), pp_owner_node_);
            }
            pub inline fn getCluster(self: *const T, pp_cluster_: ?*?*ISCluster) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).get_Cluster(@as(*const ISClusResource, @ptrCast(self)), pp_cluster_);
            }
            pub inline fn getClassInfo(self: *const T, prc_class_info_: ?*CLUSTER_RESOURCE_CLASS) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).get_ClassInfo(@as(*const ISClusResource, @ptrCast(self)), prc_class_info_);
            }
            pub inline fn getDisk(self: *const T, pp_disk_: ?*?*ISClusDisk) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).get_Disk(@as(*const ISClusResource, @ptrCast(self)), pp_disk_);
            }
            pub inline fn getRegistryKeys(self: *const T, pp_registry_keys_: ?*?*ISClusRegistryKeys) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).get_RegistryKeys(@as(*const ISClusResource, @ptrCast(self)), pp_registry_keys_);
            }
            pub inline fn getCryptoKeys(self: *const T, pp_crypto_keys_: ?*?*ISClusCryptoKeys) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).get_CryptoKeys(@as(*const ISClusResource, @ptrCast(self)), pp_crypto_keys_);
            }
            pub inline fn getTypeName(self: *const T, pbstr_type_name_: ?*?BSTR) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).get_TypeName(@as(*const ISClusResource, @ptrCast(self)), pbstr_type_name_);
            }
            pub inline fn getType(self: *const T, pp_resource_type_: ?*?*ISClusResType) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).get_Type(@as(*const ISClusResource, @ptrCast(self)), pp_resource_type_);
            }
            pub inline fn getMaintenanceMode(self: *const T, pb_maintenance_mode_: ?*BOOL) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).get_MaintenanceMode(@as(*const ISClusResource, @ptrCast(self)), pb_maintenance_mode_);
            }
            pub inline fn putMaintenanceMode(self: *const T, b_maintenance_mode_: BOOL) HRESULT {
                return @as(*const ISClusResource.VTable, @ptrCast(self.vtable)).put_MaintenanceMode(@as(*const ISClusResource, @ptrCast(self)), b_maintenance_mode_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusResDependencies = extern struct {
    pub const VTable = extern struct {
        ...
        get_Item: *const fn (
            ...
            self: *const ISClusResDependencies,
            var_index: VARIANT,
            pp_clus_resource: ?*?*ISClusResource,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        CreateItem: *const fn (
            self: *const ISClusResDependencies,
            bstr_resource_name: ?BSTR,
            bstr_resource_type: ?BSTR,
            dw_flags: CLUSTER_RESOURCE_CREATE_FLAGS,
            pp_cluster_resource: ?*?*ISClusResource,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        DeleteItem: *const fn (
            self: *const ISClusResDependencies,
            var_index: VARIANT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCount(self: *const T, pl_count_: ?*i32) HRESULT {
                return @as(*const ISClusResDependencies.VTable, @ptrCast(self.vtable)).get_Count(@as(*const ISClusResDependencies, @ptrCast(self)), pl_count_);
            }
            pub inline fn getNewEnum(self: *const T, retval_: ?*?*IUnknown) HRESULT {
                return @as(*const ISClusResDependencies.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISClusResDependencies, @ptrCast(self)), retval_);
            }
            pub inline fn refresh(self: *const T) HRESULT {
                return @as(*const ISClusResDependencies.VTable, @ptrCast(self.vtable)).Refresh(@as(*const ISClusResDependencies, @ptrCast(self)));
            }
            pub inline fn getItem(self: *const T, var_index_: VARIANT, pp_clus_resource_: ?*?*ISClusResource) HRESULT {
                return @as(*const ISClusResDependencies.VTable, @ptrCast(self.vtable)).get_Item(@as(*const ISClusResDependencies, @ptrCast(self)), var_index_, pp_clus_resource_);
            }
            pub inline fn createItem(self: *const T, bstr_resource_name_: ?BSTR, bstr_resource_type_: ?BSTR, dw_flags_: CLUSTER_RESOURCE_CREATE_FLAGS, pp_cluster_resource_: ?*?*ISClusResource) HRESULT {
                return @as(*const ISClusResDependencies.VTable, @ptrCast(self.vtable)).CreateItem(@as(*const ISClusResDependencies, @ptrCast(self)), bstr_resource_name_, bstr_resource_type_, dw_flags_, pp_cluster_resource_);
            }
            pub inline fn deleteItem(self: *const T, var_index_: VARIANT) HRESULT {
                return @as(*const ISClusResDependencies.VTable, @ptrCast(self.vtable)).DeleteItem(@as(*const ISClusResDependencies, @ptrCast(self)), var_index_);
            }
            pub inline fn addItem(self: *const T, p_resource_: ?*ISClusResource) HRESULT {
                return @as(*const ISClusResDependencies.VTable, @ptrCast(self.vtable)).AddItem(@as(*const ISClusResDependencies, @ptrCast(self)), p_resource_);
            }
            pub inline fn removeItem(self: *const T, var_index_: VARIANT) HRESULT {
                return @as(*const ISClusResDependencies.VTable, @ptrCast(self.vtable)).RemoveItem(@as(*const ISClusResDependencies, @ptrCast(self)), var_index_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusResGroupResources = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCount(self: *const T, pl_count_: ?*i32) HRESULT {
                return @as(*const ISClusResGroupResources.VTable, @ptrCast(self.vtable)).get_Count(@as(*const ISClusResGroupResources, @ptrCast(self)), pl_count_);
            }
            pub inline fn getNewEnum(self: *const T, retval_: ?*?*IUnknown) HRESULT {
                return @as(*const ISClusResGroupResources.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISClusResGroupResources, @ptrCast(self)), retval_);
            }
            pub inline fn refresh(self: *const T) HRESULT {
                return @as(*const ISClusResGroupResources.VTable, @ptrCast(self.vtable)).Refresh(@as(*const ISClusResGroupResources, @ptrCast(self)));
            }
            pub inline fn getItem(self: *const T, var_index_: VARIANT, pp_clus_resource_: ?*?*ISClusResource) HRESULT {
                return @as(*const ISClusResGroupResources.VTable, @ptrCast(self.vtable)).get_Item(@as(*const ISClusResGroupResources, @ptrCast(self)), var_index_, pp_clus_resource_);
            }
            pub inline fn createItem(self: *const T, bstr_resource_name_: ?BSTR, bstr_resource_type_: ?BSTR, dw_flags_: CLUSTER_RESOURCE_CREATE_FLAGS, pp_cluster_resource_: ?*?*ISClusResource) HRESULT {
                return @as(*const ISClusResGroupResources.VTable, @ptrCast(self.vtable)).CreateItem(@as(*const ISClusResGroupResources, @ptrCast(self)), bstr_resource_name_, bstr_resource_type_, dw_flags_, pp_cluster_resource_);
            }
            pub inline fn deleteItem(self: *const T, var_index_: VARIANT) HRESULT {
                return @as(*const ISClusResGroupResources.VTable, @ptrCast(self.vtable)).DeleteItem(@as(*const ISClusResGroupResources, @ptrCast(self)), var_index_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusResTypeResources = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCount(self: *const T, pl_count_: ?*i32) HRESULT {
                return @as(*const ISClusResTypeResources.VTable, @ptrCast(self.vtable)).get_Count(@as(*const ISClusResTypeResources, @ptrCast(self)), pl_count_);
            }
            pub inline fn getNewEnum(self: *const T, retval_: ?*?*IUnknown) HRESULT {
                return @as(*const ISClusResTypeResources.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISClusResTypeResources, @ptrCast(self)), retval_);
            }
            pub inline fn refresh(self: *const T) HRESULT {
                return @as(*const ISClusResTypeResources.VTable, @ptrCast(self.vtable)).Refresh(@as(*const ISClusResTypeResources, @ptrCast(self)));
            }
            pub inline fn getItem(self: *const T, var_index_: VARIANT, pp_clus_resource_: ?*?*ISClusResource) HRESULT {
                return @as(*const ISClusResTypeResources.VTable, @ptrCast(self.vtable)).get_Item(@as(*const ISClusResTypeResources, @ptrCast(self)), var_index_, pp_clus_resource_);
            }
            pub inline fn createItem(self: *const T, bstr_resource_name_: ?BSTR, bstr_group_name_: ?BSTR, dw_flags_: CLUSTER_RESOURCE_CREATE_FLAGS, pp_cluster_resource_: ?*?*ISClusResource) HRESULT {
                return @as(*const ISClusResTypeResources.VTable, @ptrCast(self.vtable)).CreateItem(@as(*const ISClusResTypeResources, @ptrCast(self)), bstr_resource_name_, bstr_group_name_, dw_flags_, pp_cluster_resource_);
            }
            pub inline fn deleteItem(self: *const T, var_index_: VARIANT) HRESULT {
                return @as(*const ISClusResTypeResources.VTable, @ptrCast(self.vtable)).DeleteItem(@as(*const ISClusResTypeResources, @ptrCast(self)), var_index_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusResources = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCount(self: *const T, pl_count_: ?*i32) HRESULT {
                return @as(*const ISClusResources.VTable, @ptrCast(self.vtable)).get_Count(@as(*const ISClusResources, @ptrCast(self)), pl_count_);
            }
            pub inline fn getNewEnum(self: *const T, retval_: ?*?*IUnknown) HRESULT {
                return @as(*const ISClusResources.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISClusResources, @ptrCast(self)), retval_);
            }
            pub inline fn refresh(self: *const T) HRESULT {
                return @as(*const ISClusResources.VTable, @ptrCast(self.vtable)).Refresh(@as(*const ISClusResources, @ptrCast(self)));
            }
            pub inline fn getItem(self: *const T, var_index_: VARIANT, pp_clus_resource_: ?*?*ISClusResource) HRESULT {
                return @as(*const ISClusResources.VTable, @ptrCast(self.vtable)).get_Item(@as(*const ISClusResources, @ptrCast(self)), var_index_, pp_clus_resource_);
            }
            pub inline fn createItem(self: *const T, bstr_resource_name_: ?BSTR, bstr_resource_type_: ?BSTR, bstr_group_name_: ?BSTR, dw_flags_: CLUSTER_RESOURCE_CREATE_FLAGS, pp_cluster_resource_: ?*?*ISClusResource) HRESULT {
                return @as(*const ISClusResources.VTable, @ptrCast(self.vtable)).CreateItem(@as(*const ISClusResources, @ptrCast(self)), bstr_resource_name_, bstr_resource_type_, bstr_group_name_, dw_flags_, pp_cluster_resource_);
            }
            pub inline fn deleteItem(self: *const T, var_index_: VARIANT) HRESULT {
                return @as(*const ISClusResources.VTable, @ptrCast(self.vtable)).DeleteItem(@as(*const ISClusResources, @ptrCast(self)), var_index_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusResGroupPreferredOwnerNodes = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCount(self: *const T, pl_count_: ?*i32) HRESULT {
                return @as(*const ISClusResGroupPreferredOwnerNodes.VTable, @ptrCast(self.vtable)).get_Count(@as(*const ISClusResGroupPreferredOwnerNodes, @ptrCast(self)), pl_count_);
            }
            pub inline fn getNewEnum(self: *const T, retval_: ?*?*IUnknown) HRESULT {
                return @as(*const ISClusResGroupPreferredOwnerNodes.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISClusResGroupPreferredOwnerNodes, @ptrCast(self)), retval_);
            }
            pub inline fn refresh(self: *const T) HRESULT {
            ...
            pub inline fn getItem(self: *const T, var_index_: VARIANT, pp_node_: ?*?*ISClusNode) HRESULT {
                return @as(*const ISClusResGroupPreferredOwnerNodes.VTable, @ptrCast(self.vtable)).get_Item(@as(*const ISClusResGroupPreferredOwnerNodes, @ptrCast(self)), var_index_, pp_node_);
            }
            pub inline fn insertItem(self: *const T, p_node_: ?*ISClusNode, n_position_: i32) HRESULT {
                return @as(*const ISClusResGroupPreferredOwnerNodes.VTable, @ptrCast(self.vtable)).InsertItem(@as(*const ISClusResGroupPreferredOwnerNodes, @ptrCast(self)), p_node_, n_position_);
            }
            pub inline fn removeItem(self: *const T, var_index_: VARIANT) HRESULT {
                return @as(*const ISClusResGroupPreferredOwnerNodes.VTable, @ptrCast(self.vtable)).RemoveItem(@as(*const ISClusResGroupPreferredOwnerNodes, @ptrCast(self)), var_index_);
            }
            pub inline fn getModified(self: *const T, pvar_modified_: ?*VARIANT) HRESULT {
                return @as(*const ISClusResGroupPreferredOwnerNodes.VTable, @ptrCast(self.vtable)).get_Modified(@as(*const ISClusResGroupPreferredOwnerNodes, @ptrCast(self)), pvar_modified_);
            }
            pub inline fn saveChanges(self: *const T) HRESULT {
            ...
            pub inline fn addItem(self: *const T, p_node_: ?*ISClusNode) HRESULT {
                return @as(*const ISClusResGroupPreferredOwnerNodes.VTable, @ptrCast(self.vtable)).AddItem(@as(*const ISClusResGroupPreferredOwnerNodes, @ptrCast(self)), p_node_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusResPossibleOwnerNodes = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCount(self: *const T, pl_count_: ?*i32) HRESULT {
                return @as(*const ISClusResPossibleOwnerNodes.VTable, @ptrCast(self.vtable)).get_Count(@as(*const ISClusResPossibleOwnerNodes, @ptrCast(self)), pl_count_);
            }
            pub inline fn getNewEnum(self: *const T, retval_: ?*?*IUnknown) HRESULT {
                return @as(*const ISClusResPossibleOwnerNodes.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISClusResPossibleOwnerNodes, @ptrCast(self)), retval_);
            }
            pub inline fn refresh(self: *const T) HRESULT {
            ...
            pub inline fn getItem(self: *const T, var_index_: VARIANT, pp_node_: ?*?*ISClusNode) HRESULT {
                return @as(*const ISClusResPossibleOwnerNodes.VTable, @ptrCast(self.vtable)).get_Item(@as(*const ISClusResPossibleOwnerNodes, @ptrCast(self)), var_index_, pp_node_);
            }
            pub inline fn addItem(self: *const T, p_node_: ?*ISClusNode) HRESULT {
                return @as(*const ISClusResPossibleOwnerNodes.VTable, @ptrCast(self.vtable)).AddItem(@as(*const ISClusResPossibleOwnerNodes, @ptrCast(self)), p_node_);
            }
            pub inline fn removeItem(self: *const T, var_index_: VARIANT) HRESULT {
                return @as(*const ISClusResPossibleOwnerNodes.VTable, @ptrCast(self.vtable)).RemoveItem(@as(*const ISClusResPossibleOwnerNodes, @ptrCast(self)), var_index_);
            }
            pub inline fn getModified(self: *const T, pvar_modified_: ?*VARIANT) HRESULT {
                return @as(*const ISClusResPossibleOwnerNodes.VTable, @ptrCast(self.vtable)).get_Modified(@as(*const ISClusResPossibleOwnerNodes, @ptrCast(self)), pvar_modified_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusResTypePossibleOwnerNodes = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCount(self: *const T, pl_count_: ?*i32) HRESULT {
                return @as(*const ISClusResTypePossibleOwnerNodes.VTable, @ptrCast(self.vtable)).get_Count(@as(*const ISClusResTypePossibleOwnerNodes, @ptrCast(self)), pl_count_);
            }
            pub inline fn getNewEnum(self: *const T, retval_: ?*?*IUnknown) HRESULT {
                return @as(*const ISClusResTypePossibleOwnerNodes.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISClusResTypePossibleOwnerNodes, @ptrCast(self)), retval_);
            }
            pub inline fn refresh(self: *const T) HRESULT {
            ...
            pub inline fn getItem(self: *const T, var_index_: VARIANT, pp_node_: ?*?*ISClusNode) HRESULT {
                return @as(*const ISClusResTypePossibleOwnerNodes.VTable, @ptrCast(self.vtable)).get_Item(@as(*const ISClusResTypePossibleOwnerNodes, @ptrCast(self)), var_index_, pp_node_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusResType = extern struct {
    pub const VTable = extern struct {
        ...
        get_Resources: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusResType,
            pp_cluster_res_type_resources: ?*?*ISClusResTypeResources,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_PossibleOwnerNodes: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusResType,
            pp_owner_nodes: ?*?*ISClusResTypePossibleOwnerNodes,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_AvailableDisks: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusResType,
            pp_available_disks: ?*?*ISClusDisks,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCommonProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISClusResType.VTable, @ptrCast(self.vtable)).get_CommonProperties(@as(*const ISClusResType, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getPrivateProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISClusResType.VTable, @ptrCast(self.vtable)).get_PrivateProperties(@as(*const ISClusResType, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getCommonROProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISClusResType.VTable, @ptrCast(self.vtable)).get_CommonROProperties(@as(*const ISClusResType, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getPrivateROProperties(self: *const T, pp_properties_: ?*?*ISClusProperties) HRESULT {
                return @as(*const ISClusResType.VTable, @ptrCast(self.vtable)).get_PrivateROProperties(@as(*const ISClusResType, @ptrCast(self)), pp_properties_);
            }
            pub inline fn getName(self: *const T, pbstr_name_: ?*?BSTR) HRESULT {
                return @as(*const ISClusResType.VTable, @ptrCast(self.vtable)).get_Name(@as(*const ISClusResType, @ptrCast(self)), pbstr_name_);
            }
            pub inline fn delete(self: *const T) HRESULT {
                return @as(*const ISClusResType.VTable, @ptrCast(self.vtable)).Delete(@as(*const ISClusResType, @ptrCast(self)));
            }
            pub inline fn getCluster(self: *const T, pp_cluster_: ?*?*ISCluster) HRESULT {
                return @as(*const ISClusResType.VTable, @ptrCast(self.vtable)).get_Cluster(@as(*const ISClusResType, @ptrCast(self)), pp_cluster_);
            }
            pub inline fn getResources(self: *const T, pp_cluster_res_type_resources_: ?*?*ISClusResTypeResources) HRESULT {
                return @as(*const ISClusResType.VTable, @ptrCast(self.vtable)).get_Resources(@as(*const ISClusResType, @ptrCast(self)), pp_cluster_res_type_resources_);
            }
            pub inline fn getPossibleOwnerNodes(self: *const T, pp_owner_nodes_: ?*?*ISClusResTypePossibleOwnerNodes) HRESULT {
                return @as(*const ISClusResType.VTable, @ptrCast(self.vtable)).get_PossibleOwnerNodes(@as(*const ISClusResType, @ptrCast(self)), pp_owner_nodes_);
            }
            pub inline fn getAvailableDisks(self: *const T, pp_available_disks_: ?*?*ISClusDisks) HRESULT {
                return @as(*const ISClusResType.VTable, @ptrCast(self.vtable)).get_AvailableDisks(@as(*const ISClusResType, @ptrCast(self)), pp_available_disks_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusResTypes = extern struct {
    pub const VTable = extern struct {
        ...
        get_Item: *const fn (
            ...
            self: *const ISClusResTypes,
            var_index: VARIANT,
            pp_clus_res_type: ?*?*ISClusResType,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        CreateItem: *const fn (
            self: *const ISClusResTypes,
            bstr_resource_type_name: ?BSTR,
            bstr_display_name: ?BSTR,
            bstr_resource_type_dll: ?BSTR,
            dw_looks_alive_poll_interval: i32,
            dw_is_alive_poll_interval: i32,
            pp_resource_type: ?*?*ISClusResType,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        DeleteItem: *const fn (
            self: *const ISClusResTypes,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCount(self: *const T, pl_count_: ?*i32) HRESULT {
                return @as(*const ISClusResTypes.VTable, @ptrCast(self.vtable)).get_Count(@as(*const ISClusResTypes, @ptrCast(self)), pl_count_);
            }
            pub inline fn getNewEnum(self: *const T, retval_: ?*?*IUnknown) HRESULT {
                return @as(*const ISClusResTypes.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISClusResTypes, @ptrCast(self)), retval_);
            }
            pub inline fn refresh(self: *const T) HRESULT {
                return @as(*const ISClusResTypes.VTable, @ptrCast(self.vtable)).Refresh(@as(*const ISClusResTypes, @ptrCast(self)));
            }
            pub inline fn getItem(self: *const T, var_index_: VARIANT, pp_clus_res_type_: ?*?*ISClusResType) HRESULT {
                return @as(*const ISClusResTypes.VTable, @ptrCast(self.vtable)).get_Item(@as(*const ISClusResTypes, @ptrCast(self)), var_index_, pp_clus_res_type_);
            }
            pub inline fn createItem(self: *const T, bstr_resource_type_name_: ?BSTR, bstr_display_name_: ?BSTR, bstr_resource_type_dll_: ?BSTR, dw_looks_alive_poll_interval_: i32, dw_is_alive_poll_interval_: i32, pp_resource_type_: ?*?*ISClusResType) HRESULT {
                return @as(*const ISClusResTypes.VTable, @ptrCast(self.vtable)).CreateItem(@as(*const ISClusResTypes, @ptrCast(self)), bstr_resource_type_name_, bstr_display_name_, bstr_resource_type_dll_, dw_looks_alive_poll_interval_, dw_is_alive_poll_interval_, pp_resource_type_);
            }
            pub inline fn deleteItem(self: *const T, var_index_: VARIANT) HRESULT {
                return @as(*const ISClusResTypes.VTable, @ptrCast(self.vtable)).DeleteItem(@as(*const ISClusResTypes, @ptrCast(self)), var_index_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusProperty = extern struct {
    pub const VTable = extern struct {
        ...
        get_Values: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusProperty,
            pp_cluster_property_values: ?*?*ISClusPropertyValues,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_Value: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
        ...
        get_Format: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusProperty,
            p_format: ?*CLUSTER_PROPERTY_FORMAT,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        put_Format: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
        ...
        get_ReadOnly: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusProperty,
            pvar_read_only: ?*VARIANT,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_Private: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusProperty,
            pvar_private: ?*VARIANT,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_Common: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getName(self: *const T, pbstr_name_: ?*?BSTR) HRESULT {
                return @as(*const ISClusProperty.VTable, @ptrCast(self.vtable)).get_Name(@as(*const ISClusProperty, @ptrCast(self)), pbstr_name_);
            }
            pub inline fn getLength(self: *const T, p_length_: ?*i32) HRESULT {
                return @as(*const ISClusProperty.VTable, @ptrCast(self.vtable)).get_Length(@as(*const ISClusProperty, @ptrCast(self)), p_length_);
            }
            pub inline fn getValueCount(self: *const T, p_count_: ?*i32) HRESULT {
                return @as(*const ISClusProperty.VTable, @ptrCast(self.vtable)).get_ValueCount(@as(*const ISClusProperty, @ptrCast(self)), p_count_);
            }
            pub inline fn getValues(self: *const T, pp_cluster_property_values_: ?*?*ISClusPropertyValues) HRESULT {
                return @as(*const ISClusProperty.VTable, @ptrCast(self.vtable)).get_Values(@as(*const ISClusProperty, @ptrCast(self)), pp_cluster_property_values_);
            }
            pub inline fn getValue(self: *const T, pvar_value_: ?*VARIANT) HRESULT {
                return @as(*const ISClusProperty.VTable, @ptrCast(self.vtable)).get_Value(@as(*const ISClusProperty, @ptrCast(self)), pvar_value_);
            }
            pub inline fn putValue(self: *const T, var_value_: VARIANT) HRESULT {
                return @as(*const ISClusProperty.VTable, @ptrCast(self.vtable)).put_Value(@as(*const ISClusProperty, @ptrCast(self)), var_value_);
            }
            pub inline fn getType(self: *const T, p_type_: ?*CLUSTER_PROPERTY_TYPE) HRESULT {
                return @as(*const ISClusProperty.VTable, @ptrCast(self.vtable)).get_Type(@as(*const ISClusProperty, @ptrCast(self)), p_type_);
            }
            pub inline fn putType(self: *const T, type_: CLUSTER_PROPERTY_TYPE) HRESULT {
                return @as(*const ISClusProperty.VTable, @ptrCast(self.vtable)).put_Type(@as(*const ISClusProperty, @ptrCast(self)), type_);
            }
            pub inline fn getFormat(self: *const T, p_format_: ?*CLUSTER_PROPERTY_FORMAT) HRESULT {
                return @as(*const ISClusProperty.VTable, @ptrCast(self.vtable)).get_Format(@as(*const ISClusProperty, @ptrCast(self)), p_format_);
            }
            pub inline fn putFormat(self: *const T, format_: CLUSTER_PROPERTY_FORMAT) HRESULT {
                return @as(*const ISClusProperty.VTable, @ptrCast(self.vtable)).put_Format(@as(*const ISClusProperty, @ptrCast(self)), format_);
            }
            pub inline fn getReadOnly(self: *const T, pvar_read_only_: ?*VARIANT) HRESULT {
                return @as(*const ISClusProperty.VTable, @ptrCast(self.vtable)).get_ReadOnly(@as(*const ISClusProperty, @ptrCast(self)), pvar_read_only_);
            }
            pub inline fn getPrivate(self: *const T, pvar_private_: ?*VARIANT) HRESULT {
                return @as(*const ISClusProperty.VTable, @ptrCast(self.vtable)).get_Private(@as(*const ISClusProperty, @ptrCast(self)), pvar_private_);
            }
            pub inline fn getCommon(self: *const T, pvar_common_: ?*VARIANT) HRESULT {
                return @as(*const ISClusProperty.VTable, @ptrCast(self.vtable)).get_Common(@as(*const ISClusProperty, @ptrCast(self)), pvar_common_);
            }
            pub inline fn getModified(self: *const T, pvar_modified_: ?*VARIANT) HRESULT {
                return @as(*const ISClusProperty.VTable, @ptrCast(self.vtable)).get_Modified(@as(*const ISClusProperty, @ptrCast(self)), pvar_modified_);
            }
            pub inline fn useDefaultValue(self: *const T) HRESULT {
...
pub const ISClusPropertyValue = extern struct {
    pub const VTable = extern struct {
        ...
        get_Data: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusPropertyValue,
            pp_cluster_property_value_data: ?*?*ISClusPropertyValueData,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getValue(self: *const T, pvar_value_: ?*VARIANT) HRESULT {
                return @as(*const ISClusPropertyValue.VTable, @ptrCast(self.vtable)).get_Value(@as(*const ISClusPropertyValue, @ptrCast(self)), pvar_value_);
            }
            pub inline fn putValue(self: *const T, var_value_: VARIANT) HRESULT {
                return @as(*const ISClusPropertyValue.VTable, @ptrCast(self.vtable)).put_Value(@as(*const ISClusPropertyValue, @ptrCast(self)), var_value_);
            }
            pub inline fn getType(self: *const T, p_type_: ?*CLUSTER_PROPERTY_TYPE) HRESULT {
                return @as(*const ISClusPropertyValue.VTable, @ptrCast(self.vtable)).get_Type(@as(*const ISClusPropertyValue, @ptrCast(self)), p_type_);
            }
            pub inline fn putType(self: *const T, type_: CLUSTER_PROPERTY_TYPE) HRESULT {
                return @as(*const ISClusPropertyValue.VTable, @ptrCast(self.vtable)).put_Type(@as(*const ISClusPropertyValue, @ptrCast(self)), type_);
            }
            pub inline fn getFormat(self: *const T, p_format_: ?*CLUSTER_PROPERTY_FORMAT) HRESULT {
                return @as(*const ISClusPropertyValue.VTable, @ptrCast(self.vtable)).get_Format(@as(*const ISClusPropertyValue, @ptrCast(self)), p_format_);
            }
            pub inline fn putFormat(self: *const T, format_: CLUSTER_PROPERTY_FORMAT) HRESULT {
                return @as(*const ISClusPropertyValue.VTable, @ptrCast(self.vtable)).put_Format(@as(*const ISClusPropertyValue, @ptrCast(self)), format_);
            }
            pub inline fn getLength(self: *const T, p_length_: ?*i32) HRESULT {
                return @as(*const ISClusPropertyValue.VTable, @ptrCast(self.vtable)).get_Length(@as(*const ISClusPropertyValue, @ptrCast(self)), p_length_);
            }
            pub inline fn getDataCount(self: *const T, p_count_: ?*i32) HRESULT {
                return @as(*const ISClusPropertyValue.VTable, @ptrCast(self.vtable)).get_DataCount(@as(*const ISClusPropertyValue, @ptrCast(self)), p_count_);
            }
            pub inline fn getData(self: *const T, pp_cluster_property_value_data_: ?*?*ISClusPropertyValueData) HRESULT {
                return @as(*const ISClusPropertyValue.VTable, @ptrCast(self.vtable)).get_Data(@as(*const ISClusPropertyValue, @ptrCast(self)), pp_cluster_property_value_data_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusPropertyValues = extern struct {
    pub const VTable = extern struct {
        ...
        get_Item: *const fn (
            ...
            self: *const ISClusPropertyValues,
            var_index: VARIANT,
            pp_property_value: ?*?*ISClusPropertyValue,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        CreateItem: *const fn (
            self: *const ISClusPropertyValues,
            bstr_name: ?BSTR,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCount(self: *const T, pl_count_: ?*i32) HRESULT {
                return @as(*const ISClusPropertyValues.VTable, @ptrCast(self.vtable)).get_Count(@as(*const ISClusPropertyValues, @ptrCast(self)), pl_count_);
            }
            pub inline fn getNewEnum(self: *const T, retval_: ?*?*IUnknown) HRESULT {
                return @as(*const ISClusPropertyValues.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISClusPropertyValues, @ptrCast(self)), retval_);
            }
            pub inline fn getItem(self: *const T, var_index_: VARIANT, pp_property_value_: ?*?*ISClusPropertyValue) HRESULT {
                return @as(*const ISClusPropertyValues.VTable, @ptrCast(self.vtable)).get_Item(@as(*const ISClusPropertyValues, @ptrCast(self)), var_index_, pp_property_value_);
            }
            pub inline fn createItem(self: *const T, bstr_name_: ?BSTR, var_value_: VARIANT, pp_property_value_: ?*?*ISClusPropertyValue) HRESULT {
                return @as(*const ISClusPropertyValues.VTable, @ptrCast(self.vtable)).CreateItem(@as(*const ISClusPropertyValues, @ptrCast(self)), bstr_name_, var_value_, pp_property_value_);
            }
            pub inline fn removeItem(self: *const T, var_index_: VARIANT) HRESULT {
                return @as(*const ISClusPropertyValues.VTable, @ptrCast(self.vtable)).RemoveItem(@as(*const ISClusPropertyValues, @ptrCast(self)), var_index_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusProperties = extern struct {
    pub const VTable = extern struct {
        ...
        get_Item: *const fn (
            ...
            self: *const ISClusProperties,
            var_index: VARIANT,
            pp_clus_property: ?*?*ISClusProperty,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        CreateItem: *const fn (
            self: *const ISClusProperties,
            bstr_name: ?BSTR,
            var_value: VARIANT,
            p_property: ?*?*ISClusProperty,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        UseDefaultValue: *const fn (
            self: *const ISClusProperties,
            var_index: VARIANT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCount(self: *const T, pl_count_: ?*i32) HRESULT {
                return @as(*const ISClusProperties.VTable, @ptrCast(self.vtable)).get_Count(@as(*const ISClusProperties, @ptrCast(self)), pl_count_);
            }
            pub inline fn getNewEnum(self: *const T, retval_: ?*?*IUnknown) HRESULT {
                return @as(*const ISClusProperties.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISClusProperties, @ptrCast(self)), retval_);
            }
            pub inline fn refresh(self: *const T) HRESULT {
                return @as(*const ISClusProperties.VTable, @ptrCast(self.vtable)).Refresh(@as(*const ISClusProperties, @ptrCast(self)));
            }
            pub inline fn getItem(self: *const T, var_index_: VARIANT, pp_clus_property_: ?*?*ISClusProperty) HRESULT {
                return @as(*const ISClusProperties.VTable, @ptrCast(self.vtable)).get_Item(@as(*const ISClusProperties, @ptrCast(self)), var_index_, pp_clus_property_);
            }
            pub inline fn createItem(self: *const T, bstr_name_: ?BSTR, var_value_: VARIANT, p_property_: ?*?*ISClusProperty) HRESULT {
                return @as(*const ISClusProperties.VTable, @ptrCast(self.vtable)).CreateItem(@as(*const ISClusProperties, @ptrCast(self)), bstr_name_, var_value_, p_property_);
            }
            pub inline fn useDefaultValue(self: *const T, var_index_: VARIANT) HRESULT {
                return @as(*const ISClusProperties.VTable, @ptrCast(self.vtable)).UseDefaultValue(@as(*const ISClusProperties, @ptrCast(self)), var_index_);
            }
            pub inline fn saveChanges(self: *const T, pvar_status_code_: ?*VARIANT) HRESULT {
                return @as(*const ISClusProperties.VTable, @ptrCast(self.vtable)).SaveChanges(@as(*const ISClusProperties, @ptrCast(self)), pvar_status_code_);
            }
            pub inline fn getReadOnly(self: *const T, pvar_read_only_: ?*VARIANT) HRESULT {
                return @as(*const ISClusProperties.VTable, @ptrCast(self.vtable)).get_ReadOnly(@as(*const ISClusProperties, @ptrCast(self)), pvar_read_only_);
            }
            pub inline fn getPrivate(self: *const T, pvar_private_: ?*VARIANT) HRESULT {
                return @as(*const ISClusProperties.VTable, @ptrCast(self.vtable)).get_Private(@as(*const ISClusProperties, @ptrCast(self)), pvar_private_);
            }
            pub inline fn getCommon(self: *const T, pvar_common_: ?*VARIANT) HRESULT {
                return @as(*const ISClusProperties.VTable, @ptrCast(self.vtable)).get_Common(@as(*const ISClusProperties, @ptrCast(self)), pvar_common_);
            }
            pub inline fn getModified(self: *const T, pvar_modified_: ?*VARIANT) HRESULT {
                return @as(*const ISClusProperties.VTable, @ptrCast(self.vtable)).get_Modified(@as(*const ISClusProperties, @ptrCast(self)), pvar_modified_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusPropertyValueData = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCount(self: *const T, pl_count_: ?*i32) HRESULT {
                return @as(*const ISClusPropertyValueData.VTable, @ptrCast(self.vtable)).get_Count(@as(*const ISClusPropertyValueData, @ptrCast(self)), pl_count_);
            }
            pub inline fn getNewEnum(self: *const T, retval_: ?*?*IUnknown) HRESULT {
                return @as(*const ISClusPropertyValueData.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISClusPropertyValueData, @ptrCast(self)), retval_);
            }
            pub inline fn getItem(self: *const T, var_index_: VARIANT, pvar_value_: ?*VARIANT) HRESULT {
                return @as(*const ISClusPropertyValueData.VTable, @ptrCast(self.vtable)).get_Item(@as(*const ISClusPropertyValueData, @ptrCast(self)), var_index_, pvar_value_);
            }
            pub inline fn createItem(self: *const T, var_value_: VARIANT, pvar_data_: ?*VARIANT) HRESULT {
                return @as(*const ISClusPropertyValueData.VTable, @ptrCast(self.vtable)).CreateItem(@as(*const ISClusPropertyValueData, @ptrCast(self)), var_value_, pvar_data_);
            }
            pub inline fn removeItem(self: *const T, var_index_: VARIANT) HRESULT {
                return @as(*const ISClusPropertyValueData.VTable, @ptrCast(self.vtable)).RemoveItem(@as(*const ISClusPropertyValueData, @ptrCast(self)), var_index_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusPartition = extern struct {
    pub const VTable = extern struct {
        ...
        get_VolumeLabel: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusPartition,
            pbstr_volume_label: ?*?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_SerialNumber: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusPartition,
            pl_serial_number: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_MaximumComponentLength: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusPartition,
            pl_maximum_component_length: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_FileSystemFlags: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusPartition,
            pl_file_system_flags: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_FileSystem: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusPartition,
            pbstr_file_system: ?*?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getFlags(self: *const T, pl_flags_: ?*i32) HRESULT {
                return @as(*const ISClusPartition.VTable, @ptrCast(self.vtable)).get_Flags(@as(*const ISClusPartition, @ptrCast(self)), pl_flags_);
            }
            pub inline fn getDeviceName(self: *const T, pbstr_device_name_: ?*?BSTR) HRESULT {
                return @as(*const ISClusPartition.VTable, @ptrCast(self.vtable)).get_DeviceName(@as(*const ISClusPartition, @ptrCast(self)), pbstr_device_name_);
            }
            pub inline fn getVolumeLabel(self: *const T, pbstr_volume_label_: ?*?BSTR) HRESULT {
                return @as(*const ISClusPartition.VTable, @ptrCast(self.vtable)).get_VolumeLabel(@as(*const ISClusPartition, @ptrCast(self)), pbstr_volume_label_);
            }
            pub inline fn getSerialNumber(self: *const T, pl_serial_number_: ?*i32) HRESULT {
                return @as(*const ISClusPartition.VTable, @ptrCast(self.vtable)).get_SerialNumber(@as(*const ISClusPartition, @ptrCast(self)), pl_serial_number_);
            }
            pub inline fn getMaximumComponentLength(self: *const T, pl_maximum_component_length_: ?*i32) HRESULT {
                return @as(*const ISClusPartition.VTable, @ptrCast(self.vtable)).get_MaximumComponentLength(@as(*const ISClusPartition, @ptrCast(self)), pl_maximum_component_length_);
            }
            pub inline fn getFileSystemFlags(self: *const T, pl_file_system_flags_: ?*i32) HRESULT {
                return @as(*const ISClusPartition.VTable, @ptrCast(self.vtable)).get_FileSystemFlags(@as(*const ISClusPartition, @ptrCast(self)), pl_file_system_flags_);
            }
            pub inline fn getFileSystem(self: *const T, pbstr_file_system_: ?*?BSTR) HRESULT {
                return @as(*const ISClusPartition.VTable, @ptrCast(self.vtable)).get_FileSystem(@as(*const ISClusPartition, @ptrCast(self)), pbstr_file_system_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusPartitionEx = extern struct {
    pub const VTable = extern struct {
        ...
        get_DeviceNumber: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusPartitionEx,
            pl_device_number: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_PartitionNumber: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusPartitionEx,
            pl_partition_number: ?*i32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_VolumeGuid: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusPartitionEx,
            pbstr_volume_guid: ?*?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getTotalSize(self: *const T, pl_total_size_: ?*i32) HRESULT {
                return @as(*const ISClusPartitionEx.VTable, @ptrCast(self.vtable)).get_TotalSize(@as(*const ISClusPartitionEx, @ptrCast(self)), pl_total_size_);
            }
            pub inline fn getFreeSpace(self: *const T, pl_free_space_: ?*i32) HRESULT {
                return @as(*const ISClusPartitionEx.VTable, @ptrCast(self.vtable)).get_FreeSpace(@as(*const ISClusPartitionEx, @ptrCast(self)), pl_free_space_);
            }
            pub inline fn getDeviceNumber(self: *const T, pl_device_number_: ?*i32) HRESULT {
                return @as(*const ISClusPartitionEx.VTable, @ptrCast(self.vtable)).get_DeviceNumber(@as(*const ISClusPartitionEx, @ptrCast(self)), pl_device_number_);
            }
            pub inline fn getPartitionNumber(self: *const T, pl_partition_number_: ?*i32) HRESULT {
                return @as(*const ISClusPartitionEx.VTable, @ptrCast(self.vtable)).get_PartitionNumber(@as(*const ISClusPartitionEx, @ptrCast(self)), pl_partition_number_);
            }
            pub inline fn getVolumeGuid(self: *const T, pbstr_volume_guid_: ?*?BSTR) HRESULT {
                return @as(*const ISClusPartitionEx.VTable, @ptrCast(self.vtable)).get_VolumeGuid(@as(*const ISClusPartitionEx, @ptrCast(self)), pbstr_volume_guid_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusPartitions = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCount(self: *const T, pl_count_: ?*i32) HRESULT {
                return @as(*const ISClusPartitions.VTable, @ptrCast(self.vtable)).get_Count(@as(*const ISClusPartitions, @ptrCast(self)), pl_count_);
            }
            pub inline fn getNewEnum(self: *const T, retval_: ?*?*IUnknown) HRESULT {
                return @as(*const ISClusPartitions.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISClusPartitions, @ptrCast(self)), retval_);
            }
            pub inline fn getItem(self: *const T, var_index_: VARIANT, pp_partition_: ?*?*ISClusPartition) HRESULT {
                return @as(*const ISClusPartitions.VTable, @ptrCast(self.vtable)).get_Item(@as(*const ISClusPartitions, @ptrCast(self)), var_index_, pp_partition_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusDisk = extern struct {
    pub const VTable = extern struct {
        ...
        get_ScsiAddress: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusDisk,
            pp_scsi_address: ?*?*ISClusScsiAddress,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        ...
        get_Partitions: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusDisk,
            pp_partitions: ?*?*ISClusPartitions,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getSignature(self: *const T, pl_signature_: ?*i32) HRESULT {
                return @as(*const ISClusDisk.VTable, @ptrCast(self.vtable)).get_Signature(@as(*const ISClusDisk, @ptrCast(self)), pl_signature_);
            }
            pub inline fn getScsiAddress(self: *const T, pp_scsi_address_: ?*?*ISClusScsiAddress) HRESULT {
                return @as(*const ISClusDisk.VTable, @ptrCast(self.vtable)).get_ScsiAddress(@as(*const ISClusDisk, @ptrCast(self)), pp_scsi_address_);
            }
            pub inline fn getDiskNumber(self: *const T, pl_disk_number_: ?*i32) HRESULT {
                return @as(*const ISClusDisk.VTable, @ptrCast(self.vtable)).get_DiskNumber(@as(*const ISClusDisk, @ptrCast(self)), pl_disk_number_);
            }
            pub inline fn getPartitions(self: *const T, pp_partitions_: ?*?*ISClusPartitions) HRESULT {
                return @as(*const ISClusDisk.VTable, @ptrCast(self.vtable)).get_Partitions(@as(*const ISClusDisk, @ptrCast(self)), pp_partitions_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusDisks = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCount(self: *const T, pl_count_: ?*i32) HRESULT {
                return @as(*const ISClusDisks.VTable, @ptrCast(self.vtable)).get_Count(@as(*const ISClusDisks, @ptrCast(self)), pl_count_);
            }
            pub inline fn getNewEnum(self: *const T, retval_: ?*?*IUnknown) HRESULT {
                return @as(*const ISClusDisks.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISClusDisks, @ptrCast(self)), retval_);
            }
            pub inline fn getItem(self: *const T, var_index_: VARIANT, pp_disk_: ?*?*ISClusDisk) HRESULT {
                return @as(*const ISClusDisks.VTable, @ptrCast(self.vtable)).get_Item(@as(*const ISClusDisks, @ptrCast(self)), var_index_, pp_disk_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusScsiAddress = extern struct {
    pub const VTable = extern struct {
        ...
        get_PortNumber: *const fn (
            ...
            pvar_port_number: ?*VARIANT,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_PathId: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusScsiAddress,
            pvar_path_id: ?*VARIANT,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_TargetId: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
            self: *const ISClusScsiAddress,
            pvar_target_id: ?*VARIANT,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        // TODO: this function has a "SpecialName", should Zig do anything with this?
        get_Lun: *const fn (
            // TODO: this function has a "SpecialName", should Zig do anything with this?
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getPortNumber(self: *const T, pvar_port_number_: ?*VARIANT) HRESULT {
                return @as(*const ISClusScsiAddress.VTable, @ptrCast(self.vtable)).get_PortNumber(@as(*const ISClusScsiAddress, @ptrCast(self)), pvar_port_number_);
            }
            pub inline fn getPathId(self: *const T, pvar_path_id_: ?*VARIANT) HRESULT {
                return @as(*const ISClusScsiAddress.VTable, @ptrCast(self.vtable)).get_PathId(@as(*const ISClusScsiAddress, @ptrCast(self)), pvar_path_id_);
            }
            pub inline fn getTargetId(self: *const T, pvar_target_id_: ?*VARIANT) HRESULT {
                return @as(*const ISClusScsiAddress.VTable, @ptrCast(self.vtable)).get_TargetId(@as(*const ISClusScsiAddress, @ptrCast(self)), pvar_target_id_);
            }
            pub inline fn getLun(self: *const T, pvar_lun_: ?*VARIANT) HRESULT {
                return @as(*const ISClusScsiAddress.VTable, @ptrCast(self.vtable)).get_Lun(@as(*const ISClusScsiAddress, @ptrCast(self)), pvar_lun_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusRegistryKeys = extern struct {
    pub const VTable = extern struct {
        ...
        get_Item: *const fn (
            ...
            self: *const ISClusRegistryKeys,
            var_index: VARIANT,
            pbstr_registry_key: ?*?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        AddItem: *const fn (
            self: *const ISClusRegistryKeys,
            bstr_registry_key: ?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        RemoveItem: *const fn (
            self: *const ISClusRegistryKeys,
            var_index: VARIANT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCount(self: *const T, pl_count_: ?*i32) HRESULT {
                return @as(*const ISClusRegistryKeys.VTable, @ptrCast(self.vtable)).get_Count(@as(*const ISClusRegistryKeys, @ptrCast(self)), pl_count_);
            }
            pub inline fn getNewEnum(self: *const T, retval_: ?*?*IUnknown) HRESULT {
                return @as(*const ISClusRegistryKeys.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISClusRegistryKeys, @ptrCast(self)), retval_);
            }
            pub inline fn refresh(self: *const T) HRESULT {
                return @as(*const ISClusRegistryKeys.VTable, @ptrCast(self.vtable)).Refresh(@as(*const ISClusRegistryKeys, @ptrCast(self)));
            }
            pub inline fn getItem(self: *const T, var_index_: VARIANT, pbstr_registry_key_: ?*?BSTR) HRESULT {
                return @as(*const ISClusRegistryKeys.VTable, @ptrCast(self.vtable)).get_Item(@as(*const ISClusRegistryKeys, @ptrCast(self)), var_index_, pbstr_registry_key_);
            }
            pub inline fn addItem(self: *const T, bstr_registry_key_: ?BSTR) HRESULT {
                return @as(*const ISClusRegistryKeys.VTable, @ptrCast(self.vtable)).AddItem(@as(*const ISClusRegistryKeys, @ptrCast(self)), bstr_registry_key_);
            }
            pub inline fn removeItem(self: *const T, var_index_: VARIANT) HRESULT {
                return @as(*const ISClusRegistryKeys.VTable, @ptrCast(self.vtable)).RemoveItem(@as(*const ISClusRegistryKeys, @ptrCast(self)), var_index_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusCryptoKeys = extern struct {
    pub const VTable = extern struct {
        ...
        get_Item: *const fn (
            ...
            self: *const ISClusCryptoKeys,
            var_index: VARIANT,
            pbstr_cyrpto_key: ?*?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        AddItem: *const fn (
            self: *const ISClusCryptoKeys,
            bstr_crypto_key: ?BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        RemoveItem: *const fn (
            self: *const ISClusCryptoKeys,
            var_index: VARIANT,
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCount(self: *const T, pl_count_: ?*i32) HRESULT {
                return @as(*const ISClusCryptoKeys.VTable, @ptrCast(self.vtable)).get_Count(@as(*const ISClusCryptoKeys, @ptrCast(self)), pl_count_);
            }
            pub inline fn getNewEnum(self: *const T, retval_: ?*?*IUnknown) HRESULT {
                return @as(*const ISClusCryptoKeys.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISClusCryptoKeys, @ptrCast(self)), retval_);
            }
            pub inline fn refresh(self: *const T) HRESULT {
                return @as(*const ISClusCryptoKeys.VTable, @ptrCast(self.vtable)).Refresh(@as(*const ISClusCryptoKeys, @ptrCast(self)));
            }
            pub inline fn getItem(self: *const T, var_index_: VARIANT, pbstr_cyrpto_key_: ?*?BSTR) HRESULT {
                return @as(*const ISClusCryptoKeys.VTable, @ptrCast(self.vtable)).get_Item(@as(*const ISClusCryptoKeys, @ptrCast(self)), var_index_, pbstr_cyrpto_key_);
            }
            pub inline fn addItem(self: *const T, bstr_crypto_key_: ?BSTR) HRESULT {
                return @as(*const ISClusCryptoKeys.VTable, @ptrCast(self.vtable)).AddItem(@as(*const ISClusCryptoKeys, @ptrCast(self)), bstr_crypto_key_);
            }
            pub inline fn removeItem(self: *const T, var_index_: VARIANT) HRESULT {
                return @as(*const ISClusCryptoKeys.VTable, @ptrCast(self.vtable)).RemoveItem(@as(*const ISClusCryptoKeys, @ptrCast(self)), var_index_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub const ISClusResDependents = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IDispatch.MethodMixin(T);
            pub inline fn getCount(self: *const T, pl_count_: ?*i32) HRESULT {
                return @as(*const ISClusResDependents.VTable, @ptrCast(self.vtable)).get_Count(@as(*const ISClusResDependents, @ptrCast(self)), pl_count_);
            }
            pub inline fn getNewEnum(self: *const T, retval_: ?*?*IUnknown) HRESULT {
                return @as(*const ISClusResDependents.VTable, @ptrCast(self.vtable)).get__NewEnum(@as(*const ISClusResDependents, @ptrCast(self)), retval_);
            }
            pub inline fn refresh(self: *const T) HRESULT {
                return @as(*const ISClusResDependents.VTable, @ptrCast(self.vtable)).Refresh(@as(*const ISClusResDependents, @ptrCast(self)));
            }
            pub inline fn getItem(self: *const T, var_index_: VARIANT, pp_clus_resource_: ?*?*ISClusResource) HRESULT {
                return @as(*const ISClusResDependents.VTable, @ptrCast(self.vtable)).get_Item(@as(*const ISClusResDependents, @ptrCast(self)), var_index_, pp_clus_resource_);
            }
            pub inline fn createItem(self: *const T, bstr_resource_name_: ?BSTR, bstr_resource_type_: ?BSTR, dw_flags_: CLUSTER_RESOURCE_CREATE_FLAGS, pp_cluster_resource_: ?*?*ISClusResource) HRESULT {
                return @as(*const ISClusResDependents.VTable, @ptrCast(self.vtable)).CreateItem(@as(*const ISClusResDependents, @ptrCast(self)), bstr_resource_name_, bstr_resource_type_, dw_flags_, pp_cluster_resource_);
            }
            pub inline fn deleteItem(self: *const T, var_index_: VARIANT) HRESULT {
                return @as(*const ISClusResDependents.VTable, @ptrCast(self.vtable)).DeleteItem(@as(*const ISClusResDependents, @ptrCast(self)), var_index_);
            }
            pub inline fn addItem(self: *const T, p_resource_: ?*ISClusResource) HRESULT {
                return @as(*const ISClusResDependents.VTable, @ptrCast(self.vtable)).AddItem(@as(*const ISClusResDependents, @ptrCast(self)), p_resource_);
            }
            pub inline fn removeItem(self: *const T, var_index_: VARIANT) HRESULT {
                return @as(*const ISClusResDependents.VTable, @ptrCast(self.vtable)).RemoveItem(@as(*const ISClusResDependents, @ptrCast(self)), var_index_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
...
pub extern "clusapi" fn GetClusterNotifyV2(
    ...
    buffer: ?*u8,
    lpb_buffer_size: ?*u32,
    lpsz_object_id: ?[*:0]u16,
    lpcch_object_id: ?*u32,
    lpsz_parent_id: ?[*:0]u16,
    lpcch_parent_id: ?*u32,
    lpsz_name: ?[*:0]u16,
    lpcch_name: ?*u32,
    lpsz_type: ?[*:0]u16,
...
pub extern "clusapi" fn SetClusterGroupSetDependencyExpression(
    h_group_set: ?*_HGROUPSET,
    lpsz_dependency_exprssion: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn ClusterGroupSetGetEnumCount(
    h_group_set_enum: ?*_HGROUPSETENUM,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn ClusterNodeReplacement(
    h_cluster: ?*_HCLUSTER,
    lpsz_node_name_current: ?[*:0]const u16,
    lpsz_node_name_new: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn ClusterNetInterfaceEnum(
    h_net_interface_enum: ?*_HNETINTERFACEENUM,
    dw_index: u32,
    lpsz_name: [*:0]u16,
    lpcch_name: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn CancelClusterGroupOperation(
    h_group: ?*_HGROUP,
    dw_cancel_flags__r_e_s_e_r_v_e_d: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn ClusterRegQueryInfoKey(
    h_key: ?HKEY,
    lpc_sub_keys: ?*u32,
    lpcch_max_sub_key_len: ?*u32,
    lpc_values: ?*u32,
    lpcch_max_value_name_len: ?*u32,
    lpcb_max_value_len: ?*u32,
    lpcb_security_descriptor: ?*u32,
    lpft_last_write_time: ?*FILETIME,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "clusapi" fn RemoveClusterNameAccount(
    h_cluster: ?*_HCLUSTER,
    b_delete_computer_objects: BOOL,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "clusapi" fn DetermineCNOResTypeFromNodelist(
    c_nodes: u32,
    ppsz_node_names: ?*?PWSTR,
    p_c_n_o_res_type: ?*CLUSTER_MGMT_POINT_RESTYPE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn DetermineClusterCloudTypeFromNodelist(
    c_nodes: u32,
    ppsz_node_names: ?*?PWSTR,
    p_cloud_type: ?*CLUSTER_CLOUD_TYPE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn AddClusterStorageNode(
    ...
    pfn_progress_callback: ?PCLUSTER_SETUP_PROGRESS_CALLBACK,
    pv_callback_arg: ?*anyopaque,
    lpsz_cluster_storage_node_description: ?[*:0]const u16,
    lpsz_cluster_storage_node_location: ?[*:0]const u16,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clusapi" fn RemoveClusterStorageNode(
    h_cluster: ?*_HCLUSTER,
    lpsz_cluster_storage_enclosure_name: ?[*:0]const u16,
    dw_timeout: u32,
    dw_flags: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "resutils" fn InitializeClusterHealthFault(
    cluster_health_fault: ?*CLUSTER_HEALTH_FAULT,
) callconv(@import("std").os.windows.WINAPI) u32;

// TODO: this type is limited to platform 'windowsServer2016'
pub extern "resutils" fn InitializeClusterHealthFaultArray(
    cluster_health_fault_array: ?*CLUSTER_HEALTH_FAULT_ARRAY,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "resutils" fn ClusWorkersTerminate(
    clus_workers: [*]?*CLUS_WORKER,
    clus_workers_count: usize,
    timeout_in_milliseconds: u32,
    wait_only: BOOL,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "resutils" fn ResUtilsDeleteKeyTree(
    key: ?HKEY,
    key_name: ?[*:0]const u16,
    treat_no_key_as_error: BOOL,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "resutils" fn ResUtilEnumGroups(
    h_cluster: ?*_HCLUSTER,
    h_self: ?*_HGROUP,
    p_res_call_back: ?LPGROUP_CALLBACK_EX,
    p_parameter: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "resutils" fn ResUtilNodeEnum(
    h_cluster: ?*_HCLUSTER,
    p_node_call_back: ?LPNODE_CALLBACK,
    p_parameter: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) u32;
