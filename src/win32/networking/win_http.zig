...
pub const LPWINHTTP_STATUS_CALLBACK = *const fn () callconv(@import("std").os.windows.WINAPI) void;
...
pub extern "winhttp" fn WinHttpSetStatusCallback(
    ...
    dw_notification_flags: u32,
    dw_reserved: usize,
    retval: *?WINHTTP_STATUS_CALLBACK,
) callconv(@import("std").os.windows.WINAPI) void;
...
pub extern "winhttp" fn WinHttpCrackUrl(
    ...
    dw_url_length: u32,
    dw_flags: u32,
    lp_url_components: ?*URL_COMPONENTS,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "winhttp" fn WinHttpOpen(
    psz_agent_w: ?[*:0]const u16,
    dw_access_type: WINHTTP_ACCESS_TYPE,
    psz_proxy_w: ?[*:0]const u16,
    psz_proxy_bypass_w: ?[*:0]const u16,
    dw_flags: u32,
...
pub extern "winhttp" fn WinHttpSetTimeouts(
    h_internet: ?*anyopaque,
    n_resolve_timeout: i32,
    n_connect_timeout: i32,
    n_send_timeout: i32,
    n_receive_timeout: i32,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "winhttp" fn WinHttpOpenRequest(
    h_connect: ?*anyopaque,
    pwsz_verb: ?[*:0]const u16,
    pwsz_object_name: ?[*:0]const u16,
    pwsz_version: ?[*:0]const u16,
    pwsz_referrer: ?[*:0]const u16,
    ppwsz_accept_types: ?*?PWSTR,
    dw_flags: WINHTTP_OPEN_REQUEST_FLAGS,
) callconv(@import("std").os.windows.WINAPI) ?*anyopaque;
...
pub extern "winhttp" fn WinHttpAddRequestHeadersEx(
    ...
    ull_extra: u64,
    c_headers: u32,
    p_headers: [*]WINHTTP_EXTENDED_HEADER,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "winhttp" fn WinHttpSetCredentials(
    ...
    p_auth_params: ?*anyopaque,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "winhttp" fn WinHttpQueryAuthSchemes(
    h_request: ?*anyopaque,
    lpdw_supported_schemes: ?*u32,
    lpdw_first_scheme: ?*u32,
    pdw_auth_target: ?*u32,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "winhttp" fn WinHttpQueryHeadersEx(
    ...
    ui_code_page: u32,
    pdw_index: ?*u32,
    p_header_name: ?*WINHTTP_HEADER_NAME,
    // TODO: what to do with BytesParamIndex 7?
    p_buffer: ?*anyopaque,
    pdw_buffer_length: ?*u32,
    pp_headers: ?[*]?*WINHTTP_EXTENDED_HEADER,
    pdw_headers_count: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "winhttp" fn WinHttpQueryConnectionGroup(
    h_internet: ?*anyopaque,
    p_guid_connection: ?*const Guid,
    ull_flags: u64,
    pp_result: ?*?*WINHTTP_QUERY_CONNECTION_GROUP_RESULT,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "winhttp" fn WinHttpFreeQueryConnectionGroupResult(
    p_result: ?*WINHTTP_QUERY_CONNECTION_GROUP_RESULT,
) callconv(@import("std").os.windows.WINAPI) void;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "winhttp" fn WinHttpDetectAutoProxyConfigUrl(
    dw_auto_detect_flags: u32,
    ppwstr_auto_config_url: ?*?PWSTR,
) callconv(@import("std").os.windows.WINAPI) BOOL;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "winhttp" fn WinHttpGetProxyForUrl(
    h_session: ?*anyopaque,
    lpcwsz_url: ?[*:0]const u16,
    p_auto_proxy_options: ?*WINHTTP_AUTOPROXY_OPTIONS,
    p_proxy_info: ?*WINHTTP_PROXY_INFO,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "winhttp" fn WinHttpGetProxyForUrlEx2(
    ...
    pcwsz_url: ?[*:0]const u16,
    p_auto_proxy_options: ?*WINHTTP_AUTOPROXY_OPTIONS,
    cb_interface_selection_context: u32,
    // TODO: what to do with BytesParamIndex 3?
    p_interface_selection_context: ?*u8,
    p_context: usize,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "winhttp" fn WinHttpGetProxyResult(
    h_resolver: ?*anyopaque,
    p_proxy_result: ?*WINHTTP_PROXY_RESULT,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "winhttp" fn WinHttpGetProxyResultEx(
    h_resolver: ?*anyopaque,
    p_proxy_result_ex: ?*WINHTTP_PROXY_RESULT_EX,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "winhttp" fn WinHttpGetIEProxyConfigForCurrentUser(
    p_proxy_config: ?*WINHTTP_CURRENT_USER_IE_PROXY_CONFIG,
) callconv(@import("std").os.windows.WINAPI) BOOL;

pub extern "winhttp" fn WinHttpWriteProxySettings(
    h_session: ?*anyopaque,
    f_force_update: BOOL,
    p_win_http_proxy_settings: ?*WINHTTP_PROXY_SETTINGS,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "winhttp" fn WinHttpReadProxySettings(
    h_session: ?*anyopaque,
    pcwsz_connection_name: ?[*:0]const u16,
    f_fall_back_to_default_settings: BOOL,
    f_set_auto_discover_for_default_settings: BOOL,
    pdw_settings_version: ?*u32,
    pf_default_settings_are_returned: ?*BOOL,
    p_win_http_proxy_settings: ?*WINHTTP_PROXY_SETTINGS,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "winhttp" fn WinHttpGetProxySettingsVersion(
    h_session: ?*anyopaque,
    pdw_proxy_settings_version: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "winhttp" fn WinHttpSetProxySettingsPerUser(
    f_proxy_settings_per_user: BOOL,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "winhttp" fn WinHttpWebSocketReceive(
    ...
    dw_buffer_length: u32,
    pdw_bytes_read: ?*u32,
    pe_buffer_type: ?*WINHTTP_WEB_SOCKET_BUFFER_TYPE,
) callconv(@import("std").os.windows.WINAPI) u32;
