...
pub const QUERYFORCONNECTION = *const fn (
    primary_connection: ?*ldap,
    referral_from_connection: ?*ldap,
    new_d_n: ?[*]u16,
    host_name: ?[*]u8,
    port_number: u32,
    sec_auth_identity: ?*anyopaque,
    current_user_token: ?*anyopaque,
    connection_to_use: ?*?*ldap,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const NOTIFYOFNEWCONNECTION = *const fn (
    ...
    port_number: u32,
    sec_auth_identity: ?*anyopaque,
    current_user: ?*anyopaque,
    error_code_from_bind: u32,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;

pub const DEREFERENCECONNECTION = *const fn (
    primary_connection: ?*ldap,
    connection_to_dereference: ?*ldap,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub const QUERYCLIENTCERT = *const fn (
    connection: ?*ldap,
    trusted__c_as: ?*SecPkgContext_IssuerListInfoEx,
    pp_certificate: ?*?*CERT_CONTEXT,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;

pub const VERIFYSERVERCERT = *const fn (
    connection: ?*ldap,
    p_server_cert: ?*?*CERT_CONTEXT,
) callconv(@import("std").os.windows.WINAPI) BOOLEAN;
...
pub extern "wldap32" fn ldap_sasl_bindA(
    external_handle: ?*ldap,
    dist_name: ?[*:0]const u8,
    auth_mechanism: ?[*:0]const u8,
    cred: ?*const LDAP_BERVAL,
    server_ctrls: ?*?*ldapcontrolA,
    client_ctrls: ?*?*ldapcontrolA,
    message_number: ?*i32,
...
pub extern "wldap32" fn ldap_sasl_bindW(
    external_handle: ?*ldap,
    dist_name: ?[*:0]const u16,
    auth_mechanism: ?[*:0]const u16,
    cred: ?*const LDAP_BERVAL,
    server_ctrls: ?*?*ldapcontrolW,
    client_ctrls: ?*?*ldapcontrolW,
    message_number: ?*i32,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub extern "wldap32" fn ldap_search_extW(
    ...
    attrs: ?*?*u16,
    attrsonly: u32,
    server_controls: ?*?*ldapcontrolW,
    client_controls: ?*?*ldapcontrolW,
    time_limit: u32,
    size_limit: u32,
    message_number: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wldap32" fn ldap_search_extA(
    ...
    attrs: ?*?*i8,
    attrsonly: u32,
    server_controls: ?*?*ldapcontrolA,
    client_controls: ?*?*ldapcontrolA,
    time_limit: u32,
    size_limit: u32,
    message_number: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wldap32" fn ldap_modrdn2W(
    external_handle: ?*ldap,
    distinguished_name: ?[*:0]const u16,
    new_distinguished_name: ?[*:0]const u16,
    delete_old_rdn: i32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wldap32" fn ldap_modrdn2A(
    external_handle: ?*ldap,
    distinguished_name: ?[*:0]const u8,
    new_distinguished_name: ?[*:0]const u8,
    delete_old_rdn: i32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wldap32" fn ldap_rename_extW(
    ld: ?*ldap,
    dn: ?[*:0]const u16,
    new_r_d_n: ?[*:0]const u16,
    new_parent: ?[*:0]const u16,
    delete_old_rdn: i32,
    server_controls: ?*?*ldapcontrolW,
    client_controls: ?*?*ldapcontrolW,
    message_number: ?*u32,
...
pub extern "wldap32" fn ldap_rename_extA(
    ld: ?*ldap,
    dn: ?[*:0]const u8,
    new_r_d_n: ?[*:0]const u8,
    new_parent: ?[*:0]const u8,
    delete_old_rdn: i32,
    server_controls: ?*?*ldapcontrolA,
    client_controls: ?*?*ldapcontrolA,
    message_number: ?*u32,
...
pub extern "wldap32" fn ldap_escape_filter_elementW(
    ...
    source_filter_element: ?[*]u8,
    source_length: u32,
    // TODO: what to do with BytesParamIndex 3?
    dest_filter_element: ?[*]u16,
    dest_length: u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "wldap32" fn ldap_search_init_pageW(
    ...
    distinguished_name: ?[*:0]const u16,
    scope_of_search: u32,
    search_filter: ?[*:0]const u16,
    attribute_list: ?*?*u16,
    attributes_only: u32,
    server_controls: ?*?*ldapcontrolW,
    client_controls: ?*?*ldapcontrolW,
    page_time_limit: u32,
    total_size_limit: u32,
    sort_keys: ?*?*ldapsortkeyW,
