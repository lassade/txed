...
pub const IReferenceClock = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            ...
            pub inline fn getTime(self: *const T, p_time_: ?*i64) HRESULT {
                return @as(*const IReferenceClock.VTable, @ptrCast(self.vtable)).GetTime(@as(*const IReferenceClock, @ptrCast(self)), p_time_);
            }
            pub inline fn adviseTime(self: *const T, base_time_: i64, stream_time_: i64, h_event_: ?HANDLE, pdw_advise_cookie_: ?*usize) HRESULT {
                return @as(*const IReferenceClock.VTable, @ptrCast(self.vtable)).AdviseTime(@as(*const IReferenceClock, @ptrCast(self)), base_time_, stream_time_, h_event_, pdw_advise_cookie_);
            }
            pub inline fn advisePeriodic(self: *const T, start_time_: i64, period_time_: i64, h_semaphore_: ?HANDLE, pdw_advise_cookie_: ?*usize) HRESULT {
                return @as(*const IReferenceClock.VTable, @ptrCast(self.vtable)).AdvisePeriodic(@as(*const IReferenceClock, @ptrCast(self)), start_time_, period_time_, h_semaphore_, pdw_advise_cookie_);
            }
            pub inline fn unadvise(self: *const T, dw_advise_cookie_: usize) HRESULT {
                return @as(*const IReferenceClock.VTable, @ptrCast(self.vtable)).Unadvise(@as(*const IReferenceClock, @ptrCast(self)), dw_advise_cookie_);
            }
        };
    }
...
pub const IReferenceClockTimerControl = extern struct {
    pub const VTable = extern struct {
        ...
        SetDefaultTimerResolution: *const fn (
            ...
            timer_resolution: i64,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetDefaultTimerResolution: *const fn (
            self: *const IReferenceClockTimerControl,
            p_timer_resolution: ?*i64,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type {
        return struct {
            pub usingnamespace IUnknown.MethodMixin(T);
            pub inline fn setDefaultTimerResolution(self: *const T, timer_resolution_: i64) HRESULT {
                return @as(*const IReferenceClockTimerControl.VTable, @ptrCast(self.vtable)).SetDefaultTimerResolution(@as(*const IReferenceClockTimerControl, @ptrCast(self)), timer_resolution_);
            }
            pub inline fn getDefaultTimerResolution(self: *const T, p_timer_resolution_: ?*i64) HRESULT {
                return @as(*const IReferenceClockTimerControl.VTable, @ptrCast(self.vtable)).GetDefaultTimerResolution(@as(*const IReferenceClockTimerControl, @ptrCast(self)), p_timer_resolution_);
            }
        };
    }
    pub usingnamespace MethodMixin(@This());
